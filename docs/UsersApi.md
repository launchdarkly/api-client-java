...
# **getSearchUsers**
> Users getSearchUsers(projectKey, environmentKey, q, limit, searchAfter, filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Users result = apiInstance.getSearchUsers(projectKey, environmentKey, q, limit, searchAfter, filter);
