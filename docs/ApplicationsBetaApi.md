...
public class Example {
  public static void main(String[] args) {
    ...
    ApplicationsBetaApi apiInstance = new ApplicationsBetaApi(defaultClient);
    String applicationKey = "applicationKey_example"; // String | The application key
    String filter = "filter_example"; // String | Accepts filter by `key`, `name`, `supported`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances).
...
public class Example {
  public static void main(String[] args) {
    ...
    ApplicationsBetaApi apiInstance = new ApplicationsBetaApi(defaultClient);
    String filter = "filter_example"; // String | Accepts filter by `key`, `name`, `kind`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances).
