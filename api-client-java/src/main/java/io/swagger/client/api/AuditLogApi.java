...
public class AuditLogApi {
     ...
     */
    public com.squareup.okhttp.Call getAuditLogEntriesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getAuditLogEntriesValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = getAuditLogEntriesCall(progressListener, progressRequestListener);
        return call;
     ...
     */
    public AuditLogEntries getAuditLogEntries() throws ApiException {
        ApiResponse<AuditLogEntries> resp = getAuditLogEntriesWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AuditLogEntries> getAuditLogEntriesWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getAuditLogEntriesValidateBeforeCall(null, null);
     ...
     */
    public com.squareup.okhttp.Call getAuditLogEntriesAsync(final ApiCallback<AuditLogEntries> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAuditLogEntriesValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AuditLogEntries>(){}.getType();
