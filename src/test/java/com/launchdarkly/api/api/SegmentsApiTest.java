...
public class SegmentsApiTest {
    ...
    public void deleteSegmentTest() throws ApiException {
        ...
        String envKey = null;
        String key = null;
        api.deleteSegment(projKey, envKey, key);
    ...
    public void getExpiringUserTargetsForSegmentTest() throws ApiException {
        ...
        ExpiringUserTargetGetResponse response = api.getExpiringUserTargetsForSegment(projKey, envKey, segmentKey);
    ...
    public void getSegmentTest() throws ApiException {
        ...
        String envKey = null;
        String key = null;
        UserSegment response = api.getSegment(projKey, envKey, key);
    ...
    public void getSegmentMembershipForUserTest() throws ApiException {
        ...
        String key = null;
        String userKey = null;
        BigSegmentTarget response = api.getSegmentMembershipForUser(projKey, envKey, key, userKey);
    ...
    public void getSegmentsTest() throws ApiException {
        String projKey = null;
        String envKey = null;
        UserSegments response = api.getSegments(projKey, envKey);
    ...
    public void patchExpiringUserTargetsForSegmentTest() throws ApiException {
        ...
        ExpiringUserTargetPatchResponse response = api.patchExpiringUserTargetsForSegment(projKey, envKey, segmentKey, patchSegmentRequest);
    ...
    public void patchSegmentTest() throws ApiException {
        ...
        UserSegment response = api.patchSegment(projKey, envKey, key, patchWithComment);
    ...
    public void postSegmentTest() throws ApiException {
        ...
        UserSegment response = api.postSegment(projKey, envKey, segmentBody);
    ...
    public void updateBigSegmentTargetsTest() throws ApiException {
        ...
        api.updateBigSegmentTargets(projKey, envKey, key, segmentUserState);
