...
public class AccountUsageBetaApiTest {
    ...
    public void getServiceConnectionsUsageTest() throws ApiException {
        ...
        String aggregationType = null;
        String granularity = null;
        SeriesListRepFloat response = api.getServiceConnectionsUsage(from, to, projectKey, environmentKey, connectionType, relayVersion, sdkName, sdkVersion, sdkType, groupBy, aggregationType, granularity);
        // TODO: test validations
    }
