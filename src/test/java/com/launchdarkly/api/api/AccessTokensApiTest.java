...
public class AccessTokensApiTest {
    ...
    public void getTokenTest() throws ApiException {
        String id = null;
        Token response = api.getToken(id);
    ...
    public void patchTokenTest() throws ApiException {
        ...
        Token response = api.patchToken(id, patchOperation);
    ...
    public void postTokenTest() throws ApiException {
        AccessTokenPost accessTokenPost = null;
        Token response = api.postToken(accessTokenPost);
    ...
    public void resetTokenTest() throws ApiException {
        String id = null;
        Long expiry = null;
        Token response = api.resetToken(id, expiry);
