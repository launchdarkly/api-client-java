...
public class UserSegmentsApiTest {
     ...
     */
    @Test
    public void updatedBigSegmentTargetsTest() throws ApiException {
        String projectKey = null;
        String environmentKey = null;
        String userSegmentKey = null;
        BigSegmentTargetsBody bigSegmentTargetsBody = null;
        api.updatedBigSegmentTargets(projectKey, environmentKey, userSegmentKey, bigSegmentTargetsBody);
