...
public class FeatureFlagsApiTest {
    ...
    public void getFeatureFlagsTest() throws ApiException {
        ...
        String sort = null;
        String tag = null;
        FeatureFlags response = api.getFeatureFlags(projectKey, env, summary, archived, limit, number, filter, sort, tag);
    ...
    public void patchExpiringUserTargetsTest() throws ApiException {
        ...
        UserTargetingExpirationForFlags response = api.patchExpiringUserTargets(projectKey, environmentKey, featureFlagKey, patchComment);
