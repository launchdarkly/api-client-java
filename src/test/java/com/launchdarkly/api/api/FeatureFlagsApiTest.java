...
public class FeatureFlagsApiTest {
    ...
    public void copyFeatureFlagTest() throws ApiException {
        ...
        FlagCopyConfigPost flagCopyConfigPost = null;
        FeatureFlag response = api.copyFeatureFlag(projKey, featureFlagKey, flagCopyConfigPost);
    ...
    public void deleteFeatureFlagTest() throws ApiException {
        String projKey = null;
        String key = null;
        api.deleteFeatureFlag(projKey, key);
    ...
    public void getExpiringUserTargetsTest() throws ApiException {
        ...
        String envKey = null;
        String flagKey = null;
        ExpiringUserTargetGetResponse response = api.getExpiringUserTargets(projKey, envKey, flagKey);
    ...
    public void getFeatureFlagTest() throws ApiException {
        ...
        String key = null;
        String env = null;
        FeatureFlag response = api.getFeatureFlag(projKey, key, env);
    ...
    public void getFeatureFlagStatusTest() throws ApiException {
        ...
        String envKey = null;
        String key = null;
        FlagStatusRep response = api.getFeatureFlagStatus(projKey, envKey, key);
    ...
    public void getFeatureFlagStatusAcrossEnvironmentsTest() throws ApiException {
        ...
        String key = null;
        String env = null;
        FeatureFlagStatusAcrossEnvironments response = api.getFeatureFlagStatusAcrossEnvironments(projKey, key, env);
    ...
    public void getFeatureFlagStatusesTest() throws ApiException {
        String projKey = null;
        String envKey = null;
        FeatureFlagStatuses response = api.getFeatureFlagStatuses(projKey, envKey);
    ...
    public void getFeatureFlagsTest() throws ApiException {
        ...
        String filter = null;
        String sort = null;
        FeatureFlags response = api.getFeatureFlags(projKey, env, tag, limit, offset, query, archived, summary, filter, sort);
    ...
    public void patchExpiringUserTargetsTest() throws ApiException {
        ...
        ExpiringUserTargetPatchResponse response = api.patchExpiringUserTargets(projKey, envKey, flagKey, patchWithComment);
    ...
    public void patchFeatureFlagTest() throws ApiException {
        ...
        String key = null;
        PatchWithComment patchWithComment = null;
        FeatureFlag response = api.patchFeatureFlag(projKey, key, patchWithComment);
    ...
    public void postFeatureFlagTest() throws ApiException {
        ...
        String clone = null;
        FeatureFlag response = api.postFeatureFlag(projKey, featureFlagBody, clone);
