...
public class JSON {
...

    {
        gson = createGson()
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.OnRegression.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.TokenDataRep.CustomTypeAdapterFactory())
