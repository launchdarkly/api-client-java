...
public class JSON {
...

    {
        gson = createGson()
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AIConfig.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AIConfigMaintainer.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AIConfigPatch.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AIConfigPost.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AIConfigVariation.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AIConfigVariationPatch.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AIConfigVariationPost.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AIConfigVariationsResponse.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AIConfigs.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AiConfigsAccess.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AiConfigsAccessAllowedReason.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AiConfigsAccessAllowedRep.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AiConfigsAccessDenied.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AiConfigsAccessDeniedReason.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AiConfigsLink.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AiConfigsMaintainerTeam.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementAccess.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementAccessAllowedReason.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementAccessAllowedRep.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementAccessDenied.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementAccessDeniedReason.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementAccessRep.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementLink.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementPaginatedLinks.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementPatchOperation.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementResponse.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AnnouncementResponseLinks.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.AssignedToRep.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.CoreLink.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.CreateAnnouncementBody.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.GenerateWarehouseDestinationKeyPairPostRep.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.GetAnnouncementsPublic200Response.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.MaintainerMember.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.Message.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.MethodNotAllowedErrorRep.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.MetricByVariation.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.Metrics.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.ModelConfig.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.ModelConfigPost.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.PaginatedLinks.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.ParentAndSelfLinks.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.launchdarkly.api.model.ParentLink.CustomTypeAdapterFactory())
