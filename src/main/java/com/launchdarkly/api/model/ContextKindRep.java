...
public class ContextKindRep {
   ...
   * @return the ContextKindRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, contextKindRep.key) &&
        Objects.equals(this.name, contextKindRep.name) &&
        Objects.equals(this.description, contextKindRep.description) &&
        Objects.equals(this.version, contextKindRep.version) &&
        Objects.equals(this.creationDate, contextKindRep.creationDate) &&
        Objects.equals(this.lastModified, contextKindRep.lastModified) &&
        Objects.equals(this.lastSeen, contextKindRep.lastSeen) &&
        Objects.equals(this.createdFrom, contextKindRep.createdFrom) &&
        Objects.equals(this.hideInTargeting, contextKindRep.hideInTargeting) &&
        Objects.equals(this.archived, contextKindRep.archived) &&
        Objects.equals(this.links, contextKindRep.links)&&
        Objects.equals(this.additionalProperties, contextKindRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, version, creationDate, lastModified, lastSeen, createdFrom, hideInTargeting, archived, links, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextKindRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextKindRep is not found in the empty JSON string", ContextKindRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("createdFrom").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `createdFrom` to be a primitive type in the JSON string but got `%s`", jsonObj.get("createdFrom").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContextKindRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContextKindRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContextKindRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContextKindRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ContextKindRep>() {
           @Override
           ...
           public ContextKindRep read(JsonReader in) throws IOException {
             ...
             ContextKindRep instance = thisAdapter.fromJsonTree(jsonObj);
