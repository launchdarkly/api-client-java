...
public class User {
  ...
  public User lastPing(OffsetDateTime lastPing) {
  ...
  **/
  ...
  public User sortValue(Object sortValue) {
  ...
  **/
  ...
  public User access(AccessRep access) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lastPing, user.lastPing) &&
        ...
        Objects.equals(this.sortValue, user.sortValue) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lastPing, environmentId, ownerId, user, sortValue, links, access);
  }
