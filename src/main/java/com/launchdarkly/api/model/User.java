...
public class User {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("privateAttrs") != null && !jsonObj.get("privateAttrs").isJsonNull() && !jsonObj.get("privateAttrs").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `privateAttrs` to be an array in the JSON string but got `%s`", jsonObj.get("privateAttrs").toString()));
      }
  }
