...
public class FlagPrerequisitePost {
  ...
  public FlagPrerequisitePost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public FlagPrerequisitePost variationId(@javax.annotation.Nonnull String variationId) {
   ...
   * @return the FlagPrerequisitePost instance itself
   */
  public FlagPrerequisitePost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagPrerequisitePost flagPrerequisitePost = (FlagPrerequisitePost) o;
    return Objects.equals(this.key, flagPrerequisitePost.key) &&
        Objects.equals(this.variationId, flagPrerequisitePost.variationId)&&
        Objects.equals(this.additionalProperties, flagPrerequisitePost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, variationId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagPrerequisitePost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "variationId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "variationId"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagPrerequisitePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagPrerequisitePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagPrerequisitePost is not found in the empty JSON string", FlagPrerequisitePost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlagPrerequisitePost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagPrerequisitePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagPrerequisitePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagPrerequisitePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagPrerequisitePost.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagPrerequisitePost>() {
           @Override
           public void write(JsonWriter out, FlagPrerequisitePost value) throws IOException {
           ...
           @Override
           public FlagPrerequisitePost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagPrerequisitePost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FlagPrerequisitePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlagPrerequisitePost
   * @throws IOException if the JSON string is invalid with respect to FlagPrerequisitePost
   */
  public static FlagPrerequisitePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlagPrerequisitePost.class);
  }

  /**
   * Convert an instance of FlagPrerequisitePost to an JSON string
   *
   * @return JSON string
   */
