...
import com.launchdarkly.api.model.ViewsMaintainerMember;
import com.launchdarkly.api.model.ViewsMaintainerTeam;
...
public class Maintainer {
   ...
   * @return the Maintainer instance itself
   */
  public Maintainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, maintainer.id) &&
        Objects.equals(this.kind, maintainer.kind) &&
        Objects.equals(this.maintainerMember, maintainer.maintainerMember) &&
        Objects.equals(this.maintainerTeam, maintainer.maintainerTeam)&&
        Objects.equals(this.additionalProperties, maintainer.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, kind, maintainerMember, maintainerTeam, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    maintainerMember: ").append(toIndentedString(maintainerMember)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Maintainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Maintainer is not found in the empty JSON string", Maintainer.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("maintainerMember") != null && !jsonObj.get("maintainerMember").isJsonNull()) {
        ViewsMaintainerMember.validateJsonElement(jsonObj.get("maintainerMember"));
      }
      // validate the optional field `maintainerTeam`
      if (jsonObj.get("maintainerTeam") != null && !jsonObj.get("maintainerTeam").isJsonNull()) {
        ViewsMaintainerTeam.validateJsonElement(jsonObj.get("maintainerTeam"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Maintainer>() {
           ...
           public Maintainer read(JsonReader in) throws IOException {
             ...
             Maintainer instance = thisAdapter.fromJsonTree(jsonObj);
