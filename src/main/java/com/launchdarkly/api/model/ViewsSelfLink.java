...
public class ViewsSelfLink {
   ...
   * @return the ViewsSelfLink instance itself
   */
  public ViewsSelfLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewsSelfLink viewsSelfLink = (ViewsSelfLink) o;
    return Objects.equals(this.self, viewsSelfLink.self)&&
        Objects.equals(this.additionalProperties, viewsSelfLink.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsSelfLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewsSelfLink is not found in the empty JSON string", ViewsSelfLink.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewsSelfLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewsSelfLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewsSelfLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewsSelfLink.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewsSelfLink>() {
           @Override
           public void write(JsonWriter out, ViewsSelfLink value) throws IOException {
           ...
           @Override
           public ViewsSelfLink read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewsSelfLink instance = thisAdapter.fromJsonTree(jsonObj);
