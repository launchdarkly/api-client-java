...
public class AITool {
  ...
  public AITool key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public AITool access(@javax.annotation.Nullable AiConfigsAccess access) {
    this.access = access;
    return this;
  }
  ...
  public AITool links(@javax.annotation.Nullable ParentAndSelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AITool maintainer(@javax.annotation.Nullable AIConfigMaintainer maintainer) {
  ...
  public AITool description(@javax.annotation.Nullable String description) {
  ...
  public AITool schema(@javax.annotation.Nonnull Object schema) {
    this.schema = schema;
    return this;
  }
  ...
  public AITool customParameters(@javax.annotation.Nullable Object customParameters) {
  ...
  public AITool tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public AITool addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public AITool version(@javax.annotation.Nonnull Integer version) {
  ...
  public AITool createdAt(@javax.annotation.Nonnull Long createdAt) {
   ...
   * @return the AITool instance itself
   */
  public AITool putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, aiTool.key) &&
        Objects.equals(this.access, aiTool.access) &&
        Objects.equals(this.links, aiTool.links) &&
        Objects.equals(this.maintainer, aiTool.maintainer) &&
        Objects.equals(this.description, aiTool.description) &&
        Objects.equals(this.schema, aiTool.schema) &&
        Objects.equals(this.customParameters, aiTool.customParameters) &&
        Objects.equals(this.tags, aiTool.tags) &&
        Objects.equals(this.version, aiTool.version) &&
        Objects.equals(this.createdAt, aiTool.createdAt)&&
        Objects.equals(this.additionalProperties, aiTool.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, access, links, maintainer, description, schema, customParameters, tags, version, createdAt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AITool {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "_access", "_links", "_maintainer", "description", "schema", "customParameters", "tags", "version", "createdAt"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "schema", "version", "createdAt"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AITool
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AITool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AITool is not found in the empty JSON string", AITool.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AITool.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AITool.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AITool' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AITool> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AITool.class));

       return (TypeAdapter<T>) new TypeAdapter<AITool>() {
           @Override
           public void write(JsonWriter out, AITool value) throws IOException {
           ...
           @Override
           public AITool read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AITool instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AITool given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AITool
   * @throws IOException if the JSON string is invalid with respect to AITool
   */
  public static AITool fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AITool.class);
  }

  /**
   * Convert an instance of AITool to an JSON string
   *
   * @return JSON string
   */
