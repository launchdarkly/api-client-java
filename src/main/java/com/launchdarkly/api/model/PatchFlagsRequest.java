...
public class PatchFlagsRequest {
  ...
  public PatchFlagsRequest comment(@javax.annotation.Nullable String comment) {
  ...
  public PatchFlagsRequest instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
   ...
   * @return the PatchFlagsRequest instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchFlagsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchFlagsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PatchFlagsRequest is not found in the empty JSON string", PatchFlagsRequest.openapiRequiredFields.toString()));
        }
      }
