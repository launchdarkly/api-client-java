...
public class ConflictOutput {
   ...
   * @return the ConflictOutput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConflictOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConflictOutput is not found in the empty JSON string", ConflictOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("stageId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `stageId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("stageId").toString()));
      }
