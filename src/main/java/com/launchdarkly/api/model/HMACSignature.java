...
public class HMACSignature {
   ...
   * @return the HMACSignature instance itself
   */
  public HMACSignature putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.headerName, hmACSignature.headerName) &&
        Objects.equals(this.hmacSecretFormVariableKey, hmACSignature.hmacSecretFormVariableKey)&&
        Objects.equals(this.additionalProperties, hmACSignature.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(headerName, hmacSecretFormVariableKey, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    hmacSecretFormVariableKey: ").append(toIndentedString(hmacSecretFormVariableKey)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HMACSignature.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HMACSignature is not found in the empty JSON string", HMACSignature.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("hmacSecretFormVariableKey") != null && !jsonObj.get("hmacSecretFormVariableKey").isJsonNull()) && !jsonObj.get("hmacSecretFormVariableKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hmacSecretFormVariableKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hmacSecretFormVariableKey").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HMACSignature>() {
           ...
           public HMACSignature read(JsonReader in) throws IOException {
             ...
             HMACSignature instance = thisAdapter.fromJsonTree(jsonObj);
