...
public class TeamPatchInput {
  ...
  public TeamPatchInput comment(@javax.annotation.Nullable String comment) {
  ...
  public TeamPatchInput instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
   ...
   * @return the TeamPatchInput instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamPatchInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamPatchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TeamPatchInput is not found in the empty JSON string", TeamPatchInput.openapiRequiredFields.toString()));
        }
      }
