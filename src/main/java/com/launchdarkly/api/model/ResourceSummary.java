...
public class ResourceSummary {
   ...
   * @return the ResourceSummary instance itself
   */
  public ResourceSummary putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResourceSummary is not found in the empty JSON string", ResourceSummary.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResourceSummary>() {
           ...
           public ResourceSummary read(JsonReader in) throws IOException {
             ...
             ResourceSummary instance = thisAdapter.fromJsonTree(jsonObj);
