...
public class ReleaseProgression {
  ...
  public ReleaseProgression putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the ReleaseProgression instance itself
   */
  public ReleaseProgression putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReleaseProgression releaseProgression = (ReleaseProgression) o;
    return Objects.equals(this.createdAt, releaseProgression.createdAt) &&
        Objects.equals(this.completedAt, releaseProgression.completedAt) &&
        Objects.equals(this.flagKey, releaseProgression.flagKey) &&
        Objects.equals(this.activePhaseId, releaseProgression.activePhaseId) &&
        Objects.equals(this.links, releaseProgression.links)&&
        Objects.equals(this.additionalProperties, releaseProgression.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, completedAt, flagKey, activePhaseId, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReleaseProgression {\n");
    sb.append("    createdAt: ").append(toIndentedString(createdAt)).append("\n");
    sb.append("    completedAt: ").append(toIndentedString(completedAt)).append("\n");
    sb.append("    flagKey: ").append(toIndentedString(flagKey)).append("\n");
    sb.append("    activePhaseId: ").append(toIndentedString(activePhaseId)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleaseProgression.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleaseProgression is not found in the empty JSON string", ReleaseProgression.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("activePhaseId") != null && !jsonObj.get("activePhaseId").isJsonNull()) && !jsonObj.get("activePhaseId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `activePhaseId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("activePhaseId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleaseProgression.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleaseProgression' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleaseProgression> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleaseProgression.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleaseProgression>() {
           @Override
           public void write(JsonWriter out, ReleaseProgression value) throws IOException {
           ...
           @Override
           public ReleaseProgression read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReleaseProgression instance = thisAdapter.fromJsonTree(jsonObj);
