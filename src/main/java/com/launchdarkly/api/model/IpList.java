...
public class IpList {
  ...
  public IpList addOutboundAddressesItem(String outboundAddressesItem) {
    if (this.outboundAddresses == null) {
      this.outboundAddresses = new ArrayList<>();
    }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IpList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IpList is not found in the empty JSON string", IpList.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("outboundAddresses") == null) {
        ...
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `outboundAddresses` to be an array in the JSON string but got `%s`", jsonObj.get("outboundAddresses").toString()));
      }
  }
