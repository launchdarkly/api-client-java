...
public class ConditionOutputRep {
  ...
  private List<ReviewOutputRep> allReviews = new ArrayList<ReviewOutputRep>();
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, kind, execution, scheduleKind, executionDate, waitDuration, waitDurationUnit, description, notifyMemberIds, allReviews, reviewStatus, appliedDate);
  }
