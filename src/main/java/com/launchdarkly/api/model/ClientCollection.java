...
public class ClientCollection {
  ...
  public ClientCollection links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public ClientCollection items(@javax.annotation.Nonnull List<Client> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<Client> items) {
    this.items = items;
  }
   ...
   * @return the ClientCollection instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClientCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClientCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ClientCollection is not found in the empty JSON string", ClientCollection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        Client.validateJsonElement(jsonArrayitems.get(i));
      };
  }
