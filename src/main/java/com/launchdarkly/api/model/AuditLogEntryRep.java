...
import com.launchdarkly.api.model.RelatedAIConfig;
import com.launchdarkly.api.model.RelatedExperiment;
import com.launchdarkly.api.model.RelatedFlag;
...
public class AuditLogEntryRep {
  ...
  public static final String SERIALIZED_NAME_RELATED_FLAG = "relatedFlag";
  @SerializedName(SERIALIZED_NAME_RELATED_FLAG)
  @javax.annotation.Nullable
  private RelatedFlag relatedFlag;

  public static final String SERIALIZED_NAME_RELATED_EXPERIMENT = "relatedExperiment";
  @SerializedName(SERIALIZED_NAME_RELATED_EXPERIMENT)
  @javax.annotation.Nullable
  private RelatedExperiment relatedExperiment;

  public static final String SERIALIZED_NAME_RELATED_A_I_CONFIG = "relatedAIConfig";
  @SerializedName(SERIALIZED_NAME_RELATED_A_I_CONFIG)
  @javax.annotation.Nullable
  private RelatedAIConfig relatedAIConfig;
  ...
  public AuditLogEntryRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public AuditLogEntryRep id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public AuditLogEntryRep accountId(@javax.annotation.Nonnull String accountId) {
  ...
  public AuditLogEntryRep date(@javax.annotation.Nonnull Long date) {
    this.date = date;
    return this;
  }
  ...
  public AuditLogEntryRep accesses(@javax.annotation.Nonnull List<ResourceAccess> accesses) {
  ...
  public AuditLogEntryRep kind(@javax.annotation.Nonnull String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public AuditLogEntryRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuditLogEntryRep description(@javax.annotation.Nonnull String description) {
  ...
  public AuditLogEntryRep shortDescription(@javax.annotation.Nonnull String shortDescription) {
  ...
  public AuditLogEntryRep comment(@javax.annotation.Nullable String comment) {
  ...
  public AuditLogEntryRep relatedFlag(@javax.annotation.Nullable RelatedFlag relatedFlag) {
   ...
   */
  @javax.annotation.Nullable
  public RelatedFlag getRelatedFlag() {
    return relatedFlag;
  }

  public void setRelatedFlag(@javax.annotation.Nullable RelatedFlag relatedFlag) {
    this.relatedFlag = relatedFlag;
  }


  public AuditLogEntryRep relatedExperiment(@javax.annotation.Nullable RelatedExperiment relatedExperiment) {
    this.relatedExperiment = relatedExperiment;
    return this;
  }

  /**
   * Get relatedExperiment
   * @return relatedExperiment
   */
  @javax.annotation.Nullable
  public RelatedExperiment getRelatedExperiment() {
    return relatedExperiment;
  }

  public void setRelatedExperiment(@javax.annotation.Nullable RelatedExperiment relatedExperiment) {
    this.relatedExperiment = relatedExperiment;
  }


  public AuditLogEntryRep relatedAIConfig(@javax.annotation.Nullable RelatedAIConfig relatedAIConfig) {
    this.relatedAIConfig = relatedAIConfig;
    return this;
  }

  /**
   * Get relatedAIConfig
   * @return relatedAIConfig
   */
  @javax.annotation.Nullable
  public RelatedAIConfig getRelatedAIConfig() {
    return relatedAIConfig;
  }

  public void setRelatedAIConfig(@javax.annotation.Nullable RelatedAIConfig relatedAIConfig) {
    this.relatedAIConfig = relatedAIConfig;
  }


  public AuditLogEntryRep subject(@javax.annotation.Nullable SubjectDataRep subject) {
  ...
  public AuditLogEntryRep member(@javax.annotation.Nullable MemberDataRep member) {
    this.member = member;
    return this;
  }
  ...
  public AuditLogEntryRep token(@javax.annotation.Nullable TokenSummary token) {
    this.token = token;
    return this;
  }
  ...
  public AuditLogEntryRep app(@javax.annotation.Nullable AuthorizedAppDataRep app) {
    this.app = app;
    return this;
  }
  ...
  public AuditLogEntryRep titleVerb(@javax.annotation.Nullable String titleVerb) {
  ...
  public AuditLogEntryRep title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public AuditLogEntryRep target(@javax.annotation.Nullable TargetResourceRep target) {
    this.target = target;
    return this;
  }
  ...
  public AuditLogEntryRep parent(@javax.annotation.Nullable ParentResourceRep parent) {
    this.parent = parent;
    return this;
  }
  ...
  public AuditLogEntryRep delta(@javax.annotation.Nullable Object delta) {
    this.delta = delta;
    return this;
  }
  ...
  public void setDelta(@javax.annotation.Nullable Object delta) {
    this.delta = delta;
  }


  public AuditLogEntryRep triggerBody(@javax.annotation.Nullable Object triggerBody) {
  ...
  public void setTriggerBody(@javax.annotation.Nullable Object triggerBody) {
    this.triggerBody = triggerBody;
  }


  public AuditLogEntryRep merge(@javax.annotation.Nullable Object merge) {
    this.merge = merge;
    return this;
  }
  ...
  public void setMerge(@javax.annotation.Nullable Object merge) {
    this.merge = merge;
  }


  public AuditLogEntryRep previousVersion(@javax.annotation.Nullable Object previousVersion) {
  ...
  public void setPreviousVersion(@javax.annotation.Nullable Object previousVersion) {
    this.previousVersion = previousVersion;
  }


  public AuditLogEntryRep currentVersion(@javax.annotation.Nullable Object currentVersion) {
  ...
  public void setCurrentVersion(@javax.annotation.Nullable Object currentVersion) {
    this.currentVersion = currentVersion;
  }


  public AuditLogEntryRep subentries(@javax.annotation.Nullable List<AuditLogEntryListingRep> subentries) {
  ...
  public void setSubentries(@javax.annotation.Nullable List<AuditLogEntryListingRep> subentries) {
    this.subentries = subentries;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, auditLogEntryRep.links) &&
        ...
        Objects.equals(this.relatedFlag, auditLogEntryRep.relatedFlag) &&
        Objects.equals(this.relatedExperiment, auditLogEntryRep.relatedExperiment) &&
        Objects.equals(this.relatedAIConfig, auditLogEntryRep.relatedAIConfig) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, accountId, date, accesses, kind, name, description, shortDescription, comment, relatedFlag, relatedExperiment, relatedAIConfig, subject, member, token, app, titleVerb, title, target, parent, delta, triggerBody, merge, previousVersion, currentVersion, subentries, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    relatedFlag: ").append(toIndentedString(relatedFlag)).append("\n");
    sb.append("    relatedExperiment: ").append(toIndentedString(relatedExperiment)).append("\n");
    sb.append("    relatedAIConfig: ").append(toIndentedString(relatedAIConfig)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "_id", "_accountId", "date", "accesses", "kind", "name", "description", "shortDescription", "comment", "relatedFlag", "relatedExperiment", "relatedAIConfig", "subject", "member", "token", "app", "titleVerb", "title", "target", "parent", "delta", "triggerBody", "merge", "previousVersion", "currentVersion", "subentries"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditLogEntryRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuditLogEntryRep is not found in the empty JSON string", AuditLogEntryRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("_accountId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_accountId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_accountId").toString()));
      }
      ...
      // validate the optional field `relatedFlag`
      if (jsonObj.get("relatedFlag") != null && !jsonObj.get("relatedFlag").isJsonNull()) {
        RelatedFlag.validateJsonElement(jsonObj.get("relatedFlag"));
      }
      // validate the optional field `relatedExperiment`
      if (jsonObj.get("relatedExperiment") != null && !jsonObj.get("relatedExperiment").isJsonNull()) {
        RelatedExperiment.validateJsonElement(jsonObj.get("relatedExperiment"));
      }
      // validate the optional field `relatedAIConfig`
      if (jsonObj.get("relatedAIConfig") != null && !jsonObj.get("relatedAIConfig").isJsonNull()) {
        RelatedAIConfig.validateJsonElement(jsonObj.get("relatedAIConfig"));
      }
      ...
      if ((jsonObj.get("titleVerb") != null && !jsonObj.get("titleVerb").isJsonNull()) && !jsonObj.get("titleVerb").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `titleVerb` to be a primitive type in the JSON string but got `%s`", jsonObj.get("titleVerb").toString()));
      }
      ...
      if (jsonObj.get("subentries") != null && !jsonObj.get("subentries").isJsonNull()) {
        ...
        if (jsonArraysubentries != null) {
          ...
          if (!jsonObj.get("subentries").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `subentries` to be an array in the JSON string but got `%s`", jsonObj.get("subentries").toString()));
          }
