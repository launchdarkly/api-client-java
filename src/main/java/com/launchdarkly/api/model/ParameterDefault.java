...
public class ParameterDefault {
   ...
   * @return the ParameterDefault instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterDefault.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ParameterDefault is not found in the empty JSON string", ParameterDefault.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ruleClause`
      if (jsonObj.get("ruleClause") != null && !jsonObj.get("ruleClause").isJsonNull()) {
        RuleClause.validateJsonElement(jsonObj.get("ruleClause"));
      }
  }
