...
public class Clause {
  ...
  public Clause id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Clause attribute(@javax.annotation.Nonnull String attribute) {
  ...
  public Clause op(@javax.annotation.Nonnull String op) {
    this.op = op;
    return this;
  }
  ...
  public Clause values(@javax.annotation.Nonnull List<Object> values) {
    this.values = values;
    return this;
  }
  ...
  public Clause contextKind(@javax.annotation.Nullable String contextKind) {
  ...
  public Clause negate(@javax.annotation.Nonnull Boolean negate) {
    this.negate = negate;
    return this;
  }
   ...
   * @return the Clause instance itself
   */
  public Clause putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, clause.id) &&
        ...
        Objects.equals(this.contextKind, clause.contextKind) &&
        Objects.equals(this.negate, clause.negate)&&
        Objects.equals(this.additionalProperties, clause.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, attribute, op, values, contextKind, negate, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "attribute", "op", "values", "contextKind", "negate"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("attribute", "op", "values", "negate"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Clause.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Clause is not found in the empty JSON string", Clause.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Clause>() {
           ...
           public Clause read(JsonReader in) throws IOException {
             ...
             Clause instance = thisAdapter.fromJsonTree(jsonObj);
