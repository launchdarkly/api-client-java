...
public class SdkKeyPost {
  ...
  private KindEnum kind = KindEnum.SDK;
  ...
  public SdkKeyPost kind(@javax.annotation.Nullable KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public SdkKeyPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public SdkKeyPost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public SdkKeyPost description(@javax.annotation.Nullable String description) {
  ...
  public SdkKeyPost expiry(@javax.annotation.Nullable Long expiry) {
    this.expiry = expiry;
    return this;
  }
   ...
   * @return the SdkKeyPost instance itself
   */
  public SdkKeyPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SdkKeyPost sdkKeyPost = (SdkKeyPost) o;
    return Objects.equals(this.kind, sdkKeyPost.kind) &&
        Objects.equals(this.key, sdkKeyPost.key) &&
        Objects.equals(this.name, sdkKeyPost.name) &&
        Objects.equals(this.description, sdkKeyPost.description) &&
        Objects.equals(this.expiry, sdkKeyPost.expiry)&&
        Objects.equals(this.additionalProperties, sdkKeyPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, key, name, description, expiry, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SdkKeyPost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("kind", "key", "name", "description", "expiry"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SdkKeyPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SdkKeyPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SdkKeyPost is not found in the empty JSON string", SdkKeyPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SdkKeyPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SdkKeyPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SdkKeyPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SdkKeyPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SdkKeyPost.class));

       return (TypeAdapter<T>) new TypeAdapter<SdkKeyPost>() {
           @Override
           public void write(JsonWriter out, SdkKeyPost value) throws IOException {
           ...
           @Override
           public SdkKeyPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SdkKeyPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SdkKeyPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SdkKeyPost
   * @throws IOException if the JSON string is invalid with respect to SdkKeyPost
   */
  public static SdkKeyPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SdkKeyPost.class);
  }

  /**
   * Convert an instance of SdkKeyPost to an JSON string
   *
   * @return JSON string
   */
