...
public class HoldoutRep {
   ...
   * @return the HoldoutRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, holdoutRep.id) &&
        Objects.equals(this.status, holdoutRep.status) &&
        Objects.equals(this.description, holdoutRep.description) &&
        Objects.equals(this.holdoutAmount, holdoutRep.holdoutAmount) &&
        Objects.equals(this.createdAt, holdoutRep.createdAt) &&
        Objects.equals(this.updatedAt, holdoutRep.updatedAt) &&
        Objects.equals(this.baseExperiment, holdoutRep.baseExperiment) &&
        Objects.equals(this.experiments, holdoutRep.experiments)&&
        Objects.equals(this.additionalProperties, holdoutRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, status, description, holdoutAmount, createdAt, updatedAt, baseExperiment, experiments, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HoldoutRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HoldoutRep is not found in the empty JSON string", HoldoutRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HoldoutRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HoldoutRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HoldoutRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HoldoutRep.class));

       return (TypeAdapter<T>) new TypeAdapter<HoldoutRep>() {
           @Override
           ...
           public HoldoutRep read(JsonReader in) throws IOException {
             ...
             HoldoutRep instance = thisAdapter.fromJsonTree(jsonObj);
