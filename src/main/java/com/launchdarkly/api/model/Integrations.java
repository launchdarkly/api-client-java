...
public class Integrations {
  ...
  @javax.annotation.Nullable
  private List<Integration> items = new ArrayList<>();
  ...
  public Integrations links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public Integrations putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public Integrations items(@javax.annotation.Nullable List<Integration> items) {
    this.items = items;
    return this;
  }

  public Integrations addItemsItem(Integration itemsItem) {
    if (this.items == null) {
  ...
  public void setItems(@javax.annotation.Nullable List<Integration> items) {
    this.items = items;
  }


  public Integrations key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
   ...
   * @return the Integrations instance itself
   */
  public Integrations putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, integrations.links) &&
        ...
        Objects.equals(this.key, integrations.key)&&
        Objects.equals(this.additionalProperties, integrations.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, items, key, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "items", "key"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Integrations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Integrations is not found in the empty JSON string", Integrations.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            Integration.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Integrations>() {
           ...
           public Integrations read(JsonReader in) throws IOException {
             ...
             Integrations instance = thisAdapter.fromJsonTree(jsonObj);
