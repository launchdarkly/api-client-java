...
public class InsightsRepository {
   ...
   * @return the InsightsRepository instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightsRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightsRepository is not found in the empty JSON string", InsightsRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("mainBranch").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mainBranch` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mainBranch").toString()));
      }
      // validate the optional field `projects`
      if (jsonObj.get("projects") != null && !jsonObj.get("projects").isJsonNull()) {
        ProjectSummaryCollection.validateJsonElement(jsonObj.get("projects"));
      }
  }
