...
public class ModelConfigPost {
  ...
  public static final String SERIALIZED_NAME_COST_PER_CACHED_INPUT_TOKEN = "costPerCachedInputToken";
  @SerializedName(SERIALIZED_NAME_COST_PER_CACHED_INPUT_TOKEN)
  @javax.annotation.Nullable
  private Double costPerCachedInputToken;

  public ModelConfigPost() {
  }

  public ModelConfigPost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ModelConfigPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public ModelConfigPost id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ModelConfigPost icon(@javax.annotation.Nullable String icon) {
    this.icon = icon;
    return this;
  }
  ...
  public ModelConfigPost provider(@javax.annotation.Nullable String provider) {
  ...
  public ModelConfigPost params(@javax.annotation.Nullable Object params) {
    this.params = params;
    return this;
  }
  ...
  public ModelConfigPost customParams(@javax.annotation.Nullable Object customParams) {
  ...
  public ModelConfigPost tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public ModelConfigPost addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public ModelConfigPost costPerInputToken(@javax.annotation.Nullable Double costPerInputToken) {
  ...
  public ModelConfigPost costPerOutputToken(@javax.annotation.Nullable Double costPerOutputToken) {
  ...
  public ModelConfigPost costPerCachedInputToken(@javax.annotation.Nullable Double costPerCachedInputToken) {
    this.costPerCachedInputToken = costPerCachedInputToken;
    return this;
  }

  /**
   * Cost per cached input token in USD
   * @return costPerCachedInputToken
   */
  @javax.annotation.Nullable
  public Double getCostPerCachedInputToken() {
    return costPerCachedInputToken;
  }

  public void setCostPerCachedInputToken(@javax.annotation.Nullable Double costPerCachedInputToken) {
    this.costPerCachedInputToken = costPerCachedInputToken;
  }
   ...
   * @return the ModelConfigPost instance itself
   */
  public ModelConfigPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ModelConfigPost modelConfigPost = (ModelConfigPost) o;
    return Objects.equals(this.name, modelConfigPost.name) &&
        Objects.equals(this.key, modelConfigPost.key) &&
        Objects.equals(this.id, modelConfigPost.id) &&
        Objects.equals(this.icon, modelConfigPost.icon) &&
        Objects.equals(this.provider, modelConfigPost.provider) &&
        Objects.equals(this.params, modelConfigPost.params) &&
        Objects.equals(this.customParams, modelConfigPost.customParams) &&
        Objects.equals(this.tags, modelConfigPost.tags) &&
        Objects.equals(this.costPerInputToken, modelConfigPost.costPerInputToken) &&
        Objects.equals(this.costPerOutputToken, modelConfigPost.costPerOutputToken) &&
        Objects.equals(this.costPerCachedInputToken, modelConfigPost.costPerCachedInputToken)&&
        Objects.equals(this.additionalProperties, modelConfigPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, key, id, icon, provider, params, customParams, tags, costPerInputToken, costPerOutputToken, costPerCachedInputToken, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModelConfigPost {\n");
    ...
    sb.append("    costPerInputToken: ").append(toIndentedString(costPerInputToken)).append("\n");
    sb.append("    costPerOutputToken: ").append(toIndentedString(costPerOutputToken)).append("\n");
    sb.append("    costPerCachedInputToken: ").append(toIndentedString(costPerCachedInputToken)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "key", "id", "icon", "provider", "params", "customParams", "tags", "costPerInputToken", "costPerOutputToken", "costPerCachedInputToken"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "key", "id"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelConfigPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelConfigPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelConfigPost is not found in the empty JSON string", ModelConfigPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ModelConfigPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelConfigPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelConfigPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelConfigPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelConfigPost.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelConfigPost>() {
           @Override
           public void write(JsonWriter out, ModelConfigPost value) throws IOException {
           ...
           @Override
           public ModelConfigPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ModelConfigPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ModelConfigPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelConfigPost
   * @throws IOException if the JSON string is invalid with respect to ModelConfigPost
   */
  public static ModelConfigPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelConfigPost.class);
  }

  /**
   * Convert an instance of ModelConfigPost to an JSON string
   *
   * @return JSON string
   */
