...
public class ModelConfigPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, key, id, icon, provider, params, customParams, tags, costPerInputToken, costPerOutputToken, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "key", "id", "icon", "provider", "params", "customParams", "tags", "costPerInputToken", "costPerOutputToken"));
