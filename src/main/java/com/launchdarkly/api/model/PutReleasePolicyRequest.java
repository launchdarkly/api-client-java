...
public class PutReleasePolicyRequest {
  ...
  public PutReleasePolicyRequest scope(@javax.annotation.Nullable ReleasePolicyScope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public PutReleasePolicyRequest releaseMethod(@javax.annotation.Nonnull ReleaseMethod releaseMethod) {
  ...
  public PutReleasePolicyRequest guardedReleaseConfig(@javax.annotation.Nullable GuardedReleaseConfig guardedReleaseConfig) {
  ...
  public PutReleasePolicyRequest progressiveReleaseConfig(@javax.annotation.Nullable ProgressiveReleaseConfig progressiveReleaseConfig) {
  ...
  public PutReleasePolicyRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the PutReleasePolicyRequest instance itself
   */
  public PutReleasePolicyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PutReleasePolicyRequest putReleasePolicyRequest = (PutReleasePolicyRequest) o;
    return Objects.equals(this.scope, putReleasePolicyRequest.scope) &&
        Objects.equals(this.releaseMethod, putReleasePolicyRequest.releaseMethod) &&
        Objects.equals(this.guardedReleaseConfig, putReleasePolicyRequest.guardedReleaseConfig) &&
        Objects.equals(this.progressiveReleaseConfig, putReleasePolicyRequest.progressiveReleaseConfig) &&
        Objects.equals(this.name, putReleasePolicyRequest.name)&&
        Objects.equals(this.additionalProperties, putReleasePolicyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, releaseMethod, guardedReleaseConfig, progressiveReleaseConfig, name, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutReleasePolicyRequest {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("scope", "releaseMethod", "guardedReleaseConfig", "progressiveReleaseConfig", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("releaseMethod", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutReleasePolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutReleasePolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PutReleasePolicyRequest is not found in the empty JSON string", PutReleasePolicyRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutReleasePolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutReleasePolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutReleasePolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutReleasePolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutReleasePolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutReleasePolicyRequest>() {
           @Override
           public void write(JsonWriter out, PutReleasePolicyRequest value) throws IOException {
           ...
           @Override
           public PutReleasePolicyRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PutReleasePolicyRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PutReleasePolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutReleasePolicyRequest
   * @throws IOException if the JSON string is invalid with respect to PutReleasePolicyRequest
   */
  public static PutReleasePolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutReleasePolicyRequest.class);
  }

  /**
   * Convert an instance of PutReleasePolicyRequest to an JSON string
   *
   * @return JSON string
   */
