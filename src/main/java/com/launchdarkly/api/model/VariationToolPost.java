...
public class VariationToolPost {
  ...
  public VariationToolPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public VariationToolPost version(@javax.annotation.Nonnull Integer version) {
   ...
   * @return the VariationToolPost instance itself
   */
  public VariationToolPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VariationToolPost variationToolPost = (VariationToolPost) o;
    return Objects.equals(this.key, variationToolPost.key) &&
        Objects.equals(this.version, variationToolPost.version)&&
        Objects.equals(this.additionalProperties, variationToolPost.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VariationToolPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VariationToolPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariationToolPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariationToolPost is not found in the empty JSON string", VariationToolPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VariationToolPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VariationToolPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VariationToolPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VariationToolPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VariationToolPost.class));

       return (TypeAdapter<T>) new TypeAdapter<VariationToolPost>() {
           @Override
           public void write(JsonWriter out, VariationToolPost value) throws IOException {
           ...
           @Override
           public VariationToolPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             VariationToolPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of VariationToolPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VariationToolPost
   * @throws IOException if the JSON string is invalid with respect to VariationToolPost
   */
  public static VariationToolPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VariationToolPost.class);
  }

  /**
   * Convert an instance of VariationToolPost to an JSON string
   *
   * @return JSON string
   */
