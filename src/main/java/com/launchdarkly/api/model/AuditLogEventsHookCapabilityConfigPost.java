...
public class AuditLogEventsHookCapabilityConfigPost {
  ...
  public AuditLogEventsHookCapabilityConfigPost addStatementsItem(StatementPost statementsItem) {
   ...
   * @return the AuditLogEventsHookCapabilityConfigPost instance itself
   */
  public AuditLogEventsHookCapabilityConfigPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AuditLogEventsHookCapabilityConfigPost auditLogEventsHookCapabilityConfigPost = (AuditLogEventsHookCapabilityConfigPost) o;
    return Objects.equals(this.statements, auditLogEventsHookCapabilityConfigPost.statements)&&
        Objects.equals(this.additionalProperties, auditLogEventsHookCapabilityConfigPost.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuditLogEventsHookCapabilityConfigPost {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditLogEventsHookCapabilityConfigPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuditLogEventsHookCapabilityConfigPost is not found in the empty JSON string", AuditLogEventsHookCapabilityConfigPost.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("statements") != null && !jsonObj.get("statements").isJsonNull()) {
        ...
        if (jsonArraystatements != null) {
          ...
          for (int i = 0; i < jsonArraystatements.size(); i++) {
            StatementPost.validateJsonElement(jsonArraystatements.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuditLogEventsHookCapabilityConfigPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuditLogEventsHookCapabilityConfigPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuditLogEventsHookCapabilityConfigPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuditLogEventsHookCapabilityConfigPost.class));

       return (TypeAdapter<T>) new TypeAdapter<AuditLogEventsHookCapabilityConfigPost>() {
           @Override
           public void write(JsonWriter out, AuditLogEventsHookCapabilityConfigPost value) throws IOException {
           ...
           @Override
           public AuditLogEventsHookCapabilityConfigPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AuditLogEventsHookCapabilityConfigPost instance = thisAdapter.fromJsonTree(jsonObj);
