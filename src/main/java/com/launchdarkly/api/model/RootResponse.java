...
public class RootResponse {
  ...
  public RootResponse links(Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RootResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RootResponse is not found in the empty JSON string", RootResponse.openapiRequiredFields.toString()));
        }
      }
