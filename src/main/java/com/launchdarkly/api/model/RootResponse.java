...
public class RootResponse {
  ...
  public RootResponse links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public RootResponse putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the RootResponse instance itself
   */
  public RootResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, rootResponse.links)&&
        Objects.equals(this.additionalProperties, rootResponse.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RootResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RootResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RootResponse is not found in the empty JSON string", RootResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RootResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RootResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RootResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RootResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RootResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RootResponse>() {
           @Override
           public void write(JsonWriter out, RootResponse value) throws IOException {
           ...
           @Override
           public RootResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RootResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of RootResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RootResponse
   * @throws IOException if the JSON string is invalid with respect to RootResponse
   */
  public static RootResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RootResponse.class);
  }

  /**
   * Convert an instance of RootResponse to an JSON string
   *
   * @return JSON string
   */
