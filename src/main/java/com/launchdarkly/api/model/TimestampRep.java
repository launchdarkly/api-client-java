...
public class TimestampRep {
   ...
   * @return the TimestampRep instance itself
   */
  public TimestampRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimestampRep timestampRep = (TimestampRep) o;
    return Objects.equals(this.milliseconds, timestampRep.milliseconds) &&
        Objects.equals(this.seconds, timestampRep.seconds) &&
        Objects.equals(this.rfc3339, timestampRep.rfc3339) &&
        Objects.equals(this.simple, timestampRep.simple)&&
        Objects.equals(this.additionalProperties, timestampRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(milliseconds, seconds, rfc3339, simple, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimestampRep {\n");
    sb.append("    milliseconds: ").append(toIndentedString(milliseconds)).append("\n");
    sb.append("    seconds: ").append(toIndentedString(seconds)).append("\n");
    sb.append("    rfc3339: ").append(toIndentedString(rfc3339)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimestampRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TimestampRep is not found in the empty JSON string", TimestampRep.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("rfc3339") != null && !jsonObj.get("rfc3339").isJsonNull()) && !jsonObj.get("rfc3339").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rfc3339` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rfc3339").toString()));
      }
      if ((jsonObj.get("simple") != null && !jsonObj.get("simple").isJsonNull()) && !jsonObj.get("simple").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `simple` to be a primitive type in the JSON string but got `%s`", jsonObj.get("simple").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimestampRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimestampRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimestampRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimestampRep.class));

       return (TypeAdapter<T>) new TypeAdapter<TimestampRep>() {
           @Override
           public void write(JsonWriter out, TimestampRep value) throws IOException {
           ...
           @Override
           public TimestampRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TimestampRep instance = thisAdapter.fromJsonTree(jsonObj);
