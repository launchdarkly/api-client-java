...
public class ApprovalRequestSetting {
  ...
  public ApprovalRequestSetting putServiceConfigItem(String key, Object serviceConfigItem) {
  ...
  public ApprovalRequestSetting addRequiredApprovalTagsItem(String requiredApprovalTagsItem) {
   ...
   * @return the ApprovalRequestSetting instance itself
   */
  public ApprovalRequestSetting putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApprovalRequestSetting approvalRequestSetting = (ApprovalRequestSetting) o;
    return Objects.equals(this.required, approvalRequestSetting.required) &&
        Objects.equals(this.bypassApprovalsForPendingChanges, approvalRequestSetting.bypassApprovalsForPendingChanges) &&
        Objects.equals(this.minNumApprovals, approvalRequestSetting.minNumApprovals) &&
        Objects.equals(this.canReviewOwnRequest, approvalRequestSetting.canReviewOwnRequest) &&
        Objects.equals(this.canApplyDeclinedChanges, approvalRequestSetting.canApplyDeclinedChanges) &&
        Objects.equals(this.autoApplyApprovedChanges, approvalRequestSetting.autoApplyApprovedChanges) &&
        Objects.equals(this.serviceKind, approvalRequestSetting.serviceKind) &&
        Objects.equals(this.serviceConfig, approvalRequestSetting.serviceConfig) &&
        Objects.equals(this.requiredApprovalTags, approvalRequestSetting.requiredApprovalTags) &&
        Objects.equals(this.serviceKindConfigurationId, approvalRequestSetting.serviceKindConfigurationId)&&
        Objects.equals(this.additionalProperties, approvalRequestSetting.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(required, bypassApprovalsForPendingChanges, minNumApprovals, canReviewOwnRequest, canApplyDeclinedChanges, autoApplyApprovedChanges, serviceKind, serviceConfig, requiredApprovalTags, serviceKindConfigurationId, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApprovalRequestSetting {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRequestSetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApprovalRequestSetting is not found in the empty JSON string", ApprovalRequestSetting.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalRequestSetting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalRequestSetting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalRequestSetting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalRequestSetting.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalRequestSetting>() {
           @Override
           public void write(JsonWriter out, ApprovalRequestSetting value) throws IOException {
           ...
           @Override
           public ApprovalRequestSetting read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ApprovalRequestSetting instance = thisAdapter.fromJsonTree(jsonObj);
