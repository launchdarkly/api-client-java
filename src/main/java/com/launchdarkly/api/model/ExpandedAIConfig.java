...
public class ExpandedAIConfig {
  ...
  public ExpandedAIConfig addTagsItem(String tagsItem) {
    if (this.tags == null) {
   ...
   * @return the ExpandedAIConfig instance itself
   */
  public ExpandedAIConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedAIConfig expandedAIConfig = (ExpandedAIConfig) o;
    return Objects.equals(this.key, expandedAIConfig.key) &&
        Objects.equals(this.name, expandedAIConfig.name) &&
        Objects.equals(this.tags, expandedAIConfig.tags) &&
        Objects.equals(this.description, expandedAIConfig.description) &&
        Objects.equals(this.version, expandedAIConfig.version) &&
        Objects.equals(this.createdAt, expandedAIConfig.createdAt) &&
        Objects.equals(this.updatedAt, expandedAIConfig.updatedAt) &&
        Objects.equals(this.flagKey, expandedAIConfig.flagKey) &&
        Objects.equals(this.links, expandedAIConfig.links)&&
        Objects.equals(this.additionalProperties, expandedAIConfig.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, tags, description, version, createdAt, updatedAt, flagKey, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExpandedAIConfig {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedAIConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedAIConfig is not found in the empty JSON string", ExpandedAIConfig.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedAIConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedAIConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedAIConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedAIConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedAIConfig>() {
           @Override
           public void write(JsonWriter out, ExpandedAIConfig value) throws IOException {
           ...
           @Override
           public ExpandedAIConfig read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedAIConfig instance = thisAdapter.fromJsonTree(jsonObj);
