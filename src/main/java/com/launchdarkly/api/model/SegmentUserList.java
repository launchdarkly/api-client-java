...
public class SegmentUserList {
   ...
   * @return the SegmentUserList instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentUserList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SegmentUserList is not found in the empty JSON string", SegmentUserList.openapiRequiredFields.toString()));
        }
      }
