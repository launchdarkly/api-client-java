...
public class ApplicationMaintainerRep {
  ...
  public ApplicationMaintainerRep member(@javax.annotation.Nullable MemberSummary member) {
    this.member = member;
    return this;
  }
  ...
  public ApplicationMaintainerRep team(@javax.annotation.Nullable MemberTeamSummaryRep team) {
    this.team = team;
    return this;
  }
   ...
   * @return the ApplicationMaintainerRep instance itself
   */
  public ApplicationMaintainerRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationMaintainerRep applicationMaintainerRep = (ApplicationMaintainerRep) o;
    return Objects.equals(this.member, applicationMaintainerRep.member) &&
        Objects.equals(this.team, applicationMaintainerRep.team)&&
        Objects.equals(this.additionalProperties, applicationMaintainerRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(member, team, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApplicationMaintainerRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationMaintainerRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationMaintainerRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApplicationMaintainerRep is not found in the empty JSON string", ApplicationMaintainerRep.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `member`
      if (jsonObj.get("member") != null && !jsonObj.get("member").isJsonNull()) {
        MemberSummary.validateJsonElement(jsonObj.get("member"));
      }
      // validate the optional field `team`
      if (jsonObj.get("team") != null && !jsonObj.get("team").isJsonNull()) {
        MemberTeamSummaryRep.validateJsonElement(jsonObj.get("team"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationMaintainerRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationMaintainerRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationMaintainerRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationMaintainerRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationMaintainerRep>() {
           @Override
           public void write(JsonWriter out, ApplicationMaintainerRep value) throws IOException {
           ...
           @Override
           public ApplicationMaintainerRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ApplicationMaintainerRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ApplicationMaintainerRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationMaintainerRep
   * @throws IOException if the JSON string is invalid with respect to ApplicationMaintainerRep
   */
  public static ApplicationMaintainerRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationMaintainerRep.class);
  }

  /**
   * Convert an instance of ApplicationMaintainerRep to an JSON string
   *
   * @return JSON string
   */
