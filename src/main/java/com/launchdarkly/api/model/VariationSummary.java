...
public class VariationSummary {
   ...
   * @return the VariationSummary instance itself
   */
  public VariationSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rules, variationSummary.rules) &&
        Objects.equals(this.nullRules, variationSummary.nullRules) &&
        Objects.equals(this.targets, variationSummary.targets) &&
        Objects.equals(this.contextTargets, variationSummary.contextTargets) &&
        Objects.equals(this.isFallthrough, variationSummary.isFallthrough) &&
        Objects.equals(this.isOff, variationSummary.isOff) &&
        Objects.equals(this.rollout, variationSummary.rollout) &&
        Objects.equals(this.bucketBy, variationSummary.bucketBy)&&
        Objects.equals(this.additionalProperties, variationSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rules, nullRules, targets, contextTargets, isFallthrough, isOff, rollout, bucketBy, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    nullRules: ").append(toIndentedString(nullRules)).append("\n");
    sb.append("    targets: ").append(toIndentedString(targets)).append("\n");
    sb.append("    contextTargets: ").append(toIndentedString(contextTargets)).append("\n");
    sb.append("    isFallthrough: ").append(toIndentedString(isFallthrough)).append("\n");
    sb.append("    isOff: ").append(toIndentedString(isOff)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariationSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariationSummary is not found in the empty JSON string", VariationSummary.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VariationSummary>() {
           ...
           public VariationSummary read(JsonReader in) throws IOException {
             ...
             VariationSummary instance = thisAdapter.fromJsonTree(jsonObj);
