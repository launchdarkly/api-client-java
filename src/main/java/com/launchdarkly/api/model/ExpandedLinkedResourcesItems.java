...
public class ExpandedLinkedResourcesItems {
   ...
   * @return the ExpandedLinkedResourcesItems instance itself
   */
  public ExpandedLinkedResourcesItems putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedLinkedResourcesItems.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedLinkedResourcesItems is not found in the empty JSON string", ExpandedLinkedResourcesItems.openapiRequiredFields.toString()));
        }
      }
      ...
      ExpandedLinkedResourcesFlags.validateJsonElement(jsonObj.get("flags"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedLinkedResourcesItems.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedLinkedResourcesItems' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedLinkedResourcesItems> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedLinkedResourcesItems.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedLinkedResourcesItems>() {
           @Override
           public void write(JsonWriter out, ExpandedLinkedResourcesItems value) throws IOException {
           ...
           @Override
           public ExpandedLinkedResourcesItems read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedLinkedResourcesItems instance = thisAdapter.fromJsonTree(jsonObj);
