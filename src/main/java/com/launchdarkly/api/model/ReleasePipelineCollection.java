...
public class ReleasePipelineCollection {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  @javax.annotation.Nonnull
  private List<ReleasePipeline> items = new ArrayList<>();
  ...
  public ReleasePipelineCollection items(@javax.annotation.Nonnull List<ReleasePipeline> items) {
    this.items = items;
    return this;
  }

  public ReleasePipelineCollection addItemsItem(ReleasePipeline itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<ReleasePipeline> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<ReleasePipeline> items) {
    this.items = items;
  }


  public ReleasePipelineCollection totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the ReleasePipelineCollection instance itself
   */
  public ReleasePipelineCollection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReleasePipelineCollection releasePipelineCollection = (ReleasePipelineCollection) o;
    return Objects.equals(this.items, releasePipelineCollection.items) &&
        Objects.equals(this.totalCount, releasePipelineCollection.totalCount)&&
        Objects.equals(this.additionalProperties, releasePipelineCollection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReleasePipelineCollection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReleasePipelineCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePipelineCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleasePipelineCollection is not found in the empty JSON string", ReleasePipelineCollection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReleasePipelineCollection.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ReleasePipeline.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleasePipelineCollection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleasePipelineCollection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleasePipelineCollection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleasePipelineCollection.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleasePipelineCollection>() {
           @Override
           public void write(JsonWriter out, ReleasePipelineCollection value) throws IOException {
           ...
           @Override
           public ReleasePipelineCollection read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReleasePipelineCollection instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ReleasePipelineCollection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReleasePipelineCollection
   * @throws IOException if the JSON string is invalid with respect to ReleasePipelineCollection
   */
  public static ReleasePipelineCollection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReleasePipelineCollection.class);
  }

  /**
   * Convert an instance of ReleasePipelineCollection to an JSON string
   *
   * @return JSON string
   */
