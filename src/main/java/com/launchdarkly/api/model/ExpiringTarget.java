...
public class ExpiringTarget {
  ...
  public ExpiringTarget id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ExpiringTarget version(@javax.annotation.Nonnull Integer version) {
  ...
  public ExpiringTarget expirationDate(@javax.annotation.Nonnull Long expirationDate) {
  ...
  public ExpiringTarget contextKind(@javax.annotation.Nonnull String contextKind) {
  ...
  public ExpiringTarget contextKey(@javax.annotation.Nonnull String contextKey) {
  ...
  public ExpiringTarget targetType(@javax.annotation.Nullable String targetType) {
  ...
  public ExpiringTarget variationId(@javax.annotation.Nullable String variationId) {
  ...
  public ExpiringTarget resourceId(@javax.annotation.Nonnull ResourceId resourceId) {
  ...
  public void setResourceId(@javax.annotation.Nonnull ResourceId resourceId) {
    this.resourceId = resourceId;
  }
   ...
   * @return the ExpiringTarget instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "_version", "expirationDate", "contextKind", "contextKey", "targetType", "variationId", "_resourceId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_id", "_version", "expirationDate", "contextKind", "contextKey", "_resourceId"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpiringTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpiringTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpiringTarget is not found in the empty JSON string", ExpiringTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("contextKind").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `contextKind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contextKind").toString()));
      }
      if (!jsonObj.get("contextKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `contextKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contextKey").toString()));
      }
      ...
      ResourceId.validateJsonElement(jsonObj.get("_resourceId"));
  }
