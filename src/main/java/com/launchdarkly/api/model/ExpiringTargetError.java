...
public class ExpiringTargetError {
   ...
   * @return the ExpiringTargetError instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpiringTargetError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpiringTargetError is not found in the empty JSON string", ExpiringTargetError.openapiRequiredFields.toString()));
        }
      }
