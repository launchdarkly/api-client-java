...
public class AnnouncementAccessAllowedReason {
  ...
  public AnnouncementAccessAllowedReason resources(@javax.annotation.Nullable List<String> resources) {
    this.resources = resources;
    return this;
  }

  public AnnouncementAccessAllowedReason addResourcesItem(String resourcesItem) {
  ...
  public AnnouncementAccessAllowedReason notResources(@javax.annotation.Nullable List<String> notResources) {
    this.notResources = notResources;
    return this;
  }

  public AnnouncementAccessAllowedReason addNotResourcesItem(String notResourcesItem) {
  ...
  public AnnouncementAccessAllowedReason actions(@javax.annotation.Nullable List<String> actions) {
    this.actions = actions;
    return this;
  }

  public AnnouncementAccessAllowedReason addActionsItem(String actionsItem) {
  ...
  public AnnouncementAccessAllowedReason notActions(@javax.annotation.Nullable List<String> notActions) {
    this.notActions = notActions;
    return this;
  }

  public AnnouncementAccessAllowedReason addNotActionsItem(String notActionsItem) {
  ...
  public AnnouncementAccessAllowedReason effect(@javax.annotation.Nonnull EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  public AnnouncementAccessAllowedReason roleName(@javax.annotation.Nullable String roleName) {
   ...
   * @return the AnnouncementAccessAllowedReason instance itself
   */
  public AnnouncementAccessAllowedReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnouncementAccessAllowedReason announcementAccessAllowedReason = (AnnouncementAccessAllowedReason) o;
    return Objects.equals(this.resources, announcementAccessAllowedReason.resources) &&
        Objects.equals(this.notResources, announcementAccessAllowedReason.notResources) &&
        Objects.equals(this.actions, announcementAccessAllowedReason.actions) &&
        Objects.equals(this.notActions, announcementAccessAllowedReason.notActions) &&
        Objects.equals(this.effect, announcementAccessAllowedReason.effect) &&
        Objects.equals(this.roleName, announcementAccessAllowedReason.roleName)&&
        Objects.equals(this.additionalProperties, announcementAccessAllowedReason.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnouncementAccessAllowedReason {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnnouncementAccessAllowedReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnouncementAccessAllowedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AnnouncementAccessAllowedReason is not found in the empty JSON string", AnnouncementAccessAllowedReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnnouncementAccessAllowedReason.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnouncementAccessAllowedReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnouncementAccessAllowedReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnouncementAccessAllowedReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnouncementAccessAllowedReason.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnouncementAccessAllowedReason>() {
           @Override
           public void write(JsonWriter out, AnnouncementAccessAllowedReason value) throws IOException {
           ...
           @Override
           public AnnouncementAccessAllowedReason read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AnnouncementAccessAllowedReason instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AnnouncementAccessAllowedReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnnouncementAccessAllowedReason
   * @throws IOException if the JSON string is invalid with respect to AnnouncementAccessAllowedReason
   */
  public static AnnouncementAccessAllowedReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnouncementAccessAllowedReason.class);
  }

  /**
   * Convert an instance of AnnouncementAccessAllowedReason to an JSON string
   *
   * @return JSON string
   */
