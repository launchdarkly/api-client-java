...
public class DeploymentRep {
   ...
   * @return the DeploymentRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeploymentRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeploymentRep is not found in the empty JSON string", DeploymentRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("applicationKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `applicationKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("applicationKey").toString()));
      }
      if (!jsonObj.get("applicationVersion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `applicationVersion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("applicationVersion").toString()));
      }
      ...
      if (jsonObj.get("pullRequests") != null && !jsonObj.get("pullRequests").isJsonNull()) {
        PullRequestCollectionRep.validateJsonElement(jsonObj.get("pullRequests"));
      }
      ...
      if (jsonObj.get("leadTimeStages") != null && !jsonObj.get("leadTimeStages").isJsonNull()) {
        LeadTimeStagesRep.validateJsonElement(jsonObj.get("leadTimeStages"));
      }
  }
