...
public class TreatmentRep {
  ...
  @javax.annotation.Nullable
  private List<ParameterRep> parameters = new ArrayList<>();

  public TreatmentRep() {
  }

  public TreatmentRep id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public TreatmentRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TreatmentRep allocationPercent(@javax.annotation.Nonnull String allocationPercent) {
  ...
  public TreatmentRep baseline(@javax.annotation.Nullable Boolean baseline) {
  ...
  public void setBaseline(@javax.annotation.Nullable Boolean baseline) {
    this.baseline = baseline;
  }


  public TreatmentRep parameters(@javax.annotation.Nullable List<ParameterRep> parameters) {
    this.parameters = parameters;
    return this;
  }

  public TreatmentRep addParametersItem(ParameterRep parametersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ParameterRep> getParameters() {
    return parameters;
  }

  public void setParameters(@javax.annotation.Nullable List<ParameterRep> parameters) {
    this.parameters = parameters;
  }
   ...
   * @return the TreatmentRep instance itself
   */
  public TreatmentRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TreatmentRep treatmentRep = (TreatmentRep) o;
    return Objects.equals(this.id, treatmentRep.id) &&
        Objects.equals(this.name, treatmentRep.name) &&
        Objects.equals(this.allocationPercent, treatmentRep.allocationPercent) &&
        Objects.equals(this.baseline, treatmentRep.baseline) &&
        Objects.equals(this.parameters, treatmentRep.parameters)&&
        Objects.equals(this.additionalProperties, treatmentRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, allocationPercent, baseline, parameters, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TreatmentRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "name", "allocationPercent", "baseline", "parameters"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "allocationPercent"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TreatmentRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TreatmentRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TreatmentRep is not found in the empty JSON string", TreatmentRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TreatmentRep.openapiRequiredFields) {
      ...
      if (!jsonObj.get("allocationPercent").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `allocationPercent` to be a primitive type in the JSON string but got `%s`", jsonObj.get("allocationPercent").toString()));
      }
      if (jsonObj.get("parameters") != null && !jsonObj.get("parameters").isJsonNull()) {
        ...
        if (jsonArrayparameters != null) {
          ...
          for (int i = 0; i < jsonArrayparameters.size(); i++) {
            ParameterRep.validateJsonElement(jsonArrayparameters.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TreatmentRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TreatmentRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TreatmentRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TreatmentRep.class));

       return (TypeAdapter<T>) new TypeAdapter<TreatmentRep>() {
           @Override
           public void write(JsonWriter out, TreatmentRep value) throws IOException {
           ...
           @Override
           public TreatmentRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TreatmentRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TreatmentRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TreatmentRep
   * @throws IOException if the JSON string is invalid with respect to TreatmentRep
   */
  public static TreatmentRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TreatmentRep.class);
  }

  /**
   * Convert an instance of TreatmentRep to an JSON string
   *
   * @return JSON string
   */
