...
public class ExpandedLinkedFlags {
  ...
  public ExpandedLinkedFlags items(@javax.annotation.Nonnull List<ExpandedFlag> items) {
    this.items = items;
    return this;
  }

  public ExpandedLinkedFlags addItemsItem(ExpandedFlag itemsItem) {
    if (this.items == null) {
  ...
  public ExpandedLinkedFlags totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the ExpandedLinkedFlags instance itself
   */
  public ExpandedLinkedFlags putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedLinkedFlags expandedLinkedFlags = (ExpandedLinkedFlags) o;
    return Objects.equals(this.items, expandedLinkedFlags.items) &&
        Objects.equals(this.totalCount, expandedLinkedFlags.totalCount)&&
        Objects.equals(this.additionalProperties, expandedLinkedFlags.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpandedLinkedFlags {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpandedLinkedFlags
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedLinkedFlags.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedLinkedFlags is not found in the empty JSON string", ExpandedLinkedFlags.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExpandedLinkedFlags.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedLinkedFlags.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedLinkedFlags' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedLinkedFlags> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedLinkedFlags.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedLinkedFlags>() {
           @Override
           public void write(JsonWriter out, ExpandedLinkedFlags value) throws IOException {
           ...
           @Override
           public ExpandedLinkedFlags read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedLinkedFlags instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExpandedLinkedFlags given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpandedLinkedFlags
   * @throws IOException if the JSON string is invalid with respect to ExpandedLinkedFlags
   */
  public static ExpandedLinkedFlags fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandedLinkedFlags.class);
  }

  /**
   * Convert an instance of ExpandedLinkedFlags to an JSON string
   *
   * @return JSON string
   */
