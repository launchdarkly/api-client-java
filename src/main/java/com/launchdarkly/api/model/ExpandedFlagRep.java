...
public class ExpandedFlagRep {
  ...
  public ExpandedFlagRep addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public ExpandedFlagRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public ExpandedFlagRep putCustomPropertiesItem(String key, CustomProperty customPropertiesItem) {
   ...
   * @return the ExpandedFlagRep instance itself
   */
  public ExpandedFlagRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedFlagRep expandedFlagRep = (ExpandedFlagRep) o;
    return Objects.equals(this.name, expandedFlagRep.name) &&
        Objects.equals(this.kind, expandedFlagRep.kind) &&
        Objects.equals(this.description, expandedFlagRep.description) &&
        Objects.equals(this.key, expandedFlagRep.key) &&
        Objects.equals(this.version, expandedFlagRep.version) &&
        Objects.equals(this.creationDate, expandedFlagRep.creationDate) &&
        Objects.equals(this.includeInSnippet, expandedFlagRep.includeInSnippet) &&
        Objects.equals(this.clientSideAvailability, expandedFlagRep.clientSideAvailability) &&
        Objects.equals(this.variations, expandedFlagRep.variations) &&
        Objects.equals(this.temporary, expandedFlagRep.temporary) &&
        Objects.equals(this.tags, expandedFlagRep.tags) &&
        Objects.equals(this.links, expandedFlagRep.links) &&
        Objects.equals(this.maintainerId, expandedFlagRep.maintainerId) &&
        Objects.equals(this.maintainer, expandedFlagRep.maintainer) &&
        Objects.equals(this.customProperties, expandedFlagRep.customProperties) &&
        Objects.equals(this.archived, expandedFlagRep.archived) &&
        Objects.equals(this.archivedDate, expandedFlagRep.archivedDate) &&
        Objects.equals(this.defaults, expandedFlagRep.defaults)&&
        Objects.equals(this.additionalProperties, expandedFlagRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, kind, description, key, version, creationDate, includeInSnippet, clientSideAvailability, variations, temporary, tags, links, maintainerId, maintainer, customProperties, archived, archivedDate, defaults, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedFlagRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedFlagRep is not found in the empty JSON string", ExpandedFlagRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("clientSideAvailability") != null && !jsonObj.get("clientSideAvailability").isJsonNull()) {
        ClientSideAvailability.validateJsonElement(jsonObj.get("clientSideAvailability"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedFlagRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedFlagRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedFlagRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedFlagRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedFlagRep>() {
           @Override
           public void write(JsonWriter out, ExpandedFlagRep value) throws IOException {
           ...
           @Override
           public ExpandedFlagRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedFlagRep instance = thisAdapter.fromJsonTree(jsonObj);
