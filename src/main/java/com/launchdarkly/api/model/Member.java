...
public class Member {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, firstName, lastName, role, email, pendingInvite, verified, pendingEmail, customRoles, mfa, excludedDashboards, lastSeen, lastSeenMetadata, integrationMetadata, teams, permissionGrants, creationDate, oauthProviders, version, roleAttributes, additionalProperties);
  }
