...
public class Member {
  ...
  public static final String SERIALIZED_NAME_MFA_GRACE_PERIOD_EXPIRES_AT = "mfaGracePeriodExpiresAt";
  @SerializedName(SERIALIZED_NAME_MFA_GRACE_PERIOD_EXPIRES_AT)
  @javax.annotation.Nullable
  private Long mfaGracePeriodExpiresAt;
  ...
  public Member hasPassword(@javax.annotation.Nullable Boolean hasPassword) {
  ...
  public Member mfaEnforced(@javax.annotation.Nullable Boolean mfaEnforced) {
  ...
  public void setMfaEnforced(@javax.annotation.Nullable Boolean mfaEnforced) {
    this.mfaEnforced = mfaEnforced;
  }


  public Member mfaGracePeriodExpiresAt(@javax.annotation.Nullable Long mfaGracePeriodExpiresAt) {
    this.mfaGracePeriodExpiresAt = mfaGracePeriodExpiresAt;
    return this;
  }

  /**
   * Get mfaGracePeriodExpiresAt
   * @return mfaGracePeriodExpiresAt
   */
  @javax.annotation.Nullable
  public Long getMfaGracePeriodExpiresAt() {
    return mfaGracePeriodExpiresAt;
  }

  public void setMfaGracePeriodExpiresAt(@javax.annotation.Nullable Long mfaGracePeriodExpiresAt) {
    this.mfaGracePeriodExpiresAt = mfaGracePeriodExpiresAt;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, member.links) &&
        ...
        Objects.equals(this.pendingEmail, member.pendingEmail) &&
        Objects.equals(this.customRoles, member.customRoles) &&
        Objects.equals(this.mfa, member.mfa) &&
        Objects.equals(this.excludedDashboards, member.excludedDashboards) &&
        ...
        Objects.equals(this.oauthProviders, member.oauthProviders) &&
        Objects.equals(this.hasPassword, member.hasPassword) &&
        Objects.equals(this.version, member.version) &&
        Objects.equals(this.roleAttributes, member.roleAttributes) &&
        Objects.equals(this.mfaEnforced, member.mfaEnforced) &&
        Objects.equals(this.mfaGracePeriodExpiresAt, member.mfaGracePeriodExpiresAt)&&
        Objects.equals(this.additionalProperties, member.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, id, firstName, lastName, role, email, pendingInvite, verified, pendingEmail, customRoles, mfa, excludedDashboards, lastSeen, lastSeenMetadata, integrationMetadata, teams, permissionGrants, creationDate, oauthProviders, hasPassword, version, roleAttributes, mfaEnforced, mfaGracePeriodExpiresAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    excludedDashboards: ").append(toIndentedString(excludedDashboards)).append("\n");
    ...
    sb.append("    mfaGracePeriodExpiresAt: ").append(toIndentedString(mfaGracePeriodExpiresAt)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "_id", "firstName", "lastName", "role", "email", "_pendingInvite", "_verified", "_pendingEmail", "customRoles", "mfa", "excludedDashboards", "_lastSeen", "_lastSeenMetadata", "_integrationMetadata", "teams", "permissionGrants", "creationDate", "oauthProviders", "hasPassword", "version", "roleAttributes", "mfaEnforced", "mfaGracePeriodExpiresAt"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("_pendingEmail") != null && !jsonObj.get("_pendingEmail").isJsonNull()) && !jsonObj.get("_pendingEmail").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_pendingEmail` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_pendingEmail").toString()));
      }
      // ensure the required json array is present
      if (jsonObj.get("customRoles") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("customRoles").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `customRoles` to be an array in the JSON string but got `%s`", jsonObj.get("customRoles").toString()));
      }
      if (!jsonObj.get("mfa").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mfa` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mfa").toString()));
      }
      ...
      if (jsonObj.get("excludedDashboards") != null && !jsonObj.get("excludedDashboards").isJsonNull() && !jsonObj.get("excludedDashboards").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `excludedDashboards` to be an array in the JSON string but got `%s`", jsonObj.get("excludedDashboards").toString()));
      }
      ...
      if (jsonObj.get("_lastSeenMetadata") != null && !jsonObj.get("_lastSeenMetadata").isJsonNull()) {
        LastSeenMetadata.validateJsonElement(jsonObj.get("_lastSeenMetadata"));
      }
      // validate the optional field `_integrationMetadata`
      if (jsonObj.get("_integrationMetadata") != null && !jsonObj.get("_integrationMetadata").isJsonNull()) {
        IntegrationMetadata.validateJsonElement(jsonObj.get("_integrationMetadata"));
      }
      ...
      if (jsonObj.get("permissionGrants") != null && !jsonObj.get("permissionGrants").isJsonNull()) {
        ...
        if (jsonArraypermissionGrants != null) {
          ...
          if (!jsonObj.get("permissionGrants").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `permissionGrants` to be an array in the JSON string but got `%s`", jsonObj.get("permissionGrants").toString()));
          }
      ...
      if (jsonObj.get("oauthProviders") != null && !jsonObj.get("oauthProviders").isJsonNull() && !jsonObj.get("oauthProviders").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oauthProviders` to be an array in the JSON string but got `%s`", jsonObj.get("oauthProviders").toString()));
      }
  }
