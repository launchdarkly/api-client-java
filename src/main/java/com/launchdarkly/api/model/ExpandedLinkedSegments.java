...
public class ExpandedLinkedSegments {
  ...
  public ExpandedLinkedSegments items(@javax.annotation.Nonnull List<ExpandedSegment> items) {
    this.items = items;
    return this;
  }

  public ExpandedLinkedSegments addItemsItem(ExpandedSegment itemsItem) {
    if (this.items == null) {
  ...
  public ExpandedLinkedSegments totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the ExpandedLinkedSegments instance itself
   */
  public ExpandedLinkedSegments putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedLinkedSegments expandedLinkedSegments = (ExpandedLinkedSegments) o;
    return Objects.equals(this.items, expandedLinkedSegments.items) &&
        Objects.equals(this.totalCount, expandedLinkedSegments.totalCount)&&
        Objects.equals(this.additionalProperties, expandedLinkedSegments.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpandedLinkedSegments {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpandedLinkedSegments
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedLinkedSegments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedLinkedSegments is not found in the empty JSON string", ExpandedLinkedSegments.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExpandedLinkedSegments.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedLinkedSegments.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedLinkedSegments' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedLinkedSegments> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedLinkedSegments.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedLinkedSegments>() {
           @Override
           public void write(JsonWriter out, ExpandedLinkedSegments value) throws IOException {
           ...
           @Override
           public ExpandedLinkedSegments read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedLinkedSegments instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExpandedLinkedSegments given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpandedLinkedSegments
   * @throws IOException if the JSON string is invalid with respect to ExpandedLinkedSegments
   */
  public static ExpandedLinkedSegments fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandedLinkedSegments.class);
  }

  /**
   * Convert an instance of ExpandedLinkedSegments to an JSON string
   *
   * @return JSON string
   */
