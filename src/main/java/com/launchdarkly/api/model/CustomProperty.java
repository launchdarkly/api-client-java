...
public class CustomProperty {
  ...
  public CustomProperty name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CustomProperty value(@javax.annotation.Nonnull List<String> value) {
    this.value = value;
    return this;
  }
   ...
   * @return the CustomProperty instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomProperty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomProperty is not found in the empty JSON string", CustomProperty.openapiRequiredFields.toString()));
        }
      }
