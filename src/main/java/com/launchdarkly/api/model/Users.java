...
public class Users {
  ...
  public Users links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public Users totalCount(@javax.annotation.Nonnull Integer totalCount) {
  ...
  public Users items(@javax.annotation.Nonnull List<UserRecord> items) {
    this.items = items;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Users.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Users is not found in the empty JSON string", Users.openapiRequiredFields.toString()));
        }
      }
