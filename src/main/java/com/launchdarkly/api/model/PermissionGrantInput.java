...
public class PermissionGrantInput {
  ...
  public enum ActionSetEnum {
    ...
    public static class Adapter extends TypeAdapter<ActionSetEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ActionSetEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ActionSetEnum read(final JsonReader jsonReader) throws IOException {
   ...
   * @return the PermissionGrantInput instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionSet, permissionGrantInput.actionSet) &&
        Objects.equals(this.actions, permissionGrantInput.actions) &&
        Objects.equals(this.memberIDs, permissionGrantInput.memberIDs)&&
        Objects.equals(this.additionalProperties, permissionGrantInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionSet, actions, memberIDs, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PermissionGrantInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PermissionGrantInput is not found in the empty JSON string", PermissionGrantInput.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("actionSet") != null && !jsonObj.get("actionSet").isJsonNull()) && !jsonObj.get("actionSet").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `actionSet` to be a primitive type in the JSON string but got `%s`", jsonObj.get("actionSet").toString()));
      }
      // validate the optional field `actionSet`
      if (jsonObj.get("actionSet") != null && !jsonObj.get("actionSet").isJsonNull()) {
        ActionSetEnum.validateJsonElement(jsonObj.get("actionSet"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PermissionGrantInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PermissionGrantInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PermissionGrantInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PermissionGrantInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PermissionGrantInput>() {
           @Override
           ...
           public PermissionGrantInput read(JsonReader in) throws IOException {
             ...
             PermissionGrantInput instance = thisAdapter.fromJsonTree(jsonObj);
