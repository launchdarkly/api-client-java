...
public class ExpandedMetric {
   ...
   * @return the ExpandedMetric instance itself
   */
  public ExpandedMetric putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedMetric expandedMetric = (ExpandedMetric) o;
    return Objects.equals(this.key, expandedMetric.key) &&
        Objects.equals(this.name, expandedMetric.name) &&
        Objects.equals(this.creationDate, expandedMetric.creationDate) &&
        Objects.equals(this.lastModified, expandedMetric.lastModified) &&
        Objects.equals(this.isActive, expandedMetric.isActive) &&
        Objects.equals(this.eventKey, expandedMetric.eventKey) &&
        Objects.equals(this.id, expandedMetric.id) &&
        Objects.equals(this.versionId, expandedMetric.versionId) &&
        Objects.equals(this.kind, expandedMetric.kind) &&
        Objects.equals(this.category, expandedMetric.category) &&
        Objects.equals(this.description, expandedMetric.description) &&
        Objects.equals(this.isNumeric, expandedMetric.isNumeric) &&
        Objects.equals(this.lastSeen, expandedMetric.lastSeen) &&
        Objects.equals(this.links, expandedMetric.links)&&
        Objects.equals(this.additionalProperties, expandedMetric.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, creationDate, lastModified, isActive, eventKey, id, versionId, kind, category, description, isNumeric, lastSeen, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExpandedMetric {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedMetric.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedMetric is not found in the empty JSON string", ExpandedMetric.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedMetric.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedMetric' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedMetric> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedMetric.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedMetric>() {
           @Override
           public void write(JsonWriter out, ExpandedMetric value) throws IOException {
           ...
           @Override
           public ExpandedMetric read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedMetric instance = thisAdapter.fromJsonTree(jsonObj);
