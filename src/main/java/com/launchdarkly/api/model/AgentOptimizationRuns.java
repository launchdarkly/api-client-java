...
import com.launchdarkly.api.model.AgentOptimizationRun;
...
public class AgentOptimizationRuns {
  ...
  private List<AgentOptimizationRun> items = new ArrayList<>();
  ...
  public AgentOptimizationRuns links(@javax.annotation.Nullable PaginatedLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AgentOptimizationRuns items(@javax.annotation.Nonnull List<AgentOptimizationRun> items) {
    this.items = items;
    return this;
  }

  public AgentOptimizationRuns addItemsItem(AgentOptimizationRun itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<AgentOptimizationRun> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<AgentOptimizationRun> items) {
    this.items = items;
  }


  public AgentOptimizationRuns totalCount(@javax.annotation.Nullable Integer totalCount) {
   ...
   * @return the AgentOptimizationRuns instance itself
   */
  public AgentOptimizationRuns putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AgentOptimizationRuns agentOptimizationRuns = (AgentOptimizationRuns) o;
    return Objects.equals(this.links, agentOptimizationRuns.links) &&
        Objects.equals(this.items, agentOptimizationRuns.items) &&
        Objects.equals(this.totalCount, agentOptimizationRuns.totalCount)&&
        Objects.equals(this.additionalProperties, agentOptimizationRuns.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AgentOptimizationRuns {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentOptimizationRuns
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentOptimizationRuns.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentOptimizationRuns is not found in the empty JSON string", AgentOptimizationRuns.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentOptimizationRuns.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        AgentOptimizationRun.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentOptimizationRuns.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentOptimizationRuns' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentOptimizationRuns> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentOptimizationRuns.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentOptimizationRuns>() {
           @Override
           public void write(JsonWriter out, AgentOptimizationRuns value) throws IOException {
           ...
           @Override
           public AgentOptimizationRuns read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentOptimizationRuns instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentOptimizationRuns given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentOptimizationRuns
   * @throws IOException if the JSON string is invalid with respect to AgentOptimizationRuns
   */
  public static AgentOptimizationRuns fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentOptimizationRuns.class);
  }

  /**
   * Convert an instance of AgentOptimizationRuns to an JSON string
   *
   * @return JSON string
   */
