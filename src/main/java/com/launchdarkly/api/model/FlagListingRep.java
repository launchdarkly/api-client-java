...
public class FlagListingRep {
  ...
  public FlagListingRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public FlagListingRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public FlagListingRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public FlagListingRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public FlagListingRep site(@javax.annotation.Nullable Link site) {
    this.site = site;
    return this;
  }
   ...
   * @return the FlagListingRep instance itself
   */
  public FlagListingRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagListingRep flagListingRep = (FlagListingRep) o;
    return Objects.equals(this.name, flagListingRep.name) &&
        Objects.equals(this.key, flagListingRep.key) &&
        Objects.equals(this.links, flagListingRep.links) &&
        Objects.equals(this.site, flagListingRep.site)&&
        Objects.equals(this.additionalProperties, flagListingRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, key, links, site, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagListingRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "key", "_links", "_site"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagListingRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagListingRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagListingRep is not found in the empty JSON string", FlagListingRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlagListingRep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagListingRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagListingRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagListingRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagListingRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagListingRep>() {
           @Override
           public void write(JsonWriter out, FlagListingRep value) throws IOException {
           ...
           @Override
           public FlagListingRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagListingRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FlagListingRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlagListingRep
   * @throws IOException if the JSON string is invalid with respect to FlagListingRep
   */
  public static FlagListingRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlagListingRep.class);
  }

  /**
   * Convert an instance of FlagListingRep to an JSON string
   *
   * @return JSON string
   */
