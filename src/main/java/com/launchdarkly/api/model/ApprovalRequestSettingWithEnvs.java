...
import com.launchdarkly.api.model.ApprovalRequestSetting;
...
public class ApprovalRequestSettingWithEnvs {
  ...
  public ApprovalRequestSettingWithEnvs putEnvironmentsItem(String key, ApprovalRequestSetting environmentsItem) {
   ...
   * @return the ApprovalRequestSettingWithEnvs instance itself
   */
  public ApprovalRequestSettingWithEnvs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApprovalRequestSettingWithEnvs approvalRequestSettingWithEnvs = (ApprovalRequestSettingWithEnvs) o;
    return Objects.equals(this.environments, approvalRequestSettingWithEnvs.environments) &&
        Objects.equals(this._default, approvalRequestSettingWithEnvs._default) &&
        Objects.equals(this.strict, approvalRequestSettingWithEnvs.strict)&&
        Objects.equals(this.additionalProperties, approvalRequestSettingWithEnvs.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(environments, _default, strict, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApprovalRequestSettingWithEnvs {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRequestSettingWithEnvs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApprovalRequestSettingWithEnvs is not found in the empty JSON string", ApprovalRequestSettingWithEnvs.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `_default`
      if (jsonObj.get("_default") != null && !jsonObj.get("_default").isJsonNull()) {
        ApprovalRequestSetting.validateJsonElement(jsonObj.get("_default"));
      }
      // validate the optional field `_strict`
      if (jsonObj.get("_strict") != null && !jsonObj.get("_strict").isJsonNull()) {
        ApprovalRequestSetting.validateJsonElement(jsonObj.get("_strict"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalRequestSettingWithEnvs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalRequestSettingWithEnvs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalRequestSettingWithEnvs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalRequestSettingWithEnvs.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalRequestSettingWithEnvs>() {
           @Override
           public void write(JsonWriter out, ApprovalRequestSettingWithEnvs value) throws IOException {
           ...
           @Override
           public ApprovalRequestSettingWithEnvs read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ApprovalRequestSettingWithEnvs instance = thisAdapter.fromJsonTree(jsonObj);
