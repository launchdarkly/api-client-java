...
public class Release {
   ...
   * @return the Release instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("releasePipelineDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `releasePipelineDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("releasePipelineDescription").toString()));
      }
      ...
      if ((jsonObj.get("_releaseVariationId") != null && !jsonObj.get("_releaseVariationId").isJsonNull()) && !jsonObj.get("_releaseVariationId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_releaseVariationId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_releaseVariationId").toString()));
      }
  }
