...
public class CreateApprovalRequestRequest {
   ...
   * @return the CreateApprovalRequestRequest instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceId, createApprovalRequestRequest.resourceId) &&
        Objects.equals(this.comment, createApprovalRequestRequest.comment) &&
        Objects.equals(this.description, createApprovalRequestRequest.description) &&
        Objects.equals(this.instructions, createApprovalRequestRequest.instructions) &&
        Objects.equals(this.notifyMemberIds, createApprovalRequestRequest.notifyMemberIds) &&
        Objects.equals(this.notifyTeamKeys, createApprovalRequestRequest.notifyTeamKeys) &&
        Objects.equals(this.integrationConfig, createApprovalRequestRequest.integrationConfig)&&
        Objects.equals(this.additionalProperties, createApprovalRequestRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceId, comment, description, instructions, notifyMemberIds, notifyTeamKeys, integrationConfig, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateApprovalRequestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateApprovalRequestRequest is not found in the empty JSON string", CreateApprovalRequestRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateApprovalRequestRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateApprovalRequestRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateApprovalRequestRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateApprovalRequestRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateApprovalRequestRequest>() {
           @Override
           ...
           public CreateApprovalRequestRequest read(JsonReader in) throws IOException {
             ...
             CreateApprovalRequestRequest instance = thisAdapter.fromJsonTree(jsonObj);
