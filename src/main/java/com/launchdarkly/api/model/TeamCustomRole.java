...
public class TeamCustomRole {
  ...
  public TeamCustomRole key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TeamCustomRole name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TeamCustomRole projects(@javax.annotation.Nullable TeamProjects projects) {
  ...
  public TeamCustomRole appliedOn(@javax.annotation.Nullable Long appliedOn) {
  ...
  public void setAppliedOn(@javax.annotation.Nullable Long appliedOn) {
    this.appliedOn = appliedOn;
  }
   ...
   * @return the TeamCustomRole instance itself
   */
  public TeamCustomRole putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TeamCustomRole teamCustomRole = (TeamCustomRole) o;
    return Objects.equals(this.key, teamCustomRole.key) &&
        Objects.equals(this.name, teamCustomRole.name) &&
        Objects.equals(this.projects, teamCustomRole.projects) &&
        Objects.equals(this.appliedOn, teamCustomRole.appliedOn)&&
        Objects.equals(this.additionalProperties, teamCustomRole.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, projects, appliedOn, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TeamCustomRole {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "projects", "appliedOn"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamCustomRole
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamCustomRole.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TeamCustomRole is not found in the empty JSON string", TeamCustomRole.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("projects") != null && !jsonObj.get("projects").isJsonNull()) {
        TeamProjects.validateJsonElement(jsonObj.get("projects"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamCustomRole.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamCustomRole' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamCustomRole> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamCustomRole.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamCustomRole>() {
           @Override
           public void write(JsonWriter out, TeamCustomRole value) throws IOException {
           ...
           @Override
           public TeamCustomRole read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TeamCustomRole instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TeamCustomRole given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TeamCustomRole
   * @throws IOException if the JSON string is invalid with respect to TeamCustomRole
   */
  public static TeamCustomRole fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamCustomRole.class);
  }

  /**
   * Convert an instance of TeamCustomRole to an JSON string
   *
   * @return JSON string
   */
