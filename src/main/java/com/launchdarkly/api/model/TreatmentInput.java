...
public class TreatmentInput {
   ...
   * @return the TreatmentInput instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, treatmentInput.name) &&
        Objects.equals(this.baseline, treatmentInput.baseline) &&
        Objects.equals(this.allocationPercent, treatmentInput.allocationPercent) &&
        Objects.equals(this.parameters, treatmentInput.parameters)&&
        Objects.equals(this.additionalProperties, treatmentInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, baseline, allocationPercent, parameters, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TreatmentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TreatmentInput is not found in the empty JSON string", TreatmentInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayparameters.size(); i++) {
        TreatmentParameterInput.validateJsonElement(jsonArrayparameters.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TreatmentInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TreatmentInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TreatmentInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TreatmentInput.class));

       return (TypeAdapter<T>) new TypeAdapter<TreatmentInput>() {
           @Override
           ...
           public TreatmentInput read(JsonReader in) throws IOException {
             ...
             TreatmentInput instance = thisAdapter.fromJsonTree(jsonObj);
