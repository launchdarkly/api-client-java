...
public class AiConfigsFilter {
  ...
  public AiConfigsFilter type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AiConfigsFilter attribute(@javax.annotation.Nullable String attribute) {
  ...
  public AiConfigsFilter op(@javax.annotation.Nonnull String op) {
    this.op = op;
    return this;
  }
  ...
  public AiConfigsFilter values(@javax.annotation.Nonnull List<Object> values) {
    this.values = values;
    return this;
  }

  public AiConfigsFilter addValuesItem(Object valuesItem) {
    if (this.values == null) {
  ...
  public AiConfigsFilter contextKind(@javax.annotation.Nullable String contextKind) {
  ...
  public AiConfigsFilter negate(@javax.annotation.Nonnull Boolean negate) {
    this.negate = negate;
    return this;
  }
   ...
   * @return the AiConfigsFilter instance itself
   */
  public AiConfigsFilter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiConfigsFilter aiConfigsFilter = (AiConfigsFilter) o;
    return Objects.equals(this.type, aiConfigsFilter.type) &&
        Objects.equals(this.attribute, aiConfigsFilter.attribute) &&
        Objects.equals(this.op, aiConfigsFilter.op) &&
        Objects.equals(this.values, aiConfigsFilter.values) &&
        Objects.equals(this.contextKind, aiConfigsFilter.contextKind) &&
        Objects.equals(this.negate, aiConfigsFilter.negate)&&
        Objects.equals(this.additionalProperties, aiConfigsFilter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, attribute, op, values, contextKind, negate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AiConfigsFilter {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "attribute", "op", "values", "contextKind", "negate"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "op", "values", "negate"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiConfigsFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiConfigsFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiConfigsFilter is not found in the empty JSON string", AiConfigsFilter.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AiConfigsFilter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiConfigsFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiConfigsFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiConfigsFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiConfigsFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<AiConfigsFilter>() {
           @Override
           public void write(JsonWriter out, AiConfigsFilter value) throws IOException {
           ...
           @Override
           public AiConfigsFilter read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiConfigsFilter instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AiConfigsFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AiConfigsFilter
   * @throws IOException if the JSON string is invalid with respect to AiConfigsFilter
   */
  public static AiConfigsFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiConfigsFilter.class);
  }

  /**
   * Convert an instance of AiConfigsFilter to an JSON string
   *
   * @return JSON string
   */
