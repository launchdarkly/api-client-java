...
public class AiConfigsFilter {
  ...
  public AiConfigsFilter type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public AiConfigsFilter attribute(String attribute) {
  ...
  **/
  ...
  public AiConfigsFilter op(String op) {
    this.op = op;
    return this;
  }
  ...
  **/
  ...
  public AiConfigsFilter values(List<Object> values) {
    this.values = values;
    return this;
  }
  ...
  **/
  ...
  public AiConfigsFilter contextKind(String contextKind) {
  ...
  **/
  ...
  public AiConfigsFilter negate(Boolean negate) {
    this.negate = negate;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiConfigsFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AiConfigsFilter is not found in the empty JSON string", AiConfigsFilter.openapiRequiredFields.toString()));
        }
      }
