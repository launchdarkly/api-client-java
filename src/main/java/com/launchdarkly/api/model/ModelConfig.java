...
public class ModelConfig {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(access, name, key, id, icon, provider, global, params, customParams, tags, version, costPerInputToken, costPerOutputToken, isRestricted, additionalProperties);
  }
