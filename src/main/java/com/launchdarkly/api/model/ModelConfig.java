...
public class ModelConfig {
  ...
  public ModelConfig costPerCachedInputToken(@javax.annotation.Nullable Double costPerCachedInputToken) {
   ...
   * @return the ModelConfig instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.access, modelConfig.access) &&
        Objects.equals(this.name, modelConfig.name) &&
        Objects.equals(this.key, modelConfig.key) &&
        Objects.equals(this.id, modelConfig.id) &&
        Objects.equals(this.icon, modelConfig.icon) &&
        Objects.equals(this.provider, modelConfig.provider) &&
        Objects.equals(this.global, modelConfig.global) &&
        Objects.equals(this.params, modelConfig.params) &&
        Objects.equals(this.customParams, modelConfig.customParams) &&
        Objects.equals(this.tags, modelConfig.tags) &&
        Objects.equals(this.version, modelConfig.version) &&
        Objects.equals(this.costPerInputToken, modelConfig.costPerInputToken) &&
        Objects.equals(this.costPerOutputToken, modelConfig.costPerOutputToken) &&
        Objects.equals(this.costPerCachedInputToken, modelConfig.costPerCachedInputToken) &&
        Objects.equals(this.isRestricted, modelConfig.isRestricted)&&
        Objects.equals(this.additionalProperties, modelConfig.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(access, name, key, id, icon, provider, global, params, customParams, tags, version, costPerInputToken, costPerOutputToken, costPerCachedInputToken, isRestricted, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_access", "name", "key", "id", "icon", "provider", "global", "params", "customParams", "tags", "version", "costPerInputToken", "costPerOutputToken", "costPerCachedInputToken", "isRestricted"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ModelConfig>() {
           ...
           public ModelConfig read(JsonReader in) throws IOException {
             ...
             ModelConfig instance = thisAdapter.fromJsonTree(jsonObj);
