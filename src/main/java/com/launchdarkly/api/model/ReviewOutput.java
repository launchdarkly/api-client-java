...
public class ReviewOutput {
  ...
  public ReviewOutput id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ReviewOutput kind(@javax.annotation.Nonnull String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ReviewOutput creationDate(@javax.annotation.Nullable Long creationDate) {
  ...
  public ReviewOutput comment(@javax.annotation.Nullable String comment) {
  ...
  public ReviewOutput memberId(@javax.annotation.Nullable String memberId) {
  ...
  public ReviewOutput serviceTokenId(@javax.annotation.Nullable String serviceTokenId) {
   ...
   * @return the ReviewOutput instance itself
   */
  public ReviewOutput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReviewOutput reviewOutput = (ReviewOutput) o;
    return Objects.equals(this.id, reviewOutput.id) &&
        Objects.equals(this.kind, reviewOutput.kind) &&
        Objects.equals(this.creationDate, reviewOutput.creationDate) &&
        Objects.equals(this.comment, reviewOutput.comment) &&
        Objects.equals(this.memberId, reviewOutput.memberId) &&
        Objects.equals(this.serviceTokenId, reviewOutput.serviceTokenId)&&
        Objects.equals(this.additionalProperties, reviewOutput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, kind, creationDate, comment, memberId, serviceTokenId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReviewOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReviewOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReviewOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReviewOutput is not found in the empty JSON string", ReviewOutput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReviewOutput.openapiRequiredFields) {
      ...
      if ((jsonObj.get("serviceTokenId") != null && !jsonObj.get("serviceTokenId").isJsonNull()) && !jsonObj.get("serviceTokenId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `serviceTokenId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("serviceTokenId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReviewOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReviewOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReviewOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReviewOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ReviewOutput>() {
           @Override
           public void write(JsonWriter out, ReviewOutput value) throws IOException {
           ...
           @Override
           public ReviewOutput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReviewOutput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ReviewOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReviewOutput
   * @throws IOException if the JSON string is invalid with respect to ReviewOutput
   */
  public static ReviewOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReviewOutput.class);
  }

  /**
   * Convert an instance of ReviewOutput to an JSON string
   *
   * @return JSON string
   */
