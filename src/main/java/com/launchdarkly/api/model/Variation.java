...
public class Variation {
  ...
  public Variation id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Variation value(@javax.annotation.Nullable Object value) {
    this.value = value;
    return this;
  }
  ...
  public Variation valueHash(@javax.annotation.Nullable String valueHash) {
  ...
  public void setValueHash(@javax.annotation.Nullable String valueHash) {
    this.valueHash = valueHash;
  }


  public Variation description(@javax.annotation.Nullable String description) {
  ...
  public Variation name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the Variation instance itself
   */
  public Variation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, variation.id) &&
        ...
        Objects.equals(this.valueHash, variation.valueHash) &&
        Objects.equals(this.description, variation.description) &&
        Objects.equals(this.name, variation.name)&&
        Objects.equals(this.additionalProperties, variation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, value, valueHash, description, name, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "value", "valueHash", "description", "name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Variation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Variation is not found in the empty JSON string", Variation.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("valueHash") != null && !jsonObj.get("valueHash").isJsonNull()) && !jsonObj.get("valueHash").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `valueHash` to be a primitive type in the JSON string but got `%s`", jsonObj.get("valueHash").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Variation>() {
           ...
           public Variation read(JsonReader in) throws IOException {
             ...
             Variation instance = thisAdapter.fromJsonTree(jsonObj);
