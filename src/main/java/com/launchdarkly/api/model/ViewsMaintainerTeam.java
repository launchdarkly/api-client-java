...
public class ViewsMaintainerTeam {
  ...
  public ViewsMaintainerTeam id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ViewsMaintainerTeam key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public ViewsMaintainerTeam name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the ViewsMaintainerTeam instance itself
   */
  public ViewsMaintainerTeam putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewsMaintainerTeam viewsMaintainerTeam = (ViewsMaintainerTeam) o;
    return Objects.equals(this.id, viewsMaintainerTeam.id) &&
        Objects.equals(this.key, viewsMaintainerTeam.key) &&
        Objects.equals(this.name, viewsMaintainerTeam.name)&&
        Objects.equals(this.additionalProperties, viewsMaintainerTeam.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, key, name, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewsMaintainerTeam {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "key", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "key", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewsMaintainerTeam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsMaintainerTeam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewsMaintainerTeam is not found in the empty JSON string", ViewsMaintainerTeam.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewsMaintainerTeam.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewsMaintainerTeam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewsMaintainerTeam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewsMaintainerTeam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewsMaintainerTeam.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewsMaintainerTeam>() {
           @Override
           public void write(JsonWriter out, ViewsMaintainerTeam value) throws IOException {
           ...
           @Override
           public ViewsMaintainerTeam read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewsMaintainerTeam instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewsMaintainerTeam given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewsMaintainerTeam
   * @throws IOException if the JSON string is invalid with respect to ViewsMaintainerTeam
   */
  public static ViewsMaintainerTeam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewsMaintainerTeam.class);
  }

  /**
   * Convert an instance of ViewsMaintainerTeam to an JSON string
   *
   * @return JSON string
   */
