...
public class SegmentUserState {
   ...
   * @return the SegmentUserState instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentUserState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SegmentUserState is not found in the empty JSON string", SegmentUserState.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `included`
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull()) {
        SegmentUserList.validateJsonElement(jsonObj.get("included"));
      }
      // validate the optional field `excluded`
      if (jsonObj.get("excluded") != null && !jsonObj.get("excluded").isJsonNull()) {
        SegmentUserList.validateJsonElement(jsonObj.get("excluded"));
      }
  }
