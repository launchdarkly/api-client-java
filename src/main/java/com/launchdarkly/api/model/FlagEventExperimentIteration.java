...
public class FlagEventExperimentIteration {
  ...
  public FlagEventExperimentIteration putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the FlagEventExperimentIteration instance itself
   */
  public FlagEventExperimentIteration putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagEventExperimentIteration flagEventExperimentIteration = (FlagEventExperimentIteration) o;
    return Objects.equals(this.id, flagEventExperimentIteration.id) &&
        Objects.equals(this.status, flagEventExperimentIteration.status) &&
        Objects.equals(this.startedAt, flagEventExperimentIteration.startedAt) &&
        Objects.equals(this.endedAt, flagEventExperimentIteration.endedAt) &&
        Objects.equals(this.links, flagEventExperimentIteration.links)&&
        Objects.equals(this.additionalProperties, flagEventExperimentIteration.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, status, startedAt, endedAt, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagEventExperimentIteration {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagEventExperimentIteration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagEventExperimentIteration is not found in the empty JSON string", FlagEventExperimentIteration.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagEventExperimentIteration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagEventExperimentIteration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagEventExperimentIteration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagEventExperimentIteration.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagEventExperimentIteration>() {
           @Override
           public void write(JsonWriter out, FlagEventExperimentIteration value) throws IOException {
           ...
           @Override
           public FlagEventExperimentIteration read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagEventExperimentIteration instance = thisAdapter.fromJsonTree(jsonObj);
