...
public class Environments {
  ...
  private List<Environment> items = new ArrayList<>();

  public Environments() {
  }

  public Environments links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public Environments putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public Environments totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public Environments items(@javax.annotation.Nonnull List<Environment> items) {
    this.items = items;
    return this;
  }

  public Environments addItemsItem(Environment itemsItem) {
    if (this.items == null) {
  ...
  public void setItems(@javax.annotation.Nonnull List<Environment> items) {
    this.items = items;
  }
   ...
   * @return the Environments instance itself
   */
  public Environments putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, environments.links) &&
        Objects.equals(this.totalCount, environments.totalCount) &&
        Objects.equals(this.items, environments.items)&&
        Objects.equals(this.additionalProperties, environments.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Environments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Environments is not found in the empty JSON string", Environments.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Environments.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Environments>() {
           ...
           public Environments read(JsonReader in) throws IOException {
             ...
             Environments instance = thisAdapter.fromJsonTree(jsonObj);
