...
public class DeploymentCollectionRep {
  ...
  public DeploymentCollectionRep totalCount(@javax.annotation.Nonnull Integer totalCount) {
  ...
  public DeploymentCollectionRep items(@javax.annotation.Nonnull List<DeploymentRep> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<DeploymentRep> items) {
    this.items = items;
  }


  public DeploymentCollectionRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @return the DeploymentCollectionRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeploymentCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeploymentCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeploymentCollectionRep is not found in the empty JSON string", DeploymentCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        DeploymentRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
