  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomRole.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomRole is not found in the empty JSON string", CustomRole.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("assignedTo") != null && !jsonObj.get("assignedTo").isJsonNull()) {
        AssignedToRep.validateJsonElement(jsonObj.get("assignedTo"));
      }
      if (jsonObj.get("_presetStatements") != null && !jsonObj.get("_presetStatements").isJsonNull()) {
        ...
        if (jsonArraypresetStatements != null) {
          ...
          if (!jsonObj.get("_presetStatements").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_presetStatements` to be an array in the JSON string but got `%s`", jsonObj.get("_presetStatements").toString()));
          }
