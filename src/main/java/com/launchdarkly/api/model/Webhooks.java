...
public class Webhooks {
  ...
  public Webhooks links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public Webhooks items(@javax.annotation.Nonnull List<Webhook> items) {
    this.items = items;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Webhooks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Webhooks is not found in the empty JSON string", Webhooks.openapiRequiredFields.toString()));
        }
      }
