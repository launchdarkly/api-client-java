...
public class AuditLogEventsHookCapabilityConfigRep {
  ...
  public AuditLogEventsHookCapabilityConfigRep statements(@javax.annotation.Nullable List<Statement> statements) {
    this.statements = statements;
    return this;
  }

  public AuditLogEventsHookCapabilityConfigRep addStatementsItem(Statement statementsItem) {
   ...
   * @return the AuditLogEventsHookCapabilityConfigRep instance itself
   */
  public AuditLogEventsHookCapabilityConfigRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AuditLogEventsHookCapabilityConfigRep auditLogEventsHookCapabilityConfigRep = (AuditLogEventsHookCapabilityConfigRep) o;
    return Objects.equals(this.statements, auditLogEventsHookCapabilityConfigRep.statements)&&
        Objects.equals(this.additionalProperties, auditLogEventsHookCapabilityConfigRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(statements, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuditLogEventsHookCapabilityConfigRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuditLogEventsHookCapabilityConfigRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditLogEventsHookCapabilityConfigRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuditLogEventsHookCapabilityConfigRep is not found in the empty JSON string", AuditLogEventsHookCapabilityConfigRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("statements") != null && !jsonObj.get("statements").isJsonNull()) {
        ...
        if (jsonArraystatements != null) {
          ...
          if (!jsonObj.get("statements").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `statements` to be an array in the JSON string but got `%s`", jsonObj.get("statements").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuditLogEventsHookCapabilityConfigRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuditLogEventsHookCapabilityConfigRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuditLogEventsHookCapabilityConfigRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuditLogEventsHookCapabilityConfigRep.class));

       return (TypeAdapter<T>) new TypeAdapter<AuditLogEventsHookCapabilityConfigRep>() {
           @Override
           public void write(JsonWriter out, AuditLogEventsHookCapabilityConfigRep value) throws IOException {
           ...
           @Override
           public AuditLogEventsHookCapabilityConfigRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AuditLogEventsHookCapabilityConfigRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AuditLogEventsHookCapabilityConfigRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuditLogEventsHookCapabilityConfigRep
   * @throws IOException if the JSON string is invalid with respect to AuditLogEventsHookCapabilityConfigRep
   */
  public static AuditLogEventsHookCapabilityConfigRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuditLogEventsHookCapabilityConfigRep.class);
  }

  /**
   * Convert an instance of AuditLogEventsHookCapabilityConfigRep to an JSON string
   *
   * @return JSON string
   */
