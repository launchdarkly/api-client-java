...
public class FlagReferenceRep {
   ...
   * @return the FlagReferenceRep instance itself
   */
  public FlagReferenceRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagReferenceRep flagReferenceRep = (FlagReferenceRep) o;
    return Objects.equals(this.projectKey, flagReferenceRep.projectKey) &&
        Objects.equals(this.flagKey, flagReferenceRep.flagKey) &&
        Objects.equals(this.referencesAdded, flagReferenceRep.referencesAdded) &&
        Objects.equals(this.referencesRemoved, flagReferenceRep.referencesRemoved)&&
        Objects.equals(this.additionalProperties, flagReferenceRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectKey, flagKey, referencesAdded, referencesRemoved, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagReferenceRep {\n");
    sb.append("    projectKey: ").append(toIndentedString(projectKey)).append("\n");
    sb.append("    flagKey: ").append(toIndentedString(flagKey)).append("\n");
    sb.append("    referencesAdded: ").append(toIndentedString(referencesAdded)).append("\n");
    sb.append("    referencesRemoved: ").append(toIndentedString(referencesRemoved)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagReferenceRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagReferenceRep is not found in the empty JSON string", FlagReferenceRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagReferenceRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagReferenceRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagReferenceRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagReferenceRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagReferenceRep>() {
           @Override
           public void write(JsonWriter out, FlagReferenceRep value) throws IOException {
           ...
           @Override
           public FlagReferenceRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagReferenceRep instance = thisAdapter.fromJsonTree(jsonObj);
