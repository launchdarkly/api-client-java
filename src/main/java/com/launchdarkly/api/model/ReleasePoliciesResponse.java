...
public class ReleasePoliciesResponse {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  @javax.annotation.Nonnull
  private List<ReleasePolicy> items = new ArrayList<>();
  ...
  public ReleasePoliciesResponse items(@javax.annotation.Nonnull List<ReleasePolicy> items) {
    this.items = items;
    return this;
  }

  public ReleasePoliciesResponse addItemsItem(ReleasePolicy itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<ReleasePolicy> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<ReleasePolicy> items) {
    this.items = items;
  }


  public ReleasePoliciesResponse totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the ReleasePoliciesResponse instance itself
   */
  public ReleasePoliciesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReleasePoliciesResponse releasePoliciesResponse = (ReleasePoliciesResponse) o;
    return Objects.equals(this.items, releasePoliciesResponse.items) &&
        Objects.equals(this.totalCount, releasePoliciesResponse.totalCount)&&
        Objects.equals(this.additionalProperties, releasePoliciesResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReleasePoliciesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReleasePoliciesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePoliciesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleasePoliciesResponse is not found in the empty JSON string", ReleasePoliciesResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReleasePoliciesResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ReleasePolicy.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleasePoliciesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleasePoliciesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleasePoliciesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleasePoliciesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleasePoliciesResponse>() {
           @Override
           public void write(JsonWriter out, ReleasePoliciesResponse value) throws IOException {
           ...
           @Override
           public ReleasePoliciesResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReleasePoliciesResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ReleasePoliciesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReleasePoliciesResponse
   * @throws IOException if the JSON string is invalid with respect to ReleasePoliciesResponse
   */
  public static ReleasePoliciesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReleasePoliciesResponse.class);
  }

  /**
   * Convert an instance of ReleasePoliciesResponse to an JSON string
   *
   * @return JSON string
   */
