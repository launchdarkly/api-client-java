...
public class FlagEventMemberRep {
  ...
  public FlagEventMemberRep id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public FlagEventMemberRep email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public FlagEventMemberRep firstName(@javax.annotation.Nonnull String firstName) {
  ...
  public FlagEventMemberRep lastName(@javax.annotation.Nonnull String lastName) {
   ...
   * @return the FlagEventMemberRep instance itself
   */
  public FlagEventMemberRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagEventMemberRep flagEventMemberRep = (FlagEventMemberRep) o;
    return Objects.equals(this.id, flagEventMemberRep.id) &&
        Objects.equals(this.email, flagEventMemberRep.email) &&
        Objects.equals(this.firstName, flagEventMemberRep.firstName) &&
        Objects.equals(this.lastName, flagEventMemberRep.lastName)&&
        Objects.equals(this.additionalProperties, flagEventMemberRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FlagEventMemberRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "email", "firstName", "lastName"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "email", "firstName", "lastName"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagEventMemberRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagEventMemberRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagEventMemberRep is not found in the empty JSON string", FlagEventMemberRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlagEventMemberRep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagEventMemberRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagEventMemberRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagEventMemberRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagEventMemberRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagEventMemberRep>() {
           @Override
           public void write(JsonWriter out, FlagEventMemberRep value) throws IOException {
           ...
           @Override
           public FlagEventMemberRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagEventMemberRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FlagEventMemberRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlagEventMemberRep
   * @throws IOException if the JSON string is invalid with respect to FlagEventMemberRep
   */
  public static FlagEventMemberRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlagEventMemberRep.class);
  }

  /**
   * Convert an instance of FlagEventMemberRep to an JSON string
   *
   * @return JSON string
   */
