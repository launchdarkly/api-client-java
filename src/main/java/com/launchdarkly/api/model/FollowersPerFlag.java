  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FollowersPerFlag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in FollowersPerFlag is not found in the empty JSON string", FollowersPerFlag.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("followers") != null && !jsonObj.get("followers").isJsonNull()) {
        ...
        if (jsonArrayfollowers != null) {
          ...
          if (!jsonObj.get("followers").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `followers` to be an array in the JSON string but got `%s`", jsonObj.get("followers").toString()));
          }
