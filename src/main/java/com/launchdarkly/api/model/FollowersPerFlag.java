...
public class FollowersPerFlag {
  ...
  @javax.annotation.Nullable
  private List<FollowFlagMember> followers = new ArrayList<>();

  public FollowersPerFlag() {
  }

  public FollowersPerFlag flagKey(@javax.annotation.Nullable String flagKey) {
  ...
  public FollowersPerFlag followers(@javax.annotation.Nullable List<FollowFlagMember> followers) {
    this.followers = followers;
    return this;
  }

  public FollowersPerFlag addFollowersItem(FollowFlagMember followersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<FollowFlagMember> getFollowers() {
    return followers;
  }

  public void setFollowers(@javax.annotation.Nullable List<FollowFlagMember> followers) {
    this.followers = followers;
  }
   ...
   * @return the FollowersPerFlag instance itself
   */
  public FollowersPerFlag putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FollowersPerFlag followersPerFlag = (FollowersPerFlag) o;
    return Objects.equals(this.flagKey, followersPerFlag.flagKey) &&
        Objects.equals(this.followers, followersPerFlag.followers)&&
        Objects.equals(this.additionalProperties, followersPerFlag.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(flagKey, followers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FollowersPerFlag {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("flagKey", "followers"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to FollowersPerFlag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FollowersPerFlag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FollowersPerFlag is not found in the empty JSON string", FollowersPerFlag.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("followers") != null && !jsonObj.get("followers").isJsonNull()) {
        ...
        if (jsonArrayfollowers != null) {
          ...
          if (!jsonObj.get("followers").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `followers` to be an array in the JSON string but got `%s`", jsonObj.get("followers").toString()));
          }

          // validate the optional field `followers` (array)
          for (int i = 0; i < jsonArrayfollowers.size(); i++) {
            FollowFlagMember.validateJsonElement(jsonArrayfollowers.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FollowersPerFlag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FollowersPerFlag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FollowersPerFlag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FollowersPerFlag.class));

       return (TypeAdapter<T>) new TypeAdapter<FollowersPerFlag>() {
           @Override
           public void write(JsonWriter out, FollowersPerFlag value) throws IOException {
           ...
           @Override
           public FollowersPerFlag read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FollowersPerFlag instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FollowersPerFlag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FollowersPerFlag
   * @throws IOException if the JSON string is invalid with respect to FollowersPerFlag
   */
  public static FollowersPerFlag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FollowersPerFlag.class);
  }

  /**
   * Convert an instance of FollowersPerFlag to an JSON string
   *
   * @return JSON string
   */
