...
public class AgentGraphPatch {
  ...
  public AgentGraphPatch name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AgentGraphPatch description(@javax.annotation.Nullable String description) {
  ...
  public AgentGraphPatch rootConfigKey(@javax.annotation.Nullable String rootConfigKey) {
  ...
  public AgentGraphPatch edges(@javax.annotation.Nullable List<AgentGraphEdge> edges) {
    this.edges = edges;
    return this;
  }

  public AgentGraphPatch addEdgesItem(AgentGraphEdge edgesItem) {
    if (this.edges == null) {
   ...
   * @return the AgentGraphPatch instance itself
   */
  public AgentGraphPatch putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentGraphPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentGraphPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AgentGraphPatch is not found in the empty JSON string", AgentGraphPatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentGraphPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentGraphPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentGraphPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentGraphPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentGraphPatch>() {
           @Override
           public void write(JsonWriter out, AgentGraphPatch value) throws IOException {
           ...
           @Override
           public AgentGraphPatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentGraphPatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentGraphPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentGraphPatch
   * @throws IOException if the JSON string is invalid with respect to AgentGraphPatch
   */
  public static AgentGraphPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentGraphPatch.class);
  }

  /**
   * Convert an instance of AgentGraphPatch to an JSON string
   *
   * @return JSON string
   */
