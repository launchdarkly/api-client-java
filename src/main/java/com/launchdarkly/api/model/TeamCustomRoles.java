...
public class TeamCustomRoles {
  ...
  @javax.annotation.Nullable
  private List<TeamCustomRole> items = new ArrayList<>();
  ...
  public TeamCustomRoles totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public TeamCustomRoles items(@javax.annotation.Nullable List<TeamCustomRole> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nullable List<TeamCustomRole> items) {
    this.items = items;
  }


  public TeamCustomRoles links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @return the TeamCustomRoles instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamCustomRoles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamCustomRoles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TeamCustomRoles is not found in the empty JSON string", TeamCustomRoles.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            TeamCustomRole.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
