...
import com.launchdarkly.api.model.ApprovalsCapabilityConfig;
import com.launchdarkly.api.model.AuditLogEventsHookCapabilityConfigPost;
...
public class CapabilityConfigPost {
  ...
  @javax.annotation.Nullable
  private AuditLogEventsHookCapabilityConfigPost auditLogEventsHook;

  public CapabilityConfigPost() {
  }

  public CapabilityConfigPost approvals(@javax.annotation.Nullable ApprovalsCapabilityConfig approvals) {
  ...
  public CapabilityConfigPost auditLogEventsHook(@javax.annotation.Nullable AuditLogEventsHookCapabilityConfigPost auditLogEventsHook) {
   ...
   */
  @javax.annotation.Nullable
  public AuditLogEventsHookCapabilityConfigPost getAuditLogEventsHook() {
    return auditLogEventsHook;
  }

  public void setAuditLogEventsHook(@javax.annotation.Nullable AuditLogEventsHookCapabilityConfigPost auditLogEventsHook) {
    this.auditLogEventsHook = auditLogEventsHook;
  }
   ...
   * @return the CapabilityConfigPost instance itself
   */
  public CapabilityConfigPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CapabilityConfigPost capabilityConfigPost = (CapabilityConfigPost) o;
    return Objects.equals(this.approvals, capabilityConfigPost.approvals) &&
        Objects.equals(this.auditLogEventsHook, capabilityConfigPost.auditLogEventsHook)&&
        Objects.equals(this.additionalProperties, capabilityConfigPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvals, auditLogEventsHook, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CapabilityConfigPost {\n");
    sb.append("    approvals: ").append(toIndentedString(approvals)).append("\n");
    sb.append("    auditLogEventsHook: ").append(toIndentedString(auditLogEventsHook)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CapabilityConfigPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapabilityConfigPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CapabilityConfigPost is not found in the empty JSON string", CapabilityConfigPost.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `approvals`
      if (jsonObj.get("approvals") != null && !jsonObj.get("approvals").isJsonNull()) {
        ApprovalsCapabilityConfig.validateJsonElement(jsonObj.get("approvals"));
      }
      // validate the optional field `auditLogEventsHook`
      if (jsonObj.get("auditLogEventsHook") != null && !jsonObj.get("auditLogEventsHook").isJsonNull()) {
        AuditLogEventsHookCapabilityConfigPost.validateJsonElement(jsonObj.get("auditLogEventsHook"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CapabilityConfigPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CapabilityConfigPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CapabilityConfigPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CapabilityConfigPost.class));

       return (TypeAdapter<T>) new TypeAdapter<CapabilityConfigPost>() {
           @Override
           public void write(JsonWriter out, CapabilityConfigPost value) throws IOException {
           ...
           @Override
           public CapabilityConfigPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CapabilityConfigPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CapabilityConfigPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CapabilityConfigPost
   * @throws IOException if the JSON string is invalid with respect to CapabilityConfigPost
   */
  public static CapabilityConfigPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CapabilityConfigPost.class);
  }

  /**
   * Convert an instance of CapabilityConfigPost to an JSON string
   *
   * @return JSON string
   */
