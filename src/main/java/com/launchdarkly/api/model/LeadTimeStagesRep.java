...
public class LeadTimeStagesRep {
   ...
   * @return the LeadTimeStagesRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LeadTimeStagesRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LeadTimeStagesRep is not found in the empty JSON string", LeadTimeStagesRep.openapiRequiredFields.toString()));
        }
      }
