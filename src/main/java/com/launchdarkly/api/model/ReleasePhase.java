...
public class ReleasePhase {
   ...
   * @return the ReleasePhase instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, releasePhase.id) &&
        Objects.equals(this.name, releasePhase.name) &&
        Objects.equals(this.complete, releasePhase.complete) &&
        Objects.equals(this.creationDate, releasePhase.creationDate) &&
        Objects.equals(this.completionDate, releasePhase.completionDate) &&
        Objects.equals(this.completedBy, releasePhase.completedBy) &&
        Objects.equals(this.audiences, releasePhase.audiences) &&
        Objects.equals(this.status, releasePhase.status) &&
        Objects.equals(this.started, releasePhase.started) &&
        Objects.equals(this.startedDate, releasePhase.startedDate) &&
        Objects.equals(this._configuration, releasePhase._configuration)&&
        Objects.equals(this.additionalProperties, releasePhase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, complete, creationDate, completionDate, completedBy, audiences, status, started, startedDate, _configuration, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePhase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleasePhase is not found in the empty JSON string", ReleasePhase.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("_completedBy") != null && !jsonObj.get("_completedBy").isJsonNull()) {
        CompletedBy.validateJsonElement(jsonObj.get("_completedBy"));
      }
      // ensure the json data is an array
      if (!jsonObj.get("_audiences").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_audiences` to be an array in the JSON string but got `%s`", jsonObj.get("_audiences").toString()));
      }

      JsonArray jsonArrayaudiences = jsonObj.getAsJsonArray("_audiences");
      // validate the required field `_audiences` (array)
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleasePhase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleasePhase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleasePhase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleasePhase.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleasePhase>() {
           @Override
           ...
           public ReleasePhase read(JsonReader in) throws IOException {
             ...
             ReleasePhase instance = thisAdapter.fromJsonTree(jsonObj);
