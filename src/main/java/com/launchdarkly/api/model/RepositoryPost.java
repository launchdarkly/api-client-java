...
public class RepositoryPost {
   ...
   * @return the RepositoryPost instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, repositoryPost.name) &&
        Objects.equals(this.sourceLink, repositoryPost.sourceLink) &&
        Objects.equals(this.commitUrlTemplate, repositoryPost.commitUrlTemplate) &&
        Objects.equals(this.hunkUrlTemplate, repositoryPost.hunkUrlTemplate) &&
        Objects.equals(this.type, repositoryPost.type) &&
        Objects.equals(this.defaultBranch, repositoryPost.defaultBranch)&&
        Objects.equals(this.additionalProperties, repositoryPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, sourceLink, commitUrlTemplate, hunkUrlTemplate, type, defaultBranch, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RepositoryPost is not found in the empty JSON string", RepositoryPost.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryPost.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryPost>() {
           @Override
           ...
           public RepositoryPost read(JsonReader in) throws IOException {
             ...
             RepositoryPost instance = thisAdapter.fromJsonTree(jsonObj);
