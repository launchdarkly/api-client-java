...
public class SdkVersionRep {
   ...
   * @return the SdkVersionRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SdkVersionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SdkVersionRep is not found in the empty JSON string", SdkVersionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("sdk").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sdk` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sdk").toString()));
      }
