...
import com.launchdarkly.api.model.RedshiftDataExportCompletedArtifactsRep;
...
public class Destination {
  ...
  public static final String SERIALIZED_NAME_COMPLETED_ARTIFACTS = "completedArtifacts";
  @SerializedName(SERIALIZED_NAME_COMPLETED_ARTIFACTS)
  @javax.annotation.Nullable
  private RedshiftDataExportCompletedArtifactsRep completedArtifacts;

  public Destination() {
  }

  public Destination id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Destination links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public Destination putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public Destination name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Destination kind(@javax.annotation.Nullable KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public Destination version(@javax.annotation.Nullable BigDecimal version) {
  ...
  public Destination config(@javax.annotation.Nullable Object config) {
    this.config = config;
    return this;
  }
  ...
  public Destination on(@javax.annotation.Nullable Boolean on) {
    this.on = on;
    return this;
  }
  ...
  public Destination createdAt(@javax.annotation.Nullable Long createdAt) {
  ...
  public Destination maintainerId(@javax.annotation.Nullable String maintainerId) {
  ...
  public Destination access(@javax.annotation.Nullable Access access) {
    this.access = access;
    return this;
  }
  ...
  public Destination completedArtifacts(@javax.annotation.Nullable RedshiftDataExportCompletedArtifactsRep completedArtifacts) {
    this.completedArtifacts = completedArtifacts;
    return this;
  }

  /**
   * Get completedArtifacts
   * @return completedArtifacts
   */
  @javax.annotation.Nullable
  public RedshiftDataExportCompletedArtifactsRep getCompletedArtifacts() {
    return completedArtifacts;
  }

  public void setCompletedArtifacts(@javax.annotation.Nullable RedshiftDataExportCompletedArtifactsRep completedArtifacts) {
    this.completedArtifacts = completedArtifacts;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, destination.id) &&
        ...
        Objects.equals(this.maintainerId, destination.maintainerId) &&
        Objects.equals(this.access, destination.access) &&
        Objects.equals(this.completedArtifacts, destination.completedArtifacts)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, links, name, kind, version, config, on, createdAt, maintainerId, access, completedArtifacts, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    completedArtifacts: ").append(toIndentedString(completedArtifacts)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "_links", "name", "kind", "version", "config", "on", "createdAt", "maintainerId", "_access", "completedArtifacts"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `completedArtifacts`
      if (jsonObj.get("completedArtifacts") != null && !jsonObj.get("completedArtifacts").isJsonNull()) {
        RedshiftDataExportCompletedArtifactsRep.validateJsonElement(jsonObj.get("completedArtifacts"));
      }
  }
