...
public class ExpandedSegment {
  ...
  public ExpandedSegment key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public ExpandedSegment name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ExpandedSegment environmentId(@javax.annotation.Nullable String environmentId) {
  ...
  public ExpandedSegment environmentKey(@javax.annotation.Nullable String environmentKey) {
  ...
  public ExpandedSegment description(@javax.annotation.Nullable String description) {
  ...
  public ExpandedSegment creationDate(@javax.annotation.Nullable Long creationDate) {
  ...
  public ExpandedSegment lastModifiedDate(@javax.annotation.Nullable Long lastModifiedDate) {
  ...
  public void setLastModifiedDate(@javax.annotation.Nullable Long lastModifiedDate) {
    this.lastModifiedDate = lastModifiedDate;
  }


  public ExpandedSegment deleted(@javax.annotation.Nullable Boolean deleted) {
  ...
  public ExpandedSegment tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public ExpandedSegment addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public ExpandedSegment unbounded(@javax.annotation.Nullable Boolean unbounded) {
  ...
  public ExpandedSegment version(@javax.annotation.Nullable Integer version) {
  ...
  public ExpandedSegment generation(@javax.annotation.Nullable Integer generation) {
  ...
  public ExpandedSegment links(@javax.annotation.Nullable ParentAndSelfLinks links) {
    this.links = links;
    return this;
  }
   ...
   * @return the ExpandedSegment instance itself
   */
  public ExpandedSegment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedSegment expandedSegment = (ExpandedSegment) o;
    return Objects.equals(this.key, expandedSegment.key) &&
        Objects.equals(this.name, expandedSegment.name) &&
        Objects.equals(this.environmentId, expandedSegment.environmentId) &&
        Objects.equals(this.environmentKey, expandedSegment.environmentKey) &&
        Objects.equals(this.description, expandedSegment.description) &&
        Objects.equals(this.creationDate, expandedSegment.creationDate) &&
        Objects.equals(this.lastModifiedDate, expandedSegment.lastModifiedDate) &&
        Objects.equals(this.deleted, expandedSegment.deleted) &&
        Objects.equals(this.tags, expandedSegment.tags) &&
        Objects.equals(this.unbounded, expandedSegment.unbounded) &&
        Objects.equals(this.version, expandedSegment.version) &&
        Objects.equals(this.generation, expandedSegment.generation) &&
        Objects.equals(this.links, expandedSegment.links)&&
        Objects.equals(this.additionalProperties, expandedSegment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, environmentId, environmentKey, description, creationDate, lastModifiedDate, deleted, tags, unbounded, version, generation, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExpandedSegment {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "environmentId", "environmentKey", "description", "creationDate", "lastModifiedDate", "deleted", "tags", "unbounded", "version", "generation", "_links"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpandedSegment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedSegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedSegment is not found in the empty JSON string", ExpandedSegment.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExpandedSegment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedSegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedSegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedSegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedSegment.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedSegment>() {
           @Override
           public void write(JsonWriter out, ExpandedSegment value) throws IOException {
           ...
           @Override
           public ExpandedSegment read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedSegment instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExpandedSegment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpandedSegment
   * @throws IOException if the JSON string is invalid with respect to ExpandedSegment
   */
  public static ExpandedSegment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandedSegment.class);
  }

  /**
   * Convert an instance of ExpandedSegment to an JSON string
   *
   * @return JSON string
   */
