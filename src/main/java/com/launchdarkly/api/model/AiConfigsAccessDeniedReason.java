...
public class AiConfigsAccessDeniedReason {
  ...
  public AiConfigsAccessDeniedReason resources(@javax.annotation.Nullable List<String> resources) {
    this.resources = resources;
    return this;
  }

  public AiConfigsAccessDeniedReason addResourcesItem(String resourcesItem) {
  ...
  public AiConfigsAccessDeniedReason notResources(@javax.annotation.Nullable List<String> notResources) {
    this.notResources = notResources;
    return this;
  }

  public AiConfigsAccessDeniedReason addNotResourcesItem(String notResourcesItem) {
  ...
  public AiConfigsAccessDeniedReason actions(@javax.annotation.Nullable List<String> actions) {
    this.actions = actions;
    return this;
  }

  public AiConfigsAccessDeniedReason addActionsItem(String actionsItem) {
  ...
  public AiConfigsAccessDeniedReason notActions(@javax.annotation.Nullable List<String> notActions) {
    this.notActions = notActions;
    return this;
  }

  public AiConfigsAccessDeniedReason addNotActionsItem(String notActionsItem) {
  ...
  public AiConfigsAccessDeniedReason effect(@javax.annotation.Nonnull EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  public AiConfigsAccessDeniedReason roleName(@javax.annotation.Nullable String roleName) {
   ...
   * @return the AiConfigsAccessDeniedReason instance itself
   */
  public AiConfigsAccessDeniedReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiConfigsAccessDeniedReason aiConfigsAccessDeniedReason = (AiConfigsAccessDeniedReason) o;
    return Objects.equals(this.resources, aiConfigsAccessDeniedReason.resources) &&
        Objects.equals(this.notResources, aiConfigsAccessDeniedReason.notResources) &&
        Objects.equals(this.actions, aiConfigsAccessDeniedReason.actions) &&
        Objects.equals(this.notActions, aiConfigsAccessDeniedReason.notActions) &&
        Objects.equals(this.effect, aiConfigsAccessDeniedReason.effect) &&
        Objects.equals(this.roleName, aiConfigsAccessDeniedReason.roleName)&&
        Objects.equals(this.additionalProperties, aiConfigsAccessDeniedReason.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiConfigsAccessDeniedReason {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiConfigsAccessDeniedReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiConfigsAccessDeniedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiConfigsAccessDeniedReason is not found in the empty JSON string", AiConfigsAccessDeniedReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AiConfigsAccessDeniedReason.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiConfigsAccessDeniedReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiConfigsAccessDeniedReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiConfigsAccessDeniedReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiConfigsAccessDeniedReason.class));

       return (TypeAdapter<T>) new TypeAdapter<AiConfigsAccessDeniedReason>() {
           @Override
           public void write(JsonWriter out, AiConfigsAccessDeniedReason value) throws IOException {
           ...
           @Override
           public AiConfigsAccessDeniedReason read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiConfigsAccessDeniedReason instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AiConfigsAccessDeniedReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AiConfigsAccessDeniedReason
   * @throws IOException if the JSON string is invalid with respect to AiConfigsAccessDeniedReason
   */
  public static AiConfigsAccessDeniedReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiConfigsAccessDeniedReason.class);
  }

  /**
   * Convert an instance of AiConfigsAccessDeniedReason to an JSON string
   *
   * @return JSON string
   */
