...
public class AIConfigsSummary {
  ...
  public AIConfigsSummary count(@javax.annotation.Nonnull Integer count) {
    this.count = count;
    return this;
  }
   ...
   * @return the AIConfigsSummary instance itself
   */
  public AIConfigsSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigsSummary aiConfigsSummary = (AIConfigsSummary) o;
    return Objects.equals(this.count, aiConfigsSummary.count)&&
        Objects.equals(this.additionalProperties, aiConfigsSummary.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AIConfigsSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigsSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigsSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigsSummary is not found in the empty JSON string", AIConfigsSummary.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AIConfigsSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigsSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigsSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigsSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigsSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigsSummary>() {
           @Override
           public void write(JsonWriter out, AIConfigsSummary value) throws IOException {
           ...
           @Override
           public AIConfigsSummary read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigsSummary instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigsSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigsSummary
   * @throws IOException if the JSON string is invalid with respect to AIConfigsSummary
   */
  public static AIConfigsSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigsSummary.class);
  }

  /**
   * Convert an instance of AIConfigsSummary to an JSON string
   *
   * @return JSON string
   */
