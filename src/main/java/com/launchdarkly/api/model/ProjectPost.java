...
import com.launchdarkly.api.model.NamingConvention;
...
public class ProjectPost {
   ...
   * @return the ProjectPost instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, projectPost.name) &&
        Objects.equals(this.key, projectPost.key) &&
        Objects.equals(this.includeInSnippetByDefault, projectPost.includeInSnippetByDefault) &&
        Objects.equals(this.defaultClientSideAvailability, projectPost.defaultClientSideAvailability) &&
        Objects.equals(this.tags, projectPost.tags) &&
        Objects.equals(this.environments, projectPost.environments) &&
        Objects.equals(this.namingConvention, projectPost.namingConvention)&&
        Objects.equals(this.additionalProperties, projectPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, key, includeInSnippetByDefault, defaultClientSideAvailability, tags, environments, namingConvention, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectPost is not found in the empty JSON string", ProjectPost.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("defaultClientSideAvailability") != null && !jsonObj.get("defaultClientSideAvailability").isJsonNull()) {
        DefaultClientSideAvailabilityPost.validateJsonElement(jsonObj.get("defaultClientSideAvailability"));
      }
      ...
      if (jsonObj.get("environments") != null && !jsonObj.get("environments").isJsonNull()) {
        ...
        if (jsonArrayenvironments != null) {
          ...
          for (int i = 0; i < jsonArrayenvironments.size(); i++) {
            EnvironmentPost.validateJsonElement(jsonArrayenvironments.get(i));
          };
        }
      }
      // validate the optional field `namingConvention`
      if (jsonObj.get("namingConvention") != null && !jsonObj.get("namingConvention").isJsonNull()) {
        NamingConvention.validateJsonElement(jsonObj.get("namingConvention"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectPost>() {
           ...
           public ProjectPost read(JsonReader in) throws IOException {
             ...
             ProjectPost instance = thisAdapter.fromJsonTree(jsonObj);
