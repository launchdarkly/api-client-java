...
public class Conflict {
  ...
  private Map<String, Object> instruction = new HashMap<>();
  ...
  public Conflict instruction(@javax.annotation.Nullable Map<String, Object> instruction) {
    this.instruction = instruction;
    return this;
  }

  public Conflict putInstructionItem(String key, Object instructionItem) {
    if (this.instruction == null) {
      this.instruction = new HashMap<>();
    }
    this.instruction.put(key, instructionItem);
    return this;
  }
  ...
  public void setInstruction(@javax.annotation.Nullable Map<String, Object> instruction) {
    this.instruction = instruction;
  }


  public Conflict reason(@javax.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
   ...
   * @return the Conflict instance itself
   */
  public Conflict putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instruction, conflict.instruction) &&
        Objects.equals(this.reason, conflict.reason)&&
        Objects.equals(this.additionalProperties, conflict.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instruction, reason, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("instruction", "reason"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Conflict.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Conflict is not found in the empty JSON string", Conflict.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Conflict>() {
           ...
           public Conflict read(JsonReader in) throws IOException {
             ...
             Conflict instance = thisAdapter.fromJsonTree(jsonObj);
