...
public class AIConfigVariationsResponse {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  @javax.annotation.Nonnull
  private List<AIConfigVariation> items = new ArrayList<>();
  ...
  public AIConfigVariationsResponse items(@javax.annotation.Nonnull List<AIConfigVariation> items) {
    this.items = items;
    return this;
  }

  public AIConfigVariationsResponse addItemsItem(AIConfigVariation itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<AIConfigVariation> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<AIConfigVariation> items) {
    this.items = items;
  }


  public AIConfigVariationsResponse totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the AIConfigVariationsResponse instance itself
   */
  public AIConfigVariationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigVariationsResponse aiConfigVariationsResponse = (AIConfigVariationsResponse) o;
    return Objects.equals(this.items, aiConfigVariationsResponse.items) &&
        Objects.equals(this.totalCount, aiConfigVariationsResponse.totalCount)&&
        Objects.equals(this.additionalProperties, aiConfigVariationsResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AIConfigVariationsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigVariationsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigVariationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigVariationsResponse is not found in the empty JSON string", AIConfigVariationsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AIConfigVariationsResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        AIConfigVariation.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigVariationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigVariationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigVariationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigVariationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigVariationsResponse>() {
           @Override
           public void write(JsonWriter out, AIConfigVariationsResponse value) throws IOException {
           ...
           @Override
           public AIConfigVariationsResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigVariationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigVariationsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigVariationsResponse
   * @throws IOException if the JSON string is invalid with respect to AIConfigVariationsResponse
   */
  public static AIConfigVariationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigVariationsResponse.class);
  }

  /**
   * Convert an instance of AIConfigVariationsResponse to an JSON string
   *
   * @return JSON string
   */
