...
public class EvaluationsSummary {
  public static final String SERIALIZED_NAME_VARIATIONS = "variations";
  @SerializedName(SERIALIZED_NAME_VARIATIONS)
  @javax.annotation.Nullable
  private List<VariationEvalSummary> variations = new ArrayList<>();

  public EvaluationsSummary() {
  }

  public EvaluationsSummary variations(@javax.annotation.Nullable List<VariationEvalSummary> variations) {
    this.variations = variations;
    return this;
  }

  public EvaluationsSummary addVariationsItem(VariationEvalSummary variationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<VariationEvalSummary> getVariations() {
    return variations;
  }

  public void setVariations(@javax.annotation.Nullable List<VariationEvalSummary> variations) {
    this.variations = variations;
  }
   ...
   * @return the EvaluationsSummary instance itself
   */
  public EvaluationsSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EvaluationsSummary evaluationsSummary = (EvaluationsSummary) o;
    return Objects.equals(this.variations, evaluationsSummary.variations)&&
        Objects.equals(this.additionalProperties, evaluationsSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(variations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EvaluationsSummary {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("variations"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to EvaluationsSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EvaluationsSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EvaluationsSummary is not found in the empty JSON string", EvaluationsSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("variations") != null && !jsonObj.get("variations").isJsonNull()) {
        ...
        if (jsonArrayvariations != null) {
          ...
          for (int i = 0; i < jsonArrayvariations.size(); i++) {
            VariationEvalSummary.validateJsonElement(jsonArrayvariations.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EvaluationsSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EvaluationsSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EvaluationsSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EvaluationsSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<EvaluationsSummary>() {
           @Override
           public void write(JsonWriter out, EvaluationsSummary value) throws IOException {
           ...
           @Override
           public EvaluationsSummary read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EvaluationsSummary instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EvaluationsSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EvaluationsSummary
   * @throws IOException if the JSON string is invalid with respect to EvaluationsSummary
   */
  public static EvaluationsSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EvaluationsSummary.class);
  }

  /**
   * Convert an instance of EvaluationsSummary to an JSON string
   *
   * @return JSON string
   */
