...
import com.launchdarkly.api.model.OptionsArray;
...
public class DynamicOptionsParser {
   ...
   * @return the DynamicOptionsParser instance itself
   */
  public DynamicOptionsParser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DynamicOptionsParser dynamicOptionsParser = (DynamicOptionsParser) o;
    return Objects.equals(this.optionsItems, dynamicOptionsParser.optionsItems) &&
        Objects.equals(this.optionsPath, dynamicOptionsParser.optionsPath)&&
        Objects.equals(this.additionalProperties, dynamicOptionsParser.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(optionsItems, optionsPath, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DynamicOptionsParser {\n");
    sb.append("    optionsItems: ").append(toIndentedString(optionsItems)).append("\n");
    sb.append("    optionsPath: ").append(toIndentedString(optionsPath)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicOptionsParser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicOptionsParser is not found in the empty JSON string", DynamicOptionsParser.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `optionsItems`
      if (jsonObj.get("optionsItems") != null && !jsonObj.get("optionsItems").isJsonNull()) {
      ...
      if ((jsonObj.get("optionsPath") != null && !jsonObj.get("optionsPath").isJsonNull()) && !jsonObj.get("optionsPath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `optionsPath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("optionsPath").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicOptionsParser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicOptionsParser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicOptionsParser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicOptionsParser.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicOptionsParser>() {
           @Override
           public void write(JsonWriter out, DynamicOptionsParser value) throws IOException {
           ...
           @Override
           public DynamicOptionsParser read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DynamicOptionsParser instance = thisAdapter.fromJsonTree(jsonObj);
