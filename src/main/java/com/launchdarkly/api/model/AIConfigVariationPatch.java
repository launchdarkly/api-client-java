...
public class AIConfigVariationPatch {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, description, instructions, messages, model, modelConfigKey, name, published, state, tools, toolKeys, judgeConfiguration, additionalProperties);
  }
