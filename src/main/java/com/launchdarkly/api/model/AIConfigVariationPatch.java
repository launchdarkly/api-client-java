...
public class AIConfigVariationPatch {
  ...
  public AIConfigVariationPatch addMessagesItem(Message messagesItem) {
  ...
  public AIConfigVariationPatch outputFormat(@javax.annotation.Nullable Map<String, Object> outputFormat) {
    this.outputFormat = outputFormat;
    return this;
  }

  public AIConfigVariationPatch putOutputFormatItem(String key, Object outputFormatItem) {
  ...
  public AIConfigVariationPatch addToolsItem(VariationToolPost toolsItem) {
    if (this.tools == null) {
  ...
  public AIConfigVariationPatch addToolKeysItem(String toolKeysItem) {
   ...
   * @return the AIConfigVariationPatch instance itself
   */
  public AIConfigVariationPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigVariationPatch aiConfigVariationPatch = (AIConfigVariationPatch) o;
    return Objects.equals(this.comment, aiConfigVariationPatch.comment) &&
        Objects.equals(this.description, aiConfigVariationPatch.description) &&
        Objects.equals(this.instructions, aiConfigVariationPatch.instructions) &&
        Objects.equals(this.messages, aiConfigVariationPatch.messages) &&
        Objects.equals(this.model, aiConfigVariationPatch.model) &&
        Objects.equals(this.modelConfigKey, aiConfigVariationPatch.modelConfigKey) &&
        Objects.equals(this.name, aiConfigVariationPatch.name) &&
        Objects.equals(this.outputFormat, aiConfigVariationPatch.outputFormat) &&
        Objects.equals(this.published, aiConfigVariationPatch.published) &&
        Objects.equals(this.state, aiConfigVariationPatch.state) &&
        Objects.equals(this.tools, aiConfigVariationPatch.tools) &&
        Objects.equals(this.toolKeys, aiConfigVariationPatch.toolKeys) &&
        Objects.equals(this.judgeConfiguration, aiConfigVariationPatch.judgeConfiguration)&&
        Objects.equals(this.additionalProperties, aiConfigVariationPatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, description, instructions, messages, model, modelConfigKey, name, outputFormat, published, state, tools, toolKeys, judgeConfiguration, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIConfigVariationPatch {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "instructions", "messages", "model", "modelConfigKey", "name", "outputFormat", "published", "state", "tools", "toolKeys", "judgeConfiguration"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigVariationPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigVariationPatch is not found in the empty JSON string", AIConfigVariationPatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigVariationPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigVariationPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigVariationPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigVariationPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigVariationPatch>() {
           @Override
           public void write(JsonWriter out, AIConfigVariationPatch value) throws IOException {
           ...
           @Override
           public AIConfigVariationPatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigVariationPatch instance = thisAdapter.fromJsonTree(jsonObj);
