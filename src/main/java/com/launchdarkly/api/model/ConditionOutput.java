...
public class ConditionOutput {
  ...
  public static final String SERIALIZED_NAME_CREATION_CONFIG = "creationConfig";
  @SerializedName(SERIALIZED_NAME_CREATION_CONFIG)
  @javax.annotation.Nullable
  private Map<String, Object> creationConfig = new HashMap<>();

  public ConditionOutput() {
  }

  public ConditionOutput id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ConditionOutput kind(@javax.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ConditionOutput execution(@javax.annotation.Nonnull ExecutionOutput execution) {
  ...
  public ConditionOutput scheduleKind(@javax.annotation.Nullable String scheduleKind) {
  ...
  public ConditionOutput executionDate(@javax.annotation.Nullable Long executionDate) {
  ...
  public ConditionOutput waitDuration(@javax.annotation.Nullable Integer waitDuration) {
  ...
  public ConditionOutput waitDurationUnit(@javax.annotation.Nullable String waitDurationUnit) {
  ...
  public ConditionOutput description(@javax.annotation.Nonnull String description) {
  ...
  public ConditionOutput notifyMemberIds(@javax.annotation.Nonnull List<String> notifyMemberIds) {
    this.notifyMemberIds = notifyMemberIds;
    return this;
  }

  public ConditionOutput addNotifyMemberIdsItem(String notifyMemberIdsItem) {
  ...
  public ConditionOutput allReviews(@javax.annotation.Nonnull List<ReviewOutput> allReviews) {
    this.allReviews = allReviews;
    return this;
  }

  public ConditionOutput addAllReviewsItem(ReviewOutput allReviewsItem) {
  ...
  public void setAllReviews(@javax.annotation.Nonnull List<ReviewOutput> allReviews) {
    this.allReviews = allReviews;
  }


  public ConditionOutput reviewStatus(@javax.annotation.Nonnull String reviewStatus) {
  ...
  public void setReviewStatus(@javax.annotation.Nonnull String reviewStatus) {
    this.reviewStatus = reviewStatus;
  }


  public ConditionOutput appliedDate(@javax.annotation.Nullable Long appliedDate) {
  ...
  public ConditionOutput creationConfig(@javax.annotation.Nullable Map<String, Object> creationConfig) {
    this.creationConfig = creationConfig;
    return this;
  }

  public ConditionOutput putCreationConfigItem(String key, Object creationConfigItem) {
    if (this.creationConfig == null) {
      this.creationConfig = new HashMap<>();
    }
    this.creationConfig.put(key, creationConfigItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Map<String, Object> getCreationConfig() {
    return creationConfig;
  }

  public void setCreationConfig(@javax.annotation.Nullable Map<String, Object> creationConfig) {
    this.creationConfig = creationConfig;
  }
   ...
   * @return the ConditionOutput instance itself
   */
  public ConditionOutput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConditionOutput conditionOutput = (ConditionOutput) o;
    return Objects.equals(this.id, conditionOutput.id) &&
        Objects.equals(this.kind, conditionOutput.kind) &&
        Objects.equals(this.execution, conditionOutput.execution) &&
        Objects.equals(this.scheduleKind, conditionOutput.scheduleKind) &&
        Objects.equals(this.executionDate, conditionOutput.executionDate) &&
        Objects.equals(this.waitDuration, conditionOutput.waitDuration) &&
        Objects.equals(this.waitDurationUnit, conditionOutput.waitDurationUnit) &&
        Objects.equals(this.description, conditionOutput.description) &&
        Objects.equals(this.notifyMemberIds, conditionOutput.notifyMemberIds) &&
        Objects.equals(this.allReviews, conditionOutput.allReviews) &&
        Objects.equals(this.reviewStatus, conditionOutput.reviewStatus) &&
        Objects.equals(this.appliedDate, conditionOutput.appliedDate) &&
        Objects.equals(this.creationConfig, conditionOutput.creationConfig)&&
        Objects.equals(this.additionalProperties, conditionOutput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, kind, execution, scheduleKind, executionDate, waitDuration, waitDurationUnit, description, notifyMemberIds, allReviews, reviewStatus, appliedDate, creationConfig, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    waitDurationUnit: ").append(toIndentedString(waitDurationUnit)).append("\n");
    ...
    sb.append("    creationConfig: ").append(toIndentedString(creationConfig)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "kind", "_execution", "scheduleKind", "executionDate", "waitDuration", "waitDurationUnit", "description", "notifyMemberIds", "allReviews", "reviewStatus", "appliedDate", "creationConfig"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_id", "_execution", "description", "notifyMemberIds", "allReviews", "reviewStatus"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConditionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConditionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConditionOutput is not found in the empty JSON string", ConditionOutput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConditionOutput.openapiRequiredFields) {
      ...
      // validate the required field `_execution`
      ExecutionOutput.validateJsonElement(jsonObj.get("_execution"));
      if ((jsonObj.get("scheduleKind") != null && !jsonObj.get("scheduleKind").isJsonNull()) && !jsonObj.get("scheduleKind").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `scheduleKind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("scheduleKind").toString()));
      }
      if ((jsonObj.get("waitDurationUnit") != null && !jsonObj.get("waitDurationUnit").isJsonNull()) && !jsonObj.get("waitDurationUnit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `waitDurationUnit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("waitDurationUnit").toString()));
      }
      ...
      if (jsonObj.get("notifyMemberIds") == null) {
        ...
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `notifyMemberIds` to be an array in the JSON string but got `%s`", jsonObj.get("notifyMemberIds").toString()));
      }
      // ensure the json data is an array
      if (!jsonObj.get("allReviews").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `allReviews` to be an array in the JSON string but got `%s`", jsonObj.get("allReviews").toString()));
      }
      ...
      for (int i = 0; i < jsonArrayallReviews.size(); i++) {
        ReviewOutput.validateJsonElement(jsonArrayallReviews.get(i));
      };
      if (!jsonObj.get("reviewStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `reviewStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reviewStatus").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConditionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConditionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConditionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConditionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ConditionOutput>() {
           @Override
           public void write(JsonWriter out, ConditionOutput value) throws IOException {
           ...
           @Override
           public ConditionOutput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ConditionOutput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ConditionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConditionOutput
   * @throws IOException if the JSON string is invalid with respect to ConditionOutput
   */
  public static ConditionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConditionOutput.class);
  }

  /**
   * Convert an instance of ConditionOutput to an JSON string
   *
   * @return JSON string
   */
