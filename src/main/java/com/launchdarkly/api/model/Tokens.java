...
public class Tokens {
  ...
  public Tokens items(@javax.annotation.Nullable List<Token> items) {
    this.items = items;
    return this;
  }

  public Tokens addItemsItem(Token itemsItem) {
    if (this.items == null) {
  ...
  public void setItems(@javax.annotation.Nullable List<Token> items) {
    this.items = items;
  }


  public Tokens links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public Tokens putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public Tokens totalCount(@javax.annotation.Nullable Integer totalCount) {
   ...
   * @return the Tokens instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, tokens.items) &&
        Objects.equals(this.links, tokens.links) &&
        Objects.equals(this.totalCount, tokens.totalCount)&&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Tokens.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Tokens is not found in the empty JSON string", Tokens.openapiRequiredFields.toString()));
        }
      }
