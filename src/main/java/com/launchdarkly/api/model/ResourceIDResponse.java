...
public class ResourceIDResponse {
  ...
  public ResourceIDResponse kind(@javax.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ResourceIDResponse projectKey(@javax.annotation.Nullable String projectKey) {
  ...
  public ResourceIDResponse environmentKey(@javax.annotation.Nullable String environmentKey) {
  ...
  public ResourceIDResponse flagKey(@javax.annotation.Nullable String flagKey) {
  ...
  public ResourceIDResponse key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
   ...
   * @return the ResourceIDResponse instance itself
   */
  public ResourceIDResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceIDResponse resourceIDResponse = (ResourceIDResponse) o;
    return Objects.equals(this.kind, resourceIDResponse.kind) &&
        Objects.equals(this.projectKey, resourceIDResponse.projectKey) &&
        Objects.equals(this.environmentKey, resourceIDResponse.environmentKey) &&
        Objects.equals(this.flagKey, resourceIDResponse.flagKey) &&
        Objects.equals(this.key, resourceIDResponse.key)&&
        Objects.equals(this.additionalProperties, resourceIDResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, projectKey, environmentKey, flagKey, key, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ResourceIDResponse {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("kind", "projectKey", "environmentKey", "flagKey", "key"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceIDResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceIDResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResourceIDResponse is not found in the empty JSON string", ResourceIDResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceIDResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceIDResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceIDResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceIDResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceIDResponse>() {
           @Override
           public void write(JsonWriter out, ResourceIDResponse value) throws IOException {
           ...
           @Override
           public ResourceIDResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ResourceIDResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ResourceIDResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceIDResponse
   * @throws IOException if the JSON string is invalid with respect to ResourceIDResponse
   */
  public static ResourceIDResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceIDResponse.class);
  }

  /**
   * Convert an instance of ResourceIDResponse to an JSON string
   *
   * @return JSON string
   */
