...
public class PatchSegmentInstruction {
  ...
  public PatchSegmentInstruction kind(String kind) {
  ...
  **/
  ...
  public PatchSegmentInstruction targetType(String targetType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A segment's target type. Must be either <code>included</code> or <code>excluded</code>")
  ...
  **/
  ...
  @ApiModelProperty(value = "Schedule user target expiration on a segment by including a timestamp")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Required if <code>kind</code> is <code>updateExpireUserTargetDate</code>")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, userKey, targetType, value, version);
  }
