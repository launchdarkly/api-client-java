...
public class ReleasePoliciesAccessDeniedReason {
  ...
  public ReleasePoliciesAccessDeniedReason resources(List<String> resources) {
  ...
  **/
  ...
  public ReleasePoliciesAccessDeniedReason notResources(List<String> notResources) {
  ...
  **/
  ...
  public ReleasePoliciesAccessDeniedReason actions(List<String> actions) {
  ...
  **/
  ...
  public ReleasePoliciesAccessDeniedReason notActions(List<String> notActions) {
  ...
  **/
  ...
  public ReleasePoliciesAccessDeniedReason effect(EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  **/
  ...
  public ReleasePoliciesAccessDeniedReason roleName(String roleName) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePoliciesAccessDeniedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReleasePoliciesAccessDeniedReason is not found in the empty JSON string", ReleasePoliciesAccessDeniedReason.openapiRequiredFields.toString()));
        }
      }
