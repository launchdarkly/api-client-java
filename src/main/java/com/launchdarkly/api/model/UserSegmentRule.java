...
public class UserSegmentRule {
   ...
   * @return the UserSegmentRule instance itself
   */
  public UserSegmentRule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userSegmentRule.id) &&
        Objects.equals(this.clauses, userSegmentRule.clauses) &&
        Objects.equals(this.weight, userSegmentRule.weight) &&
        Objects.equals(this.rolloutContextKind, userSegmentRule.rolloutContextKind) &&
        Objects.equals(this.bucketBy, userSegmentRule.bucketBy) &&
        Objects.equals(this.description, userSegmentRule.description)&&
        Objects.equals(this.additionalProperties, userSegmentRule.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, clauses, weight, rolloutContextKind, bucketBy, description, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    rolloutContextKind: ").append(toIndentedString(rolloutContextKind)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserSegmentRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserSegmentRule is not found in the empty JSON string", UserSegmentRule.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("rolloutContextKind") != null && !jsonObj.get("rolloutContextKind").isJsonNull()) && !jsonObj.get("rolloutContextKind").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rolloutContextKind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rolloutContextKind").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserSegmentRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserSegmentRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserSegmentRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserSegmentRule.class));

       return (TypeAdapter<T>) new TypeAdapter<UserSegmentRule>() {
           @Override
           public void write(JsonWriter out, UserSegmentRule value) throws IOException {
           ...
           @Override
           public UserSegmentRule read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UserSegmentRule instance = thisAdapter.fromJsonTree(jsonObj);
