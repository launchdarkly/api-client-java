...
public class MigrationSettingsPost {
  ...
  public MigrationSettingsPost contextKind(@javax.annotation.Nullable String contextKind) {
  ...
  public MigrationSettingsPost stageCount(@javax.annotation.Nonnull Integer stageCount) {
  ...
  public void setStageCount(@javax.annotation.Nonnull Integer stageCount) {
    this.stageCount = stageCount;
  }
   ...
   * @return the MigrationSettingsPost instance itself
   */
  public MigrationSettingsPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MigrationSettingsPost migrationSettingsPost = (MigrationSettingsPost) o;
    return Objects.equals(this.contextKind, migrationSettingsPost.contextKind) &&
        Objects.equals(this.stageCount, migrationSettingsPost.stageCount)&&
        Objects.equals(this.additionalProperties, migrationSettingsPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contextKind, stageCount, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MigrationSettingsPost {\n");
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("stageCount"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MigrationSettingsPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MigrationSettingsPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MigrationSettingsPost is not found in the empty JSON string", MigrationSettingsPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MigrationSettingsPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MigrationSettingsPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MigrationSettingsPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MigrationSettingsPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MigrationSettingsPost.class));

       return (TypeAdapter<T>) new TypeAdapter<MigrationSettingsPost>() {
           @Override
           public void write(JsonWriter out, MigrationSettingsPost value) throws IOException {
           ...
           @Override
           public MigrationSettingsPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MigrationSettingsPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MigrationSettingsPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MigrationSettingsPost
   * @throws IOException if the JSON string is invalid with respect to MigrationSettingsPost
   */
  public static MigrationSettingsPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MigrationSettingsPost.class);
  }

  /**
   * Convert an instance of MigrationSettingsPost to an JSON string
   *
   * @return JSON string
   */
