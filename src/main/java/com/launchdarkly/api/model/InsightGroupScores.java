...
public class InsightGroupScores {
   ...
   * @return the InsightGroupScores instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightGroupScores.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightGroupScores is not found in the empty JSON string", InsightGroupScores.openapiRequiredFields.toString()));
        }
      }
      ...
      InsightsMetricScore.validateJsonElement(jsonObj.get("overall"));
      // validate the required field `deploymentFrequency`
      InsightsMetricScore.validateJsonElement(jsonObj.get("deploymentFrequency"));
      // validate the required field `deploymentFailureRate`
      InsightsMetricScore.validateJsonElement(jsonObj.get("deploymentFailureRate"));
      // validate the required field `leadTime`
      InsightsMetricScore.validateJsonElement(jsonObj.get("leadTime"));
      // validate the required field `impactSize`
      InsightsMetricScore.validateJsonElement(jsonObj.get("impactSize"));
      // validate the required field `experimentationCoverage`
      InsightsMetricScore.validateJsonElement(jsonObj.get("experimentationCoverage"));
      // validate the required field `flagHealth`
      InsightsMetricScore.validateJsonElement(jsonObj.get("flagHealth"));
      // validate the required field `velocity`
      InsightsMetricScore.validateJsonElement(jsonObj.get("velocity"));
      // validate the required field `risk`
      InsightsMetricScore.validateJsonElement(jsonObj.get("risk"));
      // validate the required field `efficiency`
      InsightsMetricScore.validateJsonElement(jsonObj.get("efficiency"));
      // validate the optional field `creationRatio`
      if (jsonObj.get("creationRatio") != null && !jsonObj.get("creationRatio").isJsonNull()) {
        InsightsMetricScore.validateJsonElement(jsonObj.get("creationRatio"));
      }
  }
