...
public class MultiEnvironmentDependentFlags {
  ...
  private List<MultiEnvironmentDependentFlag> items = new ArrayList<>();
  ...
  public MultiEnvironmentDependentFlags items(@javax.annotation.Nonnull List<MultiEnvironmentDependentFlag> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<MultiEnvironmentDependentFlag> items) {
    this.items = items;
  }


  public MultiEnvironmentDependentFlags links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public MultiEnvironmentDependentFlags putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public MultiEnvironmentDependentFlags site(@javax.annotation.Nonnull Link site) {
    this.site = site;
    return this;
  }
   ...
   * @return the MultiEnvironmentDependentFlags instance itself
   */
  public MultiEnvironmentDependentFlags putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, multiEnvironmentDependentFlags.items) &&
        ...
        Objects.equals(this.additionalProperties, multiEnvironmentDependentFlags.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(items, links, site, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("items", "_links", "_site"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("items", "_links", "_site"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MultiEnvironmentDependentFlags
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MultiEnvironmentDependentFlags.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MultiEnvironmentDependentFlags is not found in the empty JSON string", MultiEnvironmentDependentFlags.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MultiEnvironmentDependentFlags.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        MultiEnvironmentDependentFlag.validateJsonElement(jsonArrayitems.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MultiEnvironmentDependentFlags.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MultiEnvironmentDependentFlags' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MultiEnvironmentDependentFlags> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MultiEnvironmentDependentFlags.class));

       return (TypeAdapter<T>) new TypeAdapter<MultiEnvironmentDependentFlags>() {
           @Override
           public void write(JsonWriter out, MultiEnvironmentDependentFlags value) throws IOException {
           ...
           @Override
           public MultiEnvironmentDependentFlags read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MultiEnvironmentDependentFlags instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MultiEnvironmentDependentFlags given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MultiEnvironmentDependentFlags
   * @throws IOException if the JSON string is invalid with respect to MultiEnvironmentDependentFlags
   */
  public static MultiEnvironmentDependentFlags fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MultiEnvironmentDependentFlags.class);
  }

  /**
   * Convert an instance of MultiEnvironmentDependentFlags to an JSON string
   *
   * @return JSON string
   */
