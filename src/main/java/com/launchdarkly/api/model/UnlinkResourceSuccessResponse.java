...
public class UnlinkResourceSuccessResponse {
  ...
  public UnlinkResourceSuccessResponse addFailedResourcesItem(FailedResourceLink failedResourcesItem) {
   ...
   * @return the UnlinkResourceSuccessResponse instance itself
   */
  public UnlinkResourceSuccessResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UnlinkResourceSuccessResponse unlinkResourceSuccessResponse = (UnlinkResourceSuccessResponse) o;
    return Objects.equals(this.successCount, unlinkResourceSuccessResponse.successCount) &&
        Objects.equals(this.failureCount, unlinkResourceSuccessResponse.failureCount) &&
        Objects.equals(this.failedResources, unlinkResourceSuccessResponse.failedResources)&&
        Objects.equals(this.additionalProperties, unlinkResourceSuccessResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(successCount, failureCount, failedResources, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UnlinkResourceSuccessResponse {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnlinkResourceSuccessResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UnlinkResourceSuccessResponse is not found in the empty JSON string", UnlinkResourceSuccessResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnlinkResourceSuccessResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnlinkResourceSuccessResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnlinkResourceSuccessResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnlinkResourceSuccessResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UnlinkResourceSuccessResponse>() {
           @Override
           public void write(JsonWriter out, UnlinkResourceSuccessResponse value) throws IOException {
           ...
           @Override
           public UnlinkResourceSuccessResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UnlinkResourceSuccessResponse instance = thisAdapter.fromJsonTree(jsonObj);
