...
public class TagsLink {
  ...
  public TagsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public TagsLink type(String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagsLink is not found in the empty JSON string", TagsLink.openapiRequiredFields.toString()));
        }
      }
