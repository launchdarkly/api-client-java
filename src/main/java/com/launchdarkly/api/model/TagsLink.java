...
public class TagsLink {
  ...
  public TagsLink href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public TagsLink type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the TagsLink instance itself
   */
  public TagsLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TagsLink tagsLink = (TagsLink) o;
    return Objects.equals(this.href, tagsLink.href) &&
        Objects.equals(this.type, tagsLink.type)&&
        Objects.equals(this.additionalProperties, tagsLink.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TagsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TagsLink is not found in the empty JSON string", TagsLink.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<TagsLink>() {
           @Override
           public void write(JsonWriter out, TagsLink value) throws IOException {
           ...
           @Override
           public TagsLink read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TagsLink instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TagsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TagsLink
   * @throws IOException if the JSON string is invalid with respect to TagsLink
   */
  public static TagsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TagsLink.class);
  }

  /**
   * Convert an instance of TagsLink to an JSON string
   *
   * @return JSON string
   */
