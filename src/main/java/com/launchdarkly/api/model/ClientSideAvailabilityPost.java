...
public class ClientSideAvailabilityPost {
  ...
  public ClientSideAvailabilityPost usingEnvironmentId(@javax.annotation.Nonnull Boolean usingEnvironmentId) {
  ...
  public ClientSideAvailabilityPost usingMobileKey(@javax.annotation.Nonnull Boolean usingMobileKey) {
   ...
   * @return the ClientSideAvailabilityPost instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClientSideAvailabilityPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClientSideAvailabilityPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ClientSideAvailabilityPost is not found in the empty JSON string", ClientSideAvailabilityPost.openapiRequiredFields.toString()));
        }
      }
