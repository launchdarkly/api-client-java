...
public class TreatmentParameterInput {
   ...
   * @return the TreatmentParameterInput instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.flagKey, treatmentParameterInput.flagKey) &&
        Objects.equals(this.variationId, treatmentParameterInput.variationId)&&
        Objects.equals(this.additionalProperties, treatmentParameterInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(flagKey, variationId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TreatmentParameterInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TreatmentParameterInput is not found in the empty JSON string", TreatmentParameterInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TreatmentParameterInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TreatmentParameterInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TreatmentParameterInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TreatmentParameterInput.class));

       return (TypeAdapter<T>) new TypeAdapter<TreatmentParameterInput>() {
           @Override
           ...
           public TreatmentParameterInput read(JsonReader in) throws IOException {
             ...
             TreatmentParameterInput instance = thisAdapter.fromJsonTree(jsonObj);
