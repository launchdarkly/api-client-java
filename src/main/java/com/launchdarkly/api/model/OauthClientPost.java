...
public class OauthClientPost {
  ...
  public OauthClientPost name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OauthClientPost redirectUri(@javax.annotation.Nullable String redirectUri) {
  ...
  public OauthClientPost description(@javax.annotation.Nullable String description) {
   ...
   * @return the OauthClientPost instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "redirectUri", "description"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to OauthClientPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OauthClientPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OauthClientPost is not found in the empty JSON string", OauthClientPost.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("redirectUri") != null && !jsonObj.get("redirectUri").isJsonNull()) && !jsonObj.get("redirectUri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `redirectUri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("redirectUri").toString()));
      }
