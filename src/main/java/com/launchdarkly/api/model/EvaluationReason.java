...
public class EvaluationReason {
   ...
   * @return the EvaluationReason instance itself
   */
  public EvaluationReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EvaluationReason evaluationReason = (EvaluationReason) o;
    return Objects.equals(this.kind, evaluationReason.kind) &&
        Objects.equals(this.ruleIndex, evaluationReason.ruleIndex) &&
        Objects.equals(this.ruleID, evaluationReason.ruleID) &&
        Objects.equals(this.prerequisiteKey, evaluationReason.prerequisiteKey) &&
        Objects.equals(this.inExperiment, evaluationReason.inExperiment) &&
        Objects.equals(this.errorKind, evaluationReason.errorKind)&&
        Objects.equals(this.additionalProperties, evaluationReason.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvaluationReason {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EvaluationReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EvaluationReason is not found in the empty JSON string", EvaluationReason.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EvaluationReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EvaluationReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EvaluationReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EvaluationReason.class));

       return (TypeAdapter<T>) new TypeAdapter<EvaluationReason>() {
           @Override
           public void write(JsonWriter out, EvaluationReason value) throws IOException {
           ...
           @Override
           public EvaluationReason read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EvaluationReason instance = thisAdapter.fromJsonTree(jsonObj);
