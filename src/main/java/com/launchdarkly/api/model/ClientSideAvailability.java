...
public class ClientSideAvailability {
   ...
   * @return the ClientSideAvailability instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClientSideAvailability.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ClientSideAvailability is not found in the empty JSON string", ClientSideAvailability.openapiRequiredFields.toString()));
        }
      }
