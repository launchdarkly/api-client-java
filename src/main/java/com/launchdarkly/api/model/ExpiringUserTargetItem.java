...
public class ExpiringUserTargetItem {
   ...
   * @return the ExpiringUserTargetItem instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpiringUserTargetItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpiringUserTargetItem is not found in the empty JSON string", ExpiringUserTargetItem.openapiRequiredFields.toString()));
        }
      }
