...
public class AudiencePost {
  ...
  public AudiencePost environmentKey(@javax.annotation.Nonnull String environmentKey) {
  ...
  public AudiencePost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AudiencePost segmentKeys(@javax.annotation.Nullable List<String> segmentKeys) {
    this.segmentKeys = segmentKeys;
    return this;
  }

  public AudiencePost addSegmentKeysItem(String segmentKeysItem) {
  ...
  public AudiencePost _configuration(@javax.annotation.Nullable AudienceConfiguration _configuration) {
   ...
   * @return the AudiencePost instance itself
   */
  public AudiencePost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AudiencePost audiencePost = (AudiencePost) o;
    return Objects.equals(this.environmentKey, audiencePost.environmentKey) &&
        Objects.equals(this.name, audiencePost.name) &&
        Objects.equals(this.segmentKeys, audiencePost.segmentKeys) &&
        Objects.equals(this._configuration, audiencePost._configuration)&&
        Objects.equals(this.additionalProperties, audiencePost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(environmentKey, name, segmentKeys, _configuration, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AudiencePost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("environmentKey", "name", "segmentKeys", "configuration"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("environmentKey", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AudiencePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AudiencePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AudiencePost is not found in the empty JSON string", AudiencePost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AudiencePost.openapiRequiredFields) {
      ...
      if (jsonObj.get("segmentKeys") != null && !jsonObj.get("segmentKeys").isJsonNull() && !jsonObj.get("segmentKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `segmentKeys` to be an array in the JSON string but got `%s`", jsonObj.get("segmentKeys").toString()));
      }
      // validate the optional field `configuration`
      if (jsonObj.get("configuration") != null && !jsonObj.get("configuration").isJsonNull()) {
        AudienceConfiguration.validateJsonElement(jsonObj.get("configuration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudiencePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudiencePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudiencePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudiencePost.class));

       return (TypeAdapter<T>) new TypeAdapter<AudiencePost>() {
           @Override
           public void write(JsonWriter out, AudiencePost value) throws IOException {
           ...
           @Override
           public AudiencePost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AudiencePost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AudiencePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AudiencePost
   * @throws IOException if the JSON string is invalid with respect to AudiencePost
   */
  public static AudiencePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudiencePost.class);
  }

  /**
   * Convert an instance of AudiencePost to an JSON string
   *
   * @return JSON string
   */
