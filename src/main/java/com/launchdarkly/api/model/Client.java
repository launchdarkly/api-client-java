...
public class Client {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, name, description, accountId, clientId, clientSecret, redirectUri, creationDate, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("_clientId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_clientId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_clientId").toString()));
      }
      if ((jsonObj.get("_clientSecret") != null && !jsonObj.get("_clientSecret").isJsonNull()) && !jsonObj.get("_clientSecret").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_clientSecret` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_clientSecret").toString()));
      }
