...
public class ContextInstanceSegmentMembership {
   ...
   * @return the ContextInstanceSegmentMembership instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, contextInstanceSegmentMembership.name) &&
        Objects.equals(this.key, contextInstanceSegmentMembership.key) &&
        Objects.equals(this.description, contextInstanceSegmentMembership.description) &&
        Objects.equals(this.unbounded, contextInstanceSegmentMembership.unbounded) &&
        Objects.equals(this.external, contextInstanceSegmentMembership.external) &&
        Objects.equals(this.isMember, contextInstanceSegmentMembership.isMember) &&
        Objects.equals(this.isIndividuallyTargeted, contextInstanceSegmentMembership.isIndividuallyTargeted) &&
        Objects.equals(this.isRuleTargeted, contextInstanceSegmentMembership.isRuleTargeted) &&
        Objects.equals(this.links, contextInstanceSegmentMembership.links)&&
        Objects.equals(this.additionalProperties, contextInstanceSegmentMembership.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, key, description, unbounded, external, isMember, isIndividuallyTargeted, isRuleTargeted, links, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    isIndividuallyTargeted: ").append(toIndentedString(isIndividuallyTargeted)).append("\n");
    sb.append("    isRuleTargeted: ").append(toIndentedString(isRuleTargeted)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextInstanceSegmentMembership.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextInstanceSegmentMembership is not found in the empty JSON string", ContextInstanceSegmentMembership.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("external").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `external` to be a primitive type in the JSON string but got `%s`", jsonObj.get("external").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContextInstanceSegmentMembership.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContextInstanceSegmentMembership' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContextInstanceSegmentMembership> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContextInstanceSegmentMembership.class));

       return (TypeAdapter<T>) new TypeAdapter<ContextInstanceSegmentMembership>() {
           @Override
           ...
           public ContextInstanceSegmentMembership read(JsonReader in) throws IOException {
             ...
             ContextInstanceSegmentMembership instance = thisAdapter.fromJsonTree(jsonObj);
