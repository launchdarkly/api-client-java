...
public class AiConfigsMetricEventDefaultRep {
  ...
  public AiConfigsMetricEventDefaultRep disabled(@javax.annotation.Nullable Boolean disabled) {
  ...
  public AiConfigsMetricEventDefaultRep value(@javax.annotation.Nullable BigDecimal value) {
    this.value = value;
    return this;
  }
   ...
   * @return the AiConfigsMetricEventDefaultRep instance itself
   */
  public AiConfigsMetricEventDefaultRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiConfigsMetricEventDefaultRep aiConfigsMetricEventDefaultRep = (AiConfigsMetricEventDefaultRep) o;
    return Objects.equals(this.disabled, aiConfigsMetricEventDefaultRep.disabled) &&
        Objects.equals(this.value, aiConfigsMetricEventDefaultRep.value)&&
        Objects.equals(this.additionalProperties, aiConfigsMetricEventDefaultRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disabled, value, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AiConfigsMetricEventDefaultRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiConfigsMetricEventDefaultRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiConfigsMetricEventDefaultRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiConfigsMetricEventDefaultRep is not found in the empty JSON string", AiConfigsMetricEventDefaultRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiConfigsMetricEventDefaultRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiConfigsMetricEventDefaultRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiConfigsMetricEventDefaultRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiConfigsMetricEventDefaultRep.class));

       return (TypeAdapter<T>) new TypeAdapter<AiConfigsMetricEventDefaultRep>() {
           @Override
           public void write(JsonWriter out, AiConfigsMetricEventDefaultRep value) throws IOException {
           ...
           @Override
           public AiConfigsMetricEventDefaultRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiConfigsMetricEventDefaultRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AiConfigsMetricEventDefaultRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AiConfigsMetricEventDefaultRep
   * @throws IOException if the JSON string is invalid with respect to AiConfigsMetricEventDefaultRep
   */
  public static AiConfigsMetricEventDefaultRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiConfigsMetricEventDefaultRep.class);
  }

  /**
   * Convert an instance of AiConfigsMetricEventDefaultRep to an JSON string
   *
   * @return JSON string
   */
