...
public class InsightGroupCollectionMetadata {
   ...
   * @return the InsightGroupCollectionMetadata instance itself
   */
  public InsightGroupCollectionMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InsightGroupCollectionMetadata insightGroupCollectionMetadata = (InsightGroupCollectionMetadata) o;
    return Objects.equals(this.countByIndicator, insightGroupCollectionMetadata.countByIndicator)&&
        Objects.equals(this.additionalProperties, insightGroupCollectionMetadata.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(countByIndicator, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InsightGroupCollectionMetadata {\n");
    sb.append("    countByIndicator: ").append(toIndentedString(countByIndicator)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightGroupCollectionMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightGroupCollectionMetadata is not found in the empty JSON string", InsightGroupCollectionMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the required field `countByIndicator`
      InsightGroupsCountByIndicator.validateJsonElement(jsonObj.get("countByIndicator"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InsightGroupCollectionMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InsightGroupCollectionMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InsightGroupCollectionMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InsightGroupCollectionMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<InsightGroupCollectionMetadata>() {
           @Override
           public void write(JsonWriter out, InsightGroupCollectionMetadata value) throws IOException {
           ...
           @Override
           public InsightGroupCollectionMetadata read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             InsightGroupCollectionMetadata instance = thisAdapter.fromJsonTree(jsonObj);
