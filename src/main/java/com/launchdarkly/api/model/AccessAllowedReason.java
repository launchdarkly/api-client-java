...
public class AccessAllowedReason {
  ...
  public AccessAllowedReason resources(@javax.annotation.Nullable List<String> resources) {
    this.resources = resources;
    return this;
  }

  public AccessAllowedReason addResourcesItem(String resourcesItem) {
  ...
  public AccessAllowedReason notResources(@javax.annotation.Nullable List<String> notResources) {
    this.notResources = notResources;
    return this;
  }

  public AccessAllowedReason addNotResourcesItem(String notResourcesItem) {
  ...
  public AccessAllowedReason actions(@javax.annotation.Nullable List<String> actions) {
    this.actions = actions;
    return this;
  }

  public AccessAllowedReason addActionsItem(String actionsItem) {
  ...
  public AccessAllowedReason notActions(@javax.annotation.Nullable List<String> notActions) {
    this.notActions = notActions;
    return this;
  }

  public AccessAllowedReason addNotActionsItem(String notActionsItem) {
  ...
  public AccessAllowedReason effect(@javax.annotation.Nonnull EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  public AccessAllowedReason roleName(@javax.annotation.Nullable String roleName) {
   ...
   * @return the AccessAllowedReason instance itself
   */
  public AccessAllowedReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccessAllowedReason accessAllowedReason = (AccessAllowedReason) o;
    return Objects.equals(this.resources, accessAllowedReason.resources) &&
        Objects.equals(this.notResources, accessAllowedReason.notResources) &&
        Objects.equals(this.actions, accessAllowedReason.actions) &&
        Objects.equals(this.notActions, accessAllowedReason.notActions) &&
        Objects.equals(this.effect, accessAllowedReason.effect) &&
        Objects.equals(this.roleName, accessAllowedReason.roleName)&&
        Objects.equals(this.additionalProperties, accessAllowedReason.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessAllowedReason {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccessAllowedReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessAllowedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccessAllowedReason is not found in the empty JSON string", AccessAllowedReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessAllowedReason.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessAllowedReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessAllowedReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessAllowedReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessAllowedReason.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessAllowedReason>() {
           @Override
           public void write(JsonWriter out, AccessAllowedReason value) throws IOException {
           ...
           @Override
           public AccessAllowedReason read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AccessAllowedReason instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AccessAllowedReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccessAllowedReason
   * @throws IOException if the JSON string is invalid with respect to AccessAllowedReason
   */
  public static AccessAllowedReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessAllowedReason.class);
  }

  /**
   * Convert an instance of AccessAllowedReason to an JSON string
   *
   * @return JSON string
   */
