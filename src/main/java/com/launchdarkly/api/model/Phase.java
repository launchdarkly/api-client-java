...
public class Phase {
   ...
   * @return the Phase instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Phase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Phase is not found in the empty JSON string", Phase.openapiRequiredFields.toString()));
        }
      }
