...
public class AIToolPatch {
  ...
  public AIToolPatch customParameters(@javax.annotation.Nullable Object customParameters) {
  ...
  public AIToolPatch tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public AIToolPatch addTagsItem(String tagsItem) {
    if (this.tags == null) {
   ...
   * @return the AIToolPatch instance itself
   */
  public AIToolPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIToolPatch aiToolPatch = (AIToolPatch) o;
    return Objects.equals(this.maintainerId, aiToolPatch.maintainerId) &&
        Objects.equals(this.maintainerTeamKey, aiToolPatch.maintainerTeamKey) &&
        Objects.equals(this.description, aiToolPatch.description) &&
        Objects.equals(this.schema, aiToolPatch.schema) &&
        Objects.equals(this.customParameters, aiToolPatch.customParameters) &&
        Objects.equals(this.tags, aiToolPatch.tags)&&
        Objects.equals(this.additionalProperties, aiToolPatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maintainerId, maintainerTeamKey, description, schema, customParameters, tags, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIToolPatch {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("maintainerId", "maintainerTeamKey", "description", "schema", "customParameters", "tags"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIToolPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIToolPatch is not found in the empty JSON string", AIToolPatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIToolPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIToolPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIToolPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIToolPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<AIToolPatch>() {
           @Override
           public void write(JsonWriter out, AIToolPatch value) throws IOException {
           ...
           @Override
           public AIToolPatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIToolPatch instance = thisAdapter.fromJsonTree(jsonObj);
