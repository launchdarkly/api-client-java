...
public class AIConfigMaintainer extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<AIConfigMaintainer>() {
                ...
                public void write(JsonWriter out, AIConfigMaintainer value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof AiConfigsMaintainerTeam) {
                        JsonObject obj = adapterAiConfigsMaintainerTeam.toJsonTree((AiConfigsMaintainerTeam)value.getActualInstance()).getAsJsonObject();
                    ...
                    if (value.getActualInstance() instanceof MaintainerMember) {
                        JsonObject obj = adapterMaintainerMember.toJsonTree((MaintainerMember)value.getActualInstance()).getAsJsonObject();
                        elementAdapter.write(out, obj);
                        return;
                    }
    ...
    static {
        schemas.put("AiConfigsMaintainerTeam", new GenericType<AiConfigsMaintainerTeam>() {
        });
        schemas.put("MaintainerMember", new GenericType<MaintainerMember>() {
        });
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AIConfigMaintainer
  */
