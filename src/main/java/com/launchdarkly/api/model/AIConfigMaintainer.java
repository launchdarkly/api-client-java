...
public class AIConfigMaintainer extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AIConfigMaintainer.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AIConfigMaintainer' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AIConfigMaintainer>() {
                @Override
                ...
                public AIConfigMaintainer read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for AIConfigMaintainer: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return AIConfigMaintainer.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to AIConfigMaintainer
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for AIConfigMaintainer with oneOf schemas: AiConfigsMaintainerTeam, MaintainerMember. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of AIConfigMaintainer given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AIConfigMaintainer
     * @throws IOException if the JSON string is invalid with respect to AIConfigMaintainer
     */
    public static AIConfigMaintainer fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AIConfigMaintainer.class);
    }

    /**
     * Convert an instance of AIConfigMaintainer to an JSON string
     *
     * @return JSON string
     */
