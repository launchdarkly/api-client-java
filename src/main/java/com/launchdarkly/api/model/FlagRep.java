...
public class FlagRep {
   ...
   * @return the FlagRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagRep is not found in the empty JSON string", FlagRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("targetingRule") != null && !jsonObj.get("targetingRule").isJsonNull()) && !jsonObj.get("targetingRule").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `targetingRule` to be a primitive type in the JSON string but got `%s`", jsonObj.get("targetingRule").toString()));
      }
      if ((jsonObj.get("targetingRuleDescription") != null && !jsonObj.get("targetingRuleDescription").isJsonNull()) && !jsonObj.get("targetingRuleDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `targetingRuleDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("targetingRuleDescription").toString()));
      }
      ...
      if (jsonObj.get("targetingRuleClauses") != null && !jsonObj.get("targetingRuleClauses").isJsonNull() && !jsonObj.get("targetingRuleClauses").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `targetingRuleClauses` to be an array in the JSON string but got `%s`", jsonObj.get("targetingRuleClauses").toString()));
      }
      if ((jsonObj.get("notInExperimentVariationId") != null && !jsonObj.get("notInExperimentVariationId").isJsonNull()) && !jsonObj.get("notInExperimentVariationId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `notInExperimentVariationId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("notInExperimentVariationId").toString()));
      }
  }
