...
public class AIConfigRep {
  ...
  public AIConfigRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public AIConfigRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the AIConfigRep instance itself
   */
  public AIConfigRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigRep aiConfigRep = (AIConfigRep) o;
    return Objects.equals(this.key, aiConfigRep.key) &&
        Objects.equals(this.name, aiConfigRep.name)&&
        Objects.equals(this.additionalProperties, aiConfigRep.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigRep is not found in the empty JSON string", AIConfigRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AIConfigRep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigRep.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigRep>() {
           @Override
           public void write(JsonWriter out, AIConfigRep value) throws IOException {
           ...
           @Override
           public AIConfigRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigRep
   * @throws IOException if the JSON string is invalid with respect to AIConfigRep
   */
  public static AIConfigRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigRep.class);
  }

  /**
   * Convert an instance of AIConfigRep to an JSON string
   *
   * @return JSON string
   */
