...
public class AIConfigRep {
  ...
  public AIConfigRep key(String key) {
    this.key = key;
    return this;
  }
  ...
  **/
  ...
  public AIConfigRep name(String name) {
    this.name = name;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AIConfigRep is not found in the empty JSON string", AIConfigRep.openapiRequiredFields.toString()));
        }
      }
