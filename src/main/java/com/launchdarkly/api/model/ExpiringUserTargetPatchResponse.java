...
public class ExpiringUserTargetPatchResponse {
  ...
  public ExpiringUserTargetPatchResponse items(@javax.annotation.Nonnull List<ExpiringUserTargetItem> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<ExpiringUserTargetItem> items) {
    this.items = items;
  }


  public ExpiringUserTargetPatchResponse links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public ExpiringUserTargetPatchResponse totalInstructions(@javax.annotation.Nullable Integer totalInstructions) {
  ...
  public ExpiringUserTargetPatchResponse successfulInstructions(@javax.annotation.Nullable Integer successfulInstructions) {
  ...
  public ExpiringUserTargetPatchResponse failedInstructions(@javax.annotation.Nullable Integer failedInstructions) {
  ...
  public ExpiringUserTargetPatchResponse errors(@javax.annotation.Nullable List<ExpiringTargetError> errors) {
    this.errors = errors;
    return this;
  }
   ...
   * @return the ExpiringUserTargetPatchResponse instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpiringUserTargetPatchResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpiringUserTargetPatchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpiringUserTargetPatchResponse is not found in the empty JSON string", ExpiringUserTargetPatchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ExpiringUserTargetItem.validateJsonElement(jsonArrayitems.get(i));
      };
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            ExpiringTargetError.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
