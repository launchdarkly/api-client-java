...
public class CustomWorkflowsListingOutput {
  ...
  public CustomWorkflowsListingOutput addItemsItem(CustomWorkflowOutput itemsItem) {
    if (this.items == null) {
  ...
  public CustomWorkflowsListingOutput putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the CustomWorkflowsListingOutput instance itself
   */
  public CustomWorkflowsListingOutput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CustomWorkflowsListingOutput customWorkflowsListingOutput = (CustomWorkflowsListingOutput) o;
    return Objects.equals(this.items, customWorkflowsListingOutput.items) &&
        Objects.equals(this.totalCount, customWorkflowsListingOutput.totalCount) &&
        Objects.equals(this.links, customWorkflowsListingOutput.links)&&
        Objects.equals(this.additionalProperties, customWorkflowsListingOutput.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomWorkflowsListingOutput {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomWorkflowsListingOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomWorkflowsListingOutput is not found in the empty JSON string", CustomWorkflowsListingOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        CustomWorkflowOutput.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomWorkflowsListingOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomWorkflowsListingOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomWorkflowsListingOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomWorkflowsListingOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomWorkflowsListingOutput>() {
           @Override
           public void write(JsonWriter out, CustomWorkflowsListingOutput value) throws IOException {
           ...
           @Override
           public CustomWorkflowsListingOutput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CustomWorkflowsListingOutput instance = thisAdapter.fromJsonTree(jsonObj);
