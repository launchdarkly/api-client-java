  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeatureFlagConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FeatureFlagConfig is not found in the empty JSON string", FeatureFlagConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("sel").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sel` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sel").toString()));
      }
      ...
      if (jsonObj.get("prerequisites") != null && !jsonObj.get("prerequisites").isJsonNull()) {
        ...
        if (jsonArrayprerequisites != null) {
          ...
          if (!jsonObj.get("prerequisites").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `prerequisites` to be an array in the JSON string but got `%s`", jsonObj.get("prerequisites").toString()));
          }
