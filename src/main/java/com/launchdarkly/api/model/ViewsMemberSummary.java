...
public class ViewsMemberSummary {
  ...
  public ViewsMemberSummary links(@javax.annotation.Nonnull Map<String, ViewsLink> links) {
    this.links = links;
    return this;
  }

  public ViewsMemberSummary putLinksItem(String key, ViewsLink linksItem) {
    if (this.links == null) {
  ...
  public void setLinks(@javax.annotation.Nonnull Map<String, ViewsLink> links) {
    this.links = links;
  }


  public ViewsMemberSummary id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ViewsMemberSummary firstName(@javax.annotation.Nullable String firstName) {
  ...
  public ViewsMemberSummary lastName(@javax.annotation.Nullable String lastName) {
  ...
  public ViewsMemberSummary role(@javax.annotation.Nonnull String role) {
    this.role = role;
    return this;
  }
  ...
  public ViewsMemberSummary email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
   ...
   * @return the ViewsMemberSummary instance itself
   */
  public ViewsMemberSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewsMemberSummary viewsMemberSummary = (ViewsMemberSummary) o;
    return Objects.equals(this.links, viewsMemberSummary.links) &&
        Objects.equals(this.id, viewsMemberSummary.id) &&
        Objects.equals(this.firstName, viewsMemberSummary.firstName) &&
        Objects.equals(this.lastName, viewsMemberSummary.lastName) &&
        Objects.equals(this.role, viewsMemberSummary.role) &&
        Objects.equals(this.email, viewsMemberSummary.email)&&
        Objects.equals(this.additionalProperties, viewsMemberSummary.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewsMemberSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewsMemberSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsMemberSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewsMemberSummary is not found in the empty JSON string", ViewsMemberSummary.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewsMemberSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewsMemberSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewsMemberSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewsMemberSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewsMemberSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewsMemberSummary>() {
           @Override
           public void write(JsonWriter out, ViewsMemberSummary value) throws IOException {
           ...
           @Override
           public ViewsMemberSummary read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewsMemberSummary instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewsMemberSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewsMemberSummary
   * @throws IOException if the JSON string is invalid with respect to ViewsMemberSummary
   */
  public static ViewsMemberSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewsMemberSummary.class);
  }

  /**
   * Convert an instance of ViewsMemberSummary to an JSON string
   *
   * @return JSON string
   */
