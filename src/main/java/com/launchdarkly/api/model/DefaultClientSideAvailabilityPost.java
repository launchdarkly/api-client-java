...
public class DefaultClientSideAvailabilityPost {
   ...
   * @return the DefaultClientSideAvailabilityPost instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DefaultClientSideAvailabilityPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DefaultClientSideAvailabilityPost is not found in the empty JSON string", DefaultClientSideAvailabilityPost.openapiRequiredFields.toString()));
        }
      }
