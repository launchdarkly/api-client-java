...
public class RepositoryCollectionRep {
  ...
  @javax.annotation.Nonnull
  private List<RepositoryRep> items = new ArrayList<>();

  public RepositoryCollectionRep() {
  }

  public RepositoryCollectionRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public RepositoryCollectionRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public RepositoryCollectionRep items(@javax.annotation.Nonnull List<RepositoryRep> items) {
    this.items = items;
    return this;
  }

  public RepositoryCollectionRep addItemsItem(RepositoryRep itemsItem) {
    if (this.items == null) {
  ...
  public void setItems(@javax.annotation.Nonnull List<RepositoryRep> items) {
    this.items = items;
  }
   ...
   * @return the RepositoryCollectionRep instance itself
   */
  public RepositoryCollectionRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RepositoryCollectionRep repositoryCollectionRep = (RepositoryCollectionRep) o;
    return Objects.equals(this.links, repositoryCollectionRep.links) &&
        Objects.equals(this.items, repositoryCollectionRep.items)&&
        Objects.equals(this.additionalProperties, repositoryCollectionRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepositoryCollectionRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepositoryCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RepositoryCollectionRep is not found in the empty JSON string", RepositoryCollectionRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RepositoryCollectionRep.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        RepositoryRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryCollectionRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryCollectionRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryCollectionRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryCollectionRep.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryCollectionRep>() {
           @Override
           public void write(JsonWriter out, RepositoryCollectionRep value) throws IOException {
           ...
           @Override
           public RepositoryCollectionRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RepositoryCollectionRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of RepositoryCollectionRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepositoryCollectionRep
   * @throws IOException if the JSON string is invalid with respect to RepositoryCollectionRep
   */
  public static RepositoryCollectionRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryCollectionRep.class);
  }

  /**
   * Convert an instance of RepositoryCollectionRep to an JSON string
   *
   * @return JSON string
   */
