...
public class HeaderItems {
  ...
  public HeaderItems name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public HeaderItems value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
   ...
   * @return the HeaderItems instance itself
   */
  public HeaderItems putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    HeaderItems headerItems = (HeaderItems) o;
    return Objects.equals(this.name, headerItems.name) &&
        Objects.equals(this.value, headerItems.value)&&
        Objects.equals(this.additionalProperties, headerItems.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HeaderItems
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HeaderItems.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HeaderItems is not found in the empty JSON string", HeaderItems.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HeaderItems.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HeaderItems' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HeaderItems> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HeaderItems.class));

       return (TypeAdapter<T>) new TypeAdapter<HeaderItems>() {
           @Override
           public void write(JsonWriter out, HeaderItems value) throws IOException {
           ...
           @Override
           public HeaderItems read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             HeaderItems instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of HeaderItems given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HeaderItems
   * @throws IOException if the JSON string is invalid with respect to HeaderItems
   */
  public static HeaderItems fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HeaderItems.class);
  }

  /**
   * Convert an instance of HeaderItems to an JSON string
   *
   * @return JSON string
   */
