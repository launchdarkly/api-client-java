...
public class HeaderItems {
  ...
  public HeaderItems name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public HeaderItems value(String value) {
    this.value = value;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HeaderItems.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HeaderItems is not found in the empty JSON string", HeaderItems.openapiRequiredFields.toString()));
        }
      }
