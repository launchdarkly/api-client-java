...
public class SdkListRep {
  ...
  public SdkListRep links(@javax.annotation.Nonnull Map<String, Object> links) {
    this.links = links;
    return this;
  }

  public SdkListRep putLinksItem(String key, Object linksItem) {
    if (this.links == null) {
  ...
  public SdkListRep sdks(@javax.annotation.Nonnull List<String> sdks) {
    this.sdks = sdks;
    return this;
  }

  public SdkListRep addSdksItem(String sdksItem) {
    if (this.sdks == null) {
  ...
  public void setSdks(@javax.annotation.Nonnull List<String> sdks) {
    this.sdks = sdks;
  }
   ...
   * @return the SdkListRep instance itself
   */
  public SdkListRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SdkListRep sdkListRep = (SdkListRep) o;
    return Objects.equals(this.links, sdkListRep.links) &&
        Objects.equals(this.sdks, sdkListRep.sdks)&&
        Objects.equals(this.additionalProperties, sdkListRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, sdks, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SdkListRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "sdks"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_links", "sdks"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SdkListRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SdkListRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SdkListRep is not found in the empty JSON string", SdkListRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SdkListRep.openapiRequiredFields) {
      ...
      if (jsonObj.get("sdks") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("sdks").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sdks` to be an array in the JSON string but got `%s`", jsonObj.get("sdks").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SdkListRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SdkListRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SdkListRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SdkListRep.class));

       return (TypeAdapter<T>) new TypeAdapter<SdkListRep>() {
           @Override
           public void write(JsonWriter out, SdkListRep value) throws IOException {
           ...
           @Override
           public SdkListRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SdkListRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SdkListRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SdkListRep
   * @throws IOException if the JSON string is invalid with respect to SdkListRep
   */
  public static SdkListRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SdkListRep.class);
  }

  /**
   * Convert an instance of SdkListRep to an JSON string
   *
   * @return JSON string
   */
