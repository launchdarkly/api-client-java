...
public class AuditLogEntryListingRep {
  ...
  public AuditLogEntryListingRep relatedFlag(@javax.annotation.Nullable RelatedFlag relatedFlag) {
  ...
  public AuditLogEntryListingRep relatedExperiment(@javax.annotation.Nullable RelatedExperiment relatedExperiment) {
  ...
  public AuditLogEntryListingRep relatedAIConfig(@javax.annotation.Nullable RelatedAIConfig relatedAIConfig) {
   ...
   * @return the AuditLogEntryListingRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, auditLogEntryListingRep.links) &&
        Objects.equals(this.id, auditLogEntryListingRep.id) &&
        Objects.equals(this.accountId, auditLogEntryListingRep.accountId) &&
        Objects.equals(this.date, auditLogEntryListingRep.date) &&
        Objects.equals(this.accesses, auditLogEntryListingRep.accesses) &&
        Objects.equals(this.kind, auditLogEntryListingRep.kind) &&
        Objects.equals(this.name, auditLogEntryListingRep.name) &&
        Objects.equals(this.description, auditLogEntryListingRep.description) &&
        Objects.equals(this.shortDescription, auditLogEntryListingRep.shortDescription) &&
        Objects.equals(this.comment, auditLogEntryListingRep.comment) &&
        Objects.equals(this.relatedFlag, auditLogEntryListingRep.relatedFlag) &&
        Objects.equals(this.relatedExperiment, auditLogEntryListingRep.relatedExperiment) &&
        Objects.equals(this.relatedAIConfig, auditLogEntryListingRep.relatedAIConfig) &&
        Objects.equals(this.subject, auditLogEntryListingRep.subject) &&
        Objects.equals(this.member, auditLogEntryListingRep.member) &&
        Objects.equals(this.token, auditLogEntryListingRep.token) &&
        Objects.equals(this.app, auditLogEntryListingRep.app) &&
        Objects.equals(this.titleVerb, auditLogEntryListingRep.titleVerb) &&
        Objects.equals(this.title, auditLogEntryListingRep.title) &&
        Objects.equals(this.target, auditLogEntryListingRep.target) &&
        Objects.equals(this.parent, auditLogEntryListingRep.parent)&&
        Objects.equals(this.additionalProperties, auditLogEntryListingRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, id, accountId, date, accesses, kind, name, description, shortDescription, comment, relatedFlag, relatedExperiment, relatedAIConfig, subject, member, token, app, titleVerb, title, target, parent, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "_id", "_accountId", "date", "accesses", "kind", "name", "description", "shortDescription", "comment", "relatedFlag", "relatedExperiment", "relatedAIConfig", "subject", "member", "token", "app", "titleVerb", "title", "target", "parent"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditLogEntryListingRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuditLogEntryListingRep is not found in the empty JSON string", AuditLogEntryListingRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuditLogEntryListingRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuditLogEntryListingRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuditLogEntryListingRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuditLogEntryListingRep.class));

       return (TypeAdapter<T>) new TypeAdapter<AuditLogEntryListingRep>() {
           @Override
           ...
           public AuditLogEntryListingRep read(JsonReader in) throws IOException {
             ...
             AuditLogEntryListingRep instance = thisAdapter.fromJsonTree(jsonObj);
