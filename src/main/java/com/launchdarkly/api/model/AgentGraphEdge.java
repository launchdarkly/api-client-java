...
public class AgentGraphEdge {
  ...
  public AgentGraphEdge targetConfig(@javax.annotation.Nonnull String targetConfig) {
  ...
  public AgentGraphEdge handoff(@javax.annotation.Nullable Object handoff) {
   ...
   * @return the AgentGraphEdge instance itself
   */
  public AgentGraphEdge putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentGraphEdge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentGraphEdge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentGraphEdge is not found in the empty JSON string", AgentGraphEdge.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentGraphEdge.openapiRequiredFields) {
      ...
      if (!jsonObj.get("sourceConfig").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sourceConfig` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sourceConfig").toString()));
      }
      if (!jsonObj.get("targetConfig").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `targetConfig` to be a primitive type in the JSON string but got `%s`", jsonObj.get("targetConfig").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentGraphEdge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentGraphEdge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentGraphEdge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentGraphEdge.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentGraphEdge>() {
           @Override
           public void write(JsonWriter out, AgentGraphEdge value) throws IOException {
           ...
           @Override
           public AgentGraphEdge read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentGraphEdge instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentGraphEdge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentGraphEdge
   * @throws IOException if the JSON string is invalid with respect to AgentGraphEdge
   */
  public static AgentGraphEdge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentGraphEdge.class);
  }

  /**
   * Convert an instance of AgentGraphEdge to an JSON string
   *
   * @return JSON string
   */
