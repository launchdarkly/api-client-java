...
public class LastSeenMetadata {
   ...
   * @return the LastSeenMetadata instance itself
   */
  public LastSeenMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LastSeenMetadata lastSeenMetadata = (LastSeenMetadata) o;
    return Objects.equals(this.tokenId, lastSeenMetadata.tokenId)&&
        Objects.equals(this.additionalProperties, lastSeenMetadata.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LastSeenMetadata {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LastSeenMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LastSeenMetadata is not found in the empty JSON string", LastSeenMetadata.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LastSeenMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LastSeenMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LastSeenMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LastSeenMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<LastSeenMetadata>() {
           @Override
           public void write(JsonWriter out, LastSeenMetadata value) throws IOException {
           ...
           @Override
           public LastSeenMetadata read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             LastSeenMetadata instance = thisAdapter.fromJsonTree(jsonObj);
