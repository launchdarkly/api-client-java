...
public class PromptSnippetPost {
  ...
  public PromptSnippetPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public PromptSnippetPost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public PromptSnippetPost description(@javax.annotation.Nullable String description) {
  ...
  public PromptSnippetPost text(@javax.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
  ...
  public PromptSnippetPost maintainerId(@javax.annotation.Nullable String maintainerId) {
  ...
  public PromptSnippetPost maintainerTeamKey(@javax.annotation.Nullable String maintainerTeamKey) {
  ...
  public PromptSnippetPost tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PromptSnippetPost addTagsItem(String tagsItem) {
    if (this.tags == null) {
   ...
   * @return the PromptSnippetPost instance itself
   */
  public PromptSnippetPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PromptSnippetPost promptSnippetPost = (PromptSnippetPost) o;
    return Objects.equals(this.key, promptSnippetPost.key) &&
        Objects.equals(this.name, promptSnippetPost.name) &&
        Objects.equals(this.description, promptSnippetPost.description) &&
        Objects.equals(this.text, promptSnippetPost.text) &&
        Objects.equals(this.maintainerId, promptSnippetPost.maintainerId) &&
        Objects.equals(this.maintainerTeamKey, promptSnippetPost.maintainerTeamKey) &&
        Objects.equals(this.tags, promptSnippetPost.tags)&&
        Objects.equals(this.additionalProperties, promptSnippetPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, text, maintainerId, maintainerTeamKey, tags, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PromptSnippetPost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "description", "text", "maintainerId", "maintainerTeamKey", "tags"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "name", "text"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromptSnippetPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptSnippetPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptSnippetPost is not found in the empty JSON string", PromptSnippetPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromptSnippetPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromptSnippetPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromptSnippetPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromptSnippetPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromptSnippetPost.class));

       return (TypeAdapter<T>) new TypeAdapter<PromptSnippetPost>() {
           @Override
           public void write(JsonWriter out, PromptSnippetPost value) throws IOException {
           ...
           @Override
           public PromptSnippetPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PromptSnippetPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PromptSnippetPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromptSnippetPost
   * @throws IOException if the JSON string is invalid with respect to PromptSnippetPost
   */
  public static PromptSnippetPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromptSnippetPost.class);
  }

  /**
   * Convert an instance of PromptSnippetPost to an JSON string
   *
   * @return JSON string
   */
