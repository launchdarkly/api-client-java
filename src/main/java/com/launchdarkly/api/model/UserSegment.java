...
public class UserSegment {
  ...
  public UserSegment addIncludedContextsItem(SegmentTarget includedContextsItem) {
    ...
    this.includedContexts.add(includedContextsItem);
    return this;
  }
  ...
  public UserSegment addExcludedContextsItem(SegmentTarget excludedContextsItem) {
    ...
    this.excludedContexts.add(excludedContextsItem);
    return this;
  }
   ...
   * @return the UserSegment instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, userSegment.name) &&
        ...
        Objects.equals(this.lastModifiedDate, userSegment.lastModifiedDate) &&
        ...
        Objects.equals(this.includedContexts, userSegment.includedContexts) &&
        Objects.equals(this.excludedContexts, userSegment.excludedContexts) &&
        ...
        Objects.equals(this.deleted, userSegment.deleted) &&
        Objects.equals(this.access, userSegment.access) &&
        Objects.equals(this.flags, userSegment.flags) &&
        Objects.equals(this.unbounded, userSegment.unbounded) &&
        Objects.equals(this.unboundedContextKind, userSegment.unboundedContextKind) &&
        ...
        Objects.equals(this.additionalProperties, userSegment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, tags, creationDate, lastModifiedDate, key, included, excluded, includedContexts, excludedContexts, links, rules, version, deleted, access, flags, unbounded, unboundedContextKind, generation, unboundedMetadata, external, externalLink, importInProgress, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    includedContexts: ").append(toIndentedString(includedContexts)).append("\n");
    sb.append("    excludedContexts: ").append(toIndentedString(excludedContexts)).append("\n");
    ...
    sb.append("    unboundedContextKind: ").append(toIndentedString(unboundedContextKind)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserSegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserSegment is not found in the empty JSON string", UserSegment.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull() && !jsonObj.get("included").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `included` to be an array in the JSON string but got `%s`", jsonObj.get("included").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("excluded") != null && !jsonObj.get("excluded").isJsonNull() && !jsonObj.get("excluded").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `excluded` to be an array in the JSON string but got `%s`", jsonObj.get("excluded").toString()));
      }
      if (jsonObj.get("includedContexts") != null && !jsonObj.get("includedContexts").isJsonNull()) {
        ...
        if (jsonArrayincludedContexts != null) {
          ...
          if (!jsonObj.get("includedContexts").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `includedContexts` to be an array in the JSON string but got `%s`", jsonObj.get("includedContexts").toString()));
          }

          // validate the optional field `includedContexts` (array)
          for (int i = 0; i < jsonArrayincludedContexts.size(); i++) {
            SegmentTarget.validateJsonElement(jsonArrayincludedContexts.get(i));
          };
        }
      }
      if (jsonObj.get("excludedContexts") != null && !jsonObj.get("excludedContexts").isJsonNull()) {
        JsonArray jsonArrayexcludedContexts = jsonObj.getAsJsonArray("excludedContexts");
        if (jsonArrayexcludedContexts != null) {
          // ensure the json data is an array
          if (!jsonObj.get("excludedContexts").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `excludedContexts` to be an array in the JSON string but got `%s`", jsonObj.get("excludedContexts").toString()));
          }

          // validate the optional field `excludedContexts` (array)
          for (int i = 0; i < jsonArrayexcludedContexts.size(); i++) {
            SegmentTarget.validateJsonElement(jsonArrayexcludedContexts.get(i));
          };
        }
      }
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayrules.size(); i++) {
        UserSegmentRule.validateJsonElement(jsonArrayrules.get(i));
      };
      ...
      if (jsonObj.get("_flags") != null && !jsonObj.get("_flags").isJsonNull()) {
        JsonArray jsonArrayflags = jsonObj.getAsJsonArray("_flags");
        if (jsonArrayflags != null) {
          // ensure the json data is an array
          if (!jsonObj.get("_flags").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_flags` to be an array in the JSON string but got `%s`", jsonObj.get("_flags").toString()));
          }

          // validate the optional field `_flags` (array)
          for (int i = 0; i < jsonArrayflags.size(); i++) {
            FlagListingRep.validateJsonElement(jsonArrayflags.get(i));
          };
        }
      }
      if ((jsonObj.get("unboundedContextKind") != null && !jsonObj.get("unboundedContextKind").isJsonNull()) && !jsonObj.get("unboundedContextKind").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `unboundedContextKind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("unboundedContextKind").toString()));
      }
      ...
      if ((jsonObj.get("_external") != null && !jsonObj.get("_external").isJsonNull()) && !jsonObj.get("_external").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_external` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_external").toString()));
      }
      if ((jsonObj.get("_externalLink") != null && !jsonObj.get("_externalLink").isJsonNull()) && !jsonObj.get("_externalLink").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_externalLink` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_externalLink").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserSegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserSegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserSegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserSegment.class));

       return (TypeAdapter<T>) new TypeAdapter<UserSegment>() {
           @Override
           ...
           public UserSegment read(JsonReader in) throws IOException {
             ...
             UserSegment instance = thisAdapter.fromJsonTree(jsonObj);
