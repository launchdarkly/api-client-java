...
public class UpdateReleasePipelineInput {
   ...
   * @return the UpdateReleasePipelineInput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateReleasePipelineInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateReleasePipelineInput is not found in the empty JSON string", UpdateReleasePipelineInput.openapiRequiredFields.toString()));
        }
      }
