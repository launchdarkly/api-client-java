...
public class Projects {
  ...
  public Projects links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public Projects putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public Projects items(@javax.annotation.Nonnull List<Project> items) {
    this.items = items;
    return this;
  }
  ...
  public Projects totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, projects.links) &&
        ...
        Objects.equals(this.totalCount, projects.totalCount)&&
   ...
   * @throws IOException if the JSON Element is invalid with respect to Projects
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Projects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Projects is not found in the empty JSON string", Projects.openapiRequiredFields.toString()));
        }
      }
