...
public class MetricDataSourceRefRep {
  ...
  public MetricDataSourceRefRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public MetricDataSourceRefRep environmentKey(@javax.annotation.Nullable String environmentKey) {
  ...
  public MetricDataSourceRefRep name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MetricDataSourceRefRep integrationKey(@javax.annotation.Nullable String integrationKey) {
   ...
   * @return the MetricDataSourceRefRep instance itself
   */
  public MetricDataSourceRefRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MetricDataSourceRefRep metricDataSourceRefRep = (MetricDataSourceRefRep) o;
    return Objects.equals(this.key, metricDataSourceRefRep.key) &&
        Objects.equals(this.environmentKey, metricDataSourceRefRep.environmentKey) &&
        Objects.equals(this.name, metricDataSourceRefRep.name) &&
        Objects.equals(this.integrationKey, metricDataSourceRefRep.integrationKey)&&
        Objects.equals(this.additionalProperties, metricDataSourceRefRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, environmentKey, name, integrationKey, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MetricDataSourceRefRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricDataSourceRefRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricDataSourceRefRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricDataSourceRefRep is not found in the empty JSON string", MetricDataSourceRefRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetricDataSourceRefRep.openapiRequiredFields) {
      ...
      if ((jsonObj.get("_name") != null && !jsonObj.get("_name").isJsonNull()) && !jsonObj.get("_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_name").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricDataSourceRefRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricDataSourceRefRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricDataSourceRefRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricDataSourceRefRep.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricDataSourceRefRep>() {
           @Override
           public void write(JsonWriter out, MetricDataSourceRefRep value) throws IOException {
           ...
           @Override
           public MetricDataSourceRefRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MetricDataSourceRefRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MetricDataSourceRefRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetricDataSourceRefRep
   * @throws IOException if the JSON string is invalid with respect to MetricDataSourceRefRep
   */
  public static MetricDataSourceRefRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricDataSourceRefRep.class);
  }

  /**
   * Convert an instance of MetricDataSourceRefRep to an JSON string
   *
   * @return JSON string
   */
