...
public class MetricDataSourceRefRep {
  ...
  public MetricDataSourceRefRep key(String key) {
    this.key = key;
    return this;
  }
  ...
  **/
  ...
  public MetricDataSourceRefRep environmentKey(String environmentKey) {
  ...
  **/
  ...
  public MetricDataSourceRefRep name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public MetricDataSourceRefRep integrationKey(String integrationKey) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricDataSourceRefRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetricDataSourceRefRep is not found in the empty JSON string", MetricDataSourceRefRep.openapiRequiredFields.toString()));
        }
      }
