...
public class PostInsightGroupParams {
  ...
  public PostInsightGroupParams name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public PostInsightGroupParams key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public PostInsightGroupParams projectKey(@javax.annotation.Nonnull String projectKey) {
  ...
  public PostInsightGroupParams environmentKey(@javax.annotation.Nonnull String environmentKey) {
  ...
  public PostInsightGroupParams applicationKeys(@javax.annotation.Nullable List<String> applicationKeys) {
    this.applicationKeys = applicationKeys;
    return this;
  }

  public PostInsightGroupParams addApplicationKeysItem(String applicationKeysItem) {
   ...
   * @return the PostInsightGroupParams instance itself
   */
  public PostInsightGroupParams putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PostInsightGroupParams postInsightGroupParams = (PostInsightGroupParams) o;
    return Objects.equals(this.name, postInsightGroupParams.name) &&
        Objects.equals(this.key, postInsightGroupParams.key) &&
        Objects.equals(this.projectKey, postInsightGroupParams.projectKey) &&
        Objects.equals(this.environmentKey, postInsightGroupParams.environmentKey) &&
        Objects.equals(this.applicationKeys, postInsightGroupParams.applicationKeys)&&
        Objects.equals(this.additionalProperties, postInsightGroupParams.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, key, projectKey, environmentKey, applicationKeys, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostInsightGroupParams {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "key", "projectKey", "environmentKey", "applicationKeys"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "key", "projectKey", "environmentKey"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostInsightGroupParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostInsightGroupParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostInsightGroupParams is not found in the empty JSON string", PostInsightGroupParams.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostInsightGroupParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostInsightGroupParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostInsightGroupParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostInsightGroupParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostInsightGroupParams.class));

       return (TypeAdapter<T>) new TypeAdapter<PostInsightGroupParams>() {
           @Override
           public void write(JsonWriter out, PostInsightGroupParams value) throws IOException {
           ...
           @Override
           public PostInsightGroupParams read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PostInsightGroupParams instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PostInsightGroupParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostInsightGroupParams
   * @throws IOException if the JSON string is invalid with respect to PostInsightGroupParams
   */
  public static PostInsightGroupParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostInsightGroupParams.class);
  }

  /**
   * Convert an instance of PostInsightGroupParams to an JSON string
   *
   * @return JSON string
   */
