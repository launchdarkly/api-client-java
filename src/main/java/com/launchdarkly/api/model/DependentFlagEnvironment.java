...
public class DependentFlagEnvironment {
  ...
  public DependentFlagEnvironment name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public DependentFlagEnvironment key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public DependentFlagEnvironment links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public DependentFlagEnvironment site(@javax.annotation.Nonnull Link site) {
    this.site = site;
    return this;
  }
   ...
   * @return the DependentFlagEnvironment instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, dependentFlagEnvironment.name) &&
        ...
        Objects.equals(this.additionalProperties, dependentFlagEnvironment.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DependentFlagEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DependentFlagEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DependentFlagEnvironment is not found in the empty JSON string", DependentFlagEnvironment.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DependentFlagEnvironment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DependentFlagEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DependentFlagEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DependentFlagEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DependentFlagEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<DependentFlagEnvironment>() {
           @Override
           ...
           public DependentFlagEnvironment read(JsonReader in) throws IOException {
             ...
             DependentFlagEnvironment instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of DependentFlagEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DependentFlagEnvironment
   * @throws IOException if the JSON string is invalid with respect to DependentFlagEnvironment
   */
  public static DependentFlagEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DependentFlagEnvironment.class);
  }

  /**
   * Convert an instance of DependentFlagEnvironment to an JSON string
   *
   * @return JSON string
   */
