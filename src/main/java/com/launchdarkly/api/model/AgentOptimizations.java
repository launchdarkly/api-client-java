...
public class AgentOptimizations {
  ...
  private List<AgentOptimization> items = new ArrayList<>();
  ...
  public AgentOptimizations links(@javax.annotation.Nullable PaginatedLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AgentOptimizations items(@javax.annotation.Nonnull List<AgentOptimization> items) {
    this.items = items;
    return this;
  }

  public AgentOptimizations addItemsItem(AgentOptimization itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<AgentOptimization> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<AgentOptimization> items) {
    this.items = items;
  }


  public AgentOptimizations totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the AgentOptimizations instance itself
   */
  public AgentOptimizations putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AgentOptimizations agentOptimizations = (AgentOptimizations) o;
    return Objects.equals(this.links, agentOptimizations.links) &&
        Objects.equals(this.items, agentOptimizations.items) &&
        Objects.equals(this.totalCount, agentOptimizations.totalCount)&&
        Objects.equals(this.additionalProperties, agentOptimizations.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AgentOptimizations {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentOptimizations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentOptimizations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentOptimizations is not found in the empty JSON string", AgentOptimizations.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentOptimizations.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        AgentOptimization.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentOptimizations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentOptimizations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentOptimizations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentOptimizations.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentOptimizations>() {
           @Override
           public void write(JsonWriter out, AgentOptimizations value) throws IOException {
           ...
           @Override
           public AgentOptimizations read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentOptimizations instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentOptimizations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentOptimizations
   * @throws IOException if the JSON string is invalid with respect to AgentOptimizations
   */
  public static AgentOptimizations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentOptimizations.class);
  }

  /**
   * Convert an instance of AgentOptimizations to an JSON string
   *
   * @return JSON string
   */
