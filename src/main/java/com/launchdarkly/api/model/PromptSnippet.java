...
public class PromptSnippet {
  ...
  public PromptSnippet key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public PromptSnippet access(@javax.annotation.Nullable AiConfigsAccess access) {
    this.access = access;
    return this;
  }
  ...
  public PromptSnippet links(@javax.annotation.Nullable ParentAndSelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public PromptSnippet maintainer(@javax.annotation.Nullable AIConfigMaintainer maintainer) {
  ...
  public PromptSnippet name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public PromptSnippet description(@javax.annotation.Nullable String description) {
  ...
  public PromptSnippet text(@javax.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
  ...
  public PromptSnippet tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PromptSnippet addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public PromptSnippet version(@javax.annotation.Nonnull Integer version) {
  ...
  public PromptSnippet createdAt(@javax.annotation.Nonnull Long createdAt) {
   ...
   * @return the PromptSnippet instance itself
   */
  public PromptSnippet putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PromptSnippet promptSnippet = (PromptSnippet) o;
    return Objects.equals(this.key, promptSnippet.key) &&
        Objects.equals(this.access, promptSnippet.access) &&
        Objects.equals(this.links, promptSnippet.links) &&
        Objects.equals(this.maintainer, promptSnippet.maintainer) &&
        Objects.equals(this.name, promptSnippet.name) &&
        Objects.equals(this.description, promptSnippet.description) &&
        Objects.equals(this.text, promptSnippet.text) &&
        Objects.equals(this.tags, promptSnippet.tags) &&
        Objects.equals(this.version, promptSnippet.version) &&
        Objects.equals(this.createdAt, promptSnippet.createdAt)&&
        Objects.equals(this.additionalProperties, promptSnippet.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, access, links, maintainer, name, description, text, tags, version, createdAt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PromptSnippet {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "_access", "_links", "_maintainer", "name", "description", "text", "tags", "version", "createdAt"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "name", "text", "tags", "version", "createdAt"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromptSnippet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptSnippet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptSnippet is not found in the empty JSON string", PromptSnippet.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromptSnippet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromptSnippet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromptSnippet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromptSnippet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromptSnippet.class));

       return (TypeAdapter<T>) new TypeAdapter<PromptSnippet>() {
           @Override
           public void write(JsonWriter out, PromptSnippet value) throws IOException {
           ...
           @Override
           public PromptSnippet read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PromptSnippet instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PromptSnippet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromptSnippet
   * @throws IOException if the JSON string is invalid with respect to PromptSnippet
   */
  public static PromptSnippet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromptSnippet.class);
  }

  /**
   * Convert an instance of PromptSnippet to an JSON string
   *
   * @return JSON string
   */
