...
public class CallerIdentityRep {
   ...
   * @return the CallerIdentityRep instance itself
   */
  public CallerIdentityRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CallerIdentityRep callerIdentityRep = (CallerIdentityRep) o;
    return Objects.equals(this.accountId, callerIdentityRep.accountId) &&
        Objects.equals(this.environmentId, callerIdentityRep.environmentId) &&
        Objects.equals(this.projectId, callerIdentityRep.projectId) &&
        Objects.equals(this.environmentName, callerIdentityRep.environmentName) &&
        Objects.equals(this.projectName, callerIdentityRep.projectName) &&
        Objects.equals(this.authKind, callerIdentityRep.authKind) &&
        Objects.equals(this.tokenKind, callerIdentityRep.tokenKind) &&
        Objects.equals(this.clientId, callerIdentityRep.clientId) &&
  ...
  public String toString() {
    ...
    sb.append("class CallerIdentityRep {\n");
    sb.append("    accountId: ").append(toIndentedString(accountId)).append("\n");
    sb.append("    environmentId: ").append(toIndentedString(environmentId)).append("\n");
    sb.append("    projectId: ").append(toIndentedString(projectId)).append("\n");
    sb.append("    environmentName: ").append(toIndentedString(environmentName)).append("\n");
    sb.append("    projectName: ").append(toIndentedString(projectName)).append("\n");
    sb.append("    authKind: ").append(toIndentedString(authKind)).append("\n");
    sb.append("    tokenKind: ").append(toIndentedString(tokenKind)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CallerIdentityRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CallerIdentityRep is not found in the empty JSON string", CallerIdentityRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("authKind") != null && !jsonObj.get("authKind").isJsonNull()) && !jsonObj.get("authKind").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `authKind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authKind").toString()));
      }
      if ((jsonObj.get("tokenKind") != null && !jsonObj.get("tokenKind").isJsonNull()) && !jsonObj.get("tokenKind").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tokenKind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tokenKind").toString()));
      }
      ...
      if ((jsonObj.get("tokenName") != null && !jsonObj.get("tokenName").isJsonNull()) && !jsonObj.get("tokenName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tokenName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tokenName").toString()));
      }
      if ((jsonObj.get("tokenId") != null && !jsonObj.get("tokenId").isJsonNull()) && !jsonObj.get("tokenId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tokenId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tokenId").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CallerIdentityRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CallerIdentityRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CallerIdentityRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CallerIdentityRep.class));

       return (TypeAdapter<T>) new TypeAdapter<CallerIdentityRep>() {
           @Override
           public void write(JsonWriter out, CallerIdentityRep value) throws IOException {
           ...
           @Override
           public CallerIdentityRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CallerIdentityRep instance = thisAdapter.fromJsonTree(jsonObj);
