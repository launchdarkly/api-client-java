...
public class TriggerWorkflowRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, version, creationDate, maintainerId, maintainer, enabled, integrationKey, instructions, lastTriggeredAt, recentTriggerBodies, triggerCount, triggerURL, links, additionalProperties);
  }
