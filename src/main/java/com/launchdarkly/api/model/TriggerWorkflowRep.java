...
public class TriggerWorkflowRep {
  ...
  public static final String SERIALIZED_NAME_LAST_FAILED_AT = "_lastFailedAt";
  @SerializedName(SERIALIZED_NAME_LAST_FAILED_AT)
  @javax.annotation.Nullable
  ...
  public TriggerWorkflowRep status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public TriggerWorkflowRep lastFailedAt(@javax.annotation.Nullable Long lastFailedAt) {
  ...
  public void setLastFailedAt(@javax.annotation.Nullable Long lastFailedAt) {
    this.lastFailedAt = lastFailedAt;
  }
   ...
   * @return the TriggerWorkflowRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, triggerWorkflowRep.id) &&
        ...
        Objects.equals(this.status, triggerWorkflowRep.status) &&
        Objects.equals(this.lastFailedAt, triggerWorkflowRep.lastFailedAt) &&
        ...
        Objects.equals(this.additionalProperties, triggerWorkflowRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, version, creationDate, maintainerId, maintainer, enabled, status, lastFailedAt, integrationKey, instructions, lastTriggeredAt, recentTriggerBodies, triggerCount, triggerURL, links, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "_version", "_creationDate", "_maintainerId", "_maintainer", "enabled", "_status", "_lastFailedAt", "_integrationKey", "instructions", "_lastTriggeredAt", "_recentTriggerBodies", "_triggerCount", "triggerURL", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TriggerWorkflowRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TriggerWorkflowRep is not found in the empty JSON string", TriggerWorkflowRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("_status") != null && !jsonObj.get("_status").isJsonNull()) && !jsonObj.get("_status").isJsonPrimitive()) {
      ...
      if (jsonObj.get("_status") != null && !jsonObj.get("_status").isJsonNull()) {
      ...
      if (jsonObj.get("_recentTriggerBodies") != null && !jsonObj.get("_recentTriggerBodies").isJsonNull()) {
        ...
        if (jsonArrayrecentTriggerBodies != null) {
          ...
          if (!jsonObj.get("_recentTriggerBodies").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_recentTriggerBodies` to be an array in the JSON string but got `%s`", jsonObj.get("_recentTriggerBodies").toString()));
          }
      ...
      if ((jsonObj.get("triggerURL") != null && !jsonObj.get("triggerURL").isJsonNull()) && !jsonObj.get("triggerURL").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `triggerURL` to be a primitive type in the JSON string but got `%s`", jsonObj.get("triggerURL").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TriggerWorkflowRep>() {
           ...
           public TriggerWorkflowRep read(JsonReader in) throws IOException {
             ...
             TriggerWorkflowRep instance = thisAdapter.fromJsonTree(jsonObj);
