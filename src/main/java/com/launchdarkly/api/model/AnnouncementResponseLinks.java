...
public class AnnouncementResponseLinks {
   ...
   * @return the AnnouncementResponseLinks instance itself
   */
  public AnnouncementResponseLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnouncementResponseLinks announcementResponseLinks = (AnnouncementResponseLinks) o;
    return Objects.equals(this.parent, announcementResponseLinks.parent)&&
        Objects.equals(this.additionalProperties, announcementResponseLinks.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnouncementResponseLinks {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnouncementResponseLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AnnouncementResponseLinks is not found in the empty JSON string", AnnouncementResponseLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      AnnouncementLink.validateJsonElement(jsonObj.get("parent"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnouncementResponseLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnouncementResponseLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnouncementResponseLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnouncementResponseLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnouncementResponseLinks>() {
           @Override
           public void write(JsonWriter out, AnnouncementResponseLinks value) throws IOException {
           ...
           @Override
           public AnnouncementResponseLinks read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AnnouncementResponseLinks instance = thisAdapter.fromJsonTree(jsonObj);
