...
public class FlagLinkPost {
   ...
   * @return the FlagLinkPost instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagLinkPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagLinkPost is not found in the empty JSON string", FlagLinkPost.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("deepLink") != null && !jsonObj.get("deepLink").isJsonNull()) && !jsonObj.get("deepLink").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `deepLink` to be a primitive type in the JSON string but got `%s`", jsonObj.get("deepLink").toString()));
      }
