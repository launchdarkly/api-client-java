...
public class AiConfigsLink {
  ...
  public AiConfigsLink href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AiConfigsLink type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the AiConfigsLink instance itself
   */
  public AiConfigsLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiConfigsLink aiConfigsLink = (AiConfigsLink) o;
    return Objects.equals(this.href, aiConfigsLink.href) &&
        Objects.equals(this.type, aiConfigsLink.type)&&
        Objects.equals(this.additionalProperties, aiConfigsLink.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiConfigsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiConfigsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiConfigsLink is not found in the empty JSON string", AiConfigsLink.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiConfigsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiConfigsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiConfigsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiConfigsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<AiConfigsLink>() {
           @Override
           public void write(JsonWriter out, AiConfigsLink value) throws IOException {
           ...
           @Override
           public AiConfigsLink read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiConfigsLink instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AiConfigsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AiConfigsLink
   * @throws IOException if the JSON string is invalid with respect to AiConfigsLink
   */
  public static AiConfigsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiConfigsLink.class);
  }

  /**
   * Convert an instance of AiConfigsLink to an JSON string
   *
   * @return JSON string
   */
