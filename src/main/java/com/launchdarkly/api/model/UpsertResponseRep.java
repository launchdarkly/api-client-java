...
public class UpsertResponseRep {
  ...
  public UpsertResponseRep status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public UpsertResponseRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public UpsertResponseRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the UpsertResponseRep instance itself
   */
  public UpsertResponseRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpsertResponseRep upsertResponseRep = (UpsertResponseRep) o;
    return Objects.equals(this.status, upsertResponseRep.status) &&
        Objects.equals(this.links, upsertResponseRep.links)&&
        Objects.equals(this.additionalProperties, upsertResponseRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpsertResponseRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "_links"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpsertResponseRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertResponseRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpsertResponseRep is not found in the empty JSON string", UpsertResponseRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertResponseRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertResponseRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertResponseRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertResponseRep.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertResponseRep>() {
           @Override
           public void write(JsonWriter out, UpsertResponseRep value) throws IOException {
           ...
           @Override
           public UpsertResponseRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpsertResponseRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpsertResponseRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpsertResponseRep
   * @throws IOException if the JSON string is invalid with respect to UpsertResponseRep
   */
  public static UpsertResponseRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertResponseRep.class);
  }

  /**
   * Convert an instance of UpsertResponseRep to an JSON string
   *
   * @return JSON string
   */
