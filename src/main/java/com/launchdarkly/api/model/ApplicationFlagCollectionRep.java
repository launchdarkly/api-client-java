...
public class ApplicationFlagCollectionRep {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  @javax.annotation.Nullable
  private List<FlagListingRep> items = new ArrayList<>();
  ...
  public ApplicationFlagCollectionRep items(@javax.annotation.Nullable List<FlagListingRep> items) {
    this.items = items;
    return this;
  }

  public ApplicationFlagCollectionRep addItemsItem(FlagListingRep itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<FlagListingRep> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nullable List<FlagListingRep> items) {
    this.items = items;
  }


  public ApplicationFlagCollectionRep totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public ApplicationFlagCollectionRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public ApplicationFlagCollectionRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the ApplicationFlagCollectionRep instance itself
   */
  public ApplicationFlagCollectionRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationFlagCollectionRep applicationFlagCollectionRep = (ApplicationFlagCollectionRep) o;
    return Objects.equals(this.items, applicationFlagCollectionRep.items) &&
        Objects.equals(this.totalCount, applicationFlagCollectionRep.totalCount) &&
        Objects.equals(this.links, applicationFlagCollectionRep.links)&&
        Objects.equals(this.additionalProperties, applicationFlagCollectionRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationFlagCollectionRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationFlagCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationFlagCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApplicationFlagCollectionRep is not found in the empty JSON string", ApplicationFlagCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            FlagListingRep.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationFlagCollectionRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationFlagCollectionRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationFlagCollectionRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationFlagCollectionRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationFlagCollectionRep>() {
           @Override
           public void write(JsonWriter out, ApplicationFlagCollectionRep value) throws IOException {
           ...
           @Override
           public ApplicationFlagCollectionRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ApplicationFlagCollectionRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ApplicationFlagCollectionRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationFlagCollectionRep
   * @throws IOException if the JSON string is invalid with respect to ApplicationFlagCollectionRep
   */
  public static ApplicationFlagCollectionRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationFlagCollectionRep.class);
  }

  /**
   * Convert an instance of ApplicationFlagCollectionRep to an JSON string
   *
   * @return JSON string
   */
