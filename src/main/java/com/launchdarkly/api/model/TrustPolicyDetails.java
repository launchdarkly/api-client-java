...
import com.launchdarkly.api.model.TrustPolicyStatement;
...
public class TrustPolicyDetails {
  ...
  @javax.annotation.Nullable
  private List<TrustPolicyStatement> statement = new ArrayList<>();

  public TrustPolicyDetails() {
  }

  public TrustPolicyDetails version(@javax.annotation.Nullable String version) {
  ...
  public TrustPolicyDetails statement(@javax.annotation.Nullable List<TrustPolicyStatement> statement) {
    this.statement = statement;
    return this;
  }

  public TrustPolicyDetails addStatementItem(TrustPolicyStatement statementItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<TrustPolicyStatement> getStatement() {
    return statement;
  }

  public void setStatement(@javax.annotation.Nullable List<TrustPolicyStatement> statement) {
    this.statement = statement;
  }
   ...
   * @return the TrustPolicyDetails instance itself
   */
  public TrustPolicyDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TrustPolicyDetails trustPolicyDetails = (TrustPolicyDetails) o;
    return Objects.equals(this.version, trustPolicyDetails.version) &&
        Objects.equals(this.statement, trustPolicyDetails.statement)&&
        Objects.equals(this.additionalProperties, trustPolicyDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, statement, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrustPolicyDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrustPolicyDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrustPolicyDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TrustPolicyDetails is not found in the empty JSON string", TrustPolicyDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Statement") != null && !jsonObj.get("Statement").isJsonNull()) {
        ...
        if (jsonArraystatement != null) {
          ...
          if (!jsonObj.get("Statement").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `Statement` to be an array in the JSON string but got `%s`", jsonObj.get("Statement").toString()));
          }

          // validate the optional field `Statement` (array)
          for (int i = 0; i < jsonArraystatement.size(); i++) {
            TrustPolicyStatement.validateJsonElement(jsonArraystatement.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrustPolicyDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrustPolicyDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrustPolicyDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrustPolicyDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<TrustPolicyDetails>() {
           @Override
           public void write(JsonWriter out, TrustPolicyDetails value) throws IOException {
           ...
           @Override
           public TrustPolicyDetails read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TrustPolicyDetails instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TrustPolicyDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrustPolicyDetails
   * @throws IOException if the JSON string is invalid with respect to TrustPolicyDetails
   */
  public static TrustPolicyDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrustPolicyDetails.class);
  }

  /**
   * Convert an instance of TrustPolicyDetails to an JSON string
   *
   * @return JSON string
   */
