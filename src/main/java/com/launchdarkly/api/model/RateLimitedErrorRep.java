...
public class RateLimitedErrorRep {
  ...
  public RateLimitedErrorRep code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public RateLimitedErrorRep message(@javax.annotation.Nonnull String message) {
   ...
   * @return the RateLimitedErrorRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to RateLimitedErrorRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RateLimitedErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RateLimitedErrorRep is not found in the empty JSON string", RateLimitedErrorRep.openapiRequiredFields.toString()));
        }
      }
