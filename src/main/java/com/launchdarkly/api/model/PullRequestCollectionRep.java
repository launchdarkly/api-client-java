...
public class PullRequestCollectionRep {
   ...
   * @return the PullRequestCollectionRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PullRequestCollectionRep is not found in the empty JSON string", PullRequestCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        PullRequestRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
