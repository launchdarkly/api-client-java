...
public class HunkRep {
  ...
  public HunkRep addAliasesItem(String aliasesItem) {
   ...
   * @return the HunkRep instance itself
   */
  public HunkRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    HunkRep hunkRep = (HunkRep) o;
    return Objects.equals(this.startingLineNumber, hunkRep.startingLineNumber) &&
        Objects.equals(this.lines, hunkRep.lines) &&
        Objects.equals(this.projKey, hunkRep.projKey) &&
        Objects.equals(this.flagKey, hunkRep.flagKey) &&
        Objects.equals(this.aliases, hunkRep.aliases)&&
        Objects.equals(this.additionalProperties, hunkRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startingLineNumber, lines, projKey, flagKey, aliases, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HunkRep {\n");
    sb.append("    startingLineNumber: ").append(toIndentedString(startingLineNumber)).append("\n");
    sb.append("    lines: ").append(toIndentedString(lines)).append("\n");
    sb.append("    projKey: ").append(toIndentedString(projKey)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HunkRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HunkRep is not found in the empty JSON string", HunkRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("lines") != null && !jsonObj.get("lines").isJsonNull()) && !jsonObj.get("lines").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `lines` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lines").toString()));
      }
      if ((jsonObj.get("projKey") != null && !jsonObj.get("projKey").isJsonNull()) && !jsonObj.get("projKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `projKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("projKey").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HunkRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HunkRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HunkRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HunkRep.class));

       return (TypeAdapter<T>) new TypeAdapter<HunkRep>() {
           @Override
           public void write(JsonWriter out, HunkRep value) throws IOException {
           ...
           @Override
           public HunkRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             HunkRep instance = thisAdapter.fromJsonTree(jsonObj);
