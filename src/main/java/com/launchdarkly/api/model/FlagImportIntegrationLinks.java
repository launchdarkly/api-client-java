...
public class FlagImportIntegrationLinks {
   ...
   * @return the FlagImportIntegrationLinks instance itself
   */
  public FlagImportIntegrationLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagImportIntegrationLinks flagImportIntegrationLinks = (FlagImportIntegrationLinks) o;
    return Objects.equals(this.self, flagImportIntegrationLinks.self) &&
        Objects.equals(this.parent, flagImportIntegrationLinks.parent) &&
        Objects.equals(this.project, flagImportIntegrationLinks.project)&&
        Objects.equals(this.additionalProperties, flagImportIntegrationLinks.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(self, parent, project, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagImportIntegrationLinks {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagImportIntegrationLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagImportIntegrationLinks is not found in the empty JSON string", FlagImportIntegrationLinks.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagImportIntegrationLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagImportIntegrationLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagImportIntegrationLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagImportIntegrationLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagImportIntegrationLinks>() {
           @Override
           public void write(JsonWriter out, FlagImportIntegrationLinks value) throws IOException {
           ...
           @Override
           public FlagImportIntegrationLinks read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagImportIntegrationLinks instance = thisAdapter.fromJsonTree(jsonObj);
