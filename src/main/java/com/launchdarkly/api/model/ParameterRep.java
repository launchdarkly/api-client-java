...
public class ParameterRep {
  ...
  public ParameterRep variationId(@javax.annotation.Nullable String variationId) {
  ...
  public ParameterRep flagKey(@javax.annotation.Nullable String flagKey) {
   ...
   * @return the ParameterRep instance itself
   */
  public ParameterRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ParameterRep parameterRep = (ParameterRep) o;
    return Objects.equals(this.variationId, parameterRep.variationId) &&
        Objects.equals(this.flagKey, parameterRep.flagKey)&&
        Objects.equals(this.additionalProperties, parameterRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(variationId, flagKey, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ParameterRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("variationId", "flagKey"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ParameterRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ParameterRep is not found in the empty JSON string", ParameterRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParameterRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParameterRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParameterRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParameterRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ParameterRep>() {
           @Override
           public void write(JsonWriter out, ParameterRep value) throws IOException {
           ...
           @Override
           public ParameterRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ParameterRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ParameterRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ParameterRep
   * @throws IOException if the JSON string is invalid with respect to ParameterRep
   */
  public static ParameterRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParameterRep.class);
  }

  /**
   * Convert an instance of ParameterRep to an JSON string
   *
   * @return JSON string
   */
