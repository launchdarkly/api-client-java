...
public class ApprovalRequestResponse {
  ...
  public ApprovalRequestResponse id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ApprovalRequestResponse version(@javax.annotation.Nonnull Integer version) {
  ...
  public ApprovalRequestResponse creationDate(@javax.annotation.Nonnull Long creationDate) {
  ...
  public ApprovalRequestResponse serviceKind(@javax.annotation.Nonnull String serviceKind) {
  ...
  public ApprovalRequestResponse requestorId(@javax.annotation.Nullable String requestorId) {
  ...
  public ApprovalRequestResponse description(@javax.annotation.Nullable String description) {
  ...
  public ApprovalRequestResponse reviewStatus(@javax.annotation.Nonnull ReviewStatusEnum reviewStatus) {
  ...
  public ApprovalRequestResponse allReviews(@javax.annotation.Nonnull List<ReviewResponse> allReviews) {
  ...
  public ApprovalRequestResponse notifyMemberIds(@javax.annotation.Nonnull List<String> notifyMemberIds) {
  ...
  public ApprovalRequestResponse appliedDate(@javax.annotation.Nullable Long appliedDate) {
  ...
  public ApprovalRequestResponse appliedByMemberId(@javax.annotation.Nullable String appliedByMemberId) {
  ...
  public ApprovalRequestResponse appliedByServiceTokenId(@javax.annotation.Nullable String appliedByServiceTokenId) {
  ...
  public ApprovalRequestResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ApprovalRequestResponse instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
  ...
  public ApprovalRequestResponse conflicts(@javax.annotation.Nonnull List<Conflict> conflicts) {
  ...
  public ApprovalRequestResponse links(@javax.annotation.Nonnull Map<String, Object> links) {
    this.links = links;
    return this;
  }
  ...
  public ApprovalRequestResponse executionDate(@javax.annotation.Nullable Long executionDate) {
  ...
  public ApprovalRequestResponse operatingOnId(@javax.annotation.Nullable String operatingOnId) {
  ...
  public ApprovalRequestResponse integrationMetadata(@javax.annotation.Nullable IntegrationMetadata integrationMetadata) {
  ...
  public ApprovalRequestResponse source(@javax.annotation.Nullable CopiedFromEnv source) {
    this.source = source;
    return this;
  }
  ...
  public ApprovalRequestResponse customWorkflowMetadata(@javax.annotation.Nullable CustomWorkflowMeta customWorkflowMetadata) {
  ...
  public ApprovalRequestResponse resourceId(@javax.annotation.Nullable String resourceId) {
  ...
  public ApprovalRequestResponse approvalSettings(@javax.annotation.Nullable ApprovalSettings approvalSettings) {
   ...
   * @return the ApprovalRequestResponse instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, approvalRequestResponse.id) &&
        Objects.equals(this.version, approvalRequestResponse.version) &&
        Objects.equals(this.creationDate, approvalRequestResponse.creationDate) &&
        Objects.equals(this.serviceKind, approvalRequestResponse.serviceKind) &&
        Objects.equals(this.requestorId, approvalRequestResponse.requestorId) &&
        Objects.equals(this.description, approvalRequestResponse.description) &&
        Objects.equals(this.reviewStatus, approvalRequestResponse.reviewStatus) &&
        Objects.equals(this.allReviews, approvalRequestResponse.allReviews) &&
        Objects.equals(this.notifyMemberIds, approvalRequestResponse.notifyMemberIds) &&
        Objects.equals(this.appliedDate, approvalRequestResponse.appliedDate) &&
        Objects.equals(this.appliedByMemberId, approvalRequestResponse.appliedByMemberId) &&
        Objects.equals(this.appliedByServiceTokenId, approvalRequestResponse.appliedByServiceTokenId) &&
        Objects.equals(this.status, approvalRequestResponse.status) &&
        Objects.equals(this.instructions, approvalRequestResponse.instructions) &&
        Objects.equals(this.conflicts, approvalRequestResponse.conflicts) &&
        Objects.equals(this.links, approvalRequestResponse.links) &&
        Objects.equals(this.executionDate, approvalRequestResponse.executionDate) &&
        Objects.equals(this.operatingOnId, approvalRequestResponse.operatingOnId) &&
        Objects.equals(this.integrationMetadata, approvalRequestResponse.integrationMetadata) &&
        Objects.equals(this.source, approvalRequestResponse.source) &&
        Objects.equals(this.customWorkflowMetadata, approvalRequestResponse.customWorkflowMetadata) &&
        Objects.equals(this.resourceId, approvalRequestResponse.resourceId) &&
        Objects.equals(this.approvalSettings, approvalRequestResponse.approvalSettings)&&
        Objects.equals(this.additionalProperties, approvalRequestResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, version, creationDate, serviceKind, requestorId, description, reviewStatus, allReviews, notifyMemberIds, appliedDate, appliedByMemberId, appliedByServiceTokenId, status, instructions, conflicts, links, executionDate, operatingOnId, integrationMetadata, source, customWorkflowMetadata, resourceId, approvalSettings, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRequestResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApprovalRequestResponse is not found in the empty JSON string", ApprovalRequestResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApprovalRequestResponse.openapiRequiredFields) {
      ...
      if ((jsonObj.get("requestorId") != null && !jsonObj.get("requestorId").isJsonNull()) && !jsonObj.get("requestorId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `requestorId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("requestorId").toString()));
      }
      ...
      if ((jsonObj.get("appliedByMemberId") != null && !jsonObj.get("appliedByMemberId").isJsonNull()) && !jsonObj.get("appliedByMemberId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `appliedByMemberId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("appliedByMemberId").toString()));
      }
      if ((jsonObj.get("appliedByServiceTokenId") != null && !jsonObj.get("appliedByServiceTokenId").isJsonNull()) && !jsonObj.get("appliedByServiceTokenId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `appliedByServiceTokenId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("appliedByServiceTokenId").toString()));
      }
      ...
      if ((jsonObj.get("operatingOnId") != null && !jsonObj.get("operatingOnId").isJsonNull()) && !jsonObj.get("operatingOnId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `operatingOnId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("operatingOnId").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ApprovalRequestResponse>() {
           ...
           public ApprovalRequestResponse read(JsonReader in) throws IOException {
             ...
             ApprovalRequestResponse instance = thisAdapter.fromJsonTree(jsonObj);
