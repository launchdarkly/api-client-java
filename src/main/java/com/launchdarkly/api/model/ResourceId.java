...
public class ResourceId {
   ...
   * @return the ResourceId instance itself
   */
  public ResourceId putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.environmentKey, resourceId.environmentKey) &&
        Objects.equals(this.flagKey, resourceId.flagKey) &&
        Objects.equals(this.key, resourceId.key) &&
        Objects.equals(this.kind, resourceId.kind) &&
        Objects.equals(this.projectKey, resourceId.projectKey)&&
        Objects.equals(this.additionalProperties, resourceId.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(environmentKey, flagKey, key, kind, projectKey, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResourceId is not found in the empty JSON string", ResourceId.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResourceId>() {
           ...
           public ResourceId read(JsonReader in) throws IOException {
             ...
             ResourceId instance = thisAdapter.fromJsonTree(jsonObj);
