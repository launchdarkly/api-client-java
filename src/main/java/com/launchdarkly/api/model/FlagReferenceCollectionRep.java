...
public class FlagReferenceCollectionRep {
   ...
   * @return the FlagReferenceCollectionRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagReferenceCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagReferenceCollectionRep is not found in the empty JSON string", FlagReferenceCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        FlagReferenceRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
