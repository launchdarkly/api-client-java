...
public class TeamPostInput {
   ...
   * @return the TeamPostInput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamPostInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TeamPostInput is not found in the empty JSON string", TeamPostInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("memberIDs") != null && !jsonObj.get("memberIDs").isJsonNull() && !jsonObj.get("memberIDs").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `memberIDs` to be an array in the JSON string but got `%s`", jsonObj.get("memberIDs").toString()));
      }
      ...
      if (jsonObj.get("permissionGrants") != null && !jsonObj.get("permissionGrants").isJsonNull()) {
        ...
        if (jsonArraypermissionGrants != null) {
          ...
          for (int i = 0; i < jsonArraypermissionGrants.size(); i++) {
            PermissionGrantInput.validateJsonElement(jsonArraypermissionGrants.get(i));
          };
        }
      }
  }
