...
public class AnnouncementPatchOperation {
  ...
  public AnnouncementPatchOperation op(@javax.annotation.Nonnull String op) {
    this.op = op;
    return this;
  }
  ...
  public AnnouncementPatchOperation path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public AnnouncementPatchOperation value(@javax.annotation.Nullable Object value) {
    this.value = value;
    return this;
  }
   ...
   * @return the AnnouncementPatchOperation instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnnouncementPatchOperation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnouncementPatchOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AnnouncementPatchOperation is not found in the empty JSON string", AnnouncementPatchOperation.openapiRequiredFields.toString()));
        }
      }
