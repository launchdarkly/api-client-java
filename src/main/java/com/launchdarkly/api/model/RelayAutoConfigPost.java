...
public class RelayAutoConfigPost {
   ...
   * @return the RelayAutoConfigPost instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelayAutoConfigPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelayAutoConfigPost is not found in the empty JSON string", RelayAutoConfigPost.openapiRequiredFields.toString()));
        }
      }
