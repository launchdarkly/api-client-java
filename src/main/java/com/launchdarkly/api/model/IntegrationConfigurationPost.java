...
public class IntegrationConfigurationPost {
   ...
   * @return the IntegrationConfigurationPost instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationConfigurationPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationConfigurationPost is not found in the empty JSON string", IntegrationConfigurationPost.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("capabilityConfig") != null && !jsonObj.get("capabilityConfig").isJsonNull()) {
        CapabilityConfigPost.validateJsonElement(jsonObj.get("capabilityConfig"));
      }
  }
