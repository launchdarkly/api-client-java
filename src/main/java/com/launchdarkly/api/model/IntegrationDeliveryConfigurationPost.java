...
public class IntegrationDeliveryConfigurationPost {
   ...
   * @return the IntegrationDeliveryConfigurationPost instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationDeliveryConfigurationPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationDeliveryConfigurationPost is not found in the empty JSON string", IntegrationDeliveryConfigurationPost.openapiRequiredFields.toString()));
        }
      }
