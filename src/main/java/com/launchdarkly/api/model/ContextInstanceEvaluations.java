...
public class ContextInstanceEvaluations {
  ...
  private List<ContextInstanceEvaluation> items = new ArrayList<>();
  ...
  public ContextInstanceEvaluations items(@javax.annotation.Nonnull List<ContextInstanceEvaluation> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<ContextInstanceEvaluation> items) {
    this.items = items;
  }


  public ContextInstanceEvaluations totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public ContextInstanceEvaluations links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @return the ContextInstanceEvaluations instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, contextInstanceEvaluations.items) &&
        Objects.equals(this.totalCount, contextInstanceEvaluations.totalCount) &&
        Objects.equals(this.links, contextInstanceEvaluations.links)&&
        Objects.equals(this.additionalProperties, contextInstanceEvaluations.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextInstanceEvaluations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextInstanceEvaluations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextInstanceEvaluations is not found in the empty JSON string", ContextInstanceEvaluations.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContextInstanceEvaluations.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ContextInstanceEvaluation.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContextInstanceEvaluations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContextInstanceEvaluations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContextInstanceEvaluations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContextInstanceEvaluations.class));

       return (TypeAdapter<T>) new TypeAdapter<ContextInstanceEvaluations>() {
           @Override
           ...
           public ContextInstanceEvaluations read(JsonReader in) throws IOException {
             ...
             ContextInstanceEvaluations instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ContextInstanceEvaluations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContextInstanceEvaluations
   * @throws IOException if the JSON string is invalid with respect to ContextInstanceEvaluations
   */
  public static ContextInstanceEvaluations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContextInstanceEvaluations.class);
  }

  /**
   * Convert an instance of ContextInstanceEvaluations to an JSON string
   *
   * @return JSON string
   */
