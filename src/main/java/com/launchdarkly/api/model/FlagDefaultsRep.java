...
public class FlagDefaultsRep {
  ...
  public FlagDefaultsRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public FlagDefaultsRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public FlagDefaultsRep key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public FlagDefaultsRep tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public FlagDefaultsRep addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public FlagDefaultsRep temporary(@javax.annotation.Nullable Boolean temporary) {
  ...
  public FlagDefaultsRep defaultClientSideAvailability(@javax.annotation.Nullable ClientSideAvailability defaultClientSideAvailability) {
  ...
  public FlagDefaultsRep booleanDefaults(@javax.annotation.Nullable BooleanDefaults booleanDefaults) {
  ...
  public void setBooleanDefaults(@javax.annotation.Nullable BooleanDefaults booleanDefaults) {
    this.booleanDefaults = booleanDefaults;
  }
   ...
   * @return the FlagDefaultsRep instance itself
   */
  public FlagDefaultsRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagDefaultsRep flagDefaultsRep = (FlagDefaultsRep) o;
    return Objects.equals(this.links, flagDefaultsRep.links) &&
        Objects.equals(this.key, flagDefaultsRep.key) &&
        Objects.equals(this.tags, flagDefaultsRep.tags) &&
        Objects.equals(this.temporary, flagDefaultsRep.temporary) &&
        Objects.equals(this.defaultClientSideAvailability, flagDefaultsRep.defaultClientSideAvailability) &&
        Objects.equals(this.booleanDefaults, flagDefaultsRep.booleanDefaults)&&
        Objects.equals(this.additionalProperties, flagDefaultsRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, key, tags, temporary, defaultClientSideAvailability, booleanDefaults, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagDefaultsRep {\n");
    ...
    sb.append("    booleanDefaults: ").append(toIndentedString(booleanDefaults)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "key", "tags", "temporary", "defaultClientSideAvailability", "booleanDefaults"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagDefaultsRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagDefaultsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagDefaultsRep is not found in the empty JSON string", FlagDefaultsRep.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `booleanDefaults`
      if (jsonObj.get("booleanDefaults") != null && !jsonObj.get("booleanDefaults").isJsonNull()) {
        BooleanDefaults.validateJsonElement(jsonObj.get("booleanDefaults"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagDefaultsRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagDefaultsRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagDefaultsRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagDefaultsRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagDefaultsRep>() {
           @Override
           public void write(JsonWriter out, FlagDefaultsRep value) throws IOException {
           ...
           @Override
           public FlagDefaultsRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagDefaultsRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FlagDefaultsRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlagDefaultsRep
   * @throws IOException if the JSON string is invalid with respect to FlagDefaultsRep
   */
  public static FlagDefaultsRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlagDefaultsRep.class);
  }

  /**
   * Convert an instance of FlagDefaultsRep to an JSON string
   *
   * @return JSON string
   */
