...
import com.launchdarkly.api.model.AIConfigRep;
import com.launchdarkly.api.model.ExpandedExperimentRep;
...
public class ExpandedResourceRep {
  ...
  public ExpandedResourceRep kind(@javax.annotation.Nonnull String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ExpandedResourceRep aiConfig(@javax.annotation.Nullable AIConfigRep aiConfig) {
   ...
   */
  @javax.annotation.Nullable
  public AIConfigRep getAiConfig() {
    return aiConfig;
  }

  public void setAiConfig(@javax.annotation.Nullable AIConfigRep aiConfig) {
    this.aiConfig = aiConfig;
  }


  public ExpandedResourceRep experiment(@javax.annotation.Nullable ExpandedExperimentRep experiment) {
   ...
   */
  @javax.annotation.Nullable
  public ExpandedExperimentRep getExperiment() {
    return experiment;
  }

  public void setExperiment(@javax.annotation.Nullable ExpandedExperimentRep experiment) {
    this.experiment = experiment;
  }


  public ExpandedResourceRep flag(@javax.annotation.Nullable ExpandedFlagRep flag) {
    this.flag = flag;
    return this;
  }
  ...
  public ExpandedResourceRep segment(@javax.annotation.Nullable UserSegment segment) {
  ...
  public void setSegment(@javax.annotation.Nullable UserSegment segment) {
    this.segment = segment;
  }
   ...
   * @return the ExpandedResourceRep instance itself
   */
  public ExpandedResourceRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedResourceRep expandedResourceRep = (ExpandedResourceRep) o;
    return Objects.equals(this.kind, expandedResourceRep.kind) &&
        Objects.equals(this.aiConfig, expandedResourceRep.aiConfig) &&
        Objects.equals(this.experiment, expandedResourceRep.experiment) &&
        Objects.equals(this.flag, expandedResourceRep.flag) &&
        Objects.equals(this.segment, expandedResourceRep.segment)&&
        Objects.equals(this.additionalProperties, expandedResourceRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, aiConfig, experiment, flag, segment, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExpandedResourceRep {\n");
    sb.append("    kind: ").append(toIndentedString(kind)).append("\n");
    sb.append("    aiConfig: ").append(toIndentedString(aiConfig)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("kind", "aiConfig", "experiment", "flag", "segment"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpandedResourceRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedResourceRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedResourceRep is not found in the empty JSON string", ExpandedResourceRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExpandedResourceRep.openapiRequiredFields) {
      ...
      // validate the optional field `aiConfig`
      if (jsonObj.get("aiConfig") != null && !jsonObj.get("aiConfig").isJsonNull()) {
        AIConfigRep.validateJsonElement(jsonObj.get("aiConfig"));
      }
      // validate the optional field `experiment`
      if (jsonObj.get("experiment") != null && !jsonObj.get("experiment").isJsonNull()) {
        ExpandedExperimentRep.validateJsonElement(jsonObj.get("experiment"));
      }
      ...
      if (jsonObj.get("segment") != null && !jsonObj.get("segment").isJsonNull()) {
        UserSegment.validateJsonElement(jsonObj.get("segment"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedResourceRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedResourceRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedResourceRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedResourceRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedResourceRep>() {
           @Override
           public void write(JsonWriter out, ExpandedResourceRep value) throws IOException {
           ...
           @Override
           public ExpandedResourceRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedResourceRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExpandedResourceRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpandedResourceRep
   * @throws IOException if the JSON string is invalid with respect to ExpandedResourceRep
   */
  public static ExpandedResourceRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandedResourceRep.class);
  }

  /**
   * Convert an instance of ExpandedResourceRep to an JSON string
   *
   * @return JSON string
   */
