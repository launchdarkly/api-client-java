...
public class StatisticsRoot {
  ...
  private List<Link> projects = new ArrayList<>();
  ...
  public StatisticsRoot projects(@javax.annotation.Nullable List<Link> projects) {
    this.projects = projects;
    return this;
  }

  public StatisticsRoot addProjectsItem(Link projectsItem) {
  ...
  public void setProjects(@javax.annotation.Nullable List<Link> projects) {
    this.projects = projects;
  }


  public StatisticsRoot self(@javax.annotation.Nullable Link self) {
    this.self = self;
    return this;
  }
   ...
   * @return the StatisticsRoot instance itself
   */
  public StatisticsRoot putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StatisticsRoot statisticsRoot = (StatisticsRoot) o;
    return Objects.equals(this.projects, statisticsRoot.projects) &&
        Objects.equals(this.self, statisticsRoot.self)&&
        Objects.equals(this.additionalProperties, statisticsRoot.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projects, self, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatisticsRoot {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("projects", "self"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatisticsRoot
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatisticsRoot.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StatisticsRoot is not found in the empty JSON string", StatisticsRoot.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("projects") != null && !jsonObj.get("projects").isJsonNull()) {
        ...
        if (jsonArrayprojects != null) {
          ...
          for (int i = 0; i < jsonArrayprojects.size(); i++) {
            Link.validateJsonElement(jsonArrayprojects.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatisticsRoot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatisticsRoot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatisticsRoot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatisticsRoot.class));

       return (TypeAdapter<T>) new TypeAdapter<StatisticsRoot>() {
           @Override
           public void write(JsonWriter out, StatisticsRoot value) throws IOException {
           ...
           @Override
           public StatisticsRoot read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             StatisticsRoot instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of StatisticsRoot given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatisticsRoot
   * @throws IOException if the JSON string is invalid with respect to StatisticsRoot
   */
  public static StatisticsRoot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatisticsRoot.class);
  }

  /**
   * Convert an instance of StatisticsRoot to an JSON string
   *
   * @return JSON string
   */
