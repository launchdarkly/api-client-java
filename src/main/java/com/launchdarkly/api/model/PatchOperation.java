...
public class PatchOperation {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/biscuits", required = true, value = "A JSON Pointer string specifying the part of the document to operate on")
  ...
  **/
  ...
  @ApiModelProperty(example = "Chocolate Digestive", required = true, value = "A JSON value used in \"add\", \"replace\", and \"test\" operations")
