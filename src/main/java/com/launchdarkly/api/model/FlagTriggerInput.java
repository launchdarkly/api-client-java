...
public class FlagTriggerInput {
   ...
   * @return the FlagTriggerInput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagTriggerInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagTriggerInput is not found in the empty JSON string", FlagTriggerInput.openapiRequiredFields.toString()));
        }
      }
