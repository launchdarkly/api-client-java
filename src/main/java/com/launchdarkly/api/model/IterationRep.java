...
import com.launchdarkly.api.model.CovariateInfoRep;
...
public class IterationRep {
  ...
  public static final String SERIALIZED_NAME_COVARIATE_INFO = "covariateInfo";
  @SerializedName(SERIALIZED_NAME_COVARIATE_INFO)
  @javax.annotation.Nullable
  private CovariateInfoRep covariateInfo;
  ...
  public IterationRep status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public IterationRep covariateInfo(@javax.annotation.Nullable CovariateInfoRep covariateInfo) {
    this.covariateInfo = covariateInfo;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CovariateInfoRep getCovariateInfo() {
    return covariateInfo;
  }

  public void setCovariateInfo(@javax.annotation.Nullable CovariateInfoRep covariateInfo) {
    this.covariateInfo = covariateInfo;
  }
   ...
   * @return the IterationRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, iterationRep.id) &&
        ...
        Objects.equals(this.reallocationFrequencyMillis, iterationRep.reallocationFrequencyMillis) &&
        Objects.equals(this.version, iterationRep.version) &&
  ...
  public String toString() {
    ...
    sb.append("    covariateInfo: ").append(toIndentedString(covariateInfo)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "hypothesis", "status", "createdAt", "startedAt", "endedAt", "winningTreatmentId", "winningReason", "canReshuffleTraffic", "flags", "reallocationFrequencyMillis", "version", "primaryMetric", "primarySingleMetric", "primaryFunnel", "randomizationUnit", "attributes", "treatments", "secondaryMetrics", "metrics", "layerSnapshot", "covariateInfo"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IterationRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IterationRep is not found in the empty JSON string", IterationRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("winningTreatmentId") != null && !jsonObj.get("winningTreatmentId").isJsonNull()) && !jsonObj.get("winningTreatmentId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `winningTreatmentId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("winningTreatmentId").toString()));
      }
      if ((jsonObj.get("winningReason") != null && !jsonObj.get("winningReason").isJsonNull()) && !jsonObj.get("winningReason").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `winningReason` to be a primitive type in the JSON string but got `%s`", jsonObj.get("winningReason").toString()));
      }
      ...
      if (jsonObj.get("secondaryMetrics") != null && !jsonObj.get("secondaryMetrics").isJsonNull()) {
        ...
        if (jsonArraysecondaryMetrics != null) {
          ...
          if (!jsonObj.get("secondaryMetrics").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `secondaryMetrics` to be an array in the JSON string but got `%s`", jsonObj.get("secondaryMetrics").toString()));
          }
      ...
      // validate the optional field `covariateInfo`
      if (jsonObj.get("covariateInfo") != null && !jsonObj.get("covariateInfo").isJsonNull()) {
        CovariateInfoRep.validateJsonElement(jsonObj.get("covariateInfo"));
      }
  }
