...
public class AccessDenied {
  ...
  public AccessDenied action(@javax.annotation.Nonnull String action) {
    this.action = action;
    return this;
  }
  ...
  public AccessDenied reason(@javax.annotation.Nonnull AccessDeniedReason reason) {
    this.reason = reason;
    return this;
  }
  ...
  public void setReason(@javax.annotation.Nonnull AccessDeniedReason reason) {
    this.reason = reason;
  }
   ...
   * @return the AccessDenied instance itself
   */
  public AccessDenied putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, accessDenied.action) &&
        Objects.equals(this.reason, accessDenied.reason)&&
        Objects.equals(this.additionalProperties, accessDenied.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessDenied.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccessDenied is not found in the empty JSON string", AccessDenied.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessDenied.openapiRequiredFields) {
      ...
      AccessDeniedReason.validateJsonElement(jsonObj.get("reason"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AccessDenied>() {
           ...
           public AccessDenied read(JsonReader in) throws IOException {
             ...
             AccessDenied instance = thisAdapter.fromJsonTree(jsonObj);
