...
import com.launchdarkly.api.model.AIConfigsSummary;
import com.launchdarkly.api.model.ExpandedLinkedAIConfigs;
import com.launchdarkly.api.model.ExpandedLinkedFlags;
import com.launchdarkly.api.model.ExpandedLinkedMetrics;
import com.launchdarkly.api.model.ExpandedLinkedResources;
import com.launchdarkly.api.model.ExpandedLinkedSegments;
import com.launchdarkly.api.model.FlagsSummary;
import com.launchdarkly.api.model.Maintainer;
import com.launchdarkly.api.model.MetricsSummary;
import com.launchdarkly.api.model.ParentAndSelfLinks;
import com.launchdarkly.api.model.ResourceSummary;
import com.launchdarkly.api.model.SegmentsSummary;
import com.launchdarkly.api.model.ViewsAccessRep;
...
public class View {
  ...
  public static final String SERIALIZED_NAME_AFFECTS_SDK_PAYLOAD = "_affectsSdkPayload";
  @SerializedName(SERIALIZED_NAME_AFFECTS_SDK_PAYLOAD)
  @javax.annotation.Nonnull
  private Boolean affectsSdkPayload;
  ...
  public View affectsSdkPayload(@javax.annotation.Nonnull Boolean affectsSdkPayload) {
    this.affectsSdkPayload = affectsSdkPayload;
    return this;
  }

  /**
   * Whether this view is used to filter SDK payloads
   * @return affectsSdkPayload
   */
  @javax.annotation.Nonnull
  public Boolean getAffectsSdkPayload() {
    return affectsSdkPayload;
  }

  public void setAffectsSdkPayload(@javax.annotation.Nonnull Boolean affectsSdkPayload) {
    this.affectsSdkPayload = affectsSdkPayload;
  }
  ...
  public View addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    View view = (View) o;
    return Objects.equals(this.access, view.access) &&
        Objects.equals(this.links, view.links) &&
        Objects.equals(this.id, view.id) &&
        Objects.equals(this.accountId, view.accountId) &&
        Objects.equals(this.projectId, view.projectId) &&
        Objects.equals(this.projectKey, view.projectKey) &&
        Objects.equals(this.key, view.key) &&
        Objects.equals(this.name, view.name) &&
        Objects.equals(this.description, view.description) &&
        Objects.equals(this.affectsSdkPayload, view.affectsSdkPayload) &&
        Objects.equals(this.generateSdkKeys, view.generateSdkKeys) &&
        Objects.equals(this.version, view.version) &&
        Objects.equals(this.tags, view.tags) &&
        Objects.equals(this.createdAt, view.createdAt) &&
        Objects.equals(this.updatedAt, view.updatedAt) &&
        Objects.equals(this.archived, view.archived) &&
        Objects.equals(this.archivedAt, view.archivedAt) &&
        Objects.equals(this.deletedAt, view.deletedAt) &&
        Objects.equals(this.deleted, view.deleted) &&
        Objects.equals(this.maintainer, view.maintainer) &&
        Objects.equals(this.flagsSummary, view.flagsSummary) &&
        Objects.equals(this.segmentsSummary, view.segmentsSummary) &&
        Objects.equals(this.metricsSummary, view.metricsSummary) &&
        Objects.equals(this.aiConfigsSummary, view.aiConfigsSummary) &&
        Objects.equals(this.resourceSummary, view.resourceSummary) &&
        Objects.equals(this.flagsExpanded, view.flagsExpanded) &&
        Objects.equals(this.segmentsExpanded, view.segmentsExpanded) &&
        Objects.equals(this.metricsExpanded, view.metricsExpanded) &&
        Objects.equals(this.aiConfigsExpanded, view.aiConfigsExpanded) &&
        Objects.equals(this.resourcesExpanded, view.resourcesExpanded)&&
        Objects.equals(this.additionalProperties, view.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(access, links, id, accountId, projectId, projectKey, key, name, description, affectsSdkPayload, generateSdkKeys, version, tags, createdAt, updatedAt, archived, archivedAt, deletedAt, deleted, maintainer, flagsSummary, segmentsSummary, metricsSummary, aiConfigsSummary, resourceSummary, flagsExpanded, segmentsExpanded, metricsExpanded, aiConfigsExpanded, resourcesExpanded, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    affectsSdkPayload: ").append(toIndentedString(affectsSdkPayload)).append("\n");
    sb.append("    generateSdkKeys: ").append(toIndentedString(generateSdkKeys)).append("\n");
    ...
    sb.append("    flagsSummary: ").append(toIndentedString(flagsSummary)).append("\n");
    sb.append("    segmentsSummary: ").append(toIndentedString(segmentsSummary)).append("\n");
    sb.append("    metricsSummary: ").append(toIndentedString(metricsSummary)).append("\n");
    sb.append("    aiConfigsSummary: ").append(toIndentedString(aiConfigsSummary)).append("\n");
    sb.append("    resourceSummary: ").append(toIndentedString(resourceSummary)).append("\n");
    sb.append("    flagsExpanded: ").append(toIndentedString(flagsExpanded)).append("\n");
    sb.append("    segmentsExpanded: ").append(toIndentedString(segmentsExpanded)).append("\n");
    sb.append("    metricsExpanded: ").append(toIndentedString(metricsExpanded)).append("\n");
    sb.append("    aiConfigsExpanded: ").append(toIndentedString(aiConfigsExpanded)).append("\n");
    sb.append("    resourcesExpanded: ").append(toIndentedString(resourcesExpanded)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_access", "_links", "id", "accountId", "projectId", "projectKey", "key", "name", "description", "_affectsSdkPayload", "generateSdkKeys", "version", "tags", "createdAt", "updatedAt", "archived", "archivedAt", "deletedAt", "deleted", "maintainer", "flagsSummary", "segmentsSummary", "metricsSummary", "aiConfigsSummary", "resourceSummary", "flagsExpanded", "segmentsExpanded", "metricsExpanded", "aiConfigsExpanded", "resourcesExpanded"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "accountId", "projectId", "projectKey", "key", "name", "description", "_affectsSdkPayload", "version", "tags", "createdAt", "updatedAt", "archived", "deleted"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!View.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in View is not found in the empty JSON string", View.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("_access") != null && !jsonObj.get("_access").isJsonNull()) {
        ViewsAccessRep.validateJsonElement(jsonObj.get("_access"));
      }
      ...
      if (jsonObj.get("flagsSummary") != null && !jsonObj.get("flagsSummary").isJsonNull()) {
        FlagsSummary.validateJsonElement(jsonObj.get("flagsSummary"));
      }
      // validate the optional field `segmentsSummary`
      if (jsonObj.get("segmentsSummary") != null && !jsonObj.get("segmentsSummary").isJsonNull()) {
        SegmentsSummary.validateJsonElement(jsonObj.get("segmentsSummary"));
      }
      // validate the optional field `metricsSummary`
      if (jsonObj.get("metricsSummary") != null && !jsonObj.get("metricsSummary").isJsonNull()) {
        MetricsSummary.validateJsonElement(jsonObj.get("metricsSummary"));
      }
      // validate the optional field `aiConfigsSummary`
      if (jsonObj.get("aiConfigsSummary") != null && !jsonObj.get("aiConfigsSummary").isJsonNull()) {
        AIConfigsSummary.validateJsonElement(jsonObj.get("aiConfigsSummary"));
      }
      // validate the optional field `resourceSummary`
      if (jsonObj.get("resourceSummary") != null && !jsonObj.get("resourceSummary").isJsonNull()) {
        ResourceSummary.validateJsonElement(jsonObj.get("resourceSummary"));
      }
      // validate the optional field `flagsExpanded`
      if (jsonObj.get("flagsExpanded") != null && !jsonObj.get("flagsExpanded").isJsonNull()) {
        ExpandedLinkedFlags.validateJsonElement(jsonObj.get("flagsExpanded"));
      }
      // validate the optional field `segmentsExpanded`
      if (jsonObj.get("segmentsExpanded") != null && !jsonObj.get("segmentsExpanded").isJsonNull()) {
        ExpandedLinkedSegments.validateJsonElement(jsonObj.get("segmentsExpanded"));
      }
      // validate the optional field `metricsExpanded`
      if (jsonObj.get("metricsExpanded") != null && !jsonObj.get("metricsExpanded").isJsonNull()) {
        ExpandedLinkedMetrics.validateJsonElement(jsonObj.get("metricsExpanded"));
      }
      // validate the optional field `aiConfigsExpanded`
      if (jsonObj.get("aiConfigsExpanded") != null && !jsonObj.get("aiConfigsExpanded").isJsonNull()) {
        ExpandedLinkedAIConfigs.validateJsonElement(jsonObj.get("aiConfigsExpanded"));
      }
      // validate the optional field `resourcesExpanded`
      if (jsonObj.get("resourcesExpanded") != null && !jsonObj.get("resourcesExpanded").isJsonNull()) {
        ExpandedLinkedResources.validateJsonElement(jsonObj.get("resourcesExpanded"));
      }
  }
