...
public class DependentExperimentRep {
  ...
  public DependentExperimentRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public DependentExperimentRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DependentExperimentRep environmentId(@javax.annotation.Nonnull String environmentId) {
  ...
  public DependentExperimentRep environmentKey(@javax.annotation.Nonnull String environmentKey) {
  ...
  public DependentExperimentRep creationDate(@javax.annotation.Nonnull Long creationDate) {
  ...
  public DependentExperimentRep archivedDate(@javax.annotation.Nullable Long archivedDate) {
  ...
  public DependentExperimentRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public DependentExperimentRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the DependentExperimentRep instance itself
   */
  public DependentExperimentRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DependentExperimentRep dependentExperimentRep = (DependentExperimentRep) o;
    return Objects.equals(this.key, dependentExperimentRep.key) &&
        Objects.equals(this.name, dependentExperimentRep.name) &&
        Objects.equals(this.environmentId, dependentExperimentRep.environmentId) &&
        Objects.equals(this.environmentKey, dependentExperimentRep.environmentKey) &&
        Objects.equals(this.creationDate, dependentExperimentRep.creationDate) &&
        Objects.equals(this.archivedDate, dependentExperimentRep.archivedDate) &&
        Objects.equals(this.links, dependentExperimentRep.links)&&
        Objects.equals(this.additionalProperties, dependentExperimentRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, environmentId, environmentKey, creationDate, archivedDate, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DependentExperimentRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "environmentId", "environmentKey", "creationDate", "archivedDate", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "name", "environmentId", "environmentKey", "creationDate", "_links"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DependentExperimentRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DependentExperimentRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DependentExperimentRep is not found in the empty JSON string", DependentExperimentRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DependentExperimentRep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DependentExperimentRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DependentExperimentRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DependentExperimentRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DependentExperimentRep.class));

       return (TypeAdapter<T>) new TypeAdapter<DependentExperimentRep>() {
           @Override
           public void write(JsonWriter out, DependentExperimentRep value) throws IOException {
           ...
           @Override
           public DependentExperimentRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DependentExperimentRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of DependentExperimentRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DependentExperimentRep
   * @throws IOException if the JSON string is invalid with respect to DependentExperimentRep
   */
  public static DependentExperimentRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DependentExperimentRep.class);
  }

  /**
   * Convert an instance of DependentExperimentRep to an JSON string
   *
   * @return JSON string
   */
