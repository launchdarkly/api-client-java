...
public class FlagEventCollectionRep {
  ...
  public FlagEventCollectionRep totalCount(@javax.annotation.Nonnull Integer totalCount) {
  ...
  public FlagEventCollectionRep items(@javax.annotation.Nonnull List<FlagEventRep> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<FlagEventRep> items) {
    this.items = items;
  }


  public FlagEventCollectionRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @return the FlagEventCollectionRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagEventCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagEventCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagEventCollectionRep is not found in the empty JSON string", FlagEventCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        FlagEventRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
