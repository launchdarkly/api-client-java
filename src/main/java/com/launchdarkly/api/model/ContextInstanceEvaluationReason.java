...
public class ContextInstanceEvaluationReason {
  ...
  public ContextInstanceEvaluationReason kind(@javax.annotation.Nonnull String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ContextInstanceEvaluationReason ruleIndex(@javax.annotation.Nullable Integer ruleIndex) {
  ...
  public ContextInstanceEvaluationReason ruleID(@javax.annotation.Nullable String ruleID) {
    this.ruleID = ruleID;
    return this;
  }
  ...
  public ContextInstanceEvaluationReason prerequisiteKey(@javax.annotation.Nullable String prerequisiteKey) {
  ...
  public ContextInstanceEvaluationReason inExperiment(@javax.annotation.Nullable Boolean inExperiment) {
  ...
  public ContextInstanceEvaluationReason errorKind(@javax.annotation.Nullable String errorKind) {
   ...
   * @return the ContextInstanceEvaluationReason instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.kind, contextInstanceEvaluationReason.kind) &&
        Objects.equals(this.ruleIndex, contextInstanceEvaluationReason.ruleIndex) &&
        Objects.equals(this.ruleID, contextInstanceEvaluationReason.ruleID) &&
        Objects.equals(this.prerequisiteKey, contextInstanceEvaluationReason.prerequisiteKey) &&
        Objects.equals(this.inExperiment, contextInstanceEvaluationReason.inExperiment) &&
        Objects.equals(this.errorKind, contextInstanceEvaluationReason.errorKind)&&
        Objects.equals(this.additionalProperties, contextInstanceEvaluationReason.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, ruleIndex, ruleID, prerequisiteKey, inExperiment, errorKind, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    prerequisiteKey: ").append(toIndentedString(prerequisiteKey)).append("\n");
    sb.append("    inExperiment: ").append(toIndentedString(inExperiment)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextInstanceEvaluationReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextInstanceEvaluationReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextInstanceEvaluationReason is not found in the empty JSON string", ContextInstanceEvaluationReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContextInstanceEvaluationReason.openapiRequiredFields) {
      ...
      if ((jsonObj.get("ruleID") != null && !jsonObj.get("ruleID").isJsonNull()) && !jsonObj.get("ruleID").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ruleID` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ruleID").toString()));
      }
      if ((jsonObj.get("prerequisiteKey") != null && !jsonObj.get("prerequisiteKey").isJsonNull()) && !jsonObj.get("prerequisiteKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `prerequisiteKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("prerequisiteKey").toString()));
      }
      if ((jsonObj.get("errorKind") != null && !jsonObj.get("errorKind").isJsonNull()) && !jsonObj.get("errorKind").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `errorKind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("errorKind").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContextInstanceEvaluationReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContextInstanceEvaluationReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContextInstanceEvaluationReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContextInstanceEvaluationReason.class));

       return (TypeAdapter<T>) new TypeAdapter<ContextInstanceEvaluationReason>() {
           @Override
           ...
           public ContextInstanceEvaluationReason read(JsonReader in) throws IOException {
             ...
             ContextInstanceEvaluationReason instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ContextInstanceEvaluationReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContextInstanceEvaluationReason
   * @throws IOException if the JSON string is invalid with respect to ContextInstanceEvaluationReason
   */
  public static ContextInstanceEvaluationReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContextInstanceEvaluationReason.class);
  }

  /**
   * Convert an instance of ContextInstanceEvaluationReason to an JSON string
   *
   * @return JSON string
   */
