...
public class StatusServiceUnavailable {
  ...
  public StatusServiceUnavailable code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public StatusServiceUnavailable message(@javax.annotation.Nonnull String message) {
   ...
   * @return the StatusServiceUnavailable instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusServiceUnavailable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusServiceUnavailable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StatusServiceUnavailable is not found in the empty JSON string", StatusServiceUnavailable.openapiRequiredFields.toString()));
        }
      }
