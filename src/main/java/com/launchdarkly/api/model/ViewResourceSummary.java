...
public class ViewResourceSummary {
  ...
  public ViewResourceSummary flagCount(@javax.annotation.Nonnull Integer flagCount) {
  ...
  public ViewResourceSummary segmentCount(@javax.annotation.Nonnull Integer segmentCount) {
   ...
   * @return the ViewResourceSummary instance itself
   */
  public ViewResourceSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewResourceSummary viewResourceSummary = (ViewResourceSummary) o;
    return Objects.equals(this.flagCount, viewResourceSummary.flagCount) &&
        Objects.equals(this.segmentCount, viewResourceSummary.segmentCount)&&
        Objects.equals(this.additionalProperties, viewResourceSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(flagCount, segmentCount, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewResourceSummary {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("flagCount", "segmentCount"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("flagCount", "segmentCount"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewResourceSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewResourceSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewResourceSummary is not found in the empty JSON string", ViewResourceSummary.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewResourceSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewResourceSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewResourceSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewResourceSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewResourceSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewResourceSummary>() {
           @Override
           public void write(JsonWriter out, ViewResourceSummary value) throws IOException {
           ...
           @Override
           public ViewResourceSummary read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewResourceSummary instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewResourceSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewResourceSummary
   * @throws IOException if the JSON string is invalid with respect to ViewResourceSummary
   */
  public static ViewResourceSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewResourceSummary.class);
  }

  /**
   * Convert an instance of ViewResourceSummary to an JSON string
   *
   * @return JSON string
   */
