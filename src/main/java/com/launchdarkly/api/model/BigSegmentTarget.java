...
public class BigSegmentTarget {
   ...
   * @return the BigSegmentTarget instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BigSegmentTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BigSegmentTarget is not found in the empty JSON string", BigSegmentTarget.openapiRequiredFields.toString()));
        }
      }
