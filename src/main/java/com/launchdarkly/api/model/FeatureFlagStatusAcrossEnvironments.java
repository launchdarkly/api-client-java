...
public class FeatureFlagStatusAcrossEnvironments {
   ...
   * @return the FeatureFlagStatusAcrossEnvironments instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeatureFlagStatusAcrossEnvironments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FeatureFlagStatusAcrossEnvironments is not found in the empty JSON string", FeatureFlagStatusAcrossEnvironments.openapiRequiredFields.toString()));
        }
      }
