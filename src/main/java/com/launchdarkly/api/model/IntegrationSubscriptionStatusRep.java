...
public class IntegrationSubscriptionStatusRep {
   ...
   * @return the IntegrationSubscriptionStatusRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationSubscriptionStatusRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationSubscriptionStatusRep is not found in the empty JSON string", IntegrationSubscriptionStatusRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            IntegrationStatusRep.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
