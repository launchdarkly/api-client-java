...
public class ExpandedLinkedResourcesMetrics {
  ...
  public ExpandedLinkedResourcesMetrics items(List<ExpandedMetric> items) {
    this.items = items;
    return this;
  }
  ...
  **/
  ...
  public ExpandedLinkedResourcesMetrics totalCount(Integer totalCount) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedLinkedResourcesMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExpandedLinkedResourcesMetrics is not found in the empty JSON string", ExpandedLinkedResourcesMetrics.openapiRequiredFields.toString()));
        }
      }
