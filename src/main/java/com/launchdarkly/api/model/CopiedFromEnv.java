...
public class CopiedFromEnv {
  ...
  public CopiedFromEnv key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public CopiedFromEnv version(@javax.annotation.Nullable Integer version) {
   ...
   * @return the CopiedFromEnv instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopiedFromEnv
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopiedFromEnv.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CopiedFromEnv is not found in the empty JSON string", CopiedFromEnv.openapiRequiredFields.toString()));
        }
      }
