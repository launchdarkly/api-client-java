...
public class FlagCopyConfigPost {
   ...
   * @return the FlagCopyConfigPost instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.source, flagCopyConfigPost.source) &&
        Objects.equals(this.target, flagCopyConfigPost.target) &&
        Objects.equals(this.comment, flagCopyConfigPost.comment) &&
        Objects.equals(this.includedActions, flagCopyConfigPost.includedActions) &&
        Objects.equals(this.excludedActions, flagCopyConfigPost.excludedActions)&&
        Objects.equals(this.additionalProperties, flagCopyConfigPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(source, target, comment, includedActions, excludedActions, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagCopyConfigPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagCopyConfigPost is not found in the empty JSON string", FlagCopyConfigPost.openapiRequiredFields.toString()));
        }
      }
      ...
      FlagCopyConfigEnvironment.validateJsonElement(jsonObj.get("source"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagCopyConfigPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagCopyConfigPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagCopyConfigPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagCopyConfigPost.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagCopyConfigPost>() {
           @Override
           ...
           public FlagCopyConfigPost read(JsonReader in) throws IOException {
             ...
             FlagCopyConfigPost instance = thisAdapter.fromJsonTree(jsonObj);
