...
public class TokenSummary {
  ...
  public TokenSummary links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public TokenSummary putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public TokenSummary id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public TokenSummary name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TokenSummary ending(@javax.annotation.Nullable String ending) {
    this.ending = ending;
    return this;
  }
  ...
  public void setEnding(@javax.annotation.Nullable String ending) {
    this.ending = ending;
  }


  public TokenSummary serviceToken(@javax.annotation.Nullable Boolean serviceToken) {
   ...
   * @return the TokenSummary instance itself
   */
  public TokenSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TokenSummary tokenSummary = (TokenSummary) o;
    return Objects.equals(this.links, tokenSummary.links) &&
        Objects.equals(this.id, tokenSummary.id) &&
        Objects.equals(this.name, tokenSummary.name) &&
        Objects.equals(this.ending, tokenSummary.ending) &&
        Objects.equals(this.serviceToken, tokenSummary.serviceToken)&&
        Objects.equals(this.additionalProperties, tokenSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, id, name, ending, serviceToken, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "_id", "name", "ending", "serviceToken"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TokenSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TokenSummary is not found in the empty JSON string", TokenSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("ending") != null && !jsonObj.get("ending").isJsonNull()) && !jsonObj.get("ending").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ending` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ending").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenSummary>() {
           @Override
           public void write(JsonWriter out, TokenSummary value) throws IOException {
           ...
           @Override
           public TokenSummary read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TokenSummary instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TokenSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TokenSummary
   * @throws IOException if the JSON string is invalid with respect to TokenSummary
   */
  public static TokenSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenSummary.class);
  }

  /**
   * Convert an instance of TokenSummary to an JSON string
   *
   * @return JSON string
   */
