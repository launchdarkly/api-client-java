...
public class PostReleasePolicyRequest {
  ...
  public PostReleasePolicyRequest scope(@javax.annotation.Nullable ReleasePolicyScope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public PostReleasePolicyRequest releaseMethod(@javax.annotation.Nonnull ReleaseMethod releaseMethod) {
  ...
  public PostReleasePolicyRequest guardedReleaseConfig(@javax.annotation.Nullable GuardedReleaseConfig guardedReleaseConfig) {
  ...
  public PostReleasePolicyRequest progressiveReleaseConfig(@javax.annotation.Nullable ProgressiveReleaseConfig progressiveReleaseConfig) {
  ...
  public PostReleasePolicyRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public PostReleasePolicyRequest key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
   ...
   * @return the PostReleasePolicyRequest instance itself
   */
  public PostReleasePolicyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PostReleasePolicyRequest postReleasePolicyRequest = (PostReleasePolicyRequest) o;
    return Objects.equals(this.scope, postReleasePolicyRequest.scope) &&
        Objects.equals(this.releaseMethod, postReleasePolicyRequest.releaseMethod) &&
        Objects.equals(this.guardedReleaseConfig, postReleasePolicyRequest.guardedReleaseConfig) &&
        Objects.equals(this.progressiveReleaseConfig, postReleasePolicyRequest.progressiveReleaseConfig) &&
        Objects.equals(this.name, postReleasePolicyRequest.name) &&
        Objects.equals(this.key, postReleasePolicyRequest.key)&&
        Objects.equals(this.additionalProperties, postReleasePolicyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, releaseMethod, guardedReleaseConfig, progressiveReleaseConfig, name, key, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostReleasePolicyRequest {\n");
    sb.append("    scope: ").append(toIndentedString(scope)).append("\n");
    sb.append("    releaseMethod: ").append(toIndentedString(releaseMethod)).append("\n");
    sb.append("    guardedReleaseConfig: ").append(toIndentedString(guardedReleaseConfig)).append("\n");
    sb.append("    progressiveReleaseConfig: ").append(toIndentedString(progressiveReleaseConfig)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("scope", "releaseMethod", "guardedReleaseConfig", "progressiveReleaseConfig", "name", "key"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("releaseMethod", "name", "key"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostReleasePolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostReleasePolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostReleasePolicyRequest is not found in the empty JSON string", PostReleasePolicyRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostReleasePolicyRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("scope") != null && !jsonObj.get("scope").isJsonNull()) {
        ReleasePolicyScope.validateJsonElement(jsonObj.get("scope"));
      }
      // validate the required field `releaseMethod`
      ReleaseMethod.validateJsonElement(jsonObj.get("releaseMethod"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostReleasePolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostReleasePolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostReleasePolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostReleasePolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostReleasePolicyRequest>() {
           @Override
           public void write(JsonWriter out, PostReleasePolicyRequest value) throws IOException {
           ...
           @Override
           public PostReleasePolicyRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PostReleasePolicyRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PostReleasePolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostReleasePolicyRequest
   * @throws IOException if the JSON string is invalid with respect to PostReleasePolicyRequest
   */
  public static PostReleasePolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostReleasePolicyRequest.class);
  }

  /**
   * Convert an instance of PostReleasePolicyRequest to an JSON string
   *
   * @return JSON string
   */
