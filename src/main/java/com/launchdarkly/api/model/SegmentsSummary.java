...
import com.launchdarkly.api.model.ExpandedDirectlyLinkedSegments;
...
public class SegmentsSummary {
   ...
   * @return the SegmentsSummary instance itself
   */
  public SegmentsSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentsSummary segmentsSummary = (SegmentsSummary) o;
    return Objects.equals(this.count, segmentsSummary.count) &&
        Objects.equals(this.linkedSegments, segmentsSummary.linkedSegments)&&
        Objects.equals(this.additionalProperties, segmentsSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, linkedSegments, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SegmentsSummary {\n");
    sb.append("    count: ").append(toIndentedString(count)).append("\n");
    sb.append("    linkedSegments: ").append(toIndentedString(linkedSegments)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentsSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SegmentsSummary is not found in the empty JSON string", SegmentsSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `linkedSegments`
      if (jsonObj.get("linkedSegments") != null && !jsonObj.get("linkedSegments").isJsonNull()) {
        ExpandedDirectlyLinkedSegments.validateJsonElement(jsonObj.get("linkedSegments"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentsSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentsSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentsSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentsSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentsSummary>() {
           @Override
           public void write(JsonWriter out, SegmentsSummary value) throws IOException {
           ...
           @Override
           public SegmentsSummary read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SegmentsSummary instance = thisAdapter.fromJsonTree(jsonObj);
