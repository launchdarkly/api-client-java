...
public class WebhookPost {
   ...
   * @return the WebhookPost instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, webhookPost.name) &&
        ...
        Objects.equals(this.statements, webhookPost.statements) &&
        Objects.equals(this.sign, webhookPost.sign) &&
        Objects.equals(this.on, webhookPost.on) &&
        Objects.equals(this.tags, webhookPost.tags)&&
        Objects.equals(this.additionalProperties, webhookPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, url, secret, statements, sign, on, tags, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookPost is not found in the empty JSON string", WebhookPost.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookPost>() {
           ...
           public WebhookPost read(JsonReader in) throws IOException {
             ...
             WebhookPost instance = thisAdapter.fromJsonTree(jsonObj);
