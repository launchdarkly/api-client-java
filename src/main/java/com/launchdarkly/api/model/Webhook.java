...
public class Webhook {
  ...
  public Webhook links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public Webhook statements(@javax.annotation.Nullable List<Statement> statements) {
  ...
  public Webhook on(@javax.annotation.Nonnull Boolean on) {
    this.on = on;
    return this;
  }
  ...
  public Webhook tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public Webhook access(@javax.annotation.Nullable Access access) {
    this.access = access;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, name, url, secret, statements, on, tags, access, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "_id", "name", "url", "secret", "statements", "on", "tags", "_access"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_links", "_id", "url", "on", "tags"));
  }
