...
public class ModelImport {
   ...
   * @return the ModelImport instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, _import.id) &&
        Objects.equals(this.segmentKey, _import.segmentKey) &&
        Objects.equals(this.creationTime, _import.creationTime) &&
        Objects.equals(this.mode, _import.mode) &&
        Objects.equals(this.status, _import.status) &&
        Objects.equals(this.files, _import.files) &&
        Objects.equals(this.links, _import.links)&&
        Objects.equals(this.additionalProperties, _import.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, segmentKey, creationTime, mode, status, files, links, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelImport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelImport is not found in the empty JSON string", ModelImport.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("files") != null && !jsonObj.get("files").isJsonNull()) {
        ...
        if (jsonArrayfiles != null) {
          ...
          for (int i = 0; i < jsonArrayfiles.size(); i++) {
            FileRep.validateJsonElement(jsonArrayfiles.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ModelImport>() {
           ...
           public ModelImport read(JsonReader in) throws IOException {
             ...
             ModelImport instance = thisAdapter.fromJsonTree(jsonObj);
