...
public class ContextAttributeNamesCollection {
  ...
  public ContextAttributeNamesCollection items(@javax.annotation.Nonnull List<ContextAttributeNames> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<ContextAttributeNames> items) {
    this.items = items;
  }
   ...
   * @return the ContextAttributeNamesCollection instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextAttributeNamesCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextAttributeNamesCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextAttributeNamesCollection is not found in the empty JSON string", ContextAttributeNamesCollection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ContextAttributeNames.validateJsonElement(jsonArrayitems.get(i));
      };
  }
