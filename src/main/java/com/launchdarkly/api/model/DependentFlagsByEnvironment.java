...
public class DependentFlagsByEnvironment {
  ...
  private List<DependentFlag> items = new ArrayList<>();
  ...
  public DependentFlagsByEnvironment items(@javax.annotation.Nonnull List<DependentFlag> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<DependentFlag> items) {
    this.items = items;
  }


  public DependentFlagsByEnvironment links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public DependentFlagsByEnvironment putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public DependentFlagsByEnvironment site(@javax.annotation.Nonnull Link site) {
    this.site = site;
    return this;
  }
   ...
   * @return the DependentFlagsByEnvironment instance itself
   */
  public DependentFlagsByEnvironment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, dependentFlagsByEnvironment.items) &&
        ...
        Objects.equals(this.additionalProperties, dependentFlagsByEnvironment.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DependentFlagsByEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DependentFlagsByEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DependentFlagsByEnvironment is not found in the empty JSON string", DependentFlagsByEnvironment.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DependentFlagsByEnvironment.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        DependentFlag.validateJsonElement(jsonArrayitems.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DependentFlagsByEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DependentFlagsByEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DependentFlagsByEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DependentFlagsByEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<DependentFlagsByEnvironment>() {
           @Override
           public void write(JsonWriter out, DependentFlagsByEnvironment value) throws IOException {
           ...
           @Override
           public DependentFlagsByEnvironment read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DependentFlagsByEnvironment instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of DependentFlagsByEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DependentFlagsByEnvironment
   * @throws IOException if the JSON string is invalid with respect to DependentFlagsByEnvironment
   */
  public static DependentFlagsByEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DependentFlagsByEnvironment.class);
  }

  /**
   * Convert an instance of DependentFlagsByEnvironment to an JSON string
   *
   * @return JSON string
   */
