  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DependentFlagsByEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DependentFlagsByEnvironment is not found in the empty JSON string", DependentFlagsByEnvironment.openapiRequiredFields.toString()));
        }
      }
