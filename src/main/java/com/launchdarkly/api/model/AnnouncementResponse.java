...
public class AnnouncementResponse {
  ...
  public AnnouncementResponse id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public AnnouncementResponse isDismissible(@javax.annotation.Nonnull Boolean isDismissible) {
  ...
  public AnnouncementResponse title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public AnnouncementResponse message(@javax.annotation.Nonnull String message) {
  ...
  public AnnouncementResponse startTime(@javax.annotation.Nonnull Long startTime) {
  ...
  public AnnouncementResponse endTime(@javax.annotation.Nullable Long endTime) {
  ...
  public AnnouncementResponse severity(@javax.annotation.Nonnull SeverityEnum severity) {
  ...
  public AnnouncementResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AnnouncementResponse access(@javax.annotation.Nullable AnnouncementAccessRep access) {
    this.access = access;
    return this;
  }
  ...
  public void setAccess(@javax.annotation.Nullable AnnouncementAccessRep access) {
    this.access = access;
  }


  public AnnouncementResponse links(@javax.annotation.Nonnull AnnouncementResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public void setLinks(@javax.annotation.Nonnull AnnouncementResponseLinks links) {
    this.links = links;
  }
   ...
   * @return the AnnouncementResponse instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, announcementResponse.id) &&
        Objects.equals(this.isDismissible, announcementResponse.isDismissible) &&
        Objects.equals(this.title, announcementResponse.title) &&
        Objects.equals(this.message, announcementResponse.message) &&
        Objects.equals(this.startTime, announcementResponse.startTime) &&
        Objects.equals(this.endTime, announcementResponse.endTime) &&
        Objects.equals(this.severity, announcementResponse.severity) &&
        Objects.equals(this.status, announcementResponse.status) &&
        Objects.equals(this.access, announcementResponse.access) &&
        Objects.equals(this.links, announcementResponse.links)&&
        Objects.equals(this.additionalProperties, announcementResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, isDismissible, title, message, startTime, endTime, severity, status, access, links, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "isDismissible", "title", "message", "startTime", "endTime", "severity", "_status", "_access", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_id", "isDismissible", "title", "message", "startTime", "severity", "_status", "_links"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnnouncementResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnouncementResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AnnouncementResponse is not found in the empty JSON string", AnnouncementResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnnouncementResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("_status").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_status").toString()));
      }
      // validate the required field `_status`
      StatusEnum.validateJsonElement(jsonObj.get("_status"));
      // validate the optional field `_access`
      if (jsonObj.get("_access") != null && !jsonObj.get("_access").isJsonNull()) {
        AnnouncementAccessRep.validateJsonElement(jsonObj.get("_access"));
      }
      // validate the required field `_links`
      AnnouncementResponseLinks.validateJsonElement(jsonObj.get("_links"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnouncementResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnouncementResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnouncementResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnouncementResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnouncementResponse>() {
           @Override
           ...
           public AnnouncementResponse read(JsonReader in) throws IOException {
             ...
             AnnouncementResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AnnouncementResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnnouncementResponse
   * @throws IOException if the JSON string is invalid with respect to AnnouncementResponse
   */
  public static AnnouncementResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnouncementResponse.class);
  }

  /**
   * Convert an instance of AnnouncementResponse to an JSON string
   *
   * @return JSON string
   */
