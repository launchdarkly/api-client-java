...
public class UnauthorizedErrorRep {
  ...
  public UnauthorizedErrorRep code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public UnauthorizedErrorRep message(@javax.annotation.Nonnull String message) {
   ...
   * @return the UnauthorizedErrorRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnauthorizedErrorRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnauthorizedErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UnauthorizedErrorRep is not found in the empty JSON string", UnauthorizedErrorRep.openapiRequiredFields.toString()));
        }
      }
