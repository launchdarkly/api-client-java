...
public class CoreLink {
  ...
  public CoreLink href(@javax.annotation.Nonnull String href) {
    this.href = href;
    return this;
  }
  ...
  public CoreLink type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the CoreLink instance itself
   */
  public CoreLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.href, coreLink.href) &&
        Objects.equals(this.type, coreLink.type)&&
        Objects.equals(this.additionalProperties, coreLink.additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("href", "type"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CoreLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CoreLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CoreLink is not found in the empty JSON string", CoreLink.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CoreLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoreLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoreLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoreLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoreLink.class));

       return (TypeAdapter<T>) new TypeAdapter<CoreLink>() {
           @Override
           public void write(JsonWriter out, CoreLink value) throws IOException {
           ...
           @Override
           public CoreLink read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CoreLink instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CoreLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CoreLink
   * @throws IOException if the JSON string is invalid with respect to CoreLink
   */
  public static CoreLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoreLink.class);
  }

  /**
   * Convert an instance of CoreLink to an JSON string
   *
   * @return JSON string
   */
