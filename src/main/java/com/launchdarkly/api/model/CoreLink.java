...
public class CoreLink {
  ...
  public CoreLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public CoreLink type(String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CoreLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoreLink is not found in the empty JSON string", CoreLink.openapiRequiredFields.toString()));
        }
      }
