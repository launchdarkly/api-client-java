...
public class TriggerWorkflowCollectionRep {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  @javax.annotation.Nullable
  private List<TriggerWorkflowRep> items = new ArrayList<>();
  ...
  public TriggerWorkflowCollectionRep items(@javax.annotation.Nullable List<TriggerWorkflowRep> items) {
    this.items = items;
    return this;
  }

  public TriggerWorkflowCollectionRep addItemsItem(TriggerWorkflowRep itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<TriggerWorkflowRep> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nullable List<TriggerWorkflowRep> items) {
    this.items = items;
  }


  public TriggerWorkflowCollectionRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public TriggerWorkflowCollectionRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the TriggerWorkflowCollectionRep instance itself
   */
  public TriggerWorkflowCollectionRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TriggerWorkflowCollectionRep triggerWorkflowCollectionRep = (TriggerWorkflowCollectionRep) o;
    return Objects.equals(this.items, triggerWorkflowCollectionRep.items) &&
        Objects.equals(this.links, triggerWorkflowCollectionRep.links)&&
        Objects.equals(this.additionalProperties, triggerWorkflowCollectionRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TriggerWorkflowCollectionRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TriggerWorkflowCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TriggerWorkflowCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TriggerWorkflowCollectionRep is not found in the empty JSON string", TriggerWorkflowCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            TriggerWorkflowRep.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TriggerWorkflowCollectionRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TriggerWorkflowCollectionRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TriggerWorkflowCollectionRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TriggerWorkflowCollectionRep.class));

       return (TypeAdapter<T>) new TypeAdapter<TriggerWorkflowCollectionRep>() {
           @Override
           public void write(JsonWriter out, TriggerWorkflowCollectionRep value) throws IOException {
           ...
           @Override
           public TriggerWorkflowCollectionRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TriggerWorkflowCollectionRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TriggerWorkflowCollectionRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TriggerWorkflowCollectionRep
   * @throws IOException if the JSON string is invalid with respect to TriggerWorkflowCollectionRep
   */
  public static TriggerWorkflowCollectionRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TriggerWorkflowCollectionRep.class);
  }

  /**
   * Convert an instance of TriggerWorkflowCollectionRep to an JSON string
   *
   * @return JSON string
   */
