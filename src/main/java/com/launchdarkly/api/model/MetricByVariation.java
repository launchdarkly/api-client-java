...
public class MetricByVariation {
   ...
   * @return the MetricByVariation instance itself
   */
  public MetricByVariation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MetricByVariation metricByVariation = (MetricByVariation) o;
    return Objects.equals(this.variationKey, metricByVariation.variationKey) &&
        Objects.equals(this.metrics, metricByVariation.metrics)&&
        Objects.equals(this.additionalProperties, metricByVariation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(variationKey, metrics, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MetricByVariation {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricByVariation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricByVariation is not found in the empty JSON string", MetricByVariation.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricByVariation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricByVariation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricByVariation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricByVariation.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricByVariation>() {
           @Override
           public void write(JsonWriter out, MetricByVariation value) throws IOException {
           ...
           @Override
           public MetricByVariation read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MetricByVariation instance = thisAdapter.fromJsonTree(jsonObj);
