...
public class BranchCollectionRep {
  ...
  public BranchCollectionRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public BranchCollectionRep items(@javax.annotation.Nonnull List<BranchRep> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<BranchRep> items) {
    this.items = items;
  }
   ...
   * @return the BranchCollectionRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to BranchCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BranchCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BranchCollectionRep is not found in the empty JSON string", BranchCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        BranchRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
