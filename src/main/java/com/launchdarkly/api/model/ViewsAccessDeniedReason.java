...
public class ViewsAccessDeniedReason {
  ...
  public ViewsAccessDeniedReason resources(List<String> resources) {
  ...
  **/
  ...
  public ViewsAccessDeniedReason notResources(List<String> notResources) {
  ...
  **/
  ...
  public ViewsAccessDeniedReason actions(List<String> actions) {
  ...
  **/
  ...
  public ViewsAccessDeniedReason notActions(List<String> notActions) {
  ...
  **/
  ...
  public ViewsAccessDeniedReason effect(EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  **/
  ...
  public ViewsAccessDeniedReason roleName(String roleName) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsAccessDeniedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewsAccessDeniedReason is not found in the empty JSON string", ViewsAccessDeniedReason.openapiRequiredFields.toString()));
        }
      }
