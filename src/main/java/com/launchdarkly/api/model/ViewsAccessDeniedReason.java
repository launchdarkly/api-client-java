...
public class ViewsAccessDeniedReason {
  ...
  public ViewsAccessDeniedReason resources(@javax.annotation.Nullable List<String> resources) {
    this.resources = resources;
    return this;
  }

  public ViewsAccessDeniedReason addResourcesItem(String resourcesItem) {
  ...
  public ViewsAccessDeniedReason notResources(@javax.annotation.Nullable List<String> notResources) {
    this.notResources = notResources;
    return this;
  }

  public ViewsAccessDeniedReason addNotResourcesItem(String notResourcesItem) {
  ...
  public ViewsAccessDeniedReason actions(@javax.annotation.Nullable List<String> actions) {
    this.actions = actions;
    return this;
  }

  public ViewsAccessDeniedReason addActionsItem(String actionsItem) {
  ...
  public ViewsAccessDeniedReason notActions(@javax.annotation.Nullable List<String> notActions) {
    this.notActions = notActions;
    return this;
  }

  public ViewsAccessDeniedReason addNotActionsItem(String notActionsItem) {
  ...
  public ViewsAccessDeniedReason effect(@javax.annotation.Nonnull EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  public ViewsAccessDeniedReason roleName(@javax.annotation.Nullable String roleName) {
   ...
   * @return the ViewsAccessDeniedReason instance itself
   */
  public ViewsAccessDeniedReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewsAccessDeniedReason viewsAccessDeniedReason = (ViewsAccessDeniedReason) o;
    return Objects.equals(this.resources, viewsAccessDeniedReason.resources) &&
        Objects.equals(this.notResources, viewsAccessDeniedReason.notResources) &&
        Objects.equals(this.actions, viewsAccessDeniedReason.actions) &&
        Objects.equals(this.notActions, viewsAccessDeniedReason.notActions) &&
        Objects.equals(this.effect, viewsAccessDeniedReason.effect) &&
        Objects.equals(this.roleName, viewsAccessDeniedReason.roleName)&&
        Objects.equals(this.additionalProperties, viewsAccessDeniedReason.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewsAccessDeniedReason {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewsAccessDeniedReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsAccessDeniedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewsAccessDeniedReason is not found in the empty JSON string", ViewsAccessDeniedReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewsAccessDeniedReason.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewsAccessDeniedReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewsAccessDeniedReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewsAccessDeniedReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewsAccessDeniedReason.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewsAccessDeniedReason>() {
           @Override
           public void write(JsonWriter out, ViewsAccessDeniedReason value) throws IOException {
           ...
           @Override
           public ViewsAccessDeniedReason read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewsAccessDeniedReason instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewsAccessDeniedReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewsAccessDeniedReason
   * @throws IOException if the JSON string is invalid with respect to ViewsAccessDeniedReason
   */
  public static ViewsAccessDeniedReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewsAccessDeniedReason.class);
  }

  /**
   * Convert an instance of ViewsAccessDeniedReason to an JSON string
   *
   * @return JSON string
   */
