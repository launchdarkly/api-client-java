...
public class RestrictedModelError {
  ...
  public RestrictedModelError key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public RestrictedModelError message(@javax.annotation.Nonnull String message) {
  ...
  public RestrictedModelError code(@javax.annotation.Nonnull Integer code) {
    this.code = code;
    return this;
  }
   ...
   * @return the RestrictedModelError instance itself
   */
  public RestrictedModelError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RestrictedModelError restrictedModelError = (RestrictedModelError) o;
    return Objects.equals(this.key, restrictedModelError.key) &&
        Objects.equals(this.message, restrictedModelError.message) &&
        Objects.equals(this.code, restrictedModelError.code)&&
        Objects.equals(this.additionalProperties, restrictedModelError.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, message, code, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RestrictedModelError {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "message", "code"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "message", "code"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RestrictedModelError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RestrictedModelError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RestrictedModelError is not found in the empty JSON string", RestrictedModelError.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RestrictedModelError.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RestrictedModelError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RestrictedModelError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RestrictedModelError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RestrictedModelError.class));

       return (TypeAdapter<T>) new TypeAdapter<RestrictedModelError>() {
           @Override
           public void write(JsonWriter out, RestrictedModelError value) throws IOException {
           ...
           @Override
           public RestrictedModelError read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RestrictedModelError instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of RestrictedModelError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RestrictedModelError
   * @throws IOException if the JSON string is invalid with respect to RestrictedModelError
   */
  public static RestrictedModelError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RestrictedModelError.class);
  }

  /**
   * Convert an instance of RestrictedModelError to an JSON string
   *
   * @return JSON string
   */
