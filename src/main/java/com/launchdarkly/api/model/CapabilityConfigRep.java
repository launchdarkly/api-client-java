...
import com.launchdarkly.api.model.AuditLogEventsHookCapabilityConfigRep;
...
public class CapabilityConfigRep {
   ...
   * @return the CapabilityConfigRep instance itself
   */
  public CapabilityConfigRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CapabilityConfigRep capabilityConfigRep = (CapabilityConfigRep) o;
    return Objects.equals(this.approvals, capabilityConfigRep.approvals) &&
        Objects.equals(this.auditLogEventsHook, capabilityConfigRep.auditLogEventsHook)&&
        Objects.equals(this.additionalProperties, capabilityConfigRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CapabilityConfigRep {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapabilityConfigRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CapabilityConfigRep is not found in the empty JSON string", CapabilityConfigRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("auditLogEventsHook") != null && !jsonObj.get("auditLogEventsHook").isJsonNull()) {
        AuditLogEventsHookCapabilityConfigRep.validateJsonElement(jsonObj.get("auditLogEventsHook"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CapabilityConfigRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CapabilityConfigRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CapabilityConfigRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CapabilityConfigRep.class));

       return (TypeAdapter<T>) new TypeAdapter<CapabilityConfigRep>() {
           @Override
           public void write(JsonWriter out, CapabilityConfigRep value) throws IOException {
           ...
           @Override
           public CapabilityConfigRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CapabilityConfigRep instance = thisAdapter.fromJsonTree(jsonObj);
