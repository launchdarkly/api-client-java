...
public class FlagSempatch {
  ...
  public FlagSempatch instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
    this.instructions = instructions;
    return this;
  }

  public FlagSempatch addInstructionsItem(Map<String, Object> instructionsItem) {
  ...
  public FlagSempatch comment(@javax.annotation.Nullable String comment) {
   ...
   * @return the FlagSempatch instance itself
   */
  public FlagSempatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagSempatch flagSempatch = (FlagSempatch) o;
    return Objects.equals(this.instructions, flagSempatch.instructions) &&
        Objects.equals(this.comment, flagSempatch.comment)&&
        Objects.equals(this.additionalProperties, flagSempatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instructions, comment, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagSempatch {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("instructions", "comment"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagSempatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagSempatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagSempatch is not found in the empty JSON string", FlagSempatch.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlagSempatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagSempatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagSempatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagSempatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagSempatch.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagSempatch>() {
           @Override
           public void write(JsonWriter out, FlagSempatch value) throws IOException {
           ...
           @Override
           public FlagSempatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagSempatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FlagSempatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlagSempatch
   * @throws IOException if the JSON string is invalid with respect to FlagSempatch
   */
  public static FlagSempatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlagSempatch.class);
  }

  /**
   * Convert an instance of FlagSempatch to an JSON string
   *
   * @return JSON string
   */
