...
public class FlagSempatch {
  ...
  public FlagSempatch instructions(List<Map<String, Object>> instructions) {
  ...
  **/
  ...
  public FlagSempatch comment(String comment) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagSempatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FlagSempatch is not found in the empty JSON string", FlagSempatch.openapiRequiredFields.toString()));
        }
      }
