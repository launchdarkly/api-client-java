...
public class StatisticCollectionRep {
   ...
   * @return the StatisticCollectionRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatisticCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StatisticCollectionRep is not found in the empty JSON string", StatisticCollectionRep.openapiRequiredFields.toString()));
        }
      }
