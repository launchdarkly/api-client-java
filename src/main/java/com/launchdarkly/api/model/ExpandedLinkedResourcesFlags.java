...
import com.launchdarkly.api.model.ExpandedFlag;
...
public class ExpandedLinkedResourcesFlags {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  @javax.annotation.Nonnull
  private List<ExpandedFlag> items = new ArrayList<>();
  ...
  public ExpandedLinkedResourcesFlags items(@javax.annotation.Nonnull List<ExpandedFlag> items) {
    this.items = items;
    return this;
  }

  public ExpandedLinkedResourcesFlags addItemsItem(ExpandedFlag itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<ExpandedFlag> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<ExpandedFlag> items) {
    this.items = items;
  }


  public ExpandedLinkedResourcesFlags totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the ExpandedLinkedResourcesFlags instance itself
   */
  public ExpandedLinkedResourcesFlags putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedLinkedResourcesFlags expandedLinkedResourcesFlags = (ExpandedLinkedResourcesFlags) o;
    return Objects.equals(this.items, expandedLinkedResourcesFlags.items) &&
        Objects.equals(this.totalCount, expandedLinkedResourcesFlags.totalCount)&&
        Objects.equals(this.additionalProperties, expandedLinkedResourcesFlags.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpandedLinkedResourcesFlags {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpandedLinkedResourcesFlags
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedLinkedResourcesFlags.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedLinkedResourcesFlags is not found in the empty JSON string", ExpandedLinkedResourcesFlags.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExpandedLinkedResourcesFlags.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ExpandedFlag.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedLinkedResourcesFlags.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedLinkedResourcesFlags' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedLinkedResourcesFlags> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedLinkedResourcesFlags.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedLinkedResourcesFlags>() {
           @Override
           public void write(JsonWriter out, ExpandedLinkedResourcesFlags value) throws IOException {
           ...
           @Override
           public ExpandedLinkedResourcesFlags read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedLinkedResourcesFlags instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExpandedLinkedResourcesFlags given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpandedLinkedResourcesFlags
   * @throws IOException if the JSON string is invalid with respect to ExpandedLinkedResourcesFlags
   */
  public static ExpandedLinkedResourcesFlags fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandedLinkedResourcesFlags.class);
  }

  /**
   * Convert an instance of ExpandedLinkedResourcesFlags to an JSON string
   *
   * @return JSON string
   */
