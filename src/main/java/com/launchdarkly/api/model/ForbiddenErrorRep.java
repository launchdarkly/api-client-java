...
public class ForbiddenErrorRep {
  ...
  public ForbiddenErrorRep code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public ForbiddenErrorRep message(@javax.annotation.Nonnull String message) {
   ...
   * @return the ForbiddenErrorRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForbiddenErrorRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForbiddenErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ForbiddenErrorRep is not found in the empty JSON string", ForbiddenErrorRep.openapiRequiredFields.toString()));
        }
      }
