...
public class MetricInMetricGroupInput {
  ...
  public MetricInMetricGroupInput key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public MetricInMetricGroupInput nameInGroup(@javax.annotation.Nonnull String nameInGroup) {
  ...
  public void setNameInGroup(@javax.annotation.Nonnull String nameInGroup) {
    this.nameInGroup = nameInGroup;
  }
   ...
   * @return the MetricInMetricGroupInput instance itself
   */
  public MetricInMetricGroupInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MetricInMetricGroupInput metricInMetricGroupInput = (MetricInMetricGroupInput) o;
    return Objects.equals(this.key, metricInMetricGroupInput.key) &&
        Objects.equals(this.nameInGroup, metricInMetricGroupInput.nameInGroup)&&
        Objects.equals(this.additionalProperties, metricInMetricGroupInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, nameInGroup, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MetricInMetricGroupInput {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "nameInGroup"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "nameInGroup"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricInMetricGroupInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricInMetricGroupInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricInMetricGroupInput is not found in the empty JSON string", MetricInMetricGroupInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetricInMetricGroupInput.openapiRequiredFields) {
      ...
      if (!jsonObj.get("nameInGroup").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricInMetricGroupInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricInMetricGroupInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricInMetricGroupInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricInMetricGroupInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricInMetricGroupInput>() {
           @Override
           public void write(JsonWriter out, MetricInMetricGroupInput value) throws IOException {
           ...
           @Override
           public MetricInMetricGroupInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MetricInMetricGroupInput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MetricInMetricGroupInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetricInMetricGroupInput
   * @throws IOException if the JSON string is invalid with respect to MetricInMetricGroupInput
   */
  public static MetricInMetricGroupInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricInMetricGroupInput.class);
  }

  /**
   * Convert an instance of MetricInMetricGroupInput to an JSON string
   *
   * @return JSON string
   */
