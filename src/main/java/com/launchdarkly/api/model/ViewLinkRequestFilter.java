...
public class ViewLinkRequestFilter {
  ...
  public ViewLinkRequestFilter filter(@javax.annotation.Nonnull String filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ViewLinkRequestFilter environmentId(@javax.annotation.Nullable String environmentId) {
  ...
  public ViewLinkRequestFilter comment(@javax.annotation.Nullable String comment) {
  ...
  public boolean equals(Object o) {
    ...
    ViewLinkRequestFilter viewLinkRequestFilter = (ViewLinkRequestFilter) o;
    return Objects.equals(this.filter, viewLinkRequestFilter.filter) &&
        Objects.equals(this.environmentId, viewLinkRequestFilter.environmentId) &&
        Objects.equals(this.comment, viewLinkRequestFilter.comment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filter, environmentId, comment);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewLinkRequestFilter {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("filter", "environmentId", "comment"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewLinkRequestFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewLinkRequestFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewLinkRequestFilter is not found in the empty JSON string", ViewLinkRequestFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewLinkRequestFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewLinkRequestFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewLinkRequestFilter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewLinkRequestFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewLinkRequestFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewLinkRequestFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewLinkRequestFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewLinkRequestFilter>() {
           @Override
           public void write(JsonWriter out, ViewLinkRequestFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewLinkRequestFilter read(JsonReader in) throws IOException {
   ...
   * @return An instance of ViewLinkRequestFilter
   * @throws IOException if the JSON string is invalid with respect to ViewLinkRequestFilter
   */
  public static ViewLinkRequestFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewLinkRequestFilter.class);
  }
