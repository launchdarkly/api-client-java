...
public class HoldoutPatchInput {
  ...
  public HoldoutPatchInput comment(@javax.annotation.Nullable String comment) {
  ...
  public HoldoutPatchInput instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
    this.instructions = instructions;
    return this;
  }

  public HoldoutPatchInput addInstructionsItem(Map<String, Object> instructionsItem) {
   ...
   * @return the HoldoutPatchInput instance itself
   */
  public HoldoutPatchInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    HoldoutPatchInput holdoutPatchInput = (HoldoutPatchInput) o;
    return Objects.equals(this.comment, holdoutPatchInput.comment) &&
        Objects.equals(this.instructions, holdoutPatchInput.instructions)&&
        Objects.equals(this.additionalProperties, holdoutPatchInput.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class HoldoutPatchInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HoldoutPatchInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HoldoutPatchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HoldoutPatchInput is not found in the empty JSON string", HoldoutPatchInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HoldoutPatchInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HoldoutPatchInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HoldoutPatchInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HoldoutPatchInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HoldoutPatchInput.class));

       return (TypeAdapter<T>) new TypeAdapter<HoldoutPatchInput>() {
           @Override
           public void write(JsonWriter out, HoldoutPatchInput value) throws IOException {
           ...
           @Override
           public HoldoutPatchInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             HoldoutPatchInput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of HoldoutPatchInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HoldoutPatchInput
   * @throws IOException if the JSON string is invalid with respect to HoldoutPatchInput
   */
  public static HoldoutPatchInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HoldoutPatchInput.class);
  }

  /**
   * Convert an instance of HoldoutPatchInput to an JSON string
   *
   * @return JSON string
   */
