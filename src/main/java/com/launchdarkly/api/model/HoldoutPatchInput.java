...
public class HoldoutPatchInput {
  ...
  public HoldoutPatchInput comment(String comment) {
  ...
  **/
  ...
  public HoldoutPatchInput instructions(List<Map<String, Object>> instructions) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HoldoutPatchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HoldoutPatchInput is not found in the empty JSON string", HoldoutPatchInput.openapiRequiredFields.toString()));
        }
      }
