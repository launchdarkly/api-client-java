...
public class EnvironmentSummary {
  ...
  public EnvironmentSummary links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public EnvironmentSummary putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public EnvironmentSummary key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public EnvironmentSummary name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public EnvironmentSummary color(@javax.annotation.Nonnull String color) {
    this.color = color;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, environmentSummary.links) &&
        Objects.equals(this.key, environmentSummary.key) &&
        Objects.equals(this.name, environmentSummary.name) &&
        Objects.equals(this.color, environmentSummary.color)&&
        Objects.equals(this.additionalProperties, environmentSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, key, name, color, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "key", "name", "color"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_links", "key", "name", "color"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnvironmentSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EnvironmentSummary is not found in the empty JSON string", EnvironmentSummary.openapiRequiredFields.toString()));
        }
      }
