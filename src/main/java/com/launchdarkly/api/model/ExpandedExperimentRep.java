...
public class ExpandedExperimentRep {
  ...
  public ExpandedExperimentRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public ExpandedExperimentRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ExpandedExperimentRep access(@javax.annotation.Nullable Access access) {
    this.access = access;
    return this;
  }
   ...
   * @return the ExpandedExperimentRep instance itself
   */
  public ExpandedExperimentRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedExperimentRep expandedExperimentRep = (ExpandedExperimentRep) o;
    return Objects.equals(this.key, expandedExperimentRep.key) &&
        Objects.equals(this.name, expandedExperimentRep.name) &&
        Objects.equals(this.access, expandedExperimentRep.access)&&
        Objects.equals(this.additionalProperties, expandedExperimentRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, access, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExpandedExperimentRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "_access"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpandedExperimentRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedExperimentRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedExperimentRep is not found in the empty JSON string", ExpandedExperimentRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExpandedExperimentRep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedExperimentRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedExperimentRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedExperimentRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedExperimentRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedExperimentRep>() {
           @Override
           public void write(JsonWriter out, ExpandedExperimentRep value) throws IOException {
           ...
           @Override
           public ExpandedExperimentRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedExperimentRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExpandedExperimentRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpandedExperimentRep
   * @throws IOException if the JSON string is invalid with respect to ExpandedExperimentRep
   */
  public static ExpandedExperimentRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandedExperimentRep.class);
  }

  /**
   * Convert an instance of ExpandedExperimentRep to an JSON string
   *
   * @return JSON string
   */
