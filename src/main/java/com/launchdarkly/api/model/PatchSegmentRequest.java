...
public class PatchSegmentRequest {
  ...
  public PatchSegmentRequest comment(@javax.annotation.Nullable String comment) {
  ...
  public PatchSegmentRequest instructions(@javax.annotation.Nonnull List<PatchSegmentInstruction> instructions) {
  ...
  public void setInstructions(@javax.annotation.Nonnull List<PatchSegmentInstruction> instructions) {
    this.instructions = instructions;
  }
   ...
   * @return the PatchSegmentRequest instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchSegmentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchSegmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PatchSegmentRequest is not found in the empty JSON string", PatchSegmentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayinstructions.size(); i++) {
        PatchSegmentInstruction.validateJsonElement(jsonArrayinstructions.get(i));
      };
  }
