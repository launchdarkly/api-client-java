...
public class AIConfigTargetingVariationValue extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AIConfigTargetingVariationValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AIConfigTargetingVariationValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AIConfigTargetingVariationValue>() {
                @Override
                ...
                public AIConfigTargetingVariationValue read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for AIConfigTargetingVariationValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AIConfigTargetingVariationValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AIConfigTargetingVariationValue(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public AIConfigTargetingVariationValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return AIConfigTargetingVariationValue.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * BigDecimal, Boolean, Object, String
     *
     ...
     * BigDecimal, Boolean, Object, String
     *
     * @return The actual instance (BigDecimal, Boolean, Object, String)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to AIConfigTargetingVariationValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for AIConfigTargetingVariationValue with oneOf schemas: BigDecimal, Boolean, Object, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
     ...
     * @return An instance of AIConfigTargetingVariationValue
     * @throws IOException if the JSON string is invalid with respect to AIConfigTargetingVariationValue
     */
    public static AIConfigTargetingVariationValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AIConfigTargetingVariationValue.class);
    }
