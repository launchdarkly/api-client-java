...
public class ContextInstanceSearch {
   ...
   * @return the ContextInstanceSearch instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextInstanceSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextInstanceSearch is not found in the empty JSON string", ContextInstanceSearch.openapiRequiredFields.toString()));
        }
      }
