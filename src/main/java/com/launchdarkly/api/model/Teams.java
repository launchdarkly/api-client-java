...
public class Teams {
  ...
  public Teams items(@javax.annotation.Nonnull List<Team> items) {
    this.items = items;
    return this;
  }
  ...
  public Teams links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public Teams totalCount(@javax.annotation.Nullable Integer totalCount) {
   ...
   * @return the Teams instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Teams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Teams is not found in the empty JSON string", Teams.openapiRequiredFields.toString()));
        }
      }
