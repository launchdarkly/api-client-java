...
public class MetricPost {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Required for click metrics")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Required for click and pageview metrics")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Required for custom metrics")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, kind, selector, urls, isActive, isNumeric, unit, eventKey, successCriteria, tags);
  }
