...
public class DependentMeasuredRolloutRep {
  ...
  public static final String SERIALIZED_NAME_FLAG_PURPOSE = "flagPurpose";
  @SerializedName(SERIALIZED_NAME_FLAG_PURPOSE)
  ...
  public DependentMeasuredRolloutRep flagPurpose(@javax.annotation.Nullable String flagPurpose) {
    this.flagPurpose = flagPurpose;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public String getFlagPurpose() {
    return flagPurpose;
  }

  public void setFlagPurpose(@javax.annotation.Nullable String flagPurpose) {
    this.flagPurpose = flagPurpose;
  }
  ...
  public DependentMeasuredRolloutRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the DependentMeasuredRolloutRep instance itself
   */
  public DependentMeasuredRolloutRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DependentMeasuredRolloutRep dependentMeasuredRolloutRep = (DependentMeasuredRolloutRep) o;
    return Objects.equals(this.id, dependentMeasuredRolloutRep.id) &&
        Objects.equals(this.flagKey, dependentMeasuredRolloutRep.flagKey) &&
        Objects.equals(this.flagName, dependentMeasuredRolloutRep.flagName) &&
        Objects.equals(this.flagPurpose, dependentMeasuredRolloutRep.flagPurpose) &&
        Objects.equals(this.environmentKey, dependentMeasuredRolloutRep.environmentKey) &&
        Objects.equals(this.environmentName, dependentMeasuredRolloutRep.environmentName) &&
        Objects.equals(this.status, dependentMeasuredRolloutRep.status) &&
        Objects.equals(this.creationDate, dependentMeasuredRolloutRep.creationDate) &&
        Objects.equals(this.links, dependentMeasuredRolloutRep.links)&&
        Objects.equals(this.additionalProperties, dependentMeasuredRolloutRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, flagKey, flagName, flagPurpose, environmentKey, environmentName, status, creationDate, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DependentMeasuredRolloutRep {\n");
    ...
    sb.append("    flagPurpose: ").append(toIndentedString(flagPurpose)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "flagKey", "flagName", "flagPurpose", "environmentKey", "environmentName", "status", "creationDate", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DependentMeasuredRolloutRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DependentMeasuredRolloutRep is not found in the empty JSON string", DependentMeasuredRolloutRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("flagName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `flagName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("flagName").toString()));
      }
      if ((jsonObj.get("flagPurpose") != null && !jsonObj.get("flagPurpose").isJsonNull()) && !jsonObj.get("flagPurpose").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `flagPurpose` to be a primitive type in the JSON string but got `%s`", jsonObj.get("flagPurpose").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DependentMeasuredRolloutRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DependentMeasuredRolloutRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DependentMeasuredRolloutRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DependentMeasuredRolloutRep.class));

       return (TypeAdapter<T>) new TypeAdapter<DependentMeasuredRolloutRep>() {
           @Override
           public void write(JsonWriter out, DependentMeasuredRolloutRep value) throws IOException {
           ...
           @Override
           public DependentMeasuredRolloutRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DependentMeasuredRolloutRep instance = thisAdapter.fromJsonTree(jsonObj);
