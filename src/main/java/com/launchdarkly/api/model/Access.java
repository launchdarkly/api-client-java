...
public class Access {
  ...
  public Access addDeniedItem(AccessDenied deniedItem) {
    if (this.denied == null) {
  ...
  public Access addAllowedItem(AccessAllowedRep allowedItem) {
   ...
   * @return the Access instance itself
   */
  public Access putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.denied, access.denied) &&
        Objects.equals(this.allowed, access.allowed)&&
        Objects.equals(this.additionalProperties, access.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Access.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Access is not found in the empty JSON string", Access.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraydenied.size(); i++) {
        AccessDenied.validateJsonElement(jsonArraydenied.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayallowed.size(); i++) {
        AccessAllowedRep.validateJsonElement(jsonArrayallowed.get(i));
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Access>() {
           ...
           public Access read(JsonReader in) throws IOException {
             ...
             Access instance = thisAdapter.fromJsonTree(jsonObj);
