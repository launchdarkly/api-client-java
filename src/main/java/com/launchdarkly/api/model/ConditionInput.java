...
public class ConditionInput {
  ...
  public ConditionInput addNotifyMemberIdsItem(String notifyMemberIdsItem) {
  ...
  public ConditionInput addNotifyTeamKeysItem(String notifyTeamKeysItem) {
  ...
  public ConditionInput putIntegrationConfigItem(String key, Object integrationConfigItem) {
   ...
   * @return the ConditionInput instance itself
   */
  public ConditionInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConditionInput conditionInput = (ConditionInput) o;
    return Objects.equals(this.scheduleKind, conditionInput.scheduleKind) &&
        Objects.equals(this.executionDate, conditionInput.executionDate) &&
        Objects.equals(this.waitDuration, conditionInput.waitDuration) &&
        Objects.equals(this.waitDurationUnit, conditionInput.waitDurationUnit) &&
        Objects.equals(this.executeNow, conditionInput.executeNow) &&
        Objects.equals(this.description, conditionInput.description) &&
        Objects.equals(this.notifyMemberIds, conditionInput.notifyMemberIds) &&
        Objects.equals(this.notifyTeamKeys, conditionInput.notifyTeamKeys) &&
        Objects.equals(this.integrationConfig, conditionInput.integrationConfig) &&
        Objects.equals(this.kind, conditionInput.kind)&&
        Objects.equals(this.additionalProperties, conditionInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scheduleKind, executionDate, waitDuration, waitDurationUnit, executeNow, description, notifyMemberIds, notifyTeamKeys, integrationConfig, kind, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConditionInput {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConditionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConditionInput is not found in the empty JSON string", ConditionInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConditionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConditionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConditionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConditionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ConditionInput>() {
           @Override
           public void write(JsonWriter out, ConditionInput value) throws IOException {
           ...
           @Override
           public ConditionInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ConditionInput instance = thisAdapter.fromJsonTree(jsonObj);
