...
public class UpsertPayloadRep {
   ...
   * @return the UpsertPayloadRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertPayloadRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpsertPayloadRep is not found in the empty JSON string", UpsertPayloadRep.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the required field `defaultClientSideAvailability`
      DefaultClientSideAvailability.validateJsonElement(jsonObj.get("defaultClientSideAvailability"));
  }
