...
public class ActionOutput {
   ...
   * @return the ActionOutput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ActionOutput is not found in the empty JSON string", ActionOutput.openapiRequiredFields.toString()));
        }
      }
