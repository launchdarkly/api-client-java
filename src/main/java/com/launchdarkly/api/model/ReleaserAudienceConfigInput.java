...
import com.launchdarkly.api.model.ReleaseGuardianConfigurationInput;
...
public class ReleaserAudienceConfigInput {
  ...
  public ReleaserAudienceConfigInput addNotifyMemberIdsItem(String notifyMemberIdsItem) {
  ...
  public ReleaserAudienceConfigInput addNotifyTeamKeysItem(String notifyTeamKeysItem) {
   ...
   * @return the ReleaserAudienceConfigInput instance itself
   */
  public ReleaserAudienceConfigInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReleaserAudienceConfigInput releaserAudienceConfigInput = (ReleaserAudienceConfigInput) o;
    return Objects.equals(this.audienceId, releaserAudienceConfigInput.audienceId) &&
        Objects.equals(this.releaseGuardianConfiguration, releaserAudienceConfigInput.releaseGuardianConfiguration) &&
        Objects.equals(this.notifyMemberIds, releaserAudienceConfigInput.notifyMemberIds) &&
        Objects.equals(this.notifyTeamKeys, releaserAudienceConfigInput.notifyTeamKeys)&&
        Objects.equals(this.additionalProperties, releaserAudienceConfigInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audienceId, releaseGuardianConfiguration, notifyMemberIds, notifyTeamKeys, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReleaserAudienceConfigInput {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleaserAudienceConfigInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleaserAudienceConfigInput is not found in the empty JSON string", ReleaserAudienceConfigInput.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("audienceId") != null && !jsonObj.get("audienceId").isJsonNull()) && !jsonObj.get("audienceId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `audienceId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("audienceId").toString()));
      }
      ...
      if (jsonObj.get("releaseGuardianConfiguration") != null && !jsonObj.get("releaseGuardianConfiguration").isJsonNull()) {
        ReleaseGuardianConfigurationInput.validateJsonElement(jsonObj.get("releaseGuardianConfiguration"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleaserAudienceConfigInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleaserAudienceConfigInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleaserAudienceConfigInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleaserAudienceConfigInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleaserAudienceConfigInput>() {
           @Override
           public void write(JsonWriter out, ReleaserAudienceConfigInput value) throws IOException {
           ...
           @Override
           public ReleaserAudienceConfigInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReleaserAudienceConfigInput instance = thisAdapter.fromJsonTree(jsonObj);
