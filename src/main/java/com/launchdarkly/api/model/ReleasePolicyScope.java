...
public class ReleasePolicyScope {
  ...
  public ReleasePolicyScope environmentKeys(List<String> environmentKeys) {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("environmentKeys");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePolicyScope.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReleasePolicyScope is not found in the empty JSON string", ReleasePolicyScope.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("environmentKeys") != null && !jsonObj.get("environmentKeys").isJsonNull() && !jsonObj.get("environmentKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `environmentKeys` to be an array in the JSON string but got `%s`", jsonObj.get("environmentKeys").toString()));
      }
  }
