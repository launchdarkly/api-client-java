...
public class ReleasePolicyScope {
  ...
  public ReleasePolicyScope environmentKeys(@javax.annotation.Nullable List<String> environmentKeys) {
    this.environmentKeys = environmentKeys;
    return this;
  }

  public ReleasePolicyScope addEnvironmentKeysItem(String environmentKeysItem) {
   ...
   * @return the ReleasePolicyScope instance itself
   */
  public ReleasePolicyScope putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReleasePolicyScope
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePolicyScope.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleasePolicyScope is not found in the empty JSON string", ReleasePolicyScope.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("environmentKeys") != null && !jsonObj.get("environmentKeys").isJsonNull() && !jsonObj.get("environmentKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `environmentKeys` to be an array in the JSON string but got `%s`", jsonObj.get("environmentKeys").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("flagTagKeys") != null && !jsonObj.get("flagTagKeys").isJsonNull() && !jsonObj.get("flagTagKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `flagTagKeys` to be an array in the JSON string but got `%s`", jsonObj.get("flagTagKeys").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleasePolicyScope.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleasePolicyScope' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleasePolicyScope> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleasePolicyScope.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleasePolicyScope>() {
           @Override
           public void write(JsonWriter out, ReleasePolicyScope value) throws IOException {
           ...
           @Override
           public ReleasePolicyScope read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReleasePolicyScope instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ReleasePolicyScope given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReleasePolicyScope
   * @throws IOException if the JSON string is invalid with respect to ReleasePolicyScope
   */
  public static ReleasePolicyScope fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReleasePolicyScope.class);
  }

  /**
   * Convert an instance of ReleasePolicyScope to an JSON string
   *
   * @return JSON string
   */
