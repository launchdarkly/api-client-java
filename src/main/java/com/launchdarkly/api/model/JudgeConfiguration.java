...
import com.launchdarkly.api.model.JudgeAttachment;
...
public class JudgeConfiguration {
  ...
  public JudgeConfiguration addJudgesItem(JudgeAttachment judgesItem) {
    if (this.judges == null) {
   ...
   * @return the JudgeConfiguration instance itself
   */
  public JudgeConfiguration putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JudgeConfiguration judgeConfiguration = (JudgeConfiguration) o;
    return Objects.equals(this.judges, judgeConfiguration.judges)&&
        Objects.equals(this.additionalProperties, judgeConfiguration.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(judges, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JudgeConfiguration {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JudgeConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in JudgeConfiguration is not found in the empty JSON string", JudgeConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("judges") != null && !jsonObj.get("judges").isJsonNull()) {
        ...
        if (jsonArrayjudges != null) {
          ...
          for (int i = 0; i < jsonArrayjudges.size(); i++) {
            JudgeAttachment.validateJsonElement(jsonArrayjudges.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JudgeConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JudgeConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JudgeConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JudgeConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<JudgeConfiguration>() {
           @Override
           public void write(JsonWriter out, JudgeConfiguration value) throws IOException {
           ...
           @Override
           public JudgeConfiguration read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             JudgeConfiguration instance = thisAdapter.fromJsonTree(jsonObj);
