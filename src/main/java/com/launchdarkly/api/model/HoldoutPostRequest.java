...
public class HoldoutPostRequest {
   ...
   * @return the HoldoutPostRequest instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, holdoutPostRequest.name) &&
        Objects.equals(this.key, holdoutPostRequest.key) &&
        Objects.equals(this.description, holdoutPostRequest.description) &&
        Objects.equals(this.randomizationunit, holdoutPostRequest.randomizationunit) &&
        Objects.equals(this.attributes, holdoutPostRequest.attributes) &&
        Objects.equals(this.holdoutamount, holdoutPostRequest.holdoutamount) &&
        Objects.equals(this.primarymetrickey, holdoutPostRequest.primarymetrickey) &&
        Objects.equals(this.metrics, holdoutPostRequest.metrics) &&
        Objects.equals(this.prerequisiteflagkey, holdoutPostRequest.prerequisiteflagkey) &&
        Objects.equals(this.maintainerId, holdoutPostRequest.maintainerId)&&
        Objects.equals(this.additionalProperties, holdoutPostRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, key, description, randomizationunit, attributes, holdoutamount, primarymetrickey, metrics, prerequisiteflagkey, maintainerId, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    primarymetrickey: ").append(toIndentedString(primarymetrickey)).append("\n");
    sb.append("    metrics: ").append(toIndentedString(metrics)).append("\n");
    sb.append("    prerequisiteflagkey: ").append(toIndentedString(prerequisiteflagkey)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HoldoutPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HoldoutPostRequest is not found in the empty JSON string", HoldoutPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("primarymetrickey") != null && !jsonObj.get("primarymetrickey").isJsonNull()) && !jsonObj.get("primarymetrickey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `primarymetrickey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("primarymetrickey").toString()));
      }
      ...
      if ((jsonObj.get("prerequisiteflagkey") != null && !jsonObj.get("prerequisiteflagkey").isJsonNull()) && !jsonObj.get("prerequisiteflagkey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `prerequisiteflagkey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("prerequisiteflagkey").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HoldoutPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HoldoutPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HoldoutPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HoldoutPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<HoldoutPostRequest>() {
           @Override
           ...
           public HoldoutPostRequest read(JsonReader in) throws IOException {
             ...
             HoldoutPostRequest instance = thisAdapter.fromJsonTree(jsonObj);
