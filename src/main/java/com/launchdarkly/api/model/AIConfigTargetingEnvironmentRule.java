...
import com.launchdarkly.api.model.AIConfigTargetingEnvironmentRuleClause;
...
public class AIConfigTargetingEnvironmentRule {
  ...
  public AIConfigTargetingEnvironmentRule addClausesItem(AIConfigTargetingEnvironmentRuleClause clausesItem) {
   ...
   * @return the AIConfigTargetingEnvironmentRule instance itself
   */
  public AIConfigTargetingEnvironmentRule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigTargetingEnvironmentRule aiConfigTargetingEnvironmentRule = (AIConfigTargetingEnvironmentRule) o;
    return Objects.equals(this.clauses, aiConfigTargetingEnvironmentRule.clauses) &&
        Objects.equals(this.trackEvents, aiConfigTargetingEnvironmentRule.trackEvents)&&
        Objects.equals(this.additionalProperties, aiConfigTargetingEnvironmentRule.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clauses, trackEvents, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIConfigTargetingEnvironmentRule {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigTargetingEnvironmentRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigTargetingEnvironmentRule is not found in the empty JSON string", AIConfigTargetingEnvironmentRule.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("clauses").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `clauses` to be an array in the JSON string but got `%s`", jsonObj.get("clauses").toString()));
      }
      ...
      for (int i = 0; i < jsonArrayclauses.size(); i++) {
        AIConfigTargetingEnvironmentRuleClause.validateJsonElement(jsonArrayclauses.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigTargetingEnvironmentRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigTargetingEnvironmentRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigTargetingEnvironmentRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigTargetingEnvironmentRule.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigTargetingEnvironmentRule>() {
           @Override
           public void write(JsonWriter out, AIConfigTargetingEnvironmentRule value) throws IOException {
           ...
           @Override
           public AIConfigTargetingEnvironmentRule read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigTargetingEnvironmentRule instance = thisAdapter.fromJsonTree(jsonObj);
