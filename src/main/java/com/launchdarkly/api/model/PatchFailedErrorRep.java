...
public class PatchFailedErrorRep {
  ...
  public PatchFailedErrorRep code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public PatchFailedErrorRep message(@javax.annotation.Nonnull String message) {
   ...
   * @return the PatchFailedErrorRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchFailedErrorRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchFailedErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PatchFailedErrorRep is not found in the empty JSON string", PatchFailedErrorRep.openapiRequiredFields.toString()));
        }
      }
