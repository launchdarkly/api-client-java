...
public class VariationOrRolloutRep {
   ...
   * @return the VariationOrRolloutRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariationOrRolloutRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariationOrRolloutRep is not found in the empty JSON string", VariationOrRolloutRep.openapiRequiredFields.toString()));
        }
      }
