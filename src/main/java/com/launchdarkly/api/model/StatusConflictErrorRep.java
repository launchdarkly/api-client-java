...
public class StatusConflictErrorRep {
  ...
  public StatusConflictErrorRep code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public StatusConflictErrorRep message(@javax.annotation.Nonnull String message) {
   ...
   * @return the StatusConflictErrorRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusConflictErrorRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusConflictErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StatusConflictErrorRep is not found in the empty JSON string", StatusConflictErrorRep.openapiRequiredFields.toString()));
        }
      }
