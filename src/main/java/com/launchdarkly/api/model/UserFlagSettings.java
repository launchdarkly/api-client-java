...
public class UserFlagSettings {
  ...
  public UserFlagSettings items(@javax.annotation.Nonnull Map<String, UserFlagSetting> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull Map<String, UserFlagSetting> items) {
    this.items = items;
  }


  public UserFlagSettings links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public UserFlagSettings putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the UserFlagSettings instance itself
   */
  public UserFlagSettings putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, userFlagSettings.items) &&
        Objects.equals(this.links, userFlagSettings.links)&&
        Objects.equals(this.additionalProperties, userFlagSettings.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserFlagSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserFlagSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserFlagSettings is not found in the empty JSON string", UserFlagSettings.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserFlagSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserFlagSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserFlagSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserFlagSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserFlagSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<UserFlagSettings>() {
           @Override
           public void write(JsonWriter out, UserFlagSettings value) throws IOException {
           ...
           @Override
           public UserFlagSettings read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UserFlagSettings instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UserFlagSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserFlagSettings
   * @throws IOException if the JSON string is invalid with respect to UserFlagSettings
   */
  public static UserFlagSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserFlagSettings.class);
  }

  /**
   * Convert an instance of UserFlagSettings to an JSON string
   *
   * @return JSON string
   */
