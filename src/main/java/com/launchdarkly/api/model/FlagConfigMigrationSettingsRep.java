...
public class FlagConfigMigrationSettingsRep {
   ...
   * @return the FlagConfigMigrationSettingsRep instance itself
   */
  public FlagConfigMigrationSettingsRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagConfigMigrationSettingsRep flagConfigMigrationSettingsRep = (FlagConfigMigrationSettingsRep) o;
    return Objects.equals(this.checkRatio, flagConfigMigrationSettingsRep.checkRatio)&&
        Objects.equals(this.additionalProperties, flagConfigMigrationSettingsRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checkRatio, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagConfigMigrationSettingsRep {\n");
    sb.append("    checkRatio: ").append(toIndentedString(checkRatio)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagConfigMigrationSettingsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagConfigMigrationSettingsRep is not found in the empty JSON string", FlagConfigMigrationSettingsRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagConfigMigrationSettingsRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagConfigMigrationSettingsRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagConfigMigrationSettingsRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagConfigMigrationSettingsRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagConfigMigrationSettingsRep>() {
           @Override
           public void write(JsonWriter out, FlagConfigMigrationSettingsRep value) throws IOException {
           ...
           @Override
           public FlagConfigMigrationSettingsRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagConfigMigrationSettingsRep instance = thisAdapter.fromJsonTree(jsonObj);
