...
public class Team {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("roles") != null && !jsonObj.get("roles").isJsonNull()) {
        TeamCustomRoles.validateJsonElement(jsonObj.get("roles"));
      }
      // validate the optional field `members`
      if (jsonObj.get("members") != null && !jsonObj.get("members").isJsonNull()) {
        TeamMembers.validateJsonElement(jsonObj.get("members"));
      }
      ...
      if (jsonObj.get("maintainers") != null && !jsonObj.get("maintainers").isJsonNull()) {
        TeamMaintainers.validateJsonElement(jsonObj.get("maintainers"));
      }
  }
