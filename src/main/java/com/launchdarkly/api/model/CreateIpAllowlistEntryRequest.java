...
public class CreateIpAllowlistEntryRequest {
  ...
  public CreateIpAllowlistEntryRequest ipAddress(@javax.annotation.Nonnull String ipAddress) {
  ...
  public CreateIpAllowlistEntryRequest description(@javax.annotation.Nullable String description) {
   ...
   * @return the CreateIpAllowlistEntryRequest instance itself
   */
  public CreateIpAllowlistEntryRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateIpAllowlistEntryRequest createIpAllowlistEntryRequest = (CreateIpAllowlistEntryRequest) o;
    return Objects.equals(this.ipAddress, createIpAllowlistEntryRequest.ipAddress) &&
        Objects.equals(this.description, createIpAllowlistEntryRequest.description)&&
        Objects.equals(this.additionalProperties, createIpAllowlistEntryRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipAddress, description, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateIpAllowlistEntryRequest {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ipAddress", "description"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("ipAddress"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIpAllowlistEntryRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIpAllowlistEntryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateIpAllowlistEntryRequest is not found in the empty JSON string", CreateIpAllowlistEntryRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateIpAllowlistEntryRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIpAllowlistEntryRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIpAllowlistEntryRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIpAllowlistEntryRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIpAllowlistEntryRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIpAllowlistEntryRequest>() {
           @Override
           public void write(JsonWriter out, CreateIpAllowlistEntryRequest value) throws IOException {
           ...
           @Override
           public CreateIpAllowlistEntryRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateIpAllowlistEntryRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateIpAllowlistEntryRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIpAllowlistEntryRequest
   * @throws IOException if the JSON string is invalid with respect to CreateIpAllowlistEntryRequest
   */
  public static CreateIpAllowlistEntryRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIpAllowlistEntryRequest.class);
  }

  /**
   * Convert an instance of CreateIpAllowlistEntryRequest to an JSON string
   *
   * @return JSON string
   */
