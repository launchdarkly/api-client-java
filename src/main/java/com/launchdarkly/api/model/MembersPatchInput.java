...
public class MembersPatchInput {
  ...
  public MembersPatchInput comment(@javax.annotation.Nullable String comment) {
  ...
  public MembersPatchInput instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
   ...
   * @return the MembersPatchInput instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to MembersPatchInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MembersPatchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MembersPatchInput is not found in the empty JSON string", MembersPatchInput.openapiRequiredFields.toString()));
        }
      }
