...
public class IterationInput {
  ...
  public static final String SERIALIZED_NAME_COVARIATE_ID = "covariateId";
  @SerializedName(SERIALIZED_NAME_COVARIATE_ID)
  @javax.annotation.Nullable
  ...
  public IterationInput reallocationFrequencyMillis(@javax.annotation.Nullable Integer reallocationFrequencyMillis) {
  ...
  public IterationInput covariateId(@javax.annotation.Nullable String covariateId) {
  ...
  public void setCovariateId(@javax.annotation.Nullable String covariateId) {
    this.covariateId = covariateId;
  }
   ...
   * @return the IterationInput instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hypothesis, iterationInput.hypothesis) &&
        Objects.equals(this.canReshuffleTraffic, iterationInput.canReshuffleTraffic) &&
        Objects.equals(this.metrics, iterationInput.metrics) &&
        Objects.equals(this.primarySingleMetricKey, iterationInput.primarySingleMetricKey) &&
        Objects.equals(this.primaryFunnelKey, iterationInput.primaryFunnelKey) &&
        ...
        Objects.equals(this.reallocationFrequencyMillis, iterationInput.reallocationFrequencyMillis) &&
        Objects.equals(this.covariateId, iterationInput.covariateId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hypothesis, canReshuffleTraffic, metrics, primarySingleMetricKey, primaryFunnelKey, treatments, flags, randomizationUnit, reallocationFrequencyMillis, covariateId, attributes, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    primarySingleMetricKey: ").append(toIndentedString(primarySingleMetricKey)).append("\n");
    sb.append("    primaryFunnelKey: ").append(toIndentedString(primaryFunnelKey)).append("\n");
    ...
    sb.append("    reallocationFrequencyMillis: ").append(toIndentedString(reallocationFrequencyMillis)).append("\n");
    sb.append("    covariateId: ").append(toIndentedString(covariateId)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("hypothesis", "canReshuffleTraffic", "metrics", "primarySingleMetricKey", "primaryFunnelKey", "treatments", "flags", "randomizationUnit", "reallocationFrequencyMillis", "covariateId", "attributes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IterationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IterationInput is not found in the empty JSON string", IterationInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("primarySingleMetricKey") != null && !jsonObj.get("primarySingleMetricKey").isJsonNull()) && !jsonObj.get("primarySingleMetricKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `primarySingleMetricKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("primarySingleMetricKey").toString()));
      }
      if ((jsonObj.get("primaryFunnelKey") != null && !jsonObj.get("primaryFunnelKey").isJsonNull()) && !jsonObj.get("primaryFunnelKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `primaryFunnelKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("primaryFunnelKey").toString()));
      }
      // ensure the json data is an array
      if (!jsonObj.get("treatments").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `treatments` to be an array in the JSON string but got `%s`", jsonObj.get("treatments").toString()));
      }
      ...
      if ((jsonObj.get("covariateId") != null && !jsonObj.get("covariateId").isJsonNull()) && !jsonObj.get("covariateId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `covariateId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("covariateId").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IterationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IterationInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IterationInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IterationInput.class));

       return (TypeAdapter<T>) new TypeAdapter<IterationInput>() {
           @Override
           ...
           public IterationInput read(JsonReader in) throws IOException {
             ...
             IterationInput instance = thisAdapter.fromJsonTree(jsonObj);
