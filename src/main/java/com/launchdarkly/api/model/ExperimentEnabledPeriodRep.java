...
public class ExperimentEnabledPeriodRep {
  ...
  public ExperimentEnabledPeriodRep() {
  }

  public ExperimentEnabledPeriodRep startDate(@javax.annotation.Nullable Long startDate) {
  ...
  public ExperimentEnabledPeriodRep stopDate(@javax.annotation.Nullable Long stopDate) {
   ...
   * @return the ExperimentEnabledPeriodRep instance itself
   */
  public ExperimentEnabledPeriodRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExperimentEnabledPeriodRep experimentEnabledPeriodRep = (ExperimentEnabledPeriodRep) o;
    return Objects.equals(this.startDate, experimentEnabledPeriodRep.startDate) &&
        Objects.equals(this.stopDate, experimentEnabledPeriodRep.stopDate)&&
        Objects.equals(this.additionalProperties, experimentEnabledPeriodRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExperimentEnabledPeriodRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExperimentEnabledPeriodRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExperimentEnabledPeriodRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExperimentEnabledPeriodRep is not found in the empty JSON string", ExperimentEnabledPeriodRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExperimentEnabledPeriodRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExperimentEnabledPeriodRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExperimentEnabledPeriodRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExperimentEnabledPeriodRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ExperimentEnabledPeriodRep>() {
           @Override
           public void write(JsonWriter out, ExperimentEnabledPeriodRep value) throws IOException {
           ...
           @Override
           public ExperimentEnabledPeriodRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExperimentEnabledPeriodRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExperimentEnabledPeriodRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExperimentEnabledPeriodRep
   * @throws IOException if the JSON string is invalid with respect to ExperimentEnabledPeriodRep
   */
  public static ExperimentEnabledPeriodRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExperimentEnabledPeriodRep.class);
  }

  /**
   * Convert an instance of ExperimentEnabledPeriodRep to an JSON string
   *
   * @return JSON string
   */
