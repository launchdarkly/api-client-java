...
public class ExpandedLinkedAIConfigs {
  ...
  public ExpandedLinkedAIConfigs items(@javax.annotation.Nonnull List<ExpandedAIConfig> items) {
    this.items = items;
    return this;
  }

  public ExpandedLinkedAIConfigs addItemsItem(ExpandedAIConfig itemsItem) {
    if (this.items == null) {
  ...
  public ExpandedLinkedAIConfigs totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the ExpandedLinkedAIConfigs instance itself
   */
  public ExpandedLinkedAIConfigs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedLinkedAIConfigs expandedLinkedAIConfigs = (ExpandedLinkedAIConfigs) o;
    return Objects.equals(this.items, expandedLinkedAIConfigs.items) &&
        Objects.equals(this.totalCount, expandedLinkedAIConfigs.totalCount)&&
        Objects.equals(this.additionalProperties, expandedLinkedAIConfigs.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpandedLinkedAIConfigs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpandedLinkedAIConfigs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedLinkedAIConfigs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedLinkedAIConfigs is not found in the empty JSON string", ExpandedLinkedAIConfigs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExpandedLinkedAIConfigs.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedLinkedAIConfigs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedLinkedAIConfigs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedLinkedAIConfigs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedLinkedAIConfigs.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedLinkedAIConfigs>() {
           @Override
           public void write(JsonWriter out, ExpandedLinkedAIConfigs value) throws IOException {
           ...
           @Override
           public ExpandedLinkedAIConfigs read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedLinkedAIConfigs instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExpandedLinkedAIConfigs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpandedLinkedAIConfigs
   * @throws IOException if the JSON string is invalid with respect to ExpandedLinkedAIConfigs
   */
  public static ExpandedLinkedAIConfigs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandedLinkedAIConfigs.class);
  }

  /**
   * Convert an instance of ExpandedLinkedAIConfigs to an JSON string
   *
   * @return JSON string
   */
