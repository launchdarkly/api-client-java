...
public class ViewLinkRequestSegmentIdentifiers {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("segmentIdentifiers").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `segmentIdentifiers` to be an array in the JSON string but got `%s`", jsonObj.get("segmentIdentifiers").toString()));
      }
