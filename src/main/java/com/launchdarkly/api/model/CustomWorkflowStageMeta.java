...
public class CustomWorkflowStageMeta {
  ...
  public CustomWorkflowStageMeta index(@javax.annotation.Nullable Integer index) {
    this.index = index;
    return this;
  }
  ...
  public CustomWorkflowStageMeta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the CustomWorkflowStageMeta instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("index", "name"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomWorkflowStageMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomWorkflowStageMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomWorkflowStageMeta is not found in the empty JSON string", CustomWorkflowStageMeta.openapiRequiredFields.toString()));
        }
      }
