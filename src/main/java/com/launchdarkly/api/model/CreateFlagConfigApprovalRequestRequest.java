...
public class CreateFlagConfigApprovalRequestRequest {
  ...
  public CreateFlagConfigApprovalRequestRequest addInstructionsItem(Map<String, Object> instructionsItem) {
  ...
  public CreateFlagConfigApprovalRequestRequest addNotifyMemberIdsItem(String notifyMemberIdsItem) {
  ...
  public CreateFlagConfigApprovalRequestRequest addNotifyTeamKeysItem(String notifyTeamKeysItem) {
  ...
  public CreateFlagConfigApprovalRequestRequest putIntegrationConfigItem(String key, Object integrationConfigItem) {
   ...
   * @return the CreateFlagConfigApprovalRequestRequest instance itself
   */
  public CreateFlagConfigApprovalRequestRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFlagConfigApprovalRequestRequest createFlagConfigApprovalRequestRequest = (CreateFlagConfigApprovalRequestRequest) o;
    return Objects.equals(this.comment, createFlagConfigApprovalRequestRequest.comment) &&
        Objects.equals(this.description, createFlagConfigApprovalRequestRequest.description) &&
        Objects.equals(this.instructions, createFlagConfigApprovalRequestRequest.instructions) &&
        Objects.equals(this.notifyMemberIds, createFlagConfigApprovalRequestRequest.notifyMemberIds) &&
        Objects.equals(this.notifyTeamKeys, createFlagConfigApprovalRequestRequest.notifyTeamKeys) &&
        Objects.equals(this.executionDate, createFlagConfigApprovalRequestRequest.executionDate) &&
        Objects.equals(this.operatingOnId, createFlagConfigApprovalRequestRequest.operatingOnId) &&
        Objects.equals(this.integrationConfig, createFlagConfigApprovalRequestRequest.integrationConfig)&&
        Objects.equals(this.additionalProperties, createFlagConfigApprovalRequestRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, description, instructions, notifyMemberIds, notifyTeamKeys, executionDate, operatingOnId, integrationConfig, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateFlagConfigApprovalRequestRequest {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFlagConfigApprovalRequestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateFlagConfigApprovalRequestRequest is not found in the empty JSON string", CreateFlagConfigApprovalRequestRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFlagConfigApprovalRequestRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFlagConfigApprovalRequestRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFlagConfigApprovalRequestRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFlagConfigApprovalRequestRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFlagConfigApprovalRequestRequest>() {
           @Override
           public void write(JsonWriter out, CreateFlagConfigApprovalRequestRequest value) throws IOException {
           ...
           @Override
           public CreateFlagConfigApprovalRequestRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateFlagConfigApprovalRequestRequest instance = thisAdapter.fromJsonTree(jsonObj);
