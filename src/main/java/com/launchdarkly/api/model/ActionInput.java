...
public class ActionInput {
   ...
   * @return the ActionInput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ActionInput is not found in the empty JSON string", ActionInput.openapiRequiredFields.toString()));
        }
      }
