...
public class UserAttributeNamesRep {
  ...
  public UserAttributeNamesRep addPrivateItem(String _privateItem) {
  ...
  public UserAttributeNamesRep addCustomItem(String customItem) {
    if (this.custom == null) {
  ...
  public UserAttributeNamesRep addStandardItem(String standardItem) {
   ...
   * @return the UserAttributeNamesRep instance itself
   */
  public UserAttributeNamesRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserAttributeNamesRep userAttributeNamesRep = (UserAttributeNamesRep) o;
    return Objects.equals(this._private, userAttributeNamesRep._private) &&
        Objects.equals(this.custom, userAttributeNamesRep.custom) &&
        Objects.equals(this.standard, userAttributeNamesRep.standard)&&
        Objects.equals(this.additionalProperties, userAttributeNamesRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_private, custom, standard, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAttributeNamesRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserAttributeNamesRep is not found in the empty JSON string", UserAttributeNamesRep.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("private") != null && !jsonObj.get("private").isJsonNull() && !jsonObj.get("private").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `private` to be an array in the JSON string but got `%s`", jsonObj.get("private").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("standard") != null && !jsonObj.get("standard").isJsonNull() && !jsonObj.get("standard").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `standard` to be an array in the JSON string but got `%s`", jsonObj.get("standard").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAttributeNamesRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAttributeNamesRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAttributeNamesRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAttributeNamesRep.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAttributeNamesRep>() {
           @Override
           public void write(JsonWriter out, UserAttributeNamesRep value) throws IOException {
           ...
           @Override
           public UserAttributeNamesRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UserAttributeNamesRep instance = thisAdapter.fromJsonTree(jsonObj);
