...
public class ExpandedLinkedMetrics {
  ...
  public ExpandedLinkedMetrics items(@javax.annotation.Nonnull List<ExpandedMetric> items) {
    this.items = items;
    return this;
  }

  public ExpandedLinkedMetrics addItemsItem(ExpandedMetric itemsItem) {
    if (this.items == null) {
  ...
  public ExpandedLinkedMetrics totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the ExpandedLinkedMetrics instance itself
   */
  public ExpandedLinkedMetrics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedLinkedMetrics expandedLinkedMetrics = (ExpandedLinkedMetrics) o;
    return Objects.equals(this.items, expandedLinkedMetrics.items) &&
        Objects.equals(this.totalCount, expandedLinkedMetrics.totalCount)&&
        Objects.equals(this.additionalProperties, expandedLinkedMetrics.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpandedLinkedMetrics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpandedLinkedMetrics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedLinkedMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedLinkedMetrics is not found in the empty JSON string", ExpandedLinkedMetrics.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExpandedLinkedMetrics.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedLinkedMetrics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedLinkedMetrics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedLinkedMetrics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedLinkedMetrics.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedLinkedMetrics>() {
           @Override
           public void write(JsonWriter out, ExpandedLinkedMetrics value) throws IOException {
           ...
           @Override
           public ExpandedLinkedMetrics read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedLinkedMetrics instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExpandedLinkedMetrics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpandedLinkedMetrics
   * @throws IOException if the JSON string is invalid with respect to ExpandedLinkedMetrics
   */
  public static ExpandedLinkedMetrics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandedLinkedMetrics.class);
  }

  /**
   * Convert an instance of ExpandedLinkedMetrics to an JSON string
   *
   * @return JSON string
   */
