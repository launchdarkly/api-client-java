...
public class VariationEvalSummary {
   ...
   * @return the VariationEvalSummary instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariationEvalSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariationEvalSummary is not found in the empty JSON string", VariationEvalSummary.openapiRequiredFields.toString()));
        }
      }
