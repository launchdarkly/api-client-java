...
public class DependentFlag {
  ...
  public DependentFlag name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public DependentFlag key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public DependentFlag links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public DependentFlag putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public DependentFlag site(@javax.annotation.Nonnull Link site) {
    this.site = site;
    return this;
  }
   ...
   * @return the DependentFlag instance itself
   */
  public DependentFlag putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, dependentFlag.name) &&
        ...
        Objects.equals(this.additionalProperties, dependentFlag.additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "_links", "_site"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DependentFlag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DependentFlag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DependentFlag is not found in the empty JSON string", DependentFlag.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DependentFlag.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DependentFlag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DependentFlag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DependentFlag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DependentFlag.class));

       return (TypeAdapter<T>) new TypeAdapter<DependentFlag>() {
           @Override
           public void write(JsonWriter out, DependentFlag value) throws IOException {
           ...
           @Override
           public DependentFlag read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DependentFlag instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of DependentFlag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DependentFlag
   * @throws IOException if the JSON string is invalid with respect to DependentFlag
   */
  public static DependentFlag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DependentFlag.class);
  }

  /**
   * Convert an instance of DependentFlag to an JSON string
   *
   * @return JSON string
   */
