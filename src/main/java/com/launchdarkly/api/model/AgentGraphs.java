...
public class AgentGraphs {
  ...
  private List<AgentGraph> items = new ArrayList<>();
  ...
  public AgentGraphs links(@javax.annotation.Nullable PaginatedLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AgentGraphs items(@javax.annotation.Nonnull List<AgentGraph> items) {
    this.items = items;
    return this;
  }

  public AgentGraphs addItemsItem(AgentGraph itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<AgentGraph> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<AgentGraph> items) {
    this.items = items;
  }


  public AgentGraphs totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the AgentGraphs instance itself
   */
  public AgentGraphs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AgentGraphs agentGraphs = (AgentGraphs) o;
    return Objects.equals(this.links, agentGraphs.links) &&
        Objects.equals(this.items, agentGraphs.items) &&
        Objects.equals(this.totalCount, agentGraphs.totalCount)&&
        Objects.equals(this.additionalProperties, agentGraphs.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentGraphs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentGraphs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentGraphs is not found in the empty JSON string", AgentGraphs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentGraphs.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        AgentGraph.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentGraphs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentGraphs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentGraphs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentGraphs.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentGraphs>() {
           @Override
           public void write(JsonWriter out, AgentGraphs value) throws IOException {
           ...
           @Override
           public AgentGraphs read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentGraphs instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentGraphs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentGraphs
   * @throws IOException if the JSON string is invalid with respect to AgentGraphs
   */
  public static AgentGraphs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentGraphs.class);
  }

  /**
   * Convert an instance of AgentGraphs to an JSON string
   *
   * @return JSON string
   */
