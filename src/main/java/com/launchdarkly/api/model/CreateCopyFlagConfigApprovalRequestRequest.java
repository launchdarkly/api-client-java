...
public class CreateCopyFlagConfigApprovalRequestRequest {
  ...
  public enum IncludedActionsEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      IncludedActionsEnum.fromValue(value);
    }
  }
  ...
  public enum ExcludedActionsEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ExcludedActionsEnum.fromValue(value);
    }
  }
   ...
   * @return the CreateCopyFlagConfigApprovalRequestRequest instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCopyFlagConfigApprovalRequestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateCopyFlagConfigApprovalRequestRequest is not found in the empty JSON string", CreateCopyFlagConfigApprovalRequestRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("notifyTeamKeys") != null && !jsonObj.get("notifyTeamKeys").isJsonNull() && !jsonObj.get("notifyTeamKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `notifyTeamKeys` to be an array in the JSON string but got `%s`", jsonObj.get("notifyTeamKeys").toString()));
      }
      ...
      if (jsonObj.get("includedActions") != null && !jsonObj.get("includedActions").isJsonNull() && !jsonObj.get("includedActions").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `includedActions` to be an array in the JSON string but got `%s`", jsonObj.get("includedActions").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("excludedActions") != null && !jsonObj.get("excludedActions").isJsonNull() && !jsonObj.get("excludedActions").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `excludedActions` to be an array in the JSON string but got `%s`", jsonObj.get("excludedActions").toString()));
      }
  }
