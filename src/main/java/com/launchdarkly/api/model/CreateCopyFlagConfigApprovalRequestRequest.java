...
public class CreateCopyFlagConfigApprovalRequestRequest {
  ...
  private List<String> includedActions = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "A comment describing the approval request")
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "An array of member IDs. These members are notified to review the approval request.")
  ...
  **/
  ...
  public CreateCopyFlagConfigApprovalRequestRequest includedActions(List<String> includedActions) {
    
    this.includedActions = includedActions;
    return this;
  }

  public CreateCopyFlagConfigApprovalRequestRequest addIncludedActionsItem(String includedActionsItem) {
    if (this.includedActions == null) {
      this.includedActions = new ArrayList<String>();
    }
  ...
  **/
  ...
  public List<String> getIncludedActions() {
    return includedActions;
  }


  public void setIncludedActions(List<String> includedActions) {
    this.includedActions = includedActions;
  }


  public CreateCopyFlagConfigApprovalRequestRequest excludedActions(List<String> excludedActions) {
    
    this.excludedActions = excludedActions;
    return this;
  }

  public CreateCopyFlagConfigApprovalRequestRequest addExcludedActionsItem(String excludedActionsItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, description, notifyMemberIds, source, includedActions, excludedActions);
  }
