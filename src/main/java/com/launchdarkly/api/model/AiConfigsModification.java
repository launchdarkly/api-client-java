...
public class AiConfigsModification {
  ...
  public AiConfigsModification date(@javax.annotation.Nullable OffsetDateTime date) {
    this.date = date;
    return this;
  }
   ...
   * @return the AiConfigsModification instance itself
   */
  public AiConfigsModification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiConfigsModification aiConfigsModification = (AiConfigsModification) o;
    return Objects.equals(this.date, aiConfigsModification.date)&&
        Objects.equals(this.additionalProperties, aiConfigsModification.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiConfigsModification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiConfigsModification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiConfigsModification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiConfigsModification is not found in the empty JSON string", AiConfigsModification.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiConfigsModification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiConfigsModification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiConfigsModification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiConfigsModification.class));

       return (TypeAdapter<T>) new TypeAdapter<AiConfigsModification>() {
           @Override
           public void write(JsonWriter out, AiConfigsModification value) throws IOException {
           ...
           @Override
           public AiConfigsModification read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiConfigsModification instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AiConfigsModification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AiConfigsModification
   * @throws IOException if the JSON string is invalid with respect to AiConfigsModification
   */
  public static AiConfigsModification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiConfigsModification.class);
  }

  /**
   * Convert an instance of AiConfigsModification to an JSON string
   *
   * @return JSON string
   */
