...
public class RelayAutoConfigCollectionRep {
  ...
  public RelayAutoConfigCollectionRep items(@javax.annotation.Nonnull List<RelayAutoConfigRep> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<RelayAutoConfigRep> items) {
    this.items = items;
  }
   ...
   * @return the RelayAutoConfigCollectionRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to RelayAutoConfigCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelayAutoConfigCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelayAutoConfigCollectionRep is not found in the empty JSON string", RelayAutoConfigCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        RelayAutoConfigRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
