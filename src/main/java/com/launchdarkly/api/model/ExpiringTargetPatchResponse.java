...
public class ExpiringTargetPatchResponse {
   ...
   * @return the ExpiringTargetPatchResponse instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, expiringTargetPatchResponse.items) &&
        Objects.equals(this.links, expiringTargetPatchResponse.links) &&
        Objects.equals(this.totalInstructions, expiringTargetPatchResponse.totalInstructions) &&
        Objects.equals(this.successfulInstructions, expiringTargetPatchResponse.successfulInstructions) &&
        Objects.equals(this.failedInstructions, expiringTargetPatchResponse.failedInstructions) &&
        Objects.equals(this.errors, expiringTargetPatchResponse.errors)&&
        Objects.equals(this.additionalProperties, expiringTargetPatchResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpiringTargetPatchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpiringTargetPatchResponse is not found in the empty JSON string", ExpiringTargetPatchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ExpiringTarget.validateJsonElement(jsonArrayitems.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpiringTargetPatchResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpiringTargetPatchResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpiringTargetPatchResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpiringTargetPatchResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpiringTargetPatchResponse>() {
           @Override
           ...
           public ExpiringTargetPatchResponse read(JsonReader in) throws IOException {
             ...
             ExpiringTargetPatchResponse instance = thisAdapter.fromJsonTree(jsonObj);
