...
public class ViewPatch {
  ...
  public ViewPatch name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ViewPatch description(@javax.annotation.Nullable String description) {
  ...
  public ViewPatch generateSdkKeys(@javax.annotation.Nullable Boolean generateSdkKeys) {
  ...
  public void setGenerateSdkKeys(@javax.annotation.Nullable Boolean generateSdkKeys) {
    this.generateSdkKeys = generateSdkKeys;
  }


  public ViewPatch maintainerId(@javax.annotation.Nullable String maintainerId) {
  ...
  public ViewPatch maintainerTeamKey(@javax.annotation.Nullable String maintainerTeamKey) {
  ...
  public ViewPatch tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public ViewPatch addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public ViewPatch archived(@javax.annotation.Nullable Boolean archived) {
   ...
   * @return the ViewPatch instance itself
   */
  public ViewPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewPatch viewPatch = (ViewPatch) o;
    return Objects.equals(this.name, viewPatch.name) &&
        Objects.equals(this.description, viewPatch.description) &&
        Objects.equals(this.generateSdkKeys, viewPatch.generateSdkKeys) &&
        Objects.equals(this.maintainerId, viewPatch.maintainerId) &&
        Objects.equals(this.maintainerTeamKey, viewPatch.maintainerTeamKey) &&
        Objects.equals(this.tags, viewPatch.tags) &&
        Objects.equals(this.archived, viewPatch.archived)&&
        Objects.equals(this.additionalProperties, viewPatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, generateSdkKeys, maintainerId, maintainerTeamKey, tags, archived, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewPatch {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "generateSdkKeys", "maintainerId", "maintainerTeamKey", "tags", "archived"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewPatch is not found in the empty JSON string", ViewPatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewPatch>() {
           @Override
           public void write(JsonWriter out, ViewPatch value) throws IOException {
           ...
           @Override
           public ViewPatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewPatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewPatch
   * @throws IOException if the JSON string is invalid with respect to ViewPatch
   */
  public static ViewPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewPatch.class);
  }

  /**
   * Convert an instance of ViewPatch to an JSON string
   *
   * @return JSON string
   */
