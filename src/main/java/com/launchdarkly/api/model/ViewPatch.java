...
public class ViewPatch {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, maintainerId, maintainerTeamKey, tags, archived, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "maintainerId", "maintainerTeamKey", "tags", "archived"));
