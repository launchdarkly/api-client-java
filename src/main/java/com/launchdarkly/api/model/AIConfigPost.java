...
public class AIConfigPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, key, maintainerId, maintainerTeamKey, mode, name, tags, defaultVariation, evaluationMetricKey, isInverted, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "key", "maintainerId", "maintainerTeamKey", "mode", "name", "tags", "defaultVariation", "evaluationMetricKey", "isInverted"));
