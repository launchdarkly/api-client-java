...
public class AIConfigPost {
  ...
  public static final String SERIALIZED_NAME_VIEW_KEYS = "viewKeys";
  @SerializedName(SERIALIZED_NAME_VIEW_KEYS)
  @javax.annotation.Nullable
  ...
  public static final String SERIALIZED_NAME_EVALUATION_METRIC_KEY = "evaluationMetricKey";
  @SerializedName(SERIALIZED_NAME_EVALUATION_METRIC_KEY)
  @javax.annotation.Nullable
  private String evaluationMetricKey;

  public static final String SERIALIZED_NAME_IS_INVERTED = "isInverted";
  ...
  public AIConfigPost description(@javax.annotation.Nullable String description) {
  ...
  public AIConfigPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public AIConfigPost maintainerId(@javax.annotation.Nullable String maintainerId) {
  ...
  public AIConfigPost maintainerTeamKey(@javax.annotation.Nullable String maintainerTeamKey) {
  ...
  public AIConfigPost mode(@javax.annotation.Nullable ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public AIConfigPost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AIConfigPost tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public AIConfigPost addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public AIConfigPost viewKeys(@javax.annotation.Nullable List<String> viewKeys) {
    this.viewKeys = viewKeys;
    return this;
  }

  public AIConfigPost addViewKeysItem(String viewKeysItem) {
    if (this.viewKeys == null) {
      this.viewKeys = new ArrayList<>();
    }
    this.viewKeys.add(viewKeysItem);
    return this;
  }
  ...
  public void setViewKeys(@javax.annotation.Nullable List<String> viewKeys) {
    this.viewKeys = viewKeys;
  }
  ...
  public AIConfigPost evaluationMetricKey(@javax.annotation.Nullable String evaluationMetricKey) {
  ...
  public void setEvaluationMetricKey(@javax.annotation.Nullable String evaluationMetricKey) {
    this.evaluationMetricKey = evaluationMetricKey;
  }


  public AIConfigPost isInverted(@javax.annotation.Nullable Boolean isInverted) {
  ...
  public void setIsInverted(@javax.annotation.Nullable Boolean isInverted) {
    this.isInverted = isInverted;
  }
   ...
   * @return the AIConfigPost instance itself
   */
  public AIConfigPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigPost aiConfigPost = (AIConfigPost) o;
    return Objects.equals(this.description, aiConfigPost.description) &&
        Objects.equals(this.key, aiConfigPost.key) &&
        Objects.equals(this.maintainerId, aiConfigPost.maintainerId) &&
        ...
        Objects.equals(this.viewKeys, aiConfigPost.viewKeys) &&
        Objects.equals(this.defaultVariation, aiConfigPost.defaultVariation) &&
        Objects.equals(this.evaluationMetricKey, aiConfigPost.evaluationMetricKey) &&
        Objects.equals(this.isInverted, aiConfigPost.isInverted)&&
        Objects.equals(this.additionalProperties, aiConfigPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, key, maintainerId, maintainerTeamKey, mode, name, tags, viewKeys, defaultVariation, evaluationMetricKey, isInverted, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIConfigPost {\n");
    ...
    sb.append("    viewKeys: ").append(toIndentedString(viewKeys)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "key", "maintainerId", "maintainerTeamKey", "mode", "name", "tags", "viewKeys", "defaultVariation", "evaluationMetricKey", "isInverted"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigPost is not found in the empty JSON string", AIConfigPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AIConfigPost.openapiRequiredFields) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("viewKeys") != null && !jsonObj.get("viewKeys").isJsonNull() && !jsonObj.get("viewKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `viewKeys` to be an array in the JSON string but got `%s`", jsonObj.get("viewKeys").toString()));
      }
      ...
      if ((jsonObj.get("evaluationMetricKey") != null && !jsonObj.get("evaluationMetricKey").isJsonNull()) && !jsonObj.get("evaluationMetricKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `evaluationMetricKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("evaluationMetricKey").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigPost.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigPost>() {
           @Override
           public void write(JsonWriter out, AIConfigPost value) throws IOException {
           ...
           @Override
           public AIConfigPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigPost
   * @throws IOException if the JSON string is invalid with respect to AIConfigPost
   */
  public static AIConfigPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigPost.class);
  }

  /**
   * Convert an instance of AIConfigPost to an JSON string
   *
   * @return JSON string
   */
