...
public class AgentGraph {
  ...
  public AgentGraph name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AgentGraph description(@javax.annotation.Nullable String description) {
  ...
  public AgentGraph rootConfigKey(@javax.annotation.Nullable String rootConfigKey) {
  ...
  public AgentGraph edges(@javax.annotation.Nullable List<AgentGraphEdge> edges) {
    this.edges = edges;
    return this;
  }

  public AgentGraph addEdgesItem(AgentGraphEdge edgesItem) {
    if (this.edges == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AgentGraphEdge> getEdges() {
    return edges;
  }

  public void setEdges(@javax.annotation.Nullable List<AgentGraphEdge> edges) {
    this.edges = edges;
  }


  public AgentGraph createdAt(@javax.annotation.Nonnull Long createdAt) {
  ...
  public AgentGraph updatedAt(@javax.annotation.Nonnull Long updatedAt) {
   ...
   * @return the AgentGraph instance itself
   */
  public AgentGraph putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, agentGraph.key) &&
        ...
        Objects.equals(this.updatedAt, agentGraph.updatedAt)&&
        Objects.equals(this.additionalProperties, agentGraph.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AgentGraph is not found in the empty JSON string", AgentGraph.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentGraph.openapiRequiredFields) {
      ...
      if (jsonObj.get("edges") != null && !jsonObj.get("edges").isJsonNull()) {
        ...
        if (jsonArrayedges != null) {
          ...
          for (int i = 0; i < jsonArrayedges.size(); i++) {
            AgentGraphEdge.validateJsonElement(jsonArrayedges.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentGraph>() {
           @Override
           public void write(JsonWriter out, AgentGraph value) throws IOException {
           ...
           @Override
           public AgentGraph read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentGraph instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentGraph
   * @throws IOException if the JSON string is invalid with respect to AgentGraph
   */
  public static AgentGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentGraph.class);
  }

  /**
   * Convert an instance of AgentGraph to an JSON string
   *
   * @return JSON string
   */
