...
public class ApplicationVersionRep {
  ...
  public ApplicationVersionRep access(@javax.annotation.Nullable Access access) {
    this.access = access;
    return this;
  }
  ...
  public ApplicationVersionRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public ApplicationVersionRep version(@javax.annotation.Nullable Integer version) {
  ...
  public ApplicationVersionRep autoAdded(@javax.annotation.Nonnull Boolean autoAdded) {
  ...
  public ApplicationVersionRep creationDate(@javax.annotation.Nullable Long creationDate) {
  ...
  public ApplicationVersionRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public ApplicationVersionRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ApplicationVersionRep supported(@javax.annotation.Nullable Boolean supported) {
   ...
   * @return the ApplicationVersionRep instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_access", "_links", "_version", "autoAdded", "creationDate", "key", "name", "supported"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("autoAdded", "key", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationVersionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationVersionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApplicationVersionRep is not found in the empty JSON string", ApplicationVersionRep.openapiRequiredFields.toString()));
        }
      }
