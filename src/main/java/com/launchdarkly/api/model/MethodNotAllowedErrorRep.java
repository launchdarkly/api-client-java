...
public class MethodNotAllowedErrorRep {
  ...
  public MethodNotAllowedErrorRep code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public MethodNotAllowedErrorRep message(@javax.annotation.Nonnull String message) {
   ...
   * @return the MethodNotAllowedErrorRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to MethodNotAllowedErrorRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MethodNotAllowedErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MethodNotAllowedErrorRep is not found in the empty JSON string", MethodNotAllowedErrorRep.openapiRequiredFields.toString()));
        }
      }
