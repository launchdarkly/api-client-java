...
public class NotFoundErrorRep {
  ...
  public NotFoundErrorRep code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public NotFoundErrorRep message(@javax.annotation.Nonnull String message) {
   ...
   * @return the NotFoundErrorRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotFoundErrorRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotFoundErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NotFoundErrorRep is not found in the empty JSON string", NotFoundErrorRep.openapiRequiredFields.toString()));
        }
      }
