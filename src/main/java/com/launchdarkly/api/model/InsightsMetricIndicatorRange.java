...
public class InsightsMetricIndicatorRange {
   ...
   * @return the InsightsMetricIndicatorRange instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightsMetricIndicatorRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightsMetricIndicatorRange is not found in the empty JSON string", InsightsMetricIndicatorRange.openapiRequiredFields.toString()));
        }
      }
