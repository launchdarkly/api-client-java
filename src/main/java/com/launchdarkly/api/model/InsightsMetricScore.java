...
public class InsightsMetricScore {
  ...
  public InsightsMetricScore addAggregateOfItem(String aggregateOfItem) {
    if (this.aggregateOf == null) {
      this.aggregateOf = new ArrayList<>();
    }
    this.aggregateOf.add(aggregateOfItem);
    return this;
  }
   ...
   * @return the InsightsMetricScore instance itself
   */
  public InsightsMetricScore putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InsightsMetricScore insightsMetricScore = (InsightsMetricScore) o;
    return Objects.equals(this.score, insightsMetricScore.score) &&
        Objects.equals(this.aggregateOf, insightsMetricScore.aggregateOf) &&
        Objects.equals(this.diffVsLastPeriod, insightsMetricScore.diffVsLastPeriod) &&
        Objects.equals(this.indicator, insightsMetricScore.indicator) &&
        Objects.equals(this.indicatorRange, insightsMetricScore.indicatorRange) &&
        Objects.equals(this.lastPeriod, insightsMetricScore.lastPeriod)&&
        Objects.equals(this.additionalProperties, insightsMetricScore.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(score, aggregateOf, diffVsLastPeriod, indicator, indicatorRange, lastPeriod, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    aggregateOf: ").append(toIndentedString(aggregateOf)).append("\n");
    sb.append("    diffVsLastPeriod: ").append(toIndentedString(diffVsLastPeriod)).append("\n");
    sb.append("    indicator: ").append(toIndentedString(indicator)).append("\n");
    sb.append("    indicatorRange: ").append(toIndentedString(indicatorRange)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightsMetricScore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightsMetricScore is not found in the empty JSON string", InsightsMetricScore.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("aggregateOf") != null && !jsonObj.get("aggregateOf").isJsonNull() && !jsonObj.get("aggregateOf").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `aggregateOf` to be an array in the JSON string but got `%s`", jsonObj.get("aggregateOf").toString()));
      }
      ...
      if (jsonObj.get("lastPeriod") != null && !jsonObj.get("lastPeriod").isJsonNull()) {
        InsightsMetricScore.validateJsonElement(jsonObj.get("lastPeriod"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InsightsMetricScore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InsightsMetricScore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InsightsMetricScore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InsightsMetricScore.class));

       return (TypeAdapter<T>) new TypeAdapter<InsightsMetricScore>() {
           @Override
           public void write(JsonWriter out, InsightsMetricScore value) throws IOException {
           ...
           @Override
           public InsightsMetricScore read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             InsightsMetricScore instance = thisAdapter.fromJsonTree(jsonObj);
