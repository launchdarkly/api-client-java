...
public class PaginatedLinks {
   ...
   * @return the PaginatedLinks instance itself
   */
  public PaginatedLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaginatedLinks paginatedLinks = (PaginatedLinks) o;
    return Objects.equals(this.first, paginatedLinks.first) &&
        Objects.equals(this.last, paginatedLinks.last) &&
        Objects.equals(this.next, paginatedLinks.next) &&
        Objects.equals(this.prev, paginatedLinks.prev) &&
        Objects.equals(this.self, paginatedLinks.self)&&
        Objects.equals(this.additionalProperties, paginatedLinks.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedLinks {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaginatedLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PaginatedLinks is not found in the empty JSON string", PaginatedLinks.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginatedLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginatedLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginatedLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginatedLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginatedLinks>() {
           @Override
           public void write(JsonWriter out, PaginatedLinks value) throws IOException {
           ...
           @Override
           public PaginatedLinks read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PaginatedLinks instance = thisAdapter.fromJsonTree(jsonObj);
