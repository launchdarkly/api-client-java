...
public class ViewPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, maintainerId, maintainerTeamKey, tags, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "description", "maintainerId", "maintainerTeamKey", "tags"));
