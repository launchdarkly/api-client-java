...
public class ViewPost {
  ...
  @javax.annotation.Nullable
  private Boolean generateSdkKeys = false;
  ...
  public ViewPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public ViewPost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ViewPost description(@javax.annotation.Nullable String description) {
  ...
  public ViewPost generateSdkKeys(@javax.annotation.Nullable Boolean generateSdkKeys) {
  ...
  public ViewPost maintainerId(@javax.annotation.Nullable String maintainerId) {
  ...
  public ViewPost maintainerTeamKey(@javax.annotation.Nullable String maintainerTeamKey) {
  ...
  public ViewPost tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public ViewPost addTagsItem(String tagsItem) {
    if (this.tags == null) {
   ...
   * @return the ViewPost instance itself
   */
  public ViewPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, viewPost.key) &&
        Objects.equals(this.name, viewPost.name) &&
        Objects.equals(this.description, viewPost.description) &&
        Objects.equals(this.generateSdkKeys, viewPost.generateSdkKeys) &&
        Objects.equals(this.maintainerId, viewPost.maintainerId) &&
        Objects.equals(this.maintainerTeamKey, viewPost.maintainerTeamKey) &&
        Objects.equals(this.tags, viewPost.tags)&&
        Objects.equals(this.additionalProperties, viewPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, generateSdkKeys, maintainerId, maintainerTeamKey, tags, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewPost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "description", "generateSdkKeys", "maintainerId", "maintainerTeamKey", "tags"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewPost is not found in the empty JSON string", ViewPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewPost.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewPost>() {
           @Override
           public void write(JsonWriter out, ViewPost value) throws IOException {
           ...
           @Override
           public ViewPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewPost
   * @throws IOException if the JSON string is invalid with respect to ViewPost
   */
  public static ViewPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewPost.class);
  }

  /**
   * Convert an instance of ViewPost to an JSON string
   *
   * @return JSON string
   */
