...
public class RestrictedModelsRequest {
  ...
  public RestrictedModelsRequest addKeysItem(String keysItem) {
    if (this.keys == null) {
   ...
   * @return the RestrictedModelsRequest instance itself
   */
  public RestrictedModelsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RestrictedModelsRequest restrictedModelsRequest = (RestrictedModelsRequest) o;
    return Objects.equals(this.keys, restrictedModelsRequest.keys)&&
        Objects.equals(this.additionalProperties, restrictedModelsRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RestrictedModelsRequest {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RestrictedModelsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RestrictedModelsRequest is not found in the empty JSON string", RestrictedModelsRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RestrictedModelsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RestrictedModelsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RestrictedModelsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RestrictedModelsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RestrictedModelsRequest>() {
           @Override
           public void write(JsonWriter out, RestrictedModelsRequest value) throws IOException {
           ...
           @Override
           public RestrictedModelsRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RestrictedModelsRequest instance = thisAdapter.fromJsonTree(jsonObj);
