...
public class CovariateInfoRep {
  ...
  public CovariateInfoRep id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public CovariateInfoRep fileName(@javax.annotation.Nonnull String fileName) {
  ...
  public CovariateInfoRep createdAt(@javax.annotation.Nonnull Long createdAt) {
   ...
   * @return the CovariateInfoRep instance itself
   */
  public CovariateInfoRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CovariateInfoRep covariateInfoRep = (CovariateInfoRep) o;
    return Objects.equals(this.id, covariateInfoRep.id) &&
        Objects.equals(this.fileName, covariateInfoRep.fileName) &&
        Objects.equals(this.createdAt, covariateInfoRep.createdAt)&&
        Objects.equals(this.additionalProperties, covariateInfoRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CovariateInfoRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CovariateInfoRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CovariateInfoRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CovariateInfoRep is not found in the empty JSON string", CovariateInfoRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CovariateInfoRep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CovariateInfoRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CovariateInfoRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CovariateInfoRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CovariateInfoRep.class));

       return (TypeAdapter<T>) new TypeAdapter<CovariateInfoRep>() {
           @Override
           public void write(JsonWriter out, CovariateInfoRep value) throws IOException {
           ...
           @Override
           public CovariateInfoRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CovariateInfoRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CovariateInfoRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CovariateInfoRep
   * @throws IOException if the JSON string is invalid with respect to CovariateInfoRep
   */
  public static CovariateInfoRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CovariateInfoRep.class);
  }

  /**
   * Convert an instance of CovariateInfoRep to an JSON string
   *
   * @return JSON string
   */
