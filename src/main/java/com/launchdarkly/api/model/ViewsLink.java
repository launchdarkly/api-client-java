...
public class ViewsLink {
  ...
  public ViewsLink href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public ViewsLink type(String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewsLink is not found in the empty JSON string", ViewsLink.openapiRequiredFields.toString()));
        }
      }
