...
public class ViewsLink {
  ...
  public ViewsLink href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ViewsLink type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the ViewsLink instance itself
   */
  public ViewsLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewsLink viewsLink = (ViewsLink) o;
    return Objects.equals(this.href, viewsLink.href) &&
        Objects.equals(this.type, viewsLink.type)&&
        Objects.equals(this.additionalProperties, viewsLink.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewsLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewsLink is not found in the empty JSON string", ViewsLink.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewsLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewsLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewsLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewsLink.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewsLink>() {
           @Override
           public void write(JsonWriter out, ViewsLink value) throws IOException {
           ...
           @Override
           public ViewsLink read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewsLink instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewsLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewsLink
   * @throws IOException if the JSON string is invalid with respect to ViewsLink
   */
  public static ViewsLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewsLink.class);
  }

  /**
   * Convert an instance of ViewsLink to an JSON string
   *
   * @return JSON string
   */
