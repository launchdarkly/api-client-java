...
public class AiConfigsAccessAllowedReason {
  ...
  public AiConfigsAccessAllowedReason resources(@javax.annotation.Nullable List<String> resources) {
  ...
  public AiConfigsAccessAllowedReason notResources(@javax.annotation.Nullable List<String> notResources) {
  ...
  public AiConfigsAccessAllowedReason actions(@javax.annotation.Nullable List<String> actions) {
  ...
  public AiConfigsAccessAllowedReason notActions(@javax.annotation.Nullable List<String> notActions) {
  ...
  public AiConfigsAccessAllowedReason effect(@javax.annotation.Nonnull EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  public AiConfigsAccessAllowedReason roleName(@javax.annotation.Nullable String roleName) {
   ...
   * @return the AiConfigsAccessAllowedReason instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resources, aiConfigsAccessAllowedReason.resources) &&
        Objects.equals(this.notResources, aiConfigsAccessAllowedReason.notResources) &&
        Objects.equals(this.actions, aiConfigsAccessAllowedReason.actions) &&
        Objects.equals(this.notActions, aiConfigsAccessAllowedReason.notActions) &&
        Objects.equals(this.effect, aiConfigsAccessAllowedReason.effect) &&
        Objects.equals(this.roleName, aiConfigsAccessAllowedReason.roleName)&&
        Objects.equals(this.additionalProperties, aiConfigsAccessAllowedReason.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiConfigsAccessAllowedReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiConfigsAccessAllowedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiConfigsAccessAllowedReason is not found in the empty JSON string", AiConfigsAccessAllowedReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AiConfigsAccessAllowedReason.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiConfigsAccessAllowedReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiConfigsAccessAllowedReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiConfigsAccessAllowedReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiConfigsAccessAllowedReason.class));

       return (TypeAdapter<T>) new TypeAdapter<AiConfigsAccessAllowedReason>() {
           @Override
           ...
           public AiConfigsAccessAllowedReason read(JsonReader in) throws IOException {
             ...
             AiConfigsAccessAllowedReason instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AiConfigsAccessAllowedReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AiConfigsAccessAllowedReason
   * @throws IOException if the JSON string is invalid with respect to AiConfigsAccessAllowedReason
   */
  public static AiConfigsAccessAllowedReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiConfigsAccessAllowedReason.class);
  }

  /**
   * Convert an instance of AiConfigsAccessAllowedReason to an JSON string
   *
   * @return JSON string
   */
