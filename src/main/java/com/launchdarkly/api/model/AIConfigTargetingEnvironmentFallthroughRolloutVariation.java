...
public class AIConfigTargetingEnvironmentFallthroughRolloutVariation {
   ...
   * @return the AIConfigTargetingEnvironmentFallthroughRolloutVariation instance itself
   */
  public AIConfigTargetingEnvironmentFallthroughRolloutVariation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigTargetingEnvironmentFallthroughRolloutVariation aiConfigTargetingEnvironmentFallthroughRolloutVariation = (AIConfigTargetingEnvironmentFallthroughRolloutVariation) o;
    return Objects.equals(this.untracked, aiConfigTargetingEnvironmentFallthroughRolloutVariation.untracked) &&
        Objects.equals(this.variation, aiConfigTargetingEnvironmentFallthroughRolloutVariation.variation) &&
        Objects.equals(this.weight, aiConfigTargetingEnvironmentFallthroughRolloutVariation.weight)&&
        Objects.equals(this.additionalProperties, aiConfigTargetingEnvironmentFallthroughRolloutVariation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(untracked, variation, weight, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIConfigTargetingEnvironmentFallthroughRolloutVariation {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigTargetingEnvironmentFallthroughRolloutVariation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigTargetingEnvironmentFallthroughRolloutVariation is not found in the empty JSON string", AIConfigTargetingEnvironmentFallthroughRolloutVariation.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigTargetingEnvironmentFallthroughRolloutVariation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigTargetingEnvironmentFallthroughRolloutVariation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigTargetingEnvironmentFallthroughRolloutVariation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigTargetingEnvironmentFallthroughRolloutVariation.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigTargetingEnvironmentFallthroughRolloutVariation>() {
           @Override
           public void write(JsonWriter out, AIConfigTargetingEnvironmentFallthroughRolloutVariation value) throws IOException {
           ...
           @Override
           public AIConfigTargetingEnvironmentFallthroughRolloutVariation read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigTargetingEnvironmentFallthroughRolloutVariation instance = thisAdapter.fromJsonTree(jsonObj);
