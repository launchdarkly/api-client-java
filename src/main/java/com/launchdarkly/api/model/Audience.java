...
public class Audience {
  ...
  public Audience environment(@javax.annotation.Nullable EnvironmentSummary environment) {
  ...
  public Audience _configuration(@javax.annotation.Nullable AudienceConfiguration _configuration) {
  ...
  public Audience segmentKeys(@javax.annotation.Nullable List<String> segmentKeys) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.environment, audience.environment) &&
        Objects.equals(this.name, audience.name) &&
        Objects.equals(this._configuration, audience._configuration) &&
        Objects.equals(this.segmentKeys, audience.segmentKeys)&&
        Objects.equals(this.additionalProperties, audience.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(environment, name, _configuration, segmentKeys, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("environment", "name", "configuration", "segmentKeys"));
