...
import com.launchdarkly.api.model.ViewsSelfLink;
...
public class ExpandedDirectlyLinkedSegment {
   ...
   * @return the ExpandedDirectlyLinkedSegment instance itself
   */
  public ExpandedDirectlyLinkedSegment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedDirectlyLinkedSegment expandedDirectlyLinkedSegment = (ExpandedDirectlyLinkedSegment) o;
    return Objects.equals(this.key, expandedDirectlyLinkedSegment.key) &&
        Objects.equals(this.name, expandedDirectlyLinkedSegment.name) &&
        Objects.equals(this.environmentId, expandedDirectlyLinkedSegment.environmentId) &&
        Objects.equals(this.links, expandedDirectlyLinkedSegment.links)&&
        Objects.equals(this.additionalProperties, expandedDirectlyLinkedSegment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, environmentId, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExpandedDirectlyLinkedSegment {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedDirectlyLinkedSegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedDirectlyLinkedSegment is not found in the empty JSON string", ExpandedDirectlyLinkedSegment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedDirectlyLinkedSegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedDirectlyLinkedSegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedDirectlyLinkedSegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedDirectlyLinkedSegment.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedDirectlyLinkedSegment>() {
           @Override
           public void write(JsonWriter out, ExpandedDirectlyLinkedSegment value) throws IOException {
           ...
           @Override
           public ExpandedDirectlyLinkedSegment read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedDirectlyLinkedSegment instance = thisAdapter.fromJsonTree(jsonObj);
