...
public class AIConfigPatch {
  ...
  public AIConfigPatch description(@javax.annotation.Nullable String description) {
  ...
  public AIConfigPatch maintainerId(@javax.annotation.Nullable String maintainerId) {
  ...
  public AIConfigPatch maintainerTeamKey(@javax.annotation.Nullable String maintainerTeamKey) {
  ...
  public AIConfigPatch name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AIConfigPatch tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public AIConfigPatch addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public AIConfigPatch evaluationMetricKey(@javax.annotation.Nullable String evaluationMetricKey) {
  ...
  public AIConfigPatch isInverted(@javax.annotation.Nullable Boolean isInverted) {
   ...
   * @return the AIConfigPatch instance itself
   */
  public AIConfigPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigPatch aiConfigPatch = (AIConfigPatch) o;
    return Objects.equals(this.description, aiConfigPatch.description) &&
        Objects.equals(this.maintainerId, aiConfigPatch.maintainerId) &&
        Objects.equals(this.maintainerTeamKey, aiConfigPatch.maintainerTeamKey) &&
        Objects.equals(this.name, aiConfigPatch.name) &&
        Objects.equals(this.tags, aiConfigPatch.tags) &&
        Objects.equals(this.evaluationMetricKey, aiConfigPatch.evaluationMetricKey) &&
        Objects.equals(this.isInverted, aiConfigPatch.isInverted)&&
        Objects.equals(this.additionalProperties, aiConfigPatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, maintainerId, maintainerTeamKey, name, tags, evaluationMetricKey, isInverted, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIConfigPatch {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "maintainerId", "maintainerTeamKey", "name", "tags", "evaluationMetricKey", "isInverted"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigPatch is not found in the empty JSON string", AIConfigPatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigPatch>() {
           @Override
           public void write(JsonWriter out, AIConfigPatch value) throws IOException {
           ...
           @Override
           public AIConfigPatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigPatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigPatch
   * @throws IOException if the JSON string is invalid with respect to AIConfigPatch
   */
  public static AIConfigPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigPatch.class);
  }

  /**
   * Convert an instance of AIConfigPatch to an JSON string
   *
   * @return JSON string
   */
