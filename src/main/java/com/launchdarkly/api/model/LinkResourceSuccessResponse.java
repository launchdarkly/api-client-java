...
import com.launchdarkly.api.model.FailedResourceLink;
...
public class LinkResourceSuccessResponse {
  ...
  public LinkResourceSuccessResponse addFailedResourcesItem(FailedResourceLink failedResourcesItem) {
   ...
   * @return the LinkResourceSuccessResponse instance itself
   */
  public LinkResourceSuccessResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LinkResourceSuccessResponse linkResourceSuccessResponse = (LinkResourceSuccessResponse) o;
    return Objects.equals(this.successCount, linkResourceSuccessResponse.successCount) &&
        Objects.equals(this.failureCount, linkResourceSuccessResponse.failureCount) &&
        Objects.equals(this.linkedResources, linkResourceSuccessResponse.linkedResources) &&
        Objects.equals(this.failedResources, linkResourceSuccessResponse.failedResources)&&
        Objects.equals(this.additionalProperties, linkResourceSuccessResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(successCount, failureCount, linkedResources, failedResources, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinkResourceSuccessResponse {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinkResourceSuccessResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LinkResourceSuccessResponse is not found in the empty JSON string", LinkResourceSuccessResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `linkedResources`
      if (jsonObj.get("linkedResources") != null && !jsonObj.get("linkedResources").isJsonNull()) {
        ViewLinkedResources.validateJsonElement(jsonObj.get("linkedResources"));
      }
      if (jsonObj.get("failedResources") != null && !jsonObj.get("failedResources").isJsonNull()) {
        JsonArray jsonArrayfailedResources = jsonObj.getAsJsonArray("failedResources");
        if (jsonArrayfailedResources != null) {
          // ensure the json data is an array
          if (!jsonObj.get("failedResources").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `failedResources` to be an array in the JSON string but got `%s`", jsonObj.get("failedResources").toString()));
          }

          // validate the optional field `failedResources` (array)
          for (int i = 0; i < jsonArrayfailedResources.size(); i++) {
            FailedResourceLink.validateJsonElement(jsonArrayfailedResources.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkResourceSuccessResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkResourceSuccessResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkResourceSuccessResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkResourceSuccessResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkResourceSuccessResponse>() {
           @Override
           public void write(JsonWriter out, LinkResourceSuccessResponse value) throws IOException {
           ...
           @Override
           public LinkResourceSuccessResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             LinkResourceSuccessResponse instance = thisAdapter.fromJsonTree(jsonObj);
