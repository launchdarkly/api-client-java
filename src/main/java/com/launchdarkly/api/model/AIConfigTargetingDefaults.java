...
public class AIConfigTargetingDefaults {
  ...
  public AIConfigTargetingDefaults onVariation(Integer onVariation) {
  ...
  **/
  ...
  public AIConfigTargetingDefaults offVariation(Integer offVariation) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigTargetingDefaults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AIConfigTargetingDefaults is not found in the empty JSON string", AIConfigTargetingDefaults.openapiRequiredFields.toString()));
        }
      }
