...
public class AIConfigTargetingDefaults {
  ...
  public AIConfigTargetingDefaults onVariation(@javax.annotation.Nonnull Integer onVariation) {
  ...
  public AIConfigTargetingDefaults offVariation(@javax.annotation.Nonnull Integer offVariation) {
   ...
   * @return the AIConfigTargetingDefaults instance itself
   */
  public AIConfigTargetingDefaults putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigTargetingDefaults aiConfigTargetingDefaults = (AIConfigTargetingDefaults) o;
    return Objects.equals(this.onVariation, aiConfigTargetingDefaults.onVariation) &&
        Objects.equals(this.offVariation, aiConfigTargetingDefaults.offVariation)&&
        Objects.equals(this.additionalProperties, aiConfigTargetingDefaults.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(onVariation, offVariation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIConfigTargetingDefaults {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("onVariation", "offVariation"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("onVariation", "offVariation"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigTargetingDefaults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigTargetingDefaults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigTargetingDefaults is not found in the empty JSON string", AIConfigTargetingDefaults.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AIConfigTargetingDefaults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigTargetingDefaults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigTargetingDefaults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigTargetingDefaults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigTargetingDefaults.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigTargetingDefaults>() {
           @Override
           public void write(JsonWriter out, AIConfigTargetingDefaults value) throws IOException {
           ...
           @Override
           public AIConfigTargetingDefaults read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigTargetingDefaults instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigTargetingDefaults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigTargetingDefaults
   * @throws IOException if the JSON string is invalid with respect to AIConfigTargetingDefaults
   */
  public static AIConfigTargetingDefaults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigTargetingDefaults.class);
  }

  /**
   * Convert an instance of AIConfigTargetingDefaults to an JSON string
   *
   * @return JSON string
   */
