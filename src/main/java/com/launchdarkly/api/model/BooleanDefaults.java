...
public class BooleanDefaults {
   ...
   * @return the BooleanDefaults instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BooleanDefaults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BooleanDefaults is not found in the empty JSON string", BooleanDefaults.openapiRequiredFields.toString()));
        }
      }
