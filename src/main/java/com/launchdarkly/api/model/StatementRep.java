...
public class StatementRep {
  ...
  public StatementRep resources(List<String> resources) {
    
    this.resources = resources;
    return this;
  }

  public StatementRep addResourcesItem(String resourcesItem) {
  ...
  **/
  ...
  public StatementRep notResources(List<String> notResources) {
    
    this.notResources = notResources;
    return this;
  }

  public StatementRep addNotResourcesItem(String notResourcesItem) {
