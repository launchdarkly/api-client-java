...
public class ExpiringTargetGetResponse {
   ...
   * @return the ExpiringTargetGetResponse instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpiringTargetGetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpiringTargetGetResponse is not found in the empty JSON string", ExpiringTargetGetResponse.openapiRequiredFields.toString()));
        }
      }
