...
public class ContextSearch {
  ...
  public ContextSearch filter(@javax.annotation.Nullable String filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ContextSearch sort(@javax.annotation.Nullable String sort) {
    this.sort = sort;
    return this;
  }
  ...
  public ContextSearch limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ContextSearch continuationToken(@javax.annotation.Nullable String continuationToken) {
   ...
   * @return the ContextSearch instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextSearch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextSearch is not found in the empty JSON string", ContextSearch.openapiRequiredFields.toString()));
        }
      }
