...
public class WorkflowTemplateParameter {
   ...
   * @return the WorkflowTemplateParameter instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowTemplateParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WorkflowTemplateParameter is not found in the empty JSON string", WorkflowTemplateParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("default") != null && !jsonObj.get("default").isJsonNull()) {
        ParameterDefault.validateJsonElement(jsonObj.get("default"));
      }
  }
