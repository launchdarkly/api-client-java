...
public class ViewLinkRequestSegmentIdentifier {
   ...
   * @return the ViewLinkRequestSegmentIdentifier instance itself
   */
  public ViewLinkRequestSegmentIdentifier putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewLinkRequestSegmentIdentifier viewLinkRequestSegmentIdentifier = (ViewLinkRequestSegmentIdentifier) o;
    return Objects.equals(this.environmentId, viewLinkRequestSegmentIdentifier.environmentId) &&
        Objects.equals(this.segmentKey, viewLinkRequestSegmentIdentifier.segmentKey)&&
        Objects.equals(this.additionalProperties, viewLinkRequestSegmentIdentifier.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(environmentId, segmentKey, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewLinkRequestSegmentIdentifier {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewLinkRequestSegmentIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewLinkRequestSegmentIdentifier is not found in the empty JSON string", ViewLinkRequestSegmentIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("segmentKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `segmentKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("segmentKey").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewLinkRequestSegmentIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewLinkRequestSegmentIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewLinkRequestSegmentIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewLinkRequestSegmentIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewLinkRequestSegmentIdentifier>() {
           @Override
           public void write(JsonWriter out, ViewLinkRequestSegmentIdentifier value) throws IOException {
           ...
           @Override
           public ViewLinkRequestSegmentIdentifier read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewLinkRequestSegmentIdentifier instance = thisAdapter.fromJsonTree(jsonObj);
