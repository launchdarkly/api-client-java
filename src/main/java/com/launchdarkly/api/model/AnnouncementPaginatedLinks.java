...
import com.launchdarkly.api.model.AnnouncementLink;
...
public class AnnouncementPaginatedLinks {
   ...
   * @return the AnnouncementPaginatedLinks instance itself
   */
  public AnnouncementPaginatedLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnouncementPaginatedLinks announcementPaginatedLinks = (AnnouncementPaginatedLinks) o;
    return Objects.equals(this.first, announcementPaginatedLinks.first) &&
        Objects.equals(this.last, announcementPaginatedLinks.last) &&
        Objects.equals(this.next, announcementPaginatedLinks.next) &&
        Objects.equals(this.prev, announcementPaginatedLinks.prev) &&
        Objects.equals(this.self, announcementPaginatedLinks.self)&&
        Objects.equals(this.additionalProperties, announcementPaginatedLinks.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnouncementPaginatedLinks {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnouncementPaginatedLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AnnouncementPaginatedLinks is not found in the empty JSON string", AnnouncementPaginatedLinks.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnouncementPaginatedLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnouncementPaginatedLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnouncementPaginatedLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnouncementPaginatedLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnouncementPaginatedLinks>() {
           @Override
           public void write(JsonWriter out, AnnouncementPaginatedLinks value) throws IOException {
           ...
           @Override
           public AnnouncementPaginatedLinks read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AnnouncementPaginatedLinks instance = thisAdapter.fromJsonTree(jsonObj);
