...
public class FlagFollowersByProjEnvGetRep {
  ...
  private List<FollowersPerFlag> items = new ArrayList<>();

  public FlagFollowersByProjEnvGetRep() {
  }

  public FlagFollowersByProjEnvGetRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public FlagFollowersByProjEnvGetRep items(@javax.annotation.Nullable List<FollowersPerFlag> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nullable List<FollowersPerFlag> items) {
    this.items = items;
  }
   ...
   * @return the FlagFollowersByProjEnvGetRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagFollowersByProjEnvGetRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagFollowersByProjEnvGetRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagFollowersByProjEnvGetRep is not found in the empty JSON string", FlagFollowersByProjEnvGetRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            FollowersPerFlag.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
