...
public class TeamMembers {
  ...
  public TeamMembers totalCount(@javax.annotation.Nullable Integer totalCount) {
   ...
   * @return the TeamMembers instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("totalCount"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamMembers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamMembers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TeamMembers is not found in the empty JSON string", TeamMembers.openapiRequiredFields.toString()));
        }
      }
