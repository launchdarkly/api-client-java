...
public class ViewsPaginatedLinks {
   ...
   * @return the ViewsPaginatedLinks instance itself
   */
  public ViewsPaginatedLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewsPaginatedLinks viewsPaginatedLinks = (ViewsPaginatedLinks) o;
    return Objects.equals(this.first, viewsPaginatedLinks.first) &&
        Objects.equals(this.last, viewsPaginatedLinks.last) &&
        Objects.equals(this.next, viewsPaginatedLinks.next) &&
        Objects.equals(this.prev, viewsPaginatedLinks.prev) &&
        Objects.equals(this.self, viewsPaginatedLinks.self)&&
        Objects.equals(this.additionalProperties, viewsPaginatedLinks.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewsPaginatedLinks {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsPaginatedLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewsPaginatedLinks is not found in the empty JSON string", ViewsPaginatedLinks.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewsPaginatedLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewsPaginatedLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewsPaginatedLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewsPaginatedLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewsPaginatedLinks>() {
           @Override
           public void write(JsonWriter out, ViewsPaginatedLinks value) throws IOException {
           ...
           @Override
           public ViewsPaginatedLinks read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewsPaginatedLinks instance = thisAdapter.fromJsonTree(jsonObj);
