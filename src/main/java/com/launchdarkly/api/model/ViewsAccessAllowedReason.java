...
public class ViewsAccessAllowedReason {
  ...
  public ViewsAccessAllowedReason resources(@javax.annotation.Nullable List<String> resources) {
    this.resources = resources;
    return this;
  }

  public ViewsAccessAllowedReason addResourcesItem(String resourcesItem) {
  ...
  public ViewsAccessAllowedReason notResources(@javax.annotation.Nullable List<String> notResources) {
    this.notResources = notResources;
    return this;
  }

  public ViewsAccessAllowedReason addNotResourcesItem(String notResourcesItem) {
  ...
  public ViewsAccessAllowedReason actions(@javax.annotation.Nullable List<String> actions) {
    this.actions = actions;
    return this;
  }

  public ViewsAccessAllowedReason addActionsItem(String actionsItem) {
  ...
  public ViewsAccessAllowedReason notActions(@javax.annotation.Nullable List<String> notActions) {
    this.notActions = notActions;
    return this;
  }

  public ViewsAccessAllowedReason addNotActionsItem(String notActionsItem) {
  ...
  public ViewsAccessAllowedReason effect(@javax.annotation.Nonnull EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  public ViewsAccessAllowedReason roleName(@javax.annotation.Nullable String roleName) {
   ...
   * @return the ViewsAccessAllowedReason instance itself
   */
  public ViewsAccessAllowedReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewsAccessAllowedReason viewsAccessAllowedReason = (ViewsAccessAllowedReason) o;
    return Objects.equals(this.resources, viewsAccessAllowedReason.resources) &&
        Objects.equals(this.notResources, viewsAccessAllowedReason.notResources) &&
        Objects.equals(this.actions, viewsAccessAllowedReason.actions) &&
        Objects.equals(this.notActions, viewsAccessAllowedReason.notActions) &&
        Objects.equals(this.effect, viewsAccessAllowedReason.effect) &&
        Objects.equals(this.roleName, viewsAccessAllowedReason.roleName)&&
        Objects.equals(this.additionalProperties, viewsAccessAllowedReason.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewsAccessAllowedReason {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewsAccessAllowedReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsAccessAllowedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewsAccessAllowedReason is not found in the empty JSON string", ViewsAccessAllowedReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewsAccessAllowedReason.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewsAccessAllowedReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewsAccessAllowedReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewsAccessAllowedReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewsAccessAllowedReason.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewsAccessAllowedReason>() {
           @Override
           public void write(JsonWriter out, ViewsAccessAllowedReason value) throws IOException {
           ...
           @Override
           public ViewsAccessAllowedReason read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewsAccessAllowedReason instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewsAccessAllowedReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewsAccessAllowedReason
   * @throws IOException if the JSON string is invalid with respect to ViewsAccessAllowedReason
   */
  public static ViewsAccessAllowedReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewsAccessAllowedReason.class);
  }

  /**
   * Convert an instance of ViewsAccessAllowedReason to an JSON string
   *
   * @return JSON string
   */
