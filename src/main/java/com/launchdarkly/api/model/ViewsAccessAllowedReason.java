...
public class ViewsAccessAllowedReason {
  ...
  public ViewsAccessAllowedReason resources(List<String> resources) {
  ...
  **/
  ...
  public ViewsAccessAllowedReason notResources(List<String> notResources) {
  ...
  **/
  ...
  public ViewsAccessAllowedReason actions(List<String> actions) {
  ...
  **/
  ...
  public ViewsAccessAllowedReason notActions(List<String> notActions) {
  ...
  **/
  ...
  public ViewsAccessAllowedReason effect(EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  **/
  ...
  public ViewsAccessAllowedReason roleName(String roleName) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsAccessAllowedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewsAccessAllowedReason is not found in the empty JSON string", ViewsAccessAllowedReason.openapiRequiredFields.toString()));
        }
      }
