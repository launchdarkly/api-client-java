...
import com.launchdarkly.api.model.ViewResourceSummary;
...
public class ViewSummary {
  ...
  @javax.annotation.Nonnull
  private ViewResourceSummary resourceSummary;

  public ViewSummary() {
  }

  public ViewSummary links(@javax.annotation.Nullable ParentAndSelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public ViewSummary key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public ViewSummary name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ViewSummary resourceSummary(@javax.annotation.Nonnull ViewResourceSummary resourceSummary) {
   ...
   */
  @javax.annotation.Nonnull
  public ViewResourceSummary getResourceSummary() {
    return resourceSummary;
  }

  public void setResourceSummary(@javax.annotation.Nonnull ViewResourceSummary resourceSummary) {
    this.resourceSummary = resourceSummary;
  }
   ...
   * @return the ViewSummary instance itself
   */
  public ViewSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewSummary viewSummary = (ViewSummary) o;
    return Objects.equals(this.links, viewSummary.links) &&
        Objects.equals(this.key, viewSummary.key) &&
        Objects.equals(this.name, viewSummary.name) &&
        Objects.equals(this.resourceSummary, viewSummary.resourceSummary)&&
        Objects.equals(this.additionalProperties, viewSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, key, name, resourceSummary, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "key", "name", "resourceSummary"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "name", "resourceSummary"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSummary is not found in the empty JSON string", ViewSummary.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewSummary.openapiRequiredFields) {
      ...
      // validate the required field `resourceSummary`
      ViewResourceSummary.validateJsonElement(jsonObj.get("resourceSummary"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSummary>() {
           @Override
           public void write(JsonWriter out, ViewSummary value) throws IOException {
           ...
           @Override
           public ViewSummary read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewSummary instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSummary
   * @throws IOException if the JSON string is invalid with respect to ViewSummary
   */
  public static ViewSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSummary.class);
  }

  /**
   * Convert an instance of ViewSummary to an JSON string
   *
   * @return JSON string
   */
