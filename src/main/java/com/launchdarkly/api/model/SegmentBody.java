...
public class SegmentBody {
   ...
   * @return the SegmentBody instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SegmentBody is not found in the empty JSON string", SegmentBody.openapiRequiredFields.toString()));
        }
      }
