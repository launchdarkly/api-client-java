...
public class InvalidRequestErrorRep {
  ...
  public InvalidRequestErrorRep code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public InvalidRequestErrorRep message(@javax.annotation.Nonnull String message) {
   ...
   * @return the InvalidRequestErrorRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to InvalidRequestErrorRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvalidRequestErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InvalidRequestErrorRep is not found in the empty JSON string", InvalidRequestErrorRep.openapiRequiredFields.toString()));
        }
      }
