  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvalidRequestErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in InvalidRequestErrorRep is not found in the empty JSON string", InvalidRequestErrorRep.openapiRequiredFields.toString()));
        }
      }
