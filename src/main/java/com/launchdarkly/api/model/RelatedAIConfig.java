...
public class RelatedAIConfig {
  ...
  public RelatedAIConfig key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
   ...
   * @return the RelatedAIConfig instance itself
   */
  public RelatedAIConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RelatedAIConfig relatedAIConfig = (RelatedAIConfig) o;
    return Objects.equals(this.key, relatedAIConfig.key)&&
        Objects.equals(this.additionalProperties, relatedAIConfig.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RelatedAIConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RelatedAIConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelatedAIConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelatedAIConfig is not found in the empty JSON string", RelatedAIConfig.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RelatedAIConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RelatedAIConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RelatedAIConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RelatedAIConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RelatedAIConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<RelatedAIConfig>() {
           @Override
           public void write(JsonWriter out, RelatedAIConfig value) throws IOException {
           ...
           @Override
           public RelatedAIConfig read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RelatedAIConfig instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of RelatedAIConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RelatedAIConfig
   * @throws IOException if the JSON string is invalid with respect to RelatedAIConfig
   */
  public static RelatedAIConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RelatedAIConfig.class);
  }

  /**
   * Convert an instance of RelatedAIConfig to an JSON string
   *
   * @return JSON string
   */
