...
public class TriggerPost {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The action to perform when triggering. It should pass an array with a single {\"kind\": <flag_action>} object. Currently supported flag actions are \"turnFlagOn\" and \"turnFlagOff\".")
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The unique identifier of the integration you intend to set your trigger up with. \"generic-trigger\" should be used for integrations not explicitly supported.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, instructions, integrationKey);
  }
