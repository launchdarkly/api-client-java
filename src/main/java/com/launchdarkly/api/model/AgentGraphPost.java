...
import com.launchdarkly.api.model.AgentGraphEdgePost;
...
public class AgentGraphPost {
  ...
  @javax.annotation.Nullable
  private String rootConfigKey;

  public static final String SERIALIZED_NAME_EDGES = "edges";
  @SerializedName(SERIALIZED_NAME_EDGES)
  @javax.annotation.Nullable
  private List<AgentGraphEdgePost> edges = new ArrayList<>();

  public AgentGraphPost() {
  }

  public AgentGraphPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public AgentGraphPost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AgentGraphPost description(@javax.annotation.Nullable String description) {
  ...
  public AgentGraphPost maintainerId(@javax.annotation.Nullable String maintainerId) {
  ...
  public AgentGraphPost maintainerTeamKey(@javax.annotation.Nullable String maintainerTeamKey) {
  ...
  public AgentGraphPost rootConfigKey(@javax.annotation.Nullable String rootConfigKey) {
  ...
  public void setRootConfigKey(@javax.annotation.Nullable String rootConfigKey) {
    this.rootConfigKey = rootConfigKey;
  }


  public AgentGraphPost edges(@javax.annotation.Nullable List<AgentGraphEdgePost> edges) {
    this.edges = edges;
    return this;
  }

  public AgentGraphPost addEdgesItem(AgentGraphEdgePost edgesItem) {
    if (this.edges == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AgentGraphEdgePost> getEdges() {
    return edges;
  }

  public void setEdges(@javax.annotation.Nullable List<AgentGraphEdgePost> edges) {
    this.edges = edges;
  }
   ...
   * @return the AgentGraphPost instance itself
   */
  public AgentGraphPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AgentGraphPost agentGraphPost = (AgentGraphPost) o;
    return Objects.equals(this.key, agentGraphPost.key) &&
        Objects.equals(this.name, agentGraphPost.name) &&
        Objects.equals(this.description, agentGraphPost.description) &&
        Objects.equals(this.maintainerId, agentGraphPost.maintainerId) &&
        Objects.equals(this.maintainerTeamKey, agentGraphPost.maintainerTeamKey) &&
        Objects.equals(this.rootConfigKey, agentGraphPost.rootConfigKey) &&
        Objects.equals(this.edges, agentGraphPost.edges)&&
        Objects.equals(this.additionalProperties, agentGraphPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, maintainerId, maintainerTeamKey, rootConfigKey, edges, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AgentGraphPost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "description", "maintainerId", "maintainerTeamKey", "rootConfigKey", "edges"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentGraphPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentGraphPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentGraphPost is not found in the empty JSON string", AgentGraphPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentGraphPost.openapiRequiredFields) {
      ...
      if (jsonObj.get("edges") != null && !jsonObj.get("edges").isJsonNull()) {
        ...
        if (jsonArrayedges != null) {
          ...
          for (int i = 0; i < jsonArrayedges.size(); i++) {
            AgentGraphEdgePost.validateJsonElement(jsonArrayedges.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentGraphPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentGraphPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentGraphPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentGraphPost.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentGraphPost>() {
           @Override
           public void write(JsonWriter out, AgentGraphPost value) throws IOException {
           ...
           @Override
           public AgentGraphPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentGraphPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentGraphPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentGraphPost
   * @throws IOException if the JSON string is invalid with respect to AgentGraphPost
   */
  public static AgentGraphPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentGraphPost.class);
  }

  /**
   * Convert an instance of AgentGraphPost to an JSON string
   *
   * @return JSON string
   */
