  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PullRequestRep is not found in the empty JSON string", PullRequestRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("mergeCommitKey") != null && !jsonObj.get("mergeCommitKey").isJsonNull()) && !jsonObj.get("mergeCommitKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mergeCommitKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mergeCommitKey").toString()));
      }
      if (!jsonObj.get("baseCommitKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `baseCommitKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("baseCommitKey").toString()));
      }
      if (!jsonObj.get("headCommitKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `headCommitKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("headCommitKey").toString()));
      }
