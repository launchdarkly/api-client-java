...
public class AiConfigsMetricDataSourceRefRep {
   ...
   * @return the AiConfigsMetricDataSourceRefRep instance itself
   */
  public AiConfigsMetricDataSourceRefRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiConfigsMetricDataSourceRefRep aiConfigsMetricDataSourceRefRep = (AiConfigsMetricDataSourceRefRep) o;
    return Objects.equals(this.key, aiConfigsMetricDataSourceRefRep.key) &&
        Objects.equals(this.environmentKey, aiConfigsMetricDataSourceRefRep.environmentKey) &&
        Objects.equals(this.name, aiConfigsMetricDataSourceRefRep.name) &&
        Objects.equals(this.integrationKey, aiConfigsMetricDataSourceRefRep.integrationKey)&&
        Objects.equals(this.additionalProperties, aiConfigsMetricDataSourceRefRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiConfigsMetricDataSourceRefRep {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiConfigsMetricDataSourceRefRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiConfigsMetricDataSourceRefRep is not found in the empty JSON string", AiConfigsMetricDataSourceRefRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiConfigsMetricDataSourceRefRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiConfigsMetricDataSourceRefRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiConfigsMetricDataSourceRefRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiConfigsMetricDataSourceRefRep.class));

       return (TypeAdapter<T>) new TypeAdapter<AiConfigsMetricDataSourceRefRep>() {
           @Override
           public void write(JsonWriter out, AiConfigsMetricDataSourceRefRep value) throws IOException {
           ...
           @Override
           public AiConfigsMetricDataSourceRefRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiConfigsMetricDataSourceRefRep instance = thisAdapter.fromJsonTree(jsonObj);
