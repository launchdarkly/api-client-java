...
public class AccessAllowedRep {
  ...
  @javax.annotation.Nonnull
  private AccessAllowedReason reason;

  public AccessAllowedRep() {
  }

  public AccessAllowedRep action(@javax.annotation.Nonnull String action) {
    this.action = action;
    return this;
  }
  ...
  public AccessAllowedRep reason(@javax.annotation.Nonnull AccessAllowedReason reason) {
    this.reason = reason;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AccessAllowedReason getReason() {
    return reason;
  }

  public void setReason(@javax.annotation.Nonnull AccessAllowedReason reason) {
    this.reason = reason;
  }
   ...
   * @return the AccessAllowedRep instance itself
   */
  public AccessAllowedRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccessAllowedRep accessAllowedRep = (AccessAllowedRep) o;
    return Objects.equals(this.action, accessAllowedRep.action) &&
        Objects.equals(this.reason, accessAllowedRep.reason)&&
        Objects.equals(this.additionalProperties, accessAllowedRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessAllowedRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccessAllowedRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessAllowedRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccessAllowedRep is not found in the empty JSON string", AccessAllowedRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessAllowedRep.openapiRequiredFields) {
      ...
      AccessAllowedReason.validateJsonElement(jsonObj.get("reason"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessAllowedRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessAllowedRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessAllowedRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessAllowedRep.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessAllowedRep>() {
           @Override
           public void write(JsonWriter out, AccessAllowedRep value) throws IOException {
           ...
           @Override
           public AccessAllowedRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AccessAllowedRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AccessAllowedRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccessAllowedRep
   * @throws IOException if the JSON string is invalid with respect to AccessAllowedRep
   */
  public static AccessAllowedRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessAllowedRep.class);
  }

  /**
   * Convert an instance of AccessAllowedRep to an JSON string
   *
   * @return JSON string
   */
