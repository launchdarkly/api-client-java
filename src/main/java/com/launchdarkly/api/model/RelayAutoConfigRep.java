...
import com.launchdarkly.api.model.StatementRep;
...
public class RelayAutoConfigRep {
  ...
  private MemberSummaryRep creator;
  ...
  private List<StatementRep> policy = new ArrayList<StatementRep>();
  ...
  **/
  ...
  public RelayAutoConfigRep creator(MemberSummaryRep creator) {
  ...
  **/
  ...
  public MemberSummaryRep getCreator() {
    return creator;
  }


  public void setCreator(MemberSummaryRep creator) {
    this.creator = creator;
  }


  public RelayAutoConfigRep access(AccessRep access) {
  ...
  **/
  ...
  public RelayAutoConfigRep policy(List<StatementRep> policy) {
    
    this.policy = policy;
    return this;
  }

  public RelayAutoConfigRep addPolicyItem(StatementRep policyItem) {
  ...
  **/
  ...
  public List<StatementRep> getPolicy() {
    return policy;
  }


  public void setPolicy(List<StatementRep> policy) {
    this.policy = policy;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, creator, access, name, policy, fullKey, displayKey, creationDate, lastModified);
  }
