...
public class RelayAutoConfigRep {
   ...
   * @return the RelayAutoConfigRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelayAutoConfigRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelayAutoConfigRep is not found in the empty JSON string", RelayAutoConfigRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("_creator") != null && !jsonObj.get("_creator").isJsonNull()) {
        MemberSummary.validateJsonElement(jsonObj.get("_creator"));
      }
      ...
      if ((jsonObj.get("fullKey") != null && !jsonObj.get("fullKey").isJsonNull()) && !jsonObj.get("fullKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `fullKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fullKey").toString()));
      }
      if (!jsonObj.get("displayKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `displayKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("displayKey").toString()));
      }
  }
