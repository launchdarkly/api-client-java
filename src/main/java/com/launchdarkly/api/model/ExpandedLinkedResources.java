...
import com.launchdarkly.api.model.ExpandedLinkedResourcesItems;
...
public class ExpandedLinkedResources {
   ...
   * @return the ExpandedLinkedResources instance itself
   */
  public ExpandedLinkedResources putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedLinkedResources expandedLinkedResources = (ExpandedLinkedResources) o;
    return Objects.equals(this.items, expandedLinkedResources.items) &&
        Objects.equals(this.totalCount, expandedLinkedResources.totalCount)&&
        Objects.equals(this.additionalProperties, expandedLinkedResources.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpandedLinkedResources {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedLinkedResources.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedLinkedResources is not found in the empty JSON string", ExpandedLinkedResources.openapiRequiredFields.toString()));
        }
      }
      ...
      ExpandedLinkedResourcesItems.validateJsonElement(jsonObj.get("items"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedLinkedResources.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedLinkedResources' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedLinkedResources> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedLinkedResources.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedLinkedResources>() {
           @Override
           public void write(JsonWriter out, ExpandedLinkedResources value) throws IOException {
           ...
           @Override
           public ExpandedLinkedResources read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedLinkedResources instance = thisAdapter.fromJsonTree(jsonObj);
