...
public class AgentGraphMaintainer extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AgentGraphMaintainer.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AgentGraphMaintainer.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AgentGraphMaintainer' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<MaintainerMember> adapterMaintainerMember = gson.getDelegateAdapter(this, TypeToken.get(MaintainerMember.class));
            final TypeAdapter<AiConfigsMaintainerTeam> adapterAiConfigsMaintainerTeam = gson.getDelegateAdapter(this, TypeToken.get(AiConfigsMaintainerTeam.class));

            return (TypeAdapter<T>) new TypeAdapter<AgentGraphMaintainer>() {
                @Override
                public void write(JsonWriter out, AgentGraphMaintainer value) throws IOException {
                    if (value == null || value.getActualInstance() == null) {
                        elementAdapter.write(out, null);
                        return;
                    }

                    // check if the actual instance is of the type `MaintainerMember`
                    if (value.getActualInstance() instanceof MaintainerMember) {
                        JsonElement element = adapterMaintainerMember.toJsonTree((MaintainerMember)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `AiConfigsMaintainerTeam`
                    if (value.getActualInstance() instanceof AiConfigsMaintainerTeam) {
                        JsonElement element = adapterAiConfigsMaintainerTeam.toJsonTree((AiConfigsMaintainerTeam)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                @Override
                public AgentGraphMaintainer read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for MaintainerMember failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for AiConfigsMaintainerTeam failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'AiConfigsMaintainerTeam'", e);
                    }

                    if (match == 1) {
                        AgentGraphMaintainer ret = new AgentGraphMaintainer();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for AgentGraphMaintainer: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AgentGraphMaintainer() {
        super("oneOf", Boolean.FALSE);
    }

    public AgentGraphMaintainer(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("MaintainerMember", MaintainerMember.class);
        schemas.put("AiConfigsMaintainerTeam", AiConfigsMaintainerTeam.class);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return AgentGraphMaintainer.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * AiConfigsMaintainerTeam, MaintainerMember
     *
     ...
     * AiConfigsMaintainerTeam, MaintainerMember
     *
     * @return The actual instance (AiConfigsMaintainerTeam, MaintainerMember)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `MaintainerMember`. If the actual instance is not `MaintainerMember`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `MaintainerMember`
     * @throws ClassCastException if the instance is not `MaintainerMember`
     */
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AiConfigsMaintainerTeam`
     * @throws ClassCastException if the instance is not `AiConfigsMaintainerTeam`
     */
     ...
     * @throws IOException if the JSON Element is invalid with respect to AgentGraphMaintainer
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        // validate oneOf schemas one by one
        int validCount = 0;
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with MaintainerMember
        try {
            MaintainerMember.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for AgentGraphMaintainer with oneOf schemas: AiConfigsMaintainerTeam, MaintainerMember. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of AgentGraphMaintainer given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AgentGraphMaintainer
     * @throws IOException if the JSON string is invalid with respect to AgentGraphMaintainer
     */
    public static AgentGraphMaintainer fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AgentGraphMaintainer.class);
    }

    /**
     * Convert an instance of AgentGraphMaintainer to an JSON string
     *
     * @return JSON string
     */
