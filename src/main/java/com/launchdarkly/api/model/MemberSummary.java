...
public class MemberSummary {
  ...
  public MemberSummary links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public MemberSummary id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public MemberSummary firstName(@javax.annotation.Nullable String firstName) {
  ...
  public MemberSummary lastName(@javax.annotation.Nullable String lastName) {
  ...
  public MemberSummary role(@javax.annotation.Nonnull String role) {
    this.role = role;
    return this;
  }
  ...
  public MemberSummary email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
   ...
   * @return the MemberSummary instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MemberSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MemberSummary is not found in the empty JSON string", MemberSummary.openapiRequiredFields.toString()));
        }
      }
