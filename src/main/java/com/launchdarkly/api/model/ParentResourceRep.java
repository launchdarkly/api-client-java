...
public class ParentResourceRep {
  ...
  public ParentResourceRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public ParentResourceRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public ParentResourceRep name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ParentResourceRep resource(@javax.annotation.Nullable String resource) {
   ...
   * @return the ParentResourceRep instance itself
   */
  public ParentResourceRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ParentResourceRep parentResourceRep = (ParentResourceRep) o;
    return Objects.equals(this.links, parentResourceRep.links) &&
        Objects.equals(this.name, parentResourceRep.name) &&
        Objects.equals(this.resource, parentResourceRep.resource)&&
        Objects.equals(this.additionalProperties, parentResourceRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, name, resource, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ParentResourceRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "name", "resource"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ParentResourceRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParentResourceRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ParentResourceRep is not found in the empty JSON string", ParentResourceRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParentResourceRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParentResourceRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParentResourceRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParentResourceRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ParentResourceRep>() {
           @Override
           public void write(JsonWriter out, ParentResourceRep value) throws IOException {
           ...
           @Override
           public ParentResourceRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ParentResourceRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ParentResourceRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ParentResourceRep
   * @throws IOException if the JSON string is invalid with respect to ParentResourceRep
   */
  public static ParentResourceRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParentResourceRep.class);
  }

  /**
   * Convert an instance of ParentResourceRep to an JSON string
   *
   * @return JSON string
   */
