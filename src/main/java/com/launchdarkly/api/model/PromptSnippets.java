...
public class PromptSnippets {
  ...
  private List<PromptSnippet> items = new ArrayList<>();
  ...
  public PromptSnippets links(@javax.annotation.Nullable PaginatedLinks links) {
    this.links = links;
    return this;
  }
  ...
  public PromptSnippets items(@javax.annotation.Nonnull List<PromptSnippet> items) {
    this.items = items;
    return this;
  }

  public PromptSnippets addItemsItem(PromptSnippet itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<PromptSnippet> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<PromptSnippet> items) {
    this.items = items;
  }


  public PromptSnippets totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the PromptSnippets instance itself
   */
  public PromptSnippets putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PromptSnippets promptSnippets = (PromptSnippets) o;
    return Objects.equals(this.links, promptSnippets.links) &&
        Objects.equals(this.items, promptSnippets.items) &&
        Objects.equals(this.totalCount, promptSnippets.totalCount)&&
        Objects.equals(this.additionalProperties, promptSnippets.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PromptSnippets {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromptSnippets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptSnippets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptSnippets is not found in the empty JSON string", PromptSnippets.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromptSnippets.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        PromptSnippet.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromptSnippets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromptSnippets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromptSnippets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromptSnippets.class));

       return (TypeAdapter<T>) new TypeAdapter<PromptSnippets>() {
           @Override
           public void write(JsonWriter out, PromptSnippets value) throws IOException {
           ...
           @Override
           public PromptSnippets read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PromptSnippets instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PromptSnippets given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromptSnippets
   * @throws IOException if the JSON string is invalid with respect to PromptSnippets
   */
  public static PromptSnippets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromptSnippets.class);
  }

  /**
   * Convert an instance of PromptSnippets to an JSON string
   *
   * @return JSON string
   */
