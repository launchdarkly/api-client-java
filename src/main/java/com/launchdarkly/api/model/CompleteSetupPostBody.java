...
public class CompleteSetupPostBody {
  ...
  public CompleteSetupPostBody publicKey(@javax.annotation.Nullable String publicKey) {
   ...
   * @return the CompleteSetupPostBody instance itself
   */
  public CompleteSetupPostBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompleteSetupPostBody completeSetupPostBody = (CompleteSetupPostBody) o;
    return Objects.equals(this.publicKey, completeSetupPostBody.publicKey)&&
        Objects.equals(this.additionalProperties, completeSetupPostBody.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompleteSetupPostBody {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("publicKey"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompleteSetupPostBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompleteSetupPostBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CompleteSetupPostBody is not found in the empty JSON string", CompleteSetupPostBody.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompleteSetupPostBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompleteSetupPostBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompleteSetupPostBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompleteSetupPostBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CompleteSetupPostBody>() {
           @Override
           public void write(JsonWriter out, CompleteSetupPostBody value) throws IOException {
           ...
           @Override
           public CompleteSetupPostBody read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CompleteSetupPostBody instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CompleteSetupPostBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompleteSetupPostBody
   * @throws IOException if the JSON string is invalid with respect to CompleteSetupPostBody
   */
  public static CompleteSetupPostBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompleteSetupPostBody.class);
  }

  /**
   * Convert an instance of CompleteSetupPostBody to an JSON string
   *
   * @return JSON string
   */
