...
public class BigSegmentStoreIntegration {
  ...
  public BigSegmentStoreIntegration putConfigItem(String key, Object configItem) {
    if (this.config == null) {
  ...
  public BigSegmentStoreIntegration addTagsItem(String tagsItem) {
    if (this.tags == null) {
   ...
   * @return the BigSegmentStoreIntegration instance itself
   */
  public BigSegmentStoreIntegration putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BigSegmentStoreIntegration bigSegmentStoreIntegration = (BigSegmentStoreIntegration) o;
    return Objects.equals(this.links, bigSegmentStoreIntegration.links) &&
        Objects.equals(this.id, bigSegmentStoreIntegration.id) &&
        Objects.equals(this.integrationKey, bigSegmentStoreIntegration.integrationKey) &&
        Objects.equals(this.projectKey, bigSegmentStoreIntegration.projectKey) &&
        Objects.equals(this.environmentKey, bigSegmentStoreIntegration.environmentKey) &&
        Objects.equals(this.config, bigSegmentStoreIntegration.config) &&
        Objects.equals(this.on, bigSegmentStoreIntegration.on) &&
        Objects.equals(this.tags, bigSegmentStoreIntegration.tags) &&
        Objects.equals(this.name, bigSegmentStoreIntegration.name) &&
        Objects.equals(this.version, bigSegmentStoreIntegration.version) &&
        Objects.equals(this.access, bigSegmentStoreIntegration.access) &&
        Objects.equals(this.status, bigSegmentStoreIntegration.status)&&
        Objects.equals(this.additionalProperties, bigSegmentStoreIntegration.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, id, integrationKey, projectKey, environmentKey, config, on, tags, name, version, access, status, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BigSegmentStoreIntegration {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BigSegmentStoreIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BigSegmentStoreIntegration is not found in the empty JSON string", BigSegmentStoreIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      BigSegmentStoreStatus.validateJsonElement(jsonObj.get("_status"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BigSegmentStoreIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BigSegmentStoreIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BigSegmentStoreIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BigSegmentStoreIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<BigSegmentStoreIntegration>() {
           @Override
           public void write(JsonWriter out, BigSegmentStoreIntegration value) throws IOException {
           ...
           @Override
           public BigSegmentStoreIntegration read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BigSegmentStoreIntegration instance = thisAdapter.fromJsonTree(jsonObj);
