...
public class ContextInstanceEvaluation {
   ...
   * @return the ContextInstanceEvaluation instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextInstanceEvaluation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextInstanceEvaluation is not found in the empty JSON string", ContextInstanceEvaluation.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("reason") != null && !jsonObj.get("reason").isJsonNull()) {
        ContextInstanceEvaluationReason.validateJsonElement(jsonObj.get("reason"));
      }
  }
