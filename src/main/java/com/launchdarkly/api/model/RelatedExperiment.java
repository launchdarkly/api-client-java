...
public class RelatedExperiment {
  ...
  public RelatedExperiment key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
   ...
   * @return the RelatedExperiment instance itself
   */
  public RelatedExperiment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RelatedExperiment relatedExperiment = (RelatedExperiment) o;
    return Objects.equals(this.key, relatedExperiment.key)&&
        Objects.equals(this.additionalProperties, relatedExperiment.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RelatedExperiment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RelatedExperiment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelatedExperiment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelatedExperiment is not found in the empty JSON string", RelatedExperiment.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RelatedExperiment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RelatedExperiment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RelatedExperiment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RelatedExperiment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RelatedExperiment.class));

       return (TypeAdapter<T>) new TypeAdapter<RelatedExperiment>() {
           @Override
           public void write(JsonWriter out, RelatedExperiment value) throws IOException {
           ...
           @Override
           public RelatedExperiment read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RelatedExperiment instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of RelatedExperiment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RelatedExperiment
   * @throws IOException if the JSON string is invalid with respect to RelatedExperiment
   */
  public static RelatedExperiment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RelatedExperiment.class);
  }

  /**
   * Convert an instance of RelatedExperiment to an JSON string
   *
   * @return JSON string
   */
