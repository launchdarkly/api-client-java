...
public class FailedResourceLink {
   ...
   * @return the FailedResourceLink instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceKey, failedResourceLink.resourceKey) &&
        Objects.equals(this.environmentId, failedResourceLink.environmentId) &&
        Objects.equals(this.resourceType, failedResourceLink.resourceType) &&
        Objects.equals(this.errorMessage, failedResourceLink.errorMessage)&&
        Objects.equals(this.additionalProperties, failedResourceLink.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceKey, environmentId, resourceType, errorMessage, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FailedResourceLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FailedResourceLink is not found in the empty JSON string", FailedResourceLink.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FailedResourceLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FailedResourceLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FailedResourceLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FailedResourceLink.class));

       return (TypeAdapter<T>) new TypeAdapter<FailedResourceLink>() {
           @Override
           ...
           public FailedResourceLink read(JsonReader in) throws IOException {
             ...
             FailedResourceLink instance = thisAdapter.fromJsonTree(jsonObj);
