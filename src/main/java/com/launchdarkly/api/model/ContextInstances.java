...
public class ContextInstances {
   ...
   * @return the ContextInstances instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, contextInstances.links) &&
        Objects.equals(this.totalCount, contextInstances.totalCount) &&
        Objects.equals(this.environmentId, contextInstances.environmentId) &&
        Objects.equals(this.continuationToken, contextInstances.continuationToken) &&
        Objects.equals(this.items, contextInstances.items)&&
        Objects.equals(this.additionalProperties, contextInstances.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextInstances.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextInstances is not found in the empty JSON string", ContextInstances.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ContextInstanceRecord.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContextInstances.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContextInstances' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContextInstances> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContextInstances.class));

       return (TypeAdapter<T>) new TypeAdapter<ContextInstances>() {
           @Override
           ...
           public ContextInstances read(JsonReader in) throws IOException {
             ...
             ContextInstances instance = thisAdapter.fromJsonTree(jsonObj);
