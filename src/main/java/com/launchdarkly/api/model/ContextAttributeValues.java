...
public class ContextAttributeValues {
   ...
   * @return the ContextAttributeValues instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextAttributeValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextAttributeValues is not found in the empty JSON string", ContextAttributeValues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayvalues.size(); i++) {
        ContextAttributeValue.validateJsonElement(jsonArrayvalues.get(i));
      };
  }
