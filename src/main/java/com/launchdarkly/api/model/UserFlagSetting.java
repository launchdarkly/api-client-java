...
public class UserFlagSetting {
   ...
   * @return the UserFlagSetting instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserFlagSetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserFlagSetting is not found in the empty JSON string", UserFlagSetting.openapiRequiredFields.toString()));
        }
      }
