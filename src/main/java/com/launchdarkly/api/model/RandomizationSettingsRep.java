...
public class RandomizationSettingsRep {
  ...
  public RandomizationSettingsRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the RandomizationSettingsRep instance itself
   */
  public RandomizationSettingsRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RandomizationSettingsRep randomizationSettingsRep = (RandomizationSettingsRep) o;
    return Objects.equals(this.projectId, randomizationSettingsRep.projectId) &&
        Objects.equals(this.projectKey, randomizationSettingsRep.projectKey) &&
        Objects.equals(this.randomizationUnits, randomizationSettingsRep.randomizationUnits) &&
        Objects.equals(this.creationDate, randomizationSettingsRep.creationDate) &&
        Objects.equals(this.links, randomizationSettingsRep.links)&&
        Objects.equals(this.additionalProperties, randomizationSettingsRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RandomizationSettingsRep {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RandomizationSettingsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RandomizationSettingsRep is not found in the empty JSON string", RandomizationSettingsRep.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("_projectId") != null && !jsonObj.get("_projectId").isJsonNull()) && !jsonObj.get("_projectId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_projectId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_projectId").toString()));
      }
      if ((jsonObj.get("_projectKey") != null && !jsonObj.get("_projectKey").isJsonNull()) && !jsonObj.get("_projectKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_projectKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_projectKey").toString()));
      }
      if (jsonObj.get("randomizationUnits") != null && !jsonObj.get("randomizationUnits").isJsonNull()) {
        ...
        if (jsonArrayrandomizationUnits != null) {
          ...
          for (int i = 0; i < jsonArrayrandomizationUnits.size(); i++) {
            RandomizationUnitRep.validateJsonElement(jsonArrayrandomizationUnits.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RandomizationSettingsRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RandomizationSettingsRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RandomizationSettingsRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RandomizationSettingsRep.class));

       return (TypeAdapter<T>) new TypeAdapter<RandomizationSettingsRep>() {
           @Override
           public void write(JsonWriter out, RandomizationSettingsRep value) throws IOException {
           ...
           @Override
           public RandomizationSettingsRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RandomizationSettingsRep instance = thisAdapter.fromJsonTree(jsonObj);
