...
public class ResourceAccess {
  ...
  public ResourceAccess action(@javax.annotation.Nullable String action) {
    this.action = action;
    return this;
  }
  ...
  public ResourceAccess resource(@javax.annotation.Nullable String resource) {
   ...
   * @return the ResourceAccess instance itself
   */
  public ResourceAccess putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, resourceAccess.action) &&
        Objects.equals(this.resource, resourceAccess.resource)&&
        Objects.equals(this.additionalProperties, resourceAccess.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, resource, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("action", "resource"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceAccess
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResourceAccess is not found in the empty JSON string", ResourceAccess.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceAccess.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceAccess' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceAccess> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceAccess.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceAccess>() {
           @Override
           public void write(JsonWriter out, ResourceAccess value) throws IOException {
           ...
           @Override
           public ResourceAccess read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ResourceAccess instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ResourceAccess given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceAccess
   * @throws IOException if the JSON string is invalid with respect to ResourceAccess
   */
  public static ResourceAccess fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceAccess.class);
  }

  /**
   * Convert an instance of ResourceAccess to an JSON string
   *
   * @return JSON string
   */
