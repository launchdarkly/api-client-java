...
public class AiConfigsMaintainerTeam {
  ...
  public AiConfigsMaintainerTeam key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public AiConfigsMaintainerTeam name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the AiConfigsMaintainerTeam instance itself
   */
  public AiConfigsMaintainerTeam putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiConfigsMaintainerTeam aiConfigsMaintainerTeam = (AiConfigsMaintainerTeam) o;
    return Objects.equals(this.key, aiConfigsMaintainerTeam.key) &&
        Objects.equals(this.name, aiConfigsMaintainerTeam.name)&&
        Objects.equals(this.additionalProperties, aiConfigsMaintainerTeam.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiConfigsMaintainerTeam {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiConfigsMaintainerTeam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiConfigsMaintainerTeam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AiConfigsMaintainerTeam is not found in the empty JSON string", AiConfigsMaintainerTeam.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AiConfigsMaintainerTeam.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiConfigsMaintainerTeam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiConfigsMaintainerTeam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiConfigsMaintainerTeam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiConfigsMaintainerTeam.class));

       return (TypeAdapter<T>) new TypeAdapter<AiConfigsMaintainerTeam>() {
           @Override
           public void write(JsonWriter out, AiConfigsMaintainerTeam value) throws IOException {
           ...
           @Override
           public AiConfigsMaintainerTeam read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiConfigsMaintainerTeam instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AiConfigsMaintainerTeam given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AiConfigsMaintainerTeam
   * @throws IOException if the JSON string is invalid with respect to AiConfigsMaintainerTeam
   */
  public static AiConfigsMaintainerTeam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiConfigsMaintainerTeam.class);
  }

  /**
   * Convert an instance of AiConfigsMaintainerTeam to an JSON string
   *
   * @return JSON string
   */
