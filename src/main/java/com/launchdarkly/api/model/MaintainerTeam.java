...
public class MaintainerTeam {
  ...
  public MaintainerTeam key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public MaintainerTeam name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public MaintainerTeam links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public MaintainerTeam putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the MaintainerTeam instance itself
   */
  public MaintainerTeam putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MaintainerTeam maintainerTeam = (MaintainerTeam) o;
    return Objects.equals(this.key, maintainerTeam.key) &&
        Objects.equals(this.name, maintainerTeam.name) &&
        Objects.equals(this.links, maintainerTeam.links)&&
        Objects.equals(this.additionalProperties, maintainerTeam.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MaintainerTeam {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "_links"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to MaintainerTeam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MaintainerTeam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MaintainerTeam is not found in the empty JSON string", MaintainerTeam.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MaintainerTeam.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MaintainerTeam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MaintainerTeam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MaintainerTeam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MaintainerTeam.class));

       return (TypeAdapter<T>) new TypeAdapter<MaintainerTeam>() {
           @Override
           public void write(JsonWriter out, MaintainerTeam value) throws IOException {
           ...
           @Override
           public MaintainerTeam read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MaintainerTeam instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MaintainerTeam given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MaintainerTeam
   * @throws IOException if the JSON string is invalid with respect to MaintainerTeam
   */
  public static MaintainerTeam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MaintainerTeam.class);
  }

  /**
   * Convert an instance of MaintainerTeam to an JSON string
   *
   * @return JSON string
   */
