...
public class ProjectRep {
   ...
   * @return the ProjectRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectRep is not found in the empty JSON string", ProjectRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("defaultReleasePipelineKey") != null && !jsonObj.get("defaultReleasePipelineKey").isJsonNull()) && !jsonObj.get("defaultReleasePipelineKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `defaultReleasePipelineKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("defaultReleasePipelineKey").toString()));
      }
