...
public class NewMemberForm {
   ...
   * @return the NewMemberForm instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, newMemberForm.email) &&
        Objects.equals(this.password, newMemberForm.password) &&
        Objects.equals(this.firstName, newMemberForm.firstName) &&
        Objects.equals(this.lastName, newMemberForm.lastName) &&
        Objects.equals(this.role, newMemberForm.role) &&
        Objects.equals(this.customRoles, newMemberForm.customRoles) &&
        Objects.equals(this.teamKeys, newMemberForm.teamKeys) &&
        Objects.equals(this.roleAttributes, newMemberForm.roleAttributes)&&
        Objects.equals(this.additionalProperties, newMemberForm.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, password, firstName, lastName, role, customRoles, teamKeys, roleAttributes, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewMemberForm.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NewMemberForm is not found in the empty JSON string", NewMemberForm.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewMemberForm.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewMemberForm' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewMemberForm> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewMemberForm.class));

       return (TypeAdapter<T>) new TypeAdapter<NewMemberForm>() {
           @Override
           ...
           public NewMemberForm read(JsonReader in) throws IOException {
             ...
             NewMemberForm instance = thisAdapter.fromJsonTree(jsonObj);
