...
public class NewMemberForm {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The member's email")
  ...
  **/
  ...
  @ApiModelProperty(value = "The member's password")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The member's first name")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The member's last name")
  ...
  public NewMemberForm role(String role) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The member's built-in role")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The member's custom role")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, password, firstName, lastName, role, customRoles);
  }
