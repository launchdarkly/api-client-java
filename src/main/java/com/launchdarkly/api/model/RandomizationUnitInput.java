...
public class RandomizationUnitInput {
   ...
   * @return the RandomizationUnitInput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RandomizationUnitInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RandomizationUnitInput is not found in the empty JSON string", RandomizationUnitInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("standardRandomizationUnit") != null && !jsonObj.get("standardRandomizationUnit").isJsonNull()) && !jsonObj.get("standardRandomizationUnit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `standardRandomizationUnit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("standardRandomizationUnit").toString()));
      }
  }
