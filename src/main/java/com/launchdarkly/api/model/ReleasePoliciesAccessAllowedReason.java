...
public class ReleasePoliciesAccessAllowedReason {
  ...
  public ReleasePoliciesAccessAllowedReason resources(@javax.annotation.Nullable List<String> resources) {
    this.resources = resources;
    return this;
  }

  public ReleasePoliciesAccessAllowedReason addResourcesItem(String resourcesItem) {
  ...
  public ReleasePoliciesAccessAllowedReason notResources(@javax.annotation.Nullable List<String> notResources) {
    this.notResources = notResources;
    return this;
  }

  public ReleasePoliciesAccessAllowedReason addNotResourcesItem(String notResourcesItem) {
  ...
  public ReleasePoliciesAccessAllowedReason actions(@javax.annotation.Nullable List<String> actions) {
    this.actions = actions;
    return this;
  }

  public ReleasePoliciesAccessAllowedReason addActionsItem(String actionsItem) {
  ...
  public ReleasePoliciesAccessAllowedReason notActions(@javax.annotation.Nullable List<String> notActions) {
    this.notActions = notActions;
    return this;
  }

  public ReleasePoliciesAccessAllowedReason addNotActionsItem(String notActionsItem) {
  ...
  public ReleasePoliciesAccessAllowedReason effect(@javax.annotation.Nonnull EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  public ReleasePoliciesAccessAllowedReason roleName(@javax.annotation.Nullable String roleName) {
   ...
   * @return the ReleasePoliciesAccessAllowedReason instance itself
   */
  public ReleasePoliciesAccessAllowedReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReleasePoliciesAccessAllowedReason releasePoliciesAccessAllowedReason = (ReleasePoliciesAccessAllowedReason) o;
    return Objects.equals(this.resources, releasePoliciesAccessAllowedReason.resources) &&
        Objects.equals(this.notResources, releasePoliciesAccessAllowedReason.notResources) &&
        Objects.equals(this.actions, releasePoliciesAccessAllowedReason.actions) &&
        Objects.equals(this.notActions, releasePoliciesAccessAllowedReason.notActions) &&
        Objects.equals(this.effect, releasePoliciesAccessAllowedReason.effect) &&
        Objects.equals(this.roleName, releasePoliciesAccessAllowedReason.roleName)&&
        Objects.equals(this.additionalProperties, releasePoliciesAccessAllowedReason.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resources, notResources, actions, notActions, effect, roleName, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReleasePoliciesAccessAllowedReason {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReleasePoliciesAccessAllowedReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePoliciesAccessAllowedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleasePoliciesAccessAllowedReason is not found in the empty JSON string", ReleasePoliciesAccessAllowedReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReleasePoliciesAccessAllowedReason.openapiRequiredFields) {
      ...
      if (jsonObj.get("notResources") != null && !jsonObj.get("notResources").isJsonNull() && !jsonObj.get("notResources").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `notResources` to be an array in the JSON string but got `%s`", jsonObj.get("notResources").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("notActions") != null && !jsonObj.get("notActions").isJsonNull() && !jsonObj.get("notActions").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `notActions` to be an array in the JSON string but got `%s`", jsonObj.get("notActions").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleasePoliciesAccessAllowedReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleasePoliciesAccessAllowedReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleasePoliciesAccessAllowedReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleasePoliciesAccessAllowedReason.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleasePoliciesAccessAllowedReason>() {
           @Override
           public void write(JsonWriter out, ReleasePoliciesAccessAllowedReason value) throws IOException {
           ...
           @Override
           public ReleasePoliciesAccessAllowedReason read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReleasePoliciesAccessAllowedReason instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ReleasePoliciesAccessAllowedReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReleasePoliciesAccessAllowedReason
   * @throws IOException if the JSON string is invalid with respect to ReleasePoliciesAccessAllowedReason
   */
  public static ReleasePoliciesAccessAllowedReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReleasePoliciesAccessAllowedReason.class);
  }

  /**
   * Convert an instance of ReleasePoliciesAccessAllowedReason to an JSON string
   *
   * @return JSON string
   */
