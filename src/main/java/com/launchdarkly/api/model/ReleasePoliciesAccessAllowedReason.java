...
public class ReleasePoliciesAccessAllowedReason {
  ...
  public ReleasePoliciesAccessAllowedReason resources(List<String> resources) {
  ...
  **/
  ...
  public ReleasePoliciesAccessAllowedReason notResources(List<String> notResources) {
  ...
  **/
  ...
  public ReleasePoliciesAccessAllowedReason actions(List<String> actions) {
  ...
  **/
  ...
  public ReleasePoliciesAccessAllowedReason notActions(List<String> notActions) {
  ...
  **/
  ...
  public ReleasePoliciesAccessAllowedReason effect(EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  **/
  ...
  public ReleasePoliciesAccessAllowedReason roleName(String roleName) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePoliciesAccessAllowedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReleasePoliciesAccessAllowedReason is not found in the empty JSON string", ReleasePoliciesAccessAllowedReason.openapiRequiredFields.toString()));
        }
      }
