...
public class AccessDeniedReasonRep {
  ...
  public AccessDeniedReasonRep resources(List<String> resources) {
    
    this.resources = resources;
    return this;
  }

  public AccessDeniedReasonRep addResourcesItem(String resourcesItem) {
  ...
  **/
  ...
  public AccessDeniedReasonRep notResources(List<String> notResources) {
    
    this.notResources = notResources;
    return this;
  }

  public AccessDeniedReasonRep addNotResourcesItem(String notResourcesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Targeted resources are the resources NOT in this list. The \"resources\" field must be empty to use this field.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Targeted actions are the actions NOT in this list. The \"actions\" field must be empty to use this field.")
