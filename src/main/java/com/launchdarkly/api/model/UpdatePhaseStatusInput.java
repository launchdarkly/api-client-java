...
public class UpdatePhaseStatusInput {
   ...
   * @return the UpdatePhaseStatusInput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePhaseStatusInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdatePhaseStatusInput is not found in the empty JSON string", UpdatePhaseStatusInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("audiences") != null && !jsonObj.get("audiences").isJsonNull()) {
        ...
        if (jsonArrayaudiences != null) {
          ...
          for (int i = 0; i < jsonArrayaudiences.size(); i++) {
            ReleaserAudienceConfigInput.validateJsonElement(jsonArrayaudiences.get(i));
          };
        }
      }
  }
