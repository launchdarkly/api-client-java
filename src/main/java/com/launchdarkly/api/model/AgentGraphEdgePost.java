...
public class AgentGraphEdgePost {
  ...
  public AgentGraphEdgePost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, agentGraphEdgePost.key) &&
        Objects.equals(this.sourceConfig, agentGraphEdgePost.sourceConfig) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentGraphEdgePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentGraphEdgePost is not found in the empty JSON string", AgentGraphEdgePost.openapiRequiredFields.toString()));
        }
      }
