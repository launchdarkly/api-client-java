...
public class ProgressiveReleaseConfig {
  ...
  public ProgressiveReleaseConfig rolloutContextKindKey(@javax.annotation.Nullable String rolloutContextKindKey) {
  ...
  public ProgressiveReleaseConfig stages(@javax.annotation.Nullable List<ReleasePolicyStage> stages) {
    this.stages = stages;
    return this;
  }

  public ProgressiveReleaseConfig addStagesItem(ReleasePolicyStage stagesItem) {
    if (this.stages == null) {
   ...
   * @return the ProgressiveReleaseConfig instance itself
   */
  public ProgressiveReleaseConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProgressiveReleaseConfig progressiveReleaseConfig = (ProgressiveReleaseConfig) o;
    return Objects.equals(this.rolloutContextKindKey, progressiveReleaseConfig.rolloutContextKindKey) &&
        Objects.equals(this.stages, progressiveReleaseConfig.stages)&&
        Objects.equals(this.additionalProperties, progressiveReleaseConfig.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rolloutContextKindKey, stages, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProgressiveReleaseConfig {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("rolloutContextKindKey", "stages"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProgressiveReleaseConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProgressiveReleaseConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProgressiveReleaseConfig is not found in the empty JSON string", ProgressiveReleaseConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("rolloutContextKindKey") != null && !jsonObj.get("rolloutContextKindKey").isJsonNull()) && !jsonObj.get("rolloutContextKindKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rolloutContextKindKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rolloutContextKindKey").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProgressiveReleaseConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProgressiveReleaseConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProgressiveReleaseConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProgressiveReleaseConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<ProgressiveReleaseConfig>() {
           @Override
           public void write(JsonWriter out, ProgressiveReleaseConfig value) throws IOException {
           ...
           @Override
           public ProgressiveReleaseConfig read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ProgressiveReleaseConfig instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ProgressiveReleaseConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProgressiveReleaseConfig
   * @throws IOException if the JSON string is invalid with respect to ProgressiveReleaseConfig
   */
  public static ProgressiveReleaseConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProgressiveReleaseConfig.class);
  }

  /**
   * Convert an instance of ProgressiveReleaseConfig to an JSON string
   *
   * @return JSON string
   */
