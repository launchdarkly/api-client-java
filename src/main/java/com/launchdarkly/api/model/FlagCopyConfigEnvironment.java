...
public class FlagCopyConfigEnvironment {
   ...
   * @return the FlagCopyConfigEnvironment instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagCopyConfigEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagCopyConfigEnvironment is not found in the empty JSON string", FlagCopyConfigEnvironment.openapiRequiredFields.toString()));
        }
      }
