...
public class ViewLinkRequestKeys {
  ...
  public ViewLinkRequestKeys() {
  }

  public ViewLinkRequestKeys keys(@javax.annotation.Nonnull List<String> keys) {
    this.keys = keys;
    return this;
  }

  public ViewLinkRequestKeys addKeysItem(String keysItem) {
    if (this.keys == null) {
  ...
  public ViewLinkRequestKeys filter(@javax.annotation.Nullable String filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ViewLinkRequestKeys comment(@javax.annotation.Nullable String comment) {
  ...
  public boolean equals(Object o) {
    ...
    ViewLinkRequestKeys viewLinkRequestKeys = (ViewLinkRequestKeys) o;
    return Objects.equals(this.keys, viewLinkRequestKeys.keys) &&
        Objects.equals(this.filter, viewLinkRequestKeys.filter) &&
        Objects.equals(this.comment, viewLinkRequestKeys.comment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keys, filter, comment);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewLinkRequestKeys {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("keys", "filter", "comment"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewLinkRequestKeys
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewLinkRequestKeys.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewLinkRequestKeys is not found in the empty JSON string", ViewLinkRequestKeys.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewLinkRequestKeys.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewLinkRequestKeys` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewLinkRequestKeys.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewLinkRequestKeys.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewLinkRequestKeys' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewLinkRequestKeys> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewLinkRequestKeys.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewLinkRequestKeys>() {
           @Override
           public void write(JsonWriter out, ViewLinkRequestKeys value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewLinkRequestKeys read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewLinkRequestKeys given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewLinkRequestKeys
   * @throws IOException if the JSON string is invalid with respect to ViewLinkRequestKeys
   */
  public static ViewLinkRequestKeys fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewLinkRequestKeys.class);
  }

  /**
   * Convert an instance of ViewLinkRequestKeys to an JSON string
   *
   * @return JSON string
   */
