...
public class PatchSegmentExpiringTargetInstruction {
   ...
   * @return the PatchSegmentExpiringTargetInstruction instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.kind, patchSegmentExpiringTargetInstruction.kind) &&
        Objects.equals(this.contextKey, patchSegmentExpiringTargetInstruction.contextKey) &&
        Objects.equals(this.contextKind, patchSegmentExpiringTargetInstruction.contextKind) &&
        Objects.equals(this.targetType, patchSegmentExpiringTargetInstruction.targetType) &&
        Objects.equals(this.value, patchSegmentExpiringTargetInstruction.value) &&
        Objects.equals(this.version, patchSegmentExpiringTargetInstruction.version)&&
        Objects.equals(this.additionalProperties, patchSegmentExpiringTargetInstruction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, contextKey, contextKind, targetType, value, version, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchSegmentExpiringTargetInstruction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PatchSegmentExpiringTargetInstruction is not found in the empty JSON string", PatchSegmentExpiringTargetInstruction.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchSegmentExpiringTargetInstruction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchSegmentExpiringTargetInstruction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchSegmentExpiringTargetInstruction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchSegmentExpiringTargetInstruction.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchSegmentExpiringTargetInstruction>() {
           @Override
           ...
           public PatchSegmentExpiringTargetInstruction read(JsonReader in) throws IOException {
             ...
             PatchSegmentExpiringTargetInstruction instance = thisAdapter.fromJsonTree(jsonObj);
