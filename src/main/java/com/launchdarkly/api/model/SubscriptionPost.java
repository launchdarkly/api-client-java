...
public class SubscriptionPost {
   ...
   * @return the SubscriptionPost instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, subscriptionPost.name) &&
        Objects.equals(this.statements, subscriptionPost.statements) &&
        Objects.equals(this.on, subscriptionPost.on) &&
        Objects.equals(this.tags, subscriptionPost.tags) &&
        Objects.equals(this.config, subscriptionPost.config) &&
        Objects.equals(this.url, subscriptionPost.url) &&
        Objects.equals(this.apiKey, subscriptionPost.apiKey)&&
        Objects.equals(this.additionalProperties, subscriptionPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, statements, on, tags, config, url, apiKey, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscriptionPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SubscriptionPost is not found in the empty JSON string", SubscriptionPost.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionPost.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionPost>() {
           @Override
           ...
           public SubscriptionPost read(JsonReader in) throws IOException {
             ...
             SubscriptionPost instance = thisAdapter.fromJsonTree(jsonObj);
