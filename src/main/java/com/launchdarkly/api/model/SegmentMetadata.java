...
public class SegmentMetadata {
   ...
   * @return the SegmentMetadata instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SegmentMetadata is not found in the empty JSON string", SegmentMetadata.openapiRequiredFields.toString()));
        }
      }
