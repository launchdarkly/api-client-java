...
public class FlagImportIntegration {
   ...
   * The integration key
   */
  @JsonAdapter(IntegrationKeyEnum.Adapter.class)
  public enum IntegrationKeyEnum {
    SPLIT("split"),
    ...
    IntegrationKeyEnum(String value) {
      this.value = value;
    }
    ...
    public static class Adapter extends TypeAdapter<IntegrationKeyEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final IntegrationKeyEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public IntegrationKeyEnum read(final JsonReader jsonReader) throws IOException {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      IntegrationKeyEnum.fromValue(value);
    }
  }
  ...
  public FlagImportIntegration links(@javax.annotation.Nonnull FlagImportIntegrationLinks links) {
    this.links = links;
    return this;
  }
  ...
  public void setLinks(@javax.annotation.Nonnull FlagImportIntegrationLinks links) {
    this.links = links;
  }


  public FlagImportIntegration id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public FlagImportIntegration integrationKey(@javax.annotation.Nonnull IntegrationKeyEnum integrationKey) {
  ...
  public FlagImportIntegration projectKey(@javax.annotation.Nonnull String projectKey) {
  ...
  public FlagImportIntegration config(@javax.annotation.Nonnull Map<String, Object> config) {
    this.config = config;
    return this;
  }
  ...
  public FlagImportIntegration tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public FlagImportIntegration name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public FlagImportIntegration version(@javax.annotation.Nonnull Integer version) {
  ...
  public FlagImportIntegration access(@javax.annotation.Nullable Access access) {
    this.access = access;
    return this;
  }
  ...
  public FlagImportIntegration status(@javax.annotation.Nonnull FlagImportStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@javax.annotation.Nonnull FlagImportStatus status) {
    this.status = status;
  }
   ...
   * @return the FlagImportIntegration instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, flagImportIntegration.links) &&
        Objects.equals(this.id, flagImportIntegration.id) &&
        Objects.equals(this.integrationKey, flagImportIntegration.integrationKey) &&
        Objects.equals(this.projectKey, flagImportIntegration.projectKey) &&
        Objects.equals(this.config, flagImportIntegration.config) &&
        Objects.equals(this.tags, flagImportIntegration.tags) &&
        Objects.equals(this.name, flagImportIntegration.name) &&
        Objects.equals(this.version, flagImportIntegration.version) &&
        Objects.equals(this.access, flagImportIntegration.access) &&
        Objects.equals(this.status, flagImportIntegration.status)&&
        Objects.equals(this.additionalProperties, flagImportIntegration.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, id, integrationKey, projectKey, config, tags, name, version, access, status, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "_id", "integrationKey", "projectKey", "config", "tags", "name", "version", "_access", "_status"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_links", "_id", "integrationKey", "projectKey", "config", "tags", "name", "version", "_status"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagImportIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagImportIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagImportIntegration is not found in the empty JSON string", FlagImportIntegration.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlagImportIntegration.openapiRequiredFields) {
      ...
      FlagImportIntegrationLinks.validateJsonElement(jsonObj.get("_links"));
      ...
      // validate the required field `_status`
      FlagImportStatus.validateJsonElement(jsonObj.get("_status"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagImportIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagImportIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagImportIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagImportIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagImportIntegration>() {
           @Override
           ...
           public FlagImportIntegration read(JsonReader in) throws IOException {
             ...
             FlagImportIntegration instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FlagImportIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlagImportIntegration
   * @throws IOException if the JSON string is invalid with respect to FlagImportIntegration
   */
  public static FlagImportIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlagImportIntegration.class);
  }

  /**
   * Convert an instance of FlagImportIntegration to an JSON string
   *
   * @return JSON string
   */
