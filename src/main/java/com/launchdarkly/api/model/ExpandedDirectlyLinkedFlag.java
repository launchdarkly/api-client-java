...
public class ExpandedDirectlyLinkedFlag {
   ...
   * @return the ExpandedDirectlyLinkedFlag instance itself
   */
  public ExpandedDirectlyLinkedFlag putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedDirectlyLinkedFlag expandedDirectlyLinkedFlag = (ExpandedDirectlyLinkedFlag) o;
    return Objects.equals(this.key, expandedDirectlyLinkedFlag.key) &&
        Objects.equals(this.name, expandedDirectlyLinkedFlag.name) &&
        Objects.equals(this.links, expandedDirectlyLinkedFlag.links)&&
        Objects.equals(this.additionalProperties, expandedDirectlyLinkedFlag.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpandedDirectlyLinkedFlag {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedDirectlyLinkedFlag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedDirectlyLinkedFlag is not found in the empty JSON string", ExpandedDirectlyLinkedFlag.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedDirectlyLinkedFlag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedDirectlyLinkedFlag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedDirectlyLinkedFlag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedDirectlyLinkedFlag.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedDirectlyLinkedFlag>() {
           @Override
           public void write(JsonWriter out, ExpandedDirectlyLinkedFlag value) throws IOException {
           ...
           @Override
           public ExpandedDirectlyLinkedFlag read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedDirectlyLinkedFlag instance = thisAdapter.fromJsonTree(jsonObj);
