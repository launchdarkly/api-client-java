...
public class UserSegments {
  ...
  private List<UserSegment> items = new ArrayList<>();
  ...
  public UserSegments items(@javax.annotation.Nonnull List<UserSegment> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<UserSegment> items) {
    this.items = items;
  }


  public UserSegments links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public UserSegments putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public UserSegments totalCount(@javax.annotation.Nullable Integer totalCount) {
   ...
   * @return the UserSegments instance itself
   */
  public UserSegments putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, userSegments.items) &&
        Objects.equals(this.links, userSegments.links) &&
        Objects.equals(this.totalCount, userSegments.totalCount)&&
        Objects.equals(this.additionalProperties, userSegments.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserSegments
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserSegments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserSegments is not found in the empty JSON string", UserSegments.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserSegments.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        UserSegment.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserSegments.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserSegments' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserSegments> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserSegments.class));

       return (TypeAdapter<T>) new TypeAdapter<UserSegments>() {
           @Override
           public void write(JsonWriter out, UserSegments value) throws IOException {
           ...
           @Override
           public UserSegments read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UserSegments instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UserSegments given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserSegments
   * @throws IOException if the JSON string is invalid with respect to UserSegments
   */
  public static UserSegments fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserSegments.class);
  }

  /**
   * Convert an instance of UserSegments to an JSON string
   *
   * @return JSON string
   */
