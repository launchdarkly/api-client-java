...
public class FlagFollowersGetRep {
  ...
  public FlagFollowersGetRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public FlagFollowersGetRep items(@javax.annotation.Nonnull List<FollowFlagMember> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<FollowFlagMember> items) {
    this.items = items;
  }
   ...
   * @return the FlagFollowersGetRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagFollowersGetRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagFollowersGetRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagFollowersGetRep is not found in the empty JSON string", FlagFollowersGetRep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        FollowFlagMember.validateJsonElement(jsonArrayitems.get(i));
      };
  }
