...
public class UrlPost {
   ...
   * @return the UrlPost instance itself
   */
  public UrlPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UrlPost urlPost = (UrlPost) o;
    return Objects.equals(this.kind, urlPost.kind) &&
        Objects.equals(this.url, urlPost.url) &&
        Objects.equals(this.substring, urlPost.substring) &&
        Objects.equals(this.pattern, urlPost.pattern)&&
        Objects.equals(this.additionalProperties, urlPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, url, substring, pattern, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UrlPost {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UrlPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UrlPost is not found in the empty JSON string", UrlPost.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("substring") != null && !jsonObj.get("substring").isJsonNull()) && !jsonObj.get("substring").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `substring` to be a primitive type in the JSON string but got `%s`", jsonObj.get("substring").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UrlPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UrlPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UrlPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UrlPost.class));

       return (TypeAdapter<T>) new TypeAdapter<UrlPost>() {
           @Override
           public void write(JsonWriter out, UrlPost value) throws IOException {
           ...
           @Override
           public UrlPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UrlPost instance = thisAdapter.fromJsonTree(jsonObj);
