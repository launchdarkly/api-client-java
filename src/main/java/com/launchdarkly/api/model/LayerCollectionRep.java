...
public class LayerCollectionRep {
  ...
  public LayerCollectionRep items(@javax.annotation.Nonnull List<LayerRep> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<LayerRep> items) {
    this.items = items;
  }


  public LayerCollectionRep totalCount(@javax.annotation.Nonnull Integer totalCount) {
  ...
  public LayerCollectionRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @return the LayerCollectionRep instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to LayerCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LayerCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LayerCollectionRep is not found in the empty JSON string", LayerCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        LayerRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
