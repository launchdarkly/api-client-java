...
import com.launchdarkly.api.model.AnalysisConfigRep;
import com.launchdarkly.api.model.IterationRep;
import com.launchdarkly.api.model.Link;
import com.launchdarkly.api.model.MutableFieldsByStatusRep;
...
public class Experiment {
   ...
   */
  @JsonAdapter(MethodologyEnum.Adapter.class)
  public enum MethodologyEnum {
    ...
    public static MethodologyEnum fromValue(String value) {
      for (MethodologyEnum b : MethodologyEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<MethodologyEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MethodologyEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public MethodologyEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return MethodologyEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      MethodologyEnum.fromValue(value);
    }
  }
  ...
  @javax.annotation.Nullable
  private MethodologyEnum methodology;
  ...
  @javax.annotation.Nullable
  private AnalysisConfigRep analysisConfig;

  public static final String SERIALIZED_NAME_MUTABLE_FIELDS_BY_STATUS = "mutableFieldsByStatus";
  @SerializedName(SERIALIZED_NAME_MUTABLE_FIELDS_BY_STATUS)
  @javax.annotation.Nullable
  private MutableFieldsByStatusRep mutableFieldsByStatus;
  ...
  public Experiment methodology(@javax.annotation.Nullable MethodologyEnum methodology) {
   ...
   */
  @javax.annotation.Nullable
  public MethodologyEnum getMethodology() {
    return methodology;
  }

  public void setMethodology(@javax.annotation.Nullable MethodologyEnum methodology) {
    this.methodology = methodology;
  }


  public Experiment dataSource(@javax.annotation.Nullable DataSourceEnum dataSource) {
  ...
  public Experiment type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public Experiment access(@javax.annotation.Nullable Access access) {
    this.access = access;
    return this;
  }
  ...
  public Experiment addPreviousIterationsItem(IterationRep previousIterationsItem) {
    if (this.previousIterations == null) {
      this.previousIterations = new ArrayList<>();
    }
  ...
  public Experiment analysisConfig(@javax.annotation.Nullable AnalysisConfigRep analysisConfig) {
   ...
   */
  @javax.annotation.Nullable
  public AnalysisConfigRep getAnalysisConfig() {
    return analysisConfig;
  }

  public void setAnalysisConfig(@javax.annotation.Nullable AnalysisConfigRep analysisConfig) {
    this.analysisConfig = analysisConfig;
  }


  public Experiment mutableFieldsByStatus(@javax.annotation.Nullable MutableFieldsByStatusRep mutableFieldsByStatus) {
    this.mutableFieldsByStatus = mutableFieldsByStatus;
    return this;
  }

  /**
   * Get mutableFieldsByStatus
   * @return mutableFieldsByStatus
   */
  @javax.annotation.Nullable
  public MutableFieldsByStatusRep getMutableFieldsByStatus() {
    return mutableFieldsByStatus;
  }

  public void setMutableFieldsByStatus(@javax.annotation.Nullable MutableFieldsByStatusRep mutableFieldsByStatus) {
    this.mutableFieldsByStatus = mutableFieldsByStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, experiment.id) &&
        ...
        Objects.equals(this.access, experiment.access) &&
        Objects.equals(this.draftIteration, experiment.draftIteration) &&
        Objects.equals(this.previousIterations, experiment.previousIterations) &&
        Objects.equals(this.analysisConfig, experiment.analysisConfig) &&
        Objects.equals(this.mutableFieldsByStatus, experiment.mutableFieldsByStatus)&&
        Objects.equals(this.additionalProperties, experiment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, key, name, description, maintainerId, creationDate, environmentKey, methodology, dataSource, archivedDate, tags, links, holdoutId, currentIteration, type, access, draftIteration, previousIterations, analysisConfig, mutableFieldsByStatus, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    draftIteration: ").append(toIndentedString(draftIteration)).append("\n");
    sb.append("    previousIterations: ").append(toIndentedString(previousIterations)).append("\n");
    sb.append("    analysisConfig: ").append(toIndentedString(analysisConfig)).append("\n");
    sb.append("    mutableFieldsByStatus: ").append(toIndentedString(mutableFieldsByStatus)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "key", "name", "description", "_maintainerId", "_creationDate", "environmentKey", "methodology", "dataSource", "archivedDate", "tags", "_links", "holdoutId", "currentIteration", "type", "_access", "draftIteration", "previousIterations", "analysisConfig", "mutableFieldsByStatus"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("methodology") != null && !jsonObj.get("methodology").isJsonNull()) && !jsonObj.get("methodology").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `methodology` to be a primitive type in the JSON string but got `%s`", jsonObj.get("methodology").toString()));
      }
      // validate the optional field `methodology`
      if (jsonObj.get("methodology") != null && !jsonObj.get("methodology").isJsonNull()) {
        MethodologyEnum.validateJsonElement(jsonObj.get("methodology"));
      }
      ...
      if ((jsonObj.get("holdoutId") != null && !jsonObj.get("holdoutId").isJsonNull()) && !jsonObj.get("holdoutId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `holdoutId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("holdoutId").toString()));
      }
      // validate the optional field `currentIteration`
      if (jsonObj.get("currentIteration") != null && !jsonObj.get("currentIteration").isJsonNull()) {
        IterationRep.validateJsonElement(jsonObj.get("currentIteration"));
      }
      ...
      if (jsonObj.get("draftIteration") != null && !jsonObj.get("draftIteration").isJsonNull()) {
        IterationRep.validateJsonElement(jsonObj.get("draftIteration"));
      }
      if (jsonObj.get("previousIterations") != null && !jsonObj.get("previousIterations").isJsonNull()) {
        JsonArray jsonArraypreviousIterations = jsonObj.getAsJsonArray("previousIterations");
        if (jsonArraypreviousIterations != null) {
          // ensure the json data is an array
          if (!jsonObj.get("previousIterations").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `previousIterations` to be an array in the JSON string but got `%s`", jsonObj.get("previousIterations").toString()));
          }

          // validate the optional field `previousIterations` (array)
          for (int i = 0; i < jsonArraypreviousIterations.size(); i++) {
            IterationRep.validateJsonElement(jsonArraypreviousIterations.get(i));
          };
        }
      }
      // validate the optional field `analysisConfig`
      if (jsonObj.get("analysisConfig") != null && !jsonObj.get("analysisConfig").isJsonNull()) {
        AnalysisConfigRep.validateJsonElement(jsonObj.get("analysisConfig"));
      }
      // validate the optional field `mutableFieldsByStatus`
      if (jsonObj.get("mutableFieldsByStatus") != null && !jsonObj.get("mutableFieldsByStatus").isJsonNull()) {
        MutableFieldsByStatusRep.validateJsonElement(jsonObj.get("mutableFieldsByStatus"));
      }
  }
