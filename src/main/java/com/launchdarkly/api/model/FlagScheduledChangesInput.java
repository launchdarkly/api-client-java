...
public class FlagScheduledChangesInput {
  ...
  public FlagScheduledChangesInput comment(@javax.annotation.Nullable String comment) {
  ...
  public FlagScheduledChangesInput instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
   ...
   * @return the FlagScheduledChangesInput instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagScheduledChangesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagScheduledChangesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagScheduledChangesInput is not found in the empty JSON string", FlagScheduledChangesInput.openapiRequiredFields.toString()));
        }
      }
