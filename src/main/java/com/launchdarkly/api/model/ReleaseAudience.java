...
public class ReleaseAudience {
   ...
   * @return the ReleaseAudience instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, releaseAudience.id) &&
        Objects.equals(this.links, releaseAudience.links) &&
        Objects.equals(this.environment, releaseAudience.environment) &&
        Objects.equals(this.name, releaseAudience.name) &&
        Objects.equals(this._configuration, releaseAudience._configuration) &&
        Objects.equals(this.segmentKeys, releaseAudience.segmentKeys) &&
        Objects.equals(this.status, releaseAudience.status) &&
        Objects.equals(this.ruleIds, releaseAudience.ruleIds)&&
        Objects.equals(this.additionalProperties, releaseAudience.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, links, environment, name, _configuration, segmentKeys, status, ruleIds, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleaseAudience.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleaseAudience is not found in the empty JSON string", ReleaseAudience.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("_ruleIds") != null && !jsonObj.get("_ruleIds").isJsonNull() && !jsonObj.get("_ruleIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_ruleIds` to be an array in the JSON string but got `%s`", jsonObj.get("_ruleIds").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleaseAudience.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleaseAudience' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleaseAudience> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleaseAudience.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleaseAudience>() {
           @Override
           ...
           public ReleaseAudience read(JsonReader in) throws IOException {
             ...
             ReleaseAudience instance = thisAdapter.fromJsonTree(jsonObj);
