...
public class VariationTool {
  ...
  public VariationTool key(String key) {
    this.key = key;
    return this;
  }
  ...
  **/
  ...
  public VariationTool version(Integer version) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariationTool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VariationTool is not found in the empty JSON string", VariationTool.openapiRequiredFields.toString()));
        }
      }
