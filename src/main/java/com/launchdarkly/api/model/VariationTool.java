...
public class VariationTool {
  ...
  public VariationTool key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public VariationTool version(@javax.annotation.Nonnull Integer version) {
   ...
   * @return the VariationTool instance itself
   */
  public VariationTool putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to VariationTool
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariationTool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariationTool is not found in the empty JSON string", VariationTool.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VariationTool.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VariationTool.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VariationTool' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VariationTool> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VariationTool.class));

       return (TypeAdapter<T>) new TypeAdapter<VariationTool>() {
           @Override
           public void write(JsonWriter out, VariationTool value) throws IOException {
           ...
           @Override
           public VariationTool read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             VariationTool instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of VariationTool given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VariationTool
   * @throws IOException if the JSON string is invalid with respect to VariationTool
   */
  public static VariationTool fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VariationTool.class);
  }

  /**
   * Convert an instance of VariationTool to an JSON string
   *
   * @return JSON string
   */
