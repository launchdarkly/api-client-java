...
public class WorkflowTemplateMetadata {
  ...
  private List<WorkflowTemplateParameter> parameters = new ArrayList<>();

  public WorkflowTemplateMetadata() {
  }

  public WorkflowTemplateMetadata parameters(@javax.annotation.Nullable List<WorkflowTemplateParameter> parameters) {
    this.parameters = parameters;
    return this;
  }

  public WorkflowTemplateMetadata addParametersItem(WorkflowTemplateParameter parametersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<WorkflowTemplateParameter> getParameters() {
    return parameters;
  }

  public void setParameters(@javax.annotation.Nullable List<WorkflowTemplateParameter> parameters) {
    this.parameters = parameters;
  }
   ...
   * @return the WorkflowTemplateMetadata instance itself
   */
  public WorkflowTemplateMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkflowTemplateMetadata workflowTemplateMetadata = (WorkflowTemplateMetadata) o;
    return Objects.equals(this.parameters, workflowTemplateMetadata.parameters)&&
        Objects.equals(this.additionalProperties, workflowTemplateMetadata.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkflowTemplateMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkflowTemplateMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowTemplateMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WorkflowTemplateMetadata is not found in the empty JSON string", WorkflowTemplateMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("parameters") != null && !jsonObj.get("parameters").isJsonNull()) {
        ...
        if (jsonArrayparameters != null) {
          ...
          for (int i = 0; i < jsonArrayparameters.size(); i++) {
            WorkflowTemplateParameter.validateJsonElement(jsonArrayparameters.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowTemplateMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowTemplateMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowTemplateMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowTemplateMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowTemplateMetadata>() {
           @Override
           public void write(JsonWriter out, WorkflowTemplateMetadata value) throws IOException {
           ...
           @Override
           public WorkflowTemplateMetadata read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WorkflowTemplateMetadata instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of WorkflowTemplateMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WorkflowTemplateMetadata
   * @throws IOException if the JSON string is invalid with respect to WorkflowTemplateMetadata
   */
  public static WorkflowTemplateMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowTemplateMetadata.class);
  }

  /**
   * Convert an instance of WorkflowTemplateMetadata to an JSON string
   *
   * @return JSON string
   */
