...
public class ViewLinkedResourceDetails {
   ...
   * @return the ViewLinkedResourceDetails instance itself
   */
  public ViewLinkedResourceDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewLinkedResourceDetails viewLinkedResourceDetails = (ViewLinkedResourceDetails) o;
    return Objects.equals(this.view, viewLinkedResourceDetails.view) &&
        Objects.equals(this.flag, viewLinkedResourceDetails.flag) &&
        Objects.equals(this.segment, viewLinkedResourceDetails.segment) &&
        Objects.equals(this.aiConfig, viewLinkedResourceDetails.aiConfig) &&
        Objects.equals(this.metric, viewLinkedResourceDetails.metric)&&
        Objects.equals(this.additionalProperties, viewLinkedResourceDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(view, flag, segment, aiConfig, metric, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewLinkedResourceDetails {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewLinkedResourceDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewLinkedResourceDetails is not found in the empty JSON string", ViewLinkedResourceDetails.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `view`
      if (jsonObj.get("view") != null && !jsonObj.get("view").isJsonNull()) {
        View.validateJsonElement(jsonObj.get("view"));
      }
      // validate the optional field `flag`
      if (jsonObj.get("flag") != null && !jsonObj.get("flag").isJsonNull()) {
        ExpandedFlag.validateJsonElement(jsonObj.get("flag"));
      }
      // validate the optional field `segment`
      if (jsonObj.get("segment") != null && !jsonObj.get("segment").isJsonNull()) {
        ExpandedSegment.validateJsonElement(jsonObj.get("segment"));
      }
      // validate the optional field `aiConfig`
      if (jsonObj.get("aiConfig") != null && !jsonObj.get("aiConfig").isJsonNull()) {
        ExpandedAIConfig.validateJsonElement(jsonObj.get("aiConfig"));
      }
      // validate the optional field `metric`
      if (jsonObj.get("metric") != null && !jsonObj.get("metric").isJsonNull()) {
        ExpandedMetric.validateJsonElement(jsonObj.get("metric"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewLinkedResourceDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewLinkedResourceDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewLinkedResourceDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewLinkedResourceDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewLinkedResourceDetails>() {
           @Override
           public void write(JsonWriter out, ViewLinkedResourceDetails value) throws IOException {
           ...
           @Override
           public ViewLinkedResourceDetails read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewLinkedResourceDetails instance = thisAdapter.fromJsonTree(jsonObj);
