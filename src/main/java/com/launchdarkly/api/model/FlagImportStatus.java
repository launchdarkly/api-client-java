...
public class FlagImportStatus {
   ...
   * @return the FlagImportStatus instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, flagImportStatus.status) &&
        Objects.equals(this.lastImport, flagImportStatus.lastImport) &&
        Objects.equals(this.lastError, flagImportStatus.lastError) &&
        Objects.equals(this.errors, flagImportStatus.errors)&&
        Objects.equals(this.additionalProperties, flagImportStatus.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, lastImport, lastError, errors, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagImportStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagImportStatus is not found in the empty JSON string", FlagImportStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            StatusResponse.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagImportStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagImportStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagImportStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagImportStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagImportStatus>() {
           @Override
           ...
           public FlagImportStatus read(JsonReader in) throws IOException {
             ...
             FlagImportStatus instance = thisAdapter.fromJsonTree(jsonObj);
