...
public class ReleasePolicy {
   ...
   * @return the ReleasePolicy instance itself
   */
  public ReleasePolicy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReleasePolicy releasePolicy = (ReleasePolicy) o;
    return Objects.equals(this.access, releasePolicy.access) &&
        Objects.equals(this.id, releasePolicy.id) &&
        Objects.equals(this.scope, releasePolicy.scope) &&
        Objects.equals(this.rank, releasePolicy.rank) &&
        Objects.equals(this.releaseMethod, releasePolicy.releaseMethod) &&
        Objects.equals(this.guardedReleaseConfig, releasePolicy.guardedReleaseConfig) &&
        Objects.equals(this.progressiveReleaseConfig, releasePolicy.progressiveReleaseConfig) &&
        Objects.equals(this.name, releasePolicy.name) &&
        Objects.equals(this.key, releasePolicy.key)&&
        Objects.equals(this.additionalProperties, releasePolicy.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(access, id, scope, rank, releaseMethod, guardedReleaseConfig, progressiveReleaseConfig, name, key, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReleasePolicy {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleasePolicy is not found in the empty JSON string", ReleasePolicy.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleasePolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleasePolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleasePolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleasePolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleasePolicy>() {
           @Override
           public void write(JsonWriter out, ReleasePolicy value) throws IOException {
           ...
           @Override
           public ReleasePolicy read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReleasePolicy instance = thisAdapter.fromJsonTree(jsonObj);
