...
public class MetricGroupPost {
  ...
  @javax.annotation.Nonnull
  private List<MetricInMetricGroupInput> metrics = new ArrayList<>();

  public MetricGroupPost() {
  }

  public MetricGroupPost key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public MetricGroupPost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public MetricGroupPost kind(@javax.annotation.Nonnull KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public MetricGroupPost description(@javax.annotation.Nullable String description) {
  ...
  public MetricGroupPost maintainerId(@javax.annotation.Nonnull String maintainerId) {
  ...
  public MetricGroupPost tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }

  public MetricGroupPost addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public MetricGroupPost metrics(@javax.annotation.Nonnull List<MetricInMetricGroupInput> metrics) {
    this.metrics = metrics;
    return this;
  }

  public MetricGroupPost addMetricsItem(MetricInMetricGroupInput metricsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<MetricInMetricGroupInput> getMetrics() {
    return metrics;
  }

  public void setMetrics(@javax.annotation.Nonnull List<MetricInMetricGroupInput> metrics) {
    this.metrics = metrics;
  }
   ...
   * @return the MetricGroupPost instance itself
   */
  public MetricGroupPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MetricGroupPost metricGroupPost = (MetricGroupPost) o;
    return Objects.equals(this.key, metricGroupPost.key) &&
        Objects.equals(this.name, metricGroupPost.name) &&
        Objects.equals(this.kind, metricGroupPost.kind) &&
        Objects.equals(this.description, metricGroupPost.description) &&
        Objects.equals(this.maintainerId, metricGroupPost.maintainerId) &&
        Objects.equals(this.tags, metricGroupPost.tags) &&
        Objects.equals(this.metrics, metricGroupPost.metrics)&&
        Objects.equals(this.additionalProperties, metricGroupPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, kind, description, maintainerId, tags, metrics, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MetricGroupPost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "kind", "description", "maintainerId", "tags", "metrics"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "kind", "maintainerId", "tags", "metrics"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricGroupPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricGroupPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricGroupPost is not found in the empty JSON string", MetricGroupPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetricGroupPost.openapiRequiredFields) {
      ...
      if (!jsonObj.get("maintainerId").isJsonPrimitive()) {
      ...
      for (int i = 0; i < jsonArraymetrics.size(); i++) {
        MetricInMetricGroupInput.validateJsonElement(jsonArraymetrics.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricGroupPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricGroupPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricGroupPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricGroupPost.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricGroupPost>() {
           @Override
           public void write(JsonWriter out, MetricGroupPost value) throws IOException {
           ...
           @Override
           public MetricGroupPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MetricGroupPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MetricGroupPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetricGroupPost
   * @throws IOException if the JSON string is invalid with respect to MetricGroupPost
   */
  public static MetricGroupPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricGroupPost.class);
  }

  /**
   * Convert an instance of MetricGroupPost to an JSON string
   *
   * @return JSON string
   */
