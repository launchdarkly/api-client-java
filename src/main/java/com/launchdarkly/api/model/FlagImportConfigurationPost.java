...
public class FlagImportConfigurationPost {
   ...
   * @return the FlagImportConfigurationPost instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagImportConfigurationPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagImportConfigurationPost is not found in the empty JSON string", FlagImportConfigurationPost.openapiRequiredFields.toString()));
        }
      }
