...
public class FlagLinkMember {
  ...
  public FlagLinkMember links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public FlagLinkMember putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public FlagLinkMember id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public FlagLinkMember firstName(@javax.annotation.Nullable String firstName) {
  ...
  public FlagLinkMember lastName(@javax.annotation.Nullable String lastName) {
   ...
   * @return the FlagLinkMember instance itself
   */
  public FlagLinkMember putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagLinkMember flagLinkMember = (FlagLinkMember) o;
    return Objects.equals(this.links, flagLinkMember.links) &&
        Objects.equals(this.id, flagLinkMember.id) &&
        Objects.equals(this.firstName, flagLinkMember.firstName) &&
        Objects.equals(this.lastName, flagLinkMember.lastName)&&
        Objects.equals(this.additionalProperties, flagLinkMember.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, id, firstName, lastName, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagLinkMember {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "_id", "firstName", "lastName"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_links", "_id"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagLinkMember
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagLinkMember.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagLinkMember is not found in the empty JSON string", FlagLinkMember.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlagLinkMember.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagLinkMember.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagLinkMember' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagLinkMember> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagLinkMember.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagLinkMember>() {
           @Override
           public void write(JsonWriter out, FlagLinkMember value) throws IOException {
           ...
           @Override
           public FlagLinkMember read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagLinkMember instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FlagLinkMember given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlagLinkMember
   * @throws IOException if the JSON string is invalid with respect to FlagLinkMember
   */
  public static FlagLinkMember fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlagLinkMember.class);
  }

  /**
   * Convert an instance of FlagLinkMember to an JSON string
   *
   * @return JSON string
   */
