...
public class IntegrationStatusRep {
   ...
   * @return the IntegrationStatusRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationStatusRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationStatusRep is not found in the empty JSON string", IntegrationStatusRep.openapiRequiredFields.toString()));
        }
      }
