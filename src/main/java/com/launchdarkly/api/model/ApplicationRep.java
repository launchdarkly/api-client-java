...
import com.launchdarkly.api.model.ApplicationMaintainerRep;
...
public class ApplicationRep {
  ...
  @javax.annotation.Nullable
  private ApplicationMaintainerRep maintainer;
  ...
  public ApplicationRep flags(@javax.annotation.Nullable ApplicationFlagCollectionRep flags) {
    this.flags = flags;
    return this;
  }
  ...
  public void setFlags(@javax.annotation.Nullable ApplicationFlagCollectionRep flags) {
    this.flags = flags;
  }


  public ApplicationRep access(@javax.annotation.Nullable Access access) {
    this.access = access;
    return this;
  }
  ...
  public ApplicationRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public ApplicationRep version(@javax.annotation.Nullable Integer version) {
  ...
  public ApplicationRep autoAdded(@javax.annotation.Nonnull Boolean autoAdded) {
  ...
  public void setAutoAdded(@javax.annotation.Nonnull Boolean autoAdded) {
    this.autoAdded = autoAdded;
  }


  public ApplicationRep creationDate(@javax.annotation.Nullable Long creationDate) {
  ...
  public ApplicationRep description(@javax.annotation.Nullable String description) {
  ...
  public ApplicationRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public ApplicationRep kind(@javax.annotation.Nonnull KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ApplicationRep maintainer(@javax.annotation.Nullable ApplicationMaintainerRep maintainer) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationMaintainerRep getMaintainer() {
    return maintainer;
  }

  public void setMaintainer(@javax.annotation.Nullable ApplicationMaintainerRep maintainer) {
    this.maintainer = maintainer;
  }


  public ApplicationRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the ApplicationRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.flags, applicationRep.flags) &&
        Objects.equals(this.access, applicationRep.access) &&
        Objects.equals(this.links, applicationRep.links) &&
        Objects.equals(this.version, applicationRep.version) &&
        Objects.equals(this.autoAdded, applicationRep.autoAdded) &&
        Objects.equals(this.creationDate, applicationRep.creationDate) &&
        Objects.equals(this.description, applicationRep.description) &&
        Objects.equals(this.key, applicationRep.key) &&
        Objects.equals(this.kind, applicationRep.kind) &&
        Objects.equals(this.maintainer, applicationRep.maintainer) &&
        Objects.equals(this.name, applicationRep.name)&&
        Objects.equals(this.additionalProperties, applicationRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(flags, access, links, version, autoAdded, creationDate, description, key, kind, maintainer, name, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("flags", "_access", "_links", "_version", "autoAdded", "creationDate", "description", "key", "kind", "_maintainer", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("autoAdded", "key", "kind", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApplicationRep is not found in the empty JSON string", ApplicationRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicationRep.openapiRequiredFields) {
      ...
      if (jsonObj.get("flags") != null && !jsonObj.get("flags").isJsonNull()) {
        ApplicationFlagCollectionRep.validateJsonElement(jsonObj.get("flags"));
      }
      ...
      if (jsonObj.get("_maintainer") != null && !jsonObj.get("_maintainer").isJsonNull()) {
        ApplicationMaintainerRep.validateJsonElement(jsonObj.get("_maintainer"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationRep>() {
           @Override
           ...
           public ApplicationRep read(JsonReader in) throws IOException {
             ...
             ApplicationRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ApplicationRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationRep
   * @throws IOException if the JSON string is invalid with respect to ApplicationRep
   */
  public static ApplicationRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationRep.class);
  }

  /**
   * Convert an instance of ApplicationRep to an JSON string
   *
   * @return JSON string
   */
