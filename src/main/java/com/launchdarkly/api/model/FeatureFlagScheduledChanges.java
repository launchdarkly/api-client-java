...
public class FeatureFlagScheduledChanges {
  ...
  public FeatureFlagScheduledChanges items(@javax.annotation.Nonnull List<FeatureFlagScheduledChange> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<FeatureFlagScheduledChange> items) {
    this.items = items;
  }


  public FeatureFlagScheduledChanges links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @return the FeatureFlagScheduledChanges instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to FeatureFlagScheduledChanges
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeatureFlagScheduledChanges.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FeatureFlagScheduledChanges is not found in the empty JSON string", FeatureFlagScheduledChanges.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        FeatureFlagScheduledChange.validateJsonElement(jsonArrayitems.get(i));
      };
  }
