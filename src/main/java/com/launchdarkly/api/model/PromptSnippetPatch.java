...
public class PromptSnippetPatch {
  ...
  public PromptSnippetPatch name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PromptSnippetPatch description(@javax.annotation.Nullable String description) {
  ...
  public PromptSnippetPatch text(@javax.annotation.Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public PromptSnippetPatch maintainerId(@javax.annotation.Nullable String maintainerId) {
  ...
  public PromptSnippetPatch maintainerTeamKey(@javax.annotation.Nullable String maintainerTeamKey) {
  ...
  public PromptSnippetPatch tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PromptSnippetPatch addTagsItem(String tagsItem) {
    if (this.tags == null) {
   ...
   * @return the PromptSnippetPatch instance itself
   */
  public PromptSnippetPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PromptSnippetPatch promptSnippetPatch = (PromptSnippetPatch) o;
    return Objects.equals(this.name, promptSnippetPatch.name) &&
        Objects.equals(this.description, promptSnippetPatch.description) &&
        Objects.equals(this.text, promptSnippetPatch.text) &&
        Objects.equals(this.maintainerId, promptSnippetPatch.maintainerId) &&
        Objects.equals(this.maintainerTeamKey, promptSnippetPatch.maintainerTeamKey) &&
        Objects.equals(this.tags, promptSnippetPatch.tags)&&
        Objects.equals(this.additionalProperties, promptSnippetPatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, text, maintainerId, maintainerTeamKey, tags, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PromptSnippetPatch {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "text", "maintainerId", "maintainerTeamKey", "tags"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromptSnippetPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromptSnippetPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PromptSnippetPatch is not found in the empty JSON string", PromptSnippetPatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromptSnippetPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromptSnippetPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromptSnippetPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromptSnippetPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<PromptSnippetPatch>() {
           @Override
           public void write(JsonWriter out, PromptSnippetPatch value) throws IOException {
           ...
           @Override
           public PromptSnippetPatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PromptSnippetPatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PromptSnippetPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromptSnippetPatch
   * @throws IOException if the JSON string is invalid with respect to PromptSnippetPatch
   */
  public static PromptSnippetPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromptSnippetPatch.class);
  }

  /**
   * Convert an instance of PromptSnippetPatch to an JSON string
   *
   * @return JSON string
   */
