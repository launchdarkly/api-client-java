...
public class ValuePut {
  ...
  public ValuePut setting(@javax.annotation.Nullable Object setting) {
  ...
  public ValuePut comment(@javax.annotation.Nullable String comment) {
   ...
   * @return the ValuePut instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("setting", "comment"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuePut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuePut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ValuePut is not found in the empty JSON string", ValuePut.openapiRequiredFields.toString()));
        }
      }
