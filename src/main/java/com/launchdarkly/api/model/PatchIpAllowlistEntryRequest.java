...
public class PatchIpAllowlistEntryRequest {
  ...
  public PatchIpAllowlistEntryRequest description(@javax.annotation.Nonnull String description) {
   ...
   * @return the PatchIpAllowlistEntryRequest instance itself
   */
  public PatchIpAllowlistEntryRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PatchIpAllowlistEntryRequest patchIpAllowlistEntryRequest = (PatchIpAllowlistEntryRequest) o;
    return Objects.equals(this.description, patchIpAllowlistEntryRequest.description)&&
        Objects.equals(this.additionalProperties, patchIpAllowlistEntryRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchIpAllowlistEntryRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("description"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchIpAllowlistEntryRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchIpAllowlistEntryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PatchIpAllowlistEntryRequest is not found in the empty JSON string", PatchIpAllowlistEntryRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatchIpAllowlistEntryRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchIpAllowlistEntryRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchIpAllowlistEntryRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchIpAllowlistEntryRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchIpAllowlistEntryRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchIpAllowlistEntryRequest>() {
           @Override
           public void write(JsonWriter out, PatchIpAllowlistEntryRequest value) throws IOException {
           ...
           @Override
           public PatchIpAllowlistEntryRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PatchIpAllowlistEntryRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PatchIpAllowlistEntryRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchIpAllowlistEntryRequest
   * @throws IOException if the JSON string is invalid with respect to PatchIpAllowlistEntryRequest
   */
  public static PatchIpAllowlistEntryRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchIpAllowlistEntryRequest.class);
  }

  /**
   * Convert an instance of PatchIpAllowlistEntryRequest to an JSON string
   *
   * @return JSON string
   */
