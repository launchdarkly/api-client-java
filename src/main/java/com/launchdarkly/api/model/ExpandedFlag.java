...
public class ExpandedFlag {
  ...
  public ExpandedFlag addTagsItem(String tagsItem) {
    if (this.tags == null) {
   ...
   * @return the ExpandedFlag instance itself
   */
  public ExpandedFlag putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandedFlag expandedFlag = (ExpandedFlag) o;
    return Objects.equals(this.key, expandedFlag.key) &&
        Objects.equals(this.name, expandedFlag.name) &&
        Objects.equals(this.description, expandedFlag.description) &&
        Objects.equals(this.creationDate, expandedFlag.creationDate) &&
        Objects.equals(this.version, expandedFlag.version) &&
        Objects.equals(this.archived, expandedFlag.archived) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandedFlag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandedFlag is not found in the empty JSON string", ExpandedFlag.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandedFlag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandedFlag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandedFlag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandedFlag.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandedFlag>() {
           @Override
           public void write(JsonWriter out, ExpandedFlag value) throws IOException {
           ...
           @Override
           public ExpandedFlag read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExpandedFlag instance = thisAdapter.fromJsonTree(jsonObj);
