...
public class GuardedReleaseConfig {
   ...
   * @return the GuardedReleaseConfig instance itself
   */
  public GuardedReleaseConfig putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GuardedReleaseConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GuardedReleaseConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GuardedReleaseConfig is not found in the empty JSON string", GuardedReleaseConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("metricKeys") != null && !jsonObj.get("metricKeys").isJsonNull() && !jsonObj.get("metricKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `metricKeys` to be an array in the JSON string but got `%s`", jsonObj.get("metricKeys").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("metricGroupKeys") != null && !jsonObj.get("metricGroupKeys").isJsonNull() && !jsonObj.get("metricGroupKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `metricGroupKeys` to be an array in the JSON string but got `%s`", jsonObj.get("metricGroupKeys").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GuardedReleaseConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GuardedReleaseConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GuardedReleaseConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GuardedReleaseConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GuardedReleaseConfig>() {
           @Override
           public void write(JsonWriter out, GuardedReleaseConfig value) throws IOException {
           ...
           @Override
           public GuardedReleaseConfig read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             GuardedReleaseConfig instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of GuardedReleaseConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GuardedReleaseConfig
   * @throws IOException if the JSON string is invalid with respect to GuardedReleaseConfig
   */
  public static GuardedReleaseConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GuardedReleaseConfig.class);
  }

  /**
   * Convert an instance of GuardedReleaseConfig to an JSON string
   *
   * @return JSON string
   */
