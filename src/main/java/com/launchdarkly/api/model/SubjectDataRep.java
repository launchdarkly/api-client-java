...
public class SubjectDataRep {
  ...
  public SubjectDataRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public SubjectDataRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public SubjectDataRep name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public SubjectDataRep avatarUrl(@javax.annotation.Nullable String avatarUrl) {
   ...
   * @return the SubjectDataRep instance itself
   */
  public SubjectDataRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SubjectDataRep subjectDataRep = (SubjectDataRep) o;
    return Objects.equals(this.links, subjectDataRep.links) &&
        Objects.equals(this.name, subjectDataRep.name) &&
        Objects.equals(this.avatarUrl, subjectDataRep.avatarUrl)&&
        Objects.equals(this.additionalProperties, subjectDataRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, name, avatarUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubjectDataRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "name", "avatarUrl"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubjectDataRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubjectDataRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SubjectDataRep is not found in the empty JSON string", SubjectDataRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubjectDataRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubjectDataRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubjectDataRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubjectDataRep.class));

       return (TypeAdapter<T>) new TypeAdapter<SubjectDataRep>() {
           @Override
           public void write(JsonWriter out, SubjectDataRep value) throws IOException {
           ...
           @Override
           public SubjectDataRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SubjectDataRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SubjectDataRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubjectDataRep
   * @throws IOException if the JSON string is invalid with respect to SubjectDataRep
   */
  public static SubjectDataRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubjectDataRep.class);
  }

  /**
   * Convert an instance of SubjectDataRep to an JSON string
   *
   * @return JSON string
   */
