...
import com.launchdarkly.api.model.DynamicOptionsParser;
import com.launchdarkly.api.model.Endpoint;
...
public class DynamicOptions {
   ...
   * @return the DynamicOptions instance itself
   */
  public DynamicOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DynamicOptions dynamicOptions = (DynamicOptions) o;
    return Objects.equals(this.endpoint, dynamicOptions.endpoint) &&
        Objects.equals(this.parser, dynamicOptions.parser)&&
        Objects.equals(this.additionalProperties, dynamicOptions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endpoint, parser, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DynamicOptions {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicOptions is not found in the empty JSON string", DynamicOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `parser`
      if (jsonObj.get("parser") != null && !jsonObj.get("parser").isJsonNull()) {
        DynamicOptionsParser.validateJsonElement(jsonObj.get("parser"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicOptions>() {
           @Override
           public void write(JsonWriter out, DynamicOptions value) throws IOException {
           ...
           @Override
           public DynamicOptions read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DynamicOptions instance = thisAdapter.fromJsonTree(jsonObj);
