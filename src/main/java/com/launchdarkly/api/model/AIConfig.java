...
public class AIConfig {
  ...
  public AIConfig evaluationMetricKey(@javax.annotation.Nullable String evaluationMetricKey) {
  ...
  public AIConfig isInverted(@javax.annotation.Nullable Boolean isInverted) {
   ...
   * @return the AIConfig instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.access, aiConfig.access) &&
        Objects.equals(this.links, aiConfig.links) &&
        Objects.equals(this.description, aiConfig.description) &&
        Objects.equals(this.key, aiConfig.key) &&
        Objects.equals(this.maintainer, aiConfig.maintainer) &&
        Objects.equals(this.mode, aiConfig.mode) &&
        Objects.equals(this.name, aiConfig.name) &&
        Objects.equals(this.tags, aiConfig.tags) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfig is not found in the empty JSON string", AIConfig.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfig>() {
           @Override
           ...
           public AIConfig read(JsonReader in) throws IOException {
             ...
             AIConfig instance = thisAdapter.fromJsonTree(jsonObj);
