...
public class TargetResourceRep {
  ...
  public TargetResourceRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public TargetResourceRep name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetResourceRep resources(@javax.annotation.Nullable List<String> resources) {
   ...
   * @return the TargetResourceRep instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "name", "resources"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetResourceRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetResourceRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetResourceRep is not found in the empty JSON string", TargetResourceRep.openapiRequiredFields.toString()));
        }
      }
