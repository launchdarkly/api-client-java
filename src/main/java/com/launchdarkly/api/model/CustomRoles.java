...
public class CustomRoles {
  ...
  private List<CustomRole> items = new ArrayList<>();
  ...
  public CustomRoles links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public CustomRoles putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public CustomRoles items(@javax.annotation.Nonnull List<CustomRole> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<CustomRole> items) {
    this.items = items;
  }


  public CustomRoles totalCount(@javax.annotation.Nullable Integer totalCount) {
   ...
   * @return the CustomRoles instance itself
   */
  public CustomRoles putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, customRoles.links) &&
        ...
        Objects.equals(this.totalCount, customRoles.totalCount)&&
        Objects.equals(this.additionalProperties, customRoles.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomRoles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomRoles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomRoles is not found in the empty JSON string", CustomRoles.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomRoles.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        CustomRole.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomRoles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomRoles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomRoles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomRoles.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomRoles>() {
           @Override
           public void write(JsonWriter out, CustomRoles value) throws IOException {
           ...
           @Override
           public CustomRoles read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CustomRoles instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CustomRoles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomRoles
   * @throws IOException if the JSON string is invalid with respect to CustomRoles
   */
  public static CustomRoles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomRoles.class);
  }

  /**
   * Convert an instance of CustomRoles to an JSON string
   *
   * @return JSON string
   */
