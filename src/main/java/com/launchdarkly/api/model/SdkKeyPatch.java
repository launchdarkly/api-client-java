...
public class SdkKeyPatch {
  ...
  public SdkKeyPatch name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public SdkKeyPatch description(@javax.annotation.Nullable String description) {
  ...
  public SdkKeyPatch expiry(@javax.annotation.Nullable Long expiry) {
    this.expiry = expiry;
    return this;
  }
   ...
   * @return the SdkKeyPatch instance itself
   */
  public SdkKeyPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SdkKeyPatch sdkKeyPatch = (SdkKeyPatch) o;
    return Objects.equals(this.name, sdkKeyPatch.name) &&
        Objects.equals(this.description, sdkKeyPatch.description) &&
        Objects.equals(this.expiry, sdkKeyPatch.expiry)&&
        Objects.equals(this.additionalProperties, sdkKeyPatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, expiry, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SdkKeyPatch {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "expiry"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SdkKeyPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SdkKeyPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SdkKeyPatch is not found in the empty JSON string", SdkKeyPatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SdkKeyPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SdkKeyPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SdkKeyPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SdkKeyPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<SdkKeyPatch>() {
           @Override
           public void write(JsonWriter out, SdkKeyPatch value) throws IOException {
           ...
           @Override
           public SdkKeyPatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SdkKeyPatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SdkKeyPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SdkKeyPatch
   * @throws IOException if the JSON string is invalid with respect to SdkKeyPatch
   */
  public static SdkKeyPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SdkKeyPatch.class);
  }

  /**
   * Convert an instance of SdkKeyPatch to an JSON string
   *
   * @return JSON string
   */
