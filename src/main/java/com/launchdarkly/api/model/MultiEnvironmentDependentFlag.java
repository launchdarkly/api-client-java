...
public class MultiEnvironmentDependentFlag {
  ...
  @javax.annotation.Nonnull
  private List<DependentFlagEnvironment> environments = new ArrayList<>();

  public MultiEnvironmentDependentFlag() {
  }

  public MultiEnvironmentDependentFlag name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MultiEnvironmentDependentFlag key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public MultiEnvironmentDependentFlag environments(@javax.annotation.Nonnull List<DependentFlagEnvironment> environments) {
  ...
  public void setEnvironments(@javax.annotation.Nonnull List<DependentFlagEnvironment> environments) {
    this.environments = environments;
  }
   ...
   * @return the MultiEnvironmentDependentFlag instance itself
   */
  public MultiEnvironmentDependentFlag putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, multiEnvironmentDependentFlag.name) &&
        ...
        Objects.equals(this.additionalProperties, multiEnvironmentDependentFlag.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, key, environments, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "key", "environments"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "environments"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MultiEnvironmentDependentFlag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MultiEnvironmentDependentFlag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MultiEnvironmentDependentFlag is not found in the empty JSON string", MultiEnvironmentDependentFlag.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MultiEnvironmentDependentFlag.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayenvironments.size(); i++) {
        DependentFlagEnvironment.validateJsonElement(jsonArrayenvironments.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MultiEnvironmentDependentFlag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MultiEnvironmentDependentFlag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MultiEnvironmentDependentFlag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MultiEnvironmentDependentFlag.class));

       return (TypeAdapter<T>) new TypeAdapter<MultiEnvironmentDependentFlag>() {
           @Override
           public void write(JsonWriter out, MultiEnvironmentDependentFlag value) throws IOException {
           ...
           @Override
           public MultiEnvironmentDependentFlag read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MultiEnvironmentDependentFlag instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MultiEnvironmentDependentFlag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MultiEnvironmentDependentFlag
   * @throws IOException if the JSON string is invalid with respect to MultiEnvironmentDependentFlag
   */
  public static MultiEnvironmentDependentFlag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MultiEnvironmentDependentFlag.class);
  }

  /**
   * Convert an instance of MultiEnvironmentDependentFlag to an JSON string
   *
   * @return JSON string
   */
