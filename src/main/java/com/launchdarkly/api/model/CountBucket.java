...
public class CountBucket {
  ...
  public CountBucket timestamp(@javax.annotation.Nonnull Long timestamp) {
  ...
  public CountBucket count(@javax.annotation.Nonnull Long count) {
    this.count = count;
    return this;
  }
   ...
   * @return the CountBucket instance itself
   */
  public CountBucket putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timestamp, countBucket.timestamp) &&
        Objects.equals(this.count, countBucket.count)&&
        Objects.equals(this.additionalProperties, countBucket.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, count, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("timestamp", "count"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("timestamp", "count"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CountBucket
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CountBucket.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CountBucket is not found in the empty JSON string", CountBucket.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CountBucket.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CountBucket.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CountBucket' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CountBucket> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CountBucket.class));

       return (TypeAdapter<T>) new TypeAdapter<CountBucket>() {
           @Override
           public void write(JsonWriter out, CountBucket value) throws IOException {
           ...
           @Override
           public CountBucket read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CountBucket instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CountBucket given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CountBucket
   * @throws IOException if the JSON string is invalid with respect to CountBucket
   */
  public static CountBucket fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CountBucket.class);
  }

  /**
   * Convert an instance of CountBucket to an JSON string
   *
   * @return JSON string
   */
