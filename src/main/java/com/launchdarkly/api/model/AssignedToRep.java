...
public class AssignedToRep {
   ...
   * @return the AssignedToRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssignedToRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AssignedToRep is not found in the empty JSON string", AssignedToRep.openapiRequiredFields.toString()));
        }
      }
