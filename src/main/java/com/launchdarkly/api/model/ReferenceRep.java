...
public class ReferenceRep {
   ...
   * @return the ReferenceRep instance itself
   */
  public ReferenceRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReferenceRep referenceRep = (ReferenceRep) o;
    return Objects.equals(this.path, referenceRep.path) &&
        Objects.equals(this.hint, referenceRep.hint) &&
        Objects.equals(this.hunks, referenceRep.hunks)&&
        Objects.equals(this.additionalProperties, referenceRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(path, hint, hunks, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReferenceRep {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReferenceRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReferenceRep is not found in the empty JSON string", ReferenceRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("hunks").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hunks` to be an array in the JSON string but got `%s`", jsonObj.get("hunks").toString()));
      }

      JsonArray jsonArrayhunks = jsonObj.getAsJsonArray("hunks");
      // validate the required field `hunks` (array)
      for (int i = 0; i < jsonArrayhunks.size(); i++) {
        HunkRep.validateJsonElement(jsonArrayhunks.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReferenceRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReferenceRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReferenceRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReferenceRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ReferenceRep>() {
           @Override
           public void write(JsonWriter out, ReferenceRep value) throws IOException {
           ...
           @Override
           public ReferenceRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReferenceRep instance = thisAdapter.fromJsonTree(jsonObj);
