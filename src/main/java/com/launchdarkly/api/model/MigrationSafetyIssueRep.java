...
public class MigrationSafetyIssueRep {
   ...
   * @return the MigrationSafetyIssueRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MigrationSafetyIssueRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MigrationSafetyIssueRep is not found in the empty JSON string", MigrationSafetyIssueRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("causingRuleId") != null && !jsonObj.get("causingRuleId").isJsonNull()) && !jsonObj.get("causingRuleId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `causingRuleId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("causingRuleId").toString()));
      }
      ...
      if (jsonObj.get("affectedRuleIds") != null && !jsonObj.get("affectedRuleIds").isJsonNull() && !jsonObj.get("affectedRuleIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `affectedRuleIds` to be an array in the JSON string but got `%s`", jsonObj.get("affectedRuleIds").toString()));
      }
