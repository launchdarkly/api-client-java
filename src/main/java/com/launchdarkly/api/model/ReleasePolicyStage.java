...
public class ReleasePolicyStage {
  ...
  public ReleasePolicyStage allocation(@javax.annotation.Nonnull Integer allocation) {
  ...
  public ReleasePolicyStage durationMillis(@javax.annotation.Nonnull Long durationMillis) {
  ...
  public void setDurationMillis(@javax.annotation.Nonnull Long durationMillis) {
    this.durationMillis = durationMillis;
  }
   ...
   * @return the ReleasePolicyStage instance itself
   */
  public ReleasePolicyStage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReleasePolicyStage releasePolicyStage = (ReleasePolicyStage) o;
    return Objects.equals(this.allocation, releasePolicyStage.allocation) &&
        Objects.equals(this.durationMillis, releasePolicyStage.durationMillis)&&
        Objects.equals(this.additionalProperties, releasePolicyStage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allocation, durationMillis, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReleasePolicyStage {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("allocation", "durationMillis"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("allocation", "durationMillis"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReleasePolicyStage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleasePolicyStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleasePolicyStage is not found in the empty JSON string", ReleasePolicyStage.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReleasePolicyStage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleasePolicyStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleasePolicyStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleasePolicyStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleasePolicyStage.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleasePolicyStage>() {
           @Override
           public void write(JsonWriter out, ReleasePolicyStage value) throws IOException {
           ...
           @Override
           public ReleasePolicyStage read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReleasePolicyStage instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ReleasePolicyStage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReleasePolicyStage
   * @throws IOException if the JSON string is invalid with respect to ReleasePolicyStage
   */
  public static ReleasePolicyStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReleasePolicyStage.class);
  }

  /**
   * Convert an instance of ReleasePolicyStage to an JSON string
   *
   * @return JSON string
   */
