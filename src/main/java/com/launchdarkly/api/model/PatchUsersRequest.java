...
public class PatchUsersRequest {
  ...
  public PatchUsersRequest comment(@javax.annotation.Nullable String comment) {
  ...
  public PatchUsersRequest instructions(@javax.annotation.Nonnull List<InstructionUserRequest> instructions) {
  ...
  public void setInstructions(@javax.annotation.Nonnull List<InstructionUserRequest> instructions) {
    this.instructions = instructions;
  }
   ...
   * @return the PatchUsersRequest instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchUsersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchUsersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PatchUsersRequest is not found in the empty JSON string", PatchUsersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayinstructions.size(); i++) {
        InstructionUserRequest.validateJsonElement(jsonArrayinstructions.get(i));
      };
  }
