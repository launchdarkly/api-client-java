...
public class UpsertFlagDefaultsPayload {
   ...
   * @return the UpsertFlagDefaultsPayload instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertFlagDefaultsPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpsertFlagDefaultsPayload is not found in the empty JSON string", UpsertFlagDefaultsPayload.openapiRequiredFields.toString()));
        }
      }
