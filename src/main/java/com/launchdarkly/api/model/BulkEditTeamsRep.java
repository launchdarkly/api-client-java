...
public class BulkEditTeamsRep {
   ...
   * @return the BulkEditTeamsRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkEditTeamsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkEditTeamsRep is not found in the empty JSON string", BulkEditTeamsRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("teamKeys") != null && !jsonObj.get("teamKeys").isJsonNull() && !jsonObj.get("teamKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `teamKeys` to be an array in the JSON string but got `%s`", jsonObj.get("teamKeys").toString()));
      }
      // ensure the optional json data is an array if present
