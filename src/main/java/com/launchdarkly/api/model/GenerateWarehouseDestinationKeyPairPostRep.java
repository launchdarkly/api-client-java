...
public class GenerateWarehouseDestinationKeyPairPostRep {
   ...
   * @return the GenerateWarehouseDestinationKeyPairPostRep instance itself
   */
  public GenerateWarehouseDestinationKeyPairPostRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateWarehouseDestinationKeyPairPostRep generateWarehouseDestinationKeyPairPostRep = (GenerateWarehouseDestinationKeyPairPostRep) o;
    return Objects.equals(this.publicKey, generateWarehouseDestinationKeyPairPostRep.publicKey) &&
        Objects.equals(this.publicKeyPkcs8, generateWarehouseDestinationKeyPairPostRep.publicKeyPkcs8)&&
        Objects.equals(this.additionalProperties, generateWarehouseDestinationKeyPairPostRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publicKey, publicKeyPkcs8, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenerateWarehouseDestinationKeyPairPostRep {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateWarehouseDestinationKeyPairPostRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GenerateWarehouseDestinationKeyPairPostRep is not found in the empty JSON string", GenerateWarehouseDestinationKeyPairPostRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("public_key_pkcs8") != null && !jsonObj.get("public_key_pkcs8").isJsonNull()) && !jsonObj.get("public_key_pkcs8").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `public_key_pkcs8` to be a primitive type in the JSON string but got `%s`", jsonObj.get("public_key_pkcs8").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateWarehouseDestinationKeyPairPostRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateWarehouseDestinationKeyPairPostRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateWarehouseDestinationKeyPairPostRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateWarehouseDestinationKeyPairPostRep.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateWarehouseDestinationKeyPairPostRep>() {
           @Override
           public void write(JsonWriter out, GenerateWarehouseDestinationKeyPairPostRep value) throws IOException {
           ...
           @Override
           public GenerateWarehouseDestinationKeyPairPostRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             GenerateWarehouseDestinationKeyPairPostRep instance = thisAdapter.fromJsonTree(jsonObj);
