...
public class PostApprovalRequestReviewRequest {
   ...
   * @return the PostApprovalRequestReviewRequest instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostApprovalRequestReviewRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostApprovalRequestReviewRequest is not found in the empty JSON string", PostApprovalRequestReviewRequest.openapiRequiredFields.toString()));
        }
      }
