...
public class ExperimentAllocationRep {
   ...
   * @return the ExperimentAllocationRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExperimentAllocationRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExperimentAllocationRep is not found in the empty JSON string", ExperimentAllocationRep.openapiRequiredFields.toString()));
        }
      }
