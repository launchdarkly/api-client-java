...
public class MemberTeamsPostInput {
   ...
   * @return the MemberTeamsPostInput instance itself
   */
  public MemberTeamsPostInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.teamKeys, memberTeamsPostInput.teamKeys)&&
        Objects.equals(this.additionalProperties, memberTeamsPostInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(teamKeys, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MemberTeamsPostInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MemberTeamsPostInput is not found in the empty JSON string", MemberTeamsPostInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberTeamsPostInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberTeamsPostInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberTeamsPostInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberTeamsPostInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberTeamsPostInput>() {
           @Override
           public void write(JsonWriter out, MemberTeamsPostInput value) throws IOException {
           ...
           @Override
           public MemberTeamsPostInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MemberTeamsPostInput instance = thisAdapter.fromJsonTree(jsonObj);
