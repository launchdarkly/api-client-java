...
public class LegacyExperimentRep {
   ...
   * @return the LegacyExperimentRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LegacyExperimentRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LegacyExperimentRep is not found in the empty JSON string", LegacyExperimentRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("_metric") != null && !jsonObj.get("_metric").isJsonNull()) {
        MetricListingRep.validateJsonElement(jsonObj.get("_metric"));
      }
