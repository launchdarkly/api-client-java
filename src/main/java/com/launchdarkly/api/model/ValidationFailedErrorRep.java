...
public class ValidationFailedErrorRep {
  ...
  @javax.annotation.Nonnull
  private List<FailureReasonRep> errors = new ArrayList<>();

  public ValidationFailedErrorRep() {
  }

  public ValidationFailedErrorRep code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public ValidationFailedErrorRep message(@javax.annotation.Nonnull String message) {
  ...
  public ValidationFailedErrorRep errors(@javax.annotation.Nonnull List<FailureReasonRep> errors) {
    this.errors = errors;
    return this;
  }

  public ValidationFailedErrorRep addErrorsItem(FailureReasonRep errorsItem) {
    if (this.errors == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<FailureReasonRep> getErrors() {
    return errors;
  }

  public void setErrors(@javax.annotation.Nonnull List<FailureReasonRep> errors) {
    this.errors = errors;
  }
   ...
   * @return the ValidationFailedErrorRep instance itself
   */
  public ValidationFailedErrorRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ValidationFailedErrorRep validationFailedErrorRep = (ValidationFailedErrorRep) o;
    return Objects.equals(this.code, validationFailedErrorRep.code) &&
        Objects.equals(this.message, validationFailedErrorRep.message) &&
        Objects.equals(this.errors, validationFailedErrorRep.errors)&&
        Objects.equals(this.additionalProperties, validationFailedErrorRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, message, errors, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValidationFailedErrorRep {\n");
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("code", "message", "errors"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValidationFailedErrorRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidationFailedErrorRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ValidationFailedErrorRep is not found in the empty JSON string", ValidationFailedErrorRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ValidationFailedErrorRep.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayerrors.size(); i++) {
        FailureReasonRep.validateJsonElement(jsonArrayerrors.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidationFailedErrorRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidationFailedErrorRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidationFailedErrorRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidationFailedErrorRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidationFailedErrorRep>() {
           @Override
           public void write(JsonWriter out, ValidationFailedErrorRep value) throws IOException {
           ...
           @Override
           public ValidationFailedErrorRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ValidationFailedErrorRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ValidationFailedErrorRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValidationFailedErrorRep
   * @throws IOException if the JSON string is invalid with respect to ValidationFailedErrorRep
   */
  public static ValidationFailedErrorRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidationFailedErrorRep.class);
  }

  /**
   * Convert an instance of ValidationFailedErrorRep to an JSON string
   *
   * @return JSON string
   */
