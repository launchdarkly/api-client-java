...
public class FlagConfigEvaluation {
  ...
  public FlagConfigEvaluation addContextKindsItem(String contextKindsItem) {
    if (this.contextKinds == null) {
      this.contextKinds = new ArrayList<>();
    }
    this.contextKinds.add(contextKindsItem);
    return this;
  }
   ...
   * @return the FlagConfigEvaluation instance itself
   */
  public FlagConfigEvaluation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagConfigEvaluation flagConfigEvaluation = (FlagConfigEvaluation) o;
    return Objects.equals(this.contextKinds, flagConfigEvaluation.contextKinds)&&
        Objects.equals(this.additionalProperties, flagConfigEvaluation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contextKinds, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlagConfigEvaluation {\n");
    sb.append("    contextKinds: ").append(toIndentedString(contextKinds)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagConfigEvaluation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagConfigEvaluation is not found in the empty JSON string", FlagConfigEvaluation.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("contextKinds") != null && !jsonObj.get("contextKinds").isJsonNull() && !jsonObj.get("contextKinds").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `contextKinds` to be an array in the JSON string but got `%s`", jsonObj.get("contextKinds").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagConfigEvaluation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagConfigEvaluation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagConfigEvaluation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagConfigEvaluation.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagConfigEvaluation>() {
           @Override
           public void write(JsonWriter out, FlagConfigEvaluation value) throws IOException {
           ...
           @Override
           public FlagConfigEvaluation read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagConfigEvaluation instance = thisAdapter.fromJsonTree(jsonObj);
