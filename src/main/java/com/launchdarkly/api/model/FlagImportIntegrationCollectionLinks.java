...
public class FlagImportIntegrationCollectionLinks {
   ...
   * @return the FlagImportIntegrationCollectionLinks instance itself
   */
  public FlagImportIntegrationCollectionLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagImportIntegrationCollectionLinks flagImportIntegrationCollectionLinks = (FlagImportIntegrationCollectionLinks) o;
    return Objects.equals(this.self, flagImportIntegrationCollectionLinks.self) &&
        Objects.equals(this.parent, flagImportIntegrationCollectionLinks.parent)&&
        Objects.equals(this.additionalProperties, flagImportIntegrationCollectionLinks.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FlagImportIntegrationCollectionLinks {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagImportIntegrationCollectionLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagImportIntegrationCollectionLinks is not found in the empty JSON string", FlagImportIntegrationCollectionLinks.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagImportIntegrationCollectionLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagImportIntegrationCollectionLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagImportIntegrationCollectionLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagImportIntegrationCollectionLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagImportIntegrationCollectionLinks>() {
           @Override
           public void write(JsonWriter out, FlagImportIntegrationCollectionLinks value) throws IOException {
           ...
           @Override
           public FlagImportIntegrationCollectionLinks read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagImportIntegrationCollectionLinks instance = thisAdapter.fromJsonTree(jsonObj);
