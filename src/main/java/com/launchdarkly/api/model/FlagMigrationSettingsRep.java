...
public class FlagMigrationSettingsRep {
   ...
   * @return the FlagMigrationSettingsRep instance itself
   */
  public FlagMigrationSettingsRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagMigrationSettingsRep flagMigrationSettingsRep = (FlagMigrationSettingsRep) o;
    return Objects.equals(this.contextKind, flagMigrationSettingsRep.contextKind) &&
        Objects.equals(this.stageCount, flagMigrationSettingsRep.stageCount)&&
        Objects.equals(this.additionalProperties, flagMigrationSettingsRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FlagMigrationSettingsRep {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagMigrationSettingsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagMigrationSettingsRep is not found in the empty JSON string", FlagMigrationSettingsRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagMigrationSettingsRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagMigrationSettingsRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagMigrationSettingsRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagMigrationSettingsRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagMigrationSettingsRep>() {
           @Override
           public void write(JsonWriter out, FlagMigrationSettingsRep value) throws IOException {
           ...
           @Override
           public FlagMigrationSettingsRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagMigrationSettingsRep instance = thisAdapter.fromJsonTree(jsonObj);
