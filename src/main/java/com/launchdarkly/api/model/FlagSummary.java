...
public class FlagSummary {
   ...
   * @return the FlagSummary instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagSummary is not found in the empty JSON string", FlagSummary.openapiRequiredFields.toString()));
        }
      }
