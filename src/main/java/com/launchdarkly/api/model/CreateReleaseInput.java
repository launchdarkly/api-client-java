...
public class CreateReleaseInput {
  public static final String SERIALIZED_NAME_RELEASE_VARIATION_ID = "releaseVariationId";
  ...
  public CreateReleaseInput releaseVariationId(@javax.annotation.Nullable String releaseVariationId) {
  ...
  public CreateReleaseInput releasePipelineKey(@javax.annotation.Nonnull String releasePipelineKey) {
   ...
   * @return the CreateReleaseInput instance itself
   */
  public CreateReleaseInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateReleaseInput createReleaseInput = (CreateReleaseInput) o;
    return Objects.equals(this.releaseVariationId, createReleaseInput.releaseVariationId) &&
        Objects.equals(this.releasePipelineKey, createReleaseInput.releasePipelineKey)&&
        Objects.equals(this.additionalProperties, createReleaseInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(releaseVariationId, releasePipelineKey, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateReleaseInput {\n");
    sb.append("    releaseVariationId: ").append(toIndentedString(releaseVariationId)).append("\n");
    sb.append("    releasePipelineKey: ").append(toIndentedString(releasePipelineKey)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("releaseVariationId", "releasePipelineKey"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("releasePipelineKey"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateReleaseInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateReleaseInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateReleaseInput is not found in the empty JSON string", CreateReleaseInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateReleaseInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("releaseVariationId") != null && !jsonObj.get("releaseVariationId").isJsonNull()) && !jsonObj.get("releaseVariationId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `releaseVariationId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("releaseVariationId").toString()));
      }
      if (!jsonObj.get("releasePipelineKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `releasePipelineKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("releasePipelineKey").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateReleaseInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateReleaseInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateReleaseInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateReleaseInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateReleaseInput>() {
           @Override
           public void write(JsonWriter out, CreateReleaseInput value) throws IOException {
           ...
           @Override
           public CreateReleaseInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateReleaseInput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateReleaseInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateReleaseInput
   * @throws IOException if the JSON string is invalid with respect to CreateReleaseInput
   */
  public static CreateReleaseInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateReleaseInput.class);
  }

  /**
   * Convert an instance of CreateReleaseInput to an JSON string
   *
   * @return JSON string
   */
