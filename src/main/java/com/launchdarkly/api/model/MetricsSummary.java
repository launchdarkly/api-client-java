...
public class MetricsSummary {
  ...
  public MetricsSummary count(@javax.annotation.Nonnull Integer count) {
    this.count = count;
    return this;
  }
   ...
   * @return the MetricsSummary instance itself
   */
  public MetricsSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, metricsSummary.count)&&
        Objects.equals(this.additionalProperties, metricsSummary.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricsSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricsSummary is not found in the empty JSON string", MetricsSummary.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetricsSummary.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetricsSummary>() {
           ...
           public MetricsSummary read(JsonReader in) throws IOException {
             ...
             MetricsSummary instance = thisAdapter.fromJsonTree(jsonObj);
