...
public class CreateAnnouncementBody {
   ...
   * @return the CreateAnnouncementBody instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAnnouncementBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAnnouncementBody is not found in the empty JSON string", CreateAnnouncementBody.openapiRequiredFields.toString()));
        }
      }
