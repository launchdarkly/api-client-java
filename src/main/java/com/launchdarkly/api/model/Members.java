...
public class Members {
  ...
  public Members items(@javax.annotation.Nonnull List<Member> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<Member> items) {
    this.items = items;
  }


  public Members links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public Members putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public Members totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Members.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Members is not found in the empty JSON string", Members.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        Member.validateJsonElement(jsonArrayitems.get(i));
      };
  }
