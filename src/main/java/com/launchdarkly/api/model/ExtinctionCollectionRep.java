...
public class ExtinctionCollectionRep {
   ...
   * @return the ExtinctionCollectionRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtinctionCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExtinctionCollectionRep is not found in the empty JSON string", ExtinctionCollectionRep.openapiRequiredFields.toString()));
        }
      }
