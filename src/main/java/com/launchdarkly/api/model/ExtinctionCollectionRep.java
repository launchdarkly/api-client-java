...
public class ExtinctionCollectionRep {
  ...
  private Map<String, List<ExtinctionRep>> items = new HashMap<String, List<ExtinctionRep>>();
  ...
  **/
  ...
  public ExtinctionCollectionRep items(Map<String, List<ExtinctionRep>> items) {
    
    this.items = items;
    return this;
  }

  public ExtinctionCollectionRep putItemsItem(String key, List<ExtinctionRep> itemsItem) {
  ...
  **/
  ...
  public void setItems(Map<String, List<ExtinctionRep>> items) {
    this.items = items;
  }
