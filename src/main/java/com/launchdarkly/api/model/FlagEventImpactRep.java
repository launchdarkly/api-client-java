...
public class FlagEventImpactRep {
   ...
   * @return the FlagEventImpactRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.size, flagEventImpactRep.size) &&
        Objects.equals(this.percentage, flagEventImpactRep.percentage) &&
        Objects.equals(this.reason, flagEventImpactRep.reason) &&
        Objects.equals(this.evaluationsSummary, flagEventImpactRep.evaluationsSummary)&&
        Objects.equals(this.additionalProperties, flagEventImpactRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(size, percentage, reason, evaluationsSummary, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    evaluationsSummary: ").append(toIndentedString(evaluationsSummary)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagEventImpactRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagEventImpactRep is not found in the empty JSON string", FlagEventImpactRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("evaluationsSummary") != null && !jsonObj.get("evaluationsSummary").isJsonNull()) {
        EvaluationsSummary.validateJsonElement(jsonObj.get("evaluationsSummary"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagEventImpactRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagEventImpactRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagEventImpactRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagEventImpactRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagEventImpactRep>() {
           @Override
           ...
           public FlagEventImpactRep read(JsonReader in) throws IOException {
             ...
             FlagEventImpactRep instance = thisAdapter.fromJsonTree(jsonObj);
