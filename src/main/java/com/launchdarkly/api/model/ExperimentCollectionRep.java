...
public class ExperimentCollectionRep {
  ...
  public ExperimentCollectionRep items(@javax.annotation.Nonnull List<Experiment> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<Experiment> items) {
    this.items = items;
  }


  public ExperimentCollectionRep totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public ExperimentCollectionRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @return the ExperimentCollectionRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, experimentCollectionRep.items) &&
        Objects.equals(this.totalCount, experimentCollectionRep.totalCount) &&
        Objects.equals(this.links, experimentCollectionRep.links)&&
        Objects.equals(this.additionalProperties, experimentCollectionRep.additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("items", "total_count", "_links"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExperimentCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExperimentCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExperimentCollectionRep is not found in the empty JSON string", ExperimentCollectionRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExperimentCollectionRep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExperimentCollectionRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExperimentCollectionRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExperimentCollectionRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExperimentCollectionRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ExperimentCollectionRep>() {
           @Override
           ...
           public ExperimentCollectionRep read(JsonReader in) throws IOException {
             ...
             ExperimentCollectionRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExperimentCollectionRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExperimentCollectionRep
   * @throws IOException if the JSON string is invalid with respect to ExperimentCollectionRep
   */
  public static ExperimentCollectionRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExperimentCollectionRep.class);
  }

  /**
   * Convert an instance of ExperimentCollectionRep to an JSON string
   *
   * @return JSON string
   */
