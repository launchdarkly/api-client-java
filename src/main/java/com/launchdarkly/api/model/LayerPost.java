...
public class LayerPost {
  ...
  public LayerPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public LayerPost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public LayerPost description(@javax.annotation.Nonnull String description) {
   ...
   * @return the LayerPost instance itself
   */
  public LayerPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LayerPost layerPost = (LayerPost) o;
    return Objects.equals(this.key, layerPost.key) &&
        Objects.equals(this.name, layerPost.name) &&
        Objects.equals(this.description, layerPost.description)&&
        Objects.equals(this.additionalProperties, layerPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LayerPost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "description"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "name", "description"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LayerPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LayerPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LayerPost is not found in the empty JSON string", LayerPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LayerPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LayerPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LayerPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LayerPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LayerPost.class));

       return (TypeAdapter<T>) new TypeAdapter<LayerPost>() {
           @Override
           public void write(JsonWriter out, LayerPost value) throws IOException {
           ...
           @Override
           public LayerPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             LayerPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of LayerPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LayerPost
   * @throws IOException if the JSON string is invalid with respect to LayerPost
   */
  public static LayerPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LayerPost.class);
  }

  /**
   * Convert an instance of LayerPost to an JSON string
   *
   * @return JSON string
   */
