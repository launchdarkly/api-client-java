  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRequestSettingsPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ApprovalRequestSettingsPatch is not found in the empty JSON string", ApprovalRequestSettingsPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("resourceKind").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `resourceKind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("resourceKind").toString()));
      }
