...
public class ApprovalRequestSettingsPatch {
  ...
  public ApprovalRequestSettingsPatch autoApplyApprovedChanges(@javax.annotation.Nullable Boolean autoApplyApprovedChanges) {
  ...
  public ApprovalRequestSettingsPatch bypassApprovalsForPendingChanges(@javax.annotation.Nullable Boolean bypassApprovalsForPendingChanges) {
  ...
  public void setBypassApprovalsForPendingChanges(@javax.annotation.Nullable Boolean bypassApprovalsForPendingChanges) {
    this.bypassApprovalsForPendingChanges = bypassApprovalsForPendingChanges;
  }


  public ApprovalRequestSettingsPatch canApplyDeclinedChanges(@javax.annotation.Nullable Boolean canApplyDeclinedChanges) {
  ...
  public void setCanApplyDeclinedChanges(@javax.annotation.Nullable Boolean canApplyDeclinedChanges) {
    this.canApplyDeclinedChanges = canApplyDeclinedChanges;
  }


  public ApprovalRequestSettingsPatch canReviewOwnRequest(@javax.annotation.Nullable Boolean canReviewOwnRequest) {
  ...
  public void setCanReviewOwnRequest(@javax.annotation.Nullable Boolean canReviewOwnRequest) {
    this.canReviewOwnRequest = canReviewOwnRequest;
  }


  public ApprovalRequestSettingsPatch environmentKey(@javax.annotation.Nonnull String environmentKey) {
  ...
  public ApprovalRequestSettingsPatch minNumApprovals(@javax.annotation.Nullable Integer minNumApprovals) {
  ...
  public void setMinNumApprovals(@javax.annotation.Nullable Integer minNumApprovals) {
    this.minNumApprovals = minNumApprovals;
  }


  public ApprovalRequestSettingsPatch required(@javax.annotation.Nullable Boolean required) {
  ...
  public ApprovalRequestSettingsPatch requiredApprovalTags(@javax.annotation.Nullable List<String> requiredApprovalTags) {
    this.requiredApprovalTags = requiredApprovalTags;
    return this;
  }

  public ApprovalRequestSettingsPatch addRequiredApprovalTagsItem(String requiredApprovalTagsItem) {
  ...
  public void setRequiredApprovalTags(@javax.annotation.Nullable List<String> requiredApprovalTags) {
    this.requiredApprovalTags = requiredApprovalTags;
  }


  public ApprovalRequestSettingsPatch resourceKind(@javax.annotation.Nonnull String resourceKind) {
  ...
  public void setResourceKind(@javax.annotation.Nonnull String resourceKind) {
    this.resourceKind = resourceKind;
  }


  public ApprovalRequestSettingsPatch serviceConfig(@javax.annotation.Nullable Map<String, Object> serviceConfig) {
    this.serviceConfig = serviceConfig;
    return this;
  }

  public ApprovalRequestSettingsPatch putServiceConfigItem(String key, Object serviceConfigItem) {
  ...
  public void setServiceConfig(@javax.annotation.Nullable Map<String, Object> serviceConfig) {
    this.serviceConfig = serviceConfig;
  }


  public ApprovalRequestSettingsPatch serviceKind(@javax.annotation.Nullable String serviceKind) {
  ...
  public void setServiceKind(@javax.annotation.Nullable String serviceKind) {
    this.serviceKind = serviceKind;
  }


  public ApprovalRequestSettingsPatch serviceKindConfigurationId(@javax.annotation.Nullable String serviceKindConfigurationId) {
   ...
   * @return the ApprovalRequestSettingsPatch instance itself
   */
  public ApprovalRequestSettingsPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApprovalRequestSettingsPatch approvalRequestSettingsPatch = (ApprovalRequestSettingsPatch) o;
    return Objects.equals(this.autoApplyApprovedChanges, approvalRequestSettingsPatch.autoApplyApprovedChanges) &&
        Objects.equals(this.bypassApprovalsForPendingChanges, approvalRequestSettingsPatch.bypassApprovalsForPendingChanges) &&
        Objects.equals(this.canApplyDeclinedChanges, approvalRequestSettingsPatch.canApplyDeclinedChanges) &&
        Objects.equals(this.canReviewOwnRequest, approvalRequestSettingsPatch.canReviewOwnRequest) &&
        Objects.equals(this.environmentKey, approvalRequestSettingsPatch.environmentKey) &&
        Objects.equals(this.minNumApprovals, approvalRequestSettingsPatch.minNumApprovals) &&
        Objects.equals(this.required, approvalRequestSettingsPatch.required) &&
        Objects.equals(this.requiredApprovalTags, approvalRequestSettingsPatch.requiredApprovalTags) &&
        Objects.equals(this.resourceKind, approvalRequestSettingsPatch.resourceKind) &&
        Objects.equals(this.serviceConfig, approvalRequestSettingsPatch.serviceConfig) &&
        Objects.equals(this.serviceKind, approvalRequestSettingsPatch.serviceKind) &&
        Objects.equals(this.serviceKindConfigurationId, approvalRequestSettingsPatch.serviceKindConfigurationId)&&
        Objects.equals(this.additionalProperties, approvalRequestSettingsPatch.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoApplyApprovedChanges, bypassApprovalsForPendingChanges, canApplyDeclinedChanges, canReviewOwnRequest, environmentKey, minNumApprovals, required, requiredApprovalTags, resourceKind, serviceConfig, serviceKind, serviceKindConfigurationId, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApprovalRequestSettingsPatch {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("autoApplyApprovedChanges", "bypassApprovalsForPendingChanges", "canApplyDeclinedChanges", "canReviewOwnRequest", "environmentKey", "minNumApprovals", "required", "requiredApprovalTags", "resourceKind", "serviceConfig", "serviceKind", "serviceKindConfigurationId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("environmentKey", "resourceKind"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApprovalRequestSettingsPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRequestSettingsPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApprovalRequestSettingsPatch is not found in the empty JSON string", ApprovalRequestSettingsPatch.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApprovalRequestSettingsPatch.openapiRequiredFields) {
      ...
      if (jsonObj.get("requiredApprovalTags") != null && !jsonObj.get("requiredApprovalTags").isJsonNull() && !jsonObj.get("requiredApprovalTags").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalRequestSettingsPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalRequestSettingsPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalRequestSettingsPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalRequestSettingsPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalRequestSettingsPatch>() {
           @Override
           public void write(JsonWriter out, ApprovalRequestSettingsPatch value) throws IOException {
           ...
           @Override
           public ApprovalRequestSettingsPatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ApprovalRequestSettingsPatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ApprovalRequestSettingsPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApprovalRequestSettingsPatch
   * @throws IOException if the JSON string is invalid with respect to ApprovalRequestSettingsPatch
   */
  public static ApprovalRequestSettingsPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApprovalRequestSettingsPatch.class);
  }

  /**
   * Convert an instance of ApprovalRequestSettingsPatch to an JSON string
   *
   * @return JSON string
   */
