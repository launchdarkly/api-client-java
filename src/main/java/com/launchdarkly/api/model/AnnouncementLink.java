...
public class AnnouncementLink {
  ...
  public AnnouncementLink href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AnnouncementLink type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the AnnouncementLink instance itself
   */
  public AnnouncementLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnouncementLink announcementLink = (AnnouncementLink) o;
    return Objects.equals(this.href, announcementLink.href) &&
        Objects.equals(this.type, announcementLink.type)&&
        Objects.equals(this.additionalProperties, announcementLink.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnouncementLink {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("href", "type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnnouncementLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnouncementLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AnnouncementLink is not found in the empty JSON string", AnnouncementLink.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnouncementLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnouncementLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnouncementLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnouncementLink.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnouncementLink>() {
           @Override
           public void write(JsonWriter out, AnnouncementLink value) throws IOException {
           ...
           @Override
           public AnnouncementLink read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AnnouncementLink instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AnnouncementLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnnouncementLink
   * @throws IOException if the JSON string is invalid with respect to AnnouncementLink
   */
  public static AnnouncementLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnouncementLink.class);
  }

  /**
   * Convert an instance of AnnouncementLink to an JSON string
   *
   * @return JSON string
   */
