...
public class Extinction {
   ...
   * @return the Extinction instance itself
   */
  public Extinction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Extinction extinction = (Extinction) o;
    return Objects.equals(this.revision, extinction.revision) &&
        Objects.equals(this.message, extinction.message) &&
        Objects.equals(this.time, extinction.time) &&
        Objects.equals(this.flagKey, extinction.flagKey) &&
        Objects.equals(this.projKey, extinction.projKey)&&
        Objects.equals(this.additionalProperties, extinction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(revision, message, time, flagKey, projKey, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Extinction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Extinction is not found in the empty JSON string", Extinction.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Extinction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Extinction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Extinction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Extinction.class));

       return (TypeAdapter<T>) new TypeAdapter<Extinction>() {
           @Override
           public void write(JsonWriter out, Extinction value) throws IOException {
           ...
           @Override
           public Extinction read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             Extinction instance = thisAdapter.fromJsonTree(jsonObj);
