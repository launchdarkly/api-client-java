...
public class SimpleHoldoutRep {
  ...
  public SimpleHoldoutRep id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public SimpleHoldoutRep key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public SimpleHoldoutRep name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public SimpleHoldoutRep status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public SimpleHoldoutRep createdAt(@javax.annotation.Nullable Long createdAt) {
  ...
  public SimpleHoldoutRep updatedAt(@javax.annotation.Nullable Long updatedAt) {
  ...
  public SimpleHoldoutRep experiments(@javax.annotation.Nullable List<RelatedExperimentRep> experiments) {
    this.experiments = experiments;
    return this;
  }

  public SimpleHoldoutRep addExperimentsItem(RelatedExperimentRep experimentsItem) {
   ...
   * @return the SimpleHoldoutRep instance itself
   */
  public SimpleHoldoutRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SimpleHoldoutRep simpleHoldoutRep = (SimpleHoldoutRep) o;
    return Objects.equals(this.id, simpleHoldoutRep.id) &&
        Objects.equals(this.key, simpleHoldoutRep.key) &&
        Objects.equals(this.name, simpleHoldoutRep.name) &&
        Objects.equals(this.status, simpleHoldoutRep.status) &&
        Objects.equals(this.createdAt, simpleHoldoutRep.createdAt) &&
        Objects.equals(this.updatedAt, simpleHoldoutRep.updatedAt) &&
        Objects.equals(this.experiments, simpleHoldoutRep.experiments)&&
        Objects.equals(this.additionalProperties, simpleHoldoutRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, key, name, status, createdAt, updatedAt, experiments, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SimpleHoldoutRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "key", "name", "status", "createdAt", "updatedAt", "experiments"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimpleHoldoutRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimpleHoldoutRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SimpleHoldoutRep is not found in the empty JSON string", SimpleHoldoutRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("experiments") != null && !jsonObj.get("experiments").isJsonNull()) {
        ...
        if (jsonArrayexperiments != null) {
          ...
          for (int i = 0; i < jsonArrayexperiments.size(); i++) {
            RelatedExperimentRep.validateJsonElement(jsonArrayexperiments.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimpleHoldoutRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimpleHoldoutRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimpleHoldoutRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimpleHoldoutRep.class));

       return (TypeAdapter<T>) new TypeAdapter<SimpleHoldoutRep>() {
           @Override
           public void write(JsonWriter out, SimpleHoldoutRep value) throws IOException {
           ...
           @Override
           public SimpleHoldoutRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SimpleHoldoutRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SimpleHoldoutRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SimpleHoldoutRep
   * @throws IOException if the JSON string is invalid with respect to SimpleHoldoutRep
   */
  public static SimpleHoldoutRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimpleHoldoutRep.class);
  }

  /**
   * Convert an instance of SimpleHoldoutRep to an JSON string
   *
   * @return JSON string
   */
