...
public class InsightScores {
  ...
  public InsightScores period(@javax.annotation.Nonnull InsightPeriod period) {
    this.period = period;
    return this;
  }
  ...
  public InsightScores lastPeriod(@javax.annotation.Nonnull InsightPeriod lastPeriod) {
  ...
  public InsightScores scores(@javax.annotation.Nonnull InsightGroupScores scores) {
    this.scores = scores;
    return this;
  }
  ...
  public void setScores(@javax.annotation.Nonnull InsightGroupScores scores) {
    this.scores = scores;
  }


  public InsightScores links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @return the InsightScores instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.period, insightScores.period) &&
        Objects.equals(this.lastPeriod, insightScores.lastPeriod) &&
        Objects.equals(this.scores, insightScores.scores) &&
        Objects.equals(this.links, insightScores.links)&&
        Objects.equals(this.additionalProperties, insightScores.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(period, lastPeriod, scores, links, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("period", "lastPeriod", "scores", "_links"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("period", "lastPeriod", "scores"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InsightScores
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightScores.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightScores is not found in the empty JSON string", InsightScores.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InsightScores.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InsightScores.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InsightScores' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InsightScores> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InsightScores.class));

       return (TypeAdapter<T>) new TypeAdapter<InsightScores>() {
           @Override
           ...
           public InsightScores read(JsonReader in) throws IOException {
             ...
             InsightScores instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of InsightScores given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InsightScores
   * @throws IOException if the JSON string is invalid with respect to InsightScores
   */
  public static InsightScores fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InsightScores.class);
  }

  /**
   * Convert an instance of InsightScores to an JSON string
   *
   * @return JSON string
   */
