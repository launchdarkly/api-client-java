...
public class ReleaseProgressionCollection {
   ...
   * @return the ReleaseProgressionCollection instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activeCount, releaseProgressionCollection.activeCount) &&
        Objects.equals(this.completedCount, releaseProgressionCollection.completedCount) &&
        Objects.equals(this.items, releaseProgressionCollection.items) &&
        Objects.equals(this.phases, releaseProgressionCollection.phases) &&
        Objects.equals(this.totalCount, releaseProgressionCollection.totalCount) &&
        Objects.equals(this.links, releaseProgressionCollection.links)&&
        Objects.equals(this.additionalProperties, releaseProgressionCollection.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activeCount, completedCount, items, phases, totalCount, links, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleaseProgressionCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleaseProgressionCollection is not found in the empty JSON string", ReleaseProgressionCollection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ReleaseProgression.validateJsonElement(jsonArrayitems.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayphases.size(); i++) {
        PhaseInfo.validateJsonElement(jsonArrayphases.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleaseProgressionCollection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleaseProgressionCollection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleaseProgressionCollection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleaseProgressionCollection.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleaseProgressionCollection>() {
           @Override
           ...
           public ReleaseProgressionCollection read(JsonReader in) throws IOException {
             ...
             ReleaseProgressionCollection instance = thisAdapter.fromJsonTree(jsonObj);
