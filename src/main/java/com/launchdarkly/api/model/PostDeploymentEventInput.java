...
public class PostDeploymentEventInput {
   ...
   */
  @JsonAdapter(ApplicationKindEnum.Adapter.class)
  public enum ApplicationKindEnum {
    ...
    ApplicationKindEnum(String value) {
      this.value = value;
    }
    ...
    public static class Adapter extends TypeAdapter<ApplicationKindEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ApplicationKindEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ApplicationKindEnum read(final JsonReader jsonReader) throws IOException {
   ...
   * @return the PostDeploymentEventInput instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.projectKey, postDeploymentEventInput.projectKey) &&
        Objects.equals(this.environmentKey, postDeploymentEventInput.environmentKey) &&
        Objects.equals(this.applicationKey, postDeploymentEventInput.applicationKey) &&
        Objects.equals(this.applicationName, postDeploymentEventInput.applicationName) &&
        Objects.equals(this.applicationKind, postDeploymentEventInput.applicationKind) &&
        Objects.equals(this.version, postDeploymentEventInput.version) &&
        Objects.equals(this.versionName, postDeploymentEventInput.versionName) &&
        Objects.equals(this.eventType, postDeploymentEventInput.eventType) &&
        Objects.equals(this.eventTime, postDeploymentEventInput.eventTime) &&
        Objects.equals(this.eventMetadata, postDeploymentEventInput.eventMetadata) &&
        Objects.equals(this.deploymentMetadata, postDeploymentEventInput.deploymentMetadata)&&
        Objects.equals(this.additionalProperties, postDeploymentEventInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectKey, environmentKey, applicationKey, applicationName, applicationKind, version, versionName, eventType, eventTime, eventMetadata, deploymentMetadata, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    applicationKind: ").append(toIndentedString(applicationKind)).append("\n");
    sb.append("    version: ").append(toIndentedString(version)).append("\n");
    sb.append("    versionName: ").append(toIndentedString(versionName)).append("\n");
    sb.append("    eventType: ").append(toIndentedString(eventType)).append("\n");
    sb.append("    eventTime: ").append(toIndentedString(eventTime)).append("\n");
    sb.append("    eventMetadata: ").append(toIndentedString(eventMetadata)).append("\n");
    sb.append("    deploymentMetadata: ").append(toIndentedString(deploymentMetadata)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostDeploymentEventInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostDeploymentEventInput is not found in the empty JSON string", PostDeploymentEventInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("applicationKind") != null && !jsonObj.get("applicationKind").isJsonNull()) && !jsonObj.get("applicationKind").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `applicationKind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("applicationKind").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostDeploymentEventInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostDeploymentEventInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostDeploymentEventInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostDeploymentEventInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PostDeploymentEventInput>() {
           @Override
           ...
           public PostDeploymentEventInput read(JsonReader in) throws IOException {
             ...
             PostDeploymentEventInput instance = thisAdapter.fromJsonTree(jsonObj);
