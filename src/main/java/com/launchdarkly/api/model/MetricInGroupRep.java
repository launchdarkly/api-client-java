...
public class MetricInGroupRep {
  ...
  public MetricInGroupRep analysisType(@javax.annotation.Nullable AnalysisTypeEnum analysisType) {
  ...
  public MetricInGroupRep analysisUnits(@javax.annotation.Nullable List<String> analysisUnits) {
    this.analysisUnits = analysisUnits;
    return this;
  }

  public MetricInGroupRep addAnalysisUnitsItem(String analysisUnitsItem) {
   ...
   * @return the MetricInGroupRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, metricInGroupRep.key) &&
        Objects.equals(this.versionId, metricInGroupRep.versionId) &&
        Objects.equals(this.name, metricInGroupRep.name) &&
        Objects.equals(this.kind, metricInGroupRep.kind) &&
        Objects.equals(this.isNumeric, metricInGroupRep.isNumeric) &&
        Objects.equals(this.unitAggregationType, metricInGroupRep.unitAggregationType) &&
        Objects.equals(this.analysisType, metricInGroupRep.analysisType) &&
        Objects.equals(this.eventKey, metricInGroupRep.eventKey) &&
        Objects.equals(this.links, metricInGroupRep.links) &&
        Objects.equals(this.nameInGroup, metricInGroupRep.nameInGroup) &&
        Objects.equals(this.randomizationUnits, metricInGroupRep.randomizationUnits) &&
        Objects.equals(this.analysisUnits, metricInGroupRep.analysisUnits)&&
        Objects.equals(this.additionalProperties, metricInGroupRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, versionId, name, kind, isNumeric, unitAggregationType, analysisType, eventKey, links, nameInGroup, randomizationUnits, analysisUnits, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    nameInGroup: ").append(toIndentedString(nameInGroup)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "_versionId", "name", "kind", "isNumeric", "unitAggregationType", "analysisType", "eventKey", "_links", "nameInGroup", "randomizationUnits", "analysisUnits"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricInGroupRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricInGroupRep is not found in the empty JSON string", MetricInGroupRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("nameInGroup") != null && !jsonObj.get("nameInGroup").isJsonNull()) && !jsonObj.get("nameInGroup").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nameInGroup` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nameInGroup").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricInGroupRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricInGroupRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricInGroupRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricInGroupRep.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricInGroupRep>() {
           @Override
           ...
           public MetricInGroupRep read(JsonReader in) throws IOException {
             ...
             MetricInGroupRep instance = thisAdapter.fromJsonTree(jsonObj);
