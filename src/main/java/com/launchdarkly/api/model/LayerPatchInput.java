...
public class LayerPatchInput {
   ...
   * @return the LayerPatchInput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LayerPatchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LayerPatchInput is not found in the empty JSON string", LayerPatchInput.openapiRequiredFields.toString()));
        }
      }
