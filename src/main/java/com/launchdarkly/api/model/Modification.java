...
public class Modification {
  ...
  public Modification date(@javax.annotation.Nullable OffsetDateTime date) {
    this.date = date;
    return this;
  }
   ...
   * @return the Modification instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Modification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Modification is not found in the empty JSON string", Modification.openapiRequiredFields.toString()));
        }
      }
