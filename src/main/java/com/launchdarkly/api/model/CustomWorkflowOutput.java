...
public class CustomWorkflowOutput {
   ...
   * @return the CustomWorkflowOutput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomWorkflowOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomWorkflowOutput is not found in the empty JSON string", CustomWorkflowOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("_conflicts").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_conflicts` to be an array in the JSON string but got `%s`", jsonObj.get("_conflicts").toString()));
      }

      JsonArray jsonArrayconflicts = jsonObj.getAsJsonArray("_conflicts");
      // validate the required field `_conflicts` (array)
