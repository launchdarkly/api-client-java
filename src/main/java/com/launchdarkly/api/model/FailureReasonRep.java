...
public class FailureReasonRep {
   ...
   * @return the FailureReasonRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FailureReasonRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FailureReasonRep is not found in the empty JSON string", FailureReasonRep.openapiRequiredFields.toString()));
        }
      }
