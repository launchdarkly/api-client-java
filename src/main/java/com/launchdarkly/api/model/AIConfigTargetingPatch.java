...
public class AIConfigTargetingPatch {
  ...
  public AIConfigTargetingPatch comment(@javax.annotation.Nullable String comment) {
  ...
  public AIConfigTargetingPatch environmentKey(@javax.annotation.Nonnull String environmentKey) {
  ...
  public AIConfigTargetingPatch instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
    this.instructions = instructions;
    return this;
  }

  public AIConfigTargetingPatch addInstructionsItem(Map<String, Object> instructionsItem) {
   ...
   * @return the AIConfigTargetingPatch instance itself
   */
  public AIConfigTargetingPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigTargetingPatch aiConfigTargetingPatch = (AIConfigTargetingPatch) o;
    return Objects.equals(this.comment, aiConfigTargetingPatch.comment) &&
        Objects.equals(this.environmentKey, aiConfigTargetingPatch.environmentKey) &&
        Objects.equals(this.instructions, aiConfigTargetingPatch.instructions)&&
        Objects.equals(this.additionalProperties, aiConfigTargetingPatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, environmentKey, instructions, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIConfigTargetingPatch {\n");
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("environmentKey", "instructions"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigTargetingPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigTargetingPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigTargetingPatch is not found in the empty JSON string", AIConfigTargetingPatch.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AIConfigTargetingPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigTargetingPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigTargetingPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigTargetingPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigTargetingPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigTargetingPatch>() {
           @Override
           public void write(JsonWriter out, AIConfigTargetingPatch value) throws IOException {
           ...
           @Override
           public AIConfigTargetingPatch read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigTargetingPatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigTargetingPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigTargetingPatch
   * @throws IOException if the JSON string is invalid with respect to AIConfigTargetingPatch
   */
  public static AIConfigTargetingPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigTargetingPatch.class);
  }

  /**
   * Convert an instance of AIConfigTargetingPatch to an JSON string
   *
   * @return JSON string
   */
