...
public class Defaults {
  ...
  public Defaults onVariation(@javax.annotation.Nonnull Integer onVariation) {
  ...
  public Defaults offVariation(@javax.annotation.Nonnull Integer offVariation) {
   ...
   * @return the Defaults instance itself
   */
  public Defaults putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.onVariation, defaults.onVariation) &&
        ...
        Objects.equals(this.additionalProperties, defaults.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Defaults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Defaults is not found in the empty JSON string", Defaults.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Defaults.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Defaults>() {
           ...
           public Defaults read(JsonReader in) throws IOException {
             ...
             Defaults instance = thisAdapter.fromJsonTree(jsonObj);
