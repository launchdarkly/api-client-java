...
public class FlagEventRep {
   ...
   * @return the FlagEventRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, flagEventRep.id) &&
        Objects.equals(this.projectId, flagEventRep.projectId) &&
        Objects.equals(this.projectKey, flagEventRep.projectKey) &&
        Objects.equals(this.environmentId, flagEventRep.environmentId) &&
        Objects.equals(this.environmentKey, flagEventRep.environmentKey) &&
        Objects.equals(this.flagKey, flagEventRep.flagKey) &&
        Objects.equals(this.eventType, flagEventRep.eventType) &&
        Objects.equals(this.eventTime, flagEventRep.eventTime) &&
        Objects.equals(this.description, flagEventRep.description) &&
        Objects.equals(this.auditLogEntryId, flagEventRep.auditLogEntryId) &&
        Objects.equals(this.member, flagEventRep.member) &&
        Objects.equals(this.actions, flagEventRep.actions) &&
        Objects.equals(this.impact, flagEventRep.impact) &&
        Objects.equals(this.experiments, flagEventRep.experiments)&&
        Objects.equals(this.additionalProperties, flagEventRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, projectId, projectKey, environmentId, environmentKey, flagKey, eventType, eventTime, description, auditLogEntryId, member, actions, impact, experiments, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagEventRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagEventRep is not found in the empty JSON string", FlagEventRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("auditLogEntryId") != null && !jsonObj.get("auditLogEntryId").isJsonNull()) && !jsonObj.get("auditLogEntryId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `auditLogEntryId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("auditLogEntryId").toString()));
      }
      // validate the optional field `member`
      if (jsonObj.get("member") != null && !jsonObj.get("member").isJsonNull()) {
        FlagEventMemberRep.validateJsonElement(jsonObj.get("member"));
      }
      ...
      if (jsonObj.get("experiments") != null && !jsonObj.get("experiments").isJsonNull()) {
        FlagEventExperimentCollection.validateJsonElement(jsonObj.get("experiments"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagEventRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagEventRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagEventRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagEventRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagEventRep>() {
           @Override
           ...
           public FlagEventRep read(JsonReader in) throws IOException {
             ...
             FlagEventRep instance = thisAdapter.fromJsonTree(jsonObj);
