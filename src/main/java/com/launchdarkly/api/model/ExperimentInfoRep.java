...
public class ExperimentInfoRep {
  ...
  @javax.annotation.Nonnull
  private List<LegacyExperimentRep> items = new ArrayList<>();

  public ExperimentInfoRep() {
  }

  public ExperimentInfoRep baselineIdx(@javax.annotation.Nonnull Integer baselineIdx) {
  ...
  public ExperimentInfoRep items(@javax.annotation.Nonnull List<LegacyExperimentRep> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<LegacyExperimentRep> items) {
    this.items = items;
  }
   ...
   * @return the ExperimentInfoRep instance itself
   */
  public ExperimentInfoRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExperimentInfoRep experimentInfoRep = (ExperimentInfoRep) o;
    return Objects.equals(this.baselineIdx, experimentInfoRep.baselineIdx) &&
        Objects.equals(this.items, experimentInfoRep.items)&&
        Objects.equals(this.additionalProperties, experimentInfoRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExperimentInfoRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExperimentInfoRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExperimentInfoRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExperimentInfoRep is not found in the empty JSON string", ExperimentInfoRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExperimentInfoRep.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        LegacyExperimentRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExperimentInfoRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExperimentInfoRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExperimentInfoRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExperimentInfoRep.class));

       return (TypeAdapter<T>) new TypeAdapter<ExperimentInfoRep>() {
           @Override
           public void write(JsonWriter out, ExperimentInfoRep value) throws IOException {
           ...
           @Override
           public ExperimentInfoRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExperimentInfoRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ExperimentInfoRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExperimentInfoRep
   * @throws IOException if the JSON string is invalid with respect to ExperimentInfoRep
   */
  public static ExperimentInfoRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExperimentInfoRep.class);
  }

  /**
   * Convert an instance of ExperimentInfoRep to an JSON string
   *
   * @return JSON string
   */
