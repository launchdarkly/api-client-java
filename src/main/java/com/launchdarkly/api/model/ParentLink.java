...
public class ParentLink {
  ...
  public ParentLink parent(@javax.annotation.Nonnull CoreLink parent) {
    this.parent = parent;
    return this;
  }
   ...
   * @return the ParentLink instance itself
   */
  public ParentLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ParentLink parentLink = (ParentLink) o;
    return Objects.equals(this.parent, parentLink.parent)&&
        Objects.equals(this.additionalProperties, parentLink.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ParentLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParentLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ParentLink is not found in the empty JSON string", ParentLink.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ParentLink.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParentLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParentLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParentLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParentLink.class));

       return (TypeAdapter<T>) new TypeAdapter<ParentLink>() {
           @Override
           public void write(JsonWriter out, ParentLink value) throws IOException {
           ...
           @Override
           public ParentLink read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ParentLink instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ParentLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ParentLink
   * @throws IOException if the JSON string is invalid with respect to ParentLink
   */
  public static ParentLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParentLink.class);
  }

  /**
   * Convert an instance of ParentLink to an JSON string
   *
   * @return JSON string
   */
