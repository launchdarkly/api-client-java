...
import com.launchdarkly.api.model.ViewsAccessDeniedReason;
...
public class ViewsAccessDenied {
  ...
  @javax.annotation.Nonnull
  private ViewsAccessDeniedReason reason;

  public ViewsAccessDenied() {
  }

  public ViewsAccessDenied action(@javax.annotation.Nonnull String action) {
    this.action = action;
    return this;
  }
  ...
  public ViewsAccessDenied reason(@javax.annotation.Nonnull ViewsAccessDeniedReason reason) {
    this.reason = reason;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ViewsAccessDeniedReason getReason() {
    return reason;
  }

  public void setReason(@javax.annotation.Nonnull ViewsAccessDeniedReason reason) {
    this.reason = reason;
  }
   ...
   * @return the ViewsAccessDenied instance itself
   */
  public ViewsAccessDenied putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewsAccessDenied viewsAccessDenied = (ViewsAccessDenied) o;
    return Objects.equals(this.action, viewsAccessDenied.action) &&
        Objects.equals(this.reason, viewsAccessDenied.reason)&&
        Objects.equals(this.additionalProperties, viewsAccessDenied.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewsAccessDenied {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewsAccessDenied
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewsAccessDenied.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewsAccessDenied is not found in the empty JSON string", ViewsAccessDenied.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewsAccessDenied.openapiRequiredFields) {
      ...
      ViewsAccessDeniedReason.validateJsonElement(jsonObj.get("reason"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewsAccessDenied.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewsAccessDenied' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewsAccessDenied> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewsAccessDenied.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewsAccessDenied>() {
           @Override
           public void write(JsonWriter out, ViewsAccessDenied value) throws IOException {
           ...
           @Override
           public ViewsAccessDenied read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewsAccessDenied instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ViewsAccessDenied given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewsAccessDenied
   * @throws IOException if the JSON string is invalid with respect to ViewsAccessDenied
   */
  public static ViewsAccessDenied fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewsAccessDenied.class);
  }

  /**
   * Convert an instance of ViewsAccessDenied to an JSON string
   *
   * @return JSON string
   */
