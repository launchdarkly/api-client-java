...
public class AITools {
  ...
  public AITools addItemsItem(AITool itemsItem) {
    if (this.items == null) {
   ...
   * @return the AITools instance itself
   */
  public AITools putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AITools aiTools = (AITools) o;
    return Objects.equals(this.links, aiTools.links) &&
        Objects.equals(this.items, aiTools.items) &&
        Objects.equals(this.totalCount, aiTools.totalCount)&&
        Objects.equals(this.additionalProperties, aiTools.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AITools.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AITools is not found in the empty JSON string", AITools.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        AITool.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AITools.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AITools' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AITools> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AITools.class));

       return (TypeAdapter<T>) new TypeAdapter<AITools>() {
           @Override
           public void write(JsonWriter out, AITools value) throws IOException {
           ...
           @Override
           public AITools read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AITools instance = thisAdapter.fromJsonTree(jsonObj);
