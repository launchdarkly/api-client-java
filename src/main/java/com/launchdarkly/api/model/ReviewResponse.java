...
public class ReviewResponse {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The approval request id")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The type of review action to take. Either \"approve\", \"decline\" or \"comment\"")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A comment describing the approval response")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of account member that reviewed request")
