...
public class Prerequisite {
  ...
  public Prerequisite key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public Prerequisite variation(@javax.annotation.Nonnull Integer variation) {
   ...
   * @return the Prerequisite instance itself
   */
  public Prerequisite putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, prerequisite.key) &&
        ...
        Objects.equals(this.additionalProperties, prerequisite.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, variation, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "variation"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "variation"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Prerequisite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Prerequisite is not found in the empty JSON string", Prerequisite.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Prerequisite>() {
           ...
           public Prerequisite read(JsonReader in) throws IOException {
             ...
             Prerequisite instance = thisAdapter.fromJsonTree(jsonObj);
