...
public class JudgeAttachment {
   ...
   * @return the JudgeAttachment instance itself
   */
  public JudgeAttachment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JudgeAttachment judgeAttachment = (JudgeAttachment) o;
    return Objects.equals(this.judgeConfigKey, judgeAttachment.judgeConfigKey) &&
        Objects.equals(this.samplingRate, judgeAttachment.samplingRate)&&
        Objects.equals(this.additionalProperties, judgeAttachment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(judgeConfigKey, samplingRate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JudgeAttachment {\n");
    sb.append("    judgeConfigKey: ").append(toIndentedString(judgeConfigKey)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JudgeAttachment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in JudgeAttachment is not found in the empty JSON string", JudgeAttachment.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("judgeConfigKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `judgeConfigKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("judgeConfigKey").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JudgeAttachment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JudgeAttachment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JudgeAttachment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JudgeAttachment.class));

       return (TypeAdapter<T>) new TypeAdapter<JudgeAttachment>() {
           @Override
           public void write(JsonWriter out, JudgeAttachment value) throws IOException {
           ...
           @Override
           public JudgeAttachment read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             JudgeAttachment instance = thisAdapter.fromJsonTree(jsonObj);
