...
public class TagsCollection {
  ...
  @javax.annotation.Nonnull
  private Map<String, TagsLink> links = new HashMap<>();
  ...
  public TagsCollection items(@javax.annotation.Nonnull List<String> items) {
    this.items = items;
    return this;
  }
  ...
  public TagsCollection links(@javax.annotation.Nonnull Map<String, TagsLink> links) {
    this.links = links;
    return this;
  }
  ...
  public void setLinks(@javax.annotation.Nonnull Map<String, TagsLink> links) {
    this.links = links;
  }


  public TagsCollection totalCount(@javax.annotation.Nullable Integer totalCount) {
   ...
   * @return the TagsCollection instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, tagsCollection.items) &&
        Objects.equals(this.links, tagsCollection.links) &&
        Objects.equals(this.totalCount, tagsCollection.totalCount)&&
        Objects.equals(this.additionalProperties, tagsCollection.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagsCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TagsCollection is not found in the empty JSON string", TagsCollection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TagsCollection.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TagsCollection>() {
           ...
           public TagsCollection read(JsonReader in) throws IOException {
             ...
             TagsCollection instance = thisAdapter.fromJsonTree(jsonObj);
