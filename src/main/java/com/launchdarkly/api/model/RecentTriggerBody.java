...
public class RecentTriggerBody {
   ...
   * @return the RecentTriggerBody instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecentTriggerBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RecentTriggerBody is not found in the empty JSON string", RecentTriggerBody.openapiRequiredFields.toString()));
        }
      }
