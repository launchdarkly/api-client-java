...
public class StoreIntegrationError {
  ...
  public StoreIntegrationError statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public StoreIntegrationError message(@javax.annotation.Nullable String message) {
  ...
  public StoreIntegrationError timestamp(@javax.annotation.Nullable Long timestamp) {
   ...
   * @return the StoreIntegrationError instance itself
   */
  public StoreIntegrationError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StoreIntegrationError storeIntegrationError = (StoreIntegrationError) o;
    return Objects.equals(this.statusCode, storeIntegrationError.statusCode) &&
        Objects.equals(this.message, storeIntegrationError.message) &&
        Objects.equals(this.timestamp, storeIntegrationError.timestamp)&&
        Objects.equals(this.additionalProperties, storeIntegrationError.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(statusCode, message, timestamp, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StoreIntegrationError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StoreIntegrationError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StoreIntegrationError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StoreIntegrationError is not found in the empty JSON string", StoreIntegrationError.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StoreIntegrationError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StoreIntegrationError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StoreIntegrationError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StoreIntegrationError.class));

       return (TypeAdapter<T>) new TypeAdapter<StoreIntegrationError>() {
           @Override
           public void write(JsonWriter out, StoreIntegrationError value) throws IOException {
           ...
           @Override
           public StoreIntegrationError read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             StoreIntegrationError instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of StoreIntegrationError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StoreIntegrationError
   * @throws IOException if the JSON string is invalid with respect to StoreIntegrationError
   */
  public static StoreIntegrationError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StoreIntegrationError.class);
  }

  /**
   * Convert an instance of StoreIntegrationError to an JSON string
   *
   * @return JSON string
   */
