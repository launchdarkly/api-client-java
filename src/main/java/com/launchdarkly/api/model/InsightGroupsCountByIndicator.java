...
public class InsightGroupsCountByIndicator {
   ...
   * @return the InsightGroupsCountByIndicator instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightGroupsCountByIndicator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightGroupsCountByIndicator is not found in the empty JSON string", InsightGroupsCountByIndicator.openapiRequiredFields.toString()));
        }
      }
