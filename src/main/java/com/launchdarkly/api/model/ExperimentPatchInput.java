...
public class ExperimentPatchInput {
  ...
  public ExperimentPatchInput comment(@javax.annotation.Nullable String comment) {
  ...
  public ExperimentPatchInput instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
   ...
   * @return the ExperimentPatchInput instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExperimentPatchInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExperimentPatchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExperimentPatchInput is not found in the empty JSON string", ExperimentPatchInput.openapiRequiredFields.toString()));
        }
      }
