...
public class MetricEventDefaultRep {
   ...
   * @return the MetricEventDefaultRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricEventDefaultRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricEventDefaultRep is not found in the empty JSON string", MetricEventDefaultRep.openapiRequiredFields.toString()));
        }
      }
