...
import com.launchdarkly.api.model.AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation;
import com.launchdarkly.api.model.AIConfigTargetingEnvironmentFallthroughRolloutVariation;
...
public class AIConfigTargetingEnvironmentFallthroughRollout {
  ...
  public AIConfigTargetingEnvironmentFallthroughRollout addVariationsItem(AIConfigTargetingEnvironmentFallthroughRolloutVariation variationsItem) {
   ...
   * @return the AIConfigTargetingEnvironmentFallthroughRollout instance itself
   */
  public AIConfigTargetingEnvironmentFallthroughRollout putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigTargetingEnvironmentFallthroughRollout aiConfigTargetingEnvironmentFallthroughRollout = (AIConfigTargetingEnvironmentFallthroughRollout) o;
    return Objects.equals(this.bucketBy, aiConfigTargetingEnvironmentFallthroughRollout.bucketBy) &&
        Objects.equals(this.contextKind, aiConfigTargetingEnvironmentFallthroughRollout.contextKind) &&
        Objects.equals(this.experimentAllocation, aiConfigTargetingEnvironmentFallthroughRollout.experimentAllocation) &&
        Objects.equals(this.seed, aiConfigTargetingEnvironmentFallthroughRollout.seed) &&
        Objects.equals(this.variations, aiConfigTargetingEnvironmentFallthroughRollout.variations)&&
        Objects.equals(this.additionalProperties, aiConfigTargetingEnvironmentFallthroughRollout.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bucketBy, contextKind, experimentAllocation, seed, variations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIConfigTargetingEnvironmentFallthroughRollout {\n");
    ...
    sb.append("    experimentAllocation: ").append(toIndentedString(experimentAllocation)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigTargetingEnvironmentFallthroughRollout.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigTargetingEnvironmentFallthroughRollout is not found in the empty JSON string", AIConfigTargetingEnvironmentFallthroughRollout.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("experimentAllocation") != null && !jsonObj.get("experimentAllocation").isJsonNull()) {
        AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation.validateJsonElement(jsonObj.get("experimentAllocation"));
      }
      ...
      for (int i = 0; i < jsonArrayvariations.size(); i++) {
        AIConfigTargetingEnvironmentFallthroughRolloutVariation.validateJsonElement(jsonArrayvariations.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigTargetingEnvironmentFallthroughRollout.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigTargetingEnvironmentFallthroughRollout' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigTargetingEnvironmentFallthroughRollout> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigTargetingEnvironmentFallthroughRollout.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigTargetingEnvironmentFallthroughRollout>() {
           @Override
           public void write(JsonWriter out, AIConfigTargetingEnvironmentFallthroughRollout value) throws IOException {
           ...
           @Override
           public AIConfigTargetingEnvironmentFallthroughRollout read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigTargetingEnvironmentFallthroughRollout instance = thisAdapter.fromJsonTree(jsonObj);
