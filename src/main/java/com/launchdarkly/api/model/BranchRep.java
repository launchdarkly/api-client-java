...
public class BranchRep {
   ...
   * @return the BranchRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BranchRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BranchRep is not found in the empty JSON string", BranchRep.openapiRequiredFields.toString()));
        }
      }
