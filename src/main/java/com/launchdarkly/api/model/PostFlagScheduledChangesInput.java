...
public class PostFlagScheduledChangesInput {
  ...
  public PostFlagScheduledChangesInput comment(@javax.annotation.Nullable String comment) {
  ...
  public PostFlagScheduledChangesInput executionDate(@javax.annotation.Nonnull Long executionDate) {
  ...
  public PostFlagScheduledChangesInput instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
    this.instructions = instructions;
    return this;
  }

  public PostFlagScheduledChangesInput addInstructionsItem(Map<String, Object> instructionsItem) {
   ...
   * @return the PostFlagScheduledChangesInput instance itself
   */
  public PostFlagScheduledChangesInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PostFlagScheduledChangesInput postFlagScheduledChangesInput = (PostFlagScheduledChangesInput) o;
    return Objects.equals(this.comment, postFlagScheduledChangesInput.comment) &&
        Objects.equals(this.executionDate, postFlagScheduledChangesInput.executionDate) &&
        Objects.equals(this.instructions, postFlagScheduledChangesInput.instructions)&&
        Objects.equals(this.additionalProperties, postFlagScheduledChangesInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, executionDate, instructions, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostFlagScheduledChangesInput {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "executionDate", "instructions"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("executionDate", "instructions"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostFlagScheduledChangesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostFlagScheduledChangesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostFlagScheduledChangesInput is not found in the empty JSON string", PostFlagScheduledChangesInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostFlagScheduledChangesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostFlagScheduledChangesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostFlagScheduledChangesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostFlagScheduledChangesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostFlagScheduledChangesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PostFlagScheduledChangesInput>() {
           @Override
           public void write(JsonWriter out, PostFlagScheduledChangesInput value) throws IOException {
           ...
           @Override
           public PostFlagScheduledChangesInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PostFlagScheduledChangesInput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PostFlagScheduledChangesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostFlagScheduledChangesInput
   * @throws IOException if the JSON string is invalid with respect to PostFlagScheduledChangesInput
   */
  public static PostFlagScheduledChangesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostFlagScheduledChangesInput.class);
  }

  /**
   * Convert an instance of PostFlagScheduledChangesInput to an JSON string
   *
   * @return JSON string
   */
