...
public class MaintainerMember {
  ...
  public MaintainerMember id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public MaintainerMember email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public MaintainerMember firstName(@javax.annotation.Nullable String firstName) {
  ...
  public MaintainerMember lastName(@javax.annotation.Nullable String lastName) {
  ...
  public MaintainerMember role(@javax.annotation.Nonnull String role) {
    this.role = role;
    return this;
  }
   ...
   * @return the MaintainerMember instance itself
   */
  public MaintainerMember putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MaintainerMember maintainerMember = (MaintainerMember) o;
    return Objects.equals(this.id, maintainerMember.id) &&
        Objects.equals(this.email, maintainerMember.email) &&
        Objects.equals(this.firstName, maintainerMember.firstName) &&
        Objects.equals(this.lastName, maintainerMember.lastName) &&
        Objects.equals(this.role, maintainerMember.role)&&
        Objects.equals(this.additionalProperties, maintainerMember.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, email, firstName, lastName, role, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MaintainerMember {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "email", "firstName", "lastName", "role"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_id", "email", "role"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MaintainerMember
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MaintainerMember.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MaintainerMember is not found in the empty JSON string", MaintainerMember.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MaintainerMember.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MaintainerMember.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MaintainerMember' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MaintainerMember> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MaintainerMember.class));

       return (TypeAdapter<T>) new TypeAdapter<MaintainerMember>() {
           @Override
           public void write(JsonWriter out, MaintainerMember value) throws IOException {
           ...
           @Override
           public MaintainerMember read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MaintainerMember instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MaintainerMember given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MaintainerMember
   * @throws IOException if the JSON string is invalid with respect to MaintainerMember
   */
  public static MaintainerMember fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MaintainerMember.class);
  }

  /**
   * Convert an instance of MaintainerMember to an JSON string
   *
   * @return JSON string
   */
