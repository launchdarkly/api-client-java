...
public class DependentMetricGroupRep {
  ...
  public DependentMetricGroupRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public DependentMetricGroupRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DependentMetricGroupRep kind(@javax.annotation.Nonnull KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public DependentMetricGroupRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public DependentMetricGroupRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the DependentMetricGroupRep instance itself
   */
  public DependentMetricGroupRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DependentMetricGroupRep dependentMetricGroupRep = (DependentMetricGroupRep) o;
    return Objects.equals(this.key, dependentMetricGroupRep.key) &&
        Objects.equals(this.name, dependentMetricGroupRep.name) &&
        Objects.equals(this.kind, dependentMetricGroupRep.kind) &&
        Objects.equals(this.links, dependentMetricGroupRep.links)&&
        Objects.equals(this.additionalProperties, dependentMetricGroupRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, kind, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DependentMetricGroupRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "kind", "_links"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DependentMetricGroupRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DependentMetricGroupRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DependentMetricGroupRep is not found in the empty JSON string", DependentMetricGroupRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DependentMetricGroupRep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DependentMetricGroupRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DependentMetricGroupRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DependentMetricGroupRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DependentMetricGroupRep.class));

       return (TypeAdapter<T>) new TypeAdapter<DependentMetricGroupRep>() {
           @Override
           public void write(JsonWriter out, DependentMetricGroupRep value) throws IOException {
           ...
           @Override
           public DependentMetricGroupRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DependentMetricGroupRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of DependentMetricGroupRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DependentMetricGroupRep
   * @throws IOException if the JSON string is invalid with respect to DependentMetricGroupRep
   */
  public static DependentMetricGroupRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DependentMetricGroupRep.class);
  }

  /**
   * Convert an instance of DependentMetricGroupRep to an JSON string
   *
   * @return JSON string
   */
