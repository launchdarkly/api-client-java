...
import com.launchdarkly.api.model.LayerConfigurationRep;
...
public class LayerRep {
  ...
  @javax.annotation.Nullable
  private Map<String, LayerConfigurationRep> environments = new HashMap<>();

  public LayerRep() {
  }

  public LayerRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public LayerRep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public LayerRep description(@javax.annotation.Nonnull String description) {
  ...
  public LayerRep createdAt(@javax.annotation.Nonnull Long createdAt) {
  ...
  public LayerRep randomizationUnit(@javax.annotation.Nullable String randomizationUnit) {
  ...
  public LayerRep environments(@javax.annotation.Nullable Map<String, LayerConfigurationRep> environments) {
    this.environments = environments;
    return this;
  }

  public LayerRep putEnvironmentsItem(String key, LayerConfigurationRep environmentsItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, LayerConfigurationRep> getEnvironments() {
    return environments;
  }

  public void setEnvironments(@javax.annotation.Nullable Map<String, LayerConfigurationRep> environments) {
    this.environments = environments;
  }
   ...
   * @return the LayerRep instance itself
   */
  public LayerRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LayerRep layerRep = (LayerRep) o;
    return Objects.equals(this.key, layerRep.key) &&
        Objects.equals(this.name, layerRep.name) &&
        Objects.equals(this.description, layerRep.description) &&
        Objects.equals(this.createdAt, layerRep.createdAt) &&
        Objects.equals(this.randomizationUnit, layerRep.randomizationUnit) &&
        Objects.equals(this.environments, layerRep.environments)&&
        Objects.equals(this.additionalProperties, layerRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, createdAt, randomizationUnit, environments, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LayerRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "description", "createdAt", "randomizationUnit", "environments"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "name", "description", "createdAt"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LayerRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LayerRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LayerRep is not found in the empty JSON string", LayerRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LayerRep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LayerRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LayerRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LayerRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LayerRep.class));

       return (TypeAdapter<T>) new TypeAdapter<LayerRep>() {
           @Override
           public void write(JsonWriter out, LayerRep value) throws IOException {
           ...
           @Override
           public LayerRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             LayerRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of LayerRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LayerRep
   * @throws IOException if the JSON string is invalid with respect to LayerRep
   */
  public static LayerRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LayerRep.class);
  }

  /**
   * Convert an instance of LayerRep to an JSON string
   *
   * @return JSON string
   */
