...
public class FeatureFlag {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("_maintainerTeam") != null && !jsonObj.get("_maintainerTeam").isJsonNull()) {
        MaintainerTeam.validateJsonElement(jsonObj.get("_maintainerTeam"));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("goalIds") != null && !jsonObj.get("goalIds").isJsonNull() && !jsonObj.get("goalIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `goalIds` to be an array in the JSON string but got `%s`", jsonObj.get("goalIds").toString()));
      }
      ...
      if ((jsonObj.get("_purpose") != null && !jsonObj.get("_purpose").isJsonNull()) && !jsonObj.get("_purpose").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_purpose` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_purpose").toString()));
      }
      ...
      if (jsonObj.get("migrationSettings") != null && !jsonObj.get("migrationSettings").isJsonNull()) {
        FlagMigrationSettingsRep.validateJsonElement(jsonObj.get("migrationSettings"));
      }
  }
