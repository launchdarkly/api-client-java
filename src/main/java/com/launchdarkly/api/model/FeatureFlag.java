...
public class FeatureFlag {
  ...
  private BigDecimal archivedDate = null;
  ...
  **/
  ...
  public FeatureFlag archivedDate(BigDecimal archivedDate) {
   ...
   * @return archivedDate
  **/
  @ApiModelProperty(example = "1.44365223259E12", value = "A unix epoch time in milliseconds specifying the archived time of this flag.")
  public BigDecimal getArchivedDate() {
    return archivedDate;
  }

  public void setArchivedDate(BigDecimal archivedDate) {
    this.archivedDate = archivedDate;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, kind, creationDate, includeInSnippet, temporary, maintainerId, tags, variations, goalIds, version, customProperties, links, maintainer, environments, archivedDate, archived, defaults);
  }
