...
public class FeatureFlag {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, kind, creationDate, includeInSnippet, temporary, maintainerId, tags, variations, goalIds, version, customProperties, links, maintainer, environments, archivedDate, archived);
  }
