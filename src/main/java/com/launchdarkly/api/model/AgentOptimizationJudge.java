...
public class AgentOptimizationJudge {
  ...
  public AgentOptimizationJudge key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public AgentOptimizationJudge threshold(@javax.annotation.Nonnull Double threshold) {
   ...
   * @return the AgentOptimizationJudge instance itself
   */
  public AgentOptimizationJudge putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AgentOptimizationJudge agentOptimizationJudge = (AgentOptimizationJudge) o;
    return Objects.equals(this.key, agentOptimizationJudge.key) &&
        Objects.equals(this.threshold, agentOptimizationJudge.threshold)&&
        Objects.equals(this.additionalProperties, agentOptimizationJudge.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, threshold, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AgentOptimizationJudge {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "threshold"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "threshold"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentOptimizationJudge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentOptimizationJudge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentOptimizationJudge is not found in the empty JSON string", AgentOptimizationJudge.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentOptimizationJudge.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentOptimizationJudge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentOptimizationJudge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentOptimizationJudge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentOptimizationJudge.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentOptimizationJudge>() {
           @Override
           public void write(JsonWriter out, AgentOptimizationJudge value) throws IOException {
           ...
           @Override
           public AgentOptimizationJudge read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentOptimizationJudge instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentOptimizationJudge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentOptimizationJudge
   * @throws IOException if the JSON string is invalid with respect to AgentOptimizationJudge
   */
  public static AgentOptimizationJudge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentOptimizationJudge.class);
  }

  /**
   * Convert an instance of AgentOptimizationJudge to an JSON string
   *
   * @return JSON string
   */
