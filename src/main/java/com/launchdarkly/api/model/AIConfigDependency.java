...
public class AIConfigDependency {
  ...
  public AIConfigDependency type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AIConfigDependency key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
   ...
   * @return the AIConfigDependency instance itself
   */
  public AIConfigDependency putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigDependency aiConfigDependency = (AIConfigDependency) o;
    return Objects.equals(this.type, aiConfigDependency.type) &&
        Objects.equals(this.key, aiConfigDependency.key)&&
        Objects.equals(this.additionalProperties, aiConfigDependency.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AIConfigDependency {\n");
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "key"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigDependency
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigDependency.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigDependency is not found in the empty JSON string", AIConfigDependency.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AIConfigDependency.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigDependency.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigDependency' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigDependency> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigDependency.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigDependency>() {
           @Override
           public void write(JsonWriter out, AIConfigDependency value) throws IOException {
           ...
           @Override
           public AIConfigDependency read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigDependency instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigDependency given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigDependency
   * @throws IOException if the JSON string is invalid with respect to AIConfigDependency
   */
  public static AIConfigDependency fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigDependency.class);
  }

  /**
   * Convert an instance of AIConfigDependency to an JSON string
   *
   * @return JSON string
   */
