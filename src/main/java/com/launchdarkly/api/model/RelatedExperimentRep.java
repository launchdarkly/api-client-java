...
public class RelatedExperimentRep {
  ...
  public RelatedExperimentRep key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RelatedExperimentRep name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RelatedExperimentRep environment(@javax.annotation.Nullable String environment) {
   ...
   * @return the RelatedExperimentRep instance itself
   */
  public RelatedExperimentRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RelatedExperimentRep relatedExperimentRep = (RelatedExperimentRep) o;
    return Objects.equals(this.key, relatedExperimentRep.key) &&
        Objects.equals(this.name, relatedExperimentRep.name) &&
        Objects.equals(this.environment, relatedExperimentRep.environment)&&
        Objects.equals(this.additionalProperties, relatedExperimentRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, name, environment, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RelatedExperimentRep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "name", "environment"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RelatedExperimentRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelatedExperimentRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelatedExperimentRep is not found in the empty JSON string", RelatedExperimentRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RelatedExperimentRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RelatedExperimentRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RelatedExperimentRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RelatedExperimentRep.class));

       return (TypeAdapter<T>) new TypeAdapter<RelatedExperimentRep>() {
           @Override
           public void write(JsonWriter out, RelatedExperimentRep value) throws IOException {
           ...
           @Override
           public RelatedExperimentRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RelatedExperimentRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of RelatedExperimentRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RelatedExperimentRep
   * @throws IOException if the JSON string is invalid with respect to RelatedExperimentRep
   */
  public static RelatedExperimentRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RelatedExperimentRep.class);
  }

  /**
   * Convert an instance of RelatedExperimentRep to an JSON string
   *
   * @return JSON string
   */
