...
public class ContextInstanceRecord {
  ...
  @SerializedName(SERIALIZED_NAME_ANONYMOUS_KINDS)
  @javax.annotation.Nullable
  private List<String> anonymousKinds = new ArrayList<>();
  ...
  public ContextInstanceRecord lastSeen(@javax.annotation.Nullable OffsetDateTime lastSeen) {
  ...
  public ContextInstanceRecord id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ContextInstanceRecord applicationId(@javax.annotation.Nullable String applicationId) {
  ...
  public ContextInstanceRecord anonymousKinds(@javax.annotation.Nullable List<String> anonymousKinds) {
  ...
  public ContextInstanceRecord addAnonymousKindsItem(String anonymousKindsItem) {
    if (this.anonymousKinds == null) {
      this.anonymousKinds = new ArrayList<>();
    }
  ...
  public void setAnonymousKinds(@javax.annotation.Nullable List<String> anonymousKinds) {
    this.anonymousKinds = anonymousKinds;
  }


  public ContextInstanceRecord context(@javax.annotation.Nullable Object context) {
  ...
  public ContextInstanceRecord links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public ContextInstanceRecord access(@javax.annotation.Nullable Access access) {
    this.access = access;
    return this;
  }
   ...
   * @return the ContextInstanceRecord instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lastSeen, contextInstanceRecord.lastSeen) &&
        Objects.equals(this.id, contextInstanceRecord.id) &&
        Objects.equals(this.applicationId, contextInstanceRecord.applicationId) &&
        Objects.equals(this.anonymousKinds, contextInstanceRecord.anonymousKinds) &&
        Objects.equals(this.context, contextInstanceRecord.context) &&
        Objects.equals(this.links, contextInstanceRecord.links) &&
        Objects.equals(this.access, contextInstanceRecord.access)&&
        Objects.equals(this.additionalProperties, contextInstanceRecord.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lastSeen, id, applicationId, anonymousKinds, context, links, access, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    anonymousKinds: ").append(toIndentedString(anonymousKinds)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("lastSeen", "id", "applicationId", "anonymousKinds", "context", "_links", "_access"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "context"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextInstanceRecord
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextInstanceRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextInstanceRecord is not found in the empty JSON string", ContextInstanceRecord.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContextInstanceRecord.openapiRequiredFields) {
      ...
      if (jsonObj.get("anonymousKinds") != null && !jsonObj.get("anonymousKinds").isJsonNull() && !jsonObj.get("anonymousKinds").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `anonymousKinds` to be an array in the JSON string but got `%s`", jsonObj.get("anonymousKinds").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContextInstanceRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContextInstanceRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContextInstanceRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContextInstanceRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<ContextInstanceRecord>() {
           @Override
           ...
           public ContextInstanceRecord read(JsonReader in) throws IOException {
             ...
             ContextInstanceRecord instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of ContextInstanceRecord
   * @throws IOException if the JSON string is invalid with respect to ContextInstanceRecord
   */
  public static ContextInstanceRecord fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContextInstanceRecord.class);
  }
