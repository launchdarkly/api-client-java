...
public class InsightPeriod {
  ...
  public InsightPeriod startTime(@javax.annotation.Nonnull Long startTime) {
  ...
  public InsightPeriod endTime(@javax.annotation.Nonnull Long endTime) {
   ...
   * @return the InsightPeriod instance itself
   */
  public InsightPeriod putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InsightPeriod insightPeriod = (InsightPeriod) o;
    return Objects.equals(this.startTime, insightPeriod.startTime) &&
        Objects.equals(this.endTime, insightPeriod.endTime)&&
        Objects.equals(this.additionalProperties, insightPeriod.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InsightPeriod
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightPeriod.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightPeriod is not found in the empty JSON string", InsightPeriod.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InsightPeriod.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InsightPeriod.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InsightPeriod' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InsightPeriod> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InsightPeriod.class));

       return (TypeAdapter<T>) new TypeAdapter<InsightPeriod>() {
           @Override
           public void write(JsonWriter out, InsightPeriod value) throws IOException {
           ...
           @Override
           public InsightPeriod read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             InsightPeriod instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of InsightPeriod given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InsightPeriod
   * @throws IOException if the JSON string is invalid with respect to InsightPeriod
   */
  public static InsightPeriod fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InsightPeriod.class);
  }

  /**
   * Convert an instance of InsightPeriod to an JSON string
   *
   * @return JSON string
   */
