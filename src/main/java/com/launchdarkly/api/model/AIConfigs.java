...
public class AIConfigs {
  ...
  private List<AIConfig> items = new ArrayList<>();
  ...
  public AIConfigs links(@javax.annotation.Nullable PaginatedLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AIConfigs items(@javax.annotation.Nonnull List<AIConfig> items) {
    this.items = items;
    return this;
  }

  public AIConfigs addItemsItem(AIConfig itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<AIConfig> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<AIConfig> items) {
    this.items = items;
  }


  public AIConfigs totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the AIConfigs instance itself
   */
  public AIConfigs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigs aiConfigs = (AIConfigs) o;
    return Objects.equals(this.links, aiConfigs.links) &&
        Objects.equals(this.items, aiConfigs.items) &&
        Objects.equals(this.totalCount, aiConfigs.totalCount)&&
        Objects.equals(this.additionalProperties, aiConfigs.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigs is not found in the empty JSON string", AIConfigs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AIConfigs.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        AIConfig.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigs.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigs>() {
           @Override
           public void write(JsonWriter out, AIConfigs value) throws IOException {
           ...
           @Override
           public AIConfigs read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigs instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigs
   * @throws IOException if the JSON string is invalid with respect to AIConfigs
   */
  public static AIConfigs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigs.class);
  }

  /**
   * Convert an instance of AIConfigs to an JSON string
   *
   * @return JSON string
   */
