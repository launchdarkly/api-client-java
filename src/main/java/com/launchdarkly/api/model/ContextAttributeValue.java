...
public class ContextAttributeValue {
  ...
  public ContextAttributeValue name(@javax.annotation.Nullable Object name) {
    this.name = name;
    return this;
  }
  ...
  public ContextAttributeValue weight(@javax.annotation.Nonnull Integer weight) {
    this.weight = weight;
    return this;
  }
   ...
   * @return the ContextAttributeValue instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "weight"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextAttributeValue
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextAttributeValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextAttributeValue is not found in the empty JSON string", ContextAttributeValue.openapiRequiredFields.toString()));
        }
      }
