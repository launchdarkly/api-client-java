...
public class IntegrationDeliveryConfiguration {
  ...
  public IntegrationDeliveryConfiguration links(@javax.annotation.Nonnull IntegrationDeliveryConfigurationLinks links) {
    this.links = links;
    return this;
  }
  ...
  public void setLinks(@javax.annotation.Nonnull IntegrationDeliveryConfigurationLinks links) {
    this.links = links;
  }


  public IntegrationDeliveryConfiguration id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public IntegrationDeliveryConfiguration integrationKey(@javax.annotation.Nonnull String integrationKey) {
  ...
  public void setIntegrationKey(@javax.annotation.Nonnull String integrationKey) {
    this.integrationKey = integrationKey;
  }


  public IntegrationDeliveryConfiguration projectKey(@javax.annotation.Nonnull String projectKey) {
  ...
  public IntegrationDeliveryConfiguration environmentKey(@javax.annotation.Nonnull String environmentKey) {
  ...
  public IntegrationDeliveryConfiguration config(@javax.annotation.Nonnull Map<String, Object> config) {
    this.config = config;
    return this;
  }
  ...
  public IntegrationDeliveryConfiguration on(@javax.annotation.Nonnull Boolean on) {
    this.on = on;
    return this;
  }
  ...
  public IntegrationDeliveryConfiguration tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public IntegrationDeliveryConfiguration name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public IntegrationDeliveryConfiguration version(@javax.annotation.Nonnull Integer version) {
  ...
  public IntegrationDeliveryConfiguration access(@javax.annotation.Nullable Access access) {
    this.access = access;
    return this;
  }
   ...
   * @return the IntegrationDeliveryConfiguration instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, integrationDeliveryConfiguration.links) &&
        Objects.equals(this.id, integrationDeliveryConfiguration.id) &&
        Objects.equals(this.integrationKey, integrationDeliveryConfiguration.integrationKey) &&
        Objects.equals(this.projectKey, integrationDeliveryConfiguration.projectKey) &&
        Objects.equals(this.environmentKey, integrationDeliveryConfiguration.environmentKey) &&
        Objects.equals(this.config, integrationDeliveryConfiguration.config) &&
        Objects.equals(this.on, integrationDeliveryConfiguration.on) &&
        Objects.equals(this.tags, integrationDeliveryConfiguration.tags) &&
        Objects.equals(this.name, integrationDeliveryConfiguration.name) &&
        Objects.equals(this.version, integrationDeliveryConfiguration.version) &&
        Objects.equals(this.access, integrationDeliveryConfiguration.access)&&
        Objects.equals(this.additionalProperties, integrationDeliveryConfiguration.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, id, integrationKey, projectKey, environmentKey, config, on, tags, name, version, access, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "_id", "integrationKey", "projectKey", "environmentKey", "config", "on", "tags", "name", "version", "_access"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_links", "_id", "integrationKey", "projectKey", "environmentKey", "config", "on", "tags", "name", "version"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntegrationDeliveryConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationDeliveryConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationDeliveryConfiguration is not found in the empty JSON string", IntegrationDeliveryConfiguration.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IntegrationDeliveryConfiguration.openapiRequiredFields) {
      ...
      IntegrationDeliveryConfigurationLinks.validateJsonElement(jsonObj.get("_links"));
      ...
      if (!jsonObj.get("integrationKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `integrationKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("integrationKey").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegrationDeliveryConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegrationDeliveryConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegrationDeliveryConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegrationDeliveryConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegrationDeliveryConfiguration>() {
           @Override
           ...
           public IntegrationDeliveryConfiguration read(JsonReader in) throws IOException {
             ...
             IntegrationDeliveryConfiguration instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of IntegrationDeliveryConfiguration
   * @throws IOException if the JSON string is invalid with respect to IntegrationDeliveryConfiguration
   */
  public static IntegrationDeliveryConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegrationDeliveryConfiguration.class);
  }
