...
public class StageInput {
   ...
   * @return the StageInput instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StageInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StageInput is not found in the empty JSON string", StageInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("conditions") != null && !jsonObj.get("conditions").isJsonNull()) {
        ...
        if (jsonArrayconditions != null) {
          ...
          for (int i = 0; i < jsonArrayconditions.size(); i++) {
            ConditionInput.validateJsonElement(jsonArrayconditions.get(i));
          };
        }
      }
      // validate the optional field `action`
      if (jsonObj.get("action") != null && !jsonObj.get("action").isJsonNull()) {
        ActionInput.validateJsonElement(jsonObj.get("action"));
      }
  }
