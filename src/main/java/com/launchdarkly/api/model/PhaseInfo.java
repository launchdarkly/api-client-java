...
public class PhaseInfo {
  ...
  public static final String SERIALIZED_NAME_RELEASE_COUNT = "releaseCount";
  ...
  public PhaseInfo id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public PhaseInfo name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public PhaseInfo releaseCount(@javax.annotation.Nonnull Integer releaseCount) {
  ...
  public void setReleaseCount(@javax.annotation.Nonnull Integer releaseCount) {
    this.releaseCount = releaseCount;
  }
   ...
   * @return the PhaseInfo instance itself
   */
  public PhaseInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, phaseInfo.id) &&
        Objects.equals(this.name, phaseInfo.name) &&
        Objects.equals(this.releaseCount, phaseInfo.releaseCount)&&
        Objects.equals(this.additionalProperties, phaseInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, releaseCount, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PhaseInfo {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "name", "releaseCount"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_id", "name", "releaseCount"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PhaseInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PhaseInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PhaseInfo is not found in the empty JSON string", PhaseInfo.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PhaseInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PhaseInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PhaseInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PhaseInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PhaseInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<PhaseInfo>() {
           @Override
           public void write(JsonWriter out, PhaseInfo value) throws IOException {
           ...
           @Override
           public PhaseInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PhaseInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PhaseInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PhaseInfo
   * @throws IOException if the JSON string is invalid with respect to PhaseInfo
   */
  public static PhaseInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PhaseInfo.class);
  }

  /**
   * Convert an instance of PhaseInfo to an JSON string
   *
   * @return JSON string
   */
