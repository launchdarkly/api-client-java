...
public class FeatureFlagScheduledChange {
  ...
  public static final String SERIALIZED_NAME_MAINTAINER_SERVICE_TOKEN_ID = "_maintainerServiceTokenId";
  @SerializedName(SERIALIZED_NAME_MAINTAINER_SERVICE_TOKEN_ID)
  @javax.annotation.Nullable
  private String maintainerServiceTokenId;
  ...
  public FeatureFlagScheduledChange maintainerServiceTokenId(@javax.annotation.Nullable String maintainerServiceTokenId) {
    this.maintainerServiceTokenId = maintainerServiceTokenId;
    return this;
  }

  /**
   * The ID of the service token that created or updated this scheduled change
   * @return maintainerServiceTokenId
   */
  @javax.annotation.Nullable
  public String getMaintainerServiceTokenId() {
    return maintainerServiceTokenId;
  }

  public void setMaintainerServiceTokenId(@javax.annotation.Nullable String maintainerServiceTokenId) {
    this.maintainerServiceTokenId = maintainerServiceTokenId;
  }
  ...
  public FeatureFlagScheduledChange addInstructionsItem(Map<String, Object> instructionsItem) {
  ...
  public FeatureFlagScheduledChange putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the FeatureFlagScheduledChange instance itself
   */
  public FeatureFlagScheduledChange putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, featureFlagScheduledChange.id) &&
        Objects.equals(this.creationDate, featureFlagScheduledChange.creationDate) &&
        Objects.equals(this.maintainerId, featureFlagScheduledChange.maintainerId) &&
        Objects.equals(this.maintainerServiceTokenId, featureFlagScheduledChange.maintainerServiceTokenId) &&
        ...
        Objects.equals(this.conflicts, featureFlagScheduledChange.conflicts) &&
        Objects.equals(this.links, featureFlagScheduledChange.links)&&
        Objects.equals(this.additionalProperties, featureFlagScheduledChange.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, creationDate, maintainerId, maintainerServiceTokenId, version, executionDate, instructions, conflicts, links, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    maintainerServiceTokenId: ").append(toIndentedString(maintainerServiceTokenId)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "_creationDate", "_maintainerId", "_maintainerServiceTokenId", "_version", "executionDate", "instructions", "conflicts", "_links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeatureFlagScheduledChange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FeatureFlagScheduledChange is not found in the empty JSON string", FeatureFlagScheduledChange.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("_maintainerServiceTokenId") != null && !jsonObj.get("_maintainerServiceTokenId").isJsonNull()) && !jsonObj.get("_maintainerServiceTokenId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_maintainerServiceTokenId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_maintainerServiceTokenId").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeatureFlagScheduledChange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeatureFlagScheduledChange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeatureFlagScheduledChange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeatureFlagScheduledChange.class));

       return (TypeAdapter<T>) new TypeAdapter<FeatureFlagScheduledChange>() {
           @Override
           public void write(JsonWriter out, FeatureFlagScheduledChange value) throws IOException {
           ...
           @Override
           public FeatureFlagScheduledChange read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FeatureFlagScheduledChange instance = thisAdapter.fromJsonTree(jsonObj);
