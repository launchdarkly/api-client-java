...
public class IntegrationStatus {
  ...
  public IntegrationStatus display(@javax.annotation.Nonnull String display) {
  ...
  public IntegrationStatus value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
   ...
   * @return the IntegrationStatus instance itself
   */
  public IntegrationStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.display, integrationStatus.display) &&
        Objects.equals(this.value, integrationStatus.value)&&
        Objects.equals(this.additionalProperties, integrationStatus.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(display, value, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("display", "value"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("display", "value"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntegrationStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IntegrationStatus is not found in the empty JSON string", IntegrationStatus.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IntegrationStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegrationStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegrationStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegrationStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegrationStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegrationStatus>() {
           @Override
           public void write(JsonWriter out, IntegrationStatus value) throws IOException {
           ...
           @Override
           public IntegrationStatus read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             IntegrationStatus instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of IntegrationStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntegrationStatus
   * @throws IOException if the JSON string is invalid with respect to IntegrationStatus
   */
  public static IntegrationStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegrationStatus.class);
  }

  /**
   * Convert an instance of IntegrationStatus to an JSON string
   *
   * @return JSON string
   */
