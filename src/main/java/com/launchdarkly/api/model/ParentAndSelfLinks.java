...
import com.launchdarkly.api.model.CoreLink;
...
public class ParentAndSelfLinks {
  ...
  @javax.annotation.Nonnull
  private CoreLink parent;

  public ParentAndSelfLinks() {
  }

  public ParentAndSelfLinks self(@javax.annotation.Nonnull CoreLink self) {
    this.self = self;
    return this;
  }
  ...
  public ParentAndSelfLinks parent(@javax.annotation.Nonnull CoreLink parent) {
    this.parent = parent;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public CoreLink getParent() {
    return parent;
  }

  public void setParent(@javax.annotation.Nonnull CoreLink parent) {
    this.parent = parent;
  }
   ...
   * @return the ParentAndSelfLinks instance itself
   */
  public ParentAndSelfLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ParentAndSelfLinks parentAndSelfLinks = (ParentAndSelfLinks) o;
    return Objects.equals(this.self, parentAndSelfLinks.self) &&
        Objects.equals(this.parent, parentAndSelfLinks.parent)&&
        Objects.equals(this.additionalProperties, parentAndSelfLinks.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParentAndSelfLinks {\n");
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("self", "parent"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ParentAndSelfLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParentAndSelfLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ParentAndSelfLinks is not found in the empty JSON string", ParentAndSelfLinks.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ParentAndSelfLinks.openapiRequiredFields) {
      ...
      CoreLink.validateJsonElement(jsonObj.get("self"));
      // validate the required field `parent`
      CoreLink.validateJsonElement(jsonObj.get("parent"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParentAndSelfLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParentAndSelfLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParentAndSelfLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParentAndSelfLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<ParentAndSelfLinks>() {
           @Override
           public void write(JsonWriter out, ParentAndSelfLinks value) throws IOException {
           ...
           @Override
           public ParentAndSelfLinks read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ParentAndSelfLinks instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ParentAndSelfLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ParentAndSelfLinks
   * @throws IOException if the JSON string is invalid with respect to ParentAndSelfLinks
   */
  public static ParentAndSelfLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParentAndSelfLinks.class);
  }

  /**
   * Convert an instance of ParentAndSelfLinks to an JSON string
   *
   * @return JSON string
   */
