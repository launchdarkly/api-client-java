...
public class BigSegmentStoreStatus {
   ...
   * @return the BigSegmentStoreStatus instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.available, bigSegmentStoreStatus.available) &&
        Objects.equals(this.potentiallyStale, bigSegmentStoreStatus.potentiallyStale) &&
        Objects.equals(this.lastSync, bigSegmentStoreStatus.lastSync) &&
        Objects.equals(this.lastError, bigSegmentStoreStatus.lastError) &&
        Objects.equals(this.errors, bigSegmentStoreStatus.errors)&&
        Objects.equals(this.additionalProperties, bigSegmentStoreStatus.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(available, potentiallyStale, lastSync, lastError, errors, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    potentiallyStale: ").append(toIndentedString(potentiallyStale)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BigSegmentStoreStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BigSegmentStoreStatus is not found in the empty JSON string", BigSegmentStoreStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            StoreIntegrationError.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BigSegmentStoreStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BigSegmentStoreStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BigSegmentStoreStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BigSegmentStoreStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<BigSegmentStoreStatus>() {
           @Override
           ...
           public BigSegmentStoreStatus read(JsonReader in) throws IOException {
             ...
             BigSegmentStoreStatus instance = thisAdapter.fromJsonTree(jsonObj);
