...
public class TeamProjects {
  ...
  public TeamProjects totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public TeamProjects items(@javax.annotation.Nullable List<ProjectSummary> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nullable List<ProjectSummary> items) {
    this.items = items;
  }
   ...
   * @return the TeamProjects instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamProjects
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamProjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TeamProjects is not found in the empty JSON string", TeamProjects.openapiRequiredFields.toString()));
        }
      }
