...
public class OptionsArray {
  ...
  public OptionsArray label(@javax.annotation.Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public OptionsArray value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
   ...
   * @return the OptionsArray instance itself
   */
  public OptionsArray putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OptionsArray optionsArray = (OptionsArray) o;
    return Objects.equals(this.label, optionsArray.label) &&
        Objects.equals(this.value, optionsArray.value)&&
        Objects.equals(this.additionalProperties, optionsArray.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OptionsArray
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptionsArray.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OptionsArray is not found in the empty JSON string", OptionsArray.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OptionsArray.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OptionsArray' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OptionsArray> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OptionsArray.class));

       return (TypeAdapter<T>) new TypeAdapter<OptionsArray>() {
           @Override
           public void write(JsonWriter out, OptionsArray value) throws IOException {
           ...
           @Override
           public OptionsArray read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OptionsArray instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of OptionsArray given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OptionsArray
   * @throws IOException if the JSON string is invalid with respect to OptionsArray
   */
  public static OptionsArray fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OptionsArray.class);
  }

  /**
   * Convert an instance of OptionsArray to an JSON string
   *
   * @return JSON string
   */
