...
public class OptionsArray {
  ...
  public OptionsArray label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public OptionsArray value(String value) {
    this.value = value;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptionsArray.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptionsArray is not found in the empty JSON string", OptionsArray.openapiRequiredFields.toString()));
        }
      }
