...
public class CreatePhaseInput {
  ...
  public CreatePhaseInput audiences(@javax.annotation.Nonnull List<AudiencePost> audiences) {
  ...
  public void setAudiences(@javax.annotation.Nonnull List<AudiencePost> audiences) {
    this.audiences = audiences;
  }


  public CreatePhaseInput name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreatePhaseInput _configuration(@javax.annotation.Nullable Object _configuration) {
   ...
   * @return the CreatePhaseInput instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("audiences", "name", "configuration"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("audiences", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePhaseInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePhaseInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreatePhaseInput is not found in the empty JSON string", CreatePhaseInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayaudiences.size(); i++) {
        AudiencePost.validateJsonElement(jsonArrayaudiences.get(i));
      };
