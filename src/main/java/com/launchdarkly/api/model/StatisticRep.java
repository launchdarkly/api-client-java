...
public class StatisticRep {
   ...
   * @return the StatisticRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, statisticRep.name) &&
        Objects.equals(this.type, statisticRep.type) &&
        Objects.equals(this.sourceLink, statisticRep.sourceLink) &&
        Objects.equals(this.defaultBranch, statisticRep.defaultBranch) &&
        Objects.equals(this.enabled, statisticRep.enabled) &&
        Objects.equals(this.version, statisticRep.version) &&
        Objects.equals(this.hunkCount, statisticRep.hunkCount) &&
        Objects.equals(this.fileCount, statisticRep.fileCount) &&
        Objects.equals(this.links, statisticRep.links) &&
        Objects.equals(this.latestCommitTime, statisticRep.latestCommitTime)&&
        Objects.equals(this.additionalProperties, statisticRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, type, sourceLink, defaultBranch, enabled, version, hunkCount, fileCount, links, latestCommitTime, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    hunkCount: ").append(toIndentedString(hunkCount)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatisticRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StatisticRep is not found in the empty JSON string", StatisticRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatisticRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatisticRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatisticRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatisticRep.class));

       return (TypeAdapter<T>) new TypeAdapter<StatisticRep>() {
           @Override
           ...
           public StatisticRep read(JsonReader in) throws IOException {
             ...
             StatisticRep instance = thisAdapter.fromJsonTree(jsonObj);
