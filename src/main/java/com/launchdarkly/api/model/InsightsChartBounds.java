...
public class InsightsChartBounds {
  ...
  public InsightsChartBounds name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public InsightsChartBounds value(@javax.annotation.Nonnull Long value) {
    this.value = value;
    return this;
  }
   ...
   * @return the InsightsChartBounds instance itself
   */
  public InsightsChartBounds putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InsightsChartBounds insightsChartBounds = (InsightsChartBounds) o;
    return Objects.equals(this.name, insightsChartBounds.name) &&
        Objects.equals(this.value, insightsChartBounds.value)&&
        Objects.equals(this.additionalProperties, insightsChartBounds.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InsightsChartBounds {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InsightsChartBounds
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightsChartBounds.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightsChartBounds is not found in the empty JSON string", InsightsChartBounds.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InsightsChartBounds.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InsightsChartBounds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InsightsChartBounds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InsightsChartBounds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InsightsChartBounds.class));

       return (TypeAdapter<T>) new TypeAdapter<InsightsChartBounds>() {
           @Override
           public void write(JsonWriter out, InsightsChartBounds value) throws IOException {
           ...
           @Override
           public InsightsChartBounds read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             InsightsChartBounds instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of InsightsChartBounds given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InsightsChartBounds
   * @throws IOException if the JSON string is invalid with respect to InsightsChartBounds
   */
  public static InsightsChartBounds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InsightsChartBounds.class);
  }

  /**
   * Convert an instance of InsightsChartBounds to an JSON string
   *
   * @return JSON string
   */
