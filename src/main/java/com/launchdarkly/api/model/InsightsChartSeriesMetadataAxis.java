...
public class InsightsChartSeriesMetadataAxis {
  ...
  public InsightsChartSeriesMetadataAxis unit(@javax.annotation.Nonnull String unit) {
    this.unit = unit;
    return this;
  }
   ...
   * @return the InsightsChartSeriesMetadataAxis instance itself
   */
  public InsightsChartSeriesMetadataAxis putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InsightsChartSeriesMetadataAxis insightsChartSeriesMetadataAxis = (InsightsChartSeriesMetadataAxis) o;
    return Objects.equals(this.unit, insightsChartSeriesMetadataAxis.unit)&&
        Objects.equals(this.additionalProperties, insightsChartSeriesMetadataAxis.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InsightsChartSeriesMetadataAxis {\n");
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("unit"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InsightsChartSeriesMetadataAxis
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightsChartSeriesMetadataAxis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightsChartSeriesMetadataAxis is not found in the empty JSON string", InsightsChartSeriesMetadataAxis.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InsightsChartSeriesMetadataAxis.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InsightsChartSeriesMetadataAxis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InsightsChartSeriesMetadataAxis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InsightsChartSeriesMetadataAxis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InsightsChartSeriesMetadataAxis.class));

       return (TypeAdapter<T>) new TypeAdapter<InsightsChartSeriesMetadataAxis>() {
           @Override
           public void write(JsonWriter out, InsightsChartSeriesMetadataAxis value) throws IOException {
           ...
           @Override
           public InsightsChartSeriesMetadataAxis read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             InsightsChartSeriesMetadataAxis instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of InsightsChartSeriesMetadataAxis given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InsightsChartSeriesMetadataAxis
   * @throws IOException if the JSON string is invalid with respect to InsightsChartSeriesMetadataAxis
   */
  public static InsightsChartSeriesMetadataAxis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InsightsChartSeriesMetadataAxis.class);
  }

  /**
   * Convert an instance of InsightsChartSeriesMetadataAxis to an JSON string
   *
   * @return JSON string
   */
