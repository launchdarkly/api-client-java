...
public class MetricGroupRep {
  ...
  public MetricGroupRep activeExperimentCount(@javax.annotation.Nullable Integer activeExperimentCount) {
  ...
  public MetricGroupRep activeGuardedRolloutCount(@javax.annotation.Nullable Integer activeGuardedRolloutCount) {
   ...
   * @return the MetricGroupRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, metricGroupRep.id) &&
        Objects.equals(this.key, metricGroupRep.key) &&
        Objects.equals(this.name, metricGroupRep.name) &&
        Objects.equals(this.kind, metricGroupRep.kind) &&
        Objects.equals(this.description, metricGroupRep.description) &&
        Objects.equals(this.links, metricGroupRep.links) &&
        Objects.equals(this.access, metricGroupRep.access) &&
        Objects.equals(this.tags, metricGroupRep.tags) &&
        Objects.equals(this.creationDate, metricGroupRep.creationDate) &&
        Objects.equals(this.lastModified, metricGroupRep.lastModified) &&
        Objects.equals(this.maintainer, metricGroupRep.maintainer) &&
        Objects.equals(this.metrics, metricGroupRep.metrics) &&
        Objects.equals(this.version, metricGroupRep.version) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricGroupRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricGroupRep is not found in the empty JSON string", MetricGroupRep.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricGroupRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricGroupRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricGroupRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricGroupRep.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricGroupRep>() {
           @Override
           ...
           public MetricGroupRep read(JsonReader in) throws IOException {
             ...
             MetricGroupRep instance = thisAdapter.fromJsonTree(jsonObj);
