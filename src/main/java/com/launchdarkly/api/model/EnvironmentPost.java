...
public class EnvironmentPost {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Secure mode ensures that a user of the client-side SDK cannot impersonate another user.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Require confirmation for all flag and segment changes via the UI in this environment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Require comments for all flag and segment changes via the UI in this environment.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, key, color, defaultTtl, secureMode, defaultTrackEvents, confirmChanges, requireComments, tags);
  }
