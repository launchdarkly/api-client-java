...
public class EnvironmentPost {
   ...
   * @return the EnvironmentPost instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, environmentPost.name) &&
        ...
        Objects.equals(this.critical, environmentPost.critical)&&
        Objects.equals(this.additionalProperties, environmentPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, key, color, defaultTtl, secureMode, defaultTrackEvents, confirmChanges, requireComments, tags, source, critical, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnvironmentPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EnvironmentPost is not found in the empty JSON string", EnvironmentPost.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        SourceEnv.validateJsonElement(jsonObj.get("source"));
      }
  }
