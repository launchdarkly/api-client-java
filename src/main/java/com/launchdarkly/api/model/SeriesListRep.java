...
public class SeriesListRep {
   ...
   * @return the SeriesListRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SeriesListRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SeriesListRep is not found in the empty JSON string", SeriesListRep.openapiRequiredFields.toString()));
        }
      }
