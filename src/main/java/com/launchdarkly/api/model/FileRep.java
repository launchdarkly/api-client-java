...
public class FileRep {
   ...
   * @return the FileRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FileRep is not found in the empty JSON string", FileRep.openapiRequiredFields.toString()));
        }
      }
