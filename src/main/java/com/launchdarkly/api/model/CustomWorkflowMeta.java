...
public class CustomWorkflowMeta {
  ...
  public CustomWorkflowMeta name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CustomWorkflowMeta stage(@javax.annotation.Nullable CustomWorkflowStageMeta stage) {
    this.stage = stage;
    return this;
  }
  ...
  public void setStage(@javax.annotation.Nullable CustomWorkflowStageMeta stage) {
    this.stage = stage;
  }
   ...
   * @return the CustomWorkflowMeta instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "stage"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomWorkflowMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomWorkflowMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomWorkflowMeta is not found in the empty JSON string", CustomWorkflowMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("stage") != null && !jsonObj.get("stage").isJsonNull()) {
        CustomWorkflowStageMeta.validateJsonElement(jsonObj.get("stage"));
      }
  }
