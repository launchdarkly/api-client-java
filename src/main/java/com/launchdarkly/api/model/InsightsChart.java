...
public class InsightsChart {
   ...
   * @return the InsightsChart instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InsightsChart.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InsightsChart is not found in the empty JSON string", InsightsChart.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayseries.size(); i++) {
        InsightsChartSeries.validateJsonElement(jsonArrayseries.get(i));
      };
  }
