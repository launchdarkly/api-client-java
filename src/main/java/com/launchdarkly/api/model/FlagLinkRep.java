...
public class FlagLinkRep {
   ...
   * @return the FlagLinkRep instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, flagLinkRep.links) &&
        Objects.equals(this.key, flagLinkRep.key) &&
        Objects.equals(this.integrationKey, flagLinkRep.integrationKey) &&
        Objects.equals(this.id, flagLinkRep.id) &&
        Objects.equals(this.deepLink, flagLinkRep.deepLink) &&
        Objects.equals(this.timestamp, flagLinkRep.timestamp) &&
        Objects.equals(this.title, flagLinkRep.title) &&
        Objects.equals(this.description, flagLinkRep.description) &&
        Objects.equals(this.metadata, flagLinkRep.metadata) &&
        Objects.equals(this.createdAt, flagLinkRep.createdAt) &&
        Objects.equals(this.member, flagLinkRep.member)&&
        Objects.equals(this.additionalProperties, flagLinkRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(links, key, integrationKey, id, deepLink, timestamp, title, description, metadata, createdAt, member, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagLinkRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagLinkRep is not found in the empty JSON string", FlagLinkRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("_deepLink").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_deepLink` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_deepLink").toString()));
      }
      ...
      if (jsonObj.get("_member") != null && !jsonObj.get("_member").isJsonNull()) {
        FlagLinkMember.validateJsonElement(jsonObj.get("_member"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagLinkRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagLinkRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagLinkRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagLinkRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagLinkRep>() {
           @Override
           ...
           public FlagLinkRep read(JsonReader in) throws IOException {
             ...
             FlagLinkRep instance = thisAdapter.fromJsonTree(jsonObj);
