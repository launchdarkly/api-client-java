...
public class MaintainerRep {
  ...
  public MaintainerRep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public MaintainerRep kind(@javax.annotation.Nonnull KindEnum kind) {
    this.kind = kind;
    return this;
  }
   ...
   * @return the MaintainerRep instance itself
   */
  public MaintainerRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MaintainerRep maintainerRep = (MaintainerRep) o;
    return Objects.equals(this.key, maintainerRep.key) &&
        Objects.equals(this.kind, maintainerRep.kind) &&
        Objects.equals(this.member, maintainerRep.member) &&
        Objects.equals(this.team, maintainerRep.team)&&
        Objects.equals(this.additionalProperties, maintainerRep.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MaintainerRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MaintainerRep is not found in the empty JSON string", MaintainerRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MaintainerRep.openapiRequiredFields) {
      ...
      if (jsonObj.get("_team") != null && !jsonObj.get("_team").isJsonNull()) {
        MemberTeamSummaryRep.validateJsonElement(jsonObj.get("_team"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MaintainerRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MaintainerRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MaintainerRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MaintainerRep.class));

       return (TypeAdapter<T>) new TypeAdapter<MaintainerRep>() {
           @Override
           public void write(JsonWriter out, MaintainerRep value) throws IOException {
           ...
           @Override
           public MaintainerRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MaintainerRep instance = thisAdapter.fromJsonTree(jsonObj);
