...
public class WeightedVariation {
  ...
  public WeightedVariation variation(@javax.annotation.Nonnull Integer variation) {
  ...
  public WeightedVariation weight(@javax.annotation.Nonnull Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public WeightedVariation untracked(@javax.annotation.Nullable Boolean untracked) {
   ...
   * @return the WeightedVariation instance itself
   */
  public WeightedVariation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.variation, weightedVariation.variation) &&
        ...
        Objects.equals(this.untracked, weightedVariation.untracked)&&
        Objects.equals(this.additionalProperties, weightedVariation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(variation, weight, untracked, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("variation", "weight", "_untracked"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WeightedVariation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WeightedVariation is not found in the empty JSON string", WeightedVariation.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WeightedVariation>() {
           ...
           public WeightedVariation read(JsonReader in) throws IOException {
             ...
             WeightedVariation instance = thisAdapter.fromJsonTree(jsonObj);
