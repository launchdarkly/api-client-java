...
public class ExperimentTimeSeriesVariationSlice {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(value, count, cumulativeValue, cumulativeCount, conversionRate, cumulativeConversionRate, confidenceInterval, cumulativeConfidenceInterval);
  }
