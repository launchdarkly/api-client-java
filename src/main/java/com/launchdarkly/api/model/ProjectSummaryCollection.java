...
public class ProjectSummaryCollection {
  ...
  @javax.annotation.Nonnull
  private List<ProjectSummary> items = new ArrayList<>();
  ...
  public ProjectSummaryCollection totalCount(@javax.annotation.Nonnull Integer totalCount) {
  ...
  public ProjectSummaryCollection items(@javax.annotation.Nonnull List<ProjectSummary> items) {
    this.items = items;
    return this;
  }

  public ProjectSummaryCollection addItemsItem(ProjectSummary itemsItem) {
    if (this.items == null) {
  ...
  public void setItems(@javax.annotation.Nonnull List<ProjectSummary> items) {
    this.items = items;
  }


  public ProjectSummaryCollection links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public ProjectSummaryCollection putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the ProjectSummaryCollection instance itself
   */
  public ProjectSummaryCollection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectSummaryCollection projectSummaryCollection = (ProjectSummaryCollection) o;
    return Objects.equals(this.totalCount, projectSummaryCollection.totalCount) &&
        Objects.equals(this.items, projectSummaryCollection.items) &&
        Objects.equals(this.links, projectSummaryCollection.links)&&
        Objects.equals(this.additionalProperties, projectSummaryCollection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectSummaryCollection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectSummaryCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectSummaryCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectSummaryCollection is not found in the empty JSON string", ProjectSummaryCollection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectSummaryCollection.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ProjectSummary.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectSummaryCollection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectSummaryCollection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectSummaryCollection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectSummaryCollection.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectSummaryCollection>() {
           @Override
           public void write(JsonWriter out, ProjectSummaryCollection value) throws IOException {
           ...
           @Override
           public ProjectSummaryCollection read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ProjectSummaryCollection instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ProjectSummaryCollection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectSummaryCollection
   * @throws IOException if the JSON string is invalid with respect to ProjectSummaryCollection
   */
  public static ProjectSummaryCollection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectSummaryCollection.class);
  }

  /**
   * Convert an instance of ProjectSummaryCollection to an JSON string
   *
   * @return JSON string
   */
