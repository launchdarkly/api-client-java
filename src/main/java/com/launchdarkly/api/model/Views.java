...
public class Views {
  ...
  public Views links(@javax.annotation.Nullable ViewsPaginatedLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Views items(@javax.annotation.Nonnull List<View> items) {
    this.items = items;
    return this;
  }

  public Views addItemsItem(View itemsItem) {
    if (this.items == null) {
  ...
  public void setItems(@javax.annotation.Nonnull List<View> items) {
    this.items = items;
  }


  public Views totalCount(@javax.annotation.Nonnull Integer totalCount) {
   ...
   * @return the Views instance itself
   */
  public Views putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, views.links) &&
        Objects.equals(this.items, views.items) &&
        Objects.equals(this.totalCount, views.totalCount)&&
        Objects.equals(this.additionalProperties, views.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Views.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Views is not found in the empty JSON string", Views.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Views.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        View.validateJsonElement(jsonArrayitems.get(i));
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Views>() {
           ...
           public Views read(JsonReader in) throws IOException {
             ...
             Views instance = thisAdapter.fromJsonTree(jsonObj);
