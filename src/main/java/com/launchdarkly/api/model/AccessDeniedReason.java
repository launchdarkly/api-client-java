...
public class AccessDeniedReason {
   ...
   * @return the AccessDeniedReason instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessDeniedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccessDeniedReason is not found in the empty JSON string", AccessDeniedReason.openapiRequiredFields.toString()));
        }
      }
