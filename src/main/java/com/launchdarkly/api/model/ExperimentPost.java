...
import com.launchdarkly.api.model.AnalysisConfigInput;
...
public class ExperimentPost {
  ...
  @javax.annotation.Nullable
  private AnalysisConfigInput analysisConfig;
  ...
  public ExperimentPost methodology(@javax.annotation.Nullable MethodologyEnum methodology) {
  ...
  public ExperimentPost analysisConfig(@javax.annotation.Nullable AnalysisConfigInput analysisConfig) {
   ...
   */
  @javax.annotation.Nullable
  public AnalysisConfigInput getAnalysisConfig() {
    return analysisConfig;
  }

  public void setAnalysisConfig(@javax.annotation.Nullable AnalysisConfigInput analysisConfig) {
    this.analysisConfig = analysisConfig;
  }


  public ExperimentPost dataSource(@javax.annotation.Nullable DataSourceEnum dataSource) {
  ...
  public ExperimentPost type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return the ExperimentPost instance itself
   */
  public ExperimentPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExperimentPost experimentPost = (ExperimentPost) o;
    return Objects.equals(this.name, experimentPost.name) &&
        Objects.equals(this.description, experimentPost.description) &&
        ...
        Objects.equals(this.methodology, experimentPost.methodology) &&
        Objects.equals(this.analysisConfig, experimentPost.analysisConfig) &&
        Objects.equals(this.dataSource, experimentPost.dataSource) &&
        Objects.equals(this.type, experimentPost.type)&&
        Objects.equals(this.additionalProperties, experimentPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, maintainerId, key, iteration, holdoutId, tags, methodology, analysisConfig, dataSource, type, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExperimentPost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "maintainerId", "key", "iteration", "holdoutId", "tags", "methodology", "analysisConfig", "dataSource", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExperimentPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExperimentPost is not found in the empty JSON string", ExperimentPost.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("analysisConfig") != null && !jsonObj.get("analysisConfig").isJsonNull()) {
        AnalysisConfigInput.validateJsonElement(jsonObj.get("analysisConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExperimentPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExperimentPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExperimentPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExperimentPost.class));

       return (TypeAdapter<T>) new TypeAdapter<ExperimentPost>() {
           @Override
           public void write(JsonWriter out, ExperimentPost value) throws IOException {
           ...
           @Override
           public ExperimentPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExperimentPost instance = thisAdapter.fromJsonTree(jsonObj);
