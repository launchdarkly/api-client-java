...
public class RelatedFlag {
  ...
  public RelatedFlag key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
   ...
   * @return the RelatedFlag instance itself
   */
  public RelatedFlag putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RelatedFlag relatedFlag = (RelatedFlag) o;
    return Objects.equals(this.key, relatedFlag.key)&&
        Objects.equals(this.additionalProperties, relatedFlag.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RelatedFlag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelatedFlag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelatedFlag is not found in the empty JSON string", RelatedFlag.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RelatedFlag.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RelatedFlag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RelatedFlag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RelatedFlag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RelatedFlag.class));

       return (TypeAdapter<T>) new TypeAdapter<RelatedFlag>() {
           @Override
           public void write(JsonWriter out, RelatedFlag value) throws IOException {
           ...
           @Override
           public RelatedFlag read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RelatedFlag instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of RelatedFlag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RelatedFlag
   * @throws IOException if the JSON string is invalid with respect to RelatedFlag
   */
  public static RelatedFlag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RelatedFlag.class);
  }

  /**
   * Convert an instance of RelatedFlag to an JSON string
   *
   * @return JSON string
   */
