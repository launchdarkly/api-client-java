  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnouncementAccessDeniedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AnnouncementAccessDeniedReason is not found in the empty JSON string", AnnouncementAccessDeniedReason.openapiRequiredFields.toString()));
        }
      }
