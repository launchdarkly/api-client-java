...
public class AnnouncementAccessDeniedReason {
  ...
  public AnnouncementAccessDeniedReason resources(@javax.annotation.Nullable List<String> resources) {
    this.resources = resources;
    return this;
  }

  public AnnouncementAccessDeniedReason addResourcesItem(String resourcesItem) {
  ...
  public AnnouncementAccessDeniedReason notResources(@javax.annotation.Nullable List<String> notResources) {
    this.notResources = notResources;
    return this;
  }

  public AnnouncementAccessDeniedReason addNotResourcesItem(String notResourcesItem) {
  ...
  public AnnouncementAccessDeniedReason actions(@javax.annotation.Nullable List<String> actions) {
    this.actions = actions;
    return this;
  }

  public AnnouncementAccessDeniedReason addActionsItem(String actionsItem) {
  ...
  public AnnouncementAccessDeniedReason notActions(@javax.annotation.Nullable List<String> notActions) {
    this.notActions = notActions;
    return this;
  }

  public AnnouncementAccessDeniedReason addNotActionsItem(String notActionsItem) {
  ...
  public AnnouncementAccessDeniedReason effect(@javax.annotation.Nonnull EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  public AnnouncementAccessDeniedReason roleName(@javax.annotation.Nullable String roleName) {
   ...
   * @return the AnnouncementAccessDeniedReason instance itself
   */
  public AnnouncementAccessDeniedReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnouncementAccessDeniedReason announcementAccessDeniedReason = (AnnouncementAccessDeniedReason) o;
    return Objects.equals(this.resources, announcementAccessDeniedReason.resources) &&
        Objects.equals(this.notResources, announcementAccessDeniedReason.notResources) &&
        Objects.equals(this.actions, announcementAccessDeniedReason.actions) &&
        Objects.equals(this.notActions, announcementAccessDeniedReason.notActions) &&
        Objects.equals(this.effect, announcementAccessDeniedReason.effect) &&
        Objects.equals(this.roleName, announcementAccessDeniedReason.roleName)&&
        Objects.equals(this.additionalProperties, announcementAccessDeniedReason.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnouncementAccessDeniedReason {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnnouncementAccessDeniedReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnouncementAccessDeniedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AnnouncementAccessDeniedReason is not found in the empty JSON string", AnnouncementAccessDeniedReason.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnnouncementAccessDeniedReason.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnouncementAccessDeniedReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnouncementAccessDeniedReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnouncementAccessDeniedReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnouncementAccessDeniedReason.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnouncementAccessDeniedReason>() {
           @Override
           public void write(JsonWriter out, AnnouncementAccessDeniedReason value) throws IOException {
           ...
           @Override
           public AnnouncementAccessDeniedReason read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AnnouncementAccessDeniedReason instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AnnouncementAccessDeniedReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnnouncementAccessDeniedReason
   * @throws IOException if the JSON string is invalid with respect to AnnouncementAccessDeniedReason
   */
  public static AnnouncementAccessDeniedReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnouncementAccessDeniedReason.class);
  }

  /**
   * Convert an instance of AnnouncementAccessDeniedReason to an JSON string
   *
   * @return JSON string
   */
