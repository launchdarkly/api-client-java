...
public class MetricV2Rep {
  ...
  public MetricV2Rep key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public MetricV2Rep versionId(@javax.annotation.Nullable String versionId) {
  ...
  public MetricV2Rep name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public MetricV2Rep kind(@javax.annotation.Nonnull KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public MetricV2Rep isNumeric(@javax.annotation.Nullable Boolean isNumeric) {
  ...
  public MetricV2Rep unitAggregationType(@javax.annotation.Nullable UnitAggregationTypeEnum unitAggregationType) {
  ...
  public MetricV2Rep analysisType(@javax.annotation.Nullable AnalysisTypeEnum analysisType) {
  ...
  public MetricV2Rep eventKey(@javax.annotation.Nullable String eventKey) {
  ...
  public MetricV2Rep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public MetricV2Rep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the MetricV2Rep instance itself
   */
  public MetricV2Rep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MetricV2Rep metricV2Rep = (MetricV2Rep) o;
    return Objects.equals(this.key, metricV2Rep.key) &&
        Objects.equals(this.versionId, metricV2Rep.versionId) &&
        Objects.equals(this.name, metricV2Rep.name) &&
        Objects.equals(this.kind, metricV2Rep.kind) &&
        Objects.equals(this.isNumeric, metricV2Rep.isNumeric) &&
        Objects.equals(this.unitAggregationType, metricV2Rep.unitAggregationType) &&
        Objects.equals(this.analysisType, metricV2Rep.analysisType) &&
        Objects.equals(this.eventKey, metricV2Rep.eventKey) &&
        Objects.equals(this.links, metricV2Rep.links)&&
        Objects.equals(this.additionalProperties, metricV2Rep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, versionId, name, kind, isNumeric, unitAggregationType, analysisType, eventKey, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MetricV2Rep {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "_versionId", "name", "kind", "isNumeric", "unitAggregationType", "analysisType", "eventKey", "_links"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricV2Rep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricV2Rep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricV2Rep is not found in the empty JSON string", MetricV2Rep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetricV2Rep.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricV2Rep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricV2Rep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricV2Rep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricV2Rep.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricV2Rep>() {
           @Override
           public void write(JsonWriter out, MetricV2Rep value) throws IOException {
           ...
           @Override
           public MetricV2Rep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MetricV2Rep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MetricV2Rep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetricV2Rep
   * @throws IOException if the JSON string is invalid with respect to MetricV2Rep
   */
  public static MetricV2Rep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricV2Rep.class);
  }

  /**
   * Convert an instance of MetricV2Rep to an JSON string
   *
   * @return JSON string
   */
