...
public class MetricV2Rep {
  ...
  public MetricV2Rep key(String key) {
    this.key = key;
    return this;
  }
  ...
  **/
  ...
  public MetricV2Rep versionId(String versionId) {
  ...
  **/
  ...
  public MetricV2Rep name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public MetricV2Rep kind(KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public MetricV2Rep isNumeric(Boolean isNumeric) {
  ...
  **/
  ...
  public MetricV2Rep unitAggregationType(UnitAggregationTypeEnum unitAggregationType) {
  ...
  **/
  ...
  public MetricV2Rep eventKey(String eventKey) {
  ...
  **/
  ...
  public MetricV2Rep links(Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricV2Rep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetricV2Rep is not found in the empty JSON string", MetricV2Rep.openapiRequiredFields.toString()));
        }
      }
