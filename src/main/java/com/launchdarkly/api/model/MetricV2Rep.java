...
public class MetricV2Rep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, versionId, name, kind, isNumeric, unitAggregationType, eventKey, links, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "_versionId", "name", "kind", "isNumeric", "unitAggregationType", "eventKey", "_links"));
