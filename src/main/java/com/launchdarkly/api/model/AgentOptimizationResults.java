...
public class AgentOptimizationResults {
  ...
  private List<AgentOptimizationResult> items = new ArrayList<>();
  ...
  public AgentOptimizationResults links(@javax.annotation.Nullable PaginatedLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AgentOptimizationResults items(@javax.annotation.Nonnull List<AgentOptimizationResult> items) {
    this.items = items;
    return this;
  }

  public AgentOptimizationResults addItemsItem(AgentOptimizationResult itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<AgentOptimizationResult> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<AgentOptimizationResult> items) {
    this.items = items;
  }


  public AgentOptimizationResults totalCount(@javax.annotation.Nullable Integer totalCount) {
   ...
   * @return the AgentOptimizationResults instance itself
   */
  public AgentOptimizationResults putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AgentOptimizationResults agentOptimizationResults = (AgentOptimizationResults) o;
    return Objects.equals(this.links, agentOptimizationResults.links) &&
        Objects.equals(this.items, agentOptimizationResults.items) &&
        Objects.equals(this.totalCount, agentOptimizationResults.totalCount)&&
        Objects.equals(this.additionalProperties, agentOptimizationResults.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AgentOptimizationResults {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentOptimizationResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentOptimizationResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AgentOptimizationResults is not found in the empty JSON string", AgentOptimizationResults.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentOptimizationResults.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        AgentOptimizationResult.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentOptimizationResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentOptimizationResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentOptimizationResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentOptimizationResults.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentOptimizationResults>() {
           @Override
           public void write(JsonWriter out, AgentOptimizationResults value) throws IOException {
           ...
           @Override
           public AgentOptimizationResults read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentOptimizationResults instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentOptimizationResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentOptimizationResults
   * @throws IOException if the JSON string is invalid with respect to AgentOptimizationResults
   */
  public static AgentOptimizationResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentOptimizationResults.class);
  }

  /**
   * Convert an instance of AgentOptimizationResults to an JSON string
   *
   * @return JSON string
   */
