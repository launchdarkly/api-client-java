...
public class UsersRep {
  ...
  public UsersRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public UsersRep totalCount(@javax.annotation.Nonnull Integer totalCount) {
  ...
  public UsersRep items(@javax.annotation.Nonnull List<UserRecord> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<UserRecord> items) {
    this.items = items;
  }
   ...
   * @return the UsersRep instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_links", "totalCount", "items"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UsersRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsersRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UsersRep is not found in the empty JSON string", UsersRep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        UserRecord.validateJsonElement(jsonArrayitems.get(i));
      };
  }
