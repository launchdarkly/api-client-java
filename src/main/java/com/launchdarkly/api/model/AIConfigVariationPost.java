...
import com.launchdarkly.api.model.VariationToolPost;
...
public class AIConfigVariationPost {
  ...
  public AIConfigVariationPost comment(@javax.annotation.Nullable String comment) {
  ...
  public AIConfigVariationPost description(@javax.annotation.Nullable String description) {
  ...
  public AIConfigVariationPost instructions(@javax.annotation.Nullable String instructions) {
  ...
  public AIConfigVariationPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public AIConfigVariationPost addMessagesItem(Message messagesItem) {
  ...
  public AIConfigVariationPost model(@javax.annotation.Nullable Object model) {
    this.model = model;
    return this;
  }
  ...
  public AIConfigVariationPost name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AIConfigVariationPost modelConfigKey(@javax.annotation.Nullable String modelConfigKey) {
  ...
  public AIConfigVariationPost outputFormat(@javax.annotation.Nullable Map<String, Object> outputFormat) {
    this.outputFormat = outputFormat;
    return this;
  }

  public AIConfigVariationPost putOutputFormatItem(String key, Object outputFormatItem) {
  ...
  public AIConfigVariationPost tools(@javax.annotation.Nullable List<VariationToolPost> tools) {
    this.tools = tools;
    return this;
  }

  public AIConfigVariationPost addToolsItem(VariationToolPost toolsItem) {
    if (this.tools == null) {
  ...
  public AIConfigVariationPost toolKeys(@javax.annotation.Nullable List<String> toolKeys) {
    this.toolKeys = toolKeys;
    return this;
  }

  public AIConfigVariationPost addToolKeysItem(String toolKeysItem) {
    if (this.toolKeys == null) {
      this.toolKeys = new ArrayList<>();
    }
    this.toolKeys.add(toolKeysItem);
    return this;
  }
  ...
  public AIConfigVariationPost judgeConfiguration(@javax.annotation.Nullable JudgeConfiguration judgeConfiguration) {
   ...
   * @return the AIConfigVariationPost instance itself
   */
  public AIConfigVariationPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIConfigVariationPost aiConfigVariationPost = (AIConfigVariationPost) o;
    return Objects.equals(this.comment, aiConfigVariationPost.comment) &&
        Objects.equals(this.description, aiConfigVariationPost.description) &&
        Objects.equals(this.instructions, aiConfigVariationPost.instructions) &&
        Objects.equals(this.key, aiConfigVariationPost.key) &&
        Objects.equals(this.messages, aiConfigVariationPost.messages) &&
        Objects.equals(this.model, aiConfigVariationPost.model) &&
        Objects.equals(this.name, aiConfigVariationPost.name) &&
        Objects.equals(this.modelConfigKey, aiConfigVariationPost.modelConfigKey) &&
        Objects.equals(this.outputFormat, aiConfigVariationPost.outputFormat) &&
        Objects.equals(this.tools, aiConfigVariationPost.tools) &&
        Objects.equals(this.toolKeys, aiConfigVariationPost.toolKeys) &&
        Objects.equals(this.judgeConfiguration, aiConfigVariationPost.judgeConfiguration)&&
        Objects.equals(this.additionalProperties, aiConfigVariationPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, description, instructions, key, messages, model, name, modelConfigKey, outputFormat, tools, toolKeys, judgeConfiguration, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIConfigVariationPost {\n");
    ...
    sb.append("    toolKeys: ").append(toIndentedString(toolKeys)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "instructions", "key", "messages", "model", "name", "modelConfigKey", "outputFormat", "tools", "toolKeys", "judgeConfiguration"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AIConfigVariationPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIConfigVariationPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIConfigVariationPost is not found in the empty JSON string", AIConfigVariationPost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AIConfigVariationPost.openapiRequiredFields) {
      ...
      if (jsonObj.get("tools") != null && !jsonObj.get("tools").isJsonNull()) {
        ...
        if (jsonArraytools != null) {
          ...
          for (int i = 0; i < jsonArraytools.size(); i++) {
            VariationToolPost.validateJsonElement(jsonArraytools.get(i));
          };
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("toolKeys") != null && !jsonObj.get("toolKeys").isJsonNull() && !jsonObj.get("toolKeys").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `toolKeys` to be an array in the JSON string but got `%s`", jsonObj.get("toolKeys").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIConfigVariationPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIConfigVariationPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIConfigVariationPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIConfigVariationPost.class));

       return (TypeAdapter<T>) new TypeAdapter<AIConfigVariationPost>() {
           @Override
           public void write(JsonWriter out, AIConfigVariationPost value) throws IOException {
           ...
           @Override
           public AIConfigVariationPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIConfigVariationPost instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AIConfigVariationPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AIConfigVariationPost
   * @throws IOException if the JSON string is invalid with respect to AIConfigVariationPost
   */
  public static AIConfigVariationPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AIConfigVariationPost.class);
  }

  /**
   * Convert an instance of AIConfigVariationPost to an JSON string
   *
   * @return JSON string
   */
