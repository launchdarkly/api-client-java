...
public class NamingConvention {
   ...
   * @return the NamingConvention instance itself
   */
  public NamingConvention putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NamingConvention namingConvention = (NamingConvention) o;
    return Objects.equals(this._case, namingConvention._case) &&
        Objects.equals(this.prefix, namingConvention.prefix)&&
        Objects.equals(this.additionalProperties, namingConvention.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_case, prefix, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NamingConvention {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NamingConvention.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NamingConvention is not found in the empty JSON string", NamingConvention.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("case") != null && !jsonObj.get("case").isJsonNull()) && !jsonObj.get("case").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `case` to be a primitive type in the JSON string but got `%s`", jsonObj.get("case").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NamingConvention.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NamingConvention' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NamingConvention> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NamingConvention.class));

       return (TypeAdapter<T>) new TypeAdapter<NamingConvention>() {
           @Override
           public void write(JsonWriter out, NamingConvention value) throws IOException {
           ...
           @Override
           public NamingConvention read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             NamingConvention instance = thisAdapter.fromJsonTree(jsonObj);
