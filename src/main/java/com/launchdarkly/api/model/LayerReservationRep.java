...
public class LayerReservationRep {
   ...
   * @return the LayerReservationRep instance itself
   */
  public LayerReservationRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LayerReservationRep layerReservationRep = (LayerReservationRep) o;
    return Objects.equals(this.experimentKey, layerReservationRep.experimentKey) &&
        Objects.equals(this.flagKey, layerReservationRep.flagKey) &&
        Objects.equals(this.reservationPercent, layerReservationRep.reservationPercent)&&
        Objects.equals(this.additionalProperties, layerReservationRep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(experimentKey, flagKey, reservationPercent, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LayerReservationRep {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LayerReservationRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LayerReservationRep is not found in the empty JSON string", LayerReservationRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("experimentKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `experimentKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("experimentKey").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LayerReservationRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LayerReservationRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LayerReservationRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LayerReservationRep.class));

       return (TypeAdapter<T>) new TypeAdapter<LayerReservationRep>() {
           @Override
           public void write(JsonWriter out, LayerReservationRep value) throws IOException {
           ...
           @Override
           public LayerReservationRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             LayerReservationRep instance = thisAdapter.fromJsonTree(jsonObj);
