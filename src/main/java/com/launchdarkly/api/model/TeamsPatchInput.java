...
public class TeamsPatchInput {
  ...
  public TeamsPatchInput comment(@javax.annotation.Nullable String comment) {
  ...
  public TeamsPatchInput instructions(@javax.annotation.Nonnull List<Map<String, Object>> instructions) {
   ...
   * @return the TeamsPatchInput instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamsPatchInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamsPatchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TeamsPatchInput is not found in the empty JSON string", TeamsPatchInput.openapiRequiredFields.toString()));
        }
      }
