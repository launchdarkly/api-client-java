...
public class AIToolPost {
  ...
  public AIToolPost tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public AIToolPost addTagsItem(String tagsItem) {
    if (this.tags == null) {
   ...
   * @return the AIToolPost instance itself
   */
  public AIToolPost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AIToolPost aiToolPost = (AIToolPost) o;
    return Objects.equals(this.key, aiToolPost.key) &&
        ...
        Objects.equals(this.tags, aiToolPost.tags)&&
        Objects.equals(this.additionalProperties, aiToolPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, maintainerId, maintainerTeamKey, description, schema, customParameters, tags, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AIToolPost {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "maintainerId", "maintainerTeamKey", "description", "schema", "customParameters", "tags"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIToolPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AIToolPost is not found in the empty JSON string", AIToolPost.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AIToolPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AIToolPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AIToolPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AIToolPost.class));

       return (TypeAdapter<T>) new TypeAdapter<AIToolPost>() {
           @Override
           public void write(JsonWriter out, AIToolPost value) throws IOException {
           ...
           @Override
           public AIToolPost read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AIToolPost instance = thisAdapter.fromJsonTree(jsonObj);
