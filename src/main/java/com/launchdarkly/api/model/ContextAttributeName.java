...
public class ContextAttributeName {
  ...
  public ContextAttributeName name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ContextAttributeName weight(@javax.annotation.Nonnull Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public ContextAttributeName redacted(@javax.annotation.Nullable Boolean redacted) {
   ...
   * @return the ContextAttributeName instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "weight", "redacted"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextAttributeName
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextAttributeName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextAttributeName is not found in the empty JSON string", ContextAttributeName.openapiRequiredFields.toString()));
        }
      }
