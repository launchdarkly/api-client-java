...
import com.launchdarkly.api.model.DynamicOptions;
...
public class FormVariable {
  ...
  public FormVariable addAllowedValuesItem(String allowedValuesItem) {
   ...
   * @return the FormVariable instance itself
   */
  public FormVariable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormVariable formVariable = (FormVariable) o;
    return Objects.equals(this.key, formVariable.key) &&
        Objects.equals(this.name, formVariable.name) &&
        Objects.equals(this.type, formVariable.type) &&
        Objects.equals(this.description, formVariable.description) &&
        Objects.equals(this.placeholder, formVariable.placeholder) &&
        Objects.equals(this.isOptional, formVariable.isOptional) &&
        Objects.equals(this.defaultValue, formVariable.defaultValue) &&
        Objects.equals(this.allowedValues, formVariable.allowedValues) &&
        Objects.equals(this.dynamicOptions, formVariable.dynamicOptions)&&
        Objects.equals(this.additionalProperties, formVariable.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, type, description, placeholder, isOptional, defaultValue, allowedValues, dynamicOptions, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FormVariable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FormVariable is not found in the empty JSON string", FormVariable.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("dynamicOptions") != null && !jsonObj.get("dynamicOptions").isJsonNull()) {
        DynamicOptions.validateJsonElement(jsonObj.get("dynamicOptions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormVariable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormVariable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormVariable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormVariable.class));

       return (TypeAdapter<T>) new TypeAdapter<FormVariable>() {
           @Override
           public void write(JsonWriter out, FormVariable value) throws IOException {
           ...
           @Override
           public FormVariable read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FormVariable instance = thisAdapter.fromJsonTree(jsonObj);
