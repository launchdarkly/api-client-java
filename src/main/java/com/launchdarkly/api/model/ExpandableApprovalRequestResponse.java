...
import com.launchdarkly.api.model.ExpandedResourceRep;
...
public class ExpandableApprovalRequestResponse {
   ...
   * @return the ExpandableApprovalRequestResponse instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, expandableApprovalRequestResponse.id) &&
        ...
        Objects.equals(this.additionalProperties, expandableApprovalRequestResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, version, creationDate, serviceKind, requestorId, description, reviewStatus, allReviews, notifyMemberIds, appliedDate, appliedByMemberId, appliedByServiceTokenId, status, instructions, conflicts, links, executionDate, operatingOnId, integrationMetadata, source, customWorkflowMetadata, resourceId, approvalSettings, project, environments, flag, resource, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpandableApprovalRequestResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExpandableApprovalRequestResponse is not found in the empty JSON string", ExpandableApprovalRequestResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExpandableApprovalRequestResponse>() {
           ...
           public ExpandableApprovalRequestResponse read(JsonReader in) throws IOException {
             ...
             ExpandableApprovalRequestResponse instance = thisAdapter.fromJsonTree(jsonObj);
