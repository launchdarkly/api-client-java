...
public class ContextAttributeValuesCollection {
  ...
  public ContextAttributeValuesCollection items(@javax.annotation.Nonnull List<ContextAttributeValues> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<ContextAttributeValues> items) {
    this.items = items;
  }
   ...
   * @return the ContextAttributeValuesCollection instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextAttributeValuesCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextAttributeValuesCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContextAttributeValuesCollection is not found in the empty JSON string", ContextAttributeValuesCollection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ContextAttributeValues.validateJsonElement(jsonArrayitems.get(i));
      };
  }
