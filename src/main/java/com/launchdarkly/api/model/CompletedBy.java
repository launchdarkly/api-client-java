...
public class CompletedBy {
  ...
  public CompletedBy member(@javax.annotation.Nullable MemberSummary member) {
    this.member = member;
    return this;
  }
  ...
  public CompletedBy token(@javax.annotation.Nullable TokenSummary token) {
    this.token = token;
    return this;
  }
   ...
   * @return the CompletedBy instance itself
   */
  public CompletedBy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompletedBy completedBy = (CompletedBy) o;
    return Objects.equals(this.member, completedBy.member) &&
        Objects.equals(this.token, completedBy.token)&&
        Objects.equals(this.additionalProperties, completedBy.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(member, token, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompletedBy {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("member", "token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompletedBy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompletedBy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CompletedBy is not found in the empty JSON string", CompletedBy.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompletedBy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompletedBy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompletedBy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompletedBy.class));

       return (TypeAdapter<T>) new TypeAdapter<CompletedBy>() {
           @Override
           public void write(JsonWriter out, CompletedBy value) throws IOException {
           ...
           @Override
           public CompletedBy read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CompletedBy instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CompletedBy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompletedBy
   * @throws IOException if the JSON string is invalid with respect to CompletedBy
   */
  public static CompletedBy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompletedBy.class);
  }

  /**
   * Convert an instance of CompletedBy to an JSON string
   *
   * @return JSON string
   */
