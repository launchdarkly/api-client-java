...
import com.launchdarkly.api.model.ViewLinkedResource;
import com.launchdarkly.api.model.ViewsPaginatedLinks;
...
public class ViewLinkedResources {
  ...
  public ViewLinkedResources addItemsItem(ViewLinkedResource itemsItem) {
    if (this.items == null) {
   ...
   * @return the ViewLinkedResources instance itself
   */
  public ViewLinkedResources putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ViewLinkedResources viewLinkedResources = (ViewLinkedResources) o;
    return Objects.equals(this.links, viewLinkedResources.links) &&
        Objects.equals(this.items, viewLinkedResources.items) &&
        Objects.equals(this.totalCount, viewLinkedResources.totalCount)&&
        Objects.equals(this.additionalProperties, viewLinkedResources.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewLinkedResources {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewLinkedResources.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewLinkedResources is not found in the empty JSON string", ViewLinkedResources.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("_links") != null && !jsonObj.get("_links").isJsonNull()) {
        ViewsPaginatedLinks.validateJsonElement(jsonObj.get("_links"));
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ViewLinkedResource.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewLinkedResources.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewLinkedResources' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewLinkedResources> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewLinkedResources.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewLinkedResources>() {
           @Override
           public void write(JsonWriter out, ViewLinkedResources value) throws IOException {
           ...
           @Override
           public ViewLinkedResources read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ViewLinkedResources instance = thisAdapter.fromJsonTree(jsonObj);
