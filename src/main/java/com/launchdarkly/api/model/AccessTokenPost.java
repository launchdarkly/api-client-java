...
public class AccessTokenPost {
   ...
   * @return the AccessTokenPost instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, accessTokenPost.name) &&
        Objects.equals(this.description, accessTokenPost.description) &&
        Objects.equals(this.role, accessTokenPost.role) &&
        Objects.equals(this.customRoleIds, accessTokenPost.customRoleIds) &&
        Objects.equals(this.inlineRole, accessTokenPost.inlineRole) &&
        Objects.equals(this.serviceToken, accessTokenPost.serviceToken) &&
        Objects.equals(this.defaultApiVersion, accessTokenPost.defaultApiVersion)&&
        Objects.equals(this.additionalProperties, accessTokenPost.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, role, customRoleIds, inlineRole, serviceToken, defaultApiVersion, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessTokenPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccessTokenPost is not found in the empty JSON string", AccessTokenPost.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("customRoleIds") != null && !jsonObj.get("customRoleIds").isJsonNull() && !jsonObj.get("customRoleIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `customRoleIds` to be an array in the JSON string but got `%s`", jsonObj.get("customRoleIds").toString()));
      }
      if (jsonObj.get("inlineRole") != null && !jsonObj.get("inlineRole").isJsonNull()) {
        ...
        if (jsonArrayinlineRole != null) {
          ...
          if (!jsonObj.get("inlineRole").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `inlineRole` to be an array in the JSON string but got `%s`", jsonObj.get("inlineRole").toString()));
          }

          // validate the optional field `inlineRole` (array)
          for (int i = 0; i < jsonArrayinlineRole.size(); i++) {
            StatementPost.validateJsonElement(jsonArrayinlineRole.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessTokenPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessTokenPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessTokenPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessTokenPost.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessTokenPost>() {
           @Override
           ...
           public AccessTokenPost read(JsonReader in) throws IOException {
             ...
             AccessTokenPost instance = thisAdapter.fromJsonTree(jsonObj);
