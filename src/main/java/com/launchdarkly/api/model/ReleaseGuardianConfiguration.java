...
public class ReleaseGuardianConfiguration {
   ...
   * @return the ReleaseGuardianConfiguration instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleaseGuardianConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleaseGuardianConfiguration is not found in the empty JSON string", ReleaseGuardianConfiguration.openapiRequiredFields.toString()));
        }
      }
