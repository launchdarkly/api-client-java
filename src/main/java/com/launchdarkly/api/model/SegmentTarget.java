...
public class SegmentTarget {
  ...
  public SegmentTarget values(@javax.annotation.Nullable List<String> values) {
    this.values = values;
    return this;
  }

  public SegmentTarget addValuesItem(String valuesItem) {
    if (this.values == null) {
  ...
  public SegmentTarget contextKind(@javax.annotation.Nullable String contextKind) {
   ...
   * @return the SegmentTarget instance itself
   */
  public SegmentTarget putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentTarget segmentTarget = (SegmentTarget) o;
    return Objects.equals(this.values, segmentTarget.values) &&
        Objects.equals(this.contextKind, segmentTarget.contextKind)&&
        Objects.equals(this.additionalProperties, segmentTarget.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(values, contextKind, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SegmentTarget {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("values", "contextKind"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SegmentTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SegmentTarget is not found in the empty JSON string", SegmentTarget.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentTarget>() {
           @Override
           public void write(JsonWriter out, SegmentTarget value) throws IOException {
           ...
           @Override
           public SegmentTarget read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SegmentTarget instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SegmentTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SegmentTarget
   * @throws IOException if the JSON string is invalid with respect to SegmentTarget
   */
  public static SegmentTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentTarget.class);
  }

  /**
   * Convert an instance of SegmentTarget to an JSON string
   *
   * @return JSON string
   */
