...
public class MetricCollectionRep {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  @javax.annotation.Nullable
  private List<MetricListingRep> items = new ArrayList<>();
  ...
  public MetricCollectionRep items(@javax.annotation.Nullable List<MetricListingRep> items) {
    this.items = items;
    return this;
  }

  public MetricCollectionRep addItemsItem(MetricListingRep itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<MetricListingRep> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nullable List<MetricListingRep> items) {
    this.items = items;
  }


  public MetricCollectionRep links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public MetricCollectionRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public MetricCollectionRep totalCount(@javax.annotation.Nullable Integer totalCount) {
   ...
   * @return the MetricCollectionRep instance itself
   */
  public MetricCollectionRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MetricCollectionRep metricCollectionRep = (MetricCollectionRep) o;
    return Objects.equals(this.items, metricCollectionRep.items) &&
        Objects.equals(this.links, metricCollectionRep.links) &&
        Objects.equals(this.totalCount, metricCollectionRep.totalCount)&&
        Objects.equals(this.additionalProperties, metricCollectionRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MetricCollectionRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MetricCollectionRep is not found in the empty JSON string", MetricCollectionRep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            MetricListingRep.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricCollectionRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricCollectionRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricCollectionRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricCollectionRep.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricCollectionRep>() {
           @Override
           public void write(JsonWriter out, MetricCollectionRep value) throws IOException {
           ...
           @Override
           public MetricCollectionRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MetricCollectionRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MetricCollectionRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetricCollectionRep
   * @throws IOException if the JSON string is invalid with respect to MetricCollectionRep
   */
  public static MetricCollectionRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricCollectionRep.class);
  }

  /**
   * Convert an instance of MetricCollectionRep to an JSON string
   *
   * @return JSON string
   */
