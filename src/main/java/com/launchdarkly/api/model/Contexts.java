...
public class Contexts {
  ...
  public Contexts links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public Contexts totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public Contexts environmentId(@javax.annotation.Nonnull String environmentId) {
  ...
  public Contexts continuationToken(@javax.annotation.Nullable String continuationToken) {
  ...
  public Contexts items(@javax.annotation.Nonnull List<ContextRecord> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nonnull List<ContextRecord> items) {
    this.items = items;
  }
   ...
   * @return the Contexts instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to Contexts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Contexts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Contexts is not found in the empty JSON string", Contexts.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("_environmentId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_environmentId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_environmentId").toString()));
      }
      if ((jsonObj.get("continuationToken") != null && !jsonObj.get("continuationToken").isJsonNull()) && !jsonObj.get("continuationToken").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `continuationToken` to be a primitive type in the JSON string but got `%s`", jsonObj.get("continuationToken").toString()));
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        ContextRecord.validateJsonElement(jsonArrayitems.get(i));
      };
  }
