...
public class InstructionUserRequest {
   ...
   * @return the InstructionUserRequest instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstructionUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InstructionUserRequest is not found in the empty JSON string", InstructionUserRequest.openapiRequiredFields.toString()));
        }
      }
