...
public class ReleaseGuardianConfigurationInput {
  ...
  public ReleaseGuardianConfigurationInput monitoringWindowMilliseconds(@javax.annotation.Nullable Long monitoringWindowMilliseconds) {
  ...
  public void setMonitoringWindowMilliseconds(@javax.annotation.Nullable Long monitoringWindowMilliseconds) {
    this.monitoringWindowMilliseconds = monitoringWindowMilliseconds;
  }


  public ReleaseGuardianConfigurationInput rolloutWeight(@javax.annotation.Nullable Integer rolloutWeight) {
  ...
  public void setRolloutWeight(@javax.annotation.Nullable Integer rolloutWeight) {
    this.rolloutWeight = rolloutWeight;
  }


  public ReleaseGuardianConfigurationInput rollbackOnRegression(@javax.annotation.Nullable Boolean rollbackOnRegression) {
  ...
  public ReleaseGuardianConfigurationInput randomizationUnit(@javax.annotation.Nullable String randomizationUnit) {
   ...
   * @return the ReleaseGuardianConfigurationInput instance itself
   */
  public ReleaseGuardianConfigurationInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReleaseGuardianConfigurationInput releaseGuardianConfigurationInput = (ReleaseGuardianConfigurationInput) o;
    return Objects.equals(this.monitoringWindowMilliseconds, releaseGuardianConfigurationInput.monitoringWindowMilliseconds) &&
        Objects.equals(this.rolloutWeight, releaseGuardianConfigurationInput.rolloutWeight) &&
        Objects.equals(this.rollbackOnRegression, releaseGuardianConfigurationInput.rollbackOnRegression) &&
        Objects.equals(this.randomizationUnit, releaseGuardianConfigurationInput.randomizationUnit)&&
        Objects.equals(this.additionalProperties, releaseGuardianConfigurationInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(monitoringWindowMilliseconds, rolloutWeight, rollbackOnRegression, randomizationUnit, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReleaseGuardianConfigurationInput {\n");
    sb.append("    monitoringWindowMilliseconds: ").append(toIndentedString(monitoringWindowMilliseconds)).append("\n");
    sb.append("    rolloutWeight: ").append(toIndentedString(rolloutWeight)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReleaseGuardianConfigurationInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReleaseGuardianConfigurationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReleaseGuardianConfigurationInput is not found in the empty JSON string", ReleaseGuardianConfigurationInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("randomizationUnit") != null && !jsonObj.get("randomizationUnit").isJsonNull()) && !jsonObj.get("randomizationUnit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `randomizationUnit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("randomizationUnit").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReleaseGuardianConfigurationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReleaseGuardianConfigurationInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReleaseGuardianConfigurationInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReleaseGuardianConfigurationInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ReleaseGuardianConfigurationInput>() {
           @Override
           public void write(JsonWriter out, ReleaseGuardianConfigurationInput value) throws IOException {
           ...
           @Override
           public ReleaseGuardianConfigurationInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReleaseGuardianConfigurationInput instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ReleaseGuardianConfigurationInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReleaseGuardianConfigurationInput
   * @throws IOException if the JSON string is invalid with respect to ReleaseGuardianConfigurationInput
   */
  public static ReleaseGuardianConfigurationInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReleaseGuardianConfigurationInput.class);
  }

  /**
   * Convert an instance of ReleaseGuardianConfigurationInput to an JSON string
   *
   * @return JSON string
   */
