...
public class MemberPermissionGrantSummaryRep {
   ...
   * @return the MemberPermissionGrantSummaryRep instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MemberPermissionGrantSummaryRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MemberPermissionGrantSummaryRep is not found in the empty JSON string", MemberPermissionGrantSummaryRep.openapiRequiredFields.toString()));
        }
      }
