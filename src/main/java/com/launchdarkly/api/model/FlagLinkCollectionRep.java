...
public class FlagLinkCollectionRep {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  @javax.annotation.Nonnull
  private List<FlagLinkRep> items = new ArrayList<>();
  ...
  public FlagLinkCollectionRep items(@javax.annotation.Nonnull List<FlagLinkRep> items) {
    this.items = items;
    return this;
  }

  public FlagLinkCollectionRep addItemsItem(FlagLinkRep itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<FlagLinkRep> getItems() {
    return items;
  }

  public void setItems(@javax.annotation.Nonnull List<FlagLinkRep> items) {
    this.items = items;
  }


  public FlagLinkCollectionRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public FlagLinkCollectionRep putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
   ...
   * @return the FlagLinkCollectionRep instance itself
   */
  public FlagLinkCollectionRep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FlagLinkCollectionRep flagLinkCollectionRep = (FlagLinkCollectionRep) o;
    return Objects.equals(this.items, flagLinkCollectionRep.items) &&
        Objects.equals(this.links, flagLinkCollectionRep.links)&&
        Objects.equals(this.additionalProperties, flagLinkCollectionRep.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FlagLinkCollectionRep {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlagLinkCollectionRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagLinkCollectionRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagLinkCollectionRep is not found in the empty JSON string", FlagLinkCollectionRep.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FlagLinkCollectionRep.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        FlagLinkRep.validateJsonElement(jsonArrayitems.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlagLinkCollectionRep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlagLinkCollectionRep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlagLinkCollectionRep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlagLinkCollectionRep.class));

       return (TypeAdapter<T>) new TypeAdapter<FlagLinkCollectionRep>() {
           @Override
           public void write(JsonWriter out, FlagLinkCollectionRep value) throws IOException {
           ...
           @Override
           public FlagLinkCollectionRep read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FlagLinkCollectionRep instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FlagLinkCollectionRep given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlagLinkCollectionRep
   * @throws IOException if the JSON string is invalid with respect to FlagLinkCollectionRep
   */
  public static FlagLinkCollectionRep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlagLinkCollectionRep.class);
  }

  /**
   * Convert an instance of FlagLinkCollectionRep to an JSON string
   *
   * @return JSON string
   */
