...
public class WorkflowTemplateOutput {
  ...
  public WorkflowTemplateOutput putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public WorkflowTemplateOutput addStagesItem(StageOutput stagesItem) {
    if (this.stages == null) {
   ...
   * @return the WorkflowTemplateOutput instance itself
   */
  public WorkflowTemplateOutput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkflowTemplateOutput workflowTemplateOutput = (WorkflowTemplateOutput) o;
    return Objects.equals(this.id, workflowTemplateOutput.id) &&
        Objects.equals(this.key, workflowTemplateOutput.key) &&
        Objects.equals(this.name, workflowTemplateOutput.name) &&
        Objects.equals(this.creationDate, workflowTemplateOutput.creationDate) &&
        Objects.equals(this.ownerId, workflowTemplateOutput.ownerId) &&
        Objects.equals(this.maintainerId, workflowTemplateOutput.maintainerId) &&
        Objects.equals(this.links, workflowTemplateOutput.links) &&
        Objects.equals(this.description, workflowTemplateOutput.description) &&
        Objects.equals(this.stages, workflowTemplateOutput.stages)&&
        Objects.equals(this.additionalProperties, workflowTemplateOutput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, key, name, creationDate, ownerId, maintainerId, links, description, stages, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkflowTemplateOutput {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowTemplateOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WorkflowTemplateOutput is not found in the empty JSON string", WorkflowTemplateOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("_key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_key").toString()));
      }
      if ((jsonObj.get("name") != null && !jsonObj.get("name").isJsonNull()) && !jsonObj.get("name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("name").toString()));
      }
      if (!jsonObj.get("_ownerId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `_ownerId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_ownerId").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowTemplateOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowTemplateOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowTemplateOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowTemplateOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowTemplateOutput>() {
           @Override
           public void write(JsonWriter out, WorkflowTemplateOutput value) throws IOException {
           ...
           @Override
           public WorkflowTemplateOutput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WorkflowTemplateOutput instance = thisAdapter.fromJsonTree(jsonObj);
