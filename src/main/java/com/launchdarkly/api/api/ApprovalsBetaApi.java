...
public class ApprovalsBetaApi {
     ...
     */
    public okhttp3.Call patchApprovalRequestCall(String projectKey, String featureFlagKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call patchApprovalRequestValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling patchApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling patchApprovalRequest(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling patchApprovalRequest(Async)");
        }
        ...
        okhttp3.Call localVarCall = patchApprovalRequestCall(projectKey, featureFlagKey, environmentKey, id, _callback);
        return localVarCall;
     ...
     */
    public FlagConfigApprovalRequestResponse patchApprovalRequest(String projectKey, String featureFlagKey, String environmentKey, String id) throws ApiException {
        ApiResponse<FlagConfigApprovalRequestResponse> localVarResp = patchApprovalRequestWithHttpInfo(projectKey, featureFlagKey, environmentKey, id);
     ...
     */
    public ApiResponse<FlagConfigApprovalRequestResponse> patchApprovalRequestWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String id) throws ApiException {
        okhttp3.Call localVarCall = patchApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, id, null);
     ...
     */
    public okhttp3.Call patchApprovalRequestAsync(String projectKey, String featureFlagKey, String environmentKey, String id, final ApiCallback<FlagConfigApprovalRequestResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, id, _callback);
        Type localVarReturnType = new TypeToken<FlagConfigApprovalRequestResponse>(){}.getType();
