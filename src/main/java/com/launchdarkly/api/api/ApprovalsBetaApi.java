...
import com.launchdarkly.api.model.ApprovalRequestPatchInput;
...
public class ApprovalsBetaApi {
     ...
     * @param environmentKey An environment key filter to apply to the approval request settings. (optional)
     * @param resourceKind A resource kind filter to apply to the approval request settings. (optional)
     * @param expand A comma-separated list of fields to expand in the response. Options include &#39;default&#39; and &#39;strict&#39;. (optional)
    ...
    public okhttp3.Call getApprovalRequestSettingsCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String resourceKind, @javax.annotation.Nullable String expand, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/approval-requests/projects/{projectKey}/settings"
        ...
        if (resourceKind != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("resourceKind", resourceKind));
        }
    ...
    private okhttp3.Call getApprovalRequestSettingsValidateBeforeCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String resourceKind, @javax.annotation.Nullable String expand, final ApiCallback _callback) throws ApiException {
        ...
        return getApprovalRequestSettingsCall(ldAPIVersion, projectKey, environmentKey, resourceKind, expand, _callback);
    ...
    /**
     * Get approval request settings (asynchronously)
     * Get the approval request settings for the given project, optionally filtered by environment and resource kind.
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey  (required)
     * @param environmentKey An environment key filter to apply to the approval request settings. (optional)
     ...
     * @param id The approval ID (required)
     * @param approvalRequestPatchInput  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call patchApprovalRequestCall(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull ApprovalRequestPatchInput approvalRequestPatchInput, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = approvalRequestPatchInput;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchApprovalRequestValidateBeforeCall(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull ApprovalRequestPatchInput approvalRequestPatchInput, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling patchApprovalRequest(Async)");
        }

        // verify the required parameter 'approvalRequestPatchInput' is set
        if (approvalRequestPatchInput == null) {
            throw new ApiException("Missing the required parameter 'approvalRequestPatchInput' when calling patchApprovalRequest(Async)");
        }

        return patchApprovalRequestCall(id, approvalRequestPatchInput, _callback);
     ...
     */
    public FlagConfigApprovalRequestResponse patchApprovalRequest(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull ApprovalRequestPatchInput approvalRequestPatchInput) throws ApiException {
        ApiResponse<FlagConfigApprovalRequestResponse> localVarResp = patchApprovalRequestWithHttpInfo(id, approvalRequestPatchInput);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FlagConfigApprovalRequestResponse> patchApprovalRequestWithHttpInfo(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull ApprovalRequestPatchInput approvalRequestPatchInput) throws ApiException {
        okhttp3.Call localVarCall = patchApprovalRequestValidateBeforeCall(id, approvalRequestPatchInput, null);
        Type localVarReturnType = new TypeToken<FlagConfigApprovalRequestResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update approval request (asynchronously)
     * Perform a partial update to an approval request. Updating an approval request uses the semantic patch format. This endpoint works with any approval requests.  To make a semantic patch request, you must append &#x60;domain-model&#x3D;launchdarkly.semanticpatch&#x60; to your &#x60;Content-Type&#x60; header. To learn more, read [Updates using semantic patch](https://launchdarkly.com/docs/api#updates-using-semantic-patch).  ### Instructions  Semantic patch requests support the following &#x60;kind&#x60; instructions for updating an approval request.  #### addReviewers  Adds the specified members and teams to the existing list of reviewers. You must include at least one of &#x60;notifyMemberIds&#x60; and &#x60;notifyTeamKeys&#x60;.  ##### Parameters  - &#x60;notifyMemberIds&#x60;: (Optional) List of member IDs. - &#x60;notifyTeamKeys&#x60;: (Optional) List of team keys.  Here&#39;s an example:  &#x60;&#x60;&#x60;json {   \&quot;instructions\&quot;: [{     \&quot;kind\&quot;: \&quot;addReviewers\&quot;,     \&quot;notifyMemberIds\&quot;: [ \&quot;user-key-123abc\&quot;, \&quot;user-key-456def\&quot; ],     \&quot;notifyTeamKeys\&quot;: [ \&quot;team-key-789abc\&quot;]   }] } &#x60;&#x60;&#x60;  #### updateDescription  Updates the description (title) of the approval request.  ##### Parameters  - &#x60;value&#x60;: (Required) The new description for the approval request. Must be non-empty and no more than 5000 characters.  Here&#39;s an example:  &#x60;&#x60;&#x60;json {   \&quot;instructions\&quot;: [{     \&quot;kind\&quot;: \&quot;updateDescription\&quot;,     \&quot;value\&quot;: \&quot;Updated approval request title\&quot;   }] } &#x60;&#x60;&#x60; 
     * @param id The approval ID (required)
     * @param approvalRequestPatchInput  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call patchApprovalRequestAsync(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull ApprovalRequestPatchInput approvalRequestPatchInput, final ApiCallback<FlagConfigApprovalRequestResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchApprovalRequestValidateBeforeCall(id, approvalRequestPatchInput, _callback);
        Type localVarReturnType = new TypeToken<FlagConfigApprovalRequestResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey  (required)
     * @param approvalRequestSettingsPatch Approval request settings to update (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call patchApprovalRequestSettingsCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable ApprovalRequestSettingsPatch approvalRequestSettingsPatch, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = approvalRequestSettingsPatch;
    ...
    private okhttp3.Call patchApprovalRequestSettingsValidateBeforeCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable ApprovalRequestSettingsPatch approvalRequestSettingsPatch, final ApiCallback _callback) throws ApiException {
        ...
        return patchApprovalRequestSettingsCall(ldAPIVersion, projectKey, approvalRequestSettingsPatch, _callback);
    ...
    /**
     * Update approval request settings (asynchronously)
     * Perform a partial update to approval request settings
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey  (required)
     * @param approvalRequestSettingsPatch Approval request settings to update (optional)
    ...
    private okhttp3.Call patchFlagConfigApprovalRequestValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String featureFlagKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull String id, final ApiCallback _callback) throws ApiException {
        ...
        return patchFlagConfigApprovalRequestCall(projectKey, featureFlagKey, environmentKey, id, _callback);
    ...
    /**
     * Update flag approval request (asynchronously)
     * Perform a partial update to an approval request. Updating an approval request uses the semantic patch format. This endpoint requires a feature flag key, and can only be used for updating approval requests for flags.  To make a semantic patch request, you must append &#x60;domain-model&#x3D;launchdarkly.semanticpatch&#x60; to your &#x60;Content-Type&#x60; header. To learn more, read [Updates using semantic patch](https://launchdarkly.com/docs/api#updates-using-semantic-patch).  ### Instructions  Semantic patch requests support the following &#x60;kind&#x60; instructions for updating an approval request.  #### addReviewers  Adds the specified members and teams to the existing list of reviewers. You must include at least one of &#x60;notifyMemberIds&#x60; and &#x60;notifyTeamKeys&#x60;.  ##### Parameters  - &#x60;notifyMemberIds&#x60;: (Optional) List of member IDs. - &#x60;notifyTeamKeys&#x60;: (Optional) List of team keys.  #### updateDescription  Updates the description (title) of the approval request.  ##### Parameters  - &#x60;value&#x60;: (Required) The new description for the approval request. Must be non-empty and no more than 5000 characters. 
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
