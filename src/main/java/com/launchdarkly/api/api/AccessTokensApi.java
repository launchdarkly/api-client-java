...
public class AccessTokensApi {
    ...
    public okhttp3.Call deleteTokenCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/tokens/{id}"
    ...
    private okhttp3.Call deleteTokenValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteTokenCall(id, _callback);
        return localVarCall;
     ...
     * @param id The ID of the access token (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Access token response JSON </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource identifier </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
    ...
    private okhttp3.Call getTokenValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTokenCall(id, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call getTokensCall(Boolean showAll, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTokensValidateBeforeCall(Boolean showAll, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getTokensCall(showAll, _callback);
        return localVarCall;
    ...
    public Tokens getTokens(Boolean showAll) throws ApiException {
        ApiResponse<Tokens> localVarResp = getTokensWithHttpInfo(showAll);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Tokens> getTokensWithHttpInfo(Boolean showAll) throws ApiException {
        okhttp3.Call localVarCall = getTokensValidateBeforeCall(showAll, null);
     ...
     */
    public okhttp3.Call getTokensAsync(Boolean showAll, final ApiCallback<Tokens> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTokensValidateBeforeCall(showAll, _callback);
        Type localVarReturnType = new TypeToken<Tokens>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call patchTokenValidateBeforeCall(String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchTokenCall(id, patchOperation, _callback);
        return localVarCall;
    ...
    /**
     * Patch access token (asynchronously)
     * Update an access token&#39;s settings. The request should be a valid JSON Patch document describing the changes to be made to the access token.
     * @param id The ID of the access token to update (required)
     * @param patchOperation  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @param accessTokenPost  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Access token response JSON </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
    ...
    public okhttp3.Call postTokenCall(AccessTokenPost accessTokenPost, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = accessTokenPost;
    ...
    private okhttp3.Call postTokenValidateBeforeCall(AccessTokenPost accessTokenPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postTokenCall(accessTokenPost, _callback);
        return localVarCall;
    ...
    public okhttp3.Call resetTokenCall(String id, Long expiry, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/tokens/{id}/reset"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    private okhttp3.Call resetTokenValidateBeforeCall(String id, Long expiry, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = resetTokenCall(id, expiry, _callback);
        return localVarCall;
    ...
    /**
     * Reset access token (asynchronously)
     * Reset an access token&#39;s secret key with an optional expiry time for the old key.
     * @param id The ID of the access token to update (required)
     * @param expiry An expiration time for the old token key, expressed as a Unix epoch time in milliseconds. By default, the token will expire immediately. (optional)
     * @param _callback The callback to be executed when the API call finishes
