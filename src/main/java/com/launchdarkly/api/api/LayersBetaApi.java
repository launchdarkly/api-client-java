...
public class LayersBetaApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LayersBetaApi() {
        this(Configuration.getDefaultApiClient());
    }

    public LayersBetaApi(ApiClient apiClient) {
    ...
    public okhttp3.Call createLayerCall(String projectKey, LayerPost layerPost, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = layerPost;

        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/layers"
    ...
    private okhttp3.Call createLayerValidateBeforeCall(String projectKey, LayerPost layerPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createLayerCall(projectKey, layerPost, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getLayersValidateBeforeCall(String projectKey, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getLayersCall(projectKey, filter, _callback);
        return localVarCall;
     ...
     * @param projectKey The project key (required)
     * @param layerKey The layer key (required)
     * @param layerPatchInput  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call updateLayerCall(String projectKey, String layerKey, LayerPatchInput layerPatchInput, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = layerPatchInput;

        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/layers/{layerKey}"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "layerKey" + "\\}", localVarApiClient.escapeString(layerKey.toString()));
    ...
    private okhttp3.Call updateLayerValidateBeforeCall(String projectKey, String layerKey, LayerPatchInput layerPatchInput, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateLayerCall(projectKey, layerKey, layerPatchInput, _callback);
        return localVarCall;
