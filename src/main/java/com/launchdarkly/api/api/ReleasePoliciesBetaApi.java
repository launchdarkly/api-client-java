...
import com.launchdarkly.api.model.PostReleasePolicyRequest;
import com.launchdarkly.api.model.PutReleasePolicyRequest;
import com.launchdarkly.api.model.ReleasePoliciesResponse;
import com.launchdarkly.api.model.ReleasePolicy;
...
public class ReleasePoliciesBetaApi {
    ...
    public okhttp3.Call deleteReleasePolicyCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String policyKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/projects/{projectKey}/release-policies/{policyKey}"
            .replace("{" + "projectKey" + "}", localVarApiClient.escapeString(projectKey.toString()))
            .replace("{" + "policyKey" + "}", localVarApiClient.escapeString(policyKey.toString()));
    ...
    private okhttp3.Call deleteReleasePolicyValidateBeforeCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String policyKey, final ApiCallback _callback) throws ApiException {
        ...
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling deleteReleasePolicy(Async)");
        }

        // verify the required parameter 'policyKey' is set
        if (policyKey == null) {
            throw new ApiException("Missing the required parameter 'policyKey' when calling deleteReleasePolicy(Async)");
        }

        return deleteReleasePolicyCall(ldAPIVersion, projectKey, policyKey, _callback);
    ...
    /**
     * Delete a release policy (asynchronously)
     * Delete an existing release policy for the specified project.
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param policyKey The human-readable key of the release policy (required)
     ...
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param excludeDefault When true, exclude the default release policy from the response. When false or omitted, include the default policy if an environment filter is present. (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call getReleasePoliciesCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable Boolean excludeDefault, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/release-policies"
            .replace("{" + "projectKey" + "}", localVarApiClient.escapeString(projectKey.toString()));
    ...
    private okhttp3.Call getReleasePoliciesValidateBeforeCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable Boolean excludeDefault, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling getReleasePolicies(Async)");
        }

        return getReleasePoliciesCall(ldAPIVersion, projectKey, excludeDefault, _callback);
    ...
    /**
     * List release policies (asynchronously)
     * Get a list of release policies for the specified project with optional filtering.
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param excludeDefault When true, exclude the default release policy from the response. When false or omitted, include the default policy if an environment filter is present. (optional, default to false)
     ...
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param policyKey The release policy key (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    private okhttp3.Call getReleasePolicyValidateBeforeCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String policyKey, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling getReleasePolicy(Async)");
        }

        // verify the required parameter 'policyKey' is set
        if (policyKey == null) {
            throw new ApiException("Missing the required parameter 'policyKey' when calling getReleasePolicy(Async)");
        }

        return getReleasePolicyCall(ldAPIVersion, projectKey, policyKey, _callback);
    ...
    /**
     * Get a release policy by key (asynchronously)
     * Retrieve a single release policy by its key for the specified project.
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param policyKey The release policy key (required)
     ...
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param requestBody Array of release policy keys in the desired rank order (scoped policies only). These keys must include _all_ of the scoped release policies for the project. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call postReleasePoliciesOrderCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull List<String> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/release-policies/order"
            .replace("{" + "projectKey" + "}", localVarApiClient.escapeString(projectKey.toString()));
    ...
    private okhttp3.Call postReleasePoliciesOrderValidateBeforeCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull List<String> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling postReleasePoliciesOrder(Async)");
        }

        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
            throw new ApiException("Missing the required parameter 'requestBody' when calling postReleasePoliciesOrder(Async)");
        }

        return postReleasePoliciesOrderCall(ldAPIVersion, projectKey, requestBody, _callback);
    ...
    /**
     * Update the order of existing release policies (asynchronously)
     * Update the order of existing release policies for the specified project.
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param requestBody Array of release policy keys in the desired rank order (scoped policies only). These keys must include _all_ of the scoped release policies for the project. (required)
     ...
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param postReleasePolicyRequest Release policy to create (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call postReleasePolicyCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull PostReleasePolicyRequest postReleasePolicyRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = postReleasePolicyRequest;
    ...
    private okhttp3.Call postReleasePolicyValidateBeforeCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull PostReleasePolicyRequest postReleasePolicyRequest, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling postReleasePolicy(Async)");
        }

        // verify the required parameter 'postReleasePolicyRequest' is set
        if (postReleasePolicyRequest == null) {
            throw new ApiException("Missing the required parameter 'postReleasePolicyRequest' when calling postReleasePolicy(Async)");
        }

        return postReleasePolicyCall(ldAPIVersion, projectKey, postReleasePolicyRequest, _callback);
    ...
    /**
     * Create a release policy (asynchronously)
     * Create a new release policy for the specified project.
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param postReleasePolicyRequest Release policy to create (required)
     ...
     * @param projectKey The project key (required)
     * @param policyKey The human-readable key of the release policy (required)
     * @param putReleasePolicyRequest Release policy data to update (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call putReleasePolicyCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String policyKey, @javax.annotation.Nonnull PutReleasePolicyRequest putReleasePolicyRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = putReleasePolicyRequest;
    ...
    private okhttp3.Call putReleasePolicyValidateBeforeCall(@javax.annotation.Nonnull String ldAPIVersion, @javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String policyKey, @javax.annotation.Nonnull PutReleasePolicyRequest putReleasePolicyRequest, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling putReleasePolicy(Async)");
        }

        // verify the required parameter 'policyKey' is set
        if (policyKey == null) {
            throw new ApiException("Missing the required parameter 'policyKey' when calling putReleasePolicy(Async)");
        }

        // verify the required parameter 'putReleasePolicyRequest' is set
        if (putReleasePolicyRequest == null) {
            throw new ApiException("Missing the required parameter 'putReleasePolicyRequest' when calling putReleasePolicy(Async)");
        }

        return putReleasePolicyCall(ldAPIVersion, projectKey, policyKey, putReleasePolicyRequest, _callback);
    ...
    /**
     * Update a release policy (asynchronously)
     * Update an existing release policy for the specified project.
     * @param ldAPIVersion Version of the endpoint. (required)
     * @param projectKey The project key (required)
     * @param policyKey The human-readable key of the release policy (required)
