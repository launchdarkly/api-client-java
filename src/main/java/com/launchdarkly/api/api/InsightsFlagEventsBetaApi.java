...
public class InsightsFlagEventsBetaApi {
    ...
    public okhttp3.Call getFlagEventsCall(String projectKey, String environmentKey, String applicationKey, String query, String impactSize, Boolean hasExperiments, String global, String expand, Long limit, Long from, Long to, String after, String before, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/engineering-insights/flag-events";
        ...
        if (impactSize != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("impactSize", impactSize));
        }
    ...
    private okhttp3.Call getFlagEventsValidateBeforeCall(String projectKey, String environmentKey, String applicationKey, String query, String impactSize, Boolean hasExperiments, String global, String expand, Long limit, Long from, Long to, String after, String before, final ApiCallback _callback) throws ApiException {
        ...
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling getFlagEvents(Async)");
        }
        

        okhttp3.Call localVarCall = getFlagEventsCall(projectKey, environmentKey, applicationKey, query, impactSize, hasExperiments, global, expand, limit, from, to, after, before, _callback);
        return localVarCall;
    ...
    /**
     * List flag events (asynchronously)
     * Get a list of flag events  ### Expanding the flag event collection response  LaunchDarkly supports expanding the flag event collection response to include additional fields.  To expand the response, append the &#x60;expand&#x60; query parameter and include the following:  * &#x60;experiments&#x60; includes details on all of the experiments run on each flag  For example, use &#x60;?expand&#x3D;experiments&#x60; to include the &#x60;experiments&#x60; field in the response. By default, this field is **not** included in the response. 
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param applicationKey Comma separated list of application keys (optional)
