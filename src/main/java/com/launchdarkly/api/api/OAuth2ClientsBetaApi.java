...
public class OAuth2ClientsBetaApi {
     ...
     * @param oauthClientPost  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Successful OAuth 2.0 client creation response </td><td>  -  </td></tr>
    ...
    public okhttp3.Call createOAuth2ClientCall(OauthClientPost oauthClientPost, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = oauthClientPost;
    ...
    private okhttp3.Call createOAuth2ClientValidateBeforeCall(OauthClientPost oauthClientPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createOAuth2ClientCall(oauthClientPost, _callback);
        return localVarCall;
    ...
    /**
     * Create a LaunchDarkly OAuth 2.0 client (asynchronously)
     * Create (register) a LaunchDarkly OAuth2 client. OAuth2 clients allow you to build custom integrations using LaunchDarkly as your identity provider.
     * @param oauthClientPost  (required)
    ...
    public okhttp3.Call deleteOAuthClientCall(String clientId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/oauth/clients/{clientId}"
    ...
    private okhttp3.Call deleteOAuthClientValidateBeforeCall(String clientId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteOAuthClientCall(clientId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getOAuthClientByIdValidateBeforeCall(String clientId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getOAuthClientByIdCall(clientId, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call getOAuthClientsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOAuthClientsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getOAuthClientsCall(_callback);
        return localVarCall;
    ...
    public ClientCollection getOAuthClients() throws ApiException {
        ApiResponse<ClientCollection> localVarResp = getOAuthClientsWithHttpInfo();
        return localVarResp.getData();
    }
    ...
    public ApiResponse<ClientCollection> getOAuthClientsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getOAuthClientsValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getOAuthClientsAsync(final ApiCallback<ClientCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOAuthClientsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<ClientCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call patchOAuthClientValidateBeforeCall(String clientId, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchOAuthClientCall(clientId, patchOperation, _callback);
        return localVarCall;
