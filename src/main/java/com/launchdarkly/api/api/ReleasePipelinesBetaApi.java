...
public class ReleasePipelinesBetaApi {
    ...
    private okhttp3.Call getAllReleasePipelinesValidateBeforeCall(String projectKey, String filter, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllReleasePipelinesCall(projectKey, filter, limit, offset, _callback);
        return localVarCall;
    ...
    /**
     * Build call for getAllReleaseProgressionsForReleasePipeline
     * @param projectKey The project key (required)
     * @param pipelineKey The pipeline key (required)
    ...
    public okhttp3.Call getAllReleaseProgressionsForReleasePipelineCall(String projectKey, String pipelineKey, String filter, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}/releases"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "pipelineKey" + "\\}", localVarApiClient.escapeString(pipelineKey.toString()));
    ...
    private okhttp3.Call getAllReleaseProgressionsForReleasePipelineValidateBeforeCall(String projectKey, String pipelineKey, String filter, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllReleaseProgressionsForReleasePipelineCall(projectKey, pipelineKey, filter, limit, offset, _callback);
        return localVarCall;
    ...
    /**
     * Get release progressions for release pipeline (asynchronously)
     * Get details on the progression of all releases, across all flags, for a release pipeline
     * @param projectKey The project key (required)
     * @param pipelineKey The pipeline key (required)
     * @param filter Accepts filter by &#x60;status&#x60; and &#x60;activePhaseId&#x60;. &#x60;status&#x60; can take a value of &#x60;completed&#x60; or &#x60;active&#x60;. &#x60;activePhaseId&#x60; takes a UUID and will filter results down to releases active on the specified phase. Providing &#x60;status equals completed&#x60; along with an &#x60;activePhaseId&#x60; filter will return an error as they are disjoint sets of data. The combination of &#x60;status equals active&#x60; and &#x60;activePhaseId&#x60; will return the same results as &#x60;activePhaseId&#x60; alone. (optional)
