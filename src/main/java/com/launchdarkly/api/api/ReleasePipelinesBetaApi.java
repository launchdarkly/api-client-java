...
public class ReleasePipelinesBetaApi {
    ...
    public okhttp3.Call deleteReleasePipelineCall(String projectKey, String pipelineKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "pipelineKey" + "\\}", localVarApiClient.escapeString(pipelineKey.toString()));
    ...
    private okhttp3.Call deleteReleasePipelineValidateBeforeCall(String projectKey, String pipelineKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteReleasePipelineCall(projectKey, pipelineKey, _callback);
        return localVarCall;
    ...
    /**
     * Delete release pipeline (asynchronously)
     * Delete a release pipeline
     * @param projectKey The project key (required)
     * @param pipelineKey The release pipeline key (required)
     ...
     */
    public okhttp3.Call getAllReleasePipelinesCall(String projectKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/release-pipelines"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllReleasePipelinesValidateBeforeCall(String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllReleasePipelinesCall(projectKey, _callback);
        return localVarCall;
     ...
     */
    public ReleasePipelineCollection getAllReleasePipelines(String projectKey) throws ApiException {
        ApiResponse<ReleasePipelineCollection> localVarResp = getAllReleasePipelinesWithHttpInfo(projectKey);
     ...
     */
    public ApiResponse<ReleasePipelineCollection> getAllReleasePipelinesWithHttpInfo(String projectKey) throws ApiException {
        okhttp3.Call localVarCall = getAllReleasePipelinesValidateBeforeCall(projectKey, null);
        Type localVarReturnType = new TypeToken<ReleasePipelineCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all release pipelines (asynchronously)
     * Get all release pipelines for a project
     * @param projectKey The project key (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getAllReleasePipelinesAsync(String projectKey, final ApiCallback<ReleasePipelineCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllReleasePipelinesValidateBeforeCall(projectKey, _callback);
        Type localVarReturnType = new TypeToken<ReleasePipelineCollection>(){}.getType();
    ...
    private okhttp3.Call getReleasePipelineByKeyValidateBeforeCall(String projectKey, String pipelineKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getReleasePipelineByKeyCall(projectKey, pipelineKey, _callback);
        return localVarCall;
    ...
    /**
     * Get release pipeline by key (asynchronously)
     * Get a release pipeline by key
     * @param projectKey The project key (required)
     * @param pipelineKey The release pipeline key (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call patchReleasePipelineCall(String projectKey, String pipelineKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchReleasePipelineValidateBeforeCall(String projectKey, String pipelineKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchReleasePipelineCall(projectKey, pipelineKey, _callback);
        return localVarCall;
     ...
     */
    public ReleasePipeline patchReleasePipeline(String projectKey, String pipelineKey) throws ApiException {
        ApiResponse<ReleasePipeline> localVarResp = patchReleasePipelineWithHttpInfo(projectKey, pipelineKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ReleasePipeline> patchReleasePipelineWithHttpInfo(String projectKey, String pipelineKey) throws ApiException {
        okhttp3.Call localVarCall = patchReleasePipelineValidateBeforeCall(projectKey, pipelineKey, null);
        Type localVarReturnType = new TypeToken<ReleasePipeline>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update a release pipeline (asynchronously)
     * Updates a release pipeline. Updating a release pipeline uses a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes. To learn more, read [Updates](/#section/Overview/Updates).
     * @param projectKey The project key (required)
     * @param pipelineKey The release pipeline key (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call patchReleasePipelineAsync(String projectKey, String pipelineKey, final ApiCallback<ReleasePipeline> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchReleasePipelineValidateBeforeCall(projectKey, pipelineKey, _callback);
        Type localVarReturnType = new TypeToken<ReleasePipeline>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param projectKey The project key (required)
     * @param createReleasePipelineInput  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call postReleasePipelineCall(String projectKey, CreateReleasePipelineInput createReleasePipelineInput, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createReleasePipelineInput;
    ...
    private okhttp3.Call postReleasePipelineValidateBeforeCall(String projectKey, CreateReleasePipelineInput createReleasePipelineInput, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postReleasePipelineCall(projectKey, createReleasePipelineInput, _callback);
        return localVarCall;
    ...
    /**
     * Create a release pipeline (asynchronously)
     * Creates a new release pipeline
     * @param projectKey The project key (required)
     * @param createReleasePipelineInput  (required)
     * @param _callback The callback to be executed when the API call finishes
