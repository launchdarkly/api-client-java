...
public class IntegrationDeliveryConfigurationsBetaApi {
    ...
    public okhttp3.Call createIntegrationDeliveryConfigurationCall(String projectKey, String environmentKey, String integrationKey, IntegrationDeliveryConfigurationPost integrationDeliveryConfigurationPost, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/integration-capabilities/featureStore/{projectKey}/{environmentKey}/{integrationKey}"
    ...
    private okhttp3.Call createIntegrationDeliveryConfigurationValidateBeforeCall(String projectKey, String environmentKey, String integrationKey, IntegrationDeliveryConfigurationPost integrationDeliveryConfigurationPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createIntegrationDeliveryConfigurationCall(projectKey, environmentKey, integrationKey, integrationDeliveryConfigurationPost, _callback);
        return localVarCall;
    ...
    /**
     * Create delivery configuration (asynchronously)
     * Create a delivery configuration.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param integrationKey The integration key (required)
    ...
    public okhttp3.Call deleteIntegrationDeliveryConfigurationCall(String projectKey, String environmentKey, String integrationKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/integration-capabilities/featureStore/{projectKey}/{environmentKey}/{integrationKey}/{id}"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "integrationKey" + "\\}", localVarApiClient.escapeString(integrationKey.toString()))
    ...
    private okhttp3.Call deleteIntegrationDeliveryConfigurationValidateBeforeCall(String projectKey, String environmentKey, String integrationKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteIntegrationDeliveryConfigurationCall(projectKey, environmentKey, integrationKey, id, _callback);
        return localVarCall;
    ...
    /**
     * Delete delivery configuration (asynchronously)
     * Delete a delivery configuration
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param integrationKey The integration key (required)
    ...
    public okhttp3.Call getIntegrationDeliveryConfigurationByEnvironmentCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/integration-capabilities/featureStore/{projectKey}/{environmentKey}"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()));
    ...
    private okhttp3.Call getIntegrationDeliveryConfigurationByEnvironmentValidateBeforeCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIntegrationDeliveryConfigurationByEnvironmentCall(projectKey, environmentKey, _callback);
        return localVarCall;
    ...
    /**
     * Get delivery configurations by environment (asynchronously)
     * Get delivery configurations by environment.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    private okhttp3.Call getIntegrationDeliveryConfigurationByIdValidateBeforeCall(String projectKey, String environmentKey, String integrationKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIntegrationDeliveryConfigurationByIdCall(projectKey, environmentKey, integrationKey, id, _callback);
        return localVarCall;
    ...
    /**
     * Get delivery configuration by ID (asynchronously)
     * Get delivery configuration by ID.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param integrationKey The integration key (required)
     ...
     */
    public okhttp3.Call getIntegrationDeliveryConfigurationsCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getIntegrationDeliveryConfigurationsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getIntegrationDeliveryConfigurationsCall(_callback);
        return localVarCall;
    ...
    public IntegrationDeliveryConfigurationCollection getIntegrationDeliveryConfigurations() throws ApiException {
        ApiResponse<IntegrationDeliveryConfigurationCollection> localVarResp = getIntegrationDeliveryConfigurationsWithHttpInfo();
        return localVarResp.getData();
    }
    ...
    public ApiResponse<IntegrationDeliveryConfigurationCollection> getIntegrationDeliveryConfigurationsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getIntegrationDeliveryConfigurationsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<IntegrationDeliveryConfigurationCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List all delivery configurations (asynchronously)
     * List all delivery configurations.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getIntegrationDeliveryConfigurationsAsync(final ApiCallback<IntegrationDeliveryConfigurationCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIntegrationDeliveryConfigurationsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<IntegrationDeliveryConfigurationCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource identifier </td><td>  -  </td></tr>
        <tr><td> 422 </td><td> Invalid patch content </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     </table>
     */
    ...
    private okhttp3.Call patchIntegrationDeliveryConfigurationValidateBeforeCall(String projectKey, String environmentKey, String integrationKey, String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchIntegrationDeliveryConfigurationCall(projectKey, environmentKey, integrationKey, id, patchOperation, _callback);
        return localVarCall;
    ...
    /**
     * Update delivery configuration (asynchronously)
     * Update an integration delivery configuration.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param integrationKey The integration key (required)
    ...
    public okhttp3.Call validateIntegrationDeliveryConfigurationCall(String projectKey, String environmentKey, String integrationKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/integration-capabilities/featureStore/{projectKey}/{environmentKey}/{integrationKey}/{id}/validate"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "integrationKey" + "\\}", localVarApiClient.escapeString(integrationKey.toString()))
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    private okhttp3.Call validateIntegrationDeliveryConfigurationValidateBeforeCall(String projectKey, String environmentKey, String integrationKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = validateIntegrationDeliveryConfigurationCall(projectKey, environmentKey, integrationKey, id, _callback);
        return localVarCall;
    ...
    /**
     * Validate delivery configuration (asynchronously)
     * Validate the saved delivery configuration.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param integrationKey The integration key (required)
