...
public class UsersBetaApi {
    ...
    public okhttp3.Call getUserAttributeNamesCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/user-attributes/{projectKey}/{environmentKey}"
    ...
    private okhttp3.Call getUserAttributeNamesValidateBeforeCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling getUserAttributeNames(Async)");
        }
        

        okhttp3.Call localVarCall = getUserAttributeNamesCall(projectKey, environmentKey, _callback);
        return localVarCall;
    ...
    /**
     * Get user attribute names (asynchronously)
     * Get all in-use user attributes in the specified environment. The set of in-use attributes typically consists of all attributes seen within the past 30 days.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
