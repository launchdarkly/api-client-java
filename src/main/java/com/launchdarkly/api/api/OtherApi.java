...
import com.launchdarkly.api.model.CallerIdentityRep;
...
public class OtherApi {
     ...
     */
    public okhttp3.Call getCallerIdentityCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/caller-identity";
    ...
    private okhttp3.Call getCallerIdentityValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getCallerIdentityCall(_callback);
        return localVarCall;
     ...
     */
    public CallerIdentityRep getCallerIdentity() throws ApiException {
        ApiResponse<CallerIdentityRep> localVarResp = getCallerIdentityWithHttpInfo();
     ...
     */
    public ApiResponse<CallerIdentityRep> getCallerIdentityWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getCallerIdentityValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<CallerIdentityRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Identify the caller (asynchronously)
     * Get basic information about the identity used (session cookie, API token, SDK keys, etc.) to call the API
     ...
     */
    public okhttp3.Call getCallerIdentityAsync(final ApiCallback<CallerIdentityRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCallerIdentityValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<CallerIdentityRep>(){}.getType();
    ...
    public okhttp3.Call getIpsCall(final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/public-ip-list";
    ...
    private okhttp3.Call getIpsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIpsCall(_callback);
        return localVarCall;
    ...
    public IpList getIps() throws ApiException {
        ApiResponse<IpList> localVarResp = getIpsWithHttpInfo();
        return localVarResp.getData();
    }
    ...
    /**
     * Gets the public IP list (asynchronously)
     * Get a list of IP ranges the LaunchDarkly service uses. You can use this list to allow LaunchDarkly through your firewall. We post upcoming changes to this list in advance on our [status page](https://status.launchdarkly.com/). &lt;br /&gt;&lt;br /&gt;In the sandbox, click &#39;Try it&#39; and enter any string in the &#39;Authorization&#39; field to test this endpoint.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getIpsAsync(final ApiCallback<IpList> _callback) throws ApiException {
    ...
    public okhttp3.Call getOpenapiSpecCall(final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/openapi.json";
    ...
    /**
     * Gets the OpenAPI spec in json (asynchronously)
     * Get the latest version of the OpenAPI specification for LaunchDarkly&#39;s API in JSON format. In the sandbox, click &#39;Try it&#39; and enter any string in the &#39;Authorization&#39; field to test this endpoint.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getOpenapiSpecAsync(final ApiCallback<Void> _callback) throws ApiException {
    ...
    private okhttp3.Call getRootValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getRootCall(_callback);
        return localVarCall;
    ...
    public RootResponse getRoot() throws ApiException {
        ApiResponse<RootResponse> localVarResp = getRootWithHttpInfo();
        return localVarResp.getData();
    }
    ...
    public ApiResponse<RootResponse> getRootWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<RootResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Root resource (asynchronously)
     * Get all of the resource categories the API supports. In the sandbox, click &#39;Try it&#39; and enter any string in the &#39;Authorization&#39; field to test this endpoint.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getRootAsync(final ApiCallback<RootResponse> _callback) throws ApiException {
    ...
    public VersionsRep getVersions() throws ApiException {
        ApiResponse<VersionsRep> localVarResp = getVersionsWithHttpInfo();
        return localVarResp.getData();
    }
    ...
    public ApiResponse<VersionsRep> getVersionsWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<VersionsRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getVersionsAsync(final ApiCallback<VersionsRep> _callback) throws ApiException {
