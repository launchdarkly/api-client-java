...
public class OtherApi {
     ...
     */
    public Map<String, Link> getRoot() throws ApiException {
        ApiResponse<Map<String, Link>> localVarResp = getRootWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * Root resource
     * Issue a &#x60;GET&#x60; request to the root resource to find all of the resource categories supported by the API
     * @return ApiResponse&lt;Map&lt;String, Link&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<Map<String, Link>> getRootWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getRootValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<Map<String, Link>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getRootAsync(final ApiCallback<Map<String, Link>> _callback) throws ApiException {
