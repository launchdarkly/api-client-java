...
public class InsightsRepositoriesBetaApi {
     ...
     * @param insightsRepositoryProjectMappings  (required)
    ...
    public okhttp3.Call associateRepositoriesAndProjectsCall(InsightsRepositoryProjectMappings insightsRepositoryProjectMappings, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = insightsRepositoryProjectMappings;
    ...
    private okhttp3.Call associateRepositoriesAndProjectsValidateBeforeCall(InsightsRepositoryProjectMappings insightsRepositoryProjectMappings, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = associateRepositoriesAndProjectsCall(insightsRepositoryProjectMappings, _callback);
        return localVarCall;
    ...
    /**
     * Associate repositories with projects (asynchronously)
     * Associate repositories with projects
     * @param insightsRepositoryProjectMappings  (required)
     ...
     * @param repositoryKey The repository key (required)
    ...
    public okhttp3.Call deleteRepositoryProjectCall(String repositoryKey, String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/engineering-insights/repositories/{repositoryKey}/projects/{projectKey}"
            .replaceAll("\\{" + "repositoryKey" + "\\}", localVarApiClient.escapeString(repositoryKey.toString()))
    ...
    private okhttp3.Call deleteRepositoryProjectValidateBeforeCall(String repositoryKey, String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteRepositoryProjectCall(repositoryKey, projectKey, _callback);
        return localVarCall;
    ...
    /**
     * Remove repository project association (asynchronously)
     * Remove repository project association
     * @param repositoryKey The repository key (required)
     * @param projectKey The project key (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    private okhttp3.Call getInsightsRepositoriesValidateBeforeCall(String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInsightsRepositoriesCall(expand, _callback);
        return localVarCall;
