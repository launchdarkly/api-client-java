...
import com.launchdarkly.api.model.CreateApplicationInput;
import com.launchdarkly.api.model.CreateApplicationVersionInput;
...
public class ApplicationsBetaApi {
     ...
     * @param createApplicationInput  (required)
     ...
     */
    public okhttp3.Call createApplicationCall(CreateApplicationInput createApplicationInput, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createApplicationInput;
    ...
    private okhttp3.Call createApplicationValidateBeforeCall(CreateApplicationInput createApplicationInput, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'createApplicationInput' is set
        if (createApplicationInput == null) {
            throw new ApiException("Missing the required parameter 'createApplicationInput' when calling createApplication(Async)");
        }
        

        okhttp3.Call localVarCall = createApplicationCall(createApplicationInput, _callback);
        return localVarCall;
     ...
     */
    public ApplicationRep createApplication(CreateApplicationInput createApplicationInput) throws ApiException {
        ApiResponse<ApplicationRep> localVarResp = createApplicationWithHttpInfo(createApplicationInput);
     ...
     */
    public ApiResponse<ApplicationRep> createApplicationWithHttpInfo(CreateApplicationInput createApplicationInput) throws ApiException {
        okhttp3.Call localVarCall = createApplicationValidateBeforeCall(createApplicationInput, null);
     ...
     */
    public okhttp3.Call createApplicationAsync(CreateApplicationInput createApplicationInput, final ApiCallback<ApplicationRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = createApplicationValidateBeforeCall(createApplicationInput, _callback);
        Type localVarReturnType = new TypeToken<ApplicationRep>(){}.getType();
    ...
    private okhttp3.Call deleteApplicationValidateBeforeCall(String applicationKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteApplicationCall(applicationKey, _callback);
        return localVarCall;
    ...
    public okhttp3.Call deleteApplicationVersionCall(String applicationKey, String versionKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/applications/{applicationKey}/versions/{versionKey}"
            .replaceAll("\\{" + "applicationKey" + "\\}", localVarApiClient.escapeString(applicationKey.toString()))
            .replaceAll("\\{" + "versionKey" + "\\}", localVarApiClient.escapeString(versionKey.toString()));
    ...
    private okhttp3.Call deleteApplicationVersionValidateBeforeCall(String applicationKey, String versionKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteApplicationVersionCall(applicationKey, versionKey, _callback);
        return localVarCall;
    ...
    /**
     * Delete application version (asynchronously)
     * Delete an application version.
     * @param applicationKey The application key (required)
     * @param versionKey The application version key (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    private okhttp3.Call getApplicationValidateBeforeCall(String applicationKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getApplicationCall(applicationKey, expand, _callback);
        return localVarCall;
    ...
    /**
     * Get application by key (asynchronously)
     *  Retrieve an application by the application key.  ### Expanding the application response  LaunchDarkly supports expanding the \&quot;Get application\&quot; response to include additional fields.  To expand the response, append the &#x60;expand&#x60; query parameter and include the following:  * &#x60;flags&#x60; includes details on the flags that have been evaluated by the application  For example, use &#x60;?expand&#x3D;flags&#x60; to include the &#x60;flags&#x60; field in the response. By default, this field is **not** included in the response. 
     * @param applicationKey The application key (required)
     * @param expand A comma-separated list of properties that can reveal additional information in the response. Options: &#x60;flags&#x60;. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @param applicationKey The application key (required)
     * @param filter Accepts filter by &#x60;key&#x60;, &#x60;name&#x60;, &#x60;supported&#x60;, and &#x60;autoAdded&#x60;. Example: &#x60;filter&#x3D;key equals &#39;test-key&#39;&#x60;. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances). (optional)
    ...
    private okhttp3.Call getApplicationVersionsValidateBeforeCall(String applicationKey, String filter, Long limit, Long offset, String sort, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getApplicationVersionsCall(applicationKey, filter, limit, offset, sort, _callback);
        return localVarCall;
    ...
    /**
     * Get application versions by application key (asynchronously)
     * Get a list of versions for a specific application in an account.
     * @param applicationKey The application key (required)
     * @param filter Accepts filter by &#x60;key&#x60;, &#x60;name&#x60;, &#x60;supported&#x60;, and &#x60;autoAdded&#x60;. Example: &#x60;filter&#x3D;key equals &#39;test-key&#39;&#x60;. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances). (optional)
     * @param limit The number of versions to return. Defaults to 50. (optional)
     ...
     * @param filter Accepts filter by &#x60;key&#x60;, &#x60;name&#x60;, &#x60;kind&#x60;, and &#x60;autoAdded&#x60;. Example: &#x60;filter&#x3D;kind anyOf [&#39;mobile&#39;, &#39;server&#39;],key equals &#39;test-key&#39;&#x60;. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances). (optional)
    ...
    private okhttp3.Call getApplicationsValidateBeforeCall(String filter, Long limit, Long offset, String sort, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getApplicationsCall(filter, limit, offset, sort, expand, _callback);
        return localVarCall;
    ...
    private okhttp3.Call patchApplicationValidateBeforeCall(String applicationKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchApplicationCall(applicationKey, patchOperation, _callback);
        return localVarCall;
    ...
    private okhttp3.Call patchApplicationVersionValidateBeforeCall(String applicationKey, String versionKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchApplicationVersionCall(applicationKey, versionKey, patchOperation, _callback);
        return localVarCall;
    ...
    /**
     * Update application version (asynchronously)
     * Update an application version. You can update the &#x60;supported&#x60; field. Requires a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes to the application version. To learn more, read [Updates](/#section/Overview/Updates).
     * @param applicationKey The application key (required)
     * @param versionKey The application version key (required)
     * @param patchOperation  (required)
    ...
    /**
     * Build call for postApplicationVersion
     * @param applicationKey The application key (required)
     * @param createApplicationVersionInput  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postApplicationVersionCall(String applicationKey, CreateApplicationVersionInput createApplicationVersionInput, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = createApplicationVersionInput;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postApplicationVersionValidateBeforeCall(String applicationKey, CreateApplicationVersionInput createApplicationVersionInput, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'applicationKey' is set
        if (applicationKey == null) {
            throw new ApiException("Missing the required parameter 'applicationKey' when calling postApplicationVersion(Async)");
        }
        
        // verify the required parameter 'createApplicationVersionInput' is set
        if (createApplicationVersionInput == null) {
            throw new ApiException("Missing the required parameter 'createApplicationVersionInput' when calling postApplicationVersion(Async)");
        }
        

        okhttp3.Call localVarCall = postApplicationVersionCall(applicationKey, createApplicationVersionInput, _callback);
        return localVarCall;
     ...
     */
    public ApplicationVersionRep postApplicationVersion(String applicationKey, CreateApplicationVersionInput createApplicationVersionInput) throws ApiException {
        ApiResponse<ApplicationVersionRep> localVarResp = postApplicationVersionWithHttpInfo(applicationKey, createApplicationVersionInput);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ApplicationVersionRep> postApplicationVersionWithHttpInfo(String applicationKey, CreateApplicationVersionInput createApplicationVersionInput) throws ApiException {
        okhttp3.Call localVarCall = postApplicationVersionValidateBeforeCall(applicationKey, createApplicationVersionInput, null);
        Type localVarReturnType = new TypeToken<ApplicationVersionRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Post application version (asynchronously)
     * Create an application version
     * @param applicationKey The application key (required)
     * @param createApplicationVersionInput  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call postApplicationVersionAsync(String applicationKey, CreateApplicationVersionInput createApplicationVersionInput, final ApiCallback<ApplicationVersionRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = postApplicationVersionValidateBeforeCall(applicationKey, createApplicationVersionInput, _callback);
        Type localVarReturnType = new TypeToken<ApplicationVersionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
