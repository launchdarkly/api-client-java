...
public class ProjectsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Cannot delete last project in an account </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Unknown project key </td><td>  -  </td></tr>
    ...
    private okhttp3.Call deleteProjectValidateBeforeCall(String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteProjectCall(projectKey, _callback);
        return localVarCall;
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Project response JSON </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Unknown project key </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getProjectCall(String projectKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectValidateBeforeCall(String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectCall(projectKey, _callback);
        return localVarCall;
    ...
    public Project getProject(String projectKey) throws ApiException {
        ApiResponse<Project> localVarResp = getProjectWithHttpInfo(projectKey);
    ...
    public ApiResponse<Project> getProjectWithHttpInfo(String projectKey) throws ApiException {
        okhttp3.Call localVarCall = getProjectValidateBeforeCall(projectKey, null);
     ...
     */
    public okhttp3.Call getProjectAsync(String projectKey, final ApiCallback<Project> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectValidateBeforeCall(projectKey, _callback);
        Type localVarReturnType = new TypeToken<Project>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Project collection response JSON </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     </table>
    ...
    public Projects getProjects() throws ApiException {
        ApiResponse<Projects> localVarResp = getProjectsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call getProjectsAsync(final ApiCallback<Projects> _callback) throws ApiException {
    ...
    private okhttp3.Call patchProjectValidateBeforeCall(String projectKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchProjectCall(projectKey, patchOperation, _callback);
        return localVarCall;
     ...
     */
    public Project patchProject(String projectKey, List<PatchOperation> patchOperation) throws ApiException {
        ApiResponse<Project> localVarResp = patchProjectWithHttpInfo(projectKey, patchOperation);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Project> patchProjectWithHttpInfo(String projectKey, List<PatchOperation> patchOperation) throws ApiException {
     ...
     */
    public okhttp3.Call patchProjectAsync(String projectKey, List<PatchOperation> patchOperation, final ApiCallback<Project> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Successful project response </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request body </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> Status conflict </td><td>  -  </td></tr>
    ...
    private okhttp3.Call postProjectValidateBeforeCall(ProjectPost projectPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postProjectCall(projectPost, _callback);
        return localVarCall;
     ...
     */
    public Project postProject(ProjectPost projectPost) throws ApiException {
        ApiResponse<Project> localVarResp = postProjectWithHttpInfo(projectPost);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Project> postProjectWithHttpInfo(ProjectPost projectPost) throws ApiException {
     ...
     */
    public okhttp3.Call postProjectAsync(ProjectPost projectPost, final ApiCallback<Project> _callback) throws ApiException {
