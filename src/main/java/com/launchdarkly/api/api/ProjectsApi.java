...
public class ProjectsApi {
    ...
    /**
     * Build call for getFlagDefaultsByProject
     * @param projectKey The project key (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public okhttp3.Call getFlagDefaultsByProjectCall(String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/flag-defaults"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()));
    ...
    private okhttp3.Call getFlagDefaultsByProjectValidateBeforeCall(String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getFlagDefaultsByProjectCall(projectKey, _callback);
        return localVarCall;
    ...
    /**
     * Get flag defaults for project (asynchronously)
     * Get the flag defaults for a specific project.
     * @param projectKey The project key (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    private okhttp3.Call getProjectsValidateBeforeCall(Long limit, Long offset, String filter, String sort, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectsCall(limit, offset, filter, sort, expand, _callback);
        return localVarCall;
    ...
    /**
     * Build call for patchFlagDefaultsByProject
     * @param projectKey The project key (required)
    ...
    private okhttp3.Call patchFlagDefaultsByProjectValidateBeforeCall(String projectKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchFlagDefaultsByProjectCall(projectKey, patchOperation, _callback);
        return localVarCall;
    ...
    /**
     * Update flag default for project (asynchronously)
     * Update a flag default. Requires a [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes to the flag default.
     * @param projectKey The project key (required)
     * @param patchOperation  (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Build call for putFlagDefaultsByProject
     * @param projectKey The project key (required)
     * @param upsertFlagDefaultsPayload  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call putFlagDefaultsByProjectCall(String projectKey, UpsertFlagDefaultsPayload upsertFlagDefaultsPayload, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = upsertFlagDefaultsPayload;
    ...
    private okhttp3.Call putFlagDefaultsByProjectValidateBeforeCall(String projectKey, UpsertFlagDefaultsPayload upsertFlagDefaultsPayload, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = putFlagDefaultsByProjectCall(projectKey, upsertFlagDefaultsPayload, _callback);
        return localVarCall;
    ...
    /**
     * Create or update flag defaults for project (asynchronously)
     * Create or update flag defaults for a project.
     * @param projectKey The project key (required)
     * @param upsertFlagDefaultsPayload  (required)
     * @param _callback The callback to be executed when the API call finishes
