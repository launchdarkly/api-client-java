...
public class ProjectsApi {
    ...
    private okhttp3.Call getProjectValidateBeforeCall(String projectKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectCall(projectKey, expand, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call getProjectsCall(Long limit, Long offset, String filter, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectsValidateBeforeCall(Long limit, Long offset, String filter, String expand, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getProjectsCall(limit, offset, filter, expand, _callback);
        return localVarCall;
     ...
     */
    public Projects getProjects(Long limit, Long offset, String filter, String expand) throws ApiException {
        ApiResponse<Projects> localVarResp = getProjectsWithHttpInfo(limit, offset, filter, expand);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Projects> getProjectsWithHttpInfo(Long limit, Long offset, String filter, String expand) throws ApiException {
        okhttp3.Call localVarCall = getProjectsValidateBeforeCall(limit, offset, filter, expand, null);
     ...
     */
    public okhttp3.Call getProjectsAsync(Long limit, Long offset, String filter, String expand, final ApiCallback<Projects> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectsValidateBeforeCall(limit, offset, filter, expand, _callback);
        Type localVarReturnType = new TypeToken<Projects>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
