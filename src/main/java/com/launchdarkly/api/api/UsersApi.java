...
public class UsersApi {
     ...
     */
    public okhttp3.Call deleteUserCall(String projKey, String envKey, String key, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/users/{projKey}/{envKey}/{key}"
    ...
    private okhttp3.Call deleteUserValidateBeforeCall(String projKey, String envKey, String key, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling deleteUser(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling deleteUser(Async)");
        }
        ...
        okhttp3.Call localVarCall = deleteUserCall(projKey, envKey, key, _callback);
        return localVarCall;
     ...
     */
    public void deleteUser(String projKey, String envKey, String key) throws ApiException {
        deleteUserWithHttpInfo(projKey, envKey, key);
    }
     ...
     */
    public ApiResponse<Void> deleteUserWithHttpInfo(String projKey, String envKey, String key) throws ApiException {
        okhttp3.Call localVarCall = deleteUserValidateBeforeCall(projKey, envKey, key, null);
     ...
     */
    public okhttp3.Call deleteUserAsync(String projKey, String envKey, String key, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteUserValidateBeforeCall(projKey, envKey, key, _callback);
     ...
     */
    public okhttp3.Call getSearchUsersCall(String projKey, String envKey, String q, Long limit, Long offset, Long after, String sort, String searchAfter, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/user-search/{projKey}/{envKey}"
            .replaceAll("\\{" + "projKey" + "\\}", localVarApiClient.escapeString(projKey.toString()))
            .replaceAll("\\{" + "envKey" + "\\}", localVarApiClient.escapeString(envKey.toString()));
        ...
        if (searchAfter != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("searchAfter", searchAfter));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSearchUsersValidateBeforeCall(String projKey, String envKey, String q, Long limit, Long offset, Long after, String sort, String searchAfter, String filter, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getSearchUsers(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getSearchUsers(Async)");
        }
        

        okhttp3.Call localVarCall = getSearchUsersCall(projKey, envKey, q, limit, offset, after, sort, searchAfter, filter, _callback);
        return localVarCall;
     ...
     */
    public Users getSearchUsers(String projKey, String envKey, String q, Long limit, Long offset, Long after, String sort, String searchAfter, String filter) throws ApiException {
        ApiResponse<Users> localVarResp = getSearchUsersWithHttpInfo(projKey, envKey, q, limit, offset, after, sort, searchAfter, filter);
     ...
     */
    public ApiResponse<Users> getSearchUsersWithHttpInfo(String projKey, String envKey, String q, Long limit, Long offset, Long after, String sort, String searchAfter, String filter) throws ApiException {
        okhttp3.Call localVarCall = getSearchUsersValidateBeforeCall(projKey, envKey, q, limit, offset, after, sort, searchAfter, filter, null);
     ...
     */
    public okhttp3.Call getSearchUsersAsync(String projKey, String envKey, String q, Long limit, Long offset, Long after, String sort, String searchAfter, String filter, final ApiCallback<Users> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSearchUsersValidateBeforeCall(projKey, envKey, q, limit, offset, after, sort, searchAfter, filter, _callback);
        Type localVarReturnType = new TypeToken<Users>(){}.getType();
     ...
     */
    public okhttp3.Call getUserCall(String projKey, String envKey, String key, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserValidateBeforeCall(String projKey, String envKey, String key, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getUser(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getUser(Async)");
        }
        ...
        okhttp3.Call localVarCall = getUserCall(projKey, envKey, key, _callback);
        return localVarCall;
     ...
     */
    public UserRecord getUser(String projKey, String envKey, String key) throws ApiException {
        ApiResponse<UserRecord> localVarResp = getUserWithHttpInfo(projKey, envKey, key);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserRecord> getUserWithHttpInfo(String projKey, String envKey, String key) throws ApiException {
        okhttp3.Call localVarCall = getUserValidateBeforeCall(projKey, envKey, key, null);
     ...
     */
    public okhttp3.Call getUserAsync(String projKey, String envKey, String key, final ApiCallback<UserRecord> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserValidateBeforeCall(projKey, envKey, key, _callback);
        Type localVarReturnType = new TypeToken<UserRecord>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getUsersCall(String projKey, String envKey, Long limit, String searchAfter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/users/{projKey}/{envKey}"
            .replaceAll("\\{" + "projKey" + "\\}", localVarApiClient.escapeString(projKey.toString()))
            .replaceAll("\\{" + "envKey" + "\\}", localVarApiClient.escapeString(envKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUsersValidateBeforeCall(String projKey, String envKey, Long limit, String searchAfter, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getUsers(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getUsers(Async)");
        }
        

        okhttp3.Call localVarCall = getUsersCall(projKey, envKey, limit, searchAfter, _callback);
        return localVarCall;
     ...
     */
    public Users getUsers(String projKey, String envKey, Long limit, String searchAfter) throws ApiException {
        ApiResponse<Users> localVarResp = getUsersWithHttpInfo(projKey, envKey, limit, searchAfter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Users> getUsersWithHttpInfo(String projKey, String envKey, Long limit, String searchAfter) throws ApiException {
        okhttp3.Call localVarCall = getUsersValidateBeforeCall(projKey, envKey, limit, searchAfter, null);
        Type localVarReturnType = new TypeToken<Users>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getUsersAsync(String projKey, String envKey, Long limit, String searchAfter, final ApiCallback<Users> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUsersValidateBeforeCall(projKey, envKey, limit, searchAfter, _callback);
        Type localVarReturnType = new TypeToken<Users>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
