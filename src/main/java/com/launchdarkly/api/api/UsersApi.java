...
public class UsersApi {
     ...
     */
    public User getUser(String projKey, String envKey, String key) throws ApiException {
        ApiResponse<User> localVarResp = getUserWithHttpInfo(projKey, envKey, key);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<User> getUserWithHttpInfo(String projKey, String envKey, String key) throws ApiException {
     ...
     */
    public okhttp3.Call getUserAsync(String projKey, String envKey, String key, final ApiCallback<User> _callback) throws ApiException {
