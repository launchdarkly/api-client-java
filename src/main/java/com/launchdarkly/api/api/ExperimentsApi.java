...
public class ExperimentsApi {
    ...
    private okhttp3.Call createExperimentValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull ExperimentPost experimentPost, final ApiCallback _callback) throws ApiException {
        ...
        return createExperimentCall(projectKey, environmentKey, experimentPost, _callback);
    ...
    public okhttp3.Call createIterationCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull String experimentKey, @javax.annotation.Nonnull IterationInput iterationInput, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/projects/{projectKey}/environments/{environmentKey}/experiments/{experimentKey}/iterations"
            .replace("{" + "projectKey" + "}", localVarApiClient.escapeString(projectKey.toString()))
            .replace("{" + "environmentKey" + "}", localVarApiClient.escapeString(environmentKey.toString()))
            .replace("{" + "experimentKey" + "}", localVarApiClient.escapeString(experimentKey.toString()));
    ...
    private okhttp3.Call createIterationValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull String experimentKey, @javax.annotation.Nonnull IterationInput iterationInput, final ApiCallback _callback) throws ApiException {
        ...
        return createIterationCall(projectKey, environmentKey, experimentKey, iterationInput, _callback);
    ...
    private okhttp3.Call getExperimentValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull String experimentKey, @javax.annotation.Nullable String expand, final ApiCallback _callback) throws ApiException {
        ...
        return getExperimentCall(projectKey, environmentKey, experimentKey, expand, _callback);
    ...
    private okhttp3.Call getExperimentationSettingsValidateBeforeCall(@javax.annotation.Nonnull String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        return getExperimentationSettingsCall(projectKey, _callback);
    ...
    private okhttp3.Call getExperimentsValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nullable Long limit, @javax.annotation.Nullable Long offset, @javax.annotation.Nullable String filter, @javax.annotation.Nullable String expand, @javax.annotation.Nullable String lifecycleState, final ApiCallback _callback) throws ApiException {
        ...
        return getExperimentsCall(projectKey, environmentKey, limit, offset, filter, expand, lifecycleState, _callback);
     ...
     */
    public okhttp3.Call getExperimentsAnyEnvCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable Long limit, @javax.annotation.Nullable Long offset, @javax.annotation.Nullable String filter, @javax.annotation.Nullable String expand, @javax.annotation.Nullable String lifecycleState, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/experiments"
            .replace("{" + "projectKey" + "}", localVarApiClient.escapeString(projectKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExperimentsAnyEnvValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable Long limit, @javax.annotation.Nullable Long offset, @javax.annotation.Nullable String filter, @javax.annotation.Nullable String expand, @javax.annotation.Nullable String lifecycleState, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling getExperimentsAnyEnv(Async)");
        }

        return getExperimentsAnyEnvCall(projectKey, limit, offset, filter, expand, lifecycleState, _callback);
     ...
     */
    public ExperimentCollectionRep getExperimentsAnyEnv(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable Long limit, @javax.annotation.Nullable Long offset, @javax.annotation.Nullable String filter, @javax.annotation.Nullable String expand, @javax.annotation.Nullable String lifecycleState) throws ApiException {
        ApiResponse<ExperimentCollectionRep> localVarResp = getExperimentsAnyEnvWithHttpInfo(projectKey, limit, offset, filter, expand, lifecycleState);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExperimentCollectionRep> getExperimentsAnyEnvWithHttpInfo(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable Long limit, @javax.annotation.Nullable Long offset, @javax.annotation.Nullable String filter, @javax.annotation.Nullable String expand, @javax.annotation.Nullable String lifecycleState) throws ApiException {
        okhttp3.Call localVarCall = getExperimentsAnyEnvValidateBeforeCall(projectKey, limit, offset, filter, expand, lifecycleState, null);
        Type localVarReturnType = new TypeToken<ExperimentCollectionRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get experiments any environment (asynchronously)
     * Get a list of experiments from across all environments in the project
     * @param projectKey The project key (required)
     * @param limit The maximum number of experiments to return. Defaults to 20. (optional)
     * @param offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;. (optional)
     ...
     */
    public okhttp3.Call getExperimentsAnyEnvAsync(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nullable Long limit, @javax.annotation.Nullable Long offset, @javax.annotation.Nullable String filter, @javax.annotation.Nullable String expand, @javax.annotation.Nullable String lifecycleState, final ApiCallback<ExperimentCollectionRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExperimentsAnyEnvValidateBeforeCall(projectKey, limit, offset, filter, expand, lifecycleState, _callback);
        Type localVarReturnType = new TypeToken<ExperimentCollectionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call patchExperimentValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull String experimentKey, @javax.annotation.Nonnull ExperimentPatchInput experimentPatchInput, final ApiCallback _callback) throws ApiException {
        ...
        return patchExperimentCall(projectKey, environmentKey, experimentKey, experimentPatchInput, _callback);
    ...
    private okhttp3.Call putExperimentationSettingsValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull RandomizationSettingsPut randomizationSettingsPut, final ApiCallback _callback) throws ApiException {
        ...
        return putExperimentationSettingsCall(projectKey, randomizationSettingsPut, _callback);
