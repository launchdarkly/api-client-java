...
public class DataExportDestinationsApi {
    ...
    private okhttp3.Call deleteDestinationValidateBeforeCall(String projectKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteDestinationCall(projectKey, environmentKey, id, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getDestinationValidateBeforeCall(String projectKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getDestinationCall(projectKey, environmentKey, id, _callback);
        return localVarCall;
    ...
    private okhttp3.Call patchDestinationValidateBeforeCall(String projectKey, String environmentKey, String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchDestinationCall(projectKey, environmentKey, id, patchOperation, _callback);
        return localVarCall;
    ...
    private okhttp3.Call postDestinationValidateBeforeCall(String projectKey, String environmentKey, DestinationPost destinationPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postDestinationCall(projectKey, environmentKey, destinationPost, _callback);
        return localVarCall;
    ...
    private okhttp3.Call postGenerateWarehouseDestinationKeyPairValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postGenerateWarehouseDestinationKeyPairCall(_callback);
        return localVarCall;
