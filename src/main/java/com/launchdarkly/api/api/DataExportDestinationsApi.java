...
import com.launchdarkly.api.model.CompleteSetupPostBody;
...
import com.launchdarkly.api.model.WarehouseDestinationSetupScriptRep;
import com.launchdarkly.api.model.WarehouseSetupScriptPostBody;
...
public class DataExportDestinationsApi {
    ...
    public okhttp3.Call deleteDestinationCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/destinations/{projectKey}/{environmentKey}/{id}"
    ...
    private okhttp3.Call deleteDestinationValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull String id, final ApiCallback _callback) throws ApiException {
        ...
        return deleteDestinationCall(projectKey, environmentKey, id, _callback);
    ...
    /**
     * Delete Data Export destination (asynchronously)
     * Delete a Data Export destination by ID.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param id The Data Export destination ID (required)
    ...
    private okhttp3.Call getDestinationValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull String id, final ApiCallback _callback) throws ApiException {
        ...
        return getDestinationCall(projectKey, environmentKey, id, _callback);
    ...
    public Destinations getDestinations() throws ApiException {
        ApiResponse<Destinations> localVarResp = getDestinationsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call getDestinationsAsync(final ApiCallback<Destinations> _callback) throws ApiException {
    ...
    private okhttp3.Call patchDestinationValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull String id, @javax.annotation.Nonnull List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        return patchDestinationCall(projectKey, environmentKey, id, patchOperation, _callback);
    ...
    /**
     * Update Data Export destination (asynchronously)
     * Update a Data Export destination. Updating a destination uses a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) or [JSON merge patch](https://datatracker.ietf.org/doc/html/rfc7386) representation of the desired changes. To learn more, read [Updates](https://launchdarkly.com/docs/api#updates).
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param id The Data Export destination ID (required)
    ...
    /**
     * Build call for postCompleteWarehouseDestinationSetup
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param kind The destination kind (snowflake-v2, bigquery, clickhouse, redshift) (required)
     * @param completeSetupPostBody  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Completed destination </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Pending destination not found </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call postCompleteWarehouseDestinationSetupCall(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nonnull CompleteSetupPostBody completeSetupPostBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = completeSetupPostBody;

        // create path and map variables
        String localVarPath = "/api/v2/destinations/projects/{projKey}/environments/{envKey}/kinds/{kind}/complete-setup"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postCompleteWarehouseDestinationSetupValidateBeforeCall(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nonnull CompleteSetupPostBody completeSetupPostBody, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling postCompleteWarehouseDestinationSetup(Async)");
        }

        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling postCompleteWarehouseDestinationSetup(Async)");
        }

        // verify the required parameter 'kind' is set
        if (kind == null) {
            throw new ApiException("Missing the required parameter 'kind' when calling postCompleteWarehouseDestinationSetup(Async)");
        }

        // verify the required parameter 'completeSetupPostBody' is set
        if (completeSetupPostBody == null) {
            throw new ApiException("Missing the required parameter 'completeSetupPostBody' when calling postCompleteWarehouseDestinationSetup(Async)");
        }

        return postCompleteWarehouseDestinationSetupCall(projKey, envKey, kind, completeSetupPostBody, _callback);
     ...
     */
    public Destination postCompleteWarehouseDestinationSetup(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nonnull CompleteSetupPostBody completeSetupPostBody) throws ApiException {
        ApiResponse<Destination> localVarResp = postCompleteWarehouseDestinationSetupWithHttpInfo(projKey, envKey, kind, completeSetupPostBody);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Destination> postCompleteWarehouseDestinationSetupWithHttpInfo(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nonnull CompleteSetupPostBody completeSetupPostBody) throws ApiException {
        okhttp3.Call localVarCall = postCompleteWarehouseDestinationSetupValidateBeforeCall(projKey, envKey, kind, completeSetupPostBody, null);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Complete warehouse destination setup (asynchronously)
     * Complete the setup of a warehouse destination by providing the Snowflake host address and the public keys from the /setup response. The custom names are read from the stored configuration.
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param kind The destination kind (snowflake-v2, bigquery, clickhouse, redshift) (required)
     ...
     */
    public okhttp3.Call postCompleteWarehouseDestinationSetupAsync(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nonnull CompleteSetupPostBody completeSetupPostBody, final ApiCallback<Destination> _callback) throws ApiException {

        okhttp3.Call localVarCall = postCompleteWarehouseDestinationSetupValidateBeforeCall(projKey, envKey, kind, completeSetupPostBody, _callback);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param destinationPost  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call postDestinationCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull DestinationPost destinationPost, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = destinationPost;

        // create path and map variables
        String localVarPath = "/api/v2/destinations/{projectKey}/{environmentKey}"
            .replace("{" + "projectKey" + "}", localVarApiClient.escapeString(projectKey.toString()))
            .replace("{" + "environmentKey" + "}", localVarApiClient.escapeString(environmentKey.toString()));
    ...
    private okhttp3.Call postDestinationValidateBeforeCall(@javax.annotation.Nonnull String projectKey, @javax.annotation.Nonnull String environmentKey, @javax.annotation.Nonnull DestinationPost destinationPost, final ApiCallback _callback) throws ApiException {
        ...
        return postDestinationCall(projectKey, environmentKey, destinationPost, _callback);
    ...
    /**
     * Create Data Export destination (asynchronously)
     *  Create a new Data Export destination.  In the &#x60;config&#x60; request body parameter, the fields required depend on the type of Data Export destination.  &lt;details&gt; &lt;summary&gt;Click to expand &lt;code&gt;config&lt;/code&gt; parameter details&lt;/summary&gt;  #### Azure Event Hubs  To create a Data Export destination with a &#x60;kind&#x60; of &#x60;azure-event-hubs&#x60;, the &#x60;config&#x60; object requires the following fields:  * &#x60;namespace&#x60;: The Event Hub Namespace name * &#x60;name&#x60;: The Event Hub name * &#x60;policyName&#x60;: The shared access signature policy name. You can find your policy name in the settings of your Azure Event Hubs Namespace. * &#x60;policyKey&#x60;: The shared access signature key. You can find your policy key in the settings of your Azure Event Hubs Namespace.  #### Google Cloud Pub/Sub  To create a Data Export destination with a &#x60;kind&#x60; of &#x60;google-pubsub&#x60;, the &#x60;config&#x60; object requires the following fields:  * &#x60;project&#x60;: The Google PubSub project ID for the project to publish to * &#x60;topic&#x60;: The Google PubSub topic ID for the topic to publish to  #### Amazon Kinesis  To create a Data Export destination with a &#x60;kind&#x60; of &#x60;kinesis&#x60;, the &#x60;config&#x60; object requires the following fields:  * &#x60;region&#x60;: The Kinesis stream&#39;s AWS region key * &#x60;roleArn&#x60;: The Amazon Resource Name (ARN) of the AWS role that will be writing to Kinesis * &#x60;streamName&#x60;: The name of the Kinesis stream that LaunchDarkly is sending events to. This is not the ARN of the stream.  #### mParticle  To create a Data Export destination with a &#x60;kind&#x60; of &#x60;mparticle&#x60;, the &#x60;config&#x60; object requires the following fields:  * &#x60;apiKey&#x60;: The mParticle API key * &#x60;secret&#x60;: The mParticle API secret * &#x60;userIdentity&#x60;: The type of identifier you use to identify your end users in mParticle * &#x60;anonymousUserIdentity&#x60;: The type of identifier you use to identify your anonymous end users in mParticle  #### Segment  To create a Data Export destination with a &#x60;kind&#x60; of &#x60;segment&#x60;, the &#x60;config&#x60; object requires the following fields:  * &#x60;writeKey&#x60;: The Segment write key. This is used to authenticate LaunchDarkly&#39;s calls to Segment.  #### Snowflake  To create a Data Export destination with a &#x60;kind&#x60; of &#x60;snowflake-v2&#x60;, the &#x60;config&#x60; object requires the following fields:  * &#x60;publicKey&#x60;: The &#x60;publicKey&#x60; is returned as part of the [Generate Snowflake destination key pair](https://launchdarkly.com/docs/api/data-export-destinations/post-generate-warehouse-destination-key-pair) response. It is the &#x60;public_key&#x60; field. * &#x60;snowflakeHostAddress&#x60;: Your Snowflake account URL.  &lt;/details&gt; 
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param destinationPost  (required)
    ...
    /**
     * Build call for postGenerateProjectEnvWarehouseDestinationKeyPair
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call postGenerateProjectEnvWarehouseDestinationKeyPairCall(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/destinations/projects/{projKey}/environments/{envKey}/generate-warehouse-destination-key-pair"
            .replace("{" + "projKey" + "}", localVarApiClient.escapeString(projKey.toString()))
            .replace("{" + "envKey" + "}", localVarApiClient.escapeString(envKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postGenerateProjectEnvWarehouseDestinationKeyPairValidateBeforeCall(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling postGenerateProjectEnvWarehouseDestinationKeyPair(Async)");
        }

        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling postGenerateProjectEnvWarehouseDestinationKeyPair(Async)");
        }

        return postGenerateProjectEnvWarehouseDestinationKeyPairCall(projKey, envKey, _callback);
     ...
     */
    public GenerateWarehouseDestinationKeyPairPostRep postGenerateProjectEnvWarehouseDestinationKeyPair(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey) throws ApiException {
        ApiResponse<GenerateWarehouseDestinationKeyPairPostRep> localVarResp = postGenerateProjectEnvWarehouseDestinationKeyPairWithHttpInfo(projKey, envKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GenerateWarehouseDestinationKeyPairPostRep> postGenerateProjectEnvWarehouseDestinationKeyPairWithHttpInfo(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey) throws ApiException {
        okhttp3.Call localVarCall = postGenerateProjectEnvWarehouseDestinationKeyPairValidateBeforeCall(projKey, envKey, null);
        Type localVarReturnType = new TypeToken<GenerateWarehouseDestinationKeyPairPostRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Generate Snowflake destination key pair (asynchronously)
     * Generate key pair to allow Data Export to authenticate into a Snowflake warehouse destination
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call postGenerateProjectEnvWarehouseDestinationKeyPairAsync(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, final ApiCallback<GenerateWarehouseDestinationKeyPairPostRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = postGenerateProjectEnvWarehouseDestinationKeyPairValidateBeforeCall(projKey, envKey, _callback);
        Type localVarReturnType = new TypeToken<GenerateWarehouseDestinationKeyPairPostRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for postGenerateWarehouseDestinationKeyPair
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postGenerateWarehouseDestinationKeyPairCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postGenerateWarehouseDestinationKeyPairValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return postGenerateWarehouseDestinationKeyPairCall(_callback);
    ...
    public GenerateWarehouseDestinationKeyPairPostRep postGenerateWarehouseDestinationKeyPair() throws ApiException {
        ApiResponse<GenerateWarehouseDestinationKeyPairPostRep> localVarResp = postGenerateWarehouseDestinationKeyPairWithHttpInfo();
        return localVarResp.getData();
    }
    ...
    public ApiResponse<GenerateWarehouseDestinationKeyPairPostRep> postGenerateWarehouseDestinationKeyPairWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = postGenerateWarehouseDestinationKeyPairValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GenerateWarehouseDestinationKeyPairPostRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postGenerateWarehouseDestinationKeyPairAsync(final ApiCallback<GenerateWarehouseDestinationKeyPairPostRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = postGenerateWarehouseDestinationKeyPairValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GenerateWarehouseDestinationKeyPairPostRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for postGenerateWarehouseDestinationSetupScript
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param kind The destination kind (snowflake-v2, redshift, clickhouse) (required)
     * @param warehouseSetupScriptPostBody  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Generate warehouse destination setup script response </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call postGenerateWarehouseDestinationSetupScriptCall(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nullable WarehouseSetupScriptPostBody warehouseSetupScriptPostBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = warehouseSetupScriptPostBody;

        // create path and map variables
        String localVarPath = "/api/v2/destinations/projects/{projKey}/environments/{envKey}/kinds/{kind}/setup"
            .replace("{" + "projKey" + "}", localVarApiClient.escapeString(projKey.toString()))
            .replace("{" + "envKey" + "}", localVarApiClient.escapeString(envKey.toString()))
            .replace("{" + "kind" + "}", localVarApiClient.escapeString(kind.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postGenerateWarehouseDestinationSetupScriptValidateBeforeCall(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nullable WarehouseSetupScriptPostBody warehouseSetupScriptPostBody, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling postGenerateWarehouseDestinationSetupScript(Async)");
        }

        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling postGenerateWarehouseDestinationSetupScript(Async)");
        }

        // verify the required parameter 'kind' is set
        if (kind == null) {
            throw new ApiException("Missing the required parameter 'kind' when calling postGenerateWarehouseDestinationSetupScript(Async)");
        }

        return postGenerateWarehouseDestinationSetupScriptCall(projKey, envKey, kind, warehouseSetupScriptPostBody, _callback);
     ...
     */
    public WarehouseDestinationSetupScriptRep postGenerateWarehouseDestinationSetupScript(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nullable WarehouseSetupScriptPostBody warehouseSetupScriptPostBody) throws ApiException {
        ApiResponse<WarehouseDestinationSetupScriptRep> localVarResp = postGenerateWarehouseDestinationSetupScriptWithHttpInfo(projKey, envKey, kind, warehouseSetupScriptPostBody);
        return localVarResp.getData();
    }
     ...
     * @param kind The destination kind (snowflake-v2, redshift, clickhouse) (required)
     * @param warehouseSetupScriptPostBody  (optional)
     * @return ApiResponse&lt;WarehouseDestinationSetupScriptRep&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<WarehouseDestinationSetupScriptRep> postGenerateWarehouseDestinationSetupScriptWithHttpInfo(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nullable WarehouseSetupScriptPostBody warehouseSetupScriptPostBody) throws ApiException {
        okhttp3.Call localVarCall = postGenerateWarehouseDestinationSetupScriptValidateBeforeCall(projKey, envKey, kind, warehouseSetupScriptPostBody, null);
        Type localVarReturnType = new TypeToken<WarehouseDestinationSetupScriptRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Generate warehouse destination setup script (asynchronously)
     * Generate the SQL setup script required to prepare a warehouse for LaunchDarkly Data Export. For Snowflake, this also generates a key pair. Custom Snowflake object names may be provided. If omitted, defaults are used.
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param kind The destination kind (snowflake-v2, redshift, clickhouse) (required)
     ...
     */
    public okhttp3.Call postGenerateWarehouseDestinationSetupScriptAsync(@javax.annotation.Nonnull String projKey, @javax.annotation.Nonnull String envKey, @javax.annotation.Nonnull String kind, @javax.annotation.Nullable WarehouseSetupScriptPostBody warehouseSetupScriptPostBody, final ApiCallback<WarehouseDestinationSetupScriptRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = postGenerateWarehouseDestinationSetupScriptValidateBeforeCall(projKey, envKey, kind, warehouseSetupScriptPostBody, _callback);
        Type localVarReturnType = new TypeToken<WarehouseDestinationSetupScriptRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
