...
public class DataExportDestinationsApi {
     ...
     */
    public okhttp3.Call deleteDestinationCall(String projKey, String envKey, String id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/destinations/{projKey}/{envKey}/{id}"
    ...
    private okhttp3.Call deleteDestinationValidateBeforeCall(String projKey, String envKey, String id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling deleteDestination(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling deleteDestination(Async)");
        }
        ...
        okhttp3.Call localVarCall = deleteDestinationCall(projKey, envKey, id, _callback);
        return localVarCall;
     ...
     */
    public void deleteDestination(String projKey, String envKey, String id) throws ApiException {
        deleteDestinationWithHttpInfo(projKey, envKey, id);
    }
     ...
     */
    public ApiResponse<Void> deleteDestinationWithHttpInfo(String projKey, String envKey, String id) throws ApiException {
        okhttp3.Call localVarCall = deleteDestinationValidateBeforeCall(projKey, envKey, id, null);
     ...
     */
    public okhttp3.Call deleteDestinationAsync(String projKey, String envKey, String id, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteDestinationValidateBeforeCall(projKey, envKey, id, _callback);
     ...
     */
    public okhttp3.Call getDestinationCall(String projKey, String envKey, String id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDestinationValidateBeforeCall(String projKey, String envKey, String id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getDestination(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getDestination(Async)");
        }
        ...
        okhttp3.Call localVarCall = getDestinationCall(projKey, envKey, id, _callback);
        return localVarCall;
     ...
     */
    public Destination getDestination(String projKey, String envKey, String id) throws ApiException {
        ApiResponse<Destination> localVarResp = getDestinationWithHttpInfo(projKey, envKey, id);
     ...
     */
    public ApiResponse<Destination> getDestinationWithHttpInfo(String projKey, String envKey, String id) throws ApiException {
        okhttp3.Call localVarCall = getDestinationValidateBeforeCall(projKey, envKey, id, null);
     ...
     */
    public okhttp3.Call getDestinationAsync(String projKey, String envKey, String id, final ApiCallback<Destination> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDestinationValidateBeforeCall(projKey, envKey, id, _callback);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
    ...
    private okhttp3.Call getDestinationsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getDestinationsCall(_callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call patchDestinationCall(String projKey, String envKey, String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchDestinationValidateBeforeCall(String projKey, String envKey, String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling patchDestination(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling patchDestination(Async)");
        }
        ...
        okhttp3.Call localVarCall = patchDestinationCall(projKey, envKey, id, patchOperation, _callback);
        return localVarCall;
     ...
     */
    public Destination patchDestination(String projKey, String envKey, String id, List<PatchOperation> patchOperation) throws ApiException {
        ApiResponse<Destination> localVarResp = patchDestinationWithHttpInfo(projKey, envKey, id, patchOperation);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Destination> patchDestinationWithHttpInfo(String projKey, String envKey, String id, List<PatchOperation> patchOperation) throws ApiException {
        okhttp3.Call localVarCall = patchDestinationValidateBeforeCall(projKey, envKey, id, patchOperation, null);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call patchDestinationAsync(String projKey, String envKey, String id, List<PatchOperation> patchOperation, final ApiCallback<Destination> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchDestinationValidateBeforeCall(projKey, envKey, id, patchOperation, _callback);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call postDestinationCall(String projKey, String envKey, DestinationPost destinationPost, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = destinationPost;

        // create path and map variables
        String localVarPath = "/api/v2/destinations/{projKey}/{envKey}"
            .replaceAll("\\{" + "projKey" + "\\}", localVarApiClient.escapeString(projKey.toString()))
            .replaceAll("\\{" + "envKey" + "\\}", localVarApiClient.escapeString(envKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postDestinationValidateBeforeCall(String projKey, String envKey, DestinationPost destinationPost, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling postDestination(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling postDestination(Async)");
        }
        ...
        okhttp3.Call localVarCall = postDestinationCall(projKey, envKey, destinationPost, _callback);
        return localVarCall;
     ...
     */
    public Destination postDestination(String projKey, String envKey, DestinationPost destinationPost) throws ApiException {
        ApiResponse<Destination> localVarResp = postDestinationWithHttpInfo(projKey, envKey, destinationPost);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Destination> postDestinationWithHttpInfo(String projKey, String envKey, DestinationPost destinationPost) throws ApiException {
        okhttp3.Call localVarCall = postDestinationValidateBeforeCall(projKey, envKey, destinationPost, null);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postDestinationAsync(String projKey, String envKey, DestinationPost destinationPost, final ApiCallback<Destination> _callback) throws ApiException {

        okhttp3.Call localVarCall = postDestinationValidateBeforeCall(projKey, envKey, destinationPost, _callback);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
