...
public class FlagLinksBetaApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Successful flag link response </td><td>  -  </td></tr>
    ...
    public okhttp3.Call createFlagLinkCall(String projectKey, String featureFlagKey, FlagLinkPost flagLinkPost, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = flagLinkPost;

        // create path and map variables
        String localVarPath = "/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}"
    ...
    private okhttp3.Call createFlagLinkValidateBeforeCall(String projectKey, String featureFlagKey, FlagLinkPost flagLinkPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createFlagLinkCall(projectKey, featureFlagKey, flagLinkPost, _callback);
        return localVarCall;
    ...
    /**
     * Create flag link (asynchronously)
     * Create a new flag link. Flag links let you reference external resources and associate them with your flags.
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param flagLinkPost  (required)
    ...
    public okhttp3.Call deleteFlagLinkCall(String projectKey, String featureFlagKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}/{id}"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "featureFlagKey" + "\\}", localVarApiClient.escapeString(featureFlagKey.toString()))
    ...
    private okhttp3.Call deleteFlagLinkValidateBeforeCall(String projectKey, String featureFlagKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteFlagLinkCall(projectKey, featureFlagKey, id, _callback);
        return localVarCall;
    ...
    /**
     * Delete flag link (asynchronously)
     * Delete a flag link by ID or key.
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param id The flag link ID or Key (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Flag link collection response JSON </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     </table>
    ...
    private okhttp3.Call getFlagLinksValidateBeforeCall(String projectKey, String featureFlagKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getFlagLinksCall(projectKey, featureFlagKey, _callback);
        return localVarCall;
    ...
    /**
     * List flag links (asynchronously)
     * Get a list of all flag links.
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param id The flag link ID (required)
    ...
    private okhttp3.Call updateFlagLinkValidateBeforeCall(String projectKey, String featureFlagKey, String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateFlagLinkCall(projectKey, featureFlagKey, id, patchOperation, _callback);
        return localVarCall;
    ...
    /**
     * Update flag link (asynchronously)
     * Update a flag link. The request body must be a valid JSON patch document. To learn more, read [Updates](/#section/Overview/Updates).
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param id The flag link ID (required)
