...
public class WorkflowTemplatesBetaApi {
     ...
     */
    public okhttp3.Call getWorkflowTemplatesCall(String search, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWorkflowTemplatesValidateBeforeCall(String search, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getWorkflowTemplatesCall(search, _callback);
        return localVarCall;
    ...
    public WorkflowTemplatesListingOutputRep getWorkflowTemplates(String search) throws ApiException {
        ApiResponse<WorkflowTemplatesListingOutputRep> localVarResp = getWorkflowTemplatesWithHttpInfo(search);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<WorkflowTemplatesListingOutputRep> getWorkflowTemplatesWithHttpInfo(String search) throws ApiException {
        okhttp3.Call localVarCall = getWorkflowTemplatesValidateBeforeCall(search, null);
     ...
     */
    public okhttp3.Call getWorkflowTemplatesAsync(String search, final ApiCallback<WorkflowTemplatesListingOutputRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getWorkflowTemplatesValidateBeforeCall(search, _callback);
        Type localVarReturnType = new TypeToken<WorkflowTemplatesListingOutputRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
