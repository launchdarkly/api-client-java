...
public class ReleasesBetaApi {
     ...
     * @param createReleaseInput  (required)
    ...
    public okhttp3.Call createReleaseForFlagCall(String projectKey, String flagKey, CreateReleaseInput createReleaseInput, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createReleaseInput;

        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/flags/{flagKey}/release"
    ...
    private okhttp3.Call createReleaseForFlagValidateBeforeCall(String projectKey, String flagKey, CreateReleaseInput createReleaseInput, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createReleaseForFlagCall(projectKey, flagKey, createReleaseInput, _callback);
        return localVarCall;
    ...
    /**
     * Create a new release for flag (asynchronously)
     * Creates a release by adding a flag to a release pipeline
     * @param projectKey The project key (required)
     * @param flagKey The flag key (required)
     * @param createReleaseInput  (required)
    ...
    public okhttp3.Call deleteReleaseByFlagKeyCall(String projectKey, String flagKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/flags/{projectKey}/{flagKey}/release"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "flagKey" + "\\}", localVarApiClient.escapeString(flagKey.toString()));
    ...
    private okhttp3.Call deleteReleaseByFlagKeyValidateBeforeCall(String projectKey, String flagKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteReleaseByFlagKeyCall(projectKey, flagKey, _callback);
        return localVarCall;
    ...
    /**
     * Delete a release for flag (asynchronously)
     * Deletes a release from a flag
     * @param projectKey The project key (required)
     * @param flagKey The flag key (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    private okhttp3.Call getReleaseByFlagKeyValidateBeforeCall(String projectKey, String flagKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getReleaseByFlagKeyCall(projectKey, flagKey, _callback);
        return localVarCall;
    ...
    /**
     * Get release for flag (asynchronously)
     * Get currently active release for a flag
     * @param projectKey The project key (required)
     * @param flagKey The flag key (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    private okhttp3.Call patchReleaseByFlagKeyValidateBeforeCall(String projectKey, String flagKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchReleaseByFlagKeyCall(projectKey, flagKey, patchOperation, _callback);
        return localVarCall;
    ...
    /**
     * Patch release for flag (asynchronously)
     * This endpoint is only available for releases that are part of a legacy release pipeline. Releases for new release pipelines should use the [Update phase status for release](/tag/Releases-(beta)#operation/updatePhaseStatus) endpoint. To learn more about migrating from legacy release pipelines to fully automated release pipelines, read the [Release pipeline migration guide](https://docs.launchdarkly.com/guides/flags/release-pipeline-migration).  Update currently active release for a flag. Updating releases requires the [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) format. To learn more, read [Updates](/#section/Overview/Updates).  You can only use this endpoint to mark a release phase complete or incomplete. To indicate which phase to update, use the array index in the &#x60;path&#x60;. For example, to mark the first phase of a release as complete, use the following request body:  &#x60;&#x60;&#x60;   [     {       \&quot;op\&quot;: \&quot;replace\&quot;,       \&quot;path\&quot;: \&quot;/phase/0/complete\&quot;,       \&quot;value\&quot;: true     }   ] &#x60;&#x60;&#x60; 
     * @param projectKey The project key (required)
     * @param flagKey The flag key (required)
     * @param patchOperation  (required)
     ...
     * @param projectKey The project key (required)
     * @param flagKey The flag key (required)
     * @param phaseId The phase ID (required)
     * @param updatePhaseStatusInput  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Invalid request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> release or phase not found </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limit exceeded </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call updatePhaseStatusCall(String projectKey, String flagKey, String phaseId, UpdatePhaseStatusInput updatePhaseStatusInput, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = updatePhaseStatusInput;

        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/flags/{flagKey}/release/phases/{phaseId}"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "flagKey" + "\\}", localVarApiClient.escapeString(flagKey.toString()))
    ...
    private okhttp3.Call updatePhaseStatusValidateBeforeCall(String projectKey, String flagKey, String phaseId, UpdatePhaseStatusInput updatePhaseStatusInput, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updatePhaseStatusCall(projectKey, flagKey, phaseId, updatePhaseStatusInput, _callback);
        return localVarCall;
    ...
    /**
     * Update phase status for release (asynchronously)
     * Updates the execution status of a phase of a release
     * @param projectKey The project key (required)
     * @param flagKey The flag key (required)
     * @param phaseId The phase ID (required)
