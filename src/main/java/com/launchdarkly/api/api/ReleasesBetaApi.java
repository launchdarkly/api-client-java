...
public class ReleasesBetaApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void patchReleaseByFlagKey(String projectKey, String flagKey, List<PatchOperation> patchOperation) throws ApiException {
        patchReleaseByFlagKeyWithHttpInfo(projectKey, flagKey, patchOperation);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> patchReleaseByFlagKeyWithHttpInfo(String projectKey, String flagKey, List<PatchOperation> patchOperation) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call patchReleaseByFlagKeyAsync(String projectKey, String flagKey, List<PatchOperation> patchOperation, final ApiCallback<Void> _callback) throws ApiException {
