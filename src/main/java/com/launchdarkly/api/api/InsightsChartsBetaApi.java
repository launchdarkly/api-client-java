...
public class InsightsChartsBetaApi {
    ...
    public okhttp3.Call getDeploymentFrequencyChartCall(String projectKey, String environmentKey, String applicationKey, OffsetDateTime from, OffsetDateTime to, String bucketType, Long bucketMs, String groupBy, String expand, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/engineering-insights/charts/deployments/frequency";
        ...
        if (bucketType != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("bucketType", bucketType));
        }

        if (bucketMs != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("bucketMs", bucketMs));
        }
    ...
    private okhttp3.Call getDeploymentFrequencyChartValidateBeforeCall(String projectKey, String environmentKey, String applicationKey, OffsetDateTime from, OffsetDateTime to, String bucketType, Long bucketMs, String groupBy, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getDeploymentFrequencyChartCall(projectKey, environmentKey, applicationKey, from, to, bucketType, bucketMs, groupBy, expand, _callback);
        return localVarCall;
    ...
    /**
     * Get deployment frequency chart data (asynchronously)
     * Get deployment frequency chart data. Engineering insights displays deployment frequency data in the [deployment frequency metric view](https://docs.launchdarkly.com/home/engineering-insights/metrics/deployment).  ### Expanding the chart response  LaunchDarkly supports expanding the chart response to include additional fields.  To expand the response, append the &#x60;expand&#x60; query parameter and include the following:  * &#x60;metrics&#x60; includes details on the metrics related to deployment frequency  For example, use &#x60;?expand&#x3D;metrics&#x60; to include the &#x60;metrics&#x60; field in the response. By default, this field is **not** included in the response. 
     * @param projectKey The project key (optional)
     * @param environmentKey The environment key (optional)
     * @param applicationKey Comma separated list of application keys (optional)
    ...
    public okhttp3.Call getFlagStatusChartCall(String projectKey, String environmentKey, String applicationKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/engineering-insights/charts/flags/status";
    ...
    private okhttp3.Call getFlagStatusChartValidateBeforeCall(String projectKey, String environmentKey, String applicationKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getFlagStatusChartCall(projectKey, environmentKey, applicationKey, _callback);
        return localVarCall;
    ...
    /**
     * Get flag status chart data (asynchronously)
     * Get flag status chart data. To learn more, read [Using the flag status chart](https://docs.launchdarkly.com/home/engineering-insights/metrics/flag-health#using-the-flag-status-chart).
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param applicationKey Comma separated list of application keys (optional)
    ...
    public okhttp3.Call getLeadTimeChartCall(String projectKey, String environmentKey, String applicationKey, Long from, Long to, String bucketType, Long bucketMs, String groupBy, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/engineering-insights/charts/lead-time";
    ...
    private okhttp3.Call getLeadTimeChartValidateBeforeCall(String projectKey, String environmentKey, String applicationKey, Long from, Long to, String bucketType, Long bucketMs, String groupBy, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getLeadTimeChartCall(projectKey, environmentKey, applicationKey, from, to, bucketType, bucketMs, groupBy, expand, _callback);
        return localVarCall;
    ...
    /**
     * Get lead time chart data (asynchronously)
     * Get lead time chart data. The engineering insights UI displays lead time data in the [lead time metric view](https://docs.launchdarkly.com/home/engineering-insights/metrics/lead-time).
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (optional)
     * @param applicationKey Comma separated list of application keys (optional)
    ...
    public okhttp3.Call getReleaseFrequencyChartCall(String projectKey, String environmentKey, String applicationKey, Boolean hasExperiments, String global, String groupBy, OffsetDateTime from, OffsetDateTime to, String bucketType, Long bucketMs, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/engineering-insights/charts/releases/frequency";
        ...
        if (hasExperiments != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("hasExperiments", hasExperiments));
        }
    ...
    private okhttp3.Call getReleaseFrequencyChartValidateBeforeCall(String projectKey, String environmentKey, String applicationKey, Boolean hasExperiments, String global, String groupBy, OffsetDateTime from, OffsetDateTime to, String bucketType, Long bucketMs, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getReleaseFrequencyChartCall(projectKey, environmentKey, applicationKey, hasExperiments, global, groupBy, from, to, bucketType, bucketMs, expand, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getStaleFlagsChartCall(String projectKey, String environmentKey, String applicationKey, String groupBy, String maintainerId, String maintainerTeamKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/engineering-insights/charts/flags/stale";
        ...
        if (maintainerId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("maintainerId", maintainerId));
        }

        if (maintainerTeamKey != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("maintainerTeamKey", maintainerTeamKey));
        }
    ...
    private okhttp3.Call getStaleFlagsChartValidateBeforeCall(String projectKey, String environmentKey, String applicationKey, String groupBy, String maintainerId, String maintainerTeamKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getStaleFlagsChartCall(projectKey, environmentKey, applicationKey, groupBy, maintainerId, maintainerTeamKey, expand, _callback);
        return localVarCall;
    ...
    /**
     * Get stale flags chart data (asynchronously)
     * Get stale flags chart data. Engineering insights displays stale flags data in the [flag health metric view](https://docs.launchdarkly.com/home/engineering-insights/metrics/flag-health).  ### Expanding the chart response  LaunchDarkly supports expanding the chart response to include additional fields.  To expand the response, append the &#x60;expand&#x60; query parameter and include the following:  * &#x60;metrics&#x60; includes details on the metrics related to stale flags  For example, use &#x60;?expand&#x3D;metrics&#x60; to include the &#x60;metrics&#x60; field in the response. By default, this field is **not** included in the response. 
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param applicationKey Comma separated list of application keys (optional)
