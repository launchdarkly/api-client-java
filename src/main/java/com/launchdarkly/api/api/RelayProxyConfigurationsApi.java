...
public class RelayProxyConfigurationsApi {
    ...
    public okhttp3.Call deleteRelayAutoConfigCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/account/relay-auto-configs/{id}"
    ...
    private okhttp3.Call deleteRelayAutoConfigValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteRelayAutoConfigCall(id, _callback);
        return localVarCall;
    ...
    /**
     * Delete Relay Proxy config by ID (asynchronously)
     * Delete a Relay Proxy config
     * @param id The relay auto config id (required)
    ...
    private okhttp3.Call getRelayProxyConfigValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getRelayProxyConfigCall(id, _callback);
        return localVarCall;
    ...
    /**
     * Get Relay Proxy config (asynchronously)
     * Get a single Relay Proxy Auto Config by ID
     * @param id The relay auto config id (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getRelayProxyConfigsCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/account/relay-auto-configs";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRelayProxyConfigsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getRelayProxyConfigsCall(_callback);
        return localVarCall;
    ...
    public RelayAutoConfigCollectionRep getRelayProxyConfigs() throws ApiException {
        ApiResponse<RelayAutoConfigCollectionRep> localVarResp = getRelayProxyConfigsWithHttpInfo();
        return localVarResp.getData();
    }
    ...
    public ApiResponse<RelayAutoConfigCollectionRep> getRelayProxyConfigsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getRelayProxyConfigsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<RelayAutoConfigCollectionRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List Relay Proxy configs (asynchronously)
     * Get a list of Relay Proxy configurations in the account.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getRelayProxyConfigsAsync(final ApiCallback<RelayAutoConfigCollectionRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRelayProxyConfigsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<RelayAutoConfigCollectionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call patchRelayAutoConfigValidateBeforeCall(String id, PatchWithComment patchWithComment, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchRelayAutoConfigCall(id, patchWithComment, _callback);
        return localVarCall;
     ...
     * @param relayAutoConfigPost  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call postRelayAutoConfigCall(RelayAutoConfigPost relayAutoConfigPost, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = relayAutoConfigPost;
    ...
    private okhttp3.Call postRelayAutoConfigValidateBeforeCall(RelayAutoConfigPost relayAutoConfigPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postRelayAutoConfigCall(relayAutoConfigPost, _callback);
        return localVarCall;
    ...
    public okhttp3.Call resetRelayAutoConfigCall(String id, Long expiry, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/account/relay-auto-configs/{id}/reset"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    private okhttp3.Call resetRelayAutoConfigValidateBeforeCall(String id, Long expiry, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = resetRelayAutoConfigCall(id, expiry, _callback);
        return localVarCall;
    ...
    /**
     * Reset Relay Proxy configuration key (asynchronously)
     * Reset a Relay Proxy configuration&#39;s secret key with an optional expiry time for the old key.
     * @param id The Relay Proxy configuration ID (required)
     * @param expiry An expiration time for the old Relay Proxy configuration key, expressed as a Unix epoch time in milliseconds. By default, the Relay Proxy configuration will expire immediately. (optional)
     * @param _callback The callback to be executed when the API call finishes
