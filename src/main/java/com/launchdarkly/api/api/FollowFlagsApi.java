...
public class FollowFlagsApi {
     ...
     * @param memberId The memberId of the member to remove as a follower of the flag (required)
     ...
     */
    public okhttp3.Call deleteFlagFollowersCall(String projectKey, String featureFlagKey, String environmentKey, String memberId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers/{memberId}"
    ...
    private okhttp3.Call deleteFlagFollowersValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String memberId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling deleteFlagFollowers(Async)");
        }
        
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling deleteFlagFollowers(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling deleteFlagFollowers(Async)");
        }
        
        // verify the required parameter 'memberId' is set
        if (memberId == null) {
            throw new ApiException("Missing the required parameter 'memberId' when calling deleteFlagFollowers(Async)");
        }
        

        okhttp3.Call localVarCall = deleteFlagFollowersCall(projectKey, featureFlagKey, environmentKey, memberId, _callback);
        return localVarCall;
     ...
     */
    public void deleteFlagFollowers(String projectKey, String featureFlagKey, String environmentKey, String memberId) throws ApiException {
        deleteFlagFollowersWithHttpInfo(projectKey, featureFlagKey, environmentKey, memberId);
    }
     ...
     */
    public ApiResponse<Void> deleteFlagFollowersWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String memberId) throws ApiException {
        okhttp3.Call localVarCall = deleteFlagFollowersValidateBeforeCall(projectKey, featureFlagKey, environmentKey, memberId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Remove a member as a follower of a flag in a project and environment (asynchronously)
     * Remove a member as a follower to a flag in a project and environment
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
     ...
     */
    public okhttp3.Call deleteFlagFollowersAsync(String projectKey, String featureFlagKey, String environmentKey, String memberId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteFlagFollowersValidateBeforeCall(projectKey, featureFlagKey, environmentKey, memberId, _callback);
    ...
    public okhttp3.Call getFlagFollowersCall(String projectKey, String featureFlagKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "featureFlagKey" + "\\}", localVarApiClient.escapeString(featureFlagKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()));
    ...
    private okhttp3.Call getFlagFollowersValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling getFlagFollowers(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling getFlagFollowers(Async)");
        }
        

        okhttp3.Call localVarCall = getFlagFollowersCall(projectKey, featureFlagKey, environmentKey, _callback);
        return localVarCall;
    ...
    /**
     * Get followers of a flag in a project and environment (asynchronously)
     * Get a list of members following a flag in a project and environment
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
    ...
    public okhttp3.Call getFollowersByProjEnvCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/environments/{environmentKey}/followers"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()));
    ...
    private okhttp3.Call getFollowersByProjEnvValidateBeforeCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling getFollowersByProjEnv(Async)");
        }
        

        okhttp3.Call localVarCall = getFollowersByProjEnvCall(projectKey, environmentKey, _callback);
        return localVarCall;
    ...
    /**
     * Get followers of all flags in a given project and environment (asynchronously)
     * Get followers of all flags in a given environment and project
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
     * @param memberId The memberId of the member to add as a follower of the flag (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call putFlagFollowersCall(String projectKey, String featureFlagKey, String environmentKey, String memberId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putFlagFollowersValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String memberId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling putFlagFollowers(Async)");
        }
        
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling putFlagFollowers(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling putFlagFollowers(Async)");
        }
        
        // verify the required parameter 'memberId' is set
        if (memberId == null) {
            throw new ApiException("Missing the required parameter 'memberId' when calling putFlagFollowers(Async)");
        }
        

        okhttp3.Call localVarCall = putFlagFollowersCall(projectKey, featureFlagKey, environmentKey, memberId, _callback);
        return localVarCall;
     ...
     */
    public void putFlagFollowers(String projectKey, String featureFlagKey, String environmentKey, String memberId) throws ApiException {
        putFlagFollowersWithHttpInfo(projectKey, featureFlagKey, environmentKey, memberId);
    }
     ...
     */
    public ApiResponse<Void> putFlagFollowersWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String memberId) throws ApiException {
        okhttp3.Call localVarCall = putFlagFollowersValidateBeforeCall(projectKey, featureFlagKey, environmentKey, memberId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Add a member as a follower of a flag in a project and environment (asynchronously)
     * Add a member as a follower to a flag in a project and environment
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
     ...
     */
    public okhttp3.Call putFlagFollowersAsync(String projectKey, String featureFlagKey, String environmentKey, String memberId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = putFlagFollowersValidateBeforeCall(projectKey, featureFlagKey, environmentKey, memberId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
