...
public class FollowFlagsApi {
    ...
    private okhttp3.Call deleteFlagFollowerValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String memberId, final ApiCallback _callback) throws ApiException {
        ...
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling deleteFlagFollower(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling deleteFlagFollower(Async)");
        }
        
        // verify the required parameter 'memberId' is set
        if (memberId == null) {
            throw new ApiException("Missing the required parameter 'memberId' when calling deleteFlagFollower(Async)");
        }
        

        okhttp3.Call localVarCall = deleteFlagFollowerCall(projectKey, featureFlagKey, environmentKey, memberId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call putFlagFollowerValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String memberId, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling putFlagFollower(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling putFlagFollower(Async)");
        }
        
        // verify the required parameter 'memberId' is set
        if (memberId == null) {
            throw new ApiException("Missing the required parameter 'memberId' when calling putFlagFollower(Async)");
        }
        

        okhttp3.Call localVarCall = putFlagFollowerCall(projectKey, featureFlagKey, environmentKey, memberId, _callback);
        return localVarCall;
