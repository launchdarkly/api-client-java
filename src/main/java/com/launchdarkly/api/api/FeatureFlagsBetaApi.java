...
public class FeatureFlagsBetaApi {
     ...
     */
    public okhttp3.Call getDependentFlagsCall(String projKey, String flagKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/flags/{projKey}/{flagKey}/dependent-flags"
    ...
    private okhttp3.Call getDependentFlagsValidateBeforeCall(String projKey, String flagKey, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getDependentFlags(Async)");
        }
        
        // verify the required parameter 'flagKey' is set
        if (flagKey == null) {
            throw new ApiException("Missing the required parameter 'flagKey' when calling getDependentFlags(Async)");
        }
        

        okhttp3.Call localVarCall = getDependentFlagsCall(projKey, flagKey, _callback);
        return localVarCall;
     ...
     */
    public MultiEnvironmentDependentFlags getDependentFlags(String projKey, String flagKey) throws ApiException {
        ApiResponse<MultiEnvironmentDependentFlags> localVarResp = getDependentFlagsWithHttpInfo(projKey, flagKey);
     ...
     */
    public ApiResponse<MultiEnvironmentDependentFlags> getDependentFlagsWithHttpInfo(String projKey, String flagKey) throws ApiException {
        okhttp3.Call localVarCall = getDependentFlagsValidateBeforeCall(projKey, flagKey, null);
        Type localVarReturnType = new TypeToken<MultiEnvironmentDependentFlags>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List dependent feature flags (asynchronously)
     * List dependent flags across all environments for the flag specified in the path parameters. A dependent flag is a flag that uses another flag as a prerequisite.
     * @param projKey The project key (required)
     * @param flagKey The flag key (required)
     ...
     */
    public okhttp3.Call getDependentFlagsAsync(String projKey, String flagKey, final ApiCallback<MultiEnvironmentDependentFlags> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDependentFlagsValidateBeforeCall(projKey, flagKey, _callback);
        Type localVarReturnType = new TypeToken<MultiEnvironmentDependentFlags>(){}.getType();
     ...
     */
    public okhttp3.Call getDependentFlagsByEnvCall(String projKey, String envKey, String flagKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/flags/{projKey}/{envKey}/{flagKey}/dependent-flags"
            .replaceAll("\\{" + "projKey" + "\\}", localVarApiClient.escapeString(projKey.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDependentFlagsByEnvValidateBeforeCall(String projKey, String envKey, String flagKey, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getDependentFlagsByEnv(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getDependentFlagsByEnv(Async)");
        }
        
        // verify the required parameter 'flagKey' is set
        if (flagKey == null) {
            throw new ApiException("Missing the required parameter 'flagKey' when calling getDependentFlagsByEnv(Async)");
        }
        

        okhttp3.Call localVarCall = getDependentFlagsByEnvCall(projKey, envKey, flagKey, _callback);
        return localVarCall;
     ...
     */
    public DependentFlagsByEnvironment getDependentFlagsByEnv(String projKey, String envKey, String flagKey) throws ApiException {
        ApiResponse<DependentFlagsByEnvironment> localVarResp = getDependentFlagsByEnvWithHttpInfo(projKey, envKey, flagKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DependentFlagsByEnvironment> getDependentFlagsByEnvWithHttpInfo(String projKey, String envKey, String flagKey) throws ApiException {
        okhttp3.Call localVarCall = getDependentFlagsByEnvValidateBeforeCall(projKey, envKey, flagKey, null);
        Type localVarReturnType = new TypeToken<DependentFlagsByEnvironment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List dependent feature flags by environment (asynchronously)
     * List dependent flags across all environments for the flag specified in the path parameters. A dependent flag is a flag that uses another flag as a prerequisite.
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param flagKey The flag key (required)
     ...
     */
    public okhttp3.Call getDependentFlagsByEnvAsync(String projKey, String envKey, String flagKey, final ApiCallback<DependentFlagsByEnvironment> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDependentFlagsByEnvValidateBeforeCall(projKey, envKey, flagKey, _callback);
        Type localVarReturnType = new TypeToken<DependentFlagsByEnvironment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
