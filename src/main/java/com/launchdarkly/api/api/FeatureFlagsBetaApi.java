...
public class FeatureFlagsBetaApi {
    ...
    public okhttp3.Call getDependentFlagsCall(String projectKey, String featureFlagKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/flags/{projectKey}/{featureFlagKey}/dependent-flags"
    ...
    private okhttp3.Call getDependentFlagsValidateBeforeCall(String projectKey, String featureFlagKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getDependentFlagsCall(projectKey, featureFlagKey, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getDependentFlagsByEnvCall(String projectKey, String environmentKey, String featureFlagKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/flags/{projectKey}/{environmentKey}/{featureFlagKey}/dependent-flags"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
    ...
    private okhttp3.Call getDependentFlagsByEnvValidateBeforeCall(String projectKey, String environmentKey, String featureFlagKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getDependentFlagsByEnvCall(projectKey, environmentKey, featureFlagKey, _callback);
        return localVarCall;
    ...
    private okhttp3.Call postMigrationSafetyIssuesValidateBeforeCall(String projectKey, String flagKey, String environmentKey, FlagSempatch flagSempatch, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postMigrationSafetyIssuesCall(projectKey, flagKey, environmentKey, flagSempatch, _callback);
        return localVarCall;
