...
public class SegmentsBetaApi {
     ...
     */
    public okhttp3.Call createBigSegmentImportCall(String projectKey, String environmentKey, String segmentKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createBigSegmentImportValidateBeforeCall(String projectKey, String environmentKey, String segmentKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createBigSegmentImportCall(projectKey, environmentKey, segmentKey, _callback);
        return localVarCall;
     ...
     */
    public void createBigSegmentImport(String projectKey, String environmentKey, String segmentKey) throws ApiException {
        createBigSegmentImportWithHttpInfo(projectKey, environmentKey, segmentKey);
    }
     ...
     */
    public ApiResponse<Void> createBigSegmentImportWithHttpInfo(String projectKey, String environmentKey, String segmentKey) throws ApiException {
        okhttp3.Call localVarCall = createBigSegmentImportValidateBeforeCall(projectKey, environmentKey, segmentKey, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call createBigSegmentImportAsync(String projectKey, String environmentKey, String segmentKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = createBigSegmentImportValidateBeforeCall(projectKey, environmentKey, segmentKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
