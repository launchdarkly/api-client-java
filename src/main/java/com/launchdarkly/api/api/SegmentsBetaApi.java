...
public class SegmentsBetaApi {
    ...
    private okhttp3.Call createBigSegmentExportValidateBeforeCall(String projectKey, String environmentKey, String segmentKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createBigSegmentExportCall(projectKey, environmentKey, segmentKey, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call createBigSegmentImportCall(String projectKey, String environmentKey, String segmentKey, File file, String mode, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createBigSegmentImportValidateBeforeCall(String projectKey, String environmentKey, String segmentKey, File file, String mode, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createBigSegmentImportCall(projectKey, environmentKey, segmentKey, file, mode, _callback);
        return localVarCall;
     ...
     */
    public void createBigSegmentImport(String projectKey, String environmentKey, String segmentKey, File file, String mode) throws ApiException {
        createBigSegmentImportWithHttpInfo(projectKey, environmentKey, segmentKey, file, mode);
    }
     ...
     */
    public ApiResponse<Void> createBigSegmentImportWithHttpInfo(String projectKey, String environmentKey, String segmentKey, File file, String mode) throws ApiException {
        okhttp3.Call localVarCall = createBigSegmentImportValidateBeforeCall(projectKey, environmentKey, segmentKey, file, mode, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call createBigSegmentImportAsync(String projectKey, String environmentKey, String segmentKey, File file, String mode, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = createBigSegmentImportValidateBeforeCall(projectKey, environmentKey, segmentKey, file, mode, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    public okhttp3.Call getBigSegmentExportCall(String projectKey, String environmentKey, String segmentKey, String exportID, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/exports/{exportID}"
            ...
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "segmentKey" + "\\}", localVarApiClient.escapeString(segmentKey.toString()))
            .replaceAll("\\{" + "exportID" + "\\}", localVarApiClient.escapeString(exportID.toString()));
    ...
    private okhttp3.Call getBigSegmentExportValidateBeforeCall(String projectKey, String environmentKey, String segmentKey, String exportID, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getBigSegmentExportCall(projectKey, environmentKey, segmentKey, exportID, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getBigSegmentImportCall(String projectKey, String environmentKey, String segmentKey, String importID, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/imports/{importID}"
            ...
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "segmentKey" + "\\}", localVarApiClient.escapeString(segmentKey.toString()))
            .replaceAll("\\{" + "importID" + "\\}", localVarApiClient.escapeString(importID.toString()));
    ...
    private okhttp3.Call getBigSegmentImportValidateBeforeCall(String projectKey, String environmentKey, String segmentKey, String importID, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getBigSegmentImportCall(projectKey, environmentKey, segmentKey, importID, _callback);
        return localVarCall;
