...
public class SegmentsBetaApi {
     ...
     */
    public okhttp3.Call createBigSegmentImportCall(String projectKey, String environmentKey, String segmentKey, File _file, String mode, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createBigSegmentImportValidateBeforeCall(String projectKey, String environmentKey, String segmentKey, File _file, String mode, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createBigSegmentImportCall(projectKey, environmentKey, segmentKey, _file, mode, _callback);
        return localVarCall;
    ...
    public void createBigSegmentImport(String projectKey, String environmentKey, String segmentKey, File _file, String mode) throws ApiException {
        createBigSegmentImportWithHttpInfo(projectKey, environmentKey, segmentKey, _file, mode);
    }
    ...
    public ApiResponse<Void> createBigSegmentImportWithHttpInfo(String projectKey, String environmentKey, String segmentKey, File _file, String mode) throws ApiException {
        okhttp3.Call localVarCall = createBigSegmentImportValidateBeforeCall(projectKey, environmentKey, segmentKey, _file, mode, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call createBigSegmentImportAsync(String projectKey, String environmentKey, String segmentKey, File _file, String mode, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = createBigSegmentImportValidateBeforeCall(projectKey, environmentKey, segmentKey, _file, mode, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
