...
public class WorkflowsBetaApi {
     ...
     */
    public okhttp3.Call getWorkflowsCall(String projectKey, String featureFlagKey, String environmentKey, String status, String sort, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWorkflowsValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String status, String sort, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getWorkflowsCall(projectKey, featureFlagKey, environmentKey, status, sort, _callback);
        return localVarCall;
     ...
     */
    public CustomWorkflowsListingOutput getWorkflows(String projectKey, String featureFlagKey, String environmentKey, String status, String sort) throws ApiException {
        ApiResponse<CustomWorkflowsListingOutput> localVarResp = getWorkflowsWithHttpInfo(projectKey, featureFlagKey, environmentKey, status, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CustomWorkflowsListingOutput> getWorkflowsWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String status, String sort) throws ApiException {
        okhttp3.Call localVarCall = getWorkflowsValidateBeforeCall(projectKey, featureFlagKey, environmentKey, status, sort, null);
     ...
     */
    public okhttp3.Call getWorkflowsAsync(String projectKey, String featureFlagKey, String environmentKey, String status, String sort, final ApiCallback<CustomWorkflowsListingOutput> _callback) throws ApiException {

        okhttp3.Call localVarCall = getWorkflowsValidateBeforeCall(projectKey, featureFlagKey, environmentKey, status, sort, _callback);
        Type localVarReturnType = new TypeToken<CustomWorkflowsListingOutput>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call postWorkflowValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInput customWorkflowInput, String templateKey, Boolean dryRun, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postWorkflowCall(projectKey, featureFlagKey, environmentKey, customWorkflowInput, templateKey, dryRun, _callback);
        return localVarCall;
