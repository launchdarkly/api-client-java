...
public class WorkflowsBetaApi {
    ...
    public CustomWorkflowsListingOutput getWorkflows(String projectKey, String featureFlagKey, String environmentKey) throws ApiException {
        ApiResponse<CustomWorkflowsListingOutput> localVarResp = getWorkflowsWithHttpInfo(projectKey, featureFlagKey, environmentKey);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call getWorkflowsAsync(String projectKey, String featureFlagKey, String environmentKey, final ApiCallback<CustomWorkflowsListingOutput> _callback) throws ApiException {
     ...
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
     * @param customWorkflowInput  (required)
     ...
     */
    public okhttp3.Call postWorkflowCall(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInput customWorkflowInput, String templateKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = customWorkflowInput;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postWorkflowValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInput customWorkflowInput, String templateKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postWorkflowCall(projectKey, featureFlagKey, environmentKey, customWorkflowInput, templateKey, _callback);
        return localVarCall;
    ...
    public CustomWorkflowOutput postWorkflow(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInput customWorkflowInput, String templateKey) throws ApiException {
        ApiResponse<CustomWorkflowOutput> localVarResp = postWorkflowWithHttpInfo(projectKey, featureFlagKey, environmentKey, customWorkflowInput, templateKey);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<CustomWorkflowOutput> postWorkflowWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInput customWorkflowInput, String templateKey) throws ApiException {
        okhttp3.Call localVarCall = postWorkflowValidateBeforeCall(projectKey, featureFlagKey, environmentKey, customWorkflowInput, templateKey, null);
        Type localVarReturnType = new TypeToken<CustomWorkflowOutput>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postWorkflowAsync(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInput customWorkflowInput, String templateKey, final ApiCallback<CustomWorkflowOutput> _callback) throws ApiException {

        okhttp3.Call localVarCall = postWorkflowValidateBeforeCall(projectKey, featureFlagKey, environmentKey, customWorkflowInput, templateKey, _callback);
        Type localVarReturnType = new TypeToken<CustomWorkflowOutput>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
