...
import com.launchdarkly.api.model.CustomWorkflowInputRep;
import com.launchdarkly.api.model.CustomWorkflowOutputRep;
import com.launchdarkly.api.model.CustomWorkflowsListingOutputRep;
...
public class WorkflowsBetaApi {
    ...
    public okhttp3.Call deleteWorkflowCall(String projectKey, String featureFlagKey, String environmentKey, String workflowId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows/{workflowId}"
            ...
            .replaceAll("\\{" + "workflowId" + "\\}", localVarApiClient.escapeString(workflowId.toString()));
    ...
    private okhttp3.Call deleteWorkflowValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String workflowId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteWorkflowCall(projectKey, featureFlagKey, environmentKey, workflowId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getCustomWorkflowValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String workflowId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getCustomWorkflowCall(projectKey, featureFlagKey, environmentKey, workflowId, _callback);
        return localVarCall;
     ...
     */
    public CustomWorkflowOutputRep getCustomWorkflow(String projectKey, String featureFlagKey, String environmentKey, String workflowId) throws ApiException {
        ApiResponse<CustomWorkflowOutputRep> localVarResp = getCustomWorkflowWithHttpInfo(projectKey, featureFlagKey, environmentKey, workflowId);
     ...
     * @param environmentKey The environment key (required)
     * @param workflowId The workflow ID (required)
     * @return ApiResponse&lt;CustomWorkflowOutputRep&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CustomWorkflowOutputRep> getCustomWorkflowWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String workflowId) throws ApiException {
        okhttp3.Call localVarCall = getCustomWorkflowValidateBeforeCall(projectKey, featureFlagKey, environmentKey, workflowId, null);
        Type localVarReturnType = new TypeToken<CustomWorkflowOutputRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get custom workflow (asynchronously)
     * Get a specific workflow by ID.
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
     ...
     */
    public okhttp3.Call getCustomWorkflowAsync(String projectKey, String featureFlagKey, String environmentKey, String workflowId, final ApiCallback<CustomWorkflowOutputRep> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getWorkflowsCall(String projectKey, String featureFlagKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "featureFlagKey" + "\\}", localVarApiClient.escapeString(featureFlagKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWorkflowsValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getWorkflowsCall(projectKey, featureFlagKey, environmentKey, _callback);
        return localVarCall;
     ...
     */
    public CustomWorkflowsListingOutputRep getWorkflows(String projectKey, String featureFlagKey, String environmentKey) throws ApiException {
        ApiResponse<CustomWorkflowsListingOutputRep> localVarResp = getWorkflowsWithHttpInfo(projectKey, featureFlagKey, environmentKey);
        return localVarResp.getData();
    }
     ...
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
     * @return ApiResponse&lt;CustomWorkflowsListingOutputRep&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CustomWorkflowsListingOutputRep> getWorkflowsWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey) throws ApiException {
        okhttp3.Call localVarCall = getWorkflowsValidateBeforeCall(projectKey, featureFlagKey, environmentKey, null);
        Type localVarReturnType = new TypeToken<CustomWorkflowsListingOutputRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get workflows (asynchronously)
     * Display workflows associated with a feature flag.
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
     ...
     */
    public okhttp3.Call getWorkflowsAsync(String projectKey, String featureFlagKey, String environmentKey, final ApiCallback<CustomWorkflowsListingOutputRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getWorkflowsValidateBeforeCall(projectKey, featureFlagKey, environmentKey, _callback);
        Type localVarReturnType = new TypeToken<CustomWorkflowsListingOutputRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param featureFlagKey The feature flag key (required)
     * @param environmentKey The environment key (required)
     * @param customWorkflowInputRep  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Successful workflow response </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource identifier </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call postWorkflowCall(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInputRep customWorkflowInputRep, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = customWorkflowInputRep;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postWorkflowValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInputRep customWorkflowInputRep, final ApiCallback _callback) throws ApiException {
        ...
        if (customWorkflowInputRep == null) {
            throw new ApiException("Missing the required parameter 'customWorkflowInputRep' when calling postWorkflow(Async)");
        }
        

        okhttp3.Call localVarCall = postWorkflowCall(projectKey, featureFlagKey, environmentKey, customWorkflowInputRep, _callback);
        return localVarCall;
     ...
     */
    public CustomWorkflowOutputRep postWorkflow(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInputRep customWorkflowInputRep) throws ApiException {
        ApiResponse<CustomWorkflowOutputRep> localVarResp = postWorkflowWithHttpInfo(projectKey, featureFlagKey, environmentKey, customWorkflowInputRep);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CustomWorkflowOutputRep> postWorkflowWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInputRep customWorkflowInputRep) throws ApiException {
        okhttp3.Call localVarCall = postWorkflowValidateBeforeCall(projectKey, featureFlagKey, environmentKey, customWorkflowInputRep, null);
        Type localVarReturnType = new TypeToken<CustomWorkflowOutputRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postWorkflowAsync(String projectKey, String featureFlagKey, String environmentKey, CustomWorkflowInputRep customWorkflowInputRep, final ApiCallback<CustomWorkflowOutputRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = postWorkflowValidateBeforeCall(projectKey, featureFlagKey, environmentKey, customWorkflowInputRep, _callback);
        Type localVarReturnType = new TypeToken<CustomWorkflowOutputRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
