...
public class AccountUsageBetaApi {
     ...
     */
    public okhttp3.Call getDataExportEventsUsageCall(String from, String to, String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getDataExportEventsUsageValidateBeforeCall(String from, String to, String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getDataExportEventsUsageCall(from, to, projectKey, environmentKey, _callback);
        return localVarCall;
     ...
     */
    public SeriesIntervalsRep getDataExportEventsUsage(String from, String to, String projectKey, String environmentKey) throws ApiException {
        ApiResponse<SeriesIntervalsRep> localVarResp = getDataExportEventsUsageWithHttpInfo(from, to, projectKey, environmentKey);
     ...
     */
    public ApiResponse<SeriesIntervalsRep> getDataExportEventsUsageWithHttpInfo(String from, String to, String projectKey, String environmentKey) throws ApiException {
        okhttp3.Call localVarCall = getDataExportEventsUsageValidateBeforeCall(from, to, projectKey, environmentKey, null);
     ...
     */
    public okhttp3.Call getDataExportEventsUsageAsync(String from, String to, String projectKey, String environmentKey, final ApiCallback<SeriesIntervalsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDataExportEventsUsageValidateBeforeCall(from, to, projectKey, environmentKey, _callback);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
     ...
     */
    public okhttp3.Call getExperimentationKeysUsageCall(String from, String to, String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExperimentationKeysUsageValidateBeforeCall(String from, String to, String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getExperimentationKeysUsageCall(from, to, projectKey, environmentKey, _callback);
        return localVarCall;
     ...
     */
    public SeriesIntervalsRep getExperimentationKeysUsage(String from, String to, String projectKey, String environmentKey) throws ApiException {
        ApiResponse<SeriesIntervalsRep> localVarResp = getExperimentationKeysUsageWithHttpInfo(from, to, projectKey, environmentKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SeriesIntervalsRep> getExperimentationKeysUsageWithHttpInfo(String from, String to, String projectKey, String environmentKey) throws ApiException {
        okhttp3.Call localVarCall = getExperimentationKeysUsageValidateBeforeCall(from, to, projectKey, environmentKey, null);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getExperimentationKeysUsageAsync(String from, String to, String projectKey, String environmentKey, final ApiCallback<SeriesIntervalsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExperimentationKeysUsageValidateBeforeCall(from, to, projectKey, environmentKey, _callback);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getExperimentationUnitsUsage
     * @param from The series of data returned starts from this timestamp (Unix seconds). Defaults to the beginning of the current month. (optional)
     * @param to The series of data returned ends at this timestamp (Unix seconds). Defaults to the current time. (optional)
     * @param projectKey A project key. If specified, &#x60;environmentKey&#x60; is required and results apply to the corresponding environment in this project. (optional)
     * @param environmentKey An environment key. If specified, &#x60;projectKey&#x60; is required and results apply to the corresponding environment in this project. (optional)
     ...
     */
    public okhttp3.Call getExperimentationUnitsUsageCall(String from, String to, String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExperimentationUnitsUsageValidateBeforeCall(String from, String to, String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getExperimentationUnitsUsageCall(from, to, projectKey, environmentKey, _callback);
        return localVarCall;
     ...
     */
    public SeriesIntervalsRep getExperimentationUnitsUsage(String from, String to, String projectKey, String environmentKey) throws ApiException {
        ApiResponse<SeriesIntervalsRep> localVarResp = getExperimentationUnitsUsageWithHttpInfo(from, to, projectKey, environmentKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SeriesIntervalsRep> getExperimentationUnitsUsageWithHttpInfo(String from, String to, String projectKey, String environmentKey) throws ApiException {
        okhttp3.Call localVarCall = getExperimentationUnitsUsageValidateBeforeCall(from, to, projectKey, environmentKey, null);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get experimentation units usage (asynchronously)
     * Get a time-series array of the number of monthly experimentation units from your account. The granularity is always daily, with a maximum of 31 days.
     * @param from The series of data returned starts from this timestamp (Unix seconds). Defaults to the beginning of the current month. (optional)
     * @param to The series of data returned ends at this timestamp (Unix seconds). Defaults to the current time. (optional)
     * @param projectKey A project key. If specified, &#x60;environmentKey&#x60; is required and results apply to the corresponding environment in this project. (optional)
     ...
     */
    public okhttp3.Call getExperimentationUnitsUsageAsync(String from, String to, String projectKey, String environmentKey, final ApiCallback<SeriesIntervalsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExperimentationUnitsUsageValidateBeforeCall(from, to, projectKey, environmentKey, _callback);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call getMauUsageValidateBeforeCall(String from, String to, String project, String environment, String sdktype, String sdk, String anonymous, String groupby, String aggregationType, String contextKind, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMauUsageCall(from, to, project, environment, sdktype, sdk, anonymous, groupby, aggregationType, contextKind, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call getServiceConnectionUsageCall(String from, String to, String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getServiceConnectionUsageValidateBeforeCall(String from, String to, String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getServiceConnectionUsageCall(from, to, projectKey, environmentKey, _callback);
        return localVarCall;
     ...
     */
    public SeriesIntervalsRep getServiceConnectionUsage(String from, String to, String projectKey, String environmentKey) throws ApiException {
        ApiResponse<SeriesIntervalsRep> localVarResp = getServiceConnectionUsageWithHttpInfo(from, to, projectKey, environmentKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SeriesIntervalsRep> getServiceConnectionUsageWithHttpInfo(String from, String to, String projectKey, String environmentKey) throws ApiException {
        okhttp3.Call localVarCall = getServiceConnectionUsageValidateBeforeCall(from, to, projectKey, environmentKey, null);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getServiceConnectionUsageAsync(String from, String to, String projectKey, String environmentKey, final ApiCallback<SeriesIntervalsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getServiceConnectionUsageValidateBeforeCall(from, to, projectKey, environmentKey, _callback);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
