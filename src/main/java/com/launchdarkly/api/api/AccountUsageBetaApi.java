...
public class AccountUsageBetaApi {
     ...
     */
    public okhttp3.Call getEvaluationsUsageCall(String projKey, String envKey, String flagKey, String from, String to, String tz, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/usage/evaluations/{projKey}/{envKey}/{flagKey}"
    ...
    private okhttp3.Call getEvaluationsUsageValidateBeforeCall(String projKey, String envKey, String flagKey, String from, String to, String tz, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getEvaluationsUsage(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getEvaluationsUsage(Async)");
        }
        
        // verify the required parameter 'flagKey' is set
        if (flagKey == null) {
            throw new ApiException("Missing the required parameter 'flagKey' when calling getEvaluationsUsage(Async)");
        }
        

        okhttp3.Call localVarCall = getEvaluationsUsageCall(projKey, envKey, flagKey, from, to, tz, _callback);
        return localVarCall;
     ...
     */
    public SeriesListRep getEvaluationsUsage(String projKey, String envKey, String flagKey, String from, String to, String tz) throws ApiException {
        ApiResponse<SeriesListRep> localVarResp = getEvaluationsUsageWithHttpInfo(projKey, envKey, flagKey, from, to, tz);
     ...
     */
    public ApiResponse<SeriesListRep> getEvaluationsUsageWithHttpInfo(String projKey, String envKey, String flagKey, String from, String to, String tz) throws ApiException {
        okhttp3.Call localVarCall = getEvaluationsUsageValidateBeforeCall(projKey, envKey, flagKey, from, to, tz, null);
     ...
     */
    public okhttp3.Call getEvaluationsUsageAsync(String projKey, String envKey, String flagKey, String from, String to, String tz, final ApiCallback<SeriesListRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEvaluationsUsageValidateBeforeCall(projKey, envKey, flagKey, from, to, tz, _callback);
        Type localVarReturnType = new TypeToken<SeriesListRep>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Usage response </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Inavlid request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource identifier </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
