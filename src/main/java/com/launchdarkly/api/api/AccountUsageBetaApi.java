...
import com.launchdarkly.api.model.SdkVersionDetailsRep;
...
public class AccountUsageBetaApi {
     ...
     * @param groupBy If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.&lt;br/&gt;Valid values: &#x60;projectId&#x60;, &#x60;environmentId&#x60;, &#x60;sdkName&#x60;, &#x60;sdkVersion&#x60;, &#x60;sdkType&#x60;. (optional)
     ...
     */
    public okhttp3.Call getAIRunsUsageCall(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkVersion, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/usage/ai-runs";
    ...
    private okhttp3.Call getAIRunsUsageValidateBeforeCall(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkVersion, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity, final ApiCallback _callback) throws ApiException {
        return getAIRunsUsageCall(from, to, projectKey, environmentKey, sdkName, sdkVersion, sdkType, groupBy, aggregationType, granularity, _callback);
     ...
     */
    public SeriesListRep getAIRunsUsage(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkVersion, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity) throws ApiException {
        ApiResponse<SeriesListRep> localVarResp = getAIRunsUsageWithHttpInfo(from, to, projectKey, environmentKey, sdkName, sdkVersion, sdkType, groupBy, aggregationType, granularity);
     ...
     */
    public ApiResponse<SeriesListRep> getAIRunsUsageWithHttpInfo(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkVersion, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity) throws ApiException {
        okhttp3.Call localVarCall = getAIRunsUsageValidateBeforeCall(from, to, projectKey, environmentKey, sdkName, sdkVersion, sdkType, groupBy, aggregationType, granularity, null);
        Type localVarReturnType = new TypeToken<SeriesListRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get AI runs usage (asynchronously)
     * Get a time series array showing the number of AI runs recorded for your account. The supported granularity varies by aggregation type. The maximum time range is 365 days.
     * @param from The series of data returned starts from this timestamp (Unix milliseconds). Defaults to the beginning of the current month. (optional)
     * @param to The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time. (optional)
     * @param projectKey A project key to filter results by. Can be specified multiple times, one query parameter per project key. (optional)
     ...
     */
    public okhttp3.Call getAIRunsUsageAsync(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkVersion, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity, final ApiCallback<SeriesListRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAIRunsUsageValidateBeforeCall(from, to, projectKey, environmentKey, sdkName, sdkVersion, sdkType, groupBy, aggregationType, granularity, _callback);
        Type localVarReturnType = new TypeToken<SeriesListRep>(){}.getType();
     ...
     * @param to The series of data returned ends at this timestamp (Unix seconds). Defaults to the current time. (optional)
     * @param projectKey A project key to filter results by. Can be specified multiple times, one query parameter per project key. (optional)
     * @param granularity Specifies the data granularity. Defaults to &#x60;daily&#x60;. Valid values depend on &#x60;aggregationType&#x60;: **month_to_date** supports &#x60;hourly&#x60;, &#x60;daily&#x60;, and &#x60;monthly&#x60;; **average** supports &#x60;hourly&#x60;, &#x60;daily&#x60;, and &#x60;monthly&#x60;. (optional)
     * @param aggregationType Specifies the aggregation method. Defaults to &#x60;month_to_date&#x60;.&lt;br/&gt;Valid values: &#x60;month_to_date&#x60;, &#x60;average&#x60;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Build call for getSdkAllVersions
     * @param environmentId Filter to a specific environment ID. (optional)
     * @param projectId Filter to a specific project ID. (optional)
     * @param sdkName Filter to a specific SDK name. (optional)
     * @param sdkType Filter to a specific SDK type (for example, &#39;server&#39;, &#39;browser&#39;, &#39;mobile&#39;). (optional)
     * @param sdkAppId Filter to a specific SDK application ID. (optional)
     * @param connectionType Filter to a specific connection type (for example, &#39;direct&#39;, &#39;proxy&#39;). (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> SDK versions usage response </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getSdkAllVersionsCall(@javax.annotation.Nullable String environmentId, @javax.annotation.Nullable String projectId, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String sdkAppId, @javax.annotation.Nullable String connectionType, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/usage/sdk-versions/all";
        ...
        if (sdkAppId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("sdkAppId", sdkAppId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSdkAllVersionsValidateBeforeCall(@javax.annotation.Nullable String environmentId, @javax.annotation.Nullable String projectId, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String sdkAppId, @javax.annotation.Nullable String connectionType, final ApiCallback _callback) throws ApiException {
        return getSdkAllVersionsCall(environmentId, projectId, sdkName, sdkType, sdkAppId, connectionType, _callback);
     ...
     * @param sdkAppId Filter to a specific SDK application ID. (optional)
     * @param connectionType Filter to a specific connection type (for example, &#39;direct&#39;, &#39;proxy&#39;). (optional)
     * @return List&lt;SdkVersionDetailsRep&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public List<SdkVersionDetailsRep> getSdkAllVersions(@javax.annotation.Nullable String environmentId, @javax.annotation.Nullable String projectId, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String sdkAppId, @javax.annotation.Nullable String connectionType) throws ApiException {
        ApiResponse<List<SdkVersionDetailsRep>> localVarResp = getSdkAllVersionsWithHttpInfo(environmentId, projectId, sdkName, sdkType, sdkAppId, connectionType);
        return localVarResp.getData();
    }
     ...
     * @param sdkAppId Filter to a specific SDK application ID. (optional)
     * @param connectionType Filter to a specific connection type (for example, &#39;direct&#39;, &#39;proxy&#39;). (optional)
     * @return ApiResponse&lt;List&lt;SdkVersionDetailsRep&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<SdkVersionDetailsRep>> getSdkAllVersionsWithHttpInfo(@javax.annotation.Nullable String environmentId, @javax.annotation.Nullable String projectId, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String sdkAppId, @javax.annotation.Nullable String connectionType) throws ApiException {
        okhttp3.Call localVarCall = getSdkAllVersionsValidateBeforeCall(environmentId, projectId, sdkName, sdkType, sdkAppId, connectionType, null);
        Type localVarReturnType = new TypeToken<List<SdkVersionDetailsRep>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get usage details for all SDK versions (asynchronously)
     * Get detailed SDK version usage data for all versions observed in the last 24 hours in your account. Unlike the &#x60;/details&#x60; endpoint which returns only the max version per SDK, this endpoint returns all SDK versions for the specified filters. This data is refreshed hourly.&lt;br/&gt;&lt;br/&gt;All query parameters are optional, allowing you to filter results as broadly or narrowly as needed.
     * @param environmentId Filter to a specific environment ID. (optional)
     * @param projectId Filter to a specific project ID. (optional)
     * @param sdkName Filter to a specific SDK name. (optional)
     ...
     */
    public okhttp3.Call getSdkAllVersionsAsync(@javax.annotation.Nullable String environmentId, @javax.annotation.Nullable String projectId, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String sdkAppId, @javax.annotation.Nullable String connectionType, final ApiCallback<List<SdkVersionDetailsRep>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSdkAllVersionsValidateBeforeCall(environmentId, projectId, sdkName, sdkType, sdkAppId, connectionType, _callback);
        Type localVarReturnType = new TypeToken<List<SdkVersionDetailsRep>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getSdkVersionsDetails
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getSdkVersionsDetailsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/usage/sdk-versions/details";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSdkVersionsDetailsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getSdkVersionsDetailsCall(_callback);
     ...
     */
    public List<SdkVersionDetailsRep> getSdkVersionsDetails() throws ApiException {
        ApiResponse<List<SdkVersionDetailsRep>> localVarResp = getSdkVersionsDetailsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<SdkVersionDetailsRep>> getSdkVersionsDetailsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getSdkVersionsDetailsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<SdkVersionDetailsRep>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get SDK versions usage details (asynchronously)
     * Get detailed SDK version usage data for your account, including version information, EOL status, and relay proxy metadata. Refreshed hourly, returns the max version for each SDK observed in the last 24 hours, including those without EOL metadata available.&lt;br/&gt;&lt;br/&gt;This endpoint provides comprehensive information about SDK versions in use across your projects and environments.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getSdkVersionsDetailsAsync(final ApiCallback<List<SdkVersionDetailsRep>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSdkVersionsDetailsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<List<SdkVersionDetailsRep>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param sdkVersion An SDK version to filter results by. Can be specified multiple times, one query parameter per SDK version. (optional)
     * @param sdkType An SDK type to filter results by. Can be specified multiple times, one query parameter per SDK type. (optional)
     * @param sdkAppId An SDK app ID to filter results by. Can be specified multiple times, one query parameter per SDK app ID. (optional)
     * @param groupBy If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.&lt;br/&gt;Valid values: &#x60;projectId&#x60;, &#x60;environmentId&#x60;, &#x60;connectionType&#x60;, &#x60;relayVersion&#x60;, &#x60;sdkName&#x60;, &#x60;sdkVersion&#x60;, &#x60;sdkType&#x60;, &#x60;sdkAppId&#x60;. (optional)
     * @param aggregationType Specifies the aggregation method. Defaults to &#x60;month_to_date&#x60;.&lt;br/&gt;Valid values: &#x60;month_to_date&#x60;, &#x60;incremental&#x60;. (optional)
     * @param granularity Specifies the data granularity. Defaults to &#x60;daily&#x60;. &#x60;monthly&#x60; granularity is only supported with the **month_to_date** aggregation type.&lt;br/&gt;Valid values: &#x60;daily&#x60;, &#x60;hourly&#x60;, &#x60;monthly&#x60;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
    ...
    private okhttp3.Call getServiceConnectionsUsageValidateBeforeCall(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String connectionType, @javax.annotation.Nullable String relayVersion, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkVersion, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String sdkAppId, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity, final ApiCallback _callback) throws ApiException {
        return getServiceConnectionsUsageCall(from, to, projectKey, environmentKey, connectionType, relayVersion, sdkName, sdkVersion, sdkType, sdkAppId, groupBy, aggregationType, granularity, _callback);
    ...
    public SeriesListRepFloat getServiceConnectionsUsage(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String connectionType, @javax.annotation.Nullable String relayVersion, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkVersion, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String sdkAppId, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity) throws ApiException {
        ApiResponse<SeriesListRepFloat> localVarResp = getServiceConnectionsUsageWithHttpInfo(from, to, projectKey, environmentKey, connectionType, relayVersion, sdkName, sdkVersion, sdkType, sdkAppId, groupBy, aggregationType, granularity);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<SeriesListRepFloat> getServiceConnectionsUsageWithHttpInfo(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String connectionType, @javax.annotation.Nullable String relayVersion, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkVersion, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String sdkAppId, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity) throws ApiException {
        okhttp3.Call localVarCall = getServiceConnectionsUsageValidateBeforeCall(from, to, projectKey, environmentKey, connectionType, relayVersion, sdkName, sdkVersion, sdkType, sdkAppId, groupBy, aggregationType, granularity, null);
    ...
    public okhttp3.Call getServiceConnectionsUsageAsync(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String connectionType, @javax.annotation.Nullable String relayVersion, @javax.annotation.Nullable String sdkName, @javax.annotation.Nullable String sdkVersion, @javax.annotation.Nullable String sdkType, @javax.annotation.Nullable String sdkAppId, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity, final ApiCallback<SeriesListRepFloat> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getServiceConnectionsUsageValidateBeforeCall(from, to, projectKey, environmentKey, connectionType, relayVersion, sdkName, sdkVersion, sdkType, sdkAppId, groupBy, aggregationType, granularity, _callback);
        Type localVarReturnType = new TypeToken<SeriesListRepFloat>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for getWarehouseExportUsage
     * @param from The series of data returned starts from this timestamp (Unix milliseconds). Defaults to the beginning of the current month. (optional)
     * @param to The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time. (optional)
     * @param projectKey A project key to filter results by. Can be specified multiple times, one query parameter per project key. (optional)
     * @param environmentKey An environment key to filter results by. If specified, exactly one &#x60;projectKey&#x60; must be provided. Can be specified multiple times, one query parameter per environment key. (optional)
     * @param destination A destination kind to filter results by. Can be specified multiple times, one query parameter per destination kind.&lt;br/&gt;Valid values: &#x60;snowflake-v2&#x60;, &#x60;databricks&#x60;, &#x60;bigquery&#x60;, &#x60;redshift&#x60;, &#x60;clickhouse&#x60;. (optional)
     * @param groupBy If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.&lt;br/&gt;Valid values: &#x60;projectId&#x60;, &#x60;environmentId&#x60;, &#x60;destination&#x60;. (optional)
     * @param aggregationType Specifies the aggregation method. Defaults to &#x60;month_to_date&#x60;.&lt;br/&gt;Valid values: &#x60;month_to_date&#x60;, &#x60;incremental&#x60;. (optional)
     * @param granularity Specifies the data granularity. Defaults to &#x60;daily&#x60;. &#x60;monthly&#x60; granularity is only supported with the **month_to_date** aggregation type.&lt;br/&gt;Valid values: &#x60;daily&#x60;, &#x60;hourly&#x60;, &#x60;monthly&#x60;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call getWarehouseExportUsageCall(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String destination, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/usage/warehouse-export";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWarehouseExportUsageValidateBeforeCall(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String destination, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity, final ApiCallback _callback) throws ApiException {
        return getWarehouseExportUsageCall(from, to, projectKey, environmentKey, destination, groupBy, aggregationType, granularity, _callback);
     ...
     */
    public SeriesListRep getWarehouseExportUsage(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String destination, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity) throws ApiException {
        ApiResponse<SeriesListRep> localVarResp = getWarehouseExportUsageWithHttpInfo(from, to, projectKey, environmentKey, destination, groupBy, aggregationType, granularity);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SeriesListRep> getWarehouseExportUsageWithHttpInfo(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String destination, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity) throws ApiException {
        okhttp3.Call localVarCall = getWarehouseExportUsageValidateBeforeCall(from, to, projectKey, environmentKey, destination, groupBy, aggregationType, granularity, null);
        Type localVarReturnType = new TypeToken<SeriesListRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get warehouse Data Export usage (asynchronously)
     * Get a time series array showing the number of rows exported to your warehouse Data Export destinations. The supported granularity varies by aggregation type. The maximum time range is 365 days.
     * @param from The series of data returned starts from this timestamp (Unix milliseconds). Defaults to the beginning of the current month. (optional)
     * @param to The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time. (optional)
     * @param projectKey A project key to filter results by. Can be specified multiple times, one query parameter per project key. (optional)
     ...
     */
    public okhttp3.Call getWarehouseExportUsageAsync(@javax.annotation.Nullable String from, @javax.annotation.Nullable String to, @javax.annotation.Nullable String projectKey, @javax.annotation.Nullable String environmentKey, @javax.annotation.Nullable String destination, @javax.annotation.Nullable String groupBy, @javax.annotation.Nullable String aggregationType, @javax.annotation.Nullable String granularity, final ApiCallback<SeriesListRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getWarehouseExportUsageValidateBeforeCall(from, to, projectKey, environmentKey, destination, groupBy, aggregationType, granularity, _callback);
        Type localVarReturnType = new TypeToken<SeriesListRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
