...
public class AccountUsageBetaApi {
     ...
     */
    public okhttp3.Call getExperimentationKeysUsageCall(String from, String to, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExperimentationKeysUsageValidateBeforeCall(String from, String to, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getExperimentationKeysUsageCall(from, to, _callback);
        return localVarCall;
    ...
    public SeriesIntervalsRep getExperimentationKeysUsage(String from, String to) throws ApiException {
        ApiResponse<SeriesIntervalsRep> localVarResp = getExperimentationKeysUsageWithHttpInfo(from, to);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<SeriesIntervalsRep> getExperimentationKeysUsageWithHttpInfo(String from, String to) throws ApiException {
        okhttp3.Call localVarCall = getExperimentationKeysUsageValidateBeforeCall(from, to, null);
     ...
     */
    public okhttp3.Call getExperimentationKeysUsageAsync(String from, String to, final ApiCallback<SeriesIntervalsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExperimentationKeysUsageValidateBeforeCall(from, to, _callback);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getExperimentationUnitsUsageCall(String from, String to, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExperimentationUnitsUsageValidateBeforeCall(String from, String to, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getExperimentationUnitsUsageCall(from, to, _callback);
        return localVarCall;
    ...
    public SeriesIntervalsRep getExperimentationUnitsUsage(String from, String to) throws ApiException {
        ApiResponse<SeriesIntervalsRep> localVarResp = getExperimentationUnitsUsageWithHttpInfo(from, to);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<SeriesIntervalsRep> getExperimentationUnitsUsageWithHttpInfo(String from, String to) throws ApiException {
        okhttp3.Call localVarCall = getExperimentationUnitsUsageValidateBeforeCall(from, to, null);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getExperimentationUnitsUsageAsync(String from, String to, final ApiCallback<SeriesIntervalsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExperimentationUnitsUsageValidateBeforeCall(from, to, _callback);
        Type localVarReturnType = new TypeToken<SeriesIntervalsRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
