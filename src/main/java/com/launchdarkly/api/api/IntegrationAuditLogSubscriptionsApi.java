...
public class IntegrationAuditLogSubscriptionsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Successful integration </td><td>  -  </td></tr>
    ...
    private okhttp3.Call createSubscriptionValidateBeforeCall(String integrationKey, SubscriptionPost subscriptionPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createSubscriptionCall(integrationKey, subscriptionPost, _callback);
        return localVarCall;
    ...
    /**
     * Create audit log subscription (asynchronously)
     * Create an audit log subscription.
     * @param integrationKey The integration key (required)
     * @param subscriptionPost  (required)
    ...
    private okhttp3.Call deleteSubscriptionValidateBeforeCall(String integrationKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteSubscriptionCall(integrationKey, id, _callback);
        return localVarCall;
    ...
    /**
     * Delete audit log subscription (asynchronously)
     * Delete an audit log subscription.
     * @param integrationKey The integration key (required)
     * @param id The subscription ID (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successful integrations response </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource identifier </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
    ...
    private okhttp3.Call getSubscriptionByIDValidateBeforeCall(String integrationKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getSubscriptionByIDCall(integrationKey, id, _callback);
        return localVarCall;
    ...
    /**
     * Get audit log subscription by ID (asynchronously)
     * Get an audit log subscription by ID.
     * @param integrationKey The integration key (required)
     * @param id The subscription ID (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    private okhttp3.Call getSubscriptionsValidateBeforeCall(String integrationKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getSubscriptionsCall(integrationKey, _callback);
        return localVarCall;
    ...
    /**
     * Get audit log subscriptions by integration (asynchronously)
     * Get all audit log subscriptions associated with a given integration.
     * @param integrationKey The integration key (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    private okhttp3.Call updateSubscriptionValidateBeforeCall(String integrationKey, String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateSubscriptionCall(integrationKey, id, patchOperation, _callback);
        return localVarCall;
    ...
    /**
     * Update audit log subscription (asynchronously)
     * Update an audit log subscription configuration. Requires a [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes to the audit log subscription.
     * @param integrationKey The integration key (required)
     * @param id The ID of the audit log subscription (required)
     * @param patchOperation  (required)
