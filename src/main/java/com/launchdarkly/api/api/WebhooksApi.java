...
public class WebhooksApi {
     ...
     */
    public okhttp3.Call getAllWebhooksCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private okhttp3.Call getAllWebhooksValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllWebhooksCall(_callback);
        return localVarCall;
    ...
    public Webhooks getAllWebhooks() throws ApiException {
        ApiResponse<Webhooks> localVarResp = getAllWebhooksWithHttpInfo();
     ...
     */
    public okhttp3.Call getAllWebhooksAsync(final ApiCallback<Webhooks> _callback) throws ApiException {
    ...
    private okhttp3.Call getWebhookValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getWebhookCall(id, _callback);
        return localVarCall;
     ...
     * @param id The ID of the webhook to update (required)
    ...
    private okhttp3.Call patchWebhookValidateBeforeCall(String id, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchWebhookCall(id, patchOperation, _callback);
        return localVarCall;
    ...
    private okhttp3.Call postWebhookValidateBeforeCall(WebhookPost webhookPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postWebhookCall(webhookPost, _callback);
        return localVarCall;
