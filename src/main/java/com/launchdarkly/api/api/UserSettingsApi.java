...
public class UserSettingsApi {
     ...
     */
    public okhttp3.Call getExpiringFlagsForUserCall(String projKey, String userKey, String envKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/users/{projKey}/{userKey}/expiring-user-targets/{envKey}"
    ...
    private okhttp3.Call getExpiringFlagsForUserValidateBeforeCall(String projKey, String userKey, String envKey, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getExpiringFlagsForUser(Async)");
        }
        ...
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getExpiringFlagsForUser(Async)");
        }
        

        okhttp3.Call localVarCall = getExpiringFlagsForUserCall(projKey, userKey, envKey, _callback);
        return localVarCall;
     ...
     */
    public ExpiringUserTargetGetResponse getExpiringFlagsForUser(String projKey, String userKey, String envKey) throws ApiException {
        ApiResponse<ExpiringUserTargetGetResponse> localVarResp = getExpiringFlagsForUserWithHttpInfo(projKey, userKey, envKey);
     ...
     */
    public ApiResponse<ExpiringUserTargetGetResponse> getExpiringFlagsForUserWithHttpInfo(String projKey, String userKey, String envKey) throws ApiException {
        okhttp3.Call localVarCall = getExpiringFlagsForUserValidateBeforeCall(projKey, userKey, envKey, null);
     ...
     */
    public okhttp3.Call getExpiringFlagsForUserAsync(String projKey, String userKey, String envKey, final ApiCallback<ExpiringUserTargetGetResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExpiringFlagsForUserValidateBeforeCall(projKey, userKey, envKey, _callback);
        Type localVarReturnType = new TypeToken<ExpiringUserTargetGetResponse>(){}.getType();
     ...
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param key The user key (required)
     * @param featureKey The feature flag key (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getUserFlagSettingCall(String projKey, String envKey, String key, String featureKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/users/{projKey}/{envKey}/{key}/flags/{featureKey}"
            .replaceAll("\\{" + "projKey" + "\\}", localVarApiClient.escapeString(projKey.toString()))
            .replaceAll("\\{" + "envKey" + "\\}", localVarApiClient.escapeString(envKey.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserFlagSettingValidateBeforeCall(String projKey, String envKey, String key, String featureKey, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getUserFlagSetting(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getUserFlagSetting(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling getUserFlagSetting(Async)");
        }
        
        // verify the required parameter 'featureKey' is set
        if (featureKey == null) {
            throw new ApiException("Missing the required parameter 'featureKey' when calling getUserFlagSetting(Async)");
        }
        

        okhttp3.Call localVarCall = getUserFlagSettingCall(projKey, envKey, key, featureKey, _callback);
        return localVarCall;
     ...
     */
    public UserFlagSetting getUserFlagSetting(String projKey, String envKey, String key, String featureKey) throws ApiException {
        ApiResponse<UserFlagSetting> localVarResp = getUserFlagSettingWithHttpInfo(projKey, envKey, key, featureKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserFlagSetting> getUserFlagSettingWithHttpInfo(String projKey, String envKey, String key, String featureKey) throws ApiException {
        okhttp3.Call localVarCall = getUserFlagSettingValidateBeforeCall(projKey, envKey, key, featureKey, null);
        Type localVarReturnType = new TypeToken<UserFlagSetting>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get flag setting for user (asynchronously)
     * Get a single flag setting for a user by key. The most important attribute in the response is the &#x60;_value&#x60;. The &#x60;_value&#x60; is the current setting that the user sees. For a boolean feature toggle, this is &#x60;true&#x60;, &#x60;false&#x60;, or &#x60;null&#x60;. &#x60;null&#x60; returns if there is no defined fallback value. The example response indicates that the user &#x60;Abbie_Braun&#x60; has the &#x60;sort.order&#x60; flag enabled.&lt;br /&gt;&lt;br /&gt;The setting attribute indicates whether you&#39;ve explicitly targeted a user to receive a particular variation. For example, if you have turned off a feature flag for a user, this setting will be &#x60;false&#x60;. A setting of &#x60;null&#x60; means that you haven&#39;t assigned that user to a specific variation.
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param key The user key (required)
     ...
     */
    public okhttp3.Call getUserFlagSettingAsync(String projKey, String envKey, String key, String featureKey, final ApiCallback<UserFlagSetting> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserFlagSettingValidateBeforeCall(projKey, envKey, key, featureKey, _callback);
        Type localVarReturnType = new TypeToken<UserFlagSetting>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getUserFlagSettingsCall(String projKey, String envKey, String key, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/users/{projKey}/{envKey}/{key}/flags"
            .replaceAll("\\{" + "projKey" + "\\}", localVarApiClient.escapeString(projKey.toString()))
            .replaceAll("\\{" + "envKey" + "\\}", localVarApiClient.escapeString(envKey.toString()))
            .replaceAll("\\{" + "key" + "\\}", localVarApiClient.escapeString(key.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserFlagSettingsValidateBeforeCall(String projKey, String envKey, String key, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getUserFlagSettings(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getUserFlagSettings(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling getUserFlagSettings(Async)");
        }
        

        okhttp3.Call localVarCall = getUserFlagSettingsCall(projKey, envKey, key, _callback);
        return localVarCall;
     ...
     */
    public UserFlagSettings getUserFlagSettings(String projKey, String envKey, String key) throws ApiException {
        ApiResponse<UserFlagSettings> localVarResp = getUserFlagSettingsWithHttpInfo(projKey, envKey, key);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserFlagSettings> getUserFlagSettingsWithHttpInfo(String projKey, String envKey, String key) throws ApiException {
        okhttp3.Call localVarCall = getUserFlagSettingsValidateBeforeCall(projKey, envKey, key, null);
        Type localVarReturnType = new TypeToken<UserFlagSettings>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List flag settings for user (asynchronously)
     * Get the current flag settings for a given user. The most important attribute in the response is the &#x60;_value&#x60;. The &#x60;_value&#x60; is the setting that the user sees. For a boolean feature toggle, this is &#x60;true&#x60;, &#x60;false&#x60;, or &#x60;null&#x60;. &#x60;null&#x60; returns if there is no defined fallthrough value. The example response indicates that the user &#x60;Abbie_Braun&#x60; has the &#x60;sort.order&#x60; flag enabled and the &#x60;alternate.page&#x60; flag disabled.&lt;br /&gt;&lt;br /&gt;The setting attribute indicates whether you&#39;ve explicitly targeted a user to receive a particular variation. For example, if you have turned off a feature flag for a user, this setting will be &#x60;false&#x60;. A setting of &#x60;null&#x60; means that you haven&#39;t assigned that user to a specific variation.
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param key The user key (required)
     ...
     */
    public okhttp3.Call getUserFlagSettingsAsync(String projKey, String envKey, String key, final ApiCallback<UserFlagSettings> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserFlagSettingsValidateBeforeCall(projKey, envKey, key, _callback);
        Type localVarReturnType = new TypeToken<UserFlagSettings>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call patchExpiringFlagsForUserCall(String projKey, String userKey, String envKey, PatchWithComment patchWithComment, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchExpiringFlagsForUserValidateBeforeCall(String projKey, String userKey, String envKey, PatchWithComment patchWithComment, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling patchExpiringFlagsForUser(Async)");
        }
        ...
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling patchExpiringFlagsForUser(Async)");
        }
        
        // verify the required parameter 'patchWithComment' is set
        if (patchWithComment == null) {
            throw new ApiException("Missing the required parameter 'patchWithComment' when calling patchExpiringFlagsForUser(Async)");
        }
        

        okhttp3.Call localVarCall = patchExpiringFlagsForUserCall(projKey, userKey, envKey, patchWithComment, _callback);
        return localVarCall;
     ...
     */
    public ExpiringUserTargetPatchResponse patchExpiringFlagsForUser(String projKey, String userKey, String envKey, PatchWithComment patchWithComment) throws ApiException {
        ApiResponse<ExpiringUserTargetPatchResponse> localVarResp = patchExpiringFlagsForUserWithHttpInfo(projKey, userKey, envKey, patchWithComment);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExpiringUserTargetPatchResponse> patchExpiringFlagsForUserWithHttpInfo(String projKey, String userKey, String envKey, PatchWithComment patchWithComment) throws ApiException {
        okhttp3.Call localVarCall = patchExpiringFlagsForUserValidateBeforeCall(projKey, userKey, envKey, patchWithComment, null);
        Type localVarReturnType = new TypeToken<ExpiringUserTargetPatchResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update expiring user target for flags (asynchronously)
     * Schedule the specified user for removal from individual user targeting on one or more flags. You can only schedule a user for removal on a single variation per flag.  To learn more about semantic patches, read [Updates](/#section/Updates).  If you previously patched the flag, and the patch included the user&#39;s data, LaunchDarkly continues to use that data. If LaunchDarkly has never encountered the user&#39;s key before, it calculates the flag values based on the user key alone. 
     * @param projKey The project key. (required)
     * @param userKey The user key. (required)
     * @param envKey The environment key. (required)
     ...
     */
    public okhttp3.Call patchExpiringFlagsForUserAsync(String projKey, String userKey, String envKey, PatchWithComment patchWithComment, final ApiCallback<ExpiringUserTargetPatchResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchExpiringFlagsForUserValidateBeforeCall(projKey, userKey, envKey, patchWithComment, _callback);
        Type localVarReturnType = new TypeToken<ExpiringUserTargetPatchResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call putFlagSettingCall(String projKey, String envKey, String key, String featureKey, ValuePut valuePut, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putFlagSettingValidateBeforeCall(String projKey, String envKey, String key, String featureKey, ValuePut valuePut, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling putFlagSetting(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling putFlagSetting(Async)");
        }
        
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling putFlagSetting(Async)");
        }
        
        // verify the required parameter 'featureKey' is set
        if (featureKey == null) {
            throw new ApiException("Missing the required parameter 'featureKey' when calling putFlagSetting(Async)");
        }
        ...
        okhttp3.Call localVarCall = putFlagSettingCall(projKey, envKey, key, featureKey, valuePut, _callback);
        return localVarCall;
     ...
     */
    public void putFlagSetting(String projKey, String envKey, String key, String featureKey, ValuePut valuePut) throws ApiException {
        putFlagSettingWithHttpInfo(projKey, envKey, key, featureKey, valuePut);
    }
     ...
     */
    public ApiResponse<Void> putFlagSettingWithHttpInfo(String projKey, String envKey, String key, String featureKey, ValuePut valuePut) throws ApiException {
        okhttp3.Call localVarCall = putFlagSettingValidateBeforeCall(projKey, envKey, key, featureKey, valuePut, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Update flag settings for user (asynchronously)
     * Enable or disable a feature flag for a user based on their key.  To change the setting, send a &#x60;PUT&#x60; request to this URL with a request body containing the flag value. For example, to disable the sort.order flag for the user &#x60;test@test.com&#x60;, send a &#x60;PUT&#x60; to &#x60;https://app.launchdarkly.com/api/v2/users/default/production/test@test.com/flags/sort.order&#x60; with the following body:  &#x60;&#x60;&#x60;json {   \&quot;setting\&quot;: false } &#x60;&#x60;&#x60;  Omitting the setting attribute, or a setting of null, in your &#x60;PUT&#x60; \&quot;clears\&quot; the current setting for a user.  If you previously patched the flag, and the patch included the user&#39;s data, LaunchDarkly continues to use that data. If LaunchDarkly has never encountered the user&#39;s key before, it calculates the flag values based on the user key alone. 
     * @param projKey The project key (required)
     * @param envKey The environment key (required)
     * @param key The user key (required)
     ...
     */
    public okhttp3.Call putFlagSettingAsync(String projKey, String envKey, String key, String featureKey, ValuePut valuePut, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = putFlagSettingValidateBeforeCall(projKey, envKey, key, featureKey, valuePut, _callback);
