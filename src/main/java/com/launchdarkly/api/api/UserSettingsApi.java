...
public class UserSettingsApi {
    ...
    private okhttp3.Call getExpiringFlagsForUserValidateBeforeCall(String projectKey, String userKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getExpiringFlagsForUserCall(projectKey, userKey, environmentKey, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getUserFlagSettingValidateBeforeCall(String projectKey, String environmentKey, String userKey, String featureFlagKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUserFlagSettingCall(projectKey, environmentKey, userKey, featureFlagKey, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getUserFlagSettingsValidateBeforeCall(String projectKey, String environmentKey, String userKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUserFlagSettingsCall(projectKey, environmentKey, userKey, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call patchExpiringFlagsForUserCall(String projectKey, String userKey, String environmentKey, PatchWithComment patchWithComment, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchExpiringFlagsForUserValidateBeforeCall(String projectKey, String userKey, String environmentKey, PatchWithComment patchWithComment, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchExpiringFlagsForUserCall(projectKey, userKey, environmentKey, patchWithComment, _callback);
        return localVarCall;
     ...
     */
    public ExpiringUserTargetPatchResponse patchExpiringFlagsForUser(String projectKey, String userKey, String environmentKey, PatchWithComment patchWithComment) throws ApiException {
        ApiResponse<ExpiringUserTargetPatchResponse> localVarResp = patchExpiringFlagsForUserWithHttpInfo(projectKey, userKey, environmentKey, patchWithComment);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExpiringUserTargetPatchResponse> patchExpiringFlagsForUserWithHttpInfo(String projectKey, String userKey, String environmentKey, PatchWithComment patchWithComment) throws ApiException {
        okhttp3.Call localVarCall = patchExpiringFlagsForUserValidateBeforeCall(projectKey, userKey, environmentKey, patchWithComment, null);
     ...
     */
    public okhttp3.Call patchExpiringFlagsForUserAsync(String projectKey, String userKey, String environmentKey, PatchWithComment patchWithComment, final ApiCallback<ExpiringUserTargetPatchResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchExpiringFlagsForUserValidateBeforeCall(projectKey, userKey, environmentKey, patchWithComment, _callback);
        Type localVarReturnType = new TypeToken<ExpiringUserTargetPatchResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call putFlagSettingValidateBeforeCall(String projectKey, String environmentKey, String userKey, String featureFlagKey, ValuePut valuePut, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = putFlagSettingCall(projectKey, environmentKey, userKey, featureFlagKey, valuePut, _callback);
        return localVarCall;
