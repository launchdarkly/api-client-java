...
public class FeatureFlagsApi {
     ...
     * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param featureFlagApprovalRequestId The feature flag approval request ID (required)
     * @param featureFlagApprovalRequestConfigBody Create a new feature flag approval request (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteFeatureFlagApprovalRequestCall(String projectKey, String environmentKey, String featureFlagKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = featureFlagApprovalRequestConfigBody;

        // create path and map variables
        String localVarPath = "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}"
            .replaceAll("\\{" + "projectKey" + "\\}", apiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", apiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "featureFlagKey" + "\\}", apiClient.escapeString(featureFlagKey.toString()))
            .replaceAll("\\{" + "featureFlagApprovalRequestId" + "\\}", apiClient.escapeString(featureFlagApprovalRequestId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteFeatureFlagApprovalRequestValidateBeforeCall(String projectKey, String environmentKey, String featureFlagKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling deleteFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling deleteFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling deleteFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagApprovalRequestId' is set
        if (featureFlagApprovalRequestId == null) {
            throw new ApiException("Missing the required parameter 'featureFlagApprovalRequestId' when calling deleteFeatureFlagApprovalRequest(Async)");
        }
        

        com.squareup.okhttp.Call call = deleteFeatureFlagApprovalRequestCall(projectKey, environmentKey, featureFlagKey, featureFlagApprovalRequestId, featureFlagApprovalRequestConfigBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void deleteFeatureFlagApprovalRequest(String projectKey, String environmentKey, String featureFlagKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody) throws ApiException {
        deleteFeatureFlagApprovalRequestWithHttpInfo(projectKey, environmentKey, featureFlagKey, featureFlagApprovalRequestId, featureFlagApprovalRequestConfigBody);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> deleteFeatureFlagApprovalRequestWithHttpInfo(String projectKey, String environmentKey, String featureFlagKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody) throws ApiException {
        com.squareup.okhttp.Call call = deleteFeatureFlagApprovalRequestValidateBeforeCall(projectKey, environmentKey, featureFlagKey, featureFlagApprovalRequestId, featureFlagApprovalRequestConfigBody, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteFeatureFlagApprovalRequestAsync(String projectKey, String environmentKey, String featureFlagKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteFeatureFlagApprovalRequestValidateBeforeCall(projectKey, environmentKey, featureFlagKey, featureFlagApprovalRequestId, featureFlagApprovalRequestConfigBody, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getFeatureFlagApprovalRequestCall(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFeatureFlagApprovalRequestValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling getFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling getFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling getFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagApprovalRequestId' is set
        if (featureFlagApprovalRequestId == null) {
            throw new ApiException("Missing the required parameter 'featureFlagApprovalRequestId' when calling getFeatureFlagApprovalRequest(Async)");
        }
        

        com.squareup.okhttp.Call call = getFeatureFlagApprovalRequestCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FeatureFlagApprovalRequests getFeatureFlagApprovalRequest(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId) throws ApiException {
        ApiResponse<FeatureFlagApprovalRequests> resp = getFeatureFlagApprovalRequestWithHttpInfo(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId);
        return resp.getData();
    }
     ...
     * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param featureFlagApprovalRequestId The feature flag approval request ID (required)
     * @return ApiResponse&lt;FeatureFlagApprovalRequests&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FeatureFlagApprovalRequests> getFeatureFlagApprovalRequestWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId) throws ApiException {
        com.squareup.okhttp.Call call = getFeatureFlagApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, null, null);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequests>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getFeatureFlagApprovalRequestAsync(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, final ApiCallback<FeatureFlagApprovalRequests> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getFeatureFlagApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequests>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getFeatureFlagApprovalRequestsCall(String projectKey, String featureFlagKey, String environmentKey, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFeatureFlagApprovalRequestsValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling getFeatureFlagApprovalRequests(Async)");
        }
        
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling getFeatureFlagApprovalRequests(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling getFeatureFlagApprovalRequests(Async)");
        }
        

        com.squareup.okhttp.Call call = getFeatureFlagApprovalRequestsCall(projectKey, featureFlagKey, environmentKey, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FeatureFlagApprovalRequests getFeatureFlagApprovalRequests(String projectKey, String featureFlagKey, String environmentKey) throws ApiException {
        ApiResponse<FeatureFlagApprovalRequests> resp = getFeatureFlagApprovalRequestsWithHttpInfo(projectKey, featureFlagKey, environmentKey);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FeatureFlagApprovalRequests> getFeatureFlagApprovalRequestsWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey) throws ApiException {
        com.squareup.okhttp.Call call = getFeatureFlagApprovalRequestsValidateBeforeCall(projectKey, featureFlagKey, environmentKey, null, null);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequests>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getFeatureFlagApprovalRequestsAsync(String projectKey, String featureFlagKey, String environmentKey, final ApiCallback<FeatureFlagApprovalRequests> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getFeatureFlagApprovalRequestsValidateBeforeCall(projectKey, featureFlagKey, environmentKey, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequests>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param featureFlagApprovalRequestId The feature flag approval request ID (required)
     * @param featureFlagApprovalRequestApplyConfigBody Apply a new feature flag approval request (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postApplyFeatureFlagApprovalRequestCall(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestApplyConfigBody featureFlagApprovalRequestApplyConfigBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = featureFlagApprovalRequestApplyConfigBody;

        // create path and map variables
        String localVarPath = "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}/apply"
            .replaceAll("\\{" + "projectKey" + "\\}", apiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "featureFlagKey" + "\\}", apiClient.escapeString(featureFlagKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", apiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "featureFlagApprovalRequestId" + "\\}", apiClient.escapeString(featureFlagApprovalRequestId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postApplyFeatureFlagApprovalRequestValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestApplyConfigBody featureFlagApprovalRequestApplyConfigBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling postApplyFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling postApplyFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling postApplyFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagApprovalRequestId' is set
        if (featureFlagApprovalRequestId == null) {
            throw new ApiException("Missing the required parameter 'featureFlagApprovalRequestId' when calling postApplyFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagApprovalRequestApplyConfigBody' is set
        if (featureFlagApprovalRequestApplyConfigBody == null) {
            throw new ApiException("Missing the required parameter 'featureFlagApprovalRequestApplyConfigBody' when calling postApplyFeatureFlagApprovalRequest(Async)");
        }
        

        com.squareup.okhttp.Call call = postApplyFeatureFlagApprovalRequestCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestApplyConfigBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FeatureFlagApprovalRequests postApplyFeatureFlagApprovalRequest(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestApplyConfigBody featureFlagApprovalRequestApplyConfigBody) throws ApiException {
        ApiResponse<FeatureFlagApprovalRequests> resp = postApplyFeatureFlagApprovalRequestWithHttpInfo(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestApplyConfigBody);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FeatureFlagApprovalRequests> postApplyFeatureFlagApprovalRequestWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestApplyConfigBody featureFlagApprovalRequestApplyConfigBody) throws ApiException {
        com.squareup.okhttp.Call call = postApplyFeatureFlagApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestApplyConfigBody, null, null);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequests>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postApplyFeatureFlagApprovalRequestAsync(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestApplyConfigBody featureFlagApprovalRequestApplyConfigBody, final ApiCallback<FeatureFlagApprovalRequests> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postApplyFeatureFlagApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestApplyConfigBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequests>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postFeatureFlagApprovalRequestCall(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = featureFlagApprovalRequestConfigBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postFeatureFlagApprovalRequestValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling postFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling postFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling postFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagApprovalRequestId' is set
        if (featureFlagApprovalRequestId == null) {
            throw new ApiException("Missing the required parameter 'featureFlagApprovalRequestId' when calling postFeatureFlagApprovalRequest(Async)");
        }
        

        com.squareup.okhttp.Call call = postFeatureFlagApprovalRequestCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestConfigBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FeatureFlagApprovalRequest postFeatureFlagApprovalRequest(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody) throws ApiException {
        ApiResponse<FeatureFlagApprovalRequest> resp = postFeatureFlagApprovalRequestWithHttpInfo(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestConfigBody);
        return resp.getData();
    }
     ...
     * @param featureFlagApprovalRequestId The feature flag approval request ID (required)
     * @param featureFlagApprovalRequestConfigBody Create a new feature flag approval request (optional)
     * @return ApiResponse&lt;FeatureFlagApprovalRequest&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FeatureFlagApprovalRequest> postFeatureFlagApprovalRequestWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody) throws ApiException {
        com.squareup.okhttp.Call call = postFeatureFlagApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestConfigBody, null, null);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequest>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postFeatureFlagApprovalRequestAsync(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestConfigBody featureFlagApprovalRequestConfigBody, final ApiCallback<FeatureFlagApprovalRequest> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postFeatureFlagApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestConfigBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequest>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param featureFlagApprovalRequestId The feature flag approval request ID (required)
     * @param featureFlagApprovalRequestReviewConfigBody Review a feature flag approval request (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postReviewFeatureFlagApprovalRequestCall(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestReviewConfigBody featureFlagApprovalRequestReviewConfigBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = featureFlagApprovalRequestReviewConfigBody;

        // create path and map variables
        String localVarPath = "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}/review"
            .replaceAll("\\{" + "projectKey" + "\\}", apiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "featureFlagKey" + "\\}", apiClient.escapeString(featureFlagKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", apiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "featureFlagApprovalRequestId" + "\\}", apiClient.escapeString(featureFlagApprovalRequestId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postReviewFeatureFlagApprovalRequestValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestReviewConfigBody featureFlagApprovalRequestReviewConfigBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling postReviewFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagKey' is set
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling postReviewFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling postReviewFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagApprovalRequestId' is set
        if (featureFlagApprovalRequestId == null) {
            throw new ApiException("Missing the required parameter 'featureFlagApprovalRequestId' when calling postReviewFeatureFlagApprovalRequest(Async)");
        }
        
        // verify the required parameter 'featureFlagApprovalRequestReviewConfigBody' is set
        if (featureFlagApprovalRequestReviewConfigBody == null) {
            throw new ApiException("Missing the required parameter 'featureFlagApprovalRequestReviewConfigBody' when calling postReviewFeatureFlagApprovalRequest(Async)");
        }
        

        com.squareup.okhttp.Call call = postReviewFeatureFlagApprovalRequestCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestReviewConfigBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FeatureFlagApprovalRequests postReviewFeatureFlagApprovalRequest(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestReviewConfigBody featureFlagApprovalRequestReviewConfigBody) throws ApiException {
        ApiResponse<FeatureFlagApprovalRequests> resp = postReviewFeatureFlagApprovalRequestWithHttpInfo(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestReviewConfigBody);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FeatureFlagApprovalRequests> postReviewFeatureFlagApprovalRequestWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestReviewConfigBody featureFlagApprovalRequestReviewConfigBody) throws ApiException {
        com.squareup.okhttp.Call call = postReviewFeatureFlagApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestReviewConfigBody, null, null);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequests>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postReviewFeatureFlagApprovalRequestAsync(String projectKey, String featureFlagKey, String environmentKey, String featureFlagApprovalRequestId, FeatureFlagApprovalRequestReviewConfigBody featureFlagApprovalRequestReviewConfigBody, final ApiCallback<FeatureFlagApprovalRequests> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postReviewFeatureFlagApprovalRequestValidateBeforeCall(projectKey, featureFlagKey, environmentKey, featureFlagApprovalRequestId, featureFlagApprovalRequestReviewConfigBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FeatureFlagApprovalRequests>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
