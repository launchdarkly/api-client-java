...
public class FeatureFlagsApi {
     ...
     */
    public okhttp3.Call getFeatureFlagsCall(String projKey, String env, String tag, Long limit, Long offset, Boolean archived, Boolean summary, String filter, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFeatureFlagsValidateBeforeCall(String projKey, String env, String tag, Long limit, Long offset, Boolean archived, Boolean summary, String filter, String sort, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getFeatureFlagsCall(projKey, env, tag, limit, offset, archived, summary, filter, sort, _callback);
        return localVarCall;
     ...
     */
    public FeatureFlags getFeatureFlags(String projKey, String env, String tag, Long limit, Long offset, Boolean archived, Boolean summary, String filter, String sort) throws ApiException {
        ApiResponse<FeatureFlags> localVarResp = getFeatureFlagsWithHttpInfo(projKey, env, tag, limit, offset, archived, summary, filter, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FeatureFlags> getFeatureFlagsWithHttpInfo(String projKey, String env, String tag, Long limit, Long offset, Boolean archived, Boolean summary, String filter, String sort) throws ApiException {
        okhttp3.Call localVarCall = getFeatureFlagsValidateBeforeCall(projKey, env, tag, limit, offset, archived, summary, filter, sort, null);
     ...
     */
    public okhttp3.Call getFeatureFlagsAsync(String projKey, String env, String tag, Long limit, Long offset, Boolean archived, Boolean summary, String filter, String sort, final ApiCallback<FeatureFlags> _callback) throws ApiException {

        okhttp3.Call localVarCall = getFeatureFlagsValidateBeforeCall(projKey, env, tag, limit, offset, archived, summary, filter, sort, _callback);
        Type localVarReturnType = new TypeToken<FeatureFlags>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
