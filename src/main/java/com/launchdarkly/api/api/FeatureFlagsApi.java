...
public class FeatureFlagsApi {
     ...
     */
    public com.squareup.okhttp.Call copyFeatureFlagCall(String projectKey, String environmentKey, String featureFlagKey, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/flags/{projectKey}/{environmentKey}/{featureFlagKey}/copy"
    ...
    private com.squareup.okhttp.Call copyFeatureFlagValidateBeforeCall(String projectKey, String environmentKey, String featureFlagKey, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling copyFeatureFlag(Async)");
        }
        ...
        com.squareup.okhttp.Call call = copyFeatureFlagCall(projectKey, environmentKey, featureFlagKey, progressListener, progressRequestListener);
        return call;
     ...
     */
    public FeatureFlag copyFeatureFlag(String projectKey, String environmentKey, String featureFlagKey) throws ApiException {
        ApiResponse<FeatureFlag> resp = copyFeatureFlagWithHttpInfo(projectKey, environmentKey, featureFlagKey);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FeatureFlag> copyFeatureFlagWithHttpInfo(String projectKey, String environmentKey, String featureFlagKey) throws ApiException {
        com.squareup.okhttp.Call call = copyFeatureFlagValidateBeforeCall(projectKey, environmentKey, featureFlagKey, null, null);
     ...
     */
    public com.squareup.okhttp.Call copyFeatureFlagAsync(String projectKey, String environmentKey, String featureFlagKey, final ApiCallback<FeatureFlag> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = copyFeatureFlagValidateBeforeCall(projectKey, environmentKey, featureFlagKey, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FeatureFlag>(){}.getType();
