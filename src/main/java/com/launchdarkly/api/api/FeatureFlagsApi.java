...
public class FeatureFlagsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call patchExpiringUserTargetsCall(String projectKey, String environmentKey, String featureFlagKey, PatchComment patchComment, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call patchExpiringUserTargetsValidateBeforeCall(String projectKey, String environmentKey, String featureFlagKey, PatchComment patchComment, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (patchComment == null) {
            throw new ApiException("Missing the required parameter 'patchComment' when calling patchExpiringUserTargets(Async)");
        }
        

        com.squareup.okhttp.Call call = patchExpiringUserTargetsCall(projectKey, environmentKey, featureFlagKey, patchComment, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UserTargetingExpirationForFlags patchExpiringUserTargets(String projectKey, String environmentKey, String featureFlagKey, PatchComment patchComment) throws ApiException {
        ApiResponse<UserTargetingExpirationForFlags> resp = patchExpiringUserTargetsWithHttpInfo(projectKey, environmentKey, featureFlagKey, patchComment);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UserTargetingExpirationForFlags> patchExpiringUserTargetsWithHttpInfo(String projectKey, String environmentKey, String featureFlagKey, PatchComment patchComment) throws ApiException {
        com.squareup.okhttp.Call call = patchExpiringUserTargetsValidateBeforeCall(projectKey, environmentKey, featureFlagKey, patchComment, null, null);
        Type localVarReturnType = new TypeToken<UserTargetingExpirationForFlags>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call patchExpiringUserTargetsAsync(String projectKey, String environmentKey, String featureFlagKey, PatchComment patchComment, final ApiCallback<UserTargetingExpirationForFlags> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = patchExpiringUserTargetsValidateBeforeCall(projectKey, environmentKey, featureFlagKey, patchComment, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UserTargetingExpirationForFlags>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
