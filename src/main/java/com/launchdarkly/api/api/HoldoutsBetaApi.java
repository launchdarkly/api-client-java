...
public class HoldoutsBetaApi {
    ...
    public okhttp3.Call getAllHoldoutsCall(String projectKey, String environmentKey, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts"
    ...
    private okhttp3.Call getAllHoldoutsValidateBeforeCall(String projectKey, String environmentKey, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllHoldoutsCall(projectKey, environmentKey, limit, offset, _callback);
        return localVarCall;
    ...
    /**
     * Get all holdouts (asynchronously)
     * 
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param limit The number of holdouts to return in the response. Defaults to 20 (optional)
    ...
    /**
     * Build call for getHoldout
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param holdoutKey The holdout experiment key (required)
    ...
    public okhttp3.Call getHoldoutCall(String projectKey, String environmentKey, String holdoutKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey}"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "holdoutKey" + "\\}", localVarApiClient.escapeString(holdoutKey.toString()));
    ...
    private okhttp3.Call getHoldoutValidateBeforeCall(String projectKey, String environmentKey, String holdoutKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getHoldoutCall(projectKey, environmentKey, holdoutKey, expand, _callback);
        return localVarCall;
    ...
    /**
     * Build call for getHoldoutById
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param holdoutId The holdout experiment ID (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call getHoldoutByIdCall(String projectKey, String environmentKey, String holdoutId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/id/{holdoutId}"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "holdoutId" + "\\}", localVarApiClient.escapeString(holdoutId.toString()));
    ...
    private okhttp3.Call getHoldoutByIdValidateBeforeCall(String projectKey, String environmentKey, String holdoutId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getHoldoutByIdCall(projectKey, environmentKey, holdoutId, _callback);
        return localVarCall;
    ...
    /**
     * Get Holdout by Id (asynchronously)
     * 
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param holdoutId The holdout experiment ID (required)
    ...
    /**
     * Build call for patchHoldout
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param holdoutKey The holdout key (required)
     * @param holdoutPatchInput  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call patchHoldoutCall(String projectKey, String environmentKey, String holdoutKey, HoldoutPatchInput holdoutPatchInput, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = holdoutPatchInput;
    ...
    private okhttp3.Call patchHoldoutValidateBeforeCall(String projectKey, String environmentKey, String holdoutKey, HoldoutPatchInput holdoutPatchInput, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchHoldoutCall(projectKey, environmentKey, holdoutKey, holdoutPatchInput, _callback);
        return localVarCall;
    ...
    /**
     * Build call for postHoldout
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param holdoutPostRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call postHoldoutCall(String projectKey, String environmentKey, HoldoutPostRequest holdoutPostRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = holdoutPostRequest;
    ...
    private okhttp3.Call postHoldoutValidateBeforeCall(String projectKey, String environmentKey, HoldoutPostRequest holdoutPostRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postHoldoutCall(projectKey, environmentKey, holdoutPostRequest, _callback);
        return localVarCall;
