...
public class MetricsBetaApi {
     ...
     */
    public okhttp3.Call getMetricGroupsCall(String projectKey, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMetricGroupsValidateBeforeCall(String projectKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMetricGroupsCall(projectKey, expand, _callback);
        return localVarCall;
     ...
     */
    public MetricGroupCollectionRep getMetricGroups(String projectKey, String expand) throws ApiException {
        ApiResponse<MetricGroupCollectionRep> localVarResp = getMetricGroupsWithHttpInfo(projectKey, expand);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MetricGroupCollectionRep> getMetricGroupsWithHttpInfo(String projectKey, String expand) throws ApiException {
        okhttp3.Call localVarCall = getMetricGroupsValidateBeforeCall(projectKey, expand, null);
     ...
     */
    public okhttp3.Call getMetricGroupsAsync(String projectKey, String expand, final ApiCallback<MetricGroupCollectionRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMetricGroupsValidateBeforeCall(projectKey, expand, _callback);
        Type localVarReturnType = new TypeToken<MetricGroupCollectionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
