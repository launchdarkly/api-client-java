...
public class ScheduledChangesApi {
    ...
    public okhttp3.Call deleteFlagConfigScheduledChangesCall(String projectKey, String featureFlagKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{id}"
    ...
    private okhttp3.Call deleteFlagConfigScheduledChangesValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteFlagConfigScheduledChangesCall(projectKey, featureFlagKey, environmentKey, id, _callback);
        return localVarCall;
    ...
    /**
     * Delete scheduled changes workflow (asynchronously)
     * Delete a scheduled changes workflow
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag&#39;s key (required)
     * @param environmentKey The environment key (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Scheduled change response </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource identifier </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     </table>
    ...
    private okhttp3.Call getFeatureFlagScheduledChangeValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getFeatureFlagScheduledChangeCall(projectKey, featureFlagKey, environmentKey, id, _callback);
        return localVarCall;
    ...
    /**
     * Get a scheduled change (asynchronously)
     * Get a scheduled change that will be applied to the feature flag by ID
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag&#39;s key (required)
     * @param environmentKey The environment key (required)
    ...
    public okhttp3.Call getFlagConfigScheduledChangesCall(String projectKey, String featureFlagKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "featureFlagKey" + "\\}", localVarApiClient.escapeString(featureFlagKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()));
    ...
    private okhttp3.Call getFlagConfigScheduledChangesValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getFlagConfigScheduledChangesCall(projectKey, featureFlagKey, environmentKey, _callback);
        return localVarCall;
    ...
    /**
     * List scheduled changes (asynchronously)
     * Get a list of scheduled changes that will be applied to the feature flag.
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag&#39;s key (required)
     * @param environmentKey The environment key (required)
     ...
     * @param environmentKey The environment key (required)
     * @param id The scheduled change ID (required)
     * @param flagScheduledChangesInput  (required)
     * @param ignoreConflicts Whether or not to succeed or fail when the new instructions conflict with existing scheduled changes (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successful scheduled changes response </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request body </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource ID </td><td>  -  </td></tr>
        <tr><td> 405 </td><td> Method not allowed </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> Status conflict </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     </table>
    ...
    public okhttp3.Call patchFlagConfigScheduledChangeCall(String projectKey, String featureFlagKey, String environmentKey, String id, FlagScheduledChangesInput flagScheduledChangesInput, Boolean ignoreConflicts, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = flagScheduledChangesInput;
    ...
    private okhttp3.Call patchFlagConfigScheduledChangeValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String id, FlagScheduledChangesInput flagScheduledChangesInput, Boolean ignoreConflicts, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchFlagConfigScheduledChangeCall(projectKey, featureFlagKey, environmentKey, id, flagScheduledChangesInput, ignoreConflicts, _callback);
        return localVarCall;
     ...
     * @param featureFlagKey The feature flag&#39;s key (required)
     * @param environmentKey The environment key (required)
     * @param postFlagScheduledChangesInput  (required)
     * @param ignoreConflicts Whether or not to succeed or fail when the new instructions conflict with existing scheduled changes (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Successful scheduled changes response </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request body </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource ID </td><td>  -  </td></tr>
    ...
    public okhttp3.Call postFlagConfigScheduledChangesCall(String projectKey, String featureFlagKey, String environmentKey, PostFlagScheduledChangesInput postFlagScheduledChangesInput, Boolean ignoreConflicts, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = postFlagScheduledChangesInput;
    ...
    private okhttp3.Call postFlagConfigScheduledChangesValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, PostFlagScheduledChangesInput postFlagScheduledChangesInput, Boolean ignoreConflicts, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postFlagConfigScheduledChangesCall(projectKey, featureFlagKey, environmentKey, postFlagScheduledChangesInput, ignoreConflicts, _callback);
        return localVarCall;
    ...
    /**
     * Create scheduled changes workflow (asynchronously)
     * Create scheduled changes for a feature flag. If the ignoreConficts query parameter is false and the new instructions would conflict with the current state of the feature flag or any existing scheduled changes, the request will fail. If the parameter is true and there are conflicts, the request will succeed as normal.
     * @param projectKey The project key (required)
     * @param featureFlagKey The feature flag&#39;s key (required)
     * @param environmentKey The environment key (required)
