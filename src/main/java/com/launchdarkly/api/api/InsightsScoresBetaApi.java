...
public class InsightsScoresBetaApi {
     ...
     * @param postInsightGroupParams  (required)
    ...
    public okhttp3.Call createInsightGroupCall(PostInsightGroupParams postInsightGroupParams, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = postInsightGroupParams;
    ...
    private okhttp3.Call createInsightGroupValidateBeforeCall(PostInsightGroupParams postInsightGroupParams, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createInsightGroupCall(postInsightGroupParams, _callback);
        return localVarCall;
    ...
    /**
     * Create insight group (asynchronously)
     * Create insight group
     * @param postInsightGroupParams  (required)
    ...
    public okhttp3.Call deleteInsightGroupCall(String insightGroupKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/engineering-insights/insights/groups/{insightGroupKey}"
            .replaceAll("\\{" + "insightGroupKey" + "\\}", localVarApiClient.escapeString(insightGroupKey.toString()));
    ...
    private okhttp3.Call deleteInsightGroupValidateBeforeCall(String insightGroupKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteInsightGroupCall(insightGroupKey, _callback);
        return localVarCall;
    ...
    /**
     * Delete insight group (asynchronously)
     * Delete insight group
     * @param insightGroupKey The insight group key (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    private okhttp3.Call getInsightGroupValidateBeforeCall(String insightGroupKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInsightGroupCall(insightGroupKey, expand, _callback);
        return localVarCall;
    ...
    /**
     * Get insight group (asynchronously)
     * Get insight group  ### Expanding the insight group response  LaunchDarkly supports expanding the insight group response to include additional fields.  To expand the response, append the &#x60;expand&#x60; query parameter and include the following:  * &#x60;scores&#x60; includes details on all of the scores used in the engineering insights metrics views for this group * &#x60;environment&#x60; includes details on each environment associated with this group  For example, use &#x60;?expand&#x3D;scores&#x60; to include the &#x60;scores&#x60; field in the response. By default, this field is **not** included in the response. 
     * @param insightGroupKey The insight group key (required)
     * @param expand Options: &#x60;scores&#x60;, &#x60;environment&#x60; (optional)
     * @param _callback The callback to be executed when the API call finishes
    ...
    private okhttp3.Call getInsightGroupsValidateBeforeCall(Long limit, Long offset, String sort, String query, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInsightGroupsCall(limit, offset, sort, query, expand, _callback);
        return localVarCall;
    ...
    /**
     * List insight groups (asynchronously)
     * List groups for which you are collecting insights  ### Expanding the insight groups collection response  LaunchDarkly supports expanding the insight groups collection response to include additional fields.  To expand the response, append the &#x60;expand&#x60; query parameter and include the following:  * &#x60;scores&#x60; includes details on all of the scores used in the engineering insights metrics views for each group * &#x60;environment&#x60; includes details on each environment associated with each group * &#x60;metadata&#x60; includes counts of the number of insight groups with particular indicators, such as \&quot;execellent,\&quot; \&quot;good,\&quot; \&quot;fair,\&quot; and so on.  For example, use &#x60;?expand&#x3D;scores&#x60; to include the &#x60;scores&#x60; field in the response. By default, this field is **not** included in the response. 
     * @param limit The number of insight groups to return. Default is 20. Must be between 1 and 20 inclusive. (optional)
     * @param offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;. (optional)
     * @param sort Sort flag list by field. Prefix field with &lt;code&gt;-&lt;/code&gt; to sort in descending order. Allowed fields: name (optional)
    ...
    private okhttp3.Call getInsightsScoresValidateBeforeCall(String projectKey, String environmentKey, String applicationKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInsightsScoresCall(projectKey, environmentKey, applicationKey, _callback);
        return localVarCall;
    ...
    /**
     * Get insight scores (asynchronously)
     * Return insights scores, based on the given parameters. This data is also used in engineering insights metrics views.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param applicationKey Comma separated list of application keys (optional)
    ...
    private okhttp3.Call patchInsightGroupValidateBeforeCall(String insightGroupKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchInsightGroupCall(insightGroupKey, patchOperation, _callback);
        return localVarCall;
    ...
    /**
     * Patch insight group (asynchronously)
     * Update an insight group. Updating an insight group uses a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes. To learn more, read [Updates](/#section/Overview/Updates).
     * @param insightGroupKey The insight group key (required)
     * @param patchOperation  (required)
     * @param _callback The callback to be executed when the API call finishes
