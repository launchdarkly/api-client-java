...
public class AuditLogApi {
     ...
     * @param q Text to search for. You can search for the full or partial name of the resource, or full or partial email address of the member who made a change. (optional)
     * @param limit A limit on the number of audit log entries that return. Set between 1 and 20. (optional)
    ...
    public okhttp3.Call getAuditLogEntriesCall(Long before, Long after, String q, Long limit, String spec, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/auditlog";
    ...
    private okhttp3.Call getAuditLogEntriesValidateBeforeCall(Long before, Long after, String q, Long limit, String spec, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAuditLogEntriesCall(before, after, q, limit, spec, _callback);
        return localVarCall;
    ...
    /**
     * List audit log feature flag entries (asynchronously)
     * Get a list of all audit log entries. The query parameters let you restrict the results that return by date ranges, resource specifiers, or a full-text search query.
     * @param before A timestamp filter, expressed as a Unix epoch time in milliseconds.  All entries this returns occurred before the timestamp. (optional)
     * @param after A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries this returns occurred after the timestamp. (optional)
     * @param q Text to search for. You can search for the full or partial name of the resource, or full or partial email address of the member who made a change. (optional)
     ...
     * @param id The ID of the audit log entry (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call getAuditLogEntryCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/auditlog/{id}"
    ...
    private okhttp3.Call getAuditLogEntryValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAuditLogEntryCall(id, _callback);
        return localVarCall;
    ...
    /**
     * Get audit log entry (asynchronously)
     * Fetch a detailed audit log entry representation. The detailed representation includes several fields that are not present in the summary representation:  - &#x60;delta&#x60;: the JSON patch body that was used in the request to update the entity - &#x60;previousVersion&#x60;: a JSON representation of the previous version of the entity - &#x60;currentVersion&#x60;: a JSON representation of the current version of the entity 
     * @param id The ID of the audit log entry (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
