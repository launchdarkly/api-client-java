...
public class MetricsApi {
    ...
    private okhttp3.Call deleteMetricValidateBeforeCall(String projectKey, String metricKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteMetricCall(projectKey, metricKey, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call getMetricCall(String projectKey, String metricKey, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMetricValidateBeforeCall(String projectKey, String metricKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMetricCall(projectKey, metricKey, expand, _callback);
        return localVarCall;
     ...
     */
    public MetricRep getMetric(String projectKey, String metricKey, String expand) throws ApiException {
        ApiResponse<MetricRep> localVarResp = getMetricWithHttpInfo(projectKey, metricKey, expand);
     ...
     */
    public ApiResponse<MetricRep> getMetricWithHttpInfo(String projectKey, String metricKey, String expand) throws ApiException {
        okhttp3.Call localVarCall = getMetricValidateBeforeCall(projectKey, metricKey, expand, null);
     ...
     */
    public okhttp3.Call getMetricAsync(String projectKey, String metricKey, String expand, final ApiCallback<MetricRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMetricValidateBeforeCall(projectKey, metricKey, expand, _callback);
        Type localVarReturnType = new TypeToken<MetricRep>(){}.getType();
     ...
     */
    public okhttp3.Call getMetricsCall(String projectKey, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMetricsValidateBeforeCall(String projectKey, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMetricsCall(projectKey, expand, _callback);
        return localVarCall;
     ...
     */
    public MetricCollectionRep getMetrics(String projectKey, String expand) throws ApiException {
        ApiResponse<MetricCollectionRep> localVarResp = getMetricsWithHttpInfo(projectKey, expand);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MetricCollectionRep> getMetricsWithHttpInfo(String projectKey, String expand) throws ApiException {
        okhttp3.Call localVarCall = getMetricsValidateBeforeCall(projectKey, expand, null);
     ...
     */
    public okhttp3.Call getMetricsAsync(String projectKey, String expand, final ApiCallback<MetricCollectionRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMetricsValidateBeforeCall(projectKey, expand, _callback);
        Type localVarReturnType = new TypeToken<MetricCollectionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call patchMetricValidateBeforeCall(String projectKey, String metricKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchMetricCall(projectKey, metricKey, patchOperation, _callback);
        return localVarCall;
