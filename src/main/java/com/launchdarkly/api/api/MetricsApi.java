...
public class MetricsApi {
     ...
     */
    public okhttp3.Call getMetricCall(String projectKey, String metricKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMetricValidateBeforeCall(String projectKey, String metricKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMetricCall(projectKey, metricKey, _callback);
        return localVarCall;
     ...
     */
    public MetricRep getMetric(String projectKey, String metricKey) throws ApiException {
        ApiResponse<MetricRep> localVarResp = getMetricWithHttpInfo(projectKey, metricKey);
     ...
     */
    public ApiResponse<MetricRep> getMetricWithHttpInfo(String projectKey, String metricKey) throws ApiException {
        okhttp3.Call localVarCall = getMetricValidateBeforeCall(projectKey, metricKey, null);
     ...
     */
    public okhttp3.Call getMetricAsync(String projectKey, String metricKey, final ApiCallback<MetricRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMetricValidateBeforeCall(projectKey, metricKey, _callback);
        Type localVarReturnType = new TypeToken<MetricRep>(){}.getType();
