...
public class MetricsApi {
     ...
     */
    public okhttp3.Call deleteMetricCall(String projectKey, String key, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/metrics/{projectKey}/{key}"
    ...
    private okhttp3.Call deleteMetricValidateBeforeCall(String projectKey, String key, final ApiCallback _callback) throws ApiException {
        ...
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling deleteMetric(Async)");
        }
        

        okhttp3.Call localVarCall = deleteMetricCall(projectKey, key, _callback);
        return localVarCall;
     ...
     */
    public void deleteMetric(String projectKey, String key) throws ApiException {
        deleteMetricWithHttpInfo(projectKey, key);
    }
     ...
     */
    public ApiResponse<Void> deleteMetricWithHttpInfo(String projectKey, String key) throws ApiException {
        okhttp3.Call localVarCall = deleteMetricValidateBeforeCall(projectKey, key, null);
     ...
     */
    public okhttp3.Call deleteMetricAsync(String projectKey, String key, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteMetricValidateBeforeCall(projectKey, key, _callback);
     ...
     */
    public okhttp3.Call getMetricCall(String projectKey, String key, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMetricValidateBeforeCall(String projectKey, String key, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling getMetric(Async)");
        }
        

        okhttp3.Call localVarCall = getMetricCall(projectKey, key, _callback);
        return localVarCall;
     ...
     */
    public MetricRep getMetric(String projectKey, String key) throws ApiException {
        ApiResponse<MetricRep> localVarResp = getMetricWithHttpInfo(projectKey, key);
     ...
     */
    public ApiResponse<MetricRep> getMetricWithHttpInfo(String projectKey, String key) throws ApiException {
        okhttp3.Call localVarCall = getMetricValidateBeforeCall(projectKey, key, null);
     ...
     */
    public okhttp3.Call getMetricAsync(String projectKey, String key, final ApiCallback<MetricRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMetricValidateBeforeCall(projectKey, key, _callback);
        Type localVarReturnType = new TypeToken<MetricRep>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMetricsValidateBeforeCall(String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMetricsCall(projectKey, _callback);
        return localVarCall;
    ...
    public MetricCollectionRep getMetrics(String projectKey) throws ApiException {
        ApiResponse<MetricCollectionRep> localVarResp = getMetricsWithHttpInfo(projectKey);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<MetricCollectionRep> getMetricsWithHttpInfo(String projectKey) throws ApiException {
        okhttp3.Call localVarCall = getMetricsValidateBeforeCall(projectKey, null);
    ...
    public okhttp3.Call getMetricsAsync(String projectKey, final ApiCallback<MetricCollectionRep> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMetricsValidateBeforeCall(projectKey, _callback);
        Type localVarReturnType = new TypeToken<MetricCollectionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call patchMetricCall(String projectKey, String key, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchMetricValidateBeforeCall(String projectKey, String key, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling patchMetric(Async)");
        }
        ...
        okhttp3.Call localVarCall = patchMetricCall(projectKey, key, patchOperation, _callback);
        return localVarCall;
     ...
     */
    public MetricRep patchMetric(String projectKey, String key, List<PatchOperation> patchOperation) throws ApiException {
        ApiResponse<MetricRep> localVarResp = patchMetricWithHttpInfo(projectKey, key, patchOperation);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MetricRep> patchMetricWithHttpInfo(String projectKey, String key, List<PatchOperation> patchOperation) throws ApiException {
        okhttp3.Call localVarCall = patchMetricValidateBeforeCall(projectKey, key, patchOperation, null);
        Type localVarReturnType = new TypeToken<MetricRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call patchMetricAsync(String projectKey, String key, List<PatchOperation> patchOperation, final ApiCallback<MetricRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchMetricValidateBeforeCall(projectKey, key, patchOperation, _callback);
        Type localVarReturnType = new TypeToken<MetricRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call postMetricValidateBeforeCall(String projectKey, MetricPost metricPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postMetricCall(projectKey, metricPost, _callback);
        return localVarCall;
