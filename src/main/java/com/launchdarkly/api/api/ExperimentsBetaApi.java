...
import com.launchdarkly.api.model.ExperimentationSettingsPut;
import com.launchdarkly.api.model.ExperimentationSettingsRep;
...
public class ExperimentsBetaApi {
     ...
     */
    public okhttp3.Call getExperimentResultsCall(String projectKey, String environmentKey, String experimentKey, String metricKey, String iterationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExperimentResultsValidateBeforeCall(String projectKey, String environmentKey, String experimentKey, String metricKey, String iterationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getExperimentResultsCall(projectKey, environmentKey, experimentKey, metricKey, iterationId, _callback);
        return localVarCall;
     ...
     */
    public ExperimentBayesianResultsRep getExperimentResults(String projectKey, String environmentKey, String experimentKey, String metricKey, String iterationId) throws ApiException {
        ApiResponse<ExperimentBayesianResultsRep> localVarResp = getExperimentResultsWithHttpInfo(projectKey, environmentKey, experimentKey, metricKey, iterationId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExperimentBayesianResultsRep> getExperimentResultsWithHttpInfo(String projectKey, String environmentKey, String experimentKey, String metricKey, String iterationId) throws ApiException {
        okhttp3.Call localVarCall = getExperimentResultsValidateBeforeCall(projectKey, environmentKey, experimentKey, metricKey, iterationId, null);
     ...
     */
    public okhttp3.Call getExperimentResultsAsync(String projectKey, String environmentKey, String experimentKey, String metricKey, String iterationId, final ApiCallback<ExperimentBayesianResultsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExperimentResultsValidateBeforeCall(projectKey, environmentKey, experimentKey, metricKey, iterationId, _callback);
        Type localVarReturnType = new TypeToken<ExperimentBayesianResultsRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Get experiment results for metric group (asynchronously)
     * Get results from an experiment for a particular metric group.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param experimentKey The experiment key (required)
     ...
     */
    public ExperimentationSettingsRep getExperimentationSettings(String projectKey) throws ApiException {
        ApiResponse<ExperimentationSettingsRep> localVarResp = getExperimentationSettingsWithHttpInfo(projectKey);
        return localVarResp.getData();
    }
     ...
     * Get current experimentation settings for the given project
     * @param projectKey The project key (required)
     * @return ApiResponse&lt;ExperimentationSettingsRep&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ExperimentationSettingsRep> getExperimentationSettingsWithHttpInfo(String projectKey) throws ApiException {
        okhttp3.Call localVarCall = getExperimentationSettingsValidateBeforeCall(projectKey, null);
        Type localVarReturnType = new TypeToken<ExperimentationSettingsRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getExperimentationSettingsAsync(String projectKey, final ApiCallback<ExperimentationSettingsRep> _callback) throws ApiException {
     ...
     * @param projectKey The project key (required)
     * @param experimentationSettingsPut  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call putExperimentationSettingsCall(String projectKey, ExperimentationSettingsPut experimentationSettingsPut, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = experimentationSettingsPut;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putExperimentationSettingsValidateBeforeCall(String projectKey, ExperimentationSettingsPut experimentationSettingsPut, final ApiCallback _callback) throws ApiException {
        ...
        if (experimentationSettingsPut == null) {
            throw new ApiException("Missing the required parameter 'experimentationSettingsPut' when calling putExperimentationSettings(Async)");
        }
        

        okhttp3.Call localVarCall = putExperimentationSettingsCall(projectKey, experimentationSettingsPut, _callback);
        return localVarCall;
     ...
     */
    public ExperimentationSettingsRep putExperimentationSettings(String projectKey, ExperimentationSettingsPut experimentationSettingsPut) throws ApiException {
        ApiResponse<ExperimentationSettingsRep> localVarResp = putExperimentationSettingsWithHttpInfo(projectKey, experimentationSettingsPut);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExperimentationSettingsRep> putExperimentationSettingsWithHttpInfo(String projectKey, ExperimentationSettingsPut experimentationSettingsPut) throws ApiException {
        okhttp3.Call localVarCall = putExperimentationSettingsValidateBeforeCall(projectKey, experimentationSettingsPut, null);
        Type localVarReturnType = new TypeToken<ExperimentationSettingsRep>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call putExperimentationSettingsAsync(String projectKey, ExperimentationSettingsPut experimentationSettingsPut, final ApiCallback<ExperimentationSettingsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = putExperimentationSettingsValidateBeforeCall(projectKey, experimentationSettingsPut, _callback);
        Type localVarReturnType = new TypeToken<ExperimentationSettingsRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
