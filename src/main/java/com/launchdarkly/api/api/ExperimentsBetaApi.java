...
import com.launchdarkly.api.model.ExperimentResultsRep;
...
public class ExperimentsBetaApi {
     ...
     */
    public okhttp3.Call getExperimentCall(String projKey, String flagKey, String envKey, String metricKey, Long from, Long to, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/flags/{projKey}/{flagKey}/experiments/{envKey}/{metricKey}"
    ...
    private okhttp3.Call getExperimentValidateBeforeCall(String projKey, String flagKey, String envKey, String metricKey, Long from, Long to, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling getExperiment(Async)");
        }
        
        // verify the required parameter 'flagKey' is set
        if (flagKey == null) {
            throw new ApiException("Missing the required parameter 'flagKey' when calling getExperiment(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling getExperiment(Async)");
        }
        
        // verify the required parameter 'metricKey' is set
        if (metricKey == null) {
            throw new ApiException("Missing the required parameter 'metricKey' when calling getExperiment(Async)");
        }
        

        okhttp3.Call localVarCall = getExperimentCall(projKey, flagKey, envKey, metricKey, from, to, _callback);
        return localVarCall;
     ...
     */
    public ExperimentResultsRep getExperiment(String projKey, String flagKey, String envKey, String metricKey, Long from, Long to) throws ApiException {
        ApiResponse<ExperimentResultsRep> localVarResp = getExperimentWithHttpInfo(projKey, flagKey, envKey, metricKey, from, to);
     ...
     * @param from A timestamp denoting the start of the data collection period, expressed as a Unix epoch time in milliseconds. (optional)
     * @param to A timestamp denoting the end of the data collection period, expressed as a Unix epoch time in milliseconds. (optional)
     * @return ApiResponse&lt;ExperimentResultsRep&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ExperimentResultsRep> getExperimentWithHttpInfo(String projKey, String flagKey, String envKey, String metricKey, Long from, Long to) throws ApiException {
        okhttp3.Call localVarCall = getExperimentValidateBeforeCall(projKey, flagKey, envKey, metricKey, from, to, null);
        Type localVarReturnType = new TypeToken<ExperimentResultsRep>(){}.getType();
     ...
     */
    public okhttp3.Call getExperimentAsync(String projKey, String flagKey, String envKey, String metricKey, Long from, Long to, final ApiCallback<ExperimentResultsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExperimentValidateBeforeCall(projKey, flagKey, envKey, metricKey, from, to, _callback);
        Type localVarReturnType = new TypeToken<ExperimentResultsRep>(){}.getType();
     ...
     * @param projKey The project key (required)
     * @param flagKey The feature flag&#39;s key (required)
     * @param envKey The environment key (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Unknown project, flag, environment or metric key </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call resetExperimentCall(String projKey, String flagKey, String envKey, String metricKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/flags/{projKey}/{flagKey}/experiments/{envKey}/{metricKey}/results"
            .replaceAll("\\{" + "projKey" + "\\}", localVarApiClient.escapeString(projKey.toString()))
            .replaceAll("\\{" + "flagKey" + "\\}", localVarApiClient.escapeString(flagKey.toString()))
            .replaceAll("\\{" + "envKey" + "\\}", localVarApiClient.escapeString(envKey.toString()))
            .replaceAll("\\{" + "metricKey" + "\\}", localVarApiClient.escapeString(metricKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resetExperimentValidateBeforeCall(String projKey, String flagKey, String envKey, String metricKey, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projKey' is set
        if (projKey == null) {
            throw new ApiException("Missing the required parameter 'projKey' when calling resetExperiment(Async)");
        }
        
        // verify the required parameter 'flagKey' is set
        if (flagKey == null) {
            throw new ApiException("Missing the required parameter 'flagKey' when calling resetExperiment(Async)");
        }
        
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling resetExperiment(Async)");
        }
        ...
        okhttp3.Call localVarCall = resetExperimentCall(projKey, flagKey, envKey, metricKey, _callback);
        return localVarCall;
     ...
     */
    public void resetExperiment(String projKey, String flagKey, String envKey, String metricKey) throws ApiException {
        resetExperimentWithHttpInfo(projKey, flagKey, envKey, metricKey);
    }
     ...
     */
    public ApiResponse<Void> resetExperimentWithHttpInfo(String projKey, String flagKey, String envKey, String metricKey) throws ApiException {
        okhttp3.Call localVarCall = resetExperimentValidateBeforeCall(projKey, flagKey, envKey, metricKey, null);
     ...
     */
    public okhttp3.Call resetExperimentAsync(String projKey, String flagKey, String envKey, String metricKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = resetExperimentValidateBeforeCall(projKey, flagKey, envKey, metricKey, _callback);
