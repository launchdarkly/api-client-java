...
public class ExperimentsBetaApi {
     ...
     */
    public okhttp3.Call getExperimentCall(String projectKey, String featureFlagKey, String environmentKey, String metricKey, Long from, Long to, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getExperimentValidateBeforeCall(String projectKey, String featureFlagKey, String environmentKey, String metricKey, Long from, Long to, final ApiCallback _callback) throws ApiException {
        ...
        if (featureFlagKey == null) {
            throw new ApiException("Missing the required parameter 'featureFlagKey' when calling getExperiment(Async)");
        }
        ...
        okhttp3.Call localVarCall = getExperimentCall(projectKey, featureFlagKey, environmentKey, metricKey, from, to, _callback);
        return localVarCall;
     ...
     */
    public ExperimentResultsRep getExperiment(String projectKey, String featureFlagKey, String environmentKey, String metricKey, Long from, Long to) throws ApiException {
        ApiResponse<ExperimentResultsRep> localVarResp = getExperimentWithHttpInfo(projectKey, featureFlagKey, environmentKey, metricKey, from, to);
     ...
     */
    public ApiResponse<ExperimentResultsRep> getExperimentWithHttpInfo(String projectKey, String featureFlagKey, String environmentKey, String metricKey, Long from, Long to) throws ApiException {
        okhttp3.Call localVarCall = getExperimentValidateBeforeCall(projectKey, featureFlagKey, environmentKey, metricKey, from, to, null);
     ...
     */
    public okhttp3.Call getExperimentAsync(String projectKey, String featureFlagKey, String environmentKey, String metricKey, Long from, Long to, final ApiCallback<ExperimentResultsRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExperimentValidateBeforeCall(projectKey, featureFlagKey, environmentKey, metricKey, from, to, _callback);
        Type localVarReturnType = new TypeToken<ExperimentResultsRep>(){}.getType();
