...
public class ExperimentsBetaApi {
     ...
     */
    public okhttp3.Call getExperimentsCall(String projectKey, String environmentKey, Long limit, Long offset, String filter, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExperimentsValidateBeforeCall(String projectKey, String environmentKey, Long limit, Long offset, String filter, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getExperimentsCall(projectKey, environmentKey, limit, offset, filter, expand, _callback);
        return localVarCall;
     ...
     */
    public ExperimentCollectionRep getExperiments(String projectKey, String environmentKey, Long limit, Long offset, String filter, String expand) throws ApiException {
        ApiResponse<ExperimentCollectionRep> localVarResp = getExperimentsWithHttpInfo(projectKey, environmentKey, limit, offset, filter, expand);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExperimentCollectionRep> getExperimentsWithHttpInfo(String projectKey, String environmentKey, Long limit, Long offset, String filter, String expand) throws ApiException {
        okhttp3.Call localVarCall = getExperimentsValidateBeforeCall(projectKey, environmentKey, limit, offset, filter, expand, null);
     ...
     */
    public okhttp3.Call getExperimentsAsync(String projectKey, String environmentKey, Long limit, Long offset, String filter, String expand, final ApiCallback<ExperimentCollectionRep> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExperimentsValidateBeforeCall(projectKey, environmentKey, limit, offset, filter, expand, _callback);
        Type localVarReturnType = new TypeToken<ExperimentCollectionRep>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
