...
public class TeamMembersApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getMembersCall(BigDecimal limit, Boolean number, String filter, String sort, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getMembersValidateBeforeCall(BigDecimal limit, Boolean number, String filter, String sort, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getMembersCall(limit, number, filter, sort, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Members getMembers(BigDecimal limit, Boolean number, String filter, String sort) throws ApiException {
        ApiResponse<Members> resp = getMembersWithHttpInfo(limit, number, filter, sort);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Members> getMembersWithHttpInfo(BigDecimal limit, Boolean number, String filter, String sort) throws ApiException {
        com.squareup.okhttp.Call call = getMembersValidateBeforeCall(limit, number, filter, sort, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getMembersAsync(BigDecimal limit, Boolean number, String filter, String sort, final ApiCallback<Members> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMembersValidateBeforeCall(limit, number, filter, sort, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Members>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
