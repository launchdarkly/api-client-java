...
public class UserSegmentsApi {
    ...
    /**
     * Build call for updatedBigSegmentTargets
     * @param projectKey The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param userSegmentKey The user segment&#39;s key. The key identifies the user segment in your code. (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updatedBigSegmentTargetsCall(String projectKey, String environmentKey, String userSegmentKey, BigSegmentTargetsBody bigSegmentTargetsBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updatedBigSegmentTargetsValidateBeforeCall(String projectKey, String environmentKey, String userSegmentKey, BigSegmentTargetsBody bigSegmentTargetsBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectKey' is set
        if (projectKey == null) {
            throw new ApiException("Missing the required parameter 'projectKey' when calling updatedBigSegmentTargets(Async)");
        }
        
        // verify the required parameter 'environmentKey' is set
        if (environmentKey == null) {
            throw new ApiException("Missing the required parameter 'environmentKey' when calling updatedBigSegmentTargets(Async)");
        }
        
        // verify the required parameter 'userSegmentKey' is set
        if (userSegmentKey == null) {
            throw new ApiException("Missing the required parameter 'userSegmentKey' when calling updatedBigSegmentTargets(Async)");
        }
        
        // verify the required parameter 'bigSegmentTargetsBody' is set
        if (bigSegmentTargetsBody == null) {
            throw new ApiException("Missing the required parameter 'bigSegmentTargetsBody' when calling updatedBigSegmentTargets(Async)");
        }
        

        com.squareup.okhttp.Call call = updatedBigSegmentTargetsCall(projectKey, environmentKey, userSegmentKey, bigSegmentTargetsBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updatedBigSegmentTargets(String projectKey, String environmentKey, String userSegmentKey, BigSegmentTargetsBody bigSegmentTargetsBody) throws ApiException {
        updatedBigSegmentTargetsWithHttpInfo(projectKey, environmentKey, userSegmentKey, bigSegmentTargetsBody);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updatedBigSegmentTargetsWithHttpInfo(String projectKey, String environmentKey, String userSegmentKey, BigSegmentTargetsBody bigSegmentTargetsBody) throws ApiException {
        com.squareup.okhttp.Call call = updatedBigSegmentTargetsValidateBeforeCall(projectKey, environmentKey, userSegmentKey, bigSegmentTargetsBody, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatedBigSegmentTargetsAsync(String projectKey, String environmentKey, String userSegmentKey, BigSegmentTargetsBody bigSegmentTargetsBody, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatedBigSegmentTargetsValidateBeforeCall(projectKey, environmentKey, userSegmentKey, bigSegmentTargetsBody, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
