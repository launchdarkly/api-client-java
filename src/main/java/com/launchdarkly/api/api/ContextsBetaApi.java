...
public class ContextsBetaApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ContextsBetaApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ContextsBetaApi(ApiClient apiClient) {
    ...
    private okhttp3.Call deleteContextInstancesValidateBeforeCall(String projectKey, String environmentKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteContextInstancesCall(projectKey, environmentKey, id, _callback);
        return localVarCall;
    ...
    /**
     * Delete context instances (asynchronously)
     * Delete context instances by ID.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param id The context instance ID (required)
     ...
     * @param filter A comma-separated list of filters. Each filter is of the form field:value. Supports the same filters as the List Feature Flags API. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    private okhttp3.Call evaluateContextInstanceValidateBeforeCall(String projectKey, String environmentKey, Map<String, Object> requestBody, Long limit, Long offset, String sort, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = evaluateContextInstanceCall(projectKey, environmentKey, requestBody, limit, offset, sort, filter, _callback);
        return localVarCall;
    ...
    /**
     * Evaluate flags for context instance (asynchronously)
     * Evaluate flags for a context instance, for example, to determine the expected flag variation. **Do not use this API instead of an SDK.** The LaunchDarkly SDKs are specialized for the tasks of evaluating feature flags in your application at scale and generating analytics events based on those evaluations. This API is not designed for that use case. Any evaluations you perform with this API will not be reflected in features such as flag statuses and flag insights. Context instances evaluated by this API will not appear in the Contexts list. To learn more, read [Comparing LaunchDarkly&#39;s SDKs and REST API](https://docs.launchdarkly.com/guide/api/comparing-sdk-rest-api).
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param requestBody  (required)
     ...
     */
    public okhttp3.Call getContextAttributeNamesCall(String projectKey, String environmentKey, String filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getContextAttributeNamesValidateBeforeCall(String projectKey, String environmentKey, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getContextAttributeNamesCall(projectKey, environmentKey, filter, _callback);
        return localVarCall;
     ...
     */
    public ContextAttributeNamesCollection getContextAttributeNames(String projectKey, String environmentKey, String filter) throws ApiException {
        ApiResponse<ContextAttributeNamesCollection> localVarResp = getContextAttributeNamesWithHttpInfo(projectKey, environmentKey, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ContextAttributeNamesCollection> getContextAttributeNamesWithHttpInfo(String projectKey, String environmentKey, String filter) throws ApiException {
        okhttp3.Call localVarCall = getContextAttributeNamesValidateBeforeCall(projectKey, environmentKey, filter, null);
        Type localVarReturnType = new TypeToken<ContextAttributeNamesCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get context attribute names (asynchronously)
     * Get context attribute names.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param filter A comma-separated list of context filters. This endpoint only accepts &#x60;kind&#x60; filters, with the &#x60;equals&#x60; operator, and &#x60;name&#x60; filters, with the &#x60;startsWith&#x60; operator. To learn more about the filter syntax, read [Filtering contexts and context instances](/tag/Contexts-(beta)#filtering-contexts-and-context-instances). (optional)
     ...
     */
    public okhttp3.Call getContextAttributeNamesAsync(String projectKey, String environmentKey, String filter, final ApiCallback<ContextAttributeNamesCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getContextAttributeNamesValidateBeforeCall(projectKey, environmentKey, filter, _callback);
        Type localVarReturnType = new TypeToken<ContextAttributeNamesCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getContextAttributeValuesCall(String projectKey, String environmentKey, String attributeName, String filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        String localVarPath = "/api/v2/projects/{projectKey}/environments/{environmentKey}/context-attributes/{attributeName}"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "environmentKey" + "\\}", localVarApiClient.escapeString(environmentKey.toString()))
            .replaceAll("\\{" + "attributeName" + "\\}", localVarApiClient.escapeString(attributeName.toString()));
    ...
    private okhttp3.Call getContextAttributeValuesValidateBeforeCall(String projectKey, String environmentKey, String attributeName, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getContextAttributeValuesCall(projectKey, environmentKey, attributeName, filter, _callback);
        return localVarCall;
     ...
     */
    public ContextAttributeValuesCollection getContextAttributeValues(String projectKey, String environmentKey, String attributeName, String filter) throws ApiException {
     ...
     */
    public ApiResponse<ContextAttributeValuesCollection> getContextAttributeValuesWithHttpInfo(String projectKey, String environmentKey, String attributeName, String filter) throws ApiException {
    ...
    /**
     * Get context attribute values (asynchronously)
     * Get context attribute values.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param attributeName The attribute name (required)
     ...
     */
    public okhttp3.Call getContextAttributeValuesAsync(String projectKey, String environmentKey, String attributeName, String filter, final ApiCallback<ContextAttributeValuesCollection> _callback) throws ApiException {
     ...
     * @param filter A comma-separated list of context filters. This endpoint only accepts an &#x60;applicationId&#x60; filter. To learn more about the filter syntax, read [Filtering contexts and context instances](/tag/Contexts-(beta)#filtering-contexts-and-context-instances). (optional)
    ...
    private okhttp3.Call getContextInstancesValidateBeforeCall(String projectKey, String environmentKey, String id, Long limit, String continuationToken, String sort, String filter, Boolean includeTotalCount, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getContextInstancesCall(projectKey, environmentKey, id, limit, continuationToken, sort, filter, includeTotalCount, _callback);
        return localVarCall;
    ...
    /**
     * Get context instances (asynchronously)
     * Get context instances by ID.
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param id The context instance ID (required)
    ...
    private okhttp3.Call getContextKindsByProjectKeyValidateBeforeCall(String projectKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getContextKindsByProjectKeyCall(projectKey, _callback);
        return localVarCall;
    ...
    /**
     * Get context kinds (asynchronously)
     * Get all context kinds for a given project.
     * @param projectKey The project key (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    private okhttp3.Call getContextsValidateBeforeCall(String projectKey, String environmentKey, String kind, String key, Long limit, String continuationToken, String sort, String filter, Boolean includeTotalCount, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getContextsCall(projectKey, environmentKey, kind, key, limit, continuationToken, sort, filter, includeTotalCount, _callback);
        return localVarCall;
    ...
    private okhttp3.Call putContextKindValidateBeforeCall(String projectKey, String key, UpsertContextKindPayload upsertContextKindPayload, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = putContextKindCall(projectKey, key, upsertContextKindPayload, _callback);
        return localVarCall;
    ...
    /**
     * Create or update context kind (asynchronously)
     * Create or update a context kind by key. Only the included fields will be updated.
     * @param projectKey The project key (required)
     * @param key The context kind key (required)
     * @param upsertContextKindPayload  (required)
    ...
    private okhttp3.Call searchContextInstancesValidateBeforeCall(String projectKey, String environmentKey, ContextInstanceSearch contextInstanceSearch, Long limit, String continuationToken, String sort, String filter, Boolean includeTotalCount, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchContextInstancesCall(projectKey, environmentKey, contextInstanceSearch, limit, continuationToken, sort, filter, includeTotalCount, _callback);
        return localVarCall;
    ...
    /**
     * Search for context instances (asynchronously)
     *  Search for context instances.  You can use either the query parameters or the request body parameters. If both are provided, there is an error.  To learn more about the filter syntax, read [Filtering contexts and context instances](/tag/Contexts-(beta)#filtering-contexts-and-context-instances). To learn more about context instances, read [Understanding context instances](https://docs.launchdarkly.com/home/contexts#understanding-context-instances). 
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param contextInstanceSearch  (required)
     ...
     * @param continuationToken Limits results to contexts with sort values after the value specified. You can use this for pagination, however, we recommend using the &#x60;next&#x60; link we provide instead. (optional)
     * @param sort Specifies a field by which to sort. LaunchDarkly supports sorting by timestamp in ascending order by specifying &#x60;ts&#x60; for this value, or descending order by specifying &#x60;-ts&#x60;. (optional)
     * @param filter A comma-separated list of context filters. To learn more about the filter syntax, read [Filtering contexts and context instances](/tag/Contexts-(beta)#filtering-contexts-and-context-instances). (optional)
     * @param includeTotalCount Specifies whether to include or omit the total count of matching contexts. Defaults to true. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    private okhttp3.Call searchContextsValidateBeforeCall(String projectKey, String environmentKey, ContextSearch contextSearch, Long limit, String continuationToken, String sort, String filter, Boolean includeTotalCount, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchContextsCall(projectKey, environmentKey, contextSearch, limit, continuationToken, sort, filter, includeTotalCount, _callback);
        return localVarCall;
    ...
    /**
     * Search for contexts (asynchronously)
     *  Search for contexts.  You can use either the query parameters or the request body parameters. If both are provided, there is an error.  To learn more about the filter syntax, read [Filtering contexts and context instances](/tag/Contexts-(beta)#filtering-contexts-and-context-instances). To learn more about contexts, read [Understanding contexts and context kinds](https://docs.launchdarkly.com/home/contexts#understanding-contexts-and-context-kinds). 
     * @param projectKey The project key (required)
     * @param environmentKey The environment key (required)
     * @param contextSearch  (required)
