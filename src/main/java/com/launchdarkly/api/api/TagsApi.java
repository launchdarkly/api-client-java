...
public class TagsApi {
     ...
     * @param kind Fetch tags associated with the specified resource type. Options are &#x60;flag&#x60;, &#x60;project&#x60;, &#x60;environment&#x60;, &#x60;segment&#x60;. Returns all types by default. (optional)
     ...
     */
    public okhttp3.Call getTagsCall(String kind, String pre, Boolean archived, final ApiCallback _callback) throws ApiException {
        ...
        if (pre != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("pre", pre));
        }
    ...
    private okhttp3.Call getTagsValidateBeforeCall(String kind, String pre, Boolean archived, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getTagsCall(kind, pre, archived, _callback);
        return localVarCall;
     ...
     */
    public TagCollection getTags(String kind, String pre, Boolean archived) throws ApiException {
        ApiResponse<TagCollection> localVarResp = getTagsWithHttpInfo(kind, pre, archived);
     ...
     */
    public ApiResponse<TagCollection> getTagsWithHttpInfo(String kind, String pre, Boolean archived) throws ApiException {
        okhttp3.Call localVarCall = getTagsValidateBeforeCall(kind, pre, archived, null);
     ...
     */
    public okhttp3.Call getTagsAsync(String kind, String pre, Boolean archived, final ApiCallback<TagCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTagsValidateBeforeCall(kind, pre, archived, _callback);
        Type localVarReturnType = new TypeToken<TagCollection>(){}.getType();
