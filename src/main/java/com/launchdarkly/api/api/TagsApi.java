...
public class TagsApi {
     ...
     */
    public okhttp3.Call getTagsCall(String kind, String pre, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getTagsValidateBeforeCall(String kind, String pre, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getTagsCall(kind, pre, _callback);
        return localVarCall;
     ...
     */
    public TagCollection getTags(String kind, String pre) throws ApiException {
        ApiResponse<TagCollection> localVarResp = getTagsWithHttpInfo(kind, pre);
     ...
     */
    public ApiResponse<TagCollection> getTagsWithHttpInfo(String kind, String pre) throws ApiException {
        okhttp3.Call localVarCall = getTagsValidateBeforeCall(kind, pre, null);
     ...
     */
    public okhttp3.Call getTagsAsync(String kind, String pre, final ApiCallback<TagCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTagsValidateBeforeCall(kind, pre, _callback);
        Type localVarReturnType = new TypeToken<TagCollection>(){}.getType();
