...
public class IntegrationsBetaApi {
     ...
     * @param integrationConfigurationPost  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 404 </td><td> Integration key not found </td><td>  -  </td></tr>
    ...
    public okhttp3.Call createIntegrationConfigurationCall(String integrationKey, IntegrationConfigurationPost integrationConfigurationPost, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = integrationConfigurationPost;

        // create path and map variables
        String localVarPath = "/api/v2/integration-configurations/keys/{integrationKey}"
    ...
    private okhttp3.Call createIntegrationConfigurationValidateBeforeCall(String integrationKey, IntegrationConfigurationPost integrationConfigurationPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createIntegrationConfigurationCall(integrationKey, integrationConfigurationPost, _callback);
        return localVarCall;
    ...
    /**
     * Create integration configuration (asynchronously)
     * Create a new integration configuration. (Excludes [persistent store](https://launchdarkly.com/docs/api/persistent-store-integrations-beta) and [flag import configurations](https://launchdarkly.com/docs/api/flag-import-configurations-beta).)
     * @param integrationKey The integration key (required)
     * @param integrationConfigurationPost  (required)
    ...
    public okhttp3.Call deleteIntegrationConfigurationCall(String integrationConfigurationId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/integration-configurations/{integrationConfigurationId}"
            .replaceAll("\\{" + "integrationConfigurationId" + "\\}", localVarApiClient.escapeString(integrationConfigurationId.toString()));
    ...
    private okhttp3.Call deleteIntegrationConfigurationValidateBeforeCall(String integrationConfigurationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteIntegrationConfigurationCall(integrationConfigurationId, _callback);
        return localVarCall;
     ...
     * @param integrationKey Integration key (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    private okhttp3.Call getAllIntegrationConfigurationsValidateBeforeCall(String integrationKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllIntegrationConfigurationsCall(integrationKey, _callback);
        return localVarCall;
    ...
    /**
     * Get all configurations for the integration (asynchronously)
     * Get all integration configurations with the specified integration key. (Excludes [persistent store](https://launchdarkly.com/docs/api/persistent-store-integrations-beta) and [flag import configurations](https://launchdarkly.com/docs/api/flag-import-configurations-beta).).
     * @param integrationKey Integration key (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param integrationConfigurationId Integration configuration ID (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Integration ID not found </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
     </table>
     */
    ...
    private okhttp3.Call getIntegrationConfigurationValidateBeforeCall(String integrationConfigurationId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIntegrationConfigurationCall(integrationConfigurationId, _callback);
        return localVarCall;
    ...
    /**
     * Get an integration configuration (asynchronously)
     * Get integration configuration with the specified ID. (Excludes [persistent store](https://launchdarkly.com/docs/api/persistent-store-integrations-beta) and [flag import configurations](https://launchdarkly.com/docs/api/flag-import-configurations-beta).)
     * @param integrationConfigurationId Integration configuration ID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param integrationConfigurationId The ID of the integration configuration (required)
    ...
    private okhttp3.Call updateIntegrationConfigurationValidateBeforeCall(String integrationConfigurationId, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateIntegrationConfigurationCall(integrationConfigurationId, patchOperation, _callback);
        return localVarCall;
    ...
    /**
     * Update integration configuration (asynchronously)
     * Update an integration configuration. Updating an integration configuration uses a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes. To learn more, read [Updates](https://launchdarkly.com/docs/api#updates).
     * @param integrationConfigurationId The ID of the integration configuration (required)
     * @param patchOperation  (required)
     * @param _callback The callback to be executed when the API call finishes
