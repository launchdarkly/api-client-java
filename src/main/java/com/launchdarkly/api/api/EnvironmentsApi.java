...
public class EnvironmentsApi {
    ...
    private okhttp3.Call deleteEnvironmentValidateBeforeCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteEnvironmentCall(projectKey, environmentKey, _callback);
        return localVarCall;
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Environment response JSON </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource identifier </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Rate limited </td><td>  -  </td></tr>
    ...
    private okhttp3.Call getEnvironmentValidateBeforeCall(String projectKey, String environmentKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getEnvironmentCall(projectKey, environmentKey, _callback);
        return localVarCall;
    ...
    private okhttp3.Call patchEnvironmentValidateBeforeCall(String projectKey, String environmentKey, List<PatchOperation> patchOperation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchEnvironmentCall(projectKey, environmentKey, patchOperation, _callback);
        return localVarCall;
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Successful environment response </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource identifier </td><td>  -  </td></tr>
    ...
    private okhttp3.Call postEnvironmentValidateBeforeCall(String projectKey, EnvironmentPost environmentPost, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postEnvironmentCall(projectKey, environmentPost, _callback);
        return localVarCall;
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successful environment response </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Invalid access token </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Invalid resource identifier </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call resetEnvironmentMobileKeyCall(String projectKey, String envKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/environments/{envKey}/mobileKey"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resetEnvironmentMobileKeyValidateBeforeCall(String projectKey, String envKey, final ApiCallback _callback) throws ApiException {
        ...
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling resetEnvironmentMobileKey(Async)");
        }
        

        okhttp3.Call localVarCall = resetEnvironmentMobileKeyCall(projectKey, envKey, _callback);
        return localVarCall;
     ...
     */
    public Environment resetEnvironmentMobileKey(String projectKey, String envKey) throws ApiException {
        ApiResponse<Environment> localVarResp = resetEnvironmentMobileKeyWithHttpInfo(projectKey, envKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Environment> resetEnvironmentMobileKeyWithHttpInfo(String projectKey, String envKey) throws ApiException {
        okhttp3.Call localVarCall = resetEnvironmentMobileKeyValidateBeforeCall(projectKey, envKey, null);
        Type localVarReturnType = new TypeToken<Environment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Reset environment mobile SDK key (asynchronously)
     * Reset an environment&#39;s mobile key. The optional expiry for the old key is deprecated for this endpoint, so the old key will always expire immediately.
     * @param projectKey The project key (required)
     * @param envKey The environment key (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call resetEnvironmentMobileKeyAsync(String projectKey, String envKey, final ApiCallback<Environment> _callback) throws ApiException {

        okhttp3.Call localVarCall = resetEnvironmentMobileKeyValidateBeforeCall(projectKey, envKey, _callback);
        Type localVarReturnType = new TypeToken<Environment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param projectKey The project key (required)
     * @param envKey The environment key (required)
     * @param expiry The time at which you want the old SDK key to expire, in UNIX milliseconds. By default, the key expires immediately. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call resetEnvironmentSDKKeyCall(String projectKey, String envKey, Long expiry, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v2/projects/{projectKey}/environments/{envKey}/apiKey"
            .replaceAll("\\{" + "projectKey" + "\\}", localVarApiClient.escapeString(projectKey.toString()))
            .replaceAll("\\{" + "envKey" + "\\}", localVarApiClient.escapeString(envKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resetEnvironmentSDKKeyValidateBeforeCall(String projectKey, String envKey, Long expiry, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'envKey' is set
        if (envKey == null) {
            throw new ApiException("Missing the required parameter 'envKey' when calling resetEnvironmentSDKKey(Async)");
        }
        

        okhttp3.Call localVarCall = resetEnvironmentSDKKeyCall(projectKey, envKey, expiry, _callback);
        return localVarCall;
     ...
     */
    public Environment resetEnvironmentSDKKey(String projectKey, String envKey, Long expiry) throws ApiException {
        ApiResponse<Environment> localVarResp = resetEnvironmentSDKKeyWithHttpInfo(projectKey, envKey, expiry);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Environment> resetEnvironmentSDKKeyWithHttpInfo(String projectKey, String envKey, Long expiry) throws ApiException {
        okhttp3.Call localVarCall = resetEnvironmentSDKKeyValidateBeforeCall(projectKey, envKey, expiry, null);
        Type localVarReturnType = new TypeToken<Environment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Reset environment SDK key (asynchronously)
     * Reset an environment&#39;s SDK key with an optional expiry time for the old key.
     * @param projectKey The project key (required)
     * @param envKey The environment key (required)
     * @param expiry The time at which you want the old SDK key to expire, in UNIX milliseconds. By default, the key expires immediately. (optional)
     ...
     */
    public okhttp3.Call resetEnvironmentSDKKeyAsync(String projectKey, String envKey, Long expiry, final ApiCallback<Environment> _callback) throws ApiException {

        okhttp3.Call localVarCall = resetEnvironmentSDKKeyValidateBeforeCall(projectKey, envKey, expiry, _callback);
        Type localVarReturnType = new TypeToken<Environment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
