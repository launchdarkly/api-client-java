...
public class EnvironmentsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void postEnvironment(String projectKey, EnvironmentPost environmentBody) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> postEnvironmentWithHttpInfo(String projectKey, EnvironmentPost environmentBody) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postEnvironmentAsync(String projectKey, EnvironmentPost environmentBody, final ApiCallback<Void> callback) throws ApiException {
