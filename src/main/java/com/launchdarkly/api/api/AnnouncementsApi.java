...
import com.launchdarkly.api.model.AnnouncementPatchOperation;
import com.launchdarkly.api.model.AnnouncementResponse;
import com.launchdarkly.api.model.CreateAnnouncementBody;
import com.launchdarkly.api.model.Error;
import com.launchdarkly.api.model.GetAnnouncementsPublic200Response;
...
public class AnnouncementsApi {
     ...
     * @param createAnnouncementBody Announcement request body (required)
    ...
    public okhttp3.Call createAnnouncementPublicCall(CreateAnnouncementBody createAnnouncementBody, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createAnnouncementBody;

        // create path and map variables
        String localVarPath = "/api/v2/announcements";
    ...
    private okhttp3.Call createAnnouncementPublicValidateBeforeCall(CreateAnnouncementBody createAnnouncementBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createAnnouncementPublicCall(createAnnouncementBody, _callback);
        return localVarCall;
    ...
    /**
     * Create an announcement (asynchronously)
     * Create an announcement
     * @param createAnnouncementBody Announcement request body (required)
    ...
    public okhttp3.Call deleteAnnouncementPublicCall(String announcementId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/announcements/{announcementId}"
            .replaceAll("\\{" + "announcementId" + "\\}", localVarApiClient.escapeString(announcementId.toString()));
    ...
    private okhttp3.Call deleteAnnouncementPublicValidateBeforeCall(String announcementId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteAnnouncementPublicCall(announcementId, _callback);
        return localVarCall;
    ...
    /**
     * Delete an announcement (asynchronously)
     * Delete an announcement
     * @param announcementId  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param status Filter announcements by status. (optional)
     * @param limit The number of announcements to return. (optional)
    ...
    private okhttp3.Call getAnnouncementsPublicValidateBeforeCall(String status, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAnnouncementsPublicCall(status, limit, offset, _callback);
        return localVarCall;
    ...
    /**
     * Get announcements (asynchronously)
     * Get announcements
     * @param status Filter announcements by status. (optional)
     * @param limit The number of announcements to return. (optional)
     * @param offset Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;. (optional)
     ...
     * @param announcementId  (required)
     * @param announcementPatchOperation Update announcement request body (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call updateAnnouncementPublicCall(String announcementId, List<AnnouncementPatchOperation> announcementPatchOperation, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = announcementPatchOperation;
    ...
    private okhttp3.Call updateAnnouncementPublicValidateBeforeCall(String announcementId, List<AnnouncementPatchOperation> announcementPatchOperation, final ApiCallback _callback) throws ApiException {
        ...
        if (announcementPatchOperation == null) {
            throw new ApiException("Missing the required parameter 'announcementPatchOperation' when calling updateAnnouncementPublic(Async)");
        }
        

        okhttp3.Call localVarCall = updateAnnouncementPublicCall(announcementId, announcementPatchOperation, _callback);
        return localVarCall;
